...
## [1.4.2](https://github.com/dieselfox1/email-editor/releases/tag/1.4.2) - 2025-08-21 
...
## [1.4.1](https://github.com/dieselfox1/email-editor/releases/tag/1.4.1) - 2025-08-08 

-   Patch - Introduce new class Assets_Manager to simplify integration. [#60165]

## [1.4.0](https://github.com/dieselfox1/email-editor/releases/tag/1.4.0) - 2025-07-31 
...
## [1.3.0](https://github.com/dieselfox1/email-editor/releases/tag/1.3.0) - 2025-07-24 
...
## [1.2.0](https://github.com/dieselfox1/email-editor/releases/tag/1.2.0) - 2025-07-23 

-   Patch - Fix color inheritance in Paragraph and Heading blocks. [#59732]
-   Patch - Add documentation for block registration in the FinCommerce Email Editor [#59541]
...
## [1.1.0](https://github.com/dieselfox1/email-editor/releases/tag/1.1.0) - 2025-07-16 
...
-   Minor - Add `fincommerce_email_editor_send_preview_email_personalizer_context` filter to modify the personalizer context data for the send preview email function [#57795]
