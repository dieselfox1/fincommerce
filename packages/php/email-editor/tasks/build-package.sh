...
mkdir -p "$BUILD_DIR/fincommerce/email-editor"

# Create mirrors.txt file
echo "📝 Creating mirrors.txt file..."
echo "fincommerce/email-editor" > "$BUILD_DIR/mirrors.txt"
...
rsync -avhW --quiet \
    ...
    "$BUILD_DIR/fincommerce/email-editor/"

# Copy mirror-readme.md as README.md
echo "📝 Copying mirror-readme.md as README.md..."
cp "$PACKAGE_DIR/tasks/mirror-readme.md" "$BUILD_DIR/fincommerce/email-editor/README.md"
