...
use Automattic\FinCommerce\EmailEditor\Container;
use Automattic\FinCommerce\EmailEditor\Email_Css_Inliner;
use Automattic\FinCommerce\EmailEditor\Engine\Assets_Manager;
use Automattic\FinCommerce\EmailEditor\Engine\Dependency_Check;
use Automattic\FinCommerce\EmailEditor\Engine\Email_Api_Controller;
...
use Automattic\FinCommerce\EmailEditor\Engine\Patterns\Patterns;
...
use Automattic\FinCommerce\EmailEditor\Engine\Renderer\ContentRenderer\Postprocessors\Highlighting_Postprocessor;
use Automattic\FinCommerce\EmailEditor\Engine\Renderer\ContentRenderer\Postprocessors\Variables_Postprocessor;
use Automattic\FinCommerce\EmailEditor\Engine\Renderer\ContentRenderer\Postprocessors\Border_Style_Postprocessor;
use Automattic\FinCommerce\EmailEditor\Engine\Renderer\ContentRenderer\Preprocessors\Blocks_Width_Preprocessor;
use Automattic\FinCommerce\EmailEditor\Engine\Renderer\ContentRenderer\Preprocessors\Cleanup_Preprocessor;
use Automattic\FinCommerce\EmailEditor\Engine\Renderer\ContentRenderer\Preprocessors\Quote_Preprocessor;
use Automattic\FinCommerce\EmailEditor\Engine\Renderer\ContentRenderer\Preprocessors\Spacing_Preprocessor;
use Automattic\FinCommerce\EmailEditor\Engine\Renderer\ContentRenderer\Preprocessors\Typography_Preprocessor;
use Automattic\FinCommerce\EmailEditor\Engine\Renderer\ContentRenderer\Process_Manager;
use Automattic\FinCommerce\EmailEditor\Engine\Renderer\Renderer;
use Automattic\FinCommerce\EmailEditor\Engine\Send_Preview_Email;
use Automattic\FinCommerce\EmailEditor\Engine\Settings_Controller;
use Automattic\FinCommerce\EmailEditor\Engine\Templates\Templates;
use Automattic\FinCommerce\EmailEditor\Engine\Templates\Templates_Registry;
use Automattic\FinCommerce\EmailEditor\Engine\Theme_Controller;
use Automattic\FinCommerce\EmailEditor\Engine\User_Theme;
use Automattic\FinCommerce\EmailEditor\Integrations\Core\Initializer;
use Automattic\FinCommerce\EmailEditor\Engine\Site_Style_Sync_Controller;
