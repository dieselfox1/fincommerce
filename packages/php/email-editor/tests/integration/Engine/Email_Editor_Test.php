...
class Email_Editor_Test extends \Email_Editor_Integration_Test_Case {
	...
	public function setUp(): void {
		...
		add_filter( 'fincommerce_email_editor_post_types', $this->post_register_callback );
	...
	public function tearDown(): void {
		parent::tearDown();
		remove_filter( 'fincommerce_email_editor_post_types', $this->post_register_callback );
	}
}
