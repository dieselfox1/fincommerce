...
namespace Automattic\FinCommerce\EmailEditor\Engine\Renderer;

use Automattic\FinCommerce\EmailEditor\Engine\Email_Editor;
use Automattic\FinCommerce\EmailEditor\Engine\Templates\Utils;
...
class Renderer_Test extends \Email_Editor_Integration_Test_Case {
	...
	public function setUp(): void {
		...
		$personalization_tags_registry_mock = $this->createMock( \Automattic\FinCommerce\EmailEditor\Engine\PersonalizationTags\Personalization_Tags_Registry::class );
	...
	public function testItInlinesStyles(): void {
		...
		add_filter( 'fincommerce_email_renderer_styles', $styles_callback );
		...
		remove_filter( 'fincommerce_email_renderer_styles', $styles_callback );
	}
	...
	public function testItPreservesPersonalizationTags(): void {
		$registry = new \Automattic\FinCommerce\EmailEditor\Engine\PersonalizationTags\Personalization_Tags_Registry(
			$this->di_container->get( \Automattic\FinCommerce\EmailEditor\Engine\Logger\Email_Editor_Logger::class )
		);
		$registry->register(
			new \Automattic\FinCommerce\EmailEditor\Engine\PersonalizationTags\Personalization_Tag(
				'Customer Username',
		...
		$this->email_post->post_content = '<!-- wp:paragraph --><p><!--[fincommerce/customer-username]--><!--[fincommerce/customer-username default="john"]--></p><!-- /wp:paragraph -->';
		wp_update_post(
			array(
		...
		$this->assertStringContainsString( '<!--[fincommerce/customer-username]-->', $rendered['html'] );
		$this->assertStringContainsString( '<!--[fincommerce/customer-username default="john"]-->', $rendered['html'] );
		$this->assertStringContainsString( '<!--[fincommerce/customer-username]-->', $rendered['text'] );
		$this->assertStringContainsString( '<!--[fincommerce/customer-username default="john"]-->', $rendered['text'] );
	}
