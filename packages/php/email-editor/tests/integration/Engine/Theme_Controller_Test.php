...
class Theme_Controller_Test extends \Email_Editor_Integration_Test_Case {
	...
	public function setUp(): void {
		...
		$post_data   = array(
			'post_title'   => __( 'Custom Email Styles', 'fincommerce' ),
			'post_name'    => 'wp-global-styles-fincommerce-email',
	...
	public function testItCanTranslateColorSlug(): void {
		add_filter( 'fincommerce_email_editor_site_style_sync_enabled', '__return_true' );
