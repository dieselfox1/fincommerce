...
namespace Automattic\FinCommerce\EmailEditor\Tests\Integration\Engine;

use Automattic\FinCommerce\EmailEditor\Engine\Site_Style_Sync_Controller;
use Automattic\FinCommerce\EmailEditor\Tests\Integration\Email_Editor_Integration_Test_Case;
use WP_Theme_JSON;
...
class Site_Style_Sync_Controller_Test extends \Email_Editor_Integration_Test_Case {
	...
	public function test_sync_can_be_disabled_via_filter(): void {
		...
		add_filter( 'fincommerce_email_editor_site_style_sync_enabled', '__return_false' );

		$this->assertFalse( $this->controller->is_sync_enabled() );

		// Clean up.
		remove_filter( 'fincommerce_email_editor_site_style_sync_enabled', '__return_false' );
	}
	...
	public function test_synced_styles_filter_is_applied(): void {
		...
		// Clean up.
		remove_all_filters( 'fincommerce_email_editor_synced_site_styles' );
	}
