...
class TemplatesRegistryTest extends TestCase {
	...
	public function testRegisterAndGetTemplateByName(): void {
		...
		$template->method( 'get_name' )->willReturn( 'fincommerce//email-general' );
		...
		$retrieved_template = $this->registry->get_by_name( 'fincommerce//email-general' );

		$this->assertNotNull( $retrieved_template );
		$this->assertSame( 'fincommerce//email-general', $retrieved_template->get_name() );
	...
	public function testInitializeAppliesFilter(): void {
		...
		add_filter(
			'fincommerce_email_editor_register_templates',
