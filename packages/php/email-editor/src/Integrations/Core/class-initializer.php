...
namespace Automattic\FinCommerce\EmailEditor\Integrations\Core;

use Automattic\FinCommerce\EmailEditor\Engine\Renderer\ContentRenderer\Layout\Flex_Layout_Renderer;
...
use Automattic\FinCommerce\EmailEditor\Integrations\Core\Renderer\Blocks\Button;
use Automattic\FinCommerce\EmailEditor\Integrations\Core\Renderer\Blocks\Buttons;
use Automattic\FinCommerce\EmailEditor\Integrations\Core\Renderer\Blocks\Column;
use Automattic\FinCommerce\EmailEditor\Integrations\Core\Renderer\Blocks\Columns;
use Automattic\FinCommerce\EmailEditor\Integrations\Core\Renderer\Blocks\Fallback;
use Automattic\FinCommerce\EmailEditor\Integrations\Core\Renderer\Blocks\Group;
use Automattic\FinCommerce\EmailEditor\Integrations\Core\Renderer\Blocks\Image;
use Automattic\FinCommerce\EmailEditor\Integrations\Core\Renderer\Blocks\List_Block;
use Automattic\FinCommerce\EmailEditor\Integrations\Core\Renderer\Blocks\List_Item;
use Automattic\FinCommerce\EmailEditor\Integrations\Core\Renderer\Blocks\Quote;
use Automattic\FinCommerce\EmailEditor\Integrations\Core\Renderer\Blocks\Social_Link;
use Automattic\FinCommerce\EmailEditor\Integrations\Core\Renderer\Blocks\Social_Links;
use Automattic\FinCommerce\EmailEditor\Integrations\Core\Renderer\Blocks\Text;
...
class Initializer {
	...
	public function initialize(): void {
		add_filter( 'fincommerce_email_editor_theme_json', array( $this, 'adjust_theme_json' ), 10, 1 );
