...
use Automattic\FinCommerce\EmailEditor\Engine\Renderer\ContentRenderer\Blocks_Registry;

add_action('fincommerce_blocks_renderer_initialized', 'register_my_block_email_renderer');
