...
use Automattic\FinCommerce\EmailEditor\Engine\Renderer\Css_Inliner;
...
class Content_Renderer {
	...
	private function initialize() {
		...
		add_filter( 'fincommerce_email_blocks_renderer_parsed_blocks', array( $this, 'preprocess_parsed_blocks' ) );
	}
	...
	public function block_parser() {
		return 'Automattic\FinCommerce\EmailEditor\Engine\Renderer\ContentRenderer\Blocks_Parser';
	}
	...
	private function reset(): void {
		...
		remove_filter( 'fincommerce_email_blocks_renderer_parsed_blocks', array( $this, 'preprocess_parsed_blocks' ) );
	...
	private function inline_styles( $html, WP_Post $post, $template = null ) {
      ...
      ',
		...
		$styles = '<style>' . wp_strip_all_tags( (string) apply_filters( 'fincommerce_email_content_renderer_styles', $styles, $post ) ) . '</style>';
