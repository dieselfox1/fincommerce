...
class Templates_Registry {
	...
	public function initialize(): void {
		apply_filters( 'fincommerce_email_editor_register_templates', $this );
	}
	 ...
	 * Example: get_by_name( 'fincommerce//email-general' ) will return the instance of Template with identical name.
	 *
