...
class Assets_Manager {
	 ...
	 *
	 * @param string $element_id Optional. The ID of the main container element. Default is 'fincommerce-email-editor'.
	 */
	public function render_email_editor_html( string $element_id = 'fincommerce-email-editor' ): void {
	...
	public function load_editor_assets( $edited_item, string $script_name ): void {
		...
		// See: https://github.com/finpress/finpress/blob/753817d462955eb4e40a89034b7b7c375a1e43f3/wp-admin/edit-form-blocks.php#L116-L120.
		...
		// See: https://github.com/finpress/finpress/blob/753817d462955eb4e40a89034b7b7c375a1e43f3/wp-admin/edit-form-blocks.php#L144C1-L148C3.
		wp_add_inline_script(
			'wp-blocks',
		...
		wp_localize_script(
			$script_name,
			'fincommerceEmailEditor',
			apply_filters( 'fincommerce_email_editor_script_localization_data', $localization_data )
		);
