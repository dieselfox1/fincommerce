...
class Site_Style_Sync_Controller {
	...
	public function sync_site_styles(): array {
		 ...
		 */
		$synced_data = apply_filters( 'fincommerce_email_editor_synced_site_styles', $synced_data, $site_data );
	...
	public function is_sync_enabled(): bool {
		 ...
		 */
		return apply_filters( 'fincommerce_email_editor_site_style_sync_enabled', true );
	}
