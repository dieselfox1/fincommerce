...
namespace Automattic\FinCommerce\EmailEditor\Engine\Patterns;
...
class Patterns {
	...
	private function register_block_pattern_categories(): void {
		$categories = array(
			array(
				'name'        => 'email-contents',
				'label'       => _x( 'Email Contents', 'Block pattern category', 'fincommerce' ),
				'description' => __( 'A collection of email content layouts.', 'fincommerce' ),
			),
		);
