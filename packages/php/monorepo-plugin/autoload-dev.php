...
( function() {
	...
	if ( class_exists( \Automattic\FinCommerce\Autoloader::class, false ) ) {
		// Locate the reference point first - FinCommerce autoloader in our case.
		$reference_point = ( new \ReflectionClass( \Automattic\FinCommerce\Autoloader::class ) )->getFileName();
