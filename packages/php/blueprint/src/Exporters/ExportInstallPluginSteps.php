...
namespace Automattic\FinCommerce\Blueprint\Exporters;
 ...
 *
 * @package Automattic\FinCommerce\Blueprint\Exporters
 */
class ExportInstallPluginSteps implements StepExporter {
	...
	public function export() {
		...
		// @todo temporary fix for JN site -- it includes FinCommerce as a custom plugin
		// since JN sites are using a different slug.
		$exclude = array( 'FinCommerce Beta Tester' );
		$steps   = array();
