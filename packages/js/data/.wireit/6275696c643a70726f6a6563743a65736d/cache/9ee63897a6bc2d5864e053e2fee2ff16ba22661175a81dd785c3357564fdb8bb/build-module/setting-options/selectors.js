 ...
 */
export const getGroup = (state, groupId) => state.groups.find((group) => group.id === groupId);
 ...
 */
export const getSettings = createSelector((state, groupId, options = { includeEdits: false }) => {
 ...
 */
export const getSetting = createSelector((state, groupId, settingId, options = { includeEdits: false }) => {
    const groupSettings = state.settings[groupId];
    if (!groupSettings) {
        return undefined;
    }
 ...
 */
export const getSettingValue = (state, groupId, settingId, options = { includeEdits: false }) => {
 ...
 */
export const isSettingEdited = (state, groupId, settingId) => {
    const groupEdits = state.edits[groupId];
 ...
 * @param {string}        groupId - The ID of the group to get settings for.
 */
export const getEditedSettingIds = createSelector((state, groupId) => {
    const groupEdits = state.edits[groupId];
    if (!groupEdits) {
        return [];
    }
 ...
 */
export const isGroupSaving = (state, groupId) => !!state.isSaving.groups?.[groupId];
/**
 ...
 * @param {string}        settingId - The ID of the setting to check.
 */
export const isSettingSaving = (state, groupId, settingId) => {
 ...
 */
export const getGroupError = (state, groupId) => state.errors[groupId];
/**
 ...
 */
export const getSettingError = (state, groupId, settingId) => {
 ...
 * @param {string}        groupId - The ID of the group to check.
 */
export const hasEditsForGroup = (state, groupId) => {
    const groupEdits = state.edits[groupId];
