...
export const getProfileProgress = (state) => {
...
export const getCoreProfilerCompletedSteps = createSelector((state) => {
    return state.profileProgress || {};
}, (state) => [state.profileProgress]);
export const getMostRecentCoreProfilerStep = createSelector((state) => {
