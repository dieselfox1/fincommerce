...
export type ProductType = 'simple' | 'grouped' | 'external' | 'variable' | 'variation';
export type ProductStatus = 'auto-draft' | 'deleted' | 'draft' | 'pending' | 'private' | 'publish' | 'any' | 'trash' | 'future';
...
export type Product<Status = ProductStatus, Type = ProductType> = Omit<Post, 'status' | 'categories'> & {
...
export declare const productReadOnlyProperties: readonly ["average_rating", "backordered", "backorders_allowed", "date_created", "date_created_gmt", "date_modified", "date_modified_gmt", "generated_slug", "id", "on_sale", "permalink", "permalink_template", "price", "price_html", "purchasable", "rating_count", "related_ids", "shipping_class_id", "shipping_required", "shipping_taxable", "total_sales", "variations"];
...
export type ProductQuery<Status = ProductStatus, Type = ProductType> = BaseQueryParams<keyof Product> & {
