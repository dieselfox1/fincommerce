...
export type SelectorKeysWithActions = 'getActivePlugins' | 'getInstalledPlugins' | 'getRecommendedPlugins' | 'installPlugins' | 'activatePlugins' | 'isJetpackConnected' | 'getJetpackConnectionData' | 'getJetpackConnectUrl' | 'getPaypalOnboardingStatus';
