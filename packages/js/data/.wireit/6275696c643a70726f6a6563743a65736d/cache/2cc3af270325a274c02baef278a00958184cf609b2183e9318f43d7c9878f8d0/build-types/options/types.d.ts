...
import { getOptionsRequestingError, isOptionsUpdating, getOptionsUpdatingError } from './selectors';
export type OptionsSelectors = {
    getOption: <T = string>(option: string) => T;
    getOptionsRequestingError: WPDataSelector<typeof getOptionsRequestingError>;
