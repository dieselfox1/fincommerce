...
export type TaxClassActions = CrudActions<'TaxClass', TaxClass, MutableProperties, 'name'>;
export type TaxClassSelectors = CrudSelectors<'TaxClass', 'TaxClasses', TaxClass, Query, MutableProperties>;
