...
export type Industry = 'clothing_and_accessories' | 'food_and_drink' | 'electronics_and_computers' | 'health_and_beauty' | 'education_and_learning' | 'home_furniture_and_garden' | 'arts_and_crafts' | 'sports_and_recreation' | 'other';
...
/** Types should match the schema in plugins/fincommerce/src/Admin/API/OnboardingProfile.php */
...
export type CoreProfilerStep = 'intro-opt-in' | 'skip-guided-setup' | 'user-profile' | 'business-info' | 'plugins' | 'skip-guided-setup';
export type CoreProfilerCompletedSteps = Record<CoreProfilerStep, {
    completed_at: string;
}>;
