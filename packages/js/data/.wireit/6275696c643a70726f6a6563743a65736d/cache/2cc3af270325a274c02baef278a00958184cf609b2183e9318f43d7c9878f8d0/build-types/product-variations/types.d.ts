...
export type ProductVariation = Omit<Product, 'slug' | 'attributes' | 'images' | 'manage_stock'> & Pick<Product, 'id'> & {
...
export type PartialProductVariation = Partial<ProductVariation> & Pick<ProductVariation, 'id'>;
...
type MutableProperties = Partial<Omit<ProductVariation, ReadOnlyProperties>>;
export type ProductVariationActions = CrudActions<'ProductVariation', ProductVariation, MutableProperties> & CustomActions;
export type ProductVariationSelectors = CrudSelectors<'ProductVariation', 'ProductVariations', ProductVariation, Query, MutableProperties> & CustomSelectors;
...
export type BatchUpdateRequest = {
    ...
    update?: (Pick<ProductVariation, 'id'> & Partial<Omit<ProductVariation, 'id'>>)[];
