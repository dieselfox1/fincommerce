...
/**
 * A simple class to handle deprecated tasks using the fincommerce_admin_onboarding_task_list filter.
 */
export declare class DeprecatedTasks {
    filteredTasks: DeprecatedTaskType[];
    tasks: {
        [key: string]: DeprecatedTaskType[];
    };
    constructor();
    hasDeprecatedTasks(): boolean;
    getPostData(): {
        extended_tasks: {
            title: string;
            content: string;
            ...
            can_view: boolean;
            id: string;
            is_snoozeable: string;
            is_dismissable: boolean;
            is_complete: boolean;
        }[];
    } | null;
    mergeDeprecatedCallbackFunctions(taskLists: TaskListType[]): TaskListType[];
    /**
     ...
     */
    static possiblyPruneTaskData(task: TaskType, keys: (keyof TaskType)[]): Partial<TaskType>;
}
//# sourceMappingURL=deprecated-tasks.d.ts.map