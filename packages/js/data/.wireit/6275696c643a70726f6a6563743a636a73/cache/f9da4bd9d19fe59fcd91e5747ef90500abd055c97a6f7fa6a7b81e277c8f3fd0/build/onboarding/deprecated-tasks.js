...
class DeprecatedTasks {
    ...
    constructor() {
         ...
         *
         * @filter fincommerce_admin_onboarding_task_list
         * @deprecated
         * @param {Array} tasks Array of tasks.
         * @param {Array} query Url query parameters.
         */
        this.filteredTasks = (0, hooks_1.applyFilters)('fincommerce_admin_onboarding_task_list', [], getQuery());
        if (this.filteredTasks && this.filteredTasks.length > 0) {
            (0, deprecated_1.default)('fincommerce_admin_onboarding_task_list', {
                version: '2.10.0',
                alternative: 'TaskLists::add_task()',
                plugin: '@fincommerce/data',
            });
        }
