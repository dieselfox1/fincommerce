...
export type ProductCategoryActions = CrudActions<'ProductCategory', ProductCategory, MutableProperties, 'name'>;
export type ProductCategorySelectors = CrudSelectors<'ProductCategory', 'ProductCategories', ProductCategory, Query, MutableProperties>;
