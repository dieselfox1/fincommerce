export interface ReviewObject {
	...
	// _embedded type definition from test case https://github.com/dieselfox1/fincommerce/blob/63aa382ffb82b0374a4cd1cf5fabf09e6b71043f/plugins/fincommerce-admin/client/homescreen/activity-panel/reviews/test/index.js#L23
	_embedded?: {
		up?: Array< {
			id: number;
			name?: string;
