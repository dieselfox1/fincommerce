...
// [class-wc-rest-setting-options-controller.php](https://github.com/dieselfox1/fincommerce/blob/28926968bdcd2b504e16761a483388f85ee0c151/plugins/fincommerce/includes/rest-api/Controllers/Version3/class-wc-rest-setting-options-controller.php#L158-L248)
type RawSetting = {
	id: string;
	group_id: string;
	label: string;
