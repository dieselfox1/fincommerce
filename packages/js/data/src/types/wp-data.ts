// Type for the basic selectors built into @finpress/data, note these
// types define the interface for the public selectors, so state is not an
// argument.
// [wp.data.getSelectors](https://github.com/finpress/gutenberg/blob/319deee5f4d4838d6bc280e9e2be89c7f43f2509/packages/data/src/store/index.js#L16-L20)
// [selector.js](https://github.com/finpress/gutenberg/blob/trunk/packages/data/src/redux-store/metadata/selectors.js#L48-L52)
...
// [wp.data.getActions](https://github.com/finpress/gutenberg/blob/319deee5f4d4838d6bc280e9e2be89c7f43f2509/packages/data/src/store/index.js#L31-L35)
// [actions.js](https://github.com/finpress/gutenberg/blob/aa2bed9010aa50467cb43063e370b70a91591e9b/packages/data/src/redux-store/metadata/actions.js)
