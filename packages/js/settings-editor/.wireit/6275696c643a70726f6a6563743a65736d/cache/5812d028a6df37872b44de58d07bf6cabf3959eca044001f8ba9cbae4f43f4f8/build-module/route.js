 ...
 */
import { createElement, useEffect, useMemo, useState, useRef, useContext, } from '@wordpress/element';
import { __ } from '@wordpress/i18n';
import { addAction, applyFilters, didFilter, removeAction, } from '@wordpress/hooks';
...
const NotFound = () => {
    return createElement("h1", null, __('Page not found', 'fincommerce'));
};
/**
...
const getNotFoundRoute = (activePage, settingsPages) => ({
    key: activePage,
    areas: {
        sidebar: (createElement(Sidebar, { activePage: activePage, pages: settingsPages, pageTitle: __('Settings', 'fincommerce') })),
        content: createElement(NotFound, null),
        edit: null,
    },
    widths: {
        content: undefined,
...
const getLegacyRoute = (activePage, activeSection, settingsPage, settingsData) => {
    return {
        key: activePage,
        areas: {
            sidebar: (createElement(Sidebar, { activePage: activePage, pages: settingsData.pages, pageTitle: __('Store settings', 'fincommerce') })),
            content: (createElement(LegacyContent, { settingsData: settingsData, settingsPage: settingsPage, activeSection: activeSection })),
            edit: null,
        },
        widths: {
            content: undefined,
...
const getModernPages = () => {
     ...
     */
    return applyFilters(PAGES_FILTER, {});
};
/**
...
export const useActiveRoute = () => {
    ...
    return useMemo(() => {
        ...
        modernRoute.areas.sidebar = (createElement(Sidebar, { activePage: activePage, pages: settingsData.pages, pageTitle: __('Store settings', 'fincommerce') }));
