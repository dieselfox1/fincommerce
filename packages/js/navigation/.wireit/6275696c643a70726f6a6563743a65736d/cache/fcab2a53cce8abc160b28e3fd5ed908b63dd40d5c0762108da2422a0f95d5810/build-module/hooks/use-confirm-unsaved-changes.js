...
export const useConfirmUnsavedChanges = (hasUnsavedChanges, shouldConfirm, 
/**
 ...
 */
message) => {
    const confirmMessage = useMemo(() => message ??
        __('Changes you made may not be saved.', 'fincommerce'), [message]);
