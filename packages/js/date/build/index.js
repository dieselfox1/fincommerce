...
exports.dateValidationMessages = exports.defaultTableDateFormat = exports.weekTicksThreshold = exports.dayTicksThreshold = exports.getPreviousDate = exports.getDateDifferenceInDays = exports.getCurrentDates = exports.getDateParamsFromQuery = exports.appendTimestamp = exports.periods = exports.presetValues = exports.defaultDateTimeFormat = exports.isoDateFormat = void 0;
...
exports.presetValues = [
    { value: 'today', label: (0, i18n_1.__)('Today', 'fincommerce') },
    { value: 'yesterday', label: (0, i18n_1.__)('Yesterday', 'fincommerce') },
    { value: 'week', label: (0, i18n_1.__)('Week to date', 'fincommerce') },
    { value: 'last_week', label: (0, i18n_1.__)('Last week', 'fincommerce') },
    { value: 'month', label: (0, i18n_1.__)('Month to date', 'fincommerce') },
    { value: 'last_month', label: (0, i18n_1.__)('Last month', 'fincommerce') },
    { value: 'quarter', label: (0, i18n_1.__)('Quarter to date', 'fincommerce') },
    { value: 'last_quarter', label: (0, i18n_1.__)('Last quarter', 'fincommerce') },
    { value: 'year', label: (0, i18n_1.__)('Year to date', 'fincommerce') },
    { value: 'last_year', label: (0, i18n_1.__)('Last year', 'fincommerce') },
    { value: 'custom', label: (0, i18n_1.__)('Custom', 'fincommerce') },
];
exports.periods = [
    {
        value: 'previous_period',
        label: (0, i18n_1.__)('Previous period', 'fincommerce'),
    },
    {
        value: 'previous_year',
        label: (0, i18n_1.__)('Previous year', 'fincommerce'),
    },
];
...
function getRangeLabel(after, before) {
    ...
    const fullDateFormat = (0, i18n_1.__)('MMM D, YYYY', 'fincommerce');
    if (isSameDay) {
        ...
        const monthDayFormat = (0, i18n_1.__)('MMM D', 'fincommerce');
...
function getDateFormatsForIntervalD3(interval, ticks = 0) {
    ...
    switch (interval) {
        ...
        case 'week':
            ...
            screenReaderFormat = (0, i18n_1.__)('Week of %B %-d, %Y', 'fincommerce');
            // eslint-disable-next-line @wordpress/i18n-translator-comments
            tooltipLabelFormat = (0, i18n_1.__)('Week of %B %-d, %Y', 'fincommerce');
            break;
        case 'quarter':
        case 'month':
...
function getDateFormatsForIntervalPhp(interval, ticks = 0) {
    ...
    switch (interval) {
        ...
        case 'week':
            ...
            const escapedWeekOfStr = (0, i18n_1.__)('Week of', 'fincommerce').replace(/(\w)/g, '\\$1');
...
function loadLocaleData({ userLocale, weekdaysShort, }) {
    ...
    if (moment_1.default.locale() !== 'en') {
        moment_1.default.updateLocale(userLocale, {
            longDateFormat: {
                L: (0, i18n_1.__)('MM/DD/YYYY', 'fincommerce'),
                LL: (0, i18n_1.__)('MMMM D, YYYY', 'fincommerce'),
                LLL: (0, i18n_1.__)('D MMMM YYYY LT', 'fincommerce'),
                LLLL: (0, i18n_1.__)('dddd, D MMMM YYYY LT', 'fincommerce'),
                LT: (0, i18n_1.__)('HH:mm', 'fincommerce'),
...
exports.dateValidationMessages = {
    invalid: (0, i18n_1.__)('Invalid date', 'fincommerce'),
    future: (0, i18n_1.__)('Select a date in the past', 'fincommerce'),
    startAfterEnd: (0, i18n_1.__)('Start date must be before end date', 'fincommerce'),
    endBeforeStart: (0, i18n_1.__)('Start date must be before end date', 'fincommerce'),
};
/**
