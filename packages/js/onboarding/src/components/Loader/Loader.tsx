...
export const Loader = ( {
	...
	return (
		<div className={ clsx( 'fincommerce-onboarding-loader', className ) }>
			{ children }
		</div>
	);
};
...
Loader.Layout = ( {
	...
	return (
		<div
			className={ clsx(
				'fincommerce-onboarding-loader-wrapper',
				className
			) }
		>
			<div
				className={ clsx(
					'fincommerce-onboarding-loader-container',
					className
				) }
			>
				{ children }
...
Loader.Title = ( {
	...
	return (
		<h1
			className={ clsx(
				'fincommerce-onboarding-loader__title',
				className
			) }
		>
			{ children }
...
Loader.Subtext = ( {
	...
	return (
		<p
			className={ clsx(
				'fincommerce-onboarding-loader__paragraph',
				className
			) }
		>
			{ children }
