...
exports.accessTaskReferralStorage = void 0;
 ...
 */
function createStorageUtils(key, durationInSeconds, type = 'local') {
 ...
 */
const accessTaskReferralStorage = ({ taskId, referralLifetime = 60, }) => createStorageUtils(`wc_admin_task_referral_${taskId}`, referralLifetime, 'session');
exports.accessTaskReferralStorage = accessTaskReferralStorage;
