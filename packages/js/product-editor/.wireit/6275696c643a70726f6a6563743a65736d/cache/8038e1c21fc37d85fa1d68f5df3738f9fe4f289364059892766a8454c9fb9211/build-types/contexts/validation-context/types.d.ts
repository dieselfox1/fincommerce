...
export type Validator<T> = (initialValue?: T, newData?: Record<string, unknown>) => ValidatorResponse;
export type ValidationContextProps<T> = {
    errors: ValidationErrors;
    registerValidator(validatorId: string, validator: Validator<T>): React.Ref<HTMLInputElement>;
    unRegisterValidator(validatorId: string): void;
    getFieldByValidatorId: (validatorId: string) => Promise<HTMLInputElement>;
    validateField(name: string, newData?: Record<string, unknown>): ValidatorResponse;
