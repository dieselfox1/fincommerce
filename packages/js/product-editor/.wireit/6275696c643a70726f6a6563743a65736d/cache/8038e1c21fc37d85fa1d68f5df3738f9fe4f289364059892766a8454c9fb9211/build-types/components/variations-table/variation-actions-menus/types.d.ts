...
export type VariationActionsMenuProps = {
    ...
    onChange(values: PartialProductVariation[] | React.FormEvent, showSuccess?: boolean): void;
...
export type MenuItemProps = Omit<React.ComponentProps<typeof MenuItem>, 'onClick'> & {
    order?: number;
    group?: string;
    supportsMultipleSelection?: boolean;
    onClick?: ({ onChange, onClose, selection, }: {
        [K in 'onChange' | 'onClose' | 'selection']: VariationQuickUpdateSlotProps[K];
    }) => void;
