...
export function BlockFill({ name, slotContainerBlockName, ...props }) {
    const { clientId } = useBlockEditContext();
    const closestAncestorClientId = useSelect((select) => {
    ...
    return (createElement(Fill, { ...props, name: getName(name, closestAncestorClientId) }));
}
