...
export function useVariationSwitcher({ variationId, parentId, parentProductType, }) {
    // eslint-disable-next-line @typescript-eslint/ban-ts-comment
    // @ts-ignore
    const { invalidateResolution } = useDispatch('core');
    const { invalidateResolutionForStoreSelector } = useDispatch(EXPERIMENTAL_PRODUCT_VARIATIONS_STORE_NAME);
    const variationValues = useSelect((select) => {
