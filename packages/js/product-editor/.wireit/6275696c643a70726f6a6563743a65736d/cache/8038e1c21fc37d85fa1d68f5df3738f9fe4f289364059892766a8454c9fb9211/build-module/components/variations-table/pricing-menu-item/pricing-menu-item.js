...
export function PricingMenuItem({ selection, onChange, onClose, supportsMultipleSelection = false, }) {
    ...
    return (createElement(Dropdown, { popoverProps: {
            placement: 'right-start',
                ...
                onToggle();
            }, "aria-expanded": isOpen, icon: chevronRight, iconPosition: "right" }, __('Pricing', 'fincommerce'))), renderContent: () => (createElement("div", { className: "components-dropdown-menu__menu" },
            createElement(MenuGroup, { label: __('Regular price', 'fincommerce') },
                ...
                createElement(MenuItem, { onClick: () => {
                        ...
                        handlePrompt({
                            message: __('Enter a value (fixed or %)', 'fincommerce'),
                            onOk(value) {
                        ...
                        onClose();
                    } }, __('Increase regular price', 'fincommerce')),
                createElement(MenuItem, { onClick: () => {
                        recordEvent('product_variations_menu_pricing_select', {
                            source: TRACKS_SOURCE,
                        ...
                        onClose();
                    } }, __('Decrease regular price', 'fincommerce'))),
            createElement(MenuGroup, { label: __('Sale price', 'fincommerce') },
                createElement(MenuItem, { onClick: () => {
                        recordEvent('product_variations_menu_pricing_select', {
                            source: TRACKS_SOURCE,
                ...
                createElement(MenuItem, { onClick: () => {
                        ...
                        onClose();
                    } }, __('Increase sale price', 'fincommerce')),
                createElement(MenuItem, { onClick: () => {
                        recordEvent('product_variations_menu_pricing_select', {
                            source: TRACKS_SOURCE,
                        ...
                        onClose();
                    } }, __('Decrease sale price', 'fincommerce')),
                createElement(MenuItem, { onClick: () => {
                        recordEvent('product_variations_menu_pricing_select', {
                            source: TRACKS_SOURCE,
                        ...
                        handlePrompt({
                            message: __('Sale start date (YYYY-MM-DD format or leave blank)', 'fincommerce'),
                            onOk(value) {
                                recordEvent('product_variations_menu_pricing_update', {
                                    source: TRACKS_SOURCE,
                                    action: 'sale_price_schedule',
                        ...
                        handlePrompt({
                            message: __('Sale end date (YYYY-MM-DD format or leave blank)', 'fincommerce'),
                            onOk(value) {
                                recordEvent('product_variations_menu_pricing_update', {
                                    source: TRACKS_SOURCE,
                                    action: 'sale_price_schedule',
                        ...
                        onClose();
                    } }, __('Schedule sale', 'fincommerce'))),
            createElement(VariationQuickUpdateMenuItem.Slot, { group: 'pricing', onChange: onChange, onClose: onClose, selection: selection, supportsMultipleSelection: supportsMultipleSelection }))) }));
}
