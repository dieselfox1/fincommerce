export const PRODUCT_EDITOR_SHOW_FEEDBACK_BAR_OPTION_NAME = 'fincommerce_product_editor_show_feedback_bar';
export const PRODUCT_EDITOR_FEEDBACK_CES_ACTION = 'product_editor';
export const SINGLE_VARIATION_NOTICE_DISMISSED_OPTION = 'fincommerce_single_variation_notice_dismissed';
export const SHOW_PREPUBLISH_CHECKS_ENABLED_OPTION_NAME = 'fincommerce_show_prepublish_checks_enabled';
...
export const ADD_NEW_SHIPPING_CLASS_OPTION_VALUE = '__ADD_NEW_SHIPPING_CLASS_OPTION__';
...
export const HEADER_PINNED_ITEMS_SCOPE = 'fincommerce/product-editor';
/**
