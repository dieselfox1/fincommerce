...
export function usePreview({ productStatus, productType = 'product', disabled, onClick, onSaveSuccess, onSaveError, ...props }) {
    ...
    return {
        'aria-label': __('Preview in new tab', 'fincommerce'),
        children: __('Preview', 'fincommerce'),
        target: '_blank',
        ...props,
        ref(element) {
