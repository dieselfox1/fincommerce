...
export function MediaLibrary({ allowedTypes, modalTitle, modalButtonText, multiple, className, uploaderParams, children, onSelect, }) {
    const mediaLibraryModal = useMemo(function createMediaLibraryModal() {
    ...
    useEffect(() => function unmountMediaLibraryModal() {
