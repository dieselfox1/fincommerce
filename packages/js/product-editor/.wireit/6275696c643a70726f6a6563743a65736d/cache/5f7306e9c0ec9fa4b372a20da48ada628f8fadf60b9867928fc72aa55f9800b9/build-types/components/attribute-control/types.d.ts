 ...
 */
import { ProductAttributeTerm, ProductProductAttribute } from '@fincommerce/data';
/**
...
export type AttributeControlProps = {
    ...
    renderCustomEmptyState?: (props: AttributeControlEmptyStateProps) => undefined | JSX.Element;
...
export type AttributeTableRowProps = {
    ...
    onAttributeSelect: (attribute: AttributesComboboxControlItem, index: number) => void;
    onTermsSelect: (terms: ProductAttributeTerm[] | string[], index: number, attribute: EnhancedProductAttribute) => void;
