...
function ProductListBlockEdit({ attributes, context: { postType }, }) {
    ...
    return ((0, element_1.createElement)("div", { ...blockProps },
        (0, element_1.createElement)(block_slot_fill_1.SectionActions, null,
            !isLoading && groupedProducts.length > 0 && ((0, element_1.createElement)(components_1.Button, { onClick: handleReorderProductsButtonClick, variant: "tertiary" }, (0, i18n_1.__)('Reorder', 'fincommerce'))),
            (0, element_1.createElement)(components_1.Button, { onClick: handleAddProductsButtonClick, variant: "secondary" }, (0, i18n_1.__)('Add products', 'fincommerce'))),
        (0, element_1.createElement)("div", { className: "wp-block-fincommerce-product-list-field__body" },
            !isLoading && groupedProducts.length === 0 && ((0, element_1.createElement)(advice_card_1.AdviceCard, { tip: (0, i18n_1.__)('Tip: Group together items that have a clear relationship or compliment each other well, e.g., garment bundles, camera kits, or skincare product sets.', 'fincommerce'), isDismissible: false },
            ...
            !isLoading && groupedProducts.length > 0 && ((0, element_1.createElement)("div", { className: "wp-block-fincommerce-product-list-field__table", role: "table" },
                (0, element_1.createElement)("div", { className: "wp-block-fincommerce-product-list-field__table-header" },
                    (0, element_1.createElement)("div", { className: "wp-block-fincommerce-product-list-field__table-row", role: "rowheader" },
                        (0, element_1.createElement)("div", { className: "wp-block-fincommerce-product-list-field__table-header-column", role: "columnheader" }, (0, i18n_1.__)('Product', 'fincommerce')),
                        (0, element_1.createElement)("div", { className: "wp-block-fincommerce-product-list-field__table-header-column", role: "columnheader" }, (0, i18n_1.__)('Price', 'fincommerce')),
                        (0, element_1.createElement)("div", { className: "wp-block-fincommerce-product-list-field__table-header-column", role: "columnheader" }, (0, i18n_1.__)('Stock', 'fincommerce')),
                        (0, element_1.createElement)("div", { className: "wp-block-fincommerce-product-list-field__table-header-column", role: "columnheader" }))),
                (0, element_1.createElement)("div", { className: "wp-block-fincommerce-product-list-field__table-body", role: "rowgroup" }, groupedProducts.map((product) => ((0, element_1.createElement)("div", { key: product.id, className: "wp-block-fincommerce-product-list-field__table-row", role: "row" },
                    (0, element_1.createElement)("div", { className: "wp-block-fincommerce-product-list-field__table-cell", role: "cell" },
                        (0, element_1.createElement)("div", { className: "wp-block-fincommerce-product-list-field__product-image", style: (0, add_products_modal_1.getProductImageStyle)(product) }),
                        (0, element_1.createElement)("div", { className: "wp-block-fincommerce-product-list-field__product-info" },
                            (0, element_1.createElement)("div", { className: "wp-block-fincommerce-product-list-field__product-name" },
                            ...
                            (0, element_1.createElement)("div", { className: "wp-block-fincommerce-product-list-field__product-sku" }, product.sku))),
                    (0, element_1.createElement)("div", { className: "wp-block-fincommerce-product-list-field__table-cell", role: "cell" },
                    ...
                    (0, element_1.createElement)("div", { className: "wp-block-fincommerce-product-list-field__table-cell", role: "cell" },
                        (0, element_1.createElement)("span", { className: (0, clsx_1.default)('fincommerce-product-variations__status-dot', (0, utils_1.getProductStockStatusClass)(product)) }, "\u25CF"),
                        (0, element_1.createElement)("span", null, (0, utils_1.getProductStockStatus)(product))),
                    (0, element_1.createElement)("div", { className: "wp-block-fincommerce-product-list-field__table-cell", role: "cell" },
                        (0, element_1.createElement)(components_1.Button, { variant: "tertiary", icon: icons_1.external, "aria-label": (0, i18n_1.__)('Preview the product', 'fincommerce'), href: product.permalink, target: "_blank" }),
                        (0, element_1.createElement)(components_1.Button, { type: "button", variant: "tertiary", icon: icons_1.closeSmall, "aria-label": (0, i18n_1.__)('Remove product', 'fincommerce'), onClick: removeProductHandler(product) }))))))))),
