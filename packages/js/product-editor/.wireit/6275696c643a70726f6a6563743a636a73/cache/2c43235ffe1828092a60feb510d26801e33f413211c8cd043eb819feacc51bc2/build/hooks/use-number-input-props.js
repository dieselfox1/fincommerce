...
exports.useNumberInputProps = void 0;
/**
...
const useNumberInputProps = ({ value, onChange, onFocus, onKeyDown, min, max, }) => {
    const { formatNumber, parseNumber } = (0, use_product_helper_1.useProductHelper)();
...
exports.useNumberInputProps = useNumberInputProps;
