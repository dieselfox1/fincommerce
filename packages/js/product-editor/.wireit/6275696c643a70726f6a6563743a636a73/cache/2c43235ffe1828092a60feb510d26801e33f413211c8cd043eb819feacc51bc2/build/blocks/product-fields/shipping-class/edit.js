...
exports.DEFAULT_SHIPPING_CLASS_OPTIONS = [
    { value: '', label: (0, i18n_1.__)('No shipping class', 'fincommerce') },
    {
        value: constants_1.ADD_NEW_SHIPPING_CLASS_OPTION_VALUE,
        label: (0, i18n_1.__)('Add new shipping class', 'fincommerce'),
    },
];
...
function Edit({ attributes, context: { postType, isInSelectedTab }, }) {
    ...
    function handleShippingClassServerError(error) {
        let message = (0, i18n_1.__)('We couldn’t add this shipping class. Try again in a few seconds.', 'fincommerce');
        if (error.code === 'term_exists') {
            message = (0, i18n_1.__)('A shipping class with that slug already exists.', 'fincommerce');
        }
    ...
    const shippingClassControlId = (0, compose_1.useInstanceId)(components_2.BaseControl, 'wp-block-fincommerce-product-shipping-class-field');
        ...
        (0, element_1.createElement)("div", { className: "wp-block-columns" },
            (0, element_1.createElement)("div", { className: "wp-block-column" },
                (0, element_1.createElement)(components_2.SelectControl, { id: shippingClassControlId, name: "shipping_class", value: shippingClass, onChange: (value) => {
                    ...
                    }, label: (0, i18n_1.__)('Shipping class', 'fincommerce'), options: [
                        ...exports.DEFAULT_SHIPPING_CLASS_OPTIONS,
                        ...mapShippingClassToSelectOption(shippingClasses ?? []),
                    ], disabled: attributes.disabled || virtual, help: (0, element_1.createInterpolateElement)((0, i18n_1.__)('Manage shipping classes and rates in <Link>global settings</Link>.', 'fincommerce'), {
