...
function TextAreaBlockEdit({ attributes, setAttributes, context: { postType }, }) {
    ...
    const contentId = (0, compose_1.useInstanceId)(TextAreaBlockEdit, 'wp-block-fincommerce-product-content-field__content');
    const labelId = contentId.toString() + '__label';
    // `property` attribute is required.
    if (!property) {
        throw new Error((0, i18n_1.__)('Property attribute is required.', 'fincommerce'));
    }
