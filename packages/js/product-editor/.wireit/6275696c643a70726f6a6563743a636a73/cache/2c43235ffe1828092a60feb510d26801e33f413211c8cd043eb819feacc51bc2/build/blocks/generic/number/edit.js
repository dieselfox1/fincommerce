    ...
    const { error, validate } = (0, validation_context_1.useValidation)(property, async function validator() {
        if (typeof min === 'number' &&
            ...
            return {
                ...
                (0, i18n_1.__)('Value must be greater than or equal to %d', 'fincommerce'), min),
            };
        }
        if (typeof max === 'number' &&
            ...
            return {
                message: (0, i18n_1.sprintf)(
                // translators: %d is the minimum value of the number input.
                (0, i18n_1.__)('Value must be less than or equal to %d', 'fincommerce'), min),
            };
        }
        if (required && !value) {
            return {
                message: (0, i18n_1.__)('This field is required.', 'fincommerce'),
            };
        }
    }, [value]);
