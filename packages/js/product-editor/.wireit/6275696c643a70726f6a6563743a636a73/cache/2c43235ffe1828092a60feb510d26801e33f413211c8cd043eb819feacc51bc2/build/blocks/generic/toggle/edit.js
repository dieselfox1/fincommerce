...
function Edit({ attributes, context: { postType }, }) {
    ...
    if (attributes?.help) {
        help = (0, element_1.createElement)('div', {
            dangerouslySetInnerHTML: {
                __html: (0, sanitize_html_1.sanitizeHTML)(attributes.help)?.__html,
            },
        });
    }
    /*
    ...
    if (attributes?.checkedHelp && isChecked()) {
        help = (0, element_1.createElement)('div', {
            dangerouslySetInnerHTML: {
                __html: (0, sanitize_html_1.sanitizeHTML)(attributes.checkedHelp)?.__html,
            },
        });
    }
    /*
    ...
    if (attributes?.uncheckedHelp && !isChecked()) {
        help = (0, element_1.createElement)('div', {
            dangerouslySetInnerHTML: {
                __html: (0, sanitize_html_1.sanitizeHTML)(attributes.uncheckedHelp)?.__html,
            },
        });
    }
    return ((0, element_1.createElement)("div", { ...blockProps },
        ...
        disabled && ((0, element_1.createElement)("p", { className: "wp-block-fincommerce-product-toggle__disable-copy", dangerouslySetInnerHTML: (0, sanitize_html_1.sanitizeHTML)(disabledCopy) }))));
}
