...
function DownloadBlockEdit({ attributes, context: { postType }, }) {
    ...
    function handleFileUpload(files) {
        ...
        if (newFiles.length !== files.length) {
            createErrorNotice(files.length === 1
                ? (0, i18n_1.__)('This file has already been added', 'fincommerce')
                : (0, i18n_1.__)('Some of these files have already been added', 'fincommerce'));
        }
        if (newFiles.length) {
    ...
    const handleLinkError = function (error) {
        createErrorNotice((0, i18n_1.sprintf)(
        /* translators: %1$s is a line break, %2$s is the detailed error message */
        (0, i18n_1.__)('Error linking file:%1$s%2$s', 'fincommerce'), '\n', error));
    };
    ...
    return ((0, element_1.createElement)("div", { ...blockProps },
        (0, element_1.createElement)(block_slot_fill_1.SectionActions, null,
            Boolean(downloads.length) && ((0, element_1.createElement)(components_1.Button, { variant: "tertiary", onClick: handleManageLimitsClick }, (0, i18n_1.__)('Manage limits', 'fincommerce'))),
        ...
        (0, element_1.createElement)("div", { className: "wp-block-fincommerce-product-downloads-field__body" },
            (0, element_1.createElement)(components_2.MediaUploader, { label: !Boolean(downloads.length) ? ((0, element_1.createElement)("div", { className: "wp-block-fincommerce-product-downloads-field__drop-zone-content" },
                    (0, element_1.createElement)(upload_image_1.UploadImage, null),
                    (0, element_1.createElement)("p", { className: "wp-block-fincommerce-product-downloads-field__drop-zone-label" }, (0, element_1.createInterpolateElement)((0, i18n_1.__)('Supported file types: <Types /> and more. <link>View all</link>', 'fincommerce'), {
            ...
            Boolean(downloads.length) && ((0, element_1.createElement)(components_2.Sortable, { className: "wp-block-fincommerce-product-downloads-field__table" }, downloads.map((download) => {
                const nameFromUrl = getFileName(download.file);
                const isUploading = download.file.startsWith('blob');
                return ((0, element_1.createElement)(components_2.ListItem, { key: download.file, className: "wp-block-fincommerce-product-downloads-field__table-row" },
                    (0, element_1.createElement)("div", { className: "wp-block-fincommerce-product-downloads-field__table-filename" },
                        (0, element_1.createElement)("span", null, download.name),
                        download.name !== nameFromUrl && ((0, element_1.createElement)("span", { className: "wp-block-fincommerce-product-downloads-field__table-filename-description" }, nameFromUrl))),
                    (0, element_1.createElement)("div", { className: "wp-block-fincommerce-product-downloads-field__table-actions" },
                        isUploading && ((0, element_1.createElement)(components_1.Spinner, { "aria-label": (0, i18n_1.__)('Uploading file', 'fincommerce') })),
                        !isUploading && ((0, element_1.createElement)(components_1.Button, { onClick: editHandler(download), variant: "tertiary" }, (0, i18n_1.__)('Edit', 'fincommerce'))),
                        (0, element_1.createElement)(components_1.Button, { icon: icons_1.closeSmall, label: (0, i18n_1.__)('Remove file', 'fincommerce'), disabled: isUploading, onClick: removeHandler(download) }))));
            })))),
