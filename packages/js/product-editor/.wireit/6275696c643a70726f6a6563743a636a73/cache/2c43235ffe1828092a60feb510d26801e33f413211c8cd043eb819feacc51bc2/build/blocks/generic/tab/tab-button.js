...
function TabButton({ children, className, id, order = exports.DEFAULT_TAB_ORDER, selected = false, }) {
    const classes = (0, clsx_1.default)('wp-block-fincommerce-product-tab__button', className, { 'is-selected': selected });
    return ((0, element_1.createElement)(components_1.Fill, { name: constants_1.TABS_SLOT_NAME }, (fillProps) => {
        ...
        return ((0, element_1.createElement)(OrderedWrapper, { order: order },
            (0, element_1.createElement)(components_1.Button, { key: id, className: classes, onClick: () => onClick(id), id: `fincommerce-product-tab__${id}`, "aria-controls": `fincommerce-product-tab__${id}-content`, "aria-selected": selected, tabIndex: selected ? undefined : -1, role: "tab" }, children)));
    }));
}
