...
function Edit({ attributes, clientId, context, }) {
    ...
    const salePriceId = (0, compose_1.useInstanceId)(components_1.BaseControl, 'wp-block-fincommerce-product-sale-price-field');
    const { ref: salePriceRef, error: salePriceValidationError, validate: validateSalePrice, } = (0, validation_context_1.useValidation)(`sale-price-${clientId}`, async function salePriceValidator() {
        if (salePrice) {
            if (Number.parseFloat(salePrice) < 0) {
                return {
                    message: (0, i18n_1.__)('Sale price must be greater than or equals to zero.', 'fincommerce'),
                };
            }
            ...
            if (!listPrice ||
                ...
                return {
                    message: (0, i18n_1.__)('Sale price must be lower than the regular price.', 'fincommerce'),
                };
            }
        }
