...
async function getProductsBySearchValue(searchValue = '', excludedIds = []) {
    return (0, data_1.resolveSelect)(data_2.productsStore).getProducts({
        search: searchValue,
        orderby: 'title',
        order: 'asc',
        per_page: 5,
...
function LinkedProductListBlockEdit({ attributes, context: { postType, isInSelectedTab }, }) {
    ...
    return ((0, element_1.createElement)("div", { ...blockProps },
        (0, element_1.createElement)(block_slot_fill_1.SectionActions, null,
            (0, element_1.createElement)(components_1.Button, { variant: "tertiary", icon: icons_1.reusableBlock, onClick: chooseProductsForMe, isBusy: isChoosingProducts, disabled: isChoosingProducts }, (0, i18n_1.__)('Choose products for me', 'fincommerce'))),
        (0, element_1.createElement)("div", { className: "wp-block-fincommerce-product-linked-list-field__form-group-content" },
        ...
        !state.isLoading && state.linkedProducts.length === 0 && ((0, element_1.createElement)(advice_card_1.AdviceCard, { tip: emptyState.tip, dismissPreferenceId: `fincommerce-product-${property}-advice-card-dismissed`, isDismissible: emptyState.isDismissible, onDismiss: handleAdviceCardDismiss },
