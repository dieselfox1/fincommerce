...
function SectionDescriptionBlockEdit({ attributes, }) {
    const { content } = attributes;
    const blockProps = (0, block_templates_1.useWooBlockProps)(attributes);
    return ((0, element_1.createElement)(block_slot_fill_1.BlockFill, { ...blockProps, name: "section-description", slotContainerBlockName: "fincommerce/product-section" },
