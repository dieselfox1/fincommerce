...
function SubsectionDescriptionBlockEdit({ attributes, }) {
    ...
    return ((0, element_1.createElement)(block_slot_fill_1.BlockFill, { ...blockProps, name: "section-description", slotContainerBlockName: "fincommerce/product-subsection" },
