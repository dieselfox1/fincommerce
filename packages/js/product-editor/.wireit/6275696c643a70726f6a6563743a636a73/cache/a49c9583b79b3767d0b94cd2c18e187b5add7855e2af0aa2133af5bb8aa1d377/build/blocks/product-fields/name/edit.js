...
function NameBlockEdit({ attributes, clientId, }) {
    ...
    const { ref: nameRef, error: nameValidationError, validate: validateName, } = (0, validation_context_1.useValidation)('name', async function nameValidator() {
        if (!name || name === utils_1.AUTO_DRAFT_NAME) {
            return {
                message: (0, i18n_1.__)('Product name is required.', 'fincommerce'),
            };
        }
        if (name.length > 120) {
            return {
                message: (0, i18n_1.__)('Please enter a product name shorter than 120 characters.', 'fincommerce'),
            };
        }
    }, [name]);
    const setSkuIfEmpty = () => {
    ...
    const help = nameValidationError ??
        (productId &&
            ...
            permalinkPrefix && ((0, element_1.createElement)("span", { className: "fincommerce-product-form__secondary-text product-details-section__product-link" },
    ...
    function renderFeaturedSuffix() {
        const markedText = (0, i18n_1.__)('Mark as featured', 'fincommerce');
        const unmarkedText = (0, i18n_1.__)('Unmark as featured', 'fincommerce');
    ...
    return ((0, element_1.createElement)(element_1.Fragment, null,
        (0, element_1.createElement)("div", { ...blockProps },
            (0, element_1.createElement)(components_1.BaseControl, { id: nameControlId, label: (0, element_1.createElement)(label_1.Label, { label: (0, i18n_1.__)('Name', 'fincommerce'), required: true }), className: (0, clsx_1.default)({
                ...
                (0, element_1.createElement)(components_1.__experimentalInputControl, { id: nameControlId, ref: nameRef, name: "name", 
                    ...
                    autoFocus: attributes.autoFocus, placeholder: (0, i18n_1.__)('e.g. 12 oz Coffee Mug', 'fincommerce'), onChange: (nextValue) => {
                        setName(nextValue ?? '');
