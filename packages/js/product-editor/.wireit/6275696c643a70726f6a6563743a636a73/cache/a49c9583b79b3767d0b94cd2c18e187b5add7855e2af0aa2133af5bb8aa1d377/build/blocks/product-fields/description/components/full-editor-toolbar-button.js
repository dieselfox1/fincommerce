...
function FullEditorToolbarButton({ label = (0, i18n_1.__)('Edit Product description', 'fincommerce'), text = (0, i18n_1.__)('Full editor', 'fincommerce'), }) {
    ...
    return ((0, element_1.createElement)(components_1.ToolbarButton, { label: label, onClick: () => {
            if (isGutenbergVersionWithCrashInFullEditor()) {
                if (shouldForceFullEditor()) {
                    ...
                    alert((0, i18n_1.__)('The version of the Gutenberg plugin installed causes a crash in the full editor. You are proceeding at your own risk and may experience crashes.', 'fincommerce'));
                }
                else {
                    // eslint-disable-next-line no-alert
                    alert((0, i18n_1.__)('The version of the Gutenberg plugin installed causes a crash in the full editor. To prevent this, the full editor has been disabled.', 'fincommerce'));
                    return;
                }
            }
