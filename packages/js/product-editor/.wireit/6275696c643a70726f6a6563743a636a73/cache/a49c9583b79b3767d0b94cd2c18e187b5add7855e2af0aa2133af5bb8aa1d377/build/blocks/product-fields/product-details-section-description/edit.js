...
function ProductDetailsSectionDescriptionBlockEdit({ attributes, clientId, context: { selectedTab }, }) {
    ...
    function menuItemClickHandler(productTemplate, onClose) {
        return async function handleMenuItemClick() {
            try {
                ...
                createSuccessNotice((0, i18n_1.__)('Product type changed.', 'fincommerce'));
    ...
    return ((0, element_1.createElement)(block_slot_fill_1.BlockFill, { name: "section-description", slotContainerBlockName: "fincommerce/product-section" },
        (0, element_1.createElement)("div", { ...blockProps },
            ...
            (0, i18n_1.__)('This is a <ProductTemplate />.', 'fincommerce'), {
            ...
            (0, element_1.createElement)(components_1.Dropdown, { focusOnMount: true, popoverProps: {
                    ...
                    (0, element_1.createElement)("span", null, (0, i18n_1.__)('Change product type', 'fincommerce')))), renderContent: ({ onClose }) => ((0, element_1.createElement)("div", { className: "wp-block-fincommerce-product-details-section-description__dropdown components-dropdown-menu__menu" },
                    ...
                    unsupportedProductTemplates.length > 0 && ((0, element_1.createElement)(components_1.MenuGroup, null,
                        (0, element_1.createElement)(components_1.Dropdown, { popoverProps: {
                                ...
                                (0, element_1.createElement)("span", null, (0, i18n_1.__)('More', 'fincommerce')))), renderContent: () => ((0, element_1.createElement)("div", { className: "wp-block-fincommerce-product-details-section-description__dropdown components-dropdown-menu__menu" },
                                (0, element_1.createElement)(components_1.MenuGroup, null, unsupportedProductTemplates.map(getMenuItem(onClose))))) }))))) }),
            Boolean(unsupportedProductTemplate) && ((0, element_1.createElement)(components_1.Modal, { title: (0, i18n_1.__)('Change product type?', 'fincommerce'), className: "wp-block-fincommerce-product-details-section-description__modal", onRequestClose: () => {
                    setUnsupportedProductTemplate(undefined);
                } },
                (0, element_1.createElement)("p", null,
                    (0, element_1.createElement)("b", null, (0, i18n_1.__)('This product type isn’t supported by the updated product editing experience yet.', 'fincommerce'))),
                (0, element_1.createElement)("p", null, (0, i18n_1.__)('You’ll be taken to the classic editing screen that isn’t optimized for commerce but offers advanced functionality and supports all extensions.', 'fincommerce')),
                (0, element_1.createElement)("div", { className: "wp-block-fincommerce-product-details-section-description__modal-actions" },
                    ...
                    (0, element_1.createElement)(components_1.Button, { variant: "primary", isBusy: isSaving, "aria-disabled": isSaving, onClick: handleModalChangeClick }, (0, i18n_1.__)('Change', 'fincommerce'))))))));
}
