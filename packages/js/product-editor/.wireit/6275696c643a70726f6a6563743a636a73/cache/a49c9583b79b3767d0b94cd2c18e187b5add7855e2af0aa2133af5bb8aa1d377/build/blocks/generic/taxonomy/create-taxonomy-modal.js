...
const CreateTaxonomyModal = ({ onCancel, onCreate, initialName, slug, hierarchical, dialogNameHelpText, parentTaxonomyText, title, }) => {
    ...
    const onSave = async () => {
        ...
        try {
            ...
            if (e.message) {
                ...
                setErrorMessage((0, i18n_1.__)(`Failed to create taxonomy`, 'fincommerce'));
                throw e;
            }
        }
    };
    ...
    return ((0, element_1.createElement)(components_1.Modal, { title: title, onRequestClose: onCancel, className: "fincommerce-create-new-taxonomy-modal" },
        (0, element_1.createElement)("div", { className: "fincommerce-create-new-taxonomy-modal__wrapper" },
            (0, element_1.createElement)(components_1.BaseControl, { id: id, label: (0, i18n_1.__)('Name', 'fincommerce'), help: errorMessage || dialogNameHelpText, className: (0, clsx_1.default)({
            ...
            hierarchical && ((0, element_1.createElement)(components_2.__experimentalSelectTreeControl, { isLoading: isResolving, label: (0, element_1.createInterpolateElement)(`${parentTaxonomyText ||
                    (0, i18n_1.__)('Parent', 'fincommerce')} <optional/>`, {
                    optional: ((0, element_1.createElement)("span", { className: "fincommerce-create-new-taxonomy-modal__optional" }, (0, i18n_1.__)('(optional)', 'fincommerce'))),
            ...
            (0, element_1.createElement)("div", { className: "fincommerce-create-new-taxonomy-modal__buttons" },
                (0, element_1.createElement)(components_1.Button, { variant: "tertiary", onClick: onCancel, disabled: isCreating }, (0, i18n_1.__)('Cancel', 'fincommerce')),
                (0, element_1.createElement)(components_1.Button, { variant: "primary", disabled: name.length === 0 || isCreating, isBusy: isCreating, onClick: onSave }, (0, i18n_1.__)('Create', 'fincommerce'))))));
};
