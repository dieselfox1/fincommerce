...
import { trash, pages, drafts, published, scheduled, notAllowed, } from '@wordpress/icons';
/**
 * Internal dependencies
 */
import { LAYOUT_LIST, LAYOUT_TABLE, LAYOUT_GRID, OPERATOR_IS, } from '../constants';
...
export function useDefaultViews({ postType }) {
    ...
    return useMemo(() => {
        return [
            {
                title: labels?.all_items || __('All items', 'fincommerce'),
                slug: 'all',
                icon: pages,
                view: { ...DEFAULT_POST_BASE },
            },
            {
                title: __('Published', 'fincommerce'),
                slug: 'published',
                icon: published,
                view: {
                    ...DEFAULT_POST_BASE,
            ...
            {
                title: __('Scheduled', 'fincommerce'),
                slug: 'future',
                icon: scheduled,
                view: {
                    ...DEFAULT_POST_BASE,
