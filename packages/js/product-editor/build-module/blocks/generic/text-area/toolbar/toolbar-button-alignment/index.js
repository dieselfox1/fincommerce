...
export default function AlignmentToolbarButton({ align, setAlignment, }) {
    return (createElement(AlignmentControl, { alignmentControls: ALIGNMENT_CONTROLS, value: align, onChange: setAlignment }));
}
