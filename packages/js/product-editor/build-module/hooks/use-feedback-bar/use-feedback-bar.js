...
export const useFeedbackBar = () => {
    ...
    const { shouldShowFeedbackBar } = useSelect((select) => {
        ...
        const showFeedbackBarOption = getOption(PRODUCT_EDITOR_SHOW_FEEDBACK_BAR_OPTION_NAME);
    ...
    const getOptions = async () => {
        ...
        const showFeedbackBarOption = (await getOption(PRODUCT_EDITOR_SHOW_FEEDBACK_BAR_OPTION_NAME));
        return {
