...
export function ResizableEditor({ enableResizing, height, children, }) {
    ...
    , { 
        ...
        resizeRatio: 2, handleComponent: {
            left: (createElement(ResizeHandle, { direction: "left", resizeWidthBy: resizeWidthBy })),
            right: (createElement(ResizeHandle, { direction: "right", resizeWidthBy: resizeWidthBy })),
