...
export function AddImageMenuItem({ selection, onChange, onClose, }) {
    ...
    return (createElement(MediaUpload, { onSelect: handleMediaUploadSelect, modalClass: MODAL_CLASS_NAME, allowedTypes: DEFAULT_ALLOWED_MEDIA_TYPES, 
        // eslint-disable-next-line @typescript-eslint/ban-ts-comment
        // @ts-ignore disabled prop exists
        mode: 'upload', multiple: false, render: ({ open }) => (createElement(MenuItem, { onClick: uploadFilesClickHandler(open) }, __('Add image', 'fincommerce'))) }));
}
