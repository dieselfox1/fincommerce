...
function useDraggable({ onSort }) {
    const dragIndexRef = (0, element_1.useRef)(-1);
    const dropIndexRef = (0, element_1.useRef)(-1);
    const draggableElementsRef = (0, element_1.useRef)([]);
    ...
    function onDragEnter(event) {
        ...
        const { draggable, index } = (0, utils_1.findDraggableIndex)(draggableElementsRef.current, element);
    ...
    function onDrop(event) {
        ...
        if (dragIndexRef.current !== -1 &&
            ...
            onSort((items) => (0, utils_1.sort)(items, drapIndex, dropIndex + Number(drapIndex < dropIndex)));
        }
