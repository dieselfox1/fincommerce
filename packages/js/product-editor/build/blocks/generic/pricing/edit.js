...
function Edit({ attributes, context: { postType }, }) {
    ...
    const { property, label = (0, i18n_1.__)('Price', 'fincommerce'), help, disabled, tooltip, } = attributes;
    ...
    const interpolatedHelp = help
        ...
        : null;
    const priceId = (0, compose_1.useInstanceId)(components_2.BaseControl, 'wp-block-fincommerce-product-pricing-field');
