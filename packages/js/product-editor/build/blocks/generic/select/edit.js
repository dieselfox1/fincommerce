...
function Edit({ attributes, context: { postType }, }) {
    ...
    if (Array.isArray(value)) {
        return ((0, element_1.createElement)("div", { ...blockProps },
            (0, element_1.createElement)(components_1.SelectControl, { value: value, disabled: disabled, label: (0, element_1.createElement)(label_1.Label, { label: label, note: note, tooltip: tooltip }), onChange: setValue, help: renderHelp(), options: options, multiple: multiple })));
    }
    return ((0, element_1.createElement)("div", { ...blockProps },
        (0, element_1.createElement)(components_1.SelectControl, { value: value, disabled: disabled, label: (0, element_1.createElement)(label_1.Label, { label: label, note: note, tooltip: tooltip }), onChange: setValue, help: renderHelp(), options: options, multiple: multiple })));
}
