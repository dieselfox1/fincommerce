...
function TabBlockEdit({ setAttributes, attributes, context, }) {
    ...
    const classes = (0, clsx_1.default)('wp-block-fincommerce-product-tab__content', {
    ...
    return ((0, element_1.createElement)("div", { ...blockProps },
        ...
        (0, element_1.createElement)("div", { id: `fincommerce-product-tab__${id}-content`, "aria-labelledby": `fincommerce-product-tab__${id}`, role: "tabpanel", className: classes },
            (0, element_1.createElement)(components_1.__experimentalErrorBoundary, { errorMessage: (0, i18n_1.__)('An unexpected error occurred in this tab. Make sure any unsaved changes are saved and then try reloading the page to see if the error recurs.', 'fincommerce'), onError: (error, errorInfo) => {
