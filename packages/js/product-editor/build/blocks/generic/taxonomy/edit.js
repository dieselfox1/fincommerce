...
function Edit({ attributes, context: { postType, isInSelectedTab }, }) {
    ...
    return ((0, element_1.createElement)("div", { ...blockProps },
        (0, element_1.createElement)(element_1.Fragment, null,
            (0, element_1.createElement)(components_1.__experimentalSelectTreeControl, { id: (0, compose_1.useInstanceId)(components_1.__experimentalSelectTreeControl, 'fincommerce-taxonomy-select'), label: (0, element_1.createElement)(label_1.Label, { label: label, tooltip: help }), isLoading: isResolving, disabled: disabled, multiple: true, createValue: searchValue, onInputChange: searchDelayed, shouldNotRecursivelySelect: true, shouldShowCreateButton: (typedValue) => !typedValue ||
