...
function Edit({ attributes, clientId, context, }) {
    ...
    const { ref: stockQuantityRef, error: stockQuantityValidationError, validate: validateStockQuantity, } = (0, validation_context_1.useValidation)(`stock_quantity-${clientId}`, async function stockQuantityValidator() {
        if (manageStock && stockQuantity && stockQuantity < 0) {
            return {
                message: (0, i18n_1.__)('Stock quantity must be a positive number.', 'fincommerce'),
            };
        }
    ...
    return ((0, element_1.createElement)("div", { ...blockProps },
        (0, element_1.createElement)("div", { className: "wp-block-columns" },
            (0, element_1.createElement)("div", { className: "wp-block-column" },
                (0, element_1.createElement)(components_1.BaseControl, { id: stockQuantityId, className: stockQuantityValidationError && 'has-error', help: stockQuantityValidationError ?? '' },
                    (0, element_1.createElement)(components_1.__experimentalInputControl, { id: stockQuantityId, name: "stock_quantity", ref: stockQuantityRef, label: (0, i18n_1.__)('Available stock', 'fincommerce'), value: stockQuantity?.toString(), onChange: (value) => {
