...
function DownloadsMenu({ allowedTypes, maxUploadFileSize, onUploadSuccess, onUploadError, onLinkError, }) {
    return ((0, element_1.createElement)(components_1.Dropdown, { popoverProps: {
        ...
        }, contentClassName: "fincommerce-downloads-menu__menu-content", renderToggle: ({ isOpen, onToggle }) => ((0, element_1.createElement)(components_1.Button, { "aria-expanded": isOpen, icon: isOpen ? icons_1.chevronUp : icons_1.chevronDown, variant: "secondary", onClick: onToggle, className: "fincommerce-downloads-menu__toggle" },
            (0, element_1.createElement)("span", null, (0, i18n_1.__)('Add new', 'fincommerce')))), renderContent: ({ onClose }) => ((0, element_1.createElement)("div", { className: "components-dropdown-menu__menu" },
