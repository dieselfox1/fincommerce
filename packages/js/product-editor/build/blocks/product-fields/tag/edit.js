...
function Edit({ attributes, context: { postType, isInSelectedTab }, }) {
    ...
    return ((0, element_1.createElement)("div", { ...blockProps }, (0, element_1.createElement)(tags_field_1.TagField, { id: tagFieldId, isVisible: isInSelectedTab, label: label || (0, i18n_1.__)('Tags', 'fincommerce'), placeholder: placeholder ||
            (0, i18n_1.__)('Search or create tags…', 'fincommerce'), onChange: setTags, value: tags || [] })));
}
