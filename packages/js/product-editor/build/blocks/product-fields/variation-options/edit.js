...
function Edit({ attributes: blockAttributes, context: { postType, isInSelectedTab }, }) {
    ...
    if (localAttributeNames.length > 0 &&
        ...
        notice = (0, element_1.createInterpolateElement)((0, i18n_1.__)('Buyers can’t search or filter by <attributeNames /> to find the variations. Consider adding them again as <globalAttributeLink>global attributes</globalAttributeLink> to make them easier to discover.', 'fincommerce'), {
            attributeNames: ((0, element_1.createElement)("span", null, localAttributeNames.length === 2
                ? localAttributeNames.join((0, i18n_1.__)(' and ', 'fincommerce'))
    ...
    function renderCustomEmptyState({ addAttribute, }) {
        return ((0, element_1.createElement)("div", { className: "wp-block-fincommerce-product-variations-options-field__empty-state" },
            (0, element_1.createElement)("div", { className: "wp-block-fincommerce-product-variations-options-field__empty-state-image" },
                (0, element_1.createElement)(images_1.ProductTShirt, { className: "wp-block-fincommerce-product-variations-options-field__empty-state-image-product" }),
                (0, element_1.createElement)(images_1.ProductTShirt, { className: "wp-block-fincommerce-product-variations-options-field__empty-state-image-product" }),
                (0, element_1.createElement)(images_1.ProductTShirt, { className: "wp-block-fincommerce-product-variations-options-field__empty-state-image-product" })),
            (0, element_1.createElement)("p", { className: "wp-block-fincommerce-product-variations-options-field__empty-state-description" }, (0, i18n_1.__)('Sell your product in multiple variations like size or color.', 'fincommerce')),
            (0, element_1.createElement)("div", { className: "wp-block-fincommerce-product-variations-options-field__empty-state-actions" },
                (0, element_1.createElement)(components_1.Button, { variant: "primary", onClick: () => addAttribute() }, (0, i18n_1.__)('Add options', 'fincommerce')))));
    }
    return ((0, element_1.createElement)("div", { ...blockProps },
        (0, element_1.createElement)(attribute_control_1.AttributeControl, { value: (0, element_1.useMemo)(mapDefaultAttributes, [
                ...
                newAttributeModalTitle: (0, i18n_1.__)('Add variation options', 'fincommerce'),
                newAttributeModalDescription: (0, i18n_1.__)('Select from existing attributes or create new ones to add new variations for your product. You can change the order later.', 'fincommerce'),
                attributeRemoveLabel: (0, i18n_1.__)('Remove variation option', 'fincommerce'),
                attributeRemoveConfirmationModalMessage: (0, i18n_1.__)('If you continue, some variations of this product will be deleted and customers will no longer be able to purchase them.', 'fincommerce'),
            } })));
}
