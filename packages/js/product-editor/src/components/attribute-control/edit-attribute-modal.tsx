...
export const EditAttributeModal = ( {
	...
	nameLabel = __( 'Name', 'fincommerce' ),
	globalAttributeHelperMessage,
	customAttributeHelperMessage = __(
		'Your customers will see this on the product page',
		'fincommerce'
	),
	termsLabel = __( 'Values', 'fincommerce' ),
	termsPlaceholder = __( 'Search or create value', 'fincommerce' ),
	isDefaultLabel = __( 'Set default value', 'fincommerce' ),
	isDefaultTooltip = __(
		'Check to preselect the first choice when customers enter the product page.',
		'fincommerce'
	),
	useAsFilterLabel = __( 'Use as filter', 'fincommerce' ),
	useAsFilterTooltip = __(
		'Check to allow customers to search and filter by this option in your store.',
		'fincommerce'
	),
	visibleLabel = __( 'Show in product details', 'fincommerce' ),
	visibleTooltip = __(
		'Check to show this option and its values in the product details section on the product page.',
		'fincommerce'
	),
	cancelAccessibleLabel = __( 'Cancel', 'fincommerce' ),
	cancelLabel = __( 'Cancel', 'fincommerce' ),
	updateAccessibleLabel = __( 'Edit attribute', 'fincommerce' ),
	updateLabel = __( 'Update', 'fincommerce' ),
	onCancel,
	onEdit,
	attribute,
	attributes,
	...
	return (
		<>
			<Modal
				...
				className="fincommerce-edit-attribute-modal"
			>
				<div className="fincommerce-edit-attribute-modal__body">
					<TextControl
						label={ nameLabel }
					...
					/>
					<p className="fincommerce-edit-attribute-modal__helper-text">
						{ ! isCustomAttribute
							? globalAttributeHelperMessage
					...
					<div className="fincommerce-edit-attribute-modal__options">
						{ attribute.variation && (
							<div className="fincommerce-edit-attribute-modal__option-container">
								<CheckboxControl
									onChange={ ( checked ) =>
										setEditableAttribute( {
											...( editableAttribute as EnhancedProductAttribute ),
								...
								/>
								<Tooltip
									className="fincommerce-edit-attribute-modal__tooltip-set-default-value"
						...
						<div className="fincommerce-edit-attribute-modal__option-container">
							...
							/>
							<Tooltip
								className="fincommerce-edit-attribute-modal__tooltip-show-in-product-details"
								text={ visibleTooltip }
							/>
						</div>
						{ attribute.id !== 0 && (
							...
							<div className="fincommerce-edit-attribute-modal__option-container">
								...
								/>
								<Tooltip
									className="fincommerce-edit-attribute-modal__tooltip-use-as-filter"
				...
				<div className="fincommerce-edit-attribute-modal__buttons">
					<Button
						isSecondary
