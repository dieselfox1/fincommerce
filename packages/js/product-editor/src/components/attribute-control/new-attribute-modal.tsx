...
export const NewAttributeModal = ( {
	title = __( 'Add attributes', 'fincommerce' ),
	description = '',
	notice,
	attributeLabel = __( 'Attribute', 'fincommerce' ),
	valueLabel = __( 'Values', 'fincommerce' ),
	attributePlaceholder = __( 'Search or create attribute', 'fincommerce' ),
	termPlaceholder = __( 'Search or create value', 'fincommerce' ),
	removeLabel = __( 'Remove attribute', 'fincommerce' ),
	addAnotherAccessibleLabel = __( 'Add another attribute', 'fincommerce' ),
	addAnotherLabel = __( '+ Add another', 'fincommerce' ),
	cancelLabel = __( 'Cancel', 'fincommerce' ),
	addAccessibleLabel = __( 'Add attributes', 'fincommerce' ),
	addLabel = __( 'Add', 'fincommerce' ),
	onCancel,
	onAdd,
	onAddAnother = () => {},
	onRemoveItem = () => {},
	...
	const scrollAttributeIntoView = ( index: number ) => {
		setTimeout( () => {
			const attributeRow = document.querySelector(
				`.fincommerce-new-attribute-modal__table-row-${ index }`
			);
	...
	useEffect( function focusFirstAttributeField() {
		const firstAttributeFieldLabel =
			document.querySelector< HTMLLabelElement >(
				'.fincommerce-new-attribute-modal__table-row .fincommerce-attribute-input-field label'
			);
				...
				{ ( {
					...
					return (
						...
						>
							...
							<div className="fincommerce-new-attribute-modal__body">
								<table className="fincommerce-new-attribute-modal__table">
									<thead>
										<tr className="fincommerce-new-attribute-modal__table-header">
							...
							<div>
								<Button
									className="fincommerce-new-attribute-modal__add-attribute"
									variant="tertiary"
							...
							<div className="fincommerce-new-attribute-modal__buttons">
								<Button
									isSecondary
									label={ cancelLabel }
									onClick={ () => onCancel() }
