...
export const AttributeTableRow = ( {
	...
	return (
		<tr
			key={ index }
			className={ `fincommerce-new-attribute-modal__table-row fincommerce-new-attribute-modal__table-row-${ index }` }
		>
			<td className="fincommerce-new-attribute-modal__table-attribute-column">
			...
			<td
				className={ `fincommerce-new-attribute-modal__table-attribute-value-column${
			...
			<td className="fincommerce-new-attribute-modal__table-attribute-trash-column">
				<Button
					icon={ closeSmall }
