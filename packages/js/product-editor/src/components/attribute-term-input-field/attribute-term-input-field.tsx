...
export const AttributeTermInputField = ( {
	...
	const attributeTermInputId = useRef(
		`fincommerce-attribute-term-field-${ ++uniqueId }`
	);
	...
	return (
		<>
			<SelectControl< ProductAttributeTerm >
				...
				className={
					'fincommerce-attribute-term-field ' +
					attributeTermInputId.current
				}
						...
						<Menu isOpen={ isOpen } getMenuProps={ getMenuProps }>
							{ [
								isFetching || isCreatingTerm ? (
									<div
										key="loading-spinner"
										className="fincommerce-attribute-term-field__loading-spinner"
									>
										<Spinner />
									</div>
								) : null,
									...
									return (
										...
										>
											{ item.id !== -99 ? (
												...
												<div className="fincommerce-attribute-term-field__add-new">
													<Icon
														icon={ plus }
														size={ 20 }
														className="fincommerce-attribute-term-field__add-new-icon"
													/>
													<span>
														{ sprintf(
