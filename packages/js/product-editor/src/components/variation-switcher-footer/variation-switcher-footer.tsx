...
export function VariationSwitcherFooter( {
	...
	return (
		<div className="fincommerce-product-variation-switcher-footer">
			{ previousVariation && (
				<Button
					className="fincommerce-product-variation-switcher-footer__button fincommerce-product-variation-switcher-footer__button-previous"
					label={ __( 'Previous', 'fincommerce' ) }
					onClick={ onPrevious }
				>
					...
					{ previousVariation.image ? (
						<img
							...
							className="fincommerce-product-variation-switcher-footer__product-image"
						/>
					) : (
						<VariationImagePlaceholder className="fincommerce-product-variation-switcher-footer__product-image" />
					) }
			...
			{ nextVariation && (
				<Button
					className="fincommerce-product-variation-switcher-footer__button fincommerce-product-variation-switcher-footer__button-next"
					label={ __( 'Next', 'fincommerce' ) }
					onClick={ onNext }
				>
					{ nextVariation.name }
					{ nextVariation.image ? (
