...
export function BlockEditor( {
	...
	if ( isEditorLoading ) {
		return (
			<div className="fincommerce-product-block-editor">
				<LoadingState />
			</div>
		);
	}
		...
		return (
			<Suspense fallback={ null }>
				<ModalEditor
					...
					title={ __( 'Edit description', 'fincommerce' ) }
					name={
		...
		<div className="fincommerce-product-block-editor">
			<BlockContextProvider value={ context }>
				...
				>
					...
					<BlockTools>
						<ObserveTyping>
							<BlockList className="fincommerce-product-block-editor__block-list" />
						</ObserveTyping>
					</BlockTools>
					{ /* eslint-disable-next-line @typescript-eslint/no-non-null-assertion */ }
					<PostTypeContext.Provider value={ context.postType! }>
						<Suspense fallback={ null }>
							<PluginArea scope="fincommerce-product-block-editor" />
						</Suspense>
