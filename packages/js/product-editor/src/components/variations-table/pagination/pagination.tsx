...
export function Pagination( {
	...
	return (
		<div
			className={ clsx(
				className,
				'fincommerce-product-variations-pagination'
			) }
		>
			<div className="fincommerce-product-variations-pagination__info">
				{ sprintf(
					paginationLabel,
			...
			<div className="fincommerce-product-variations-pagination__current-page">
				<PaginationPageArrowsWithPicker { ...paginationProps } />
			</div>

			<div className="fincommerce-product-variations-pagination__page-size">
				<PaginationPageSizePicker
					{ ...paginationProps }
					total={ totalCount }
