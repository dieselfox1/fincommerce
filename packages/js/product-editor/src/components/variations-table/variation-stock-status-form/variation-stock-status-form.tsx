...
export function VariationStockStatusForm( {
	...
	return (
		<form
			...
			className="fincommerce-variation-stock-status-form"
			aria-label={ __( 'Variation stock status form', 'fincommerce' ) }
			noValidate
		>
			<div className="fincommerce-variation-stock-status-form__controls">
				<ToggleControl
			...
			<div className="fincommerce-variation-stock-status-form__controls">
				{ value.manage_stock ? (
					<InputControl
						type="number"
						min={ 0 }
						label={ __( 'Available stock', 'fincommerce' ) }
			...
			<div className="fincommerce-variation-stock-status-form__actions">
