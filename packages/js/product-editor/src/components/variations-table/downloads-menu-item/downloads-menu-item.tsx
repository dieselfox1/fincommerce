 ...
 */
import { Dropdown, MenuItem, MenuGroup } from '@finpress/components';
			...
			renderContent={ () => (
				<div className="components-dropdown-menu__menu">
					<MenuGroup>
						...
						>
							{ __( 'Set download limit', 'fincommerce' ) }
						</MenuItem>
						...
						>
							{ __( 'Set download expiry', 'fincommerce' ) }
						</MenuItem>
					</MenuGroup>
