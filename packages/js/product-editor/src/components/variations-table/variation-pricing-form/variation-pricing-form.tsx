...
export function VariationPricingForm( {
	...
	return (
		<form
			...
			className="fincommerce-variation-pricing-form"
			aria-label={ __( 'Variation pricing form', 'fincommerce' ) }
		>
			<div className="fincommerce-variation-pricing-form__controls">
				<InputControl
			...
			<div className="fincommerce-variation-pricing-form__actions">
