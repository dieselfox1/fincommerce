		...
		<>
			...
			{ customFields.length === 0 ? (
				...
				<table
					{ ...props }
					className={ clsx(
						'fincommerce-product-custom-fields__table',
						className
					) }
				>
					<thead>
						<tr className="fincommerce-product-custom-fields__table-row">
							<th>{ __( 'Name', 'fincommerce' ) }</th>
							<th>{ __( 'Value', 'fincommerce' ) }</th>
							<th>{ __( 'Actions', 'fincommerce' ) }</th>
						</tr>
					</thead>
					<tbody>
						{ customFields.map( ( customField, index ) => (
							<tr
								className="fincommerce-product-custom-fields__table-row"
								key={ customField.id ?? customField.key }
							>
								<td className="fincommerce-product-custom-fields__table-datacell">
									{ customField.key }
								</td>
								<td className="fincommerce-product-custom-fields__table-datacell">
									{ customField.value }
