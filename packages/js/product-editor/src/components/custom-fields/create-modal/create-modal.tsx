...
import { createElement, useState, useRef, useEffect } from '@finpress/element';
...
export function CreateModal( {
	...
	return (
		<Modal
			...
			title={ __( 'Add custom fields', 'fincommerce' ) }
			onRequestClose={ onCancel }
			{ ...props }
			className={ clsx(
				'fincommerce-product-custom-fields__create-modal',
				props.className
			) }
		>
			<div role="table">
						...
						<div key={ customField.id } role="row">
							...
							<div role="cell">
								<TextControl
									...
									label={ '' }
									aria-label={ __( 'Value', 'fincommerce' ) }
			...
			<div className="fincommerce-product-custom-fields__create-modal-add-another">
				<Button
					variant="tertiary"
					onClick={ handleAddAnotherButtonClick }
				>
					{ __( '+ Add another', 'fincommerce' ) }
				</Button>
			</div>

			<div className="fincommerce-product-custom-fields__create-modal-actions">
