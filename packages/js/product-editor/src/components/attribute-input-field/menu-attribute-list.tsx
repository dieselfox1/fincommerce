...
export const MenuAttributeList = ( {
				...
				{ renderItems.map( ( item, index: number ) => (
					...
					>
						{ isNewAttributeListItem( item ) ? (
							<div className="fincommerce-attribute-input-field__add-new">
								<Icon
									icon={ plus }
									size={ 20 }
									className="fincommerce-attribute-input-field__add-new-icon"
								/>
								<span>
									{ sprintf(
	...
	return (
		<div className="fincommerce-attribute-input-field__no-results">
			{ __( 'Nothing yet. Type to create.', 'fincommerce' ) }
		</div>
	);
};
