...
export function DocumentOverviewSidebar() {
	...
	return (
		...
		<div
			className="fincommerce-iframe-editor__document-overview-sidebar"
			onKeyDown={ closeOnEscape }
		>
			<Button
				className="fincommerce-iframe-editor__document-overview-sidebar-close-button"
			...
			/>
			<TabPanel
				className="fincommerce-iframe-editor__document-overview-sidebar-tab-panel"
				initialTabName={ tab }
				onSelect={ setTab }
				tabs={ [
					{
						...
						className:
							'fincommerce-iframe-editor__document-overview-sidebar-tab-item',
					},
				] }
			>
				{ ( currentTab ) => (
					<div
						className="fincommerce-iframe-editor__document-overview-sidebar-tab-content"
