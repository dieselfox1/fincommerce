...
export function IframeEditor( {
	...
	return (
		<div className="fincommerce-iframe-editor">
			...
			>
				...
				>
					...
					/>
					<div className="fincommerce-iframe-editor__main">
						<SecondarySidebar />
						<BlockTools
							className={ clsx(
								'fincommerce-iframe-editor__content'
							) }
							onClick={ (
						...
						>
							...
							{ /* This is a hack, but I couldn't find another (easy) way to not
								 ...
								 bounds. */ }
							<div className="fincommerce-iframe-editor__content-inserter-clipper" />
						</BlockTools>
						<ComplementaryArea.Slot
							scope={ SIDEBAR_COMPLEMENTARY_AREA_SCOPE }
						/>
					</div>
					<PluginArea scope="fincommerce-product-editor-modal-block-editor" />
