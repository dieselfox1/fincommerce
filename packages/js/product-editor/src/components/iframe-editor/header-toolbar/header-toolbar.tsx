...
export function HeaderToolbar( {
	...
	return (
		<div className="fincommerce-iframe-editor__header">
			<div className="fincommerce-iframe-editor__header-left">
				<NavigableToolbar
					className="fincommerce-iframe-editor-document-tools"
					aria-label={ __( 'Document tools', 'fincommerce' ) }
					// @ts-expect-error variant prop exists
					variant="unstyled"
				>
					<div className="fincommerce-iframe-editor-document-tools__left">
						<ToolbarItem
							ref={ inserterButton }
							as={ Button }
							className="fincommerce-iframe-editor__header-inserter-toggle"
			...
			<div className="fincommerce-iframe-editor__header-right">
				<Button
					variant="tertiary"
					className="fincommerce-modal-actions__cancel-button"
					onClick={ onCancel }
					text={ __( 'Cancel', 'fincommerce' ) }
				/>
				<Button
					variant="primary"
					className="fincommerce-modal-actions__done-button"
					onClick={ onSave }
					text={ __( 'Done', 'fincommerce' ) }
				/>
