...
export const KeyboardShortcuts = () => {
	...
	useShortcut(
		'fincommerce/product-editor/modal-block-editor/undo',
		( event ) => {
			undo();
	...
	useShortcut(
		'fincommerce/product-editor/modal-block-editor/redo',
		( event ) => {
			redo();
			event.preventDefault();
		}
	...
	useShortcut(
		'fincommerce/product-editor/modal-block-editor/toggle-list-view',
		( event ) => {
	...
	useShortcut(
		'fincommerce/product-editor/modal-block-editor/toggle-sidebar',
		( event ) => {
