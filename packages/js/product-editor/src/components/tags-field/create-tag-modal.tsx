...
export const CreateTagModal = ( {
	...
	const onSave = async () => {
		...
		try {
			...
			createNotice(
				'error',
				__( 'Failed to create tag.', 'fincommerce' )
			);
			setIsCreating( false );
			onCancel();
		}
	...
	return (
		<Modal
			title={ __( 'Create tag', 'fincommerce' ) }
			onRequestClose={ () => onCancel() }
			className="fincommerce-create-new-tag-modal"
		>
			<div className="fincommerce-create-new-tag-modal__wrapper">
				<TextControl
					...
					onChange={ setTagName }
				/>
				<div className="fincommerce-create-new-tag-modal__buttons">
					<Button
						isSecondary
						onClick={ () => onCancel() }
						disabled={ isCreating }
