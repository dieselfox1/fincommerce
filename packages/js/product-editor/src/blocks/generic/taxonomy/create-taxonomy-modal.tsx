...
export const CreateTaxonomyModal = ( {
	...
	const onSave = async () => {
		...
		try {
			...
			if ( e.message ) {
				...
				setErrorMessage(
					__( `Failed to create taxonomy`, 'fincommerce' )
				);
				throw e;
			}
		}
	...
	return (
		<Modal
			...
			className="fincommerce-create-new-taxonomy-modal"
		>
			<div className="fincommerce-create-new-taxonomy-modal__wrapper">
				<BaseControl
					id={ id }
				...
				{ hierarchical && (
					<SelectTree
						...
						label={ createInterpolateElement(
							`${
								parentTaxonomyText ||
								__( 'Parent', 'fincommerce' )
							} <optional/>`,
							{
								optional: (
									<span className="fincommerce-create-new-taxonomy-modal__optional">
				...
				<div className="fincommerce-create-new-taxonomy-modal__buttons">
					<Button
						variant="tertiary"
						onClick={ onCancel }
						disabled={ isCreating }
