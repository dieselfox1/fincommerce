	...
	return (
		<div { ...blockProps }>
			<SectionActions>
				...
				>
					{ __( 'Choose products for me', 'fincommerce' ) }
				</Button>
			</SectionActions>

			<div className="wp-block-fincommerce-product-linked-list-field__form-group-content">
				<ProductSelect
			...
			{ ! state.isLoading && state.linkedProducts.length === 0 && (
				<AdviceCard
					tip={ emptyState.tip }
					dismissPreferenceId={ `fincommerce-product-${ property }-advice-card-dismissed` }
