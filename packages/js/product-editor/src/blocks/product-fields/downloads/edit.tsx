...
import { Product, ProductDownload } from '@fincommerce/data';
...
export function DownloadBlockEdit( {
	...
	return (
		<div { ...blockProps }>
			...
			<div className="wp-block-fincommerce-product-downloads-field__body">
				<MediaUploader
					label={
						! Boolean( downloads.length ) ? (
							<div className="wp-block-fincommerce-product-downloads-field__drop-zone-content">
								<UploadImage />
								<p className="wp-block-fincommerce-product-downloads-field__drop-zone-label">
									{ createInterpolateElement(
										__(
				...
				{ Boolean( downloads.length ) && (
					<Sortable className="wp-block-fincommerce-product-downloads-field__table">
						{ downloads.map( ( download: ProductDownload ) => {
							...
							return (
								<ListItem
									key={ download.file }
									className="wp-block-fincommerce-product-downloads-field__table-row"
								>
									<div className="wp-block-fincommerce-product-downloads-field__table-filename">
										<span>{ download.name }</span>
										{ download.name !== nameFromUrl && (
											<span className="wp-block-fincommerce-product-downloads-field__table-filename-description">
												{ nameFromUrl }
											</span>
										) }
									</div>

									<div className="wp-block-fincommerce-product-downloads-field__table-actions">
										{ isUploading && (
											<Spinner
												aria-label={ __(
													'Uploading file',
