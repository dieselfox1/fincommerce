 ...
 */
import { Button, Dropdown, MenuGroup } from '@finpress/components';
...
export function DownloadsMenu( {
	...
	return (
		<Dropdown
			...
			contentClassName="fincommerce-downloads-menu__menu-content"
			renderToggle={ ( { isOpen, onToggle } ) => (
				<Button
					...
					variant="secondary"
					onClick={ onToggle }
					className="fincommerce-downloads-menu__toggle"
				>
					<span>{ __( 'Add new', 'fincommerce' ) }</span>
				</Button>
			) }
