...
export const EditDownloadsModal = ( {
	...
	const onCopySuccess = () => {
		createNotice(
			'success',
			__( 'URL copied successfully.', 'fincommerce' )
		);
	};
	...
	return (
		...
		>
			<div className="fincommerce-edit-downloads-modal__preview">
			...
			<BaseControl
				id={ 'file-name-help' }
				className="fincommerce-edit-downloads-modal__file-name"
				help={ __(
			...
			>
				<InputControl
					id={ 'file-name' }
					label={ __( 'FILE NAME', 'fincommerce' ) }
					name={ 'file-name' }
					value={ name || '' }
					onChange={ ( value ) => {
						onChange( value ?? '' );
			...
			<div className="fincommerce-edit-downloads-modal__file-url">
				<InputControl
					disabled
					id={ 'file-url' }
					label={ __( 'FILE URL', 'fincommerce' ) }
					name={ 'file-url' }
					value={ file || '' }
					suffix={
						<Button
			...
			<div className="fincommerce-edit-downloads-modal__buttons">
				<div className="fincommerce-edit-downloads-modal__buttons-left">
					<Button
						icon={ trash }
						isDestructive
						variant="tertiary"
				...
				<div className="fincommerce-edit-downloads-modal__buttons-right">
					<Button
