...
export function ImageBlockEdit( {
	...
	return (
		<div { ...blockProps }>
			<div className="fincommerce-product-form__image-drop-zone">
				{ isRemovingZoneVisible ? (
					<div className="fincommerce-product-form__remove-image-drop-zone">
						<span>
							<Icon
								icon={ trash }
								size={ 20 }
						...
						<DropZone
							...
							label={ __( 'Drop here to remove', 'fincommerce' ) }
						/>
					</div>
				) : (
					<SectionActions>
						<div className="fincommerce-product-form__media-uploader">
							<MediaUploader
								value={
