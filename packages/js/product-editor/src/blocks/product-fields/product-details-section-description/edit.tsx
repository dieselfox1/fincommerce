	...
	function menuItemClickHandler(
		...
		return async function handleMenuItemClick() {
			try {
				...
				createSuccessNotice(
					__( 'Product type changed.', 'fincommerce' )
				);
			...
			<div { ...blockProps }>
				...
				<Dropdown
					...
					renderToggle={ ( { isOpen, onToggle } ) => (
						...
						>
							<span>
								{ __( 'Change product type', 'fincommerce' ) }
							</span>
						</Button>
					) }
					renderContent={ ( { onClose } ) => (
						<div className="wp-block-fincommerce-product-details-section-description__dropdown components-dropdown-menu__menu">
							<MenuGroup>
				...
				{ Boolean( unsupportedProductTemplate ) && (
					<Modal
						title={ __( 'Change product type?', 'fincommerce' ) }
						className="wp-block-fincommerce-product-details-section-description__modal"
						onRequestClose={ () => {
					...
					>
						...
						<div className="wp-block-fincommerce-product-details-section-description__modal-actions">
							<Button
								variant="secondary"
