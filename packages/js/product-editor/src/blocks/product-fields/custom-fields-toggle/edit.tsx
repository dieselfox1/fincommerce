...
import { Spinner, ToggleControl } from '@finpress/components';
...
export function Edit( {
	...
	const innerBlockProps = useInnerBlocksProps(
		{
			className:
				'wp-block-fincommerce-product-custom-fields-toggle-field__inner-blocks',
		},
		{
			templateLock: 'all',
	...
	return (
		<div { ...blockProps }>
			<div className="wp-block-fincommerce-product-custom-fields-toggle-field__content">
				<ToggleControl
					label={ label }
					checked={ isChecked }
					disabled={ isLoading }
