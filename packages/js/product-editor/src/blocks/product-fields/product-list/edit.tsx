...
export function ProductListBlockEdit( {
	...
	return (
		<div { ...blockProps }>
			...
			<div className="wp-block-fincommerce-product-list-field__body">
				{ ! isLoading && groupedProducts.length === 0 && (
					<AdviceCard
						tip={ __(
				...
				{ ! isLoading && groupedProducts.length > 0 && (
					<div
						className="wp-block-fincommerce-product-list-field__table"
						role="table"
					>
						<div className="wp-block-fincommerce-product-list-field__table-header">
							<div
								className="wp-block-fincommerce-product-list-field__table-row"
								role="rowheader"
							>
								<div
									className="wp-block-fincommerce-product-list-field__table-header-column"
									role="columnheader"
								>
						...
						<div
							className="wp-block-fincommerce-product-list-field__table-body"
							role="rowgroup"
						>
							{ groupedProducts.map( ( product ) => (
								...
								>
									<div
										className="wp-block-fincommerce-product-list-field__table-cell"
										role="cell"
									>
										<div
											className="wp-block-fincommerce-product-list-field__product-image"
											style={ getProductImageStyle(
												product
											) }
										/>

										<div className="wp-block-fincommerce-product-list-field__product-info">
											<div className="wp-block-fincommerce-product-list-field__product-name">
												<Button
													variant="link"
													href={ getNewPath(
														{},
											...
											<div className="wp-block-fincommerce-product-list-field__product-sku">
												{ product.sku }
											</div>
										</div>
									</div>
									...
									>
										...
										{ product.regular_price && (
											<span
												className={ clsx( {
													'wp-block-fincommerce-product-list-field__price--on-sale':
														product.on_sale,
												} ) }
											>
												{ formatAmount(
