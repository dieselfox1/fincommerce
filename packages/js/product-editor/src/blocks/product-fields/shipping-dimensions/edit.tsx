...
export function Edit( {
	...
	const { dimensionUnit, weightUnit } = useSelect( ( select ) => {
		...
		return {
			dimensionUnit: getOption( 'fincommerce_dimension_unit' ) as string,
	...
	return (
		<div { ...blockProps }>
			<h4>{ __( 'Dimensions', 'fincommerce' ) }</h4>

			<div className="wp-block-columns">
				<div className="wp-block-column">
					<NumberControl
						label={ createInterpolateElement(
							__( 'Width <Side />', 'fincommerce' ),
							{ Side: <span>A</span> }
						) }
						error={ dimensionsWidthValidationError }
				...
				<div className="wp-block-column">
					<ShippingDimensionsImage
						...
						className="wp-block-fincommerce-product-shipping-dimensions-fields__dimensions-image"
						labels={ {
