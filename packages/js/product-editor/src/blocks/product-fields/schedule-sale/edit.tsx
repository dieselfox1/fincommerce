...
export function Edit( {
	...
	return (
		<div { ...blockProps }>
			<ToggleControl
				label={ __( 'Schedule sale', 'fincommerce' ) }
			...
			{ showScheduleSale && (
				<div className="wp-block-columns wp-block-fincommerce-product-schedule-sale-fields__content">
					<div className="wp-block-column">
						<DateTimePickerControl
							ref={
								dateOnSaleFromGmtRef as React.Ref< HTMLInputElement >
							}
							label={ __( 'From', 'fincommerce' ) }
							placeholder={ __(
