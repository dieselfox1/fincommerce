...
import { numberFormat, parseNumber } from '@fincommerce/number';
 ...
 */
export const localiseMonetaryValue = (config, number) => {
    if (typeof number === 'number') {
...
export const unformatLocalisedMonetaryValue = (config, inputNumber) => {
    if (!inputNumber) {
