...
export function CustomerFeedbackModal( {
	recordScoreCallback,
	title = __( 'Please share your feedback', 'fincommerce' ),
	description,
	...
	return (
		<Modal
			className="fincommerce-customer-effort-score"
			title={ title }
		...
		>
			{ showDescription && (
				<Text
					variant="body"
					as="p"
					className="fincommerce-customer-effort-score__intro"
					size={ 14 }
					lineHeight="20px"
					marginBottom="1.5em"
				>
			...
			<div className="fincommerce-customer-effort-score__selection">
				<RadioControl
					...
					className="fincommerce-customer-effort-score__radio-control"
				/>
			</div>
			...
			{ typeof shouldShowComments === 'function' &&
				shouldShowComments(
					...
					<div className="fincommerce-customer-effort-score__comments">
						<TextareaControl
							...
							help={ __(
								'Your feedback will go to the FinCommerce development team',
								'fincommerce'
							) }
							value={ comments }
							placeholder={ __(
			...
			{ showNoScoreMessage && (
				<div
					className="fincommerce-customer-effort-score__errors"
					role="alert"
				>
