...
import { ADMIN_INSTALL_TIMESTAMP_OPTION_NAME, ALLOW_TRACKING_OPTION_NAME, SHOWN_FOR_ACTIONS_OPTION_NAME, } from '../../constants';
 ...
 */
function _CustomerEffortScoreTracks({ action, trackProps, title, description, noticeLabel, firstQuestion, secondQuestion, icon, onSubmitLabel = __('Thank you for your feedback!', 'fincommerce'), cesShownForActions, allowTracking, resolving, storeAgeInWeeks, createNotice, }) {
    ...
    return (createElement(CustomerEffortScore, { recordScoreCallback: recordScore, title: title, description: description, noticeLabel: noticeLabel, firstQuestion: firstQuestion, secondQuestion: secondQuestion, onNoticeShownCallback: onNoticeShown, onNoticeDismissedCallback: onNoticeDismissed, onModalShownCallback: onModalShown, onModalDismissedCallback: onModalDismissed, icon: createElement("span", { style: { height: 21, width: 21 }, role: "img", "aria-label": __('Pencil icon', 'fincommerce') }, icon || '✏') }));
}
/**
 ...
 */
export const CustomerEffortScoreTracks = compose(withSelect((select) => {
