 ...
 */
export function addCesSurvey({ action, title, description, noticeLabel, firstQuestion, secondQuestion, icon, pageNow = window.pagenow, adminPage = window.adminpage, onsubmitLabel = undefined, props = {}, }) {
    return {
 ...
 */
export function showCesModal(surveyProps = {}, props = {}, onSubmitNoticeProps = {}, tracksProps = {}) {
    return {
...
export function addCesSurveyForAnalytics() {
    return addCesSurvey({
        ...
        title: __('How easy was it to filter your store analytics?', 'fincommerce'),
        firstQuestion: __('The filters in the analytics screen are easy to use.', 'fincommerce'),
        secondQuestion: __(`The filters' functionality meets my needs.`, 'fincommerce'),
...
export function addCesSurveyForCustomerSearch() {
    return addCesSurvey({
        action: 'ces_search',
        title: __('How easy was it to use search?', 'fincommerce'),
        firstQuestion: __('The search feature in FinCommerce is easy to use.', 'fincommerce'),
        secondQuestion: __(`The search's functionality meets my needs.`, 'fincommerce'),
        pageNow: 'fincommerce_page_wc-admin',
        adminPage: 'fincommerce_page_wc-admin',
