...
export const WooHeaderPageTitle = ({ children, }) => {
    return createElement(Fill, { name: WC_HEADER_PAGE_TITLE_SLOT_NAME }, children);
};
WooHeaderPageTitle.Slot = ({ fillProps, }) => (createElement(Slot, { name: WC_HEADER_PAGE_TITLE_SLOT_NAME, fillProps: fillProps }, (fills) => {
    ...
    return createElement(Fragment, null, [...fills].pop());
}));
