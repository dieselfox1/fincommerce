 ...
 */
import { __experimentalNavigation, __experimentalNavigationBackButton, __experimentalNavigationGroup, __experimentalNavigationMenu, __experimentalNavigationItem, __experimentalText, __experimentalUseSlot, __experimentalUseSlotFills as useSlotFillsHook, Navigation as NavigationComponent, NavigationBackButton as NavigationBackButtonComponent, NavigationGroup as NavigationGroupComponent, NavigationMenu as NavigationMenuComponent, NavigationItem as NavigationItemComponent, Text as TextComponent, useSlot as useSlotHook, } from '@wordpress/components';
/**
...
export const NavigationBackButton = NavigationBackButtonComponent || __experimentalNavigationBackButton;
export const NavigationGroup = NavigationGroupComponent || __experimentalNavigationGroup;
export const NavigationMenu = NavigationMenuComponent || __experimentalNavigationMenu;
