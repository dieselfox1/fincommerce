...
exports.VerticalCSSTransition = void 0;
/**
 ...
 */
const VerticalCSSTransition = ({ children, defaultStyle, ...props }) => {
    const [containerHeight, setContainerHeight] = (0, element_1.useState)(0);
    const [transitionIn, setTransitionIn] = (0, element_1.useState)(props.in || false);
    const cssTransitionRef = (0, element_1.useRef)(null);
    const collapseContainerRef = (0, element_1.useCallback)((containerElement) => {
        if (containerElement) {
    ...
    const getTransitionStyle = (state) => {
        ...
        const appearing = cssTransitionRef.current &&
    ...
    return ((0, element_1.createElement)(react_transition_group_1.CSSTransition, { ...props, in: transitionIn, ref: cssTransitionRef }, (state) => ((0, element_1.createElement)("div", { className: "vertical-css-transition-container", style: getTransitionStyle(state), ref: collapseContainerRef }, children))));
};
exports.VerticalCSSTransition = VerticalCSSTransition;
