...
describe( 'Chart', () => {
	...
	test( '<Chart legendPosition="bottom" /> should render the legend at the bottom', () => {
		...
		const footer = container.querySelector( '.fincommerce-chart__footer' );
		expect(
	...
	test( '<Chart legendPosition="side" /> should render the legend at the side', () => {
		...
		const body = container.querySelector( '.fincommerce-chart__body' );
		expect(
	...
	test( '<Chart legendPosition="top" /> should render the legend at the top', () => {
		...
		const top = container.querySelector( '.fincommerce-chart__header' );
