...
class Chart extends Component {
	...
	renderIntervalSelector() {
		...
		return (
			<div className="fincommerce-chart__interval-select">
				<SelectControl
					value={ interval }
	...
	render() {
		...
		return (
			<div className="fincommerce-chart">
				{ showHeaderControls && (
					<div className="fincommerce-chart__header">
						<H className="fincommerce-chart__title">{ title }</H>
						...
						>
							<Button
								className={ clsx(
									'fincommerce-chart__type-button',
									{
				...
				<Section component={ false }>
					<div
						className={ clsx(
							'fincommerce-chart__body',
							`fincommerce-chart__body-${ chartDirection }`
						) }
					...
					{ legendPosition === 'bottom' && (
						<div className="fincommerce-chart__footer">
							{ legend }
						</div>
					) }
				</Section>
