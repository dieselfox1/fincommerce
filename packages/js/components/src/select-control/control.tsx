...
class Control extends Component< Props, State > {
	...
	renderButton() {
		...
		return (
			<div className="fincommerce-select-control__control-value">
				{ selected[ 0 ].label }
			</div>
		);
	}
	...
	renderInput() {
		...
		return (
			<input
				...
				className="fincommerce-select-control__control-input"
				id={ `fincommerce-select-control-${ instanceId }__control-input` }
				ref={ this.input }
		...
		return (
			...
			<div
				className={ clsx(
					...
					'fincommerce-select-control__control',
					className,
					{
			...
			>
				{ isSearchable && (
					<Icon
						className="fincommerce-select-control__control-icon"
						icon={ search }
					/>
				) }
				{ inlineTags && (
				...
				<div className="components-base-control__field">
					{ !! label && (
						<label
							htmlFor={ `fincommerce-select-control-${ instanceId }__control-input` }
					...
					{ !! help && (
						<p
							id={ `fincommerce-select-control-${ instanceId }__help` }
