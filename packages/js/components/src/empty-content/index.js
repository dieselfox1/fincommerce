...
class EmptyContent extends Component {
	renderIllustration() {
		...
		return (
			<img
				...
				className="fincommerce-empty-content__illustration"
			/>
		);
	}
	...
	renderActionButtons( type ) {
		...
		if ( actionURL && actionCallback ) {
			return (
				<Button
					className="fincommerce-empty-content__action"
	...
	renderActions() {
		...
		return (
			<div className="fincommerce-empty-content__actions">
	...
	render() {
		...
		return (
			<div className={ clsx( 'fincommerce-empty-content', className ) }>
				{ illustration && this.renderIllustration() }
				{ title ? (
					<H className="fincommerce-empty-content__title">
						{ title }
					</H>
				) : null }
				{ message ? (
					<p className="fincommerce-empty-content__message">
						{ message }
					</p>
				) : null }
