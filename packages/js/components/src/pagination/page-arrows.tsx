...
export function PageArrows( {
	...
	return (
		<div className="fincommerce-pagination__page-arrows">
			{ showPageArrowsLabel && (
				<span
					className="fincommerce-pagination__page-arrows-label"
					role="status"
					aria-live="polite"
				>
					{ sprintf(
						/* translators: 1: current page number, 2: total number of pages */
						__( 'Page %1$d of %2$d', 'fincommerce' ),
						currentPage,
						pageCount
					) }
				</span>
			) }
			<div className="fincommerce-pagination__page-arrows-buttons">
				<Button
					className={ previousLinkClass }
					disabled={ ! ( currentPage > 1 ) }
					onClick={ previousPage }
					label={ __( 'Previous Page', 'fincommerce' ) }
				>
				...
				<Button
					...
					onClick={ nextPage }
					label={ __( 'Next Page', 'fincommerce' ) }
				>
