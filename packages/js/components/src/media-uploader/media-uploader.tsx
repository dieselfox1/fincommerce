...
export const MediaUploader = ( {
	...
	buttonText = __( 'Choose images', 'fincommerce' ),
	buttonProps,
	hasDropZone = true,
	label = __( 'Drag images here or click to upload', 'fincommerce' ),
	...
	return (
		<FormFileUpload
			...
			render={ ( { openFileDialog } ) => (
				<div
					className="fincommerce-form-file-upload"
					onKeyPress={ () => {} }
					tabIndex={ 0 }
					role="button"
					onClick={ (
					...
					onBlur={ () => {} }
				>
					<div className="fincommerce-media-uploader">
						<div className="fincommerce-media-uploader__label">
							{ label }
						</div>
