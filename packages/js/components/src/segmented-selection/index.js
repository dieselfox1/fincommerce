...
class SegmentedSelection extends Component {
	render() {
		...
		return (
			<fieldset className="fincommerce-segmented-selection">
				<legend className="screen-reader-text">{ legend }</legend>
				<div
					className={ clsx(
						className,
						'fincommerce-segmented-selection__container'
					) }
				>
					{ options.map( ( { value, label } ) => {
						...
						return (
							<div
								className="fincommerce-segmented-selection__item"
								key={ value }
							>
								{ /* eslint-disable jsx-a11y/label-has-for */ }
								<input
									className="fincommerce-segmented-selection__input"
									type="radio"
									name={ name }
									id={ id }
								...
								/>
								<label htmlFor={ id }>
									<span className="fincommerce-segmented-selection__label">
										{ label }
									</span>
								</label>
