...
export const Menu = ( {
	...
	return (
		<div
			...
			className="fincommerce-experimental-select-control__menu"
		>
			<div>
				<Popover
					__unstableSlotName="fincommerce-select-control-menu"
					focusOnMount={ false }
					className={ clsx(
						'fincommerce-experimental-select-control__popover-menu',
						{
							'is-open': isOpen,
				...
				>
					<ul
						{ ...getMenuProps() }
						className={ clsx(
							'fincommerce-experimental-select-control__popover-menu-container',
							className
						) }
						onMouseUp={ ( e ) =>
