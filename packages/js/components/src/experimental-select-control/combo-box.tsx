...
const ToggleButton = forwardRef< HTMLButtonElement >( ( props, ref ) => {
	...
	return (
		<button
			className="fincommerce-experimental-select-control__combox-box-toggle-button"
			{ ...props }
			ref={ ref }
		>
	...
	return (
		...
		<div
			className={ clsx(
				...
				{
					'fincommerce-experimental-select-control__combo-box-wrapper--disabled':
						inputProps.disabled,
				}
			) }
			onMouseDown={ maybeFocusInput }
		>
			<div className="fincommerce-experimental-select-control__items-wrapper">
				{ children }
				<div
					{ ...comboBoxProps }
					className="fincommerce-experimental-select-control__combox-box"
				>
					<input
						{ ...inputProps }
						ref={ ( node ) => {
			...
			{ suffix && (
				<div className="fincommerce-experimental-select-control__suffix">
					{ suffix }
				</div>
			) }
			{ showToggleButton && (
