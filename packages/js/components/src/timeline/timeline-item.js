...
const TimelineItem = ( { item = {}, className = '', clockFormat } ) => {
	...
	return (
		<li className={ itemClassName }>
			<div className={ 'fincommerce-timeline-item__top-border' }></div>
			<div className={ 'fincommerce-timeline-item__title' }>
				<div className={ 'fincommerce-timeline-item__headline' }>
					{ item.icon }
					<span>{ item.headline }</span>
				</div>
				<span className={ 'fincommerce-timeline-item__timestamp' }>
					{ item.hideTimestamp || false ? null : itemTimeString }
				</span>
			</div>
			<div className={ 'fincommerce-timeline-item__body' }>
