...
const AdvancedFilterItem = ( props ) => {
	...
	return (
		<li className="fincommerce-filters-advanced__list-item">
			<FilterComponent
				className="fincommerce-filters-advanced__fieldset-item"
				currency={ currency }
				filter={ filterValue }
				config={ filterConfig }
			...
			<Button
				className={ clsx(
					'fincommerce-filters-advanced__line-item',
					'fincommerce-filters-advanced__remove'
				) }
				label={ labels.remove }
