...
const EllipsisMenu = ( {
	...
	const renderMenu = ( renderContentArgs: CallbackProps ) => (
		<NavigableMenu className="fincommerce-ellipsis-menu__content">
			{ renderContent( renderContentArgs ) }
		</NavigableMenu>
	);

	return (
		<div className={ clsx( className, 'fincommerce-ellipsis-menu' ) }>
			<Dropdown
				contentClassName="fincommerce-ellipsis-menu__popover"
