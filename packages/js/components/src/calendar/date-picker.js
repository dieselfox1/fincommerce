			...
			<Dropdown
				...
				renderToggle={ ( { isOpen, onToggle } ) => (
					<DateInput
						...
						label={ __( 'Choose a date', 'fincommerce' ) }
						error={ error }
						describedBy={ sprintf(
				...
				renderContent={ ( { onToggle } ) => (
					<Section component={ false }>
						<H className="fincommerce-calendar__date-picker-title">
							{ __( 'select a date', 'fincommerce' ) }
						</H>
						<div className="fincommerce-calendar__react-dates is-core-datepicker">
							<WpDatePicker
								currentDate={
