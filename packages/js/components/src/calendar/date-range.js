...
class DateRange extends Component {
	...
	render() {
		...
		return (
			<div
				className={ clsx( 'fincommerce-calendar', {
					'is-mobile': isViewportMobile,
				} ) }
			>
				<div className="fincommerce-calendar__inputs">
					<DateInput
						value={ afterText }
						onChange={ partial( this.onInputChange, 'after' ) }
						dateFormat={ shortDateFormat }
						label={ __( 'Start Date', 'fincommerce' ) }
						error={ afterError }
						describedBy={ sprintf(
					...
					/>
					<div className="fincommerce-calendar__inputs-to">
						{ __( 'to', 'fincommerce' ) }
					</div>
					<DateInput
						value={ beforeText }
				...
				<div
					className="fincommerce-calendar__react-dates"
					ref={ this.nodeRef }
