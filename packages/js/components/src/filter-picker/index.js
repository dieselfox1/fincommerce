...
class FilterPicker extends Component {
	...
	renderButton( filter, onClose, config ) {
		if ( filter.component ) {
			...
			return (
				<Search
					...
					className="fincommerce-filters-filter__search"
					type={ type }
		...
		return (
			<Button
				className="fincommerce-filters-filter__button"
				onClick={ onClick }
			>
				{ filter.label }
			</Button>
	...
	render() {
		...
		const selectedFilter = this.getFilter();
		return (
			<div className="fincommerce-filters-filter">
				{ config.label && (
					<span className="fincommerce-filters-label">
						{ config.label }:
					</span>
				) }
				<Dropdown
					contentClassName="fincommerce-filters-filter__content"
					popoverProps={ {
						placement: 'bottom',
					} }
					expandOnMobile
						...
						>
							{ () => (
								<ul className="fincommerce-filters-filter__content-list">
									{ parentFilter && (
										<li className="fincommerce-filters-filter__content-list-item">
											<Button
												className="fincommerce-filters-filter__button"
												onClick={ this.goBack }
											>
									...
									{ visibleFilters.map( ( filter ) => (
										<li
											key={ filter.value }
											className={ clsx(
												'fincommerce-filters-filter__content-list-item',
												{
													'is-selected':
