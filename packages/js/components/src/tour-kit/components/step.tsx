...
const Step = ( {
	...
	return (
		<Card
			...
			className="fincommerce-tour-kit-step"
			elevation={ 2 }
		>
			<CardHeader isBorderless={ true } size="small">
				<StepControls onDismiss={ onDismiss } />
			</CardHeader>
			<CardBody className="fincommerce-tour-kit-step__body" size="small">
				<h2 className="fincommerce-tour-kit-step__heading">
					{ heading }
				</h2>
				<p className="fincommerce-tour-kit-step__description">
					{ description }
				</p>
			</CardBody>
