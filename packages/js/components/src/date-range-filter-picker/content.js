		...
		return (
			<div>
				<H className="screen-reader-text" tabIndex="0">
					{ __( 'Select date range and comparison', 'fincommerce' ) }
				</H>
				<Section component={ false }>
					<H className="fincommerce-filters-date__text">
						{ __( 'select a date range', 'fincommerce' ) }
					</H>
					<TabPanel
						tabs={ [
							{
						...
						className="fincommerce-filters-date__tabs"
					...
					>
						{ ( selected ) => (
							<Fragment>
								...
								<div
									className={ clsx(
										'fincommerce-filters-date__content-controls',
										{
											'is-custom':
												selected.name === 'custom',
										}
								...
								>
									<H className="fincommerce-filters-date__text">
										{ __( 'compare to', 'fincommerce' ) }
									</H>
									<ComparePeriods
										onSelect={ onUpdate }
										compare={ compare }
									/>
									<div className="fincommerce-filters-date__button-group">
										{ selected.name === 'custom' && (
											<Button
												className="fincommerce-filters-date__button"
												isSecondary
