		...
		return (
			...
			<div
				className={ clsx(
					...
					'fincommerce-tree-select-control__control',
					{
			...
			>
				...
				<div className="components-base-control__field">
					<input
						ref={ ref }
						id={ `fincommerce-tree-select-control-${ instanceId }__control-input` }
						type="search"
						placeholder={ showPlaceholder ? placeholder : '' }
						autoComplete="off"
						className="fincommerce-tree-select-control__control-input"
						role="combobox"
