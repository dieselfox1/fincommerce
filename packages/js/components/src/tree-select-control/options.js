	...
	return options.map( ( option ) => {
		...
		return (
			<div
				...
				className={ clsx(
					'fincommerce-tree-select-control__node',
			...
			>
				<Flex justify="flex-start">
					{ ! isRoot && (
						<button
							className={ clsx(
								'fincommerce-tree-select-control__expander',
					...
					<Checkbox
						className={ clsx(
							...
							'fincommerce-tree-select-control__option',
				...
				{ hasChildren && expanded && (
					<div
						className={ clsx(
							'fincommerce-tree-select-control__children',
							isRoot && 'fincommerce-tree-select-control__main'
						) }
					>
						<Options
