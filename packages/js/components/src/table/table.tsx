		...
		>
			<table>
				<caption
					...
					className="fincommerce-table__caption screen-reader-text"
				>
					{ caption }
					{ tabIndex === 0 && (
						<small>
							{ __( '(scroll to see more)', 'fincommerce' ) }
						</small>
					) }
				</caption>
				<tbody>
					...
					{ hasData ? (
						...
						<tr>
							<td
								className="fincommerce-table__empty-item"
