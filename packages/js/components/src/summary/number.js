...
const SummaryNumber = ( {
	...
	labelTooltipText,
	onToggle,
	prevLabel = __( 'Previous period:', 'fincommerce' ),
	prevValue,
	reverseTrend = false,
	selected = false,
	value,
	...
	if ( ! delta ) {
		screenReaderLabel = sprintf(
			...
			__( 'No change from %s', 'fincommerce' ),
			prevLabel
		);
	}
	...
	return (
		<li className={ liClasses }>
			<Container { ...containerProps }>
				<div className="fincommerce-summary__item-label">
					...
					{ labelTooltipText && (
						<Tooltip
							...
							position="top center"
						>
							<div className="fincommerce-summary__info-tooltip">
								<Icon
									width={ 20 }
									height={ 20 }
									icon={ info }
				...
				<div className="fincommerce-summary__item-data">
					<div className="fincommerce-summary__item-value">
					...
					>
						<div
							className="fincommerce-summary__item-delta"
							role="presentation"
				...
				{ onToggle ? (
					<ChevronDownIcon
						className="fincommerce-summary__toggle"
						size={ 24 }
					/>
				) : null }
				{ children }
