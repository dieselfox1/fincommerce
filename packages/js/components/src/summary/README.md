...
`label` | String | `__( 'Performance Indicators', 'fincommerce' )` | An optional label of this group, read to screen reader users
...
`prevLabel` | String | `__( 'Previous period:', 'fincommerce' )` | A string description of the previous value's timeframe, ex "Previous year:"
