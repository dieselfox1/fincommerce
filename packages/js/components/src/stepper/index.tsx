...
export const Stepper = ( {
	...
	const renderCurrentStepContent = () => {
		...
		return (
			<div className="fincommerce-stepper_content">{ step.content }</div>
		);
	};
	...
	return (
		<div className={ stepperClassName }>
			<div className="fincommerce-stepper__steps">
				{ steps.map( ( step, i ) => {
					...
					const icon =
						isCurrentStep && isPending ? (
							...
							<div className="fincommerce-stepper__step-icon">
								<span className="fincommerce-stepper__step-number">
									{ i + 1 }
								</span>
								<CheckIcon />
							</div>
					...
					return (
						<Fragment key={ key }>
							<div className={ stepClassName }>
								<LabelWrapper
									className="fincommerce-stepper__step-label-wrapper"
									onClick={
								...
								>
									{ icon }
									<div className="fincommerce-stepper__step-text">
										<span className="fincommerce-stepper__step-label">
											{ label }
										</span>
										{ description && (
											<span className="fincommerce-stepper__step-description">
												{ description }
											</span>
										) }
									</div>
							...
							{ ! isVertical && (
								<div className="fincommerce-stepper__step-divider" />
							) }
						</Fragment>
					);
				} ) }
