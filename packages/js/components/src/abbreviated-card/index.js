...
const AbbreviatedCard = ( {
	...
	return (
		<Card className={ clsx( 'fincommerce-abbreviated-card', className ) }>
			<CardBody size={ null }>
				<Link href={ href } onClick={ onClick } type={ type }>
					<div className="fincommerce-abbreviated-card__icon">
						<Icon icon={ icon } />
					</div>
					<div className="fincommerce-abbreviated-card__content">
						{ children }
					</div>
				</Link>
			</CardBody>
