...
class SectionHeader extends Component {
	render() {
		...
		const className = clsx(
			'fincommerce-section-header',
			this.props.className
		);
		return (
			<div className={ className }>
				<H className="fincommerce-section-header__title fincommerce-section-header__header-item">
					{ title }
				</H>
				<hr role="presentation" />
				{ children && (
					<div className="fincommerce-section-header__actions fincommerce-section-header__header-item">
						{ children }
					</div>
				) }
				{ menu && (
					<div className="fincommerce-section-header__menu fincommerce-section-header__header-item">
						{ menu }
					</div>
				) }
			</div>
