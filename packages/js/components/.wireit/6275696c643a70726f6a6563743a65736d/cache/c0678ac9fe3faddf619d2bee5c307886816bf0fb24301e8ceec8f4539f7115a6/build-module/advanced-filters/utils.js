...
export function getInterpolatedString(interpolatedString) {
    ...
    if (replacedString !== interpolatedString) {
        deprecated('Old interpolation string format `{{element}}...{{/element}}` or `{{element/}}`', {
            since: '7.8',
 ...
 */
export function backwardsCompatibleCreateInterpolateElement(interpolatedString, conversionMap) {
    return createInterpolateElement(getInterpolatedString(interpolatedString), conversionMap);
}
