 ...
 */
const TextControl = withFocusOutside(class extends Component {
    constructor(props) {
        super(props);
        this.state = {
            isFocused: false,
    ...
    render() {
        ...
        return (createElement(BaseComponent, { className: clsx('muriel-component', 'muriel-input-text', className, {
                disabled,
                empty: isEmpty,
                active: isActive,
                'with-value': !isEmpty,
