...
import { attributes, countries, coupons, customers, downloadIps, emails, orders, product, productCategory, taxes, usernames, variableProduct, variations, } from './autocompleters';
/**
...
export class Search extends Component {
    ...
    render() {
        ...
        return (createElement("div", null,
            createElement(SelectControl, { className: clsx('fincommerce-search', className, {
