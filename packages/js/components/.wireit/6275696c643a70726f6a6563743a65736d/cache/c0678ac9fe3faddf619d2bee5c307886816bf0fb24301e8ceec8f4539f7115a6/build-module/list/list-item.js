...
function ListItem(props) {
    ...
    return (createElement(InnerTag, { ...innerTagProps },
        before && (createElement("div", { className: "fincommerce-list__item-before" }, before)),
        createElement("div", { className: "fincommerce-list__item-text" },
            createElement("span", { className: "fincommerce-list__item-title" }, title),
            content && (createElement("span", { className: "fincommerce-list__item-content" }, content))),
        after && (createElement("div", { className: "fincommerce-list__item-after" }, after))));
}
ListItem.propTypes = {
    /**
