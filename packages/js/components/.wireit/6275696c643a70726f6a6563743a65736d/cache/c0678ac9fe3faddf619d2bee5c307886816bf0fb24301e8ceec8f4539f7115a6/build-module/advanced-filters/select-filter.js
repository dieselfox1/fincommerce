...
import { getDefaultOptionValue } from '@fincommerce/navigation';
/**
...
class SelectFilter extends Component {
    ...
    getScreenReaderText(filter, config) {
        ...
        return textContent(createInterpolateElement(config.labels.title, {
            filter: createElement(Fragment, null, value.label),
    ...
    render() {
        ...
        const children = createInterpolateElement(labels.title, {
            ...
            rule: (createElement(SelectControl, { className: clsx(className, 'fincommerce-filters-advanced__rule'), options: rules, value: rule, onChange: (selectedValue) => onFilterChange({
                    property: 'rule',
                    value: selectedValue,
                }), "aria-label": labels.rule })),
            filter: options ? (createElement(SelectControl, { className: clsx(className, 'fincommerce-filters-advanced__input'), options: options, value: value, onChange: (selectedValue) => onFilterChange({
                    property: 'value',
                    value: selectedValue,
                }), "aria-label": labels.filter })) : (createElement(Spinner, null)),
        });
