...
class TextControlWithAffixes extends Component {
    ...
    render() {
        ...
        return (createElement(BaseControl, { label: label, id: id, help: help, className: baseControlClasses, onClick: (event) => this.handleOnClick(event, onClick) },
            createElement("div", { className: affixesClasses },
                prefix && (createElement("span", { id: `${id}__prefix`, className: "text-control-with-affixes__prefix" }, prefix)),
                createElement("input", { className: "components-text-control__input", type: type, id: id, value: value, onChange: onChangeValue, "aria-describedby": describedby.join(' '), disabled: disabled, onFocus: () => this.setState({ isFocused: true }), ...props }),
                suffix && (createElement("span", { id: `${id}__suffix`, className: "text-control-with-affixes__suffix" }, suffix)))));
    }
}
