...
declare class ReportFilters extends Component<any, any, any> {
    ...
    getDateQuery(query: any): {
        ...
        primaryDate: import("@fincommerce/date").DataPickerOptions;
        secondaryDate: import("@fincommerce/date").DataPickerOptions;
    };
    render(): JSX.Element;
}
declare namespace ReportFilters {
    namespace propTypes {
        ...
        let advancedFilters: PropTypes.Requireable<object>;
        let filters: PropTypes.Requireable<any[]>;
        let path: PropTypes.Validator<string>;
        let query: PropTypes.Requireable<object>;
        let showDatePicker: PropTypes.Requireable<boolean>;
        let onDateSelect: PropTypes.Requireable<(...args: any[]) => any>;
        let onFilterSelect: PropTypes.Requireable<(...args: any[]) => any>;
        let onAdvancedFilterAction: PropTypes.Requireable<(...args: any[]) => any>;
        let currency: PropTypes.Requireable<object>;
        let dateQuery: PropTypes.Requireable<PropTypes.InferProps<{
            ...
            primaryDate: PropTypes.Validator<NonNullable<PropTypes.InferProps<{
        ...
        let isoDateFormat: PropTypes.Requireable<string>;
    }
