...
export type FormProps<Values> = {
    ...
    onChange?: (value: {
        name: string;
        value: any;
    }, values: Values, isValid: boolean) => void;
    /**
...
export type InputProps<Values, Value> = {
    ...
    checked: boolean;
    selected?: Value;
    onChange: (value: ChangeEvent<HTMLInputElement> | Values[keyof Values]) => void;
    onBlur: () => void;
    className: string | undefined;
    help?: React.ReactNode;
};
export type CheckboxProps<Values, Value> = Omit<InputProps<Values, Value>, 'value' | 'selected'>;
export type SelectControlProps<Values, Value> = Omit<InputProps<Values, Value>, 'value'> & {
...
export type FormContextType<Values extends Record<string, any> = any> = {
    ...
    getCheckboxControlProps: <P extends keyof Values>(name: P, inputProps?: ConsumerInputProps<Values>) => CheckboxProps<Values, Values[P]>;
    getInputProps: <P extends keyof Values>(name: P, inputProps?: ConsumerInputProps<Values>) => InputProps<Values, Values[P]>;
    getSelectControlProps: <P extends keyof Values>(name: P, inputProps?: ConsumerInputProps<Values>) => SelectControlProps<Values, Values[P]>;
    resetForm: (newInitialValues?: Values, newTouchedFields?: {
        [P in keyof Values]?: boolean | undefined;
    } | undefined, newErrors?: FormErrors<Values>) => void;
};
