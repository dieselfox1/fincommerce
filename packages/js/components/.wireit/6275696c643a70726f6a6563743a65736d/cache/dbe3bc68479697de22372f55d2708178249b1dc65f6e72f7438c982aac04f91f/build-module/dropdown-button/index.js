...
const DropdownButton = (props) => {
    ...
    const buttonClasses = clsx('fincommerce-dropdown-button', {
        'is-open': isOpen,
        'is-multi-line': labels.length > 1,
    });
    return (createElement(Button, { className: buttonClasses, "aria-expanded": isOpen, ...otherProps },
        createElement("div", { className: "fincommerce-dropdown-button__labels" }, labels.map((label, i) => (createElement("span", { key: i }, decodeEntities(label)))))));
};
