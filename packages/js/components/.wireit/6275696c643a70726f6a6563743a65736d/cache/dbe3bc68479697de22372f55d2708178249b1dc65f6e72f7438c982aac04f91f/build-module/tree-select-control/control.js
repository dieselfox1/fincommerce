 ...
 */
const Control = forwardRef(({ tags = [], instanceId, placeholder, isExpanded, disabled, maxVisibleTags, value = '', onFocus = () => { }, onTagsChange = () => { }, onInputChange = () => { }, onControlClick = noop, alwaysShowPlaceholder = false, }, ref) => {
     ...
     * https://github.com/dieselfox1/fincommerce-admin/blob/main/packages/components/src/select-control/control.js#L200
     */
    /* eslint-disable jsx-a11y/no-static-element-interactions, jsx-a11y/click-events-have-key-events */
    createElement("div", { className: clsx('components-base-control', 'fincommerce-tree-select-control__control', {
        ...
        hasTags && (createElement(Tags, { disabled: disabled, tags: tags, maxVisibleTags: maxVisibleTags, onChange: onTagsChange })),
        createElement("div", { className: "components-base-control__field" },
            createElement("input", { ref: ref, id: `fincommerce-tree-select-control-${instanceId}__control-input`, type: "search", placeholder: showPlaceholder ? placeholder : '', autoComplete: "off", className: "fincommerce-tree-select-control__control-input", role: "combobox", "aria-autocomplete": "list", value: value, "aria-expanded": isExpanded, disabled: disabled, onFocus: onFocus, onChange: onInputChange, onKeyDown: handleKeydown }))));
});
