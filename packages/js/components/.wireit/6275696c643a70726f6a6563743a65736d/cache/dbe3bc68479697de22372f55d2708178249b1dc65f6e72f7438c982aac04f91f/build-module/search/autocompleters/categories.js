...
const completer = {
    ...
    getFreeTextOptions(query) {
        const label = (createElement("span", { key: "name", className: "fincommerce-search__result-name" }, interpolateComponents({
            mixedString: __('All categories with titles that include {{query /}}', 'fincommerce'),
            components: {
    ...
    getOptionLabel(cat, query) {
        ...
        return (createElement("span", { key: "name", className: "fincommerce-search__result-name", "aria-label": cat.name },
