...
class SearchFilter extends Component {
    ...
    render() {
        ...
        const children = createInterpolateElement(labels.title, {
            ...
            filter: (createElement(Search, { className: clsx(className, 'fincommerce-filters-advanced__input'), onChange: this.onSearchChange, type: input.type, autocompleter: input.autocompleter, placeholder: labels.placeholder, selected: selected, inlineTags: true, "aria-label": labels.filter })),
        });
