...
const Flag = ({ code, order, className, size, hideFromScreenReader }) => {
    const classes = clsx('fincommerce-flag', className);
    ...
    return (createElement("div", { className: classes, style: inlineStyles, "aria-hidden": hideFromScreenReader },
        emoji && createElement("span", null, emoji),
        !emoji && (createElement("span", { className: "fincommerce-flag__fallback" }, "Invalid country flag"))));
};
Flag.propTypes = {
    /**
