...
class SegmentedSelection extends Component {
    render() {
        ...
        return (createElement("fieldset", { className: "fincommerce-segmented-selection" },
            createElement("legend", { className: "screen-reader-text" }, legend),
            createElement("div", { className: clsx(className, 'fincommerce-segmented-selection__container') }, options.map(({ value, label }) => {
                if (!value || !label) {
                    return null;
                }
                const id = uniqueId(`${value}_`);
                return (createElement("div", { className: "fincommerce-segmented-selection__item", key: value },
                    createElement("input", { className: "fincommerce-segmented-selection__input", type: "radio", name: name, id: id, checked: selected === value, onChange: partial(onSelect, {
                            [name]: value,
                        }) }),
                    createElement("label", { htmlFor: id },
                        createElement("span", { className: "fincommerce-segmented-selection__label" }, label))));
            }))));
    }
}
