...
class WebPreview extends Component {
    ...
    render() {
        ...
        const classes = clsx('fincommerce-web-preview', className, {
            'is-loading': isLoading,
        });
        return (createElement("div", { className: classes },
            isLoading && loadingContent,
            createElement("div", { className: "fincommerce-web-preview__iframe-wrapper" },
                createElement("iframe", { ref: this.iframeRef, title: title, src: src }))));
    }
}
...
WebPreview.defaultProps = {
    loadingContent: createElement(Spinner, null),
    onLoad: noop,
};
