...
class Control extends Component {
    ...
    renderButton() {
        ...
        return (createElement("div", { className: "fincommerce-select-control__control-value" }, selected[0].label));
    }
    renderInput() {
    ...
    getInputValue() {
        ...
        const selectedValue = isArray(selected) &&
            selected.length &&
    ...
    render() {
        ...
        createElement("div", { className: clsx('components-base-control', 'fincommerce-select-control__control', className, {
            ...
            isSearchable && (createElement(Icon, { className: "fincommerce-select-control__control-icon", icon: search })),
            inlineTags && (createElement(Tags, { onChange: onChange, showClearButton: showClearButton, selected: this.props.selected })),
            createElement("div", { className: "components-base-control__field" },
                !!label && (createElement("label", { htmlFor: `fincommerce-select-control-${instanceId}__control-input`, className: "components-base-control__label" }, label)),
                this.renderInput(),
                inlineTags && (createElement("span", { id: `search-inline-input-${instanceId}`, className: "screen-reader-text" }, __('Move backward for selected items', 'fincommerce'))),
                !!help && (createElement("p", { id: `fincommerce-select-control-${instanceId}__help`, className: "components-base-control__help" }, help))))
