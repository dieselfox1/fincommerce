 ...
 * @return {Object} -
 */
const SummaryList = ({ children, isDropdownBreakpoint, label = (0, i18n_1.__)('Performance Indicators', 'fincommerce'), }) => {
    ...
    return ((0, element_1.createElement)(components_1.Dropdown, { className: "fincommerce-summary", popoverProps: {
            placement: 'bottom',
