...
class D3Base extends element_1.Component {
    ...
    render() {
        ...
        return ((0, element_1.createElement)("div", { className: (0, clsx_1.default)('d3-base', className), ref: this.chartRef, onScroll: this.delayedScroll() }));
    }
}
...
D3Base.propTypes = {
    ...
    orderedKeys: prop_types_1.default.array, // required to detect changes in data
