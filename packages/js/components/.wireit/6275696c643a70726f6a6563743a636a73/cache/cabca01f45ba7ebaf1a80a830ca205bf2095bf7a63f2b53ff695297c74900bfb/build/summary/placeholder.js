...
const SummaryNumberPlaceholder = ({ className }) => ((0, element_1.createElement)("li", { "data-testid": "summary-placeholder", className: (0, clsx_1.default)('fincommerce-summary__item-container is-placeholder', className) },
    (0, element_1.createElement)("div", { className: "fincommerce-summary__item" },
        ...
        (0, element_1.createElement)("div", { className: "fincommerce-summary__item-data" },
            ...
            (0, element_1.createElement)("div", { className: "fincommerce-summary__item-delta" })))));
...
class SummaryListPlaceholder extends element_1.Component {
    render() {
        ...
        const classes = (0, clsx_1.default)('fincommerce-summary', {
