...
function List(props) {
    ...
    const listClassName = (0, clsx_1.default)('fincommerce-list', className);
    ...
    return ((0, element_1.createElement)(react_transition_group_1.TransitionGroup, { component: "ul", className: listClassName, role: "menu" }, items.map((item, index) => {
        ...
        const itemClassName = (0, clsx_1.default)('fincommerce-list__item', itemClasses, {
            'has-action': hasAction,
        });
        return ((0, element_1.createElement)(react_transition_group_1.CSSTransition, { key: key || index, timeout: 500, classNames: "fincommerce-list__item" },
