...
const shortDateFormat = (0, i18n_1.__)('MM/DD/YYYY', 'fincommerce');
/**
...
class DateRangeFilterPicker extends element_1.Component {
    ...
    getButtonLabel() {
        ...
        return [
            ...
            `${(0, i18n_1.__)('vs.', 'fincommerce')} ${secondaryDate.label} (${secondaryDate.range})`,
        ];
    }
