...
class ReportFilters extends element_1.Component {
    ...
    renderCard(config) {
        ...
        if (query[param].indexOf('compare') === 0) {
            ...
            return ((0, element_1.createElement)("div", { key: param, className: "fincommerce-filters__advanced-filters" },
                (0, element_1.createElement)(compare_filter_1.CompareFilter, { path: path, query: query, ...settings })));
        }
    ...
    render() {
        ...
        return ((0, element_1.createElement)(element_1.Fragment, null,
            (0, element_1.createElement)(section_1.H, { className: "screen-reader-text" }, (0, i18n_1.__)('Filters', 'fincommerce')),
            (0, element_1.createElement)(section_1.Section, { component: "div", className: "fincommerce-filters" },
                (0, element_1.createElement)("div", { className: "fincommerce-filters__basic-filters" },
...
ReportFilters.defaultProps = {
    ...
    showDatePicker: true,
    onDateSelect: () => { },
    currency: (0, currency_1.CurrencyFactory)().getCurrencyConfig(),
};
