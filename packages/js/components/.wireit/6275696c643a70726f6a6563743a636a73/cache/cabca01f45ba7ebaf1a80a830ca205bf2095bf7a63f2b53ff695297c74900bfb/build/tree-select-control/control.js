 ...
 */
const Control = (0, element_1.forwardRef)(({ tags = [], instanceId, placeholder, isExpanded, disabled, maxVisibleTags, value = '', onFocus = () => { }, onTagsChange = () => { }, onInputChange = () => { }, onControlClick = lodash_1.noop, alwaysShowPlaceholder = false, }, ref) => {
    ...
    (0, element_1.createElement)("div", { className: (0, clsx_1.default)('components-base-control', 'fincommerce-tree-select-control__control', {
