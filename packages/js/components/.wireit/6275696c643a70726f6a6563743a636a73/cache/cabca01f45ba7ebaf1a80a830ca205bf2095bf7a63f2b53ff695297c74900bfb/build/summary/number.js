 ...
 * @return {Object} -
 */
const SummaryNumber = ({ children, delta, href = '', hrefType = 'wc-admin', isOpen = false, label, labelTooltipText, onToggle, prevLabel = (0, i18n_1.__)('Previous period:', 'fincommerce'), prevValue, reverseTrend = false, selected = false, value, onLinkClickCallback = lodash_1.noop, }) => {
    const liClasses = (0, clsx_1.default)('fincommerce-summary__item-container', {
        'is-dropdown-button': onToggle,
        'is-dropdown-expanded': isOpen,
    });
    const classes = (0, clsx_1.default)('fincommerce-summary__item', {
    ...
    let screenReaderLabel = delta > 0
        ? // eslint-disable-next-line @wordpress/valid-sprintf -- false positive from %%
            ...
            (0, i18n_1.__)('Up %f%% from %s', 'fincommerce'), delta, prevLabel)
        : // eslint-disable-next-line @wordpress/valid-sprintf -- false positive from %%
            (0, i18n_1.sprintf)(
            /* translators: percentage change downwards */
            (0, i18n_1.__)('Down %f%% from %s', 'fincommerce'), Math.abs(delta), prevLabel);
    if (!delta) {
        screenReaderLabel = (0, i18n_1.sprintf)(
        /* translators: previous value */
        (0, i18n_1.__)('No change from %s', 'fincommerce'), prevLabel);
    }
    let Container;
    ...
    return ((0, element_1.createElement)("li", { className: liClasses },
        (0, element_1.createElement)(Container, { ...containerProps },
            (0, element_1.createElement)("div", { className: "fincommerce-summary__item-label" },
                ...
                labelTooltipText && ((0, element_1.createElement)(components_1.Tooltip, { text: labelTooltipText, position: "top center" },
                    (0, element_1.createElement)("div", { className: "fincommerce-summary__info-tooltip" },
                        (0, element_1.createElement)(icons_1.Icon, { width: 20, height: 20, icon: icons_1.info }))))),
            (0, element_1.createElement)("div", { className: "fincommerce-summary__item-data" },
                (0, element_1.createElement)("div", { className: "fincommerce-summary__item-value" },
                    (0, element_1.createElement)(experimental_1.Text, { variant: "title.small", size: "20", lineHeight: "28px" }, !(0, lodash_1.isNil)(value)
                        ? value
                        : (0, i18n_1.__)('N/A', 'fincommerce'))),
                (0, element_1.createElement)(components_1.Tooltip, { text: !(0, lodash_1.isNil)(prevValue)
                        ? `${prevLabel} ${prevValue}`
                        : (0, i18n_1.__)('N/A', 'fincommerce'), position: "top center" },
                    (0, element_1.createElement)("div", { className: "fincommerce-summary__item-delta", role: "presentation", "aria-label": screenReaderLabel },
                        (0, element_1.createElement)(experimental_1.Text, { variant: "caption", size: "12", lineHeight: "16px" }, !(0, lodash_1.isNil)(delta)
                            ? // eslint-disable-next-line @wordpress/valid-sprintf -- false positive from %%
                                ...
                                (0, i18n_1.__)('%f%%', 'fincommerce'), delta)
                            : (0, i18n_1.__)('N/A', 'fincommerce'))))),
            onToggle ? ((0, element_1.createElement)(chevron_down_1.default, { className: "fincommerce-summary__toggle", size: 24 })) : null,
            children)));
};
