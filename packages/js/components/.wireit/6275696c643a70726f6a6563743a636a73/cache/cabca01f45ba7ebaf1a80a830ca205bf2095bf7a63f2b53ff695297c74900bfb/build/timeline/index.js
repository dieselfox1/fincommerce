...
dateFormat = (0, i18n_1.__)('F j, Y', 'fincommerce'), 
/* translators: PHP clock format string used to display times, see php.net/date. */
clockFormat = (0, i18n_1.__)('g:ia', 'fincommerce'), }) => {
    const timelineClassName = (0, clsx_1.default)('fincommerce-timeline', className);
    ...
    if (!items || items.length === 0) {
        return ((0, element_1.createElement)("div", { className: timelineClassName },
            (0, element_1.createElement)("p", { className: 'timeline_no_events' }, (0, i18n_1.__)('No data to display', 'fincommerce'))));
    }
    const addGroupTitles = (group) => {
        return {
            ...group,
            title: (0, date_1.format)(dateFormat, group.date),
        };
    };
    return ((0, element_1.createElement)("div", { className: timelineClassName },
