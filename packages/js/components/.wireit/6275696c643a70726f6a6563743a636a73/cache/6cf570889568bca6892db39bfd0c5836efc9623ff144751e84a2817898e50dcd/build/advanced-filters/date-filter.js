...
const dateStringFormat = (0, i18n_1.__)('MMM D, YYYY', 'fincommerce');
const dateFormat = (0, i18n_1.__)('MM/DD/YYYY', 'fincommerce');
class DateFilter extends element_1.Component {
    ...
    getBetweenString() {
        return (0, i18n_1._x)('<after/><span> and </span><before/>', 'Date range inputs arranged on a single line', 'fincommerce');
    }
    ...
    render() {
        ...
        const children = (0, utils_1.backwardsCompatibleCreateInterpolateElement)(labels.title, {
            ...
            rule: ((0, element_1.createElement)(components_1.SelectControl, { className: (0, clsx_1.default)(className, 'fincommerce-filters-advanced__rule'), options: rules, value: rule, onChange: this.onRuleChange, "aria-label": labels.rule })),
