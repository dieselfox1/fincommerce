...
const OrderStatus = ({ order: { status }, className, orderStatusMap, labelPositionToLeft = false, }) => {
    const indicatorClasses = (0, clsx_1.default)('fincommerce-order-status__indicator', {
        ['is-' + status]: true,
    });
    const label = orderStatusMap[status] || status;
    return ((0, element_1.createElement)("div", { className: (0, clsx_1.default)('fincommerce-order-status', className) }, labelPositionToLeft ? ((0, element_1.createElement)(element_1.Fragment, null,
        label,
