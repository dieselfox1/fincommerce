...
const DynamicForm = ({ fields: baseFields = [], isBusy = false, onSubmit = () => { }, onChange = () => { }, validate = () => ({}), submitLabel = (0, i18n_1.__)('Proceed', 'fincommerce'), }) => {
    ...
    (0, element_1.createElement)(index_1.Form, { initialValues: initialValues, onChange: onChange, onSubmit: onSubmit, validate: validate }, ({ getInputProps, handleSubmit, }) => {
        return ((0, element_1.createElement)("div", { className: "fincommerce-component_dynamic-form" },
            fields.map((field) => {
                if (field.type &&
