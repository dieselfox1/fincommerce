...
class SelectFilter extends element_1.Component {
    ...
    render() {
        ...
        const children = (0, utils_1.backwardsCompatibleCreateInterpolateElement)(labels.title, {
            ...
            filter: options ? ((0, element_1.createElement)(components_1.SelectControl, { className: (0, clsx_1.default)(className, 'fincommerce-filters-advanced__input'), options: options, value: value, onChange: (selectedValue) => onFilterChange({
                    property: 'value',
                    value: selectedValue,
