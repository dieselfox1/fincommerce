...
class DatePickerContent extends element_1.Component {
    ...
    render() {
        ...
        return ((0, element_1.createElement)("div", null,
            (0, element_1.createElement)(section_1.H, { className: "screen-reader-text", tabIndex: "0" }, (0, i18n_1.__)('Select date range and comparison', 'fincommerce')),
            (0, element_1.createElement)(section_1.Section, { component: false },
                (0, element_1.createElement)(section_1.H, { className: "fincommerce-filters-date__text" }, (0, i18n_1.__)('select a date range', 'fincommerce')),
                (0, element_1.createElement)(components_1.TabPanel, { tabs: [
                        {
                            name: 'period',
                            title: (0, i18n_1.__)('Presets', 'fincommerce'),
                            className: 'fincommerce-filters-date__tab',
                        },
                        {
                            name: 'custom',
                            title: (0, i18n_1.__)('Custom', 'fincommerce'),
                            className: 'fincommerce-filters-date__tab',
                        },
                    ], className: "fincommerce-filters-date__tabs", activeClass: "is-active", initialTabName: period === 'custom' ? 'custom' : 'period', onSelect: this.onTabSelect }, (selected) => ((0, element_1.createElement)(element_1.Fragment, null,
                    ...
                    (0, element_1.createElement)("div", { className: (0, clsx_1.default)('fincommerce-filters-date__content-controls', {
                            'is-custom': selected.name === 'custom',
                        }), ref: this.controlsRef },
                        (0, element_1.createElement)(section_1.H, { className: "fincommerce-filters-date__text" }, (0, i18n_1.__)('compare to', 'fincommerce')),
                        (0, element_1.createElement)(compare_periods_1.default, { onSelect: onUpdate, compare: compare }),
                        (0, element_1.createElement)("div", { className: "fincommerce-filters-date__button-group" },
                            selected.name === 'custom' && ((0, element_1.createElement)(components_1.Button, { className: "fincommerce-filters-date__button", isSecondary: true, onClick: resetCustomValues, disabled: !(after || before) }, (0, i18n_1.__)('Reset', 'fincommerce'))),
                            isValidSelection(selected.name) ? ((0, element_1.createElement)(components_1.Button, { className: "fincommerce-filters-date__button", onClick: onSelect(selected.name, onClose), isPrimary: true }, (0, i18n_1.__)('Update', 'fincommerce'))) : ((0, element_1.createElement)(components_1.Button, { className: "fincommerce-filters-date__button", isPrimary: true, disabled: true }, (0, i18n_1.__)('Update', 'fincommerce')))))))))));
    }
}
