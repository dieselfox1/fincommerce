...
class SegmentedSelection extends element_1.Component {
    render() {
        ...
        return ((0, element_1.createElement)("fieldset", { className: "fincommerce-segmented-selection" },
            (0, element_1.createElement)("legend", { className: "screen-reader-text" }, legend),
            (0, element_1.createElement)("div", { className: (0, clsx_1.default)(className, 'fincommerce-segmented-selection__container') }, options.map(({ value, label }) => {
                if (!value || !label) {
                    return null;
                }
                const id = (0, lodash_1.uniqueId)(`${value}_`);
                return ((0, element_1.createElement)("div", { className: "fincommerce-segmented-selection__item", key: value },
                    (0, element_1.createElement)("input", { className: "fincommerce-segmented-selection__input", type: "radio", name: name, id: id, checked: selected === value, onChange: (0, lodash_1.partial)(onSelect, {
                            [name]: value,
                        }) }),
                    (0, element_1.createElement)("label", { htmlFor: id },
                        (0, element_1.createElement)("span", { className: "fincommerce-segmented-selection__label" }, label))));
            }))));
    }
}
