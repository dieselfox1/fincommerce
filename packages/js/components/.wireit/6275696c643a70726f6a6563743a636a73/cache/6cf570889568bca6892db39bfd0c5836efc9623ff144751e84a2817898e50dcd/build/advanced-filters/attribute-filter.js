...
const getScreenReaderText = ({ attributeTerms, config, filter, selectedAttribute, selectedAttributeTerm, }) => {
    ...
    (0, i18n_1.__)('<attribute/> <equals/> <value/>', 'fincommerce'), {
...
const AttributeFilter = (props) => {
    ...
    return ((0, element_1.createElement)("fieldset", { className: "fincommerce-filters-advanced__line-item", tabIndex: "0" },
        ...
        (0, element_1.createElement)("div", { className: (0, clsx_1.default)('fincommerce-filters-advanced__fieldset', {
            ...
            rule: ((0, element_1.createElement)(components_1.SelectControl, { className: (0, clsx_1.default)(className, 'fincommerce-filters-advanced__rule'), options: rules, value: rule, onChange: (selectedValue) => onFilterChange({
                    property: 'rule',
                    value: selectedValue,
                }), "aria-label": labels.rule })),
            filter: ((0, element_1.createElement)("div", { className: (0, clsx_1.default)(className, 'fincommerce-filters-advanced__attribute-fieldset') },
                !Array.isArray(value) ||
                    !value.length ||
                    selectedAttribute.length ? ((0, element_1.createElement)(search_1.default, { className: "fincommerce-filters-advanced__input fincommerce-search", onChange: ([attr]) => {
                    ...
                    }, type: "attributes", placeholder: (0, i18n_1.__)('Attribute name', 'fincommerce'), multiple: false, selected: selectedAttribute, inlineTags: true, "aria-label": (0, i18n_1.__)('Attribute name', 'fincommerce') })) : ((0, element_1.createElement)(components_1.Spinner, null)),
                selectedAttribute.length > 0 &&
                    (attributeTerms.length ? ((0, element_1.createElement)(element_1.Fragment, null,
                        (0, element_1.createElement)("span", { className: "fincommerce-filters-advanced__attribute-field-separator" }, "="),
                        (0, element_1.createElement)(select_control_1.default, { className: "fincommerce-filters-advanced__input fincommerce-search", placeholder: (0, i18n_1.__)('Attribute value', 'fincommerce'), inlineTags: true, isSearchable: true, multiple: false, showAllOnFocus: true, options: attributeTerms, selected: selectedAttributeTerm, onChange: (term) => {
