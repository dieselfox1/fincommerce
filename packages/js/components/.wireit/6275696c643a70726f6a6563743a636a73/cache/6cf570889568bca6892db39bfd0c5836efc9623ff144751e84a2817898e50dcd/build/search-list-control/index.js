...
const defaultMessages = {
    clear: (0, i18n_1.__)('Clear all selected items', 'fincommerce'),
    noItems: (0, i18n_1.__)('No items found.', 'fincommerce'),
    /* translators: %s: search term */
    noResults: (0, i18n_1.__)('No results for %s', 'fincommerce'),
    search: (0, i18n_1.__)('Search for items', 'fincommerce'),
    selected: (n) => (0, i18n_1.sprintf)(
    /* translators: Number of items selected from list. */
    (0, i18n_1._n)('%d item selected', '%d items selected', n, 'fincommerce'), n),
    updated: (0, i18n_1.__)('Search results updated.', 'fincommerce'),
};
/**
...
const SearchListControl = (props) => {
    ...
    const renderListSection = () => {
        if (isLoading) {
            return ((0, element_1.createElement)("div", { className: "fincommerce-search-list__list is-loading" },
                (0, element_1.createElement)(components_1.Spinner, null)));
        }
        const list = getFilteredList(props.list, searchValue);
        if (!list.length) {
            return ((0, element_1.createElement)("div", { className: "fincommerce-search-list__list is-not-found" },
                (0, element_1.createElement)("span", { className: "fincommerce-search-list__not-found-icon" },
                    (0, element_1.createElement)(notice_outline_1.default, { role: "img", "aria-hidden": "true", focusable: "false" })),
                (0, element_1.createElement)("span", { className: "fincommerce-search-list__not-found-text" }, searchValue
                    ? // eslint-disable-next-line @wordpress/valid-sprintf
                        (0, i18n_1.sprintf)(messages.noResults || '', searchValue)
                    : messages.noItems)));
        }
        return ((0, element_1.createElement)("ul", { className: "fincommerce-search-list__list" }, renderList(list)));
    };
    const renderSelectedSection = () => {
        ...
        return ((0, element_1.createElement)("div", { className: "fincommerce-search-list__selected" },
            (0, element_1.createElement)("div", { className: "fincommerce-search-list__selected-header" },
                (0, element_1.createElement)("strong", null, messages.selected(selectedCount)),
                selectedCount > 0 ? ((0, element_1.createElement)(components_1.Button, { isLink: true, isDestructive: true, onClick: onChange([]), "aria-label": messages.clear }, (0, i18n_1.__)('Clear all', 'fincommerce'))) : null),
    ...
    return ((0, element_1.createElement)("div", { className: (0, clsx_1.default)('fincommerce-search-list', className, {
            'is-compact': isCompact,
        }) },
        renderSelectedSection(),
        (0, element_1.createElement)("div", { className: "fincommerce-search-list__search" },
