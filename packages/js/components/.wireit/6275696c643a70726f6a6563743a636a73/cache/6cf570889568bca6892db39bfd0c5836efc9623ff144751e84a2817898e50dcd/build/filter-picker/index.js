...
class FilterPicker extends element_1.Component {
    ...
    renderButton(filter, onClose, config) {
        if (filter.component) {
            ...
            const selectedTag = persistedFilter.value === filter.value
                ...
                : null;
            return ((0, element_1.createElement)(search_1.default, { autocompleter: autocompleter, className: "fincommerce-filters-filter__search", type: type, placeholder: labels.placeholder, selected: selectedTag ? [selectedTag] : [], onChange: (0, lodash_1.partial)(this.onTagChange, filter, onClose, config), inlineTags: true, staticResults: true }));
        }
        ...
        return ((0, element_1.createElement)(components_1.Button, { className: "fincommerce-filters-filter__button", onClick: onClick }, filter.label));
    }
    ...
    render() {
        ...
        const parentFilter = nav.length
            ...
            : false;
        const selectedFilter = this.getFilter();
        return ((0, element_1.createElement)("div", { className: "fincommerce-filters-filter" },
            config.label && ((0, element_1.createElement)("span", { className: "fincommerce-filters-label" },
                config.label,
                ":")),
            (0, element_1.createElement)(components_1.Dropdown, { contentClassName: "fincommerce-filters-filter__content", popoverProps: {
                    placement: 'bottom',
                }, expandOnMobile: true, headerTitle: (0, i18n_1.__)('filter report to show:', 'fincommerce'), renderToggle: ({ isOpen, onToggle }) => ((0, element_1.createElement)(dropdown_button_1.default, { onClick: onToggle, isOpen: isOpen, labels: this.getButtonLabel(selectedFilter) })), renderContent: ({ onClose }) => ((0, element_1.createElement)(animation_slider_1.default, { animationKey: nav, animate: animate, onExited: this.onContentMount }, () => ((0, element_1.createElement)("ul", { className: "fincommerce-filters-filter__content-list" },
                    parentFilter && ((0, element_1.createElement)("li", { className: "fincommerce-filters-filter__content-list-item" },
                        (0, element_1.createElement)(components_1.Button, { className: "fincommerce-filters-filter__button", onClick: this.goBack },
                            (0, element_1.createElement)(icons_1.Icon, { icon: icons_1.chevronLeft }),
                            parentFilter.label))),
                    visibleFilters.map((filter) => ((0, element_1.createElement)("li", { key: filter.value, className: (0, clsx_1.default)('fincommerce-filters-filter__content-list-item', {
