...
const TimelineGroup = ({ group = { title: '', items: [] }, className = '', orderBy = 'desc', clockFormat, }) => {
    const groupClassName = (0, clsx_1.default)('fincommerce-timeline-group', className);
    ...
    return ((0, element_1.createElement)("li", { className: groupClassName },
        (0, element_1.createElement)("p", { className: 'fincommerce-timeline-group__title' }, group.title),
