...
class SearchFilter extends element_1.Component {
    ...
    render() {
        ...
        const children = (0, utils_1.backwardsCompatibleCreateInterpolateElement)(labels.title, {
            ...
            filter: ((0, element_1.createElement)(search_1.default, { className: (0, clsx_1.default)(className, 'fincommerce-filters-advanced__input'), onChange: this.onSearchChange, type: input.type, autocompleter: input.autocompleter, placeholder: labels.placeholder, selected: selected, inlineTags: true, "aria-label": labels.filter })),
        });
