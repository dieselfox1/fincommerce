...
const AbbreviatedCard = ({ children, className, href, icon, onClick, type, }) => {
    return ((0, element_1.createElement)(components_1.Card, { className: (0, clsx_1.default)('fincommerce-abbreviated-card', className) },
        (0, element_1.createElement)(components_1.CardBody, { size: null },
            (0, element_1.createElement)(link_1.default, { href: href, onClick: onClick, type: type },
                (0, element_1.createElement)("div", { className: "fincommerce-abbreviated-card__icon" },
                    (0, element_1.createElement)(components_1.Icon, { icon: icon })),
                (0, element_1.createElement)("div", { className: "fincommerce-abbreviated-card__content" }, children)))));
};
