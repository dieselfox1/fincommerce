...
class AnimationSlider extends element_1.Component {
    ...
    render() {
        ...
        const containerClasses = (0, clsx_1.default)('fincommerce-slide-animation', animate && `animate-${animate}`);
        return ((0, element_1.createElement)("div", { className: containerClasses, ref: this.container },
            (0, element_1.createElement)(react_transition_group_1.TransitionGroup, null,
                (0, element_1.createElement)(react_transition_group_1.CSSTransition, { timeout: 200, classNames: "slide", key: animationKey, ...this.props, onExited: this.onExited }, (status) => children({ status })))));
    }
}
