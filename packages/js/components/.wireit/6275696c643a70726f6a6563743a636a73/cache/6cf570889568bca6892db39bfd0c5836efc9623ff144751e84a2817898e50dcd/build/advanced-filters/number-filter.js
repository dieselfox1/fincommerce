...
class NumberFilter extends element_1.Component {
    getBetweenString() {
        return (0, i18n_1._x)('<rangeStart/><span> and </span><rangeEnd/>', 'Numerical range inputs arranged on a single line', 'fincommerce');
    }
    getScreenReaderText(filter, config) {
        ...
        if (inputType === 'currency') {
            const { formatAmount } = (0, currency_1.CurrencyFactory)(currency);
            rangeStart = formatAmount(rangeStart);
            rangeEnd = formatAmount(rangeEnd);
        }
        let filterStr = rangeStart;
        if (rule.value === 'between') {
            filterStr = (0, utils_1.backwardsCompatibleCreateInterpolateElement)(this.getBetweenString(), {
    ...
    getFormControl({ type, value, label, onChange, currencySymbol, symbolPosition, }) {
        if (type === 'currency') {
            return symbolPosition.indexOf('right') === 0 ? ((0, element_1.createElement)(text_control_with_affixes_1.default, { suffix: (0, element_1.createElement)("span", null, currencySymbol), className: "fincommerce-filters-advanced__input", type: "number", value: value || '', "aria-label": label, onChange: onChange })) : ((0, element_1.createElement)(text_control_with_affixes_1.default, { prefix: (0, element_1.createElement)("span", null, currencySymbol), className: "fincommerce-filters-advanced__input", type: "number", value: value || '', "aria-label": label, onChange: onChange }));
        }
        return ((0, element_1.createElement)(components_1.TextControl, { className: "fincommerce-filters-advanced__input", type: "number", value: value || '', "aria-label": label, onChange: onChange }));
    }
    getFilterInputs() {
        ...
        if (filter.rule === 'lessthan') {
            ...
            labelFormat = (0, i18n_1._x)('%(field)s maximum amount', 'maximum value input', 'fincommerce');
        }
        else {
            ...
            labelFormat = (0, i18n_1._x)('%(field)s minimum amount', 'minimum value input', 'fincommerce');
        }
    ...
    getRangeInput() {
        ...
        return (0, utils_1.backwardsCompatibleCreateInterpolateElement)(this.getBetweenString(), {
            rangeStart: this.getFormControl({
                ...
                (0, i18n_1.__)('%(field)s range start', 'fincommerce'), { field: (0, lodash_1.get)(config, ['labels', 'add']) }),
            ...
            rangeEnd: this.getFormControl({
                ...
                (0, i18n_1.__)('%(field)s range end', 'fincommerce'), { field: (0, lodash_1.get)(config, ['labels', 'add']) }),
    ...
    render() {
        ...
        const children = (0, utils_1.backwardsCompatibleCreateInterpolateElement)(labels.title, {
            ...
            rule: ((0, element_1.createElement)(components_1.SelectControl, { className: (0, clsx_1.default)(className, 'fincommerce-filters-advanced__rule'), options: rules, value: rule, onChange: (value) => onFilterChange({ property: 'rule', value }), "aria-label": labels.rule })),
            filter: ((0, element_1.createElement)("div", { className: (0, clsx_1.default)(className, 'fincommerce-filters-advanced__input-range', {
                    'is-between': rule === 'between',
                }) }, this.getFilterInputs())),
        });
        const screenReaderText = this.getScreenReaderText(filter, config);
        /*eslint-disable jsx-a11y/no-noninteractive-tabindex*/
        return ((0, element_1.createElement)("fieldset", { className: "fincommerce-filters-advanced__line-item", tabIndex: "0" },
            (0, element_1.createElement)("legend", { className: "screen-reader-text" }, labels.add || ''),
            (0, element_1.createElement)("div", { className: (0, clsx_1.default)('fincommerce-filters-advanced__fieldset', {
