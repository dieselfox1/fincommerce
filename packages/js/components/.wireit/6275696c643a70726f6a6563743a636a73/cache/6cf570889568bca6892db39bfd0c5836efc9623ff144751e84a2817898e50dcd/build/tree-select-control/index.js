 ...
 */
const TreeSelectControl = ({ id, label, selectAllLabel = (0, i18n_1.__)('All', 'fincommerce'), help, placeholder, className, disabled, options = [], value = [], maxVisibleTags, onChange = () => { }, onDropdownVisibilityChange = lodash_1.noop, onInputChange = lodash_1.noop, includeParent = false, individuallySelectParent = false, alwaysShowPlaceholder = false, minFilterQueryLength = 3, clearOnSelect = true, }) => {
    ...
    const filteredOptions = (0, element_1.useMemo)(() => {
        ...
        const descriptors = {
                ...
                get() {
                    ...
                    return this.children.flatMap((option) => {
                        if (option.hasChildren) {
                            return includeParent && option.value !== constants_1.ROOT_VALUE
            ...
            checked: {
                 ...
                 */
                get() {
                    if ((includeParent && this.value !== constants_1.ROOT_VALUE) ||
    ...
    const handleSingleChange = (checked, option, parent) => {
        ...
        if (includeParent &&
            parent &&
            parent.value !== constants_1.ROOT_VALUE &&
            parent.children &&
    ...
    const handleParentChange = (checked, option) => {
        ...
        if (includeParent &&
            !individuallySelectParent &&
            option.value !== constants_1.ROOT_VALUE) {
    ...
    (0, element_1.createElement)("div", { ...focusOutside, onKeyDown: onKeyDown, className: (0, clsx_1.default)('fincommerce-tree-select-control', className) },
        !!label && ((0, element_1.createElement)("label", { htmlFor: `fincommerce-tree-select-control-${instanceId}__control-input`, className: "fincommerce-tree-select-control__label" }, label)),
        ...
        showTree && ((0, element_1.createElement)("div", { ref: dropdownRef, className: "fincommerce-tree-select-control__tree", role: "tree", tabIndex: "-1" },
        ...
        help && ((0, element_1.createElement)("div", { className: "fincommerce-tree-select-control__help" }, help))));
};
