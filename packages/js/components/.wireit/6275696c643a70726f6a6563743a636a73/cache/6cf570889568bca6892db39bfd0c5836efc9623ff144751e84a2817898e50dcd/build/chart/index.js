...
class Chart extends element_1.Component {
    ...
    renderIntervalSelector() {
        ...
        const intervalLabels = {
            hour: (0, i18n_1.__)('By hour', 'fincommerce'),
            day: (0, i18n_1.__)('By day', 'fincommerce'),
            week: (0, i18n_1.__)('By week', 'fincommerce'),
            month: (0, i18n_1.__)('By month', 'fincommerce'),
            quarter: (0, i18n_1.__)('By quarter', 'fincommerce'),
            year: (0, i18n_1.__)('By year', 'fincommerce'),
        };
        return ((0, element_1.createElement)("div", { className: "fincommerce-chart__interval-select" },
    ...
    render() {
        ...
        const totalLabel = itemsLabel
            ? (0, i18n_1.sprintf)(itemsLabel, orderedKeys.length)
            : '';
        ...
        return ((0, element_1.createElement)("div", { className: "fincommerce-chart" },
            showHeaderControls && ((0, element_1.createElement)("div", { className: "fincommerce-chart__header" },
                (0, element_1.createElement)(section_1.H, { className: "fincommerce-chart__title" }, title),
                legendPosition === 'top' && legend,
                this.renderIntervalSelector(),
                (0, element_1.createElement)(components_1.NavigableMenu, { className: "fincommerce-chart__types", orientation: "horizontal", role: "menubar" },
                    (0, element_1.createElement)(components_1.Button, { className: (0, clsx_1.default)('fincommerce-chart__type-button', {
                            'fincommerce-chart__type-button-selected': chartType === 'line',
                        }), title: (0, i18n_1.__)('Line chart', 'fincommerce'), "aria-checked": chartType === 'line', role: "menuitemradio", tabIndex: chartType === 'line' ? 0 : -1, onClick: (0, lodash_1.partial)(this.handleTypeToggle, 'line') },
                        (0, element_1.createElement)(line_graph_1.default, null)),
                    (0, element_1.createElement)(components_1.Button, { className: (0, clsx_1.default)('fincommerce-chart__type-button', {
                            'fincommerce-chart__type-button-selected': chartType === 'bar',
                        }), title: (0, i18n_1.__)('Bar chart', 'fincommerce'), "aria-checked": chartType === 'bar', role: "menuitemradio", tabIndex: chartType === 'bar' ? 0 : -1, onClick: (0, lodash_1.partial)(this.handleTypeToggle, 'bar') },
                        (0, element_1.createElement)(stats_alt_1.default, null))))),
            (0, element_1.createElement)(section_1.Section, { component: false },
                (0, element_1.createElement)("div", { className: (0, clsx_1.default)('fincommerce-chart__body', `fincommerce-chart__body-${chartDirection}`), ref: this.chartBodyRef },
                ...
                legendPosition === 'bottom' && ((0, element_1.createElement)("div", { className: "fincommerce-chart__footer" }, legend)))));
    }
}
Chart.propTypes = {
    /**
