...
class EmptyContent extends Component {
    renderIllustration() {
        ...
        return (createElement("img", { alt: "", src: illustration, width: illustrationWidth, height: illustrationHeight, className: "fincommerce-empty-content__illustration" }));
    }
    renderActionButtons(type) {
        ...
        if (actionURL && actionCallback) {
            return (createElement(Button, { className: "fincommerce-empty-content__action", variant: buttonVariant, onClick: actionCallback, href: actionURL }, actionLabel));
        }
        else if (actionURL) {
            return (createElement(Button, { className: "fincommerce-empty-content__action", variant: buttonVariant, href: actionURL }, actionLabel));
        }
        else if (actionCallback) {
            return (createElement(Button, { className: "fincommerce-empty-content__action", variant: buttonVariant, onClick: actionCallback }, actionLabel));
        }
        return null;
    }
    renderActions() {
        const { actionLabel, secondaryActionLabel } = this.props;
        return (createElement("div", { className: "fincommerce-empty-content__actions" },
    ...
    render() {
        ...
        return (createElement("div", { className: clsx('fincommerce-empty-content', className) },
            illustration && this.renderIllustration(),
            title ? (createElement(H, { className: "fincommerce-empty-content__title" }, title)) : null,
            message ? (createElement("p", { className: "fincommerce-empty-content__message" }, message)) : null,
            this.renderActions()));
    }
}
