...
class AnimationSlider extends Component {
    ...
    render() {
        ...
        const containerClasses = clsx('fincommerce-slide-animation', animate && `animate-${animate}`);
        return (createElement("div", { className: containerClasses, ref: this.container },
            createElement(TransitionGroup, null,
                createElement(CSSTransition, { timeout: 200, classNames: "slide", key: animationKey, ...this.props, onExited: this.onExited }, (status) => children({ status })))));
    }
}
