    ...
    return (createElement("div", { className: className },
        createElement("div", { className: "components-base-control__field" },
            createElement("span", { className: "components-checkbox-control__input-container" },
                createElement("input", { id: `inspector-checkbox-control-${option.key ?? option.value}`, className: "components-checkbox-control__input", type: "checkbox", tabIndex: "-1", value: option.value, checked: checked, ...props }),
                checked && (createElement(Icon, { icon: check, role: "presentation", className: "components-checkbox-control__checked" }))),
            createElement("label", { className: "components-checkbox-control__label", htmlFor: `inspector-checkbox-control-${option.key ?? option.value}` }, option.label))));
};
