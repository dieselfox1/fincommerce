...
exports.getItemName = exports.getPreviousIndex = exports.getNextIndex = exports.isLastDroppable = exports.isDraggingOverBefore = exports.isDraggingOverAfter = exports.isBefore = exports.moveIndex = void 0;
/**
...
exports.isDraggingOverAfter = isDraggingOverAfter;
...
exports.isDraggingOverBefore = isDraggingOverBefore;
...
exports.isLastDroppable = isLastDroppable;
...
const getItemName = (parentNode, index) => {
    ...
    return (0, i18n_1.__)('Item', 'fincommerce');
};
