...
const completer = {
    name: 'emails',
    className: 'fincommerce-search__emails-result',
    options(search) {
        const query = search
            ? {
                search,
    ...
    getOptionLabel(customer, query) {
        const match = (0, utils_1.computeSuggestionMatch)(customer.email, query);
        return ((0, element_1.createElement)("span", { key: "name", className: "fincommerce-search__result-name", "aria-label": customer.email },
