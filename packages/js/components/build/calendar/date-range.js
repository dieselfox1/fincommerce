...
class DateRange extends element_1.Component {
    ...
    render() {
        ...
        return ((0, element_1.createElement)("div", { className: (0, clsx_1.default)('fincommerce-calendar', {
                'is-mobile': isViewportMobile,
            }) },
            (0, element_1.createElement)("div", { className: "fincommerce-calendar__inputs" },
                (0, element_1.createElement)(input_1.default, { value: afterText, onChange: (0, lodash_1.partial)(this.onInputChange, 'after'), dateFormat: shortDateFormat, label: (0, i18n_1.__)('Start Date', 'fincommerce'), error: afterError, describedBy: (0, i18n_1.sprintf)(
                    /* translators: %s: date format specification */
                    (0, i18n_1.__)("Date input describing a selected date range's start date in format %s", 'fincommerce'), shortDateFormat), onFocus: () => this.onFocusChange('startDate') }),
                (0, element_1.createElement)("div", { className: "fincommerce-calendar__inputs-to" }, (0, i18n_1.__)('to', 'fincommerce')),
                (0, element_1.createElement)(input_1.default, { value: beforeText, onChange: (0, lodash_1.partial)(this.onInputChange, 'before'), dateFormat: shortDateFormat, label: (0, i18n_1.__)('End Date', 'fincommerce'), error: beforeError, describedBy: (0, i18n_1.sprintf)(
                    /* translators: %s: date format specification */
                    (0, i18n_1.__)("Date input describing a selected date range's end date in format %s", 'fincommerce'), shortDateFormat), onFocus: () => this.onFocusChange('endDate') })),
            (0, element_1.createElement)("div", { className: "fincommerce-calendar__react-dates", ref: this.nodeRef, onBlur: (0, lodash_1.partial)(this.keepFocusInside, CONTAINER_DIV), tabIndex: -1 },
