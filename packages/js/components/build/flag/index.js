...
const Flag = ({ code, order, className, size, hideFromScreenReader }) => {
    const classes = (0, clsx_1.default)('fincommerce-flag', className);
    ...
    return ((0, element_1.createElement)("div", { className: classes, style: inlineStyles, "aria-hidden": hideFromScreenReader },
        ...
        !emoji && ((0, element_1.createElement)("span", { className: "fincommerce-flag__fallback" }, "Invalid country flag"))));
};
Flag.propTypes = {
    /**
