...
class CompareFilter extends element_1.Component {
    ...
    render() {
        ...
        const { selected } = this.state;
        return ((0, element_1.createElement)(components_1.Card, { className: "fincommerce-filters__compare" },
            ...
            (0, element_1.createElement)(components_1.CardFooter, { justify: "flex-start" },
                ...
                selected.length > 0 && ((0, element_1.createElement)(components_1.Button, { isLink: true, onClick: this.clearQuery }, (0, i18n_1.__)('Clear all', 'fincommerce'))))));
    }
}
