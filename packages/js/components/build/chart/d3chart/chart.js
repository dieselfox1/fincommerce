...
class D3Chart extends element_1.Component {
    ...
    render() {
        ...
        return ((0, element_1.createElement)("div", { className: (0, clsx_1.default)('d3-chart__container', className), style: { height } },
            this.getEmptyMessage(),
            (0, element_1.createElement)("div", { className: "d3-chart__tooltip", ref: this.tooltipRef }),
            (0, element_1.createElement)(d3base_1.default, { className: (0, clsx_1.default)(className), data: data, drawChart: this.drawChart, height: height, orderedKeys: orderedKeys, tooltip: this.tooltip, chartType: chartType, width: computedWidth })));
    }
}
D3Chart.propTypes = {
    /**
