...
class D3Legend extends element_1.Component {
    ...
    render() {
        ...
        return ((0, element_1.createElement)("div", { className: (0, clsx_1.default)('fincommerce-legend', `fincommerce-legend__direction-${legendDirection}`, {
                'has-total': showTotalLabel,
                'is-scrollable': isScrollable,
            }, this.props.className) },
            (0, element_1.createElement)("ul", { className: "fincommerce-legend__list", ref: this.listRef, onScroll: showTotalLabel ? this.updateListScroll : null }, data.map((row) => ((0, element_1.createElement)("li", { className: (0, clsx_1.default)('fincommerce-legend__item', {
                    'fincommerce-legend__item-checked': row.visible,
                }), key: row.key, id: `fincommerce-legend-${instanceId}__item__${row.key}`, onMouseEnter: handleLegendHover, onMouseLeave: handleLegendHover, onBlur: handleLegendHover, onFocus: handleLegendHover },
                (0, element_1.createElement)("button", { role: "checkbox", "aria-checked": row.visible ? 'true' : 'false', onClick: handleLegendToggle, id: `fincommerce-legend-${instanceId}__item-button__${row.key}`, disabled: (row.visible &&
                        ...
                        (0, i18n_1.__)('You may select up to %d items.', 'fincommerce'), constants_1.selectionLimit)
                        : '' },
                    (0, element_1.createElement)("div", { className: "fincommerce-legend__item-container" },
                        (0, element_1.createElement)("span", { className: (0, clsx_1.default)('fincommerce-legend__item-checkmark', {
                                'fincommerce-legend__item-checkmark-checked': row.visible,
                            }), style: row.visible
                                ? {
                                    color: (0, color_1.getColor)(keys, colorScheme)(row.key),
                                }
                                : null }),
                        (0, element_1.createElement)("span", { className: "fincommerce-legend__item-title" }, row.label),
                        (0, element_1.createElement)("span", { className: "fincommerce-legend__item-total" }, (0, index_1.getFormatter)(legendValueFormat)(row.total)))))))),
            showTotalLabel && ((0, element_1.createElement)("div", { className: "fincommerce-legend__total" }, totalLabel))));
    }
}
D3Legend.propTypes = {
    /**
