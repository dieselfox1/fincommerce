...
const matches = [
    { value: 'all', label: (0, i18n_1.__)('All', 'fincommerce') },
    { value: 'any', label: (0, i18n_1.__)('Any', 'fincommerce') },
];
/**
...
class AdvancedFilters extends element_1.Component {
    ...
    getTitle() {
        ...
        return (0, utils_1.backwardsCompatibleCreateInterpolateElement)(config.title, {
            select: ((0, element_1.createElement)(components_1.SelectControl, { className: "fincommerce-filters-advanced__title-select", options: matches, value: match, onChange: this.onMatchChange, "aria-label": (0, i18n_1.__)('Choose to apply any or all filters', 'fincommerce') })),
        });
    }
    getAvailableFilters() {
        const { config } = this.props;
    ...
    render() {
        ...
        return ((0, element_1.createElement)(components_1.Card, { className: "fincommerce-filters-advanced", size: "small" },
            ...
            !!activeFilters.length && ((0, element_1.createElement)(components_1.CardBody, { size: null },
                (0, element_1.createElement)("ul", { className: "fincommerce-filters-advanced__list", ref: this.filterListRef }, activeFilters
            ...
            availableFilters.length > 0 && ((0, element_1.createElement)(components_1.CardBody, null,
                (0, element_1.createElement)("div", { className: "fincommerce-filters-advanced__add-filter" },
                    (0, element_1.createElement)(components_1.Dropdown, { className: "fincommerce-filters-advanced__add-filter-dropdown", popoverProps: {
                            placement: 'bottom',
                        }, renderToggle: ({ isOpen, onToggle }) => ((0, element_1.createElement)(components_1.Button, { className: "fincommerce-filters-advanced__add-button", onClick: onToggle, "aria-expanded": isOpen },
                            (0, element_1.createElement)(add_outline_1.default, null),
                            (0, i18n_1.__)('Add a filter', 'fincommerce'))), renderContent: ({ onClose }) => ((0, element_1.createElement)("ul", { className: "fincommerce-filters-advanced__add-dropdown" }, availableFilters.map((filter) => ((0, element_1.createElement)("li", { key: filter.key },
            ...
            (0, element_1.createElement)(components_1.CardFooter, { align: "center" },
                (0, element_1.createElement)("div", { className: "fincommerce-filters-advanced__controls" },
                    updateDisabled && ((0, element_1.createElement)(components_1.Button, { isPrimary: true, disabled: true }, (0, i18n_1.__)('Filter', 'fincommerce'))),
                    !updateDisabled && ((0, element_1.createElement)(link_1.default, { className: "components-button is-primary is-button", type: "wc-admin", href: updateHref, onClick: this.onFilter }, (0, i18n_1.__)('Filter', 'fincommerce'))),
                    activeFilters.length > 0 && ((0, element_1.createElement)(link_1.default, { type: "wc-admin", href: this.getUpdateHref([]), onClick: this.clearFilters }, (0, i18n_1.__)('Clear all filters', 'fincommerce')))))));
    }
}
