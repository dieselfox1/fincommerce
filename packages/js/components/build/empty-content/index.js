...
class EmptyContent extends element_1.Component {
    renderIllustration() {
        ...
        return ((0, element_1.createElement)("img", { alt: "", src: illustration, width: illustrationWidth, height: illustrationHeight, className: "fincommerce-empty-content__illustration" }));
    }
    renderActionButtons(type) {
        ...
        if (actionURL && actionCallback) {
            return ((0, element_1.createElement)(components_1.Button, { className: "fincommerce-empty-content__action", variant: buttonVariant, onClick: actionCallback, href: actionURL }, actionLabel));
        }
        else if (actionURL) {
            return ((0, element_1.createElement)(components_1.Button, { className: "fincommerce-empty-content__action", variant: buttonVariant, href: actionURL }, actionLabel));
        }
        else if (actionCallback) {
            return ((0, element_1.createElement)(components_1.Button, { className: "fincommerce-empty-content__action", variant: buttonVariant, onClick: actionCallback }, actionLabel));
        }
        return null;
    }
    renderActions() {
        const { actionLabel, secondaryActionLabel } = this.props;
        return ((0, element_1.createElement)("div", { className: "fincommerce-empty-content__actions" },
    ...
    render() {
        ...
        return ((0, element_1.createElement)("div", { className: (0, clsx_1.default)('fincommerce-empty-content', className) },
            illustration && this.renderIllustration(),
            title ? ((0, element_1.createElement)(section_1.H, { className: "fincommerce-empty-content__title" }, title)) : null,
            message ? ((0, element_1.createElement)("p", { className: "fincommerce-empty-content__message" }, message)) : null,
            this.renderActions()));
    }
}
