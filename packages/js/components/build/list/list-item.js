...
function ListItem(props) {
    ...
    const innerTagProps = {
        className: 'fincommerce-list__item-inner',
    ...
    return ((0, element_1.createElement)(InnerTag, { ...innerTagProps },
        before && ((0, element_1.createElement)("div", { className: "fincommerce-list__item-before" }, before)),
        (0, element_1.createElement)("div", { className: "fincommerce-list__item-text" },
            (0, element_1.createElement)("span", { className: "fincommerce-list__item-title" }, title),
            content && ((0, element_1.createElement)("span", { className: "fincommerce-list__item-content" }, content))),
        after && ((0, element_1.createElement)("div", { className: "fincommerce-list__item-after" }, after))));
}
ListItem.propTypes = {
    /**
