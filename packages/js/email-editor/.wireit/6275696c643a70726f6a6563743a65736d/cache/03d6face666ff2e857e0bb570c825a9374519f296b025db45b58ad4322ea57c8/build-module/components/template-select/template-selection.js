...
export function TemplateSelection() {
    ...
    const { emailContentIsEmpty, emailHasEdits, postType } = useSelect((select) => ({
    ...
    return (_jsx(SelectTemplateModal, { onSelectCallback: () => setTemplateSelected(true), postType: postType }));
}
