...
import { store as blocksStore, unregisterBlockStyle, getBlockTypes, } from '@wordpress/blocks';
...
function alterSupportConfiguration() {
    addFilter('blocks.registerBlockType', 'fincommerce-email-editor/block-support', (settings) => {
