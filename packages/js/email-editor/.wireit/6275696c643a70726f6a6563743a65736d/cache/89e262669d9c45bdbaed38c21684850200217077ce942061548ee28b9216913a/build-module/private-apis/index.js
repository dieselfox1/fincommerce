 ...
 */
const { Editor, FullscreenMode, ViewMoreMenuGroup, BackButton } = unlock(editorPrivateApis);
/**
 ...
 */
const { registerEntityAction, unregisterEntityAction } = unlock(dispatch(editorStore));
