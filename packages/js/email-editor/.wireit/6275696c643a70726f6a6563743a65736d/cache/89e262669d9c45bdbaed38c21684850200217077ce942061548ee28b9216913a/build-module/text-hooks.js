...
export const initTextHooks = () => {
    const replaceTextMatrix = {
        'You’ve tried to select a block that is part of a template that may be used elsewhere on your site. Would you like to edit the template?': {
            domain: 'default',
            replacementText: __('You’ve tried to select a block that is part of a template that may be used in other emails. Would you like to edit the template?', 'fincommerce'),
        },
    };
    addFilter('i18n.gettext', 'fincommerce/email-editor/override-text', (translation, text, domain) => {
