...
function modifyMoveToTrashAction() {
    ...
    addAction('core.registerPostTypeSchema', 'fincommerce-email-editor/modify-move-to-trash-action', (postType) => {
        removeDefaultMoveToTrashActionAddCustom(postType);
    });
    // Support for WordPress 6.7+
    addAction('core.registerPostTypeActions', 'fincommerce-email-editor/modify-move-to-trash-action', (postType) => {
        removeDefaultMoveToTrashActionAddCustom(postType);
    });
}
