...
export function unwrapCompressedPresetStyleVariableName(value) {
...
export function unwrapCompressedPresetStyleVariable(value) {
...
export function getCompressedVariableValue(value) {
    const variableName = unwrapCompressedPresetStyleVariableName(value);
    if (!variableName)
        return value;
