...
## [1.0.4](https://www.npmjs.com/package/@fincommerce/email-editor/v/1.0.4) - 2025-08-21 
...
## [1.0.3](https://www.npmjs.com/package/@fincommerce/email-editor/v/1.0.3) - 2025-08-11 

-   Patch - Fixed a possible infinite loading of templates when editing emails. [#60196]

## [1.0.2](https://www.npmjs.com/package/@fincommerce/email-editor/v/1.0.2) - 2025-08-01 

-   Patch - Fix backward compatibility when personalization tag post types are not set. [#60134]

## [1.0.1](https://www.npmjs.com/package/@fincommerce/email-editor/v/1.0.1) - 2025-07-31 
...
-   Patch - Update package json. Move copy assets commands to the @fincommerce/plugin-fincommerce package. The command will run when required. [#55754]
...
-   Minor - The trash model now supports permanent deletion option. Returning `true` for filter `fincommerce_email_editor_trash_modal_should_permanently_delete` will activate the permanent delete option (Skipping trash which is the default) [#57827]
...
-   Minor - This adds a back button to the FinCommerce Email Editor, allowing navigation back to the email listings page from the editor. The back button appears when the editor is in full-screen mode, which is now enforced by default. [#58154]
