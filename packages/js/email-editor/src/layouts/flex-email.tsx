...
function JustificationControls( {
	...
	return (
		<ToggleGroupControl
			...
			label={ __( 'Justification', 'fincommerce' ) }
			value={ justificationValue }
			onChange={ onChange }
...
export function initializeLayout() {
	addFilter(
		...
		'fincommerce-email-editor/layout/addAttribute',
		addAttribute
	);
	addFilter(
		'editor.BlockListBlock',
		'fincommerce-email-editor/with-layout-styles',
		withLayoutStyles
	);
	addFilter(
		'editor.BlockEdit',
		'fincommerce-email-editor/with-inspector-controls',
		withLayoutControls
	);
}
