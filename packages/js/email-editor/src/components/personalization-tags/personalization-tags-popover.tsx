		...
		<>
			{ isPopoverVisible && anchor && (
				<Popover
					...
					className="fincommerce-personalization-tag-popover"
				>
					<div className="fincommerce-personalization-tag-popover-content">
						<TextControl
							label={ __( 'Personalization Tag', 'fincommerce' ) }
							value={ updatedValue }
							onChange={ ( value ) => setUpdatedValue( value ) }
							__nextHasNoMarginBottom // To avoid warning about deprecation in console
							__next40pxDefaultSize
						/>
						<div className="fincommerce-personalization-tag-popover-content-buttons">
							<Button
								isTertiary
								onClick={ () => {
