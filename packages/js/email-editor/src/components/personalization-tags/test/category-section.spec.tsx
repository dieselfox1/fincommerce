/* eslint-disable @fincommerce/dependency-group -- because we import mocks first, we deactivate this rule to avoid ESLint errors */
...
describe( 'CategorySection', () => {
	const mockTags: Record< string, PersonalizationTag[] > = {
		General: [
			{
				name: 'Customer Name',
				token: 'fincommerce/customer-name',
				valueToInsert: '[fincommerce/customer-name]',
				category: 'Customer',
				attributes: [],
				postTypes: [ 'woo_mail' ],
			},
			{
				name: 'Customer Email',
				token: 'fincommerce/customer-email',
				valueToInsert: '[fincommerce/customer-email]',
				category: 'Customer',
				attributes: [],
				postTypes: [ 'woo_mail' ],
			},
		...
		Link: [
			{
				name: 'Profile URL',
				token: 'fincommerce/profile-url',
				valueToInsert: '[fincommerce/profile-url]',
				category: 'Link',
				attributes: [],
				postTypes: [ 'woo_mail' ],
			},
