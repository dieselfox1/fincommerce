...
export function RichTextWithButton( {
	...
	const finalLabel = (
		<>
			<span>{ label }</span>
			<Button
				className="fincommerce-settings-panel-personalization-tags-button"
				icon="shortcode"
	...
	return (
		<BaseControl
			...
			label={ finalLabel }
			className={ `fincommerce-settings-panel-${ attributeName }-text` }
			help={ help }
		...
		>
			...
			<RichText
				ref={ richTextRef }
				className="fincommerce-settings-panel-richtext"
