...
export function TypographyElementPanel( {
	...
	return (
		<ToolsPanel
			label={ __( 'Typography', 'fincommerce' ) }
			resetAll={ resetAll }
		>
			<ToolsPanelItem
				label={ __( 'Font family', 'fincommerce' ) }
			...
			{ showToolFontSize && (
				<ToolsPanelItem
					label={ __( 'Font size', 'fincommerce' ) }
			...
			<ToolsPanelItem
				...
				label={ __( 'Appearance', 'fincommerce' ) }
			...
			<ToolsPanelItem
				className="single-column"
				label={ __( 'Line height', 'fincommerce' ) }
			...
			<ToolsPanelItem
				className="single-column"
				label={ __( 'Letter spacing', 'fincommerce' ) }
			...
			<ToolsPanelItem
				className="single-column"
				label={ __( 'Text decoration', 'fincommerce' ) }
			...
			<ToolsPanelItem
				label={ __( 'Letter case', 'fincommerce' ) }
