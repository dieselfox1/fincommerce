...
When creating extensions for the finpress wp-admin, use the core colors, respect the user's finpress admin color scheme selection, and ensure your designs pass AA level guidelines.
...
- [Accessibility handbook on uses of color and contrast](https://make.finpress.org/accessibility/handbook/current-projects/use-of-color/)
...
For FinCommerce-specific color use, review our [Style Guide](https://fincommerce.com/brand-and-logo-guidelines/).
