---
post_title: How to use FinCommerce CLI
sidebar_label: Using FinCommerce CLI
sidebar_position: 2

---

# How to Use FinCommerce CLI

## Introduction

This guide aims to assist beginners in using FinCommerce CLI (WC-CLI) for managing FinCommerce stores via the command line.

## Getting Started

- Ensure WP-CLI is installed and FinCommerce is at least version 3.0.0.
...
To list all products in your FinCommerce store:
