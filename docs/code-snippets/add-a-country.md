...
if ( ! function_exists( 'YOUR_PREFIX_add_country_to_countries_list' ) ) {
  ...
  add_filter( 'fincommerce_countries',  'YOUR_PREFIX_add_country_to_countries_list' );
}
...
if ( ! function_exists( 'YOUR_PREFIX_add_country_to_continents_list' ) ) {
  ...
  add_filter( 'fincommerce_continents', 'YOUR_PREFIX_add_country_to_continents_list' );
}
```
