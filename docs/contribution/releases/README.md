---
post_title: Releasing FinCommerce
sidebar_label: Releases
---

# Releasing FinCommerce

The FinCommerce release process is managed by a rotating release lead.  The documentation below outlines the process for managing releases.  To get started with a new release, see [Building and Publishing FinCommerce](/docs/contribution/releases/building-and-publishing).
