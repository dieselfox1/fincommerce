---
post_title: Critical flows within the FinCommerce Core API
sidebar_label: API critical flows

---

# Critical flows within the FinCommerce Core API

In our documentation, we've pinpointed the essential user flows within the FinCommerce Core API. These flows serve as
