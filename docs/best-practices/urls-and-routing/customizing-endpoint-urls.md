---
post_title: Customizing FinCommerce endpoint URLs
sidebar_label: Customizing endpoint URLs

---

# Customizing FinCommerce endpoint URLs

Before you start, check out [FinCommerce Endpoints](./fincommerce-endpoints.md). 

## Customizing endpoint URLs

The URL for each endpoint can be customized in **FinCommerce > Settings > Advanced** in the Page setup section.

![Endpoints](https://developer.fincommerce.com/wp-content/uploads/2023/12/endpoints.png)
...
FinCommerce provides helper functions in the order class for getting these URLs. They are:
...
Sometimes the "Downloads" endpoint on the "My account" page does not need to be displayed. This can be removed by going to **FinCommerce > Settings > Advanced > Account endpoints** and clearing the Downloads endpoint field.

![Account endpoints](https://developer.fincommerce.com/wp-content/uploads/2023/12/Screenshot-2023-04-09-at-11.45.58-PM.png)
