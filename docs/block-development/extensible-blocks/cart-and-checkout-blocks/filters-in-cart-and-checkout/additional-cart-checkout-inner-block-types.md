...
-   _args_ `object` - The arguments object with the following key:
    -   _block_ `string` - The block name of the inner block area, e.g. `fincommerce/checkout-shipping-address-block`.
...
document.addEventListener( 'DOMContentLoaded', function () {
	...
	const modifyAdditionalInnerBlockTypes = (
		...
		if ( args?.block === 'fincommerce/checkout-shipping-address-block' ) {
...
| Before                                                                 | After                                                                 |
|:---------------------------------------------------------------------:|:---------------------------------------------------------------------:|
|![Before applying the Additional Cart and Checkout inner block types filter](https://github.com/dieselfox1/fincommerce-blocks/assets/3323310/0d4560c8-c2b1-4ed8-8aee-469b248ccb08) |![After applying the Additional Cart and Checkout inner block types filter](https://github.com/dieselfox1/fincommerce-blocks/assets/3323310/d38cd568-6c8c-4158-9269-d8dffdf66988) |
