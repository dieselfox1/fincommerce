---
post_title: Conditional tags in FinCommerce
sidebar_label: Conditional tags

---

# Conditional tags in FinCommerce
...
The list below holds the main conditional tags. To see all conditional tags, visit the [FinCommerce API Docs](https://fincommerce.com/wc-apidocs/).
...
- `is_wc_endpoint_url()`  
  Returns true when viewing a FinCommerce endpoint
