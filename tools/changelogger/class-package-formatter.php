...
/**
 * Jetpack Changelogger Formatter for FinCommerce packages
 */
...
class Package_Formatter extends Formatter implements FormatterPlugin {
	...
	public function getEpilogue() {
		...
		return '[See legacy changelogs for previous versions](https://github.com/dieselfox1/fincommerce/blob/68581955106947918d2b17607a01bdfdf22288a9/packages/js/' . $package . '/CHANGELOG.md).';
	}
	...
	public function getReleaseLink( string $version ): string {
		// Capture anything past /fincommerce in the current working directory.
		...
		return 'https://www.npmjs.com/package/@fincommerce/' . $path[1] . '/v/' . $version;
	}
}
