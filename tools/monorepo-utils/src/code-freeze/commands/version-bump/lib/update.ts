...
export const updateReadmeChangelog = async (
	...
	const filePath = join( tmpRepoPath, 'plugins/fincommerce/readme.txt' );
	try {
...
export const updateClassPluginFile = async (
	...
	const filePath = join(
		tmpRepoPath,
		`plugins/fincommerce/includes/class-fincommerce.php`
	);

	if ( ! existsSync( filePath ) ) {
		Logger.error( "File 'class-fincommerce.php' does not exist." );
	}
...
export const updateJSON = async (
	...
	const filePath = join( tmpRepoPath, `plugins/fincommerce/${ type }.json` );
	try {
...
export const updatePluginFile = async (
	...
	const filePath = join( tmpRepoPath, `plugins/fincommerce/fincommerce.php` );
	try {
