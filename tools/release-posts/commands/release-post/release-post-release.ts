...
const SOURCE_REPO = 'https://github.com/dieselfox1/fincommerce.git';
...
const program = new Command()
	...
	.action( async ( currentVersion, previousVersion, options ) => {
		const siteId = options.siteId || DEVELOPER_fincommerce_SITE_ID;
		...
		const title = `FinCommerce ${ currentVersion } Released`;
