...
class CartFeeSchema extends AbstractSchema {
	...
	public function get_properties() {
		return [
			'id'     => [
				'description' => __( 'Unique identifier for the fee within the cart.', 'fincommerce' ),
				'type'        => 'string',
				'context'     => [ 'view', 'edit' ],
				'readonly'    => true,
			],
			...
			'totals' => [
				'description' => __( 'Fee total amounts provided using the smallest unit of the currency.', 'fincommerce' ),
				'type'        => 'object',
				'context'     => [ 'view', 'edit' ],
				'readonly'    => true,
				'properties'  => array_merge(
					...
					[
						'total'     => [
							'description' => __( 'Total amount for this fee.', 'fincommerce' ),
							'type'        => 'string',
							'context'     => [ 'view', 'edit' ],
							'readonly'    => true,
						],
						'total_tax' => [
							'description' => __( 'Total tax amount for this fee.', 'fincommerce' ),
							'type'        => 'string',
							'context'     => [ 'view', 'edit' ],
							'readonly'    => true,
						],
	...
	/**
	 * Convert a FinCommerce cart fee to an object suitable for the response.
	 *
