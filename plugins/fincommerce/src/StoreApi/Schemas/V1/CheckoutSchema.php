...
use Automattic\FinCommerce\StoreApi\Utilities\SanitizationUtils;
...
class CheckoutSchema extends AbstractSchema {
	...
	public function get_properties() {
		...
		return [
			'order_id'          => [
				'description' => __( 'The order ID to process during checkout.', 'fincommerce' ),
				'type'        => 'integer',
				'context'     => [ 'view', 'edit' ],
				'readonly'    => true,
			],
			'status'            => [
				'description' => __( 'Order status. Payment providers will update this value after payment.', 'fincommerce' ),
				'type'        => 'string',
				'context'     => [ 'view', 'edit' ],
				'readonly'    => true,
			],
			'order_key'         => [
				'description' => __( 'Order key used to check validity or protect access to certain order data.', 'fincommerce' ),
				'type'        => 'string',
				'context'     => [ 'view', 'edit' ],
				'readonly'    => true,
			],
			'order_number'      => [
				'description' => __( 'Order number used for display.', 'fincommerce' ),
				'type'        => 'string',
				'context'     => [ 'view', 'edit' ],
				'readonly'    => true,
			],
			'customer_note'     => [
				'description' => __( 'Note added to the order by the customer during checkout.', 'fincommerce' ),
				'type'        => 'string',
				'context'     => [ 'view', 'edit' ],
			],
			'customer_id'       => [
				'description' => __( 'Customer ID if registered. Will return 0 for guests.', 'fincommerce' ),
				'type'        => 'integer',
				'context'     => [ 'view', 'edit' ],
				'readonly'    => true,
			],
			...
			'payment_method'    => [
				'description' => __( 'The ID of the payment method being used to process the payment.', 'fincommerce' ),
				'type'        => 'string',
				'context'     => [ 'view', 'edit' ],
			...
			'create_account'    => [
				'description' => __( 'Whether to create a new user account as part of order processing.', 'fincommerce' ),
				'type'        => 'boolean',
				'context'     => [ 'view', 'edit' ],
			],
			'payment_result'    => [
				'description' => __( 'Result of payment processing, or null if not yet processed.', 'fincommerce' ),
				'type'        => [ 'object', 'null' ],
				'context'     => [ 'view', 'edit' ],
				'readonly'    => true,
				'properties'  => [
					'payment_status'  => [
						'description' => __( 'Status of the payment returned by the gateway. One of success, pending, failure, error.', 'fincommerce' ),
						'readonly'    => true,
						'type'        => 'string',
					],
					'payment_details' => [
						'description' => __( 'An array of data being returned from the payment gateway.', 'fincommerce' ),
						'readonly'    => true,
						'type'        => 'array',
						'items'       => [
							'type'       => 'object',
					...
					'redirect_url'    => [
						'description' => __( 'A URL to redirect the customer after checkout. This could be, for example, a link to the payment processors website.', 'fincommerce' ),
						'readonly'    => true,
						'type'        => 'string',
					],
				],
			...
			'additional_fields' => [
				'description' => __( 'Additional fields to be persisted on the order.', 'fincommerce' ),
				'type'        => 'object',
				'context'     => [ 'view', 'edit' ],
