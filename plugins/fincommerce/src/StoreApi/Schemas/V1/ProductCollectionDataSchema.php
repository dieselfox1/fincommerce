...
class ProductCollectionDataSchema extends AbstractSchema {
	...
	public function get_properties() {
		return [
			'price_range'         => [
				'description' => __( 'Min and max prices found in collection of products, provided using the smallest unit of the currency.', 'fincommerce' ),
				'type'        => [ 'object', 'null' ],
				'context'     => [ 'view', 'edit' ],
				'readonly'    => true,
				'properties'  => array_merge(
					...
					[
						'min_price' => [
							'description' => __( 'Min price found in collection of products.', 'fincommerce' ),
							'type'        => 'string',
							'context'     => [ 'view', 'edit' ],
							'readonly'    => true,
						],
						'max_price' => [
							'description' => __( 'Max price found in collection of products.', 'fincommerce' ),
							'type'        => 'string',
							'context'     => [ 'view', 'edit' ],
							'readonly'    => true,
						],
			...
			'attribute_counts'    => [
				'description' => __( 'Returns number of products within attribute terms.', 'fincommerce' ),
				'type'        => [ 'array', 'null' ],
				'context'     => [ 'view', 'edit' ],
				'readonly'    => true,
				'items'       => [
					...
					'properties' => [
						'term'  => [
							'description' => __( 'Term ID', 'fincommerce' ),
							'type'        => 'integer',
							'context'     => [ 'view', 'edit' ],
							'readonly'    => true,
						],
						'count' => [
							'description' => __( 'Number of products.', 'fincommerce' ),
							'type'        => 'integer',
							'context'     => [ 'view', 'edit' ],
							'readonly'    => true,
						],
			...
			'rating_counts'       => [
				'description' => __( 'Returns number of products with each average rating.', 'fincommerce' ),
				'type'        => [ 'array', 'null' ],
				'context'     => [ 'view', 'edit' ],
				'readonly'    => true,
				'items'       => [
					...
					'properties' => [
						'rating' => [
							'description' => __( 'Average rating', 'fincommerce' ),
							'type'        => 'integer',
							'context'     => [ 'view', 'edit' ],
							'readonly'    => true,
						],
			...
			'stock_status_counts' => [
				'description' => __( 'Returns number of products with each stock status.', 'fincommerce' ),
				'type'        => [ 'array', 'null' ],
				'context'     => [ 'view', 'edit' ],
				'readonly'    => true,
				'items'       => [
					...
					'properties' => [
						'status' => [
							'description' => __( 'Status', 'fincommerce' ),
							'type'        => 'string',
							'context'     => [ 'view', 'edit' ],
							'readonly'    => true,
						],
			...
			'taxonomy_counts'     => [
				'description' => __( 'Returns number of products within taxonomy terms.', 'fincommerce' ),
				'type'        => [ 'array', 'null' ],
				'context'     => [ 'view', 'edit' ],
				'readonly'    => true,
				'items'       => [
