...
class OrderSchema extends AbstractSchema {
	...
	public function get_properties() {
		return [
			...
			'totals'               => [
				'description' => __( 'Order totals.', 'fincommerce' ),
				'type'        => 'object',
				'context'     => [ 'view', 'edit' ],
				'readonly'    => true,
				'properties'  => array_merge(
					...
					[
						'subtotal'           => [
							'description' => __( 'Subtotal of the order.', 'fincommerce' ),
							'type'        => 'string',
							'context'     => [ 'view', 'edit' ],
							'readonly'    => true,
						],
						...
						'total_shipping'     => [
							'description' => __( 'Total price of shipping.', 'fincommerce' ),
							'type'        => [ 'string', 'null' ],
							'context'     => [ 'view', 'edit' ],
							'readonly'    => true,
						],
						...
						'total_tax'          => [
							'description' => __( 'Total tax applied to the order.', 'fincommerce' ),
							'type'        => 'string',
							'context'     => [ 'view', 'edit' ],
							'readonly'    => true,
						],
						'total_refund'       => [
							'description' => __( 'Total refund applied to the order.', 'fincommerce' ),
							'type'        => 'string',
							'context'     => [ 'view', 'edit' ],
							'readonly'    => true,
						],
						...
						'total_items'        => [
							'description' => __( 'Total price of items in the order.', 'fincommerce' ),
							'type'        => 'string',
							'context'     => [ 'view', 'edit' ],
							'readonly'    => true,
						],
						'total_items_tax'    => [
							'description' => __( 'Total tax on items in the order.', 'fincommerce' ),
							'type'        => 'string',
							'context'     => [ 'view', 'edit' ],
							'readonly'    => true,
						],
			...
			'status'               => [
				'description' => __( 'Status of the order.', 'fincommerce' ),
				'type'        => 'string',
				'context'     => [ 'view', 'edit' ],
				'readonly'    => true,
			],
