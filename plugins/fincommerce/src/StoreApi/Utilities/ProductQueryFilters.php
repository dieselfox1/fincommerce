...
class ProductQueryFilters {
	...
	public function get_stock_status_counts( $request ) {
		...
		$hide_outofstock_items = get_option( 'fincommerce_hide_out_of_stock_items' );
	...
	public function get_taxonomy_counts( $request, $taxonomies = [] ) {
		...
		$filter_data_provider = $container->get( \Automattic\FinCommerce\Internal\ProductFilters\FilterDataProvider::class );
