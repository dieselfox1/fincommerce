...
abstract class AbstractTermsRoute extends AbstractRoute {
	...
	public function get_collection_params() {
		...
		$params['order'] = array(
			'description'       => __( 'Sort ascending or descending.', 'fincommerce' ),
			'type'              => 'string',
			'default'           => 'asc',
			'enum'              => array( 'asc', 'desc' ),
			'validate_callback' => 'rest_validate_request_arg',
		...
		$params['orderby'] = array(
			'description'       => __( 'Sort by term property.', 'fincommerce' ),
			'type'              => 'string',
			'default'           => 'name',
			'enum'              => array(
				'name',
		...
		$params['hide_empty'] = array(
			'description' => __( 'If true, empty terms will not be returned.', 'fincommerce' ),
			'type'        => 'boolean',
			'default'     => true,
		);
