...
use Automattic\FinCommerce\StoreApi\Routes\RouteInterface;
...
abstract class AbstractRoute implements RouteInterface {
	...
	protected function get_route_response( \WP_REST_Request $request ) {
		return $this->get_route_error_response( 'fincommerce_rest_invalid_endpoint', __( 'Method not implemented', 'fincommerce' ), 404 );
	}
	...
	protected function get_context_param( $args = array() ) {
		$param_details = array(
			'description'       => __( 'Scope under which the request is made; determines fields present in response.', 'fincommerce' ),
			'type'              => 'string',
