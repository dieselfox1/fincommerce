...
class ProductReviews extends AbstractRoute {
	...
	public function get_collection_params() {
		...
		$params['category_id'] = array(
			'description'       => __( 'Limit result set to reviews from specific category IDs.', 'fincommerce' ),
			'type'              => 'string',
		...
		$params['product_id'] = array(
			'description'       => __( 'Limit result set to reviews from specific product IDs.', 'fincommerce' ),
			'type'              => 'string',
			'sanitize_callback' => 'wp_parse_id_list',
			'validate_callback' => 'rest_validate_request_arg',
		);
