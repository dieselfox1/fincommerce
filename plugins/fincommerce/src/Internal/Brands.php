...
class Brands {
	...
	/**
	 * As of FinCommerce 9.6, Brands is enabled for all users.
	 *
	 * @return bool
	 */
	...
	/**
	 * If FinCommerce Brands gets activated forcibly, without FinCommerce active (e.g. via '--skip-plugins'),
	 * remove FinCommerce Brands initialization functions early on in the 'plugins_loaded' timeline.
	 */
