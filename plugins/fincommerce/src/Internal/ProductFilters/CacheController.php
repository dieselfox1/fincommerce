...
/**
 * Hooks into FinCommerce actions to register cache invalidation.
 *
...
class CacheController implements RegisterHooksInterface {
	...
	public function register() {
		add_action( 'fincommerce_after_product_object_save', array( $this, 'clear_filter_data_cache' ) );
		add_action( 'fincommerce_delete_product_transients', array( $this, 'clear_filter_data_cache' ) );
