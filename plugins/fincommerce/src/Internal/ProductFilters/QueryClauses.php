...
use Automattic\FinCommerce\Internal\ProductFilters\Interfaces\MainQueryClausesGenerator;
use Automattic\FinCommerce\Internal\ProductFilters\CacheController;
use WC_Tax;
use WC_Cache_Helper;
...
class QueryClauses implements QueryClausesGenerator, MainQueryClausesGenerator {
	 ...
	 * FinCommerce handles attribute, price, and rating filters in the main query.
	...
	private function should_adjust_price_filters_for_displayed_taxes(): bool {
		$display  = get_option( 'fincommerce_tax_display_shop' );
