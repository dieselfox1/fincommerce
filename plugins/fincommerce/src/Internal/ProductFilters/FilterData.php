...
namespace Automattic\FinCommerce\Internal\ProductFilters;

use Automattic\FinCommerce\Internal\ProductFilters\Interfaces\QueryClausesGenerator;
use Automattic\FinCommerce\Internal\ProductFilters\TaxonomyHierarchyData;
use WC_Cache_Helper;
...
class FilterData {
	...
	public function get_filtered_price( array $query_vars ) {
		 ...
		 *
		 * @hook fincommerce_pre_product_filter_data
		 *
		 * @since 9.9.0
		 *
		 ...
		 */
		$pre_filter_counts = apply_filters( 'fincommerce_pre_product_filter_data', null, 'price', $query_vars, array() );
		 ...
		 *
		 * @hook fincommerce_product_filter_data
		 * @since 9.9.0
		 *
		 * @param array  $results      The results for current query.
		 * @param string $filter_type  The type of filter. Accepts price|stock|rating|attribute.
		 ...
		 */
		$results = apply_filters( 'fincommerce_product_filter_data', $results, 'price', $query_vars, array() );
	...
	public function get_stock_status_counts( array $query_vars, array $statuses ) {
		 ...
		 */
		$pre_filter_counts = apply_filters( 'fincommerce_pre_product_filter_data', null, 'stock', $query_vars, array() ); // phpcs:ignore FinCommerce.Commenting.CommentHooks.MissingSinceComment
		 ...
		 */
		$results = apply_filters( 'fincommerce_product_filter_data', $results, 'stock', $query_vars, array() ); // phpcs:ignore FinCommerce.Commenting.CommentHooks.MissingSinceComment
	...
	public function get_rating_counts( array $query_vars ) {
		 ...
		 * Filter the data. @see get_filtered_price() for full documentation.
		 */
		$pre_filter_counts = apply_filters( 'fincommerce_pre_product_filter_data', null, 'rating', $query_vars, array() ); // phpcs:ignore FinCommerce.Commenting.CommentHooks.MissingSinceComment
		 ...
		 * Filter the results. @see get_filtered_price() for full documentation.
		 */
		$results = apply_filters( 'fincommerce_product_filter_data', $results, 'rating', $query_vars, array() ); // phpcs:ignore FinCommerce.Commenting.CommentHooks.MissingSinceComment
	...
	public function get_attribute_counts( array $query_vars, string $attribute_to_count ) {
		 ...
		 * Filter the data. @see get_filtered_price() for full documentation.
		 */
		$pre_filter_counts = apply_filters( 'fincommerce_pre_product_filter_data', null, 'attribute', $query_vars, array( 'taxonomy' => $attribute_to_count ) ); // phpcs:ignore FinCommerce.Commenting.CommentHooks.MissingSinceComment
		 ...
		 * @since 9.9.0
		 */
		$results = apply_filters( 'fincommerce_product_filter_data', $results, 'attribute', $query_vars, array( 'taxonomy' => $attribute_to_count ) );
	...
	public function get_taxonomy_counts( array $query_vars, string $taxonomy_to_count ) {
		 ...
		 * @since 9.9.0
		 */
		$pre_filter_counts = apply_filters( 'fincommerce_pre_product_filter_data', null, 'taxonomy', $query_vars, array( 'taxonomy' => $taxonomy_to_count ) );
		 ...
		 * @since 9.9.0
		 */
		$results = apply_filters( 'fincommerce_product_filter_data', $results, 'taxonomy', $query_vars, array( 'taxonomy' => $taxonomy_to_count ) );
