...
class FulfillmentsSettings {
	...
	public function register() {
		...
		add_action( 'fincommerce_order_status_processing', array( $this, 'auto_fulfill_items_on_processing' ), 10, 2 );
		add_action( 'fincommerce_order_status_completed', array( $this, 'auto_fulfill_items_on_completed' ), 10, 2 );
	}
	...
	public function init_settings_auto_fulfill() {
		add_filter( 'fincommerce_get_settings_products', array( $this, 'add_auto_fulfill_settings' ), 10, 2 );
	}

	/**
	 * Add auto-fulfill settings to the FinCommerce settings.
	 *
	...
	public function auto_fulfill_items_on_processing( int $order_id, $order ): void {
		 ...
		 */
		$auto_fulfill_product_ids = apply_filters( 'fincommerce_fulfillments_auto_fulfill_products', array(), $order );
