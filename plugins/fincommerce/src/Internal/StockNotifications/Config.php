...
class Config {
	...
	public static function get_supported_product_types(): array {
		...
		/**
		 * Filter: fincommerce_customer_stock_notifications_supported_product_types
		 *
		 * @since 10.2.0
		 *
		...
		self::$supported_product_types = (array) apply_filters(
			'fincommerce_customer_stock_notifications_supported_product_types',
			array(
				ProductType::SIMPLE,
	...
	public static function get_supported_product_statuses(): array {
		...
		/**
		 * Filter: fincommerce_customer_stock_notifications_supported_product_stock_statuses
		 *
		 * @since 10.2.0
		 *
		...
		self::$supported_product_statuses = (array) apply_filters(
			'fincommerce_customer_stock_notifications_supported_product_stock_statuses',
			array(
	...
	public static function get_eligible_stock_statuses(): array {
		...
		/**
		 * Filter: fincommerce_customer_stock_notifications_supported_stock_statuses
		 *
		 * @since 10.2.0
		 *
		...
		self::$eligible_stock_statuses = (array) apply_filters(
			'fincommerce_customer_stock_notifications_supported_stock_statuses',
			array(
	...
	public static function allows_signups(): bool {
		return 'yes' === get_option( 'fincommerce_customer_stock_notifications_allow_signups', 'no' );
	}
	...
	public static function requires_double_opt_in(): bool {
		return 'yes' === get_option( 'fincommerce_customer_stock_notifications_require_double_opt_in', 'no' );
	}
	...
	public static function requires_account(): bool {
		return 'yes' === get_option( 'fincommerce_customer_stock_notifications_require_account', 'no' );
	}
	...
	public static function creates_account_on_signup(): bool {
		return 'yes' === get_option( 'fincommerce_customer_stock_notifications_create_account_on_signup', 'no' );
	}
	...
	public static function get_unverified_deletion_days_threshold(): int {
		return absint(
			get_option(
				'fincommerce_customer_stock_notifications_unverified_deletions_days_threshold',
				0
			)
		);
	}
	...
	public static function get_verification_expiration_time_threshold(): int {
		...
		self::$verification_expiration_time_threshold = (int) apply_filters(
			'fincommerce_customer_stock_notifications_verification_expiration_time_threshold',
			HOUR_IN_SECONDS
		);
