...
class CustomerStockNotificationEmail extends WC_Email {
	...
	public function __construct() {
		...
		$this->title       = __( 'Back in stock notification', 'fincommerce' );
		$this->description = __( 'Email sent to signed-up customers when a product is back in stock.', 'fincommerce' );
	...
	public function get_default_subject() {
		return __( '"{product_name}" is back in stock!', 'fincommerce' );
	}
	...
	public function get_default_heading() {
		return __( 'It\'s back in stock!', 'fincommerce' );
	}
	...
	public function get_default_intro_content() {
		return __( 'Great news: "{product_name}" is now available for purchase.', 'fincommerce' );
	}
	...
	private function get_additional_template_args(): array {
		 ...
		 */
		$button_text = apply_filters( 'fincommerce_email_stock_notification_button_text', _x( 'Shop Now', 'Email notification', 'fincommerce' ), $notification, $product );
		...
		$button_link = apply_filters(
			'fincommerce_email_stock_notification_button_link',
			add_query_arg(
				$query_args,
