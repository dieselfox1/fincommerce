...
class CustomerStockNotificationVerifiedEmail extends WC_Email {
	...
	public function __construct() {
		...
		$this->title       = __( 'Back in stock sign-up confirmation', 'fincommerce' );
		$this->description = __( 'Email sent to customers after completing the sign-up process successfully.', 'fincommerce' );
		...
		add_action( 'fincommerce_email_stock_notification_verified_notification', array( $this, 'trigger' ), 10, 1 );
	...
	public function get_default_subject() {
		return __( 'You have joined the "{product_name}" waitlist.', 'fincommerce' );
	}
	...
	public function get_default_heading() {
		return __( 'Sign-up successful', 'fincommerce' );
	}
	...
	public function get_default_intro_content() {
		return __( 'Thanks for joining the waitlist! You will hear from us again when "{product_name}" is back in stock.', 'fincommerce' );
	}
