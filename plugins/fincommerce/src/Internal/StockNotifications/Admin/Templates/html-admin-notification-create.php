...
<div class="wrap fincommerce-customer-stock-notifications">
	...
	<h1 class="wp-heading-inline"><?php esc_html_e( 'Add Notification', 'fincommerce' ); ?></h1>
	...
	<?php wp_nonce_field( 'fincommerce-customer-stock-notification-create', 'customer_stock_notification_create_security' ); ?>
					...
					<div class="inside">
						<ul class="order_actions submitbox">
							...
							<li class="wide" id="actions">
								...
								<button class="button wc-reload" disabled="disabled"><span><?php esc_html_e( 'Apply', 'fincommerce' ); ?></span></button>
							</li>

							<li class="wide">
								<button type="submit" class="button save_order button-primary" name="save" value="<?php esc_attr_e( 'Create', 'fincommerce' ); ?>"><?php esc_html_e( 'Create', 'fincommerce' ); ?></button>
							</li>
				...
				<div id="notification-data" class="postbox notification-data notification-data--create">
					<div class="notification-data__row notification-data__row--columns">
						...
						<div class="notification-data__header-column">
							...
							<h2 class="notification-data__header">
								<?php esc_html_e( 'Notification details', 'fincommerce' ); ?>
							</h2>
					...
					<div class="notification-data__row notification-data__row--columns">
						...
						<div class="notification-data__form-field">
							...
							<span class="or_relation_label"><?php esc_html_e( '&mdash;&nbsp;or&nbsp;&mdash;', 'fincommerce' ); ?></span>
							<input type="email" class="or_relation_label__input" placeholder="<?php esc_html_e( 'Enter customer e-mail&hellip;', 'fincommerce' ); ?>" name="user_email" value="<?php echo esc_attr( $email ); ?>"/>
