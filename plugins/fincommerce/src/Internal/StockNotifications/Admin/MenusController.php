...
class MenusController {
	...
	public function __construct() {
		...
		add_filter( 'fincommerce_screen_ids', array( $this, 'add_screen_ids' ) );
	...
	public function add_menu() {
		...
		$dashboard_page = add_submenu_page(
			'fincommerce',
			__( 'Stock Notifications', 'fincommerce' ),
			__( 'Notifications', 'fincommerce' ),
			'manage_fincommerce',
	...
	public function add_screen_options(): void {
		...
		add_screen_option(
			'per_page',
			array(
				'label'   => __( 'Notifications per page', 'fincommerce' ),
				'default' => 10,
