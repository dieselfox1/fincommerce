...
use Automattic\FinCommerce\Internal\StockNotifications\AsyncTasks\JobManager;
use Automattic\FinCommerce\Internal\StockNotifications\AsyncTasks\CycleStateService;
...
class NotificationsProcessor {
	...
	private function get_batch_size(): int {
		/**
		 * Filter: fincommerce_customer_stock_notifications_batch_size
		 *
		 * @since 10.2.0
		 *
		 ...
		 * @return int
		 */
		return (int) apply_filters( 'fincommerce_customer_stock_notifications_batch_size', self::BATCH_SIZE );
	}
