...
namespace Automattic\FinCommerce\Internal\StockNotifications\Privacy;
...
/**
 * Privacy eraser for FinCommerce Customer Stock Notifications.
 *
...
class PrivacyEraser extends \WC_Abstract_Privacy {
	...
	public function register_erasers_exporters() {
		$this->add_eraser(
			'fincommerce-customer-stock-notifications',
			__( 'FinCommerce Customer Stock Notifications', 'fincommerce' ),
	...
	public static function erase_notification_data( string $email_address ): array {
		...
		foreach ( $notifications as $notification_id ) {
			...
			/* translators: %d the numeric product ID */
				__( 'Removed back-in-stock notification for product id: %d', 'fincommerce' ),
