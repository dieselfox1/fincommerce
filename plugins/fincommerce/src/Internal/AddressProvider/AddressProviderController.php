...
namespace Automattic\FinCommerce\Internal\AddressProvider;
...
class AddressProviderController {
	...
	final public function init() {
		$this->preferred_provider_option = get_option( 'fincommerce_address_autocomplete_provider', '' );
	...
	private function get_registered_providers(): array {
		 ...
		 */
		$provider_items = apply_filters( 'fincommerce_address_providers', array() );
	...
	/**
	 * Get the preferred provider; this is what was selected in the FinCommerce "preferred provider" setting *or* the
