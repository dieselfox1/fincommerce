...
abstract class AbstractAutomatticAddressProvider extends WC_Address_Provider {
	...
	public function __construct() {
		add_filter( 'pre_update_option_fincommerce_address_autocomplete_enabled', array( $this, 'refresh_cache' ) );
	...
	public static function get_asset_url( $path ) {
		 ...
		 */
		return apply_filters( 'fincommerce_get_asset_url', plugins_url( $path, Constants::get_constant( 'WC_PLUGIN_FILE' ) ), $path );
	}
