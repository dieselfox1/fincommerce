...
class Filterer {
	...
	public function filtering_via_lookup_table_is_active() {
		return 'yes' === get_option( 'fincommerce_attribute_lookup_enabled' );
	}
	...
	public function filter_by_attribute_post_clauses( array $args, \WP_Query $wp_query, array $attributes_to_filter_by ) {
		...
		/**
		 * Filters the fincommerce_hide_out_of_stock_items option to override the default behavior in product filtering by attribute.
		 *
		 * @param bool $option_value The behavior configured in FinCommerce settings.
		 * @return bool The behavior to use in the catalog when product filtering by attribute.
		 *
		 * @since 9.8.0.
		 */
		$hide_out_of_stock = apply_filters( 'fincommerce_product_attributes_filterer_hide_out_of_stock', 'yes' === get_option( 'fincommerce_hide_out_of_stock_items' ) );
	...
	public function get_filtered_term_product_counts( $term_ids, $taxonomy, $query_type ) {
		...
		$query     = apply_filters( 'fincommerce_get_filtered_term_product_counts_query', $query );
		$query_sql = implode( ' ', $query );

		// We have a query - let's see if cached results of this query already exist.
		$query_hash = md5( $query_sql );
		// Maybe store a transient of the count values.
		$cache = apply_filters( 'fincommerce_layered_nav_count_maybe_cache', true );
		if ( true === $cache ) {
