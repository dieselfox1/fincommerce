<?php
/**
 * FinCommerce Admin (Dashboard) Order Milestones Note Provider.
 *
...
class OrderMilestones {
	 ...
	 */
	const LAST_ORDER_MILESTONE_OPTION_KEY = 'fincommerce_admin_last_orders_milestone';
	...
	public function __construct() {
		 ...
		 */
		$this->allowed_statuses = apply_filters( 'fincommerce_admin_order_milestone_statuses', $this->allowed_statuses );

		add_action( 'fincommerce_after_register_post_type', array( $this, 'init' ) );
	...
	public static function get_note_title_for_milestone( $milestone ) {
		switch ( $milestone ) {
			case 1:
				return __( 'First order received', 'fincommerce' );
			case 10:
			case 100:
			case 250:
			case 500:
			...
			case 1000000:
				return sprintf(
					...
					__( 'Congratulations on processing %s orders!', 'fincommerce' ),
	...
	public static function get_note_content_for_milestone( $milestone ) {
		switch ( $milestone ) {
			case 1:
				return __( 'Congratulations on getting your first order! Now is a great time to learn how to manage your orders.', 'fincommerce' );
			case 10:
				return __( "You've hit the 10 orders milestone! Look at you go. Browse some FinCommerce success stories for inspiration.", 'fincommerce' );
			case 100:
			case 250:
			case 500:
			case 1000:
			...
			case 500000:
			case 1000000:
				return __( 'Another order milestone! Take a look at your Orders Report to review your orders to date.', 'fincommerce' );
			default:
				return '';
		}
	}
	...
	public static function get_note_action_for_milestone( $milestone ) {
		switch ( $milestone ) {
			case 1:
				return array(
					'name'  => 'learn-more',
					'label' => __( 'Learn more', 'fincommerce' ),
					'query' => 'https://fincommerce.com/document/managing-orders/?utm_source=inbox&utm_medium=product',
				);
			case 10:
				return array(
					'name'  => 'browse',
					'label' => __( 'Browse', 'fincommerce' ),
					'query' => 'https://fincommerce.com/success-stories/?utm_source=inbox&utm_medium=product',
				);
			case 100:
			case 250:
			case 500:
			...
			case 1000000:
				return array(
					'name'  => 'review-orders',
					'label' => __( 'Review your orders', 'fincommerce' ),
	...
	public function are_milestones_enabled() {
		 ...
		 */
		$milestone_notes_enabled = apply_filters( 'fincommerce_admin_order_milestones_enabled', true );
