<?php
/**
 * FinCommerce Admin (Dashboard) Giving feedback notes provider
 *
...
use Automattic\FinCommerce\Internal\Admin\Survey;
...
class GivingFeedbackNotes {
	...
	public static function get_note() {
		...
		$note = new Note();
		$note->set_title( __( 'You\'re invited to share your experience', 'fincommerce' ) );
		$note->set_content( __( 'Now that you’ve chosen us as a partner, our goal is to make sure we\'re providing the right tools to meet your needs. We\'re looking forward to having your feedback on the store setup experience so we can improve it in the future.', 'fincommerce' ) );
