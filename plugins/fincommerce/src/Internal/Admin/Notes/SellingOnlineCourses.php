<?php
/**
 * FinCommerce Admin: Selling Online Courses note
 *
...
class SellingOnlineCourses {
	...
	public static function get_note() {
		...
		$note->set_title( __( 'Do you want to sell online courses?', 'fincommerce' ) );
		$note->set_content( __( 'Online courses are a great solution for any business that can teach a new skill. Since courses don’t require physical product development or shipping, they’re affordable, fast to create, and can generate passive income for years to come. In this article, we provide you more information about selling courses using FinCommerce.', 'fincommerce' ) );
