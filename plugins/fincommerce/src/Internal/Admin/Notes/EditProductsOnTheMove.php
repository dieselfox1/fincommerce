<?php
/**
 * FinCommerce Admin Edit products on the move note.
 *
...
class EditProductsOnTheMove {
	...
	public static function get_note() {
		...
		$note->set_title( __( 'Edit products on the move', 'fincommerce' ) );
		$note->set_content( __( 'Edit and create new products from your mobile devices with the Woo app', 'fincommerce' ) );
