<?php
/**
 * FinCommerce Admin: How to customize your product catalog note provider
 *
 ...
 *
 * @package Automattic\FinCommerce\Admin\Notes
 */
class CustomizingProductCatalog {
	/**
	 * Note traits.
	...
	public static function get_note() {
		...
		$note = new Note();
		$note->set_title( __( 'How to customize your product catalog', 'fincommerce' ) );
		$note->set_content( __( 'You want your product catalog and images to look great and align with your brand. This guide will give you all the tips you need to get your products looking great in your store.', 'fincommerce' ) );
		...
		$note->add_action(
			...
			'https://fincommerce.com/document/fincommerce-customizer/?utm_source=inbox&utm_medium=product'
		);
