<?php
/**
 * FinCommerce Admin Unsecured Files Note.
 *
...
class UnsecuredReportFiles {
	...
	public static function get_note() {
		$note = new Note();
		$note->set_title( __( 'Potentially unsecured files were found in your uploads directory', 'fincommerce' ) );
		$note->set_content(
			sprintf(
				/* translators: 1: opening analytics docs link tag. 2: closing link tag */
				__( 'Files that may contain %1$sstore analytics%2$s reports were found in your uploads directory - we recommend assessing and deleting any such files.', 'fincommerce' ),
				'<a href="https://fincommerce.com/document/fincommerce-analytics/" target="_blank">',
				'</a>'
			)
		);
		...
		$note->add_action(
			...
			'https://developer.fincommerce.com/2021/09/22/important-security-patch-released-in-fincommerce/',
