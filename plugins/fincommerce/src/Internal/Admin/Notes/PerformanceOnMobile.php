<?php
/**
 * FinCommerce Admin Performance on mobile note.
 *
...
class PerformanceOnMobile {
	...
	public static function get_note() {
		...
		$note->set_title( __( 'Track your store performance on mobile', 'fincommerce' ) );
		$note->set_content( __( 'Monitor your sales and high performing products with the Woo app.', 'fincommerce' ) );
