<?php
/**
 * FinCommerce Admin: Start your online clothing store.
 *
...
class OnlineClothingStore {
	...
	public static function get_note() {
		...
		$note = new Note();
		$note->set_title( __( 'Start your online clothing store', 'fincommerce' ) );
		$note->set_content( __( 'Starting a fashion website is exciting but it may seem overwhelming as well. In this article, we\'ll walk you through the setup process, teach you to create successful product listings, and show you how to market to your ideal audience.', 'fincommerce' ) );
		...
		$note->add_action(
			...
			'https://fincommerce.com/posts/starting-an-online-clothing-store/?utm_source=inbox&utm_medium=product',
