<?php
/**
 * FinCommerce Admin: Customize your online store with FinCommerce blocks.
 *
 * Adds a note to customize the client online store with FinCommerce blocks.
 *
...
class CustomizeStoreWithBlocks {
	...
	public static function get_note() {
		...
		$note = new Note();
		$note->set_title( __( 'Customize your online store with FinCommerce blocks', 'fincommerce' ) );
		$note->set_content( __( 'With our blocks, you can select and display products, categories, filters, and more virtually anywhere on your site — no need to use shortcodes or edit lines of code. Learn more about how to use each one of them.', 'fincommerce' ) );
		...
		$note->add_action(
			...
			'https://fincommerce.com/posts/how-to-customize-your-online-store-with-fincommerce-blocks/?utm_source=inbox&utm_medium=product',
