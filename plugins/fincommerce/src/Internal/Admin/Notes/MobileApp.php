<?php
/**
 * FinCommerce Admin Mobile App Note Provider.
 *
...
class MobileApp {
	...
	public static function get_note() {
		...
		$content = __( 'Install the FinCommerce mobile app to manage orders, receive sales notifications, and view key metrics — wherever you are.', 'fincommerce' );

		$note = new Note();
		$note->set_title( __( 'Install Woo mobile app', 'fincommerce' ) );
		$note->set_content( $content );
		$note->set_content_data( (object) array() );
		$note->set_type( Note::E_WC_ADMIN_NOTE_INFORMATIONAL );
		$note->set_name( self::NOTE_NAME );
		$note->set_source( 'fincommerce-admin' );
		$note->add_action( 'learn-more', __( 'Learn more', 'fincommerce' ), 'https://fincommerce.com/mobile/?utm_medium=product' );
		return $note;
	}
}
