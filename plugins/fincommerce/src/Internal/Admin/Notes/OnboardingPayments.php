<?php
/**
 * FinCommerce Admin: Payments reminder note.
 *
...
class OnboardingPayments {
	...
	public static function get_note() {
		...
		$note = new Note();
		$note->set_title( __( 'Start accepting payments on your store!', 'fincommerce' ) );
		$note->set_content( __( 'Take payments with the provider that’s right for you - choose from 100+ payment gateways for FinCommerce.', 'fincommerce' ) );
		...
		$note->add_action(
			...
			'https://fincommerce.com/product-category/fincommerce-extensions/payment-gateways/?utm_medium=product',
