<?php
/**
 * FinCommerce Admin: Do you need help with adding your first product?
 *
...
class FirstProduct {
	...
	public static function get_note() {
		...
		$note = new Note();
		$note->set_title( __( 'Do you need help with adding your first product?', 'fincommerce' ) );
		$note->set_content( __( 'This video tutorial will help you go through the process of adding your first product in FinCommerce.', 'fincommerce' ) );
