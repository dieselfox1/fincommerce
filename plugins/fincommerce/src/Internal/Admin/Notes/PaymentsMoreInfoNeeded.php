<?php
/**
 * FinCommerce Admin Payments More Info Needed Inbox Note Provider
 */
...
class PaymentsMoreInfoNeeded {
	...
	public static function get_note() {
		...
		$content = __( 'We recently asked you if you wanted more information about WooPayments. Run your business and manage your payments in one place with the solution built and supported by FinCommerce.', 'fincommerce' );

		$note = new Note();
		$note->set_title( __( 'Payments made simple with WooPayments', 'fincommerce' ) );
		$note->set_content( $content );
		$note->set_content_data( (object) array() );
		$note->set_type( Note::E_WC_ADMIN_NOTE_INFORMATIONAL );
		$note->set_name( self::NOTE_NAME );
		$note->set_source( 'fincommerce-admin' );
		$note->add_action( 'learn-more', __( 'Learn more here', 'fincommerce' ), 'https://fincommerce.com/payments/' );
		return $note;
	}
}
