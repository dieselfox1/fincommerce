...
class Coupons {
	...
	public function __construct() {
		...
		add_action( 'fincommerce_register_post_type_shop_coupon', array( $this, 'move_coupons' ) );
	...
	public function move_coupons( $args ) {
		$args['show_in_menu'] = current_user_can( 'manage_fincommerce' ) ? 'fincommerce-marketing' : true;
		return $args;
	}
	...
	public function maybe_add_marketing_coupon_script() {
		...
		if ( ! isset( $curent_screen['id'] ) || $curent_screen['id'] !== 'fincommerce-coupons' ) {
			return;
		}
