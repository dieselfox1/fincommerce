<?php
/**
 * FinCommerce Shipping Label Banner Display Rules.
 */
...
class ShippingLabelBannerDisplayRules {
	...
	/**
	 * Holds the installed FinCommerce Shipping & Tax version.
	 *
	 * @var string
	 */
	private $wcs_version;
	...
	private function banner_not_dismissed() {
		$dismissed_timestamp_ms = get_option( 'fincommerce_shipping_dismissed_timestamp' );
	...
	private function store_in_us_and_usd() {
		$base_currency = get_fincommerce_currency();
	...
	/**
	 * Checks if FinCommerce Shipping & Tax is not installed.
	 *
	 * @return bool
	 */
