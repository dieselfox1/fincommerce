...
class AbstractBlock implements BlockInterface {
	 ...
	 * See [@fincommerce/expression-evaluation](https://github.com/dieselfox1/fincommerce/blob/trunk/packages/js/expression-evaluation/README.md) for more details.
	 *
	...
	public function add_hide_condition( string $expression ): string {
		 ...
		 * @since 8.4.0
		 */
		do_action( 'fincommerce_block_template_after_add_hide_condition', $this );
	...
	public function remove_hide_condition( string $key ) {
		 ...
		 * @since 8.4.0
		 */
		do_action( 'fincommerce_block_template_after_remove_hide_condition', $this );
	}
