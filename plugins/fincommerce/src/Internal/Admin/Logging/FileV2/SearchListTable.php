...
class SearchListTable extends WP_List_Table {
	 ...
	 * @const string
	 */
	public const PER_PAGE_USER_OPTION_KEY = 'fincommerce_logging_search_results_per_page';
	...
	public function no_items(): void {
		esc_html_e( 'No search results.', 'fincommerce' );
	}
		...
		if ( $total_items >= $this->file_controller::SEARCH_MAX_RESULTS ) {
			printf(
				...
				sprintf(
					...
					esc_html__( 'The number of search results has reached the limit of %s. Try refining your search.', 'fincommerce' ),
	...
	public function get_columns(): array {
		$columns = array(
			'file_id'     => esc_html__( 'File', 'fincommerce' ),
			'line_number' => esc_html__( 'Line #', 'fincommerce' ),
			'line'        => esc_html__( 'Matched Line', 'fincommerce' ),
		);
