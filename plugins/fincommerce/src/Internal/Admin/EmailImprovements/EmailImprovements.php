...
namespace Automattic\FinCommerce\Internal\Admin\EmailImprovements;
...
class EmailImprovements {
	...
	private const EMAIL_CUSTOMIZERS = array(
		'aco-email-customizer-and-designer-for-fincommerce.php',
		'decorator.php',
		'email-customizer-for-fincommerce.php',
		'email-customizer-pro.php',
		'kadence-fincommerce-email-designer.php',
		'mailpoet.php',
		'wp-html-mail.php',
		'yaymail.php',
	);
	...
	public static function is_email_improvements_enabled_for_existing_stores() {
		...
		$is_enabled_for_existing_stores = 'yes' === get_option( 'fincommerce_email_improvements_existing_store_enabled' );
	...
	public static function should_enable_email_improvements_for_existing_stores() {
		...
		$manually_disabled_before = get_option( 'fincommerce_email_improvements_last_disabled_at' );
	...
	/**
	 * Add email improvements modal parameter to the URL when loading the FinCommerce Home page.
	 *
	 * @return void
	 */
	public static function add_email_improvements_modal_to_url() {
		...
		$dismissed_modal = get_option( 'fincommerce_admin_dismissed_email_improvements_modal' );
		if ( 'yes' !== $dismissed_modal && self::is_email_improvements_enabled_for_existing_stores() ) {
			update_option( 'fincommerce_admin_dismissed_email_improvements_modal', 'yes' );
			wp_safe_redirect( add_query_arg( 'emailImprovementsModal', 'enabled' ) );
			exit;
		}

		$dismissed_modal = get_option( 'fincommerce_admin_dismissed_try_email_improvements_modal' );
