 ...
 *
 * Fetches the specifications for the marketing feature from FinCommerce.com API.
 */

namespace Automattic\FinCommerce\Internal\Admin\Marketing;
...
class MarketingSpecs {
	...
	/**
	 * Load knowledge base posts from FinCommerce.com
	 *
	...
	public function get_knowledge_base_posts( ?string $topic ): array {
		...
		if ( false === $posts ) {
			$request_url = add_query_arg(
				...
				'https://fincommerce.com/wp-json/wccom/marketing-knowledgebase/v1/posts/' . $topic
			);
