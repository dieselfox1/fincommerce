...
namespace Automattic\FinCommerce\Internal\Admin\Settings\Exceptions;
...
class ApiException extends \Exception {
	 ...
	 * Setup exception.
	 *
	 * @param string $error_code       Machine-readable error code, e.g `fincommerce_invalid_step_id`.
