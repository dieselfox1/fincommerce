...
use Automattic\FinCommerce\Internal\Font\FontFace;
use Automattic\FinCommerce\Internal\Font\FontFamily;
...
class OnboardingFonts {
	...
	final public static function init() {
		add_action( 'fincommerce_install_assembler_fonts', array( __CLASS__, 'install_fonts' ) );
		add_filter( 'update_option_fincommerce_allow_tracking', array( self::class, 'start_install_fonts_async_job' ), 10, 2 );
	}
	 ...
	 * PHP version of https://github.com/dieselfox1/fincommerce/blob/45923dc5f38150c717210ae9db10045cd9582331/plugins/fincommerce-admin/client/customize-store/assembler-hub/sidebar/global-styles/font-pairing-variations/constants.ts/#L13-L74
	 *
	 * @var array
	 */
	...
	public static function start_install_fonts_async_job( $old_value, $value ) {
		...
		WC()->call_function(
			...
			'fincommerce_install_assembler_fonts',
		);
	}
				...
				if ( is_wp_error( $wp_error ) ) {
					wc_get_logger()->error(
						sprintf(
							...
							__( 'Font Face installation error: %s', 'fincommerce' ),
