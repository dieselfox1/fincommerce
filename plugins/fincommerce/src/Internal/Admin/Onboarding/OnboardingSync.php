...
class OnboardingSync {
	...
	public function init() {
		...
		add_action( 'fincommerce_helper_connected', array( $this, 'send_profile_data_on_connect' ) );
	...
	/**
	 * Send profile data to FinCommerce.com.
	 */
	private function send_profile_data() {
		...
		$defaults      = array(
			...
			'default_currency'    => get_fincommerce_currency(),
		);
