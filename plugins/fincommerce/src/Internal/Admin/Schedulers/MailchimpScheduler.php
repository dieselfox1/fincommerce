 ...
 *
 * @package Automattic\FinCommerce\Admin\Schedulers
 */
class MailchimpScheduler {

	const SUBSCRIBE_ENDPOINT     = 'https://fincommerce.com/wp-json/wccom/v1/subscribe';
	const SUBSCRIBE_ENDPOINT_DEV = 'https://fincommerce.test/wp-json/wccom/v1/subscribe';

	const SUBSCRIBED_OPTION_NAME             = 'fincommerce_onboarding_subscribed_to_mailchimp';
	const SUBSCRIBED_ERROR_COUNT_OPTION_NAME = 'fincommerce_onboarding_subscribed_to_mailchimp_error_count';
	...
	public function run() {
		...
		$profile_data = get_option( 'fincommerce_onboarding_profile' );
