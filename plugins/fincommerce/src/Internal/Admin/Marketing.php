...
class Marketing {
	...
	public function __construct() {
		...
		add_filter( 'fincommerce_admin_shared_settings', array( $this, 'component_settings' ), 30 );
	}
	...
	public function register_pages() {
		 ...
		 */
		$marketing_pages = apply_filters( 'fincommerce_marketing_menu_items', array() );
	...
	protected function register_overview_page() {
		...
		if ( ! isset( $submenu['fincommerce-marketing'] ) ) {
			return;
		}

		foreach ( $submenu['fincommerce-marketing'] as &$item ) {
	...
	public function reorder_marketing_submenu() {
		...
		$marketing_submenu = $submenu['fincommerce-marketing'];
