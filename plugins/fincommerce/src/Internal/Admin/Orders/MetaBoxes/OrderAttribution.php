	...
	public function format_meta_data( array &$meta ) {
		...
		if ( array_key_exists( 'device_type', $meta ) ) {
			...
			switch ( $meta['device_type'] ) {
				case 'Mobile':
					$meta['device_type'] = __( 'Mobile', 'fincommerce' );
					break;
				case 'Tablet':
					$meta['device_type'] = __( 'Tablet', 'fincommerce' );
					break;
				case 'Desktop':
					$meta['device_type'] = __( 'Desktop', 'fincommerce' );
					break;

				default:
					$meta['device_type'] = __( 'Unknown', 'fincommerce' );
					break;
			}
		}
