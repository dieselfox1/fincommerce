...
class Marketplace {
	...
	public function get_marketplace_pages() {
		$marketplace_pages = array(
			array(
				...
				'parent'     => 'fincommerce',
				'title'      => __( 'Extensions', 'fincommerce' ) . $this->badge(),
				'page_title' => __( 'Extensions', 'fincommerce' ),
				'path'       => '/extensions',
			),
		);
		 ...
		 * @since 8.0
		 */
		return apply_filters( 'fincommerce_marketplace_menu_items', $marketplace_pages );
	}
	...
	public function add_woo_plugin_install_action_link( $tabs ) {
		$tabs[ self::MARKETPLACE_TAB_SLUG ] = 'FinCommerce Marketplace';
		return $tabs;
	}
