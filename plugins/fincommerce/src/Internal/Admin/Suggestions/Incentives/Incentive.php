...
namespace Automattic\FinCommerce\Internal\Admin\Suggestions\Incentives;

/**
 * Abstract class for payment extension suggestion incentive provider classes.
 */
abstract class Incentive {
	const PREFIX = 'fincommerce_admin_pes_incentive_';
	...
	public function dismiss( string $id, string $context = 'all', ?int $timestamp = null ): bool {
		 ...
		 * @since 9.9.0
		 */
		do_action( 'fincommerce_admin_payments_extension_suggestion_incentive_dismissed', $id, $this->suggestion_id, $context );
