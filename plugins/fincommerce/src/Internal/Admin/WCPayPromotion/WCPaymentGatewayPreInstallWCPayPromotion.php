...
class WCPaymentGatewayPreInstallWCPayPromotion extends \WC_Payment_Gateway {
	...
	const GATEWAY_ID = 'pre_install_fincommerce_payments_promotion';
	...
	public function init_form_fields() {
		$this->form_fields = array(
			'is_dismissed' => array(
				'title'   => __( 'Dismiss', 'fincommerce' ),
				'type'    => 'checkbox',
				'label'   => __( 'Dismiss the gateway', 'fincommerce' ),
				'default' => 'no',
			),
		);
	}
	...
	public static function is_dismissed() {
		$settings = get_option( 'fincommerce_' . self::GATEWAY_ID . '_settings', array() );
