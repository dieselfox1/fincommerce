<?php
/**
 * FinCommerce Shipping Label banner.
 */
...
class ShippingLabelBanner {
	...
	/**
	 * Check if FinCommerce Shipping makes sense for this merchant.
	 *
	 * @return bool
	 */
	...
	public function add_print_shipping_label_script( $hook ) {
		...
		$wc_shipping_plugin_file = WP_PLUGIN_DIR . '/fincommerce-shipping/fincommerce-shipping.php';
	...
	public function meta_box( $post, $args ) {
		...
		?>
		<div id="wc-admin-shipping-banner-root" class="fincommerce <?php echo esc_attr( 'wc-admin-shipping-banner' ); ?>" data-args="<?php echo esc_attr( wp_json_encode( $args['args'] ) ); ?>">
		</div>
		<?php
	}
}
