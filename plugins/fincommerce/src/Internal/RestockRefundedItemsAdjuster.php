...
class RestockRefundedItemsAdjuster {
	...
	final public function init() {
		...
		add_action( 'fincommerce_before_save_order_items', array( $this, 'initialize_restock_refunded_items' ), 10, 2 );
	}

	/**
	 * Initializes the restock refunded items meta for order version less than 5.5.
	 *
	 * @see https://github.com/dieselfox1/fincommerce/issues/29502
	 *
