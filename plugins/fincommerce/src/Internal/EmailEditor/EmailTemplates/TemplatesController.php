...
/**
 * Controller for managing FinCommerce email templates.
 *
 * @internal
 */
class TemplatesController {
	 ...
	 * @var string
	 */
	private string $template_prefix = 'fincommerce';
	...
	final public function init(): void {
		add_filter( 'fincommerce_email_editor_register_templates', array( $this, 'register_templates' ) );
	...
	/**
	 * Register FinCommerce email templates with the template registry.
	 *
