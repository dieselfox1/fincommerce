...
/**
 * Basic template for FinCommerce transactional emails used in the email editor.
 */
class WooEmailTemplate {
	...
	public function get_title(): string {
		return __( 'Woo Email Template', 'fincommerce' );
	}
	...
	public function get_description(): string {
		return __( 'Basic template for FinCommerce transactional emails used in the email editor', 'fincommerce' );
	}
...
<p class="has-text-align-center has-text-color has-link-color has-small-font-size" style="border-top-color:var(--wp--preset--color--cyan-bluish-gray);border-top-style:solid;border-top-width:1px;color:#787c82;padding-top:var(--wp--preset--spacing--20);padding-bottom:var(--wp--preset--spacing--20)">You received this email because you shopped at <!--[fincommerce/site-title]--></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
		';
	}
