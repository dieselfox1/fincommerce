 ...
 *
 * Handles the initialization and management of FinCommerce transactional emails.
 *
...
class WCTransactionalEmails {
	...
	/**
	 * Get the Core FinCommerce transactional emails for the block editor.
	 *
	 * @return array
	 */
	public static function get_transactional_emails() {
		 ...
		 * @since 9.9.0
		 */
		return apply_filters( 'fincommerce_transactional_emails_for_block_editor', $emails );
	}

	/**
	 * Initialize email templates on FinCommerce admin pages.
	 */
	public function init_email_templates() {
		...
		// run only on FinCommerce admin pages.
