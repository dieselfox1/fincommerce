...
namespace Automattic\FinCommerce\Internal\EmailEditor\WCTransactionalEmails;
 ...
 *
 * Handles the generation of FinCommerce transactional email templates.
 ...
 *
 * @package Automattic\FinCommerce\Internal\EmailEditor\WCTransactionalEmails
 */
class WCTransactionalEmailPostsGenerator {
	/**
	...
	/**
	 * Initialize the default FinCommerce Transactional Emails.
	 *
	 * This function initializes the default templates for the core transactional emails.
	 * It fetches all the emails from FinCommerce and filters them to include only the core transactional emails.
	 */
	public function init_default_transactional_emails() {
		...
		/**
		 * FinCommerce Transactional Emails instance.
		 *
		 * @var \WC_Email[]
		 */
	 ...
	 *
	 * Looks for the initial email block content in plugins/fincommerce/templates/emails/block.
	 *
