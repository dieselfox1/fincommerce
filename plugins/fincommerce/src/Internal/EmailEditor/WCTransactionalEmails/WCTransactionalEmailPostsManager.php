...
/**
 * Class responsible for managing FinCommerce email editor post templates.
 */
class WCTransactionalEmailPostsManager {
	const WC_OPTION_NAME = 'fincommerce_email_templates_%_post_id';
	...
	/**
	 * Retrieves the FinCommerce email type from the options table when post ID is provided.
	 *
	 * @param int|string $post_id The post ID.
	 * @return string|null The FinCommerce email type if found, null otherwise.
	 */
	 ...
	 *
	 * @param string $email_type The type of email template e.g. 'customer_new_account' from the WC_Email->id property.
	 * @return string The option name e.g. 'fincommerce_email_templates_customer_new_account_post_id'
	 */
	 ...
	 *
	 * @param string $option_name The option name e.g. 'fincommerce_email_templates_customer_new_account_post_id'.
	 * @return string The email type e.g. 'customer_new_account'
	 */
	private function get_email_type_from_option_name( $option_name ) {
		return str_replace(
			array(
				'fincommerce_email_templates_',
				'_post_id',
			),
			'',
			$option_name
