<?php
/**
 * This file is part of the FinCommerce package.
 *
 * @package Automattic\FinCommerce\Internal\EmailEditor
 */
...
use Automattic\FinCommerce\EmailEditor\Engine\Logger\Email_Editor_Logger_Interface;
use WC_Log_Levels;

/**
 * FinCommerce logger adapter for the email editor.
 *
 * This class adapts the FinCommerce logger to work with the email editor logging interface.
 */
class Logger implements Email_Editor_Logger_Interface {
	/**
	 * The FinCommerce logger instance.
	 *
	 ...
	 * Constructor.
	 *
	 * @param \WC_Logger_Interface $wc_logger The FinCommerce logger instance.
	 */
	...
	private function should_handle( string $level ): bool {
		 ...
		 * @since 10.2.0
		 */
		$logging_threshold = apply_filters( 'fincommerce_email_editor_logging_threshold', WC_Log_Levels::WARNING );
