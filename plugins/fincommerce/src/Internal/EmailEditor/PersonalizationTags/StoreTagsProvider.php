	...
	public function register_tags( Personalization_Tags_Registry $registry ): void {
		$registry->register(
			new Personalization_Tag(
				__( 'Store Email', 'fincommerce' ),
				'fincommerce/store-email',
				__( 'Store', 'fincommerce' ),
		...
		$registry->register(
			new Personalization_Tag(
				__( 'Store Name', 'fincommerce' ),
				'fincommerce/store-name',
				__( 'Store', 'fincommerce' ),
				function ( array $context ): string {
		...
		$registry->register(
			new Personalization_Tag(
				__( 'Store Address', 'fincommerce' ),
				'fincommerce/store-address',
				__( 'Store', 'fincommerce' ),
				function (): string {
		...
		$registry->register(
			new Personalization_Tag(
				__( 'My Account URL', 'fincommerce' ),
				'fincommerce/my-account-url',
				__( 'Store', 'fincommerce' ),
				function (): string {
		...
		$registry->register(
			new Personalization_Tag(
				__( 'Admin Order Note', 'fincommerce' ),
				'fincommerce/admin-order-note',
				__( 'Store', 'fincommerce' ),
				function ( array $context ): string {
