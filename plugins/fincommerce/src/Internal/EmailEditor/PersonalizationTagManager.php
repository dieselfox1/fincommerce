...
use Automattic\FinCommerce\Internal\EmailEditor\PersonalizationTags\CustomerTagsProvider;
use Automattic\FinCommerce\Internal\EmailEditor\PersonalizationTags\OrderTagsProvider;
use Automattic\FinCommerce\Internal\EmailEditor\PersonalizationTags\SiteTagsProvider;
use Automattic\FinCommerce\Internal\EmailEditor\PersonalizationTags\StoreTagsProvider;

defined( 'ABSPATH' ) || exit;

/**
 * Manages personalization tags for FinCommerce emails.
 *
 * @internal
 */
class PersonalizationTagManager {
	...
	final public function init(): void {
		add_filter( 'fincommerce_email_editor_register_personalization_tags', array( $this, 'register_personalization_tags' ) );
	}

	/**
	 * Register FinCommerce personalization tags with the registry.
	 *
