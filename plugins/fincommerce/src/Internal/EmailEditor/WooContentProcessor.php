...
class WooContentProcessor {
	...
	/**
	 * Get the FinCommerce content excluding headers and footers.
	 *
	 ...
	 * The method hookes to fincommerce_email_styles and removes CSS rules that we don't want to apply to the email.
	 *
	 * @param string $css CSS.
	 * @return string
	 */
	public function prepare_css( string $css ): string {
		remove_filter( 'fincommerce_email_styles', array( $this, 'prepare_css' ) );
		// Remove color and font-family declarations from FinCommerce CSS.
	 ...
	 *
	 * @param string $woo_content FinCommerce content.
	 * @return string
	 */
	...
	/**
	 * Capture the FinCommerce content excluding headers and footers.
	 *
	 * @param \WC_Email $wc_email FinCommerce email.
	 * @return string
	 */
