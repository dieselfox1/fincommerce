...
namespace Automattic\FinCommerce\Internal\EmailEditor\EmailPatterns;

use Automattic\FinCommerce\EmailEditor\Engine\Patterns\Abstract_Pattern;
use Automattic\FinCommerce\Internal\EmailEditor\Integration;

/**
 * Pattern class for FinCommerce email content.
 *
 * Provides a default content pattern that can be used in FinCommerce email templates.
 */
class WooEmailContentPattern extends Abstract_Pattern {
	 ...
	 * @var string
	 */
	public $namespace = 'fincommerce';      // Required.
...
<!-- /wp:group -->';
	...
	public function get_title(): string {
		...
		return __( 'Woo Email Content Pattern', 'fincommerce' );
	}
}
