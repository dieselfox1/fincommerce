...
use Automattic\FinCommerce\EmailEditor\Engine\Templates\Template;
...
class PageRenderer {
	...
	public function render() {
		...
		add_filter( 'fincommerce_email_editor_script_localization_data', array( $this, 'update_localized_data' ) );
		// Load the email editor integration script.
		// The JS file is located in plugins/fincommerce/client/admin/client/wp-admin-scripts/email-editor-integration/index.ts.
		...
		remove_filter(
			'fincommerce_email_editor_script_localization_data',
	...
	public function update_localized_data( array $localized_data ): array {
		// Fetch all email types from FinCommerce including those added by other plugins.
