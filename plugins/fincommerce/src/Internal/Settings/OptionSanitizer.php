...
namespace Automattic\FinCommerce\Internal\Settings;
...
class OptionSanitizer {
	...
	public function __construct() {
		...
		foreach ( $color_options as $option_name ) {
			add_filter(
				"fincommerce_admin_settings_sanitize_option_{$option_name}",
		...
		add_filter( 'fincommerce_admin_settings_sanitize_option_fincommerce_notify_no_stock_amount', 'absint' );
	}
