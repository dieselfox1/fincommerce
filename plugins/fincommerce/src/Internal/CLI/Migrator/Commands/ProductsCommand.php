...
namespace Automattic\FinCommerce\Internal\CLI\Migrator\Commands;

use Automattic\FinCommerce\Internal\CLI\Migrator\Core\CredentialManager;
use Automattic\FinCommerce\Internal\CLI\Migrator\Core\PlatformRegistry;
use Automattic\FinCommerce\Internal\CLI\Migrator\Core\ProductsController;
use WP_CLI;
...
final class ProductsCommand {
	 ...
	 * @internal
	 */
	final public function init( CredentialManager $credential_manager, PlatformRegistry $platform_registry, ProductsController $products_controller ): void { // phpcs:ignore Generic.CodeAnalysis.UnnecessaryFinalModifier.Found -- Required by FinCommerce injection method rules
	 ...
	 * : Filter products by type (for Shopify: any product type name, or 'single'/'variable' for FinCommerce equivalents).
	 *
	 * [--vendor=<vendor>]
	 ...
	 *
	 * [--skip-existing]
	 * : Skip products that already exist in FinCommerce.
	 *
	 * [--dry-run]
	 ...
	 * : Assign FinCommerce default category to products that have no categories.
	 *
	 * ## EXAMPLES
	 *
