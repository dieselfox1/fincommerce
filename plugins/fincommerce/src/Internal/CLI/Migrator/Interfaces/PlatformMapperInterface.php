...
namespace Automattic\FinCommerce\Internal\CLI\Migrator\Interfaces;

/**
 * Defines the contract for classes responsible for transforming
 * raw platform data into a standardized format suitable for the FinCommerce Importer.
 */
interface PlatformMapperInterface {
	 ...
	 *
	 * @return array A standardized array representing the product, understandable by the fincommerce_Product_Importer.
