 ...
 */
class fincommerceProductImporter {
	...
	/**
	 * Constructor - parameterless to support FinCommerce DI container.
	 */
	 ...
	 *
	 * @param array $product_data Mapped FinCommerce product data.
