 ...
 * Products Controller
 *
 * @package Automattic\FinCommerce\Internal\CLI\Migrator\Core
 */
...
use Automattic\FinCommerce\Internal\CLI\Migrator\Lib\ImportSession;
use Exception;
use WP_CLI;
...
class ProductsController {
	...
	/**
	 * FinCommerce Product Importer instance.
	 *
	 * @var fincommerceProductImporter
	 */
	private fincommerceProductImporter $product_importer;

	/**
	 * Initialize the controller with its dependencies.
	 * Called automatically by the FinCommerce DI container.
	 *
	 * @internal
	 *
	 ...
	 * @param fincommerceProductImporter $product_importer   The product importer.
	 */
	final public function init(
		CredentialManager $credential_manager,
		PlatformRegistry $platform_registry,
		fincommerceProductImporter $product_importer
	): void {
