...
class ShopifyFetcher implements PlatformFetcherInterface {
	 ...
	 * collections, and metadata for migration to FinCommerce.
	 */
	...
	public function fetch_batch( array $args ): array {
		...
		return array(
			'items'         => $items,
			'cursor'        => $last_cursor,
			// phpcs:ignore finpress.NamingConventions.ValidVariableName.UsedPropertyNotSnakeCase -- GraphQL response property
