 ...
 * Shopify Mapper
 *
 * @package Automattic\FinCommerce\Internal\CLI\Migrator\Platforms\Shopify
 */

declare( strict_types=1 );

namespace Automattic\FinCommerce\Internal\CLI\Migrator\Platforms\Shopify;
 ...
 * into a standardized format suitable for the FinCommerce Importer.
...
class ShopifyMapper implements PlatformMapperInterface {
	 ...
	 * @return array Standardized data array for fincommerce_Product_Importer.
	 */
	...
	/**
	 * Converts the Shopify product status into FinCommerce product status.
	 *
	 * @param object $shopify_product The Shopify product data.
	 * @return string The FinCommerce product status.
	 */
	...
	/**
	 * Gets mapped FinCommerce product categories from Shopify collections.
	 *
	 * @param object $shopify_product The Shopify product data.
	...
	/**
	 * Gets mapped FinCommerce product tags from Shopify tags.
	 *
	 * @param object $shopify_product The Shopify product data.
	...
	private function get_converted_weight( $weight, $weight_unit ): ?float {
		...
		$store_weight_unit = get_option( 'fincommerce_weight_unit' );
	...
	/**
	 * Maps basic product fields from Shopify to FinCommerce format.
	 *
	 * @param object $shopify_product The Shopify product data.
