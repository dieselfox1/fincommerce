...
/**
 * Proxy class to access legacy FinCommerce functionality.
 *
...
class LegacyProxy {
	 ...
	 * @throws \Exception The requested class has a namespace starting with ' Automattic\FinCommerce', or there was an error creating an instance of the class.
	 */
	public function get_instance_of( string $class_name, ...$args ) {
		if ( StringUtil::starts_with( $class_name, 'Automattic\\FinCommerce\\' ) ) {
			throw new \Exception(
				'The LegacyProxy class is not intended for getting instances of classes whose namespace starts with \'Automattic\\FinCommerce\', please use ' .
