...
namespace Automattic\FinCommerce\LayoutTemplates;

use Automattic\FinCommerce\Admin\BlockTemplates\BlockTemplateInterface;

use Automattic\FinCommerce\Internal\Admin\BlockTemplates\BlockTemplateLogger;
...
final class LayoutTemplateRegistry {
	...
	private function get_layout_template_instance( $layout_template_info ): BlockTemplateInterface {
		 ...
		 * @since 8.6.0
		 */
		do_action( 'fincommerce_layout_template_after_instantiation', $layout_template_info['id'], $layout_template_info['area'], $layout_template_instance );

		// Call the old, deprecated, register hook.
		wc_do_deprecated_action( 'fincommerce_block_template_register', array( $layout_template_instance ), '8.6.0', 'fincommerce_layout_template_after_instantiation' );
