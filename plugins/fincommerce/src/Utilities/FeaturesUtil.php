...
/**
 * Class with methods that allow to retrieve information about the existing FinCommerce features,
 * also has methods for FinCommerce plugins to declare (in)compatibility with the features.
 */
class FeaturesUtil {
	 ...
	 *
	 * This method MUST be executed from inside a handler for the 'before_fincommerce_init' hook and
