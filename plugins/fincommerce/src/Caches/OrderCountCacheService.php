...
namespace Automattic\FinCommerce\Caches;
...
class OrderCountCacheService {
	...
	const BACKGROUND_EVENT_HOOK = 'fincommerce_refresh_order_count_cache';
	...
	final public function init() {
		...
		add_action( 'fincommerce_new_order', array( $this, 'update_on_new_order' ), 10, 2 );
		add_action( 'fincommerce_order_status_changed', array( $this, 'update_on_order_status_changed' ), 10, 4 );
		add_action( 'fincommerce_before_trash_order', array( $this, 'update_on_order_trashed' ), 10, 2 );
		add_action( 'fincommerce_before_delete_order', array( $this, 'update_on_order_deleted' ), 10, 2 );
