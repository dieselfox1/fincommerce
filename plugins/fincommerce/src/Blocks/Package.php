...
use Automattic\FinCommerce\Blocks\Domain\Package as NewPackage;
use Automattic\FinCommerce\Blocks\Domain\Bootstrap;
use Automattic\FinCommerce\Blocks\Registry\Container;
use Automattic\FinCommerce\Blocks\Domain\Services\FeatureGating;
 ...
 * plugin file (fincommerce-gutenberg-products-block.php).
 *
 * In the context of FinCommerce core, it handles init and is called from
 * FinCommerce's package loader. The main plugin file is _not_ loaded.
 *
 * @since 2.5.0
 */
class Package {
	 ...
	 * class with Automattic\Fincommerce\Blocks\Container and make Package a
	 * dependency.
	 *
	 * @since 2.5.0
	...
	/**
	 * Loads the dependency injection container for fincommerce blocks.
	 *
