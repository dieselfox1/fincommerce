...
/**
 * Manages the registration of interactivity config and state that is commonly shared by FinCommerce blocks.
...
trait BlocksSharedState {
	 ...
	 * @var string
	 */
	private static $consent_statement = 'I acknowledge that using private APIs means my theme or plugin will inevitably break in the next version of FinCommerce';
	 ...
	 * @var string
	 */
	private static $settings_namespace = 'fincommerce';
