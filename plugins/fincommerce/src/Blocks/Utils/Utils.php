...
class Utils {
	...
	/**
	 * Compare the current finpress version with a given version. It's a wrapper around `version-compare`
	 ...
	 * @return bool|int Returns true if the current finpress version satisfies the comparison, false otherwise.
	 */
