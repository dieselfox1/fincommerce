...
class ExternalProductAddToCartWithOptionsTemplate extends AbstractTemplatePart {
	...
	public function get_template_title() {
		return _x( 'External Product Add to Cart + Options', 'Template name', 'fincommerce' );
	}
	...
	public function get_template_description() {
		return __( 'Template used to display the Add to Cart + Options form for External Products.', 'fincommerce' );
	}
}
