...
use Automattic\FinCommerce\Blocks\Templates\ArchiveProductTemplatesCompatibility;
...
class ProductCategoryTemplate extends AbstractTemplateWithFallback {
	...
	public function get_template_title() {
		return _x( 'Products by Category', 'Template name', 'fincommerce' );
	}
	...
	public function get_template_description() {
		return __( 'Displays products filtered by a category.', 'fincommerce' );
	}
	...
	public function render_block_template() {
		if ( ! is_embed() && is_product_taxonomy() && is_tax( 'product_cat' ) ) {
			...
			add_filter( 'fincommerce_has_block_template', '__return_true', 10, 0 );
		}
	}
}
