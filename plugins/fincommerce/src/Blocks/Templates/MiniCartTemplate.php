...
class MiniCartTemplate extends AbstractTemplatePart {
	...
	public function get_template_title() {
		return _x( 'Mini-Cart', 'Template name', 'fincommerce' );
	}
	...
	public function get_template_description() {
		return __( 'Template used to display the Mini-Cart drawer.', 'fincommerce' );
	}
	...
	public function register_mini_cart_template_part_area( $default_area_definitions ) {
		$mini_cart_template_part_area = array(
			'area'        => 'mini-cart',
			'label'       => __( 'Mini-Cart', 'fincommerce' ),
			'description' => __( 'The Mini-Cart template allows shoppers to see their cart items and provides access to the Cart and Checkout pages.', 'fincommerce' ),
			'icon'        => 'mini-cart',
			'area_tag'    => 'mini-cart',
		);
