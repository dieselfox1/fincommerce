...
class OrderConfirmationTemplate extends AbstractPageTemplate {
	...
	public function get_template_title() {
		return _x( 'Order Confirmation', 'Template name', 'fincommerce' );
	}
	...
	public function get_template_description() {
		return __( 'The Order Confirmation template serves as a receipt and confirmation of a successful purchase. It includes a summary of the ordered items, shipping, billing, and totals.', 'fincommerce' );
	}
