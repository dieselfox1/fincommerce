...
class ArchiveProductTemplatesCompatibility extends AbstractTemplateCompatibility {
	...
	public function inject_hooks( $block_content, $block ) {
		...
		// https://github.com/dieselfox1/fincommerce-blocks/issues/9463.
	...
	protected function set_hook_data() {
		$this->hook_data = array(
			'fincommerce_before_main_content'         => array(
				'block_names' => array( 'core/query', 'fincommerce/product-collection' ),
				'position'    => 'before',
				'hooked'      => array(
			...
			'fincommerce_before_shop_loop_item_title' => array(
				'block_names' => array( 'core/post-title' ),
				'position'    => 'before',
				'hooked'      => array(
					'fincommerce_show_product_loop_sale_flash' => 10,
					'fincommerce_template_loop_product_thumbnail' => 10,
				),
			),
			'fincommerce_shop_loop_item_title'        => array(
				'block_names' => array( 'core/post-title' ),
				'position'    => 'after',
				'hooked'      => array(
					'fincommerce_template_loop_product_title' => 10,
				),
			),
			'fincommerce_after_shop_loop_item_title'  => array(
				'block_names' => array( 'core/post-title' ),
				'position'    => 'after',
				'hooked'      => array(
					'fincommerce_template_loop_rating' => 5,
					'fincommerce_template_loop_price'  => 10,
				),
			),
			'fincommerce_before_shop_loop_item'       => array(
				'block_names' => array( self::LOOP_ITEM_ID ),
				'position'    => 'before',
				'hooked'      => array(
					'fincommerce_template_loop_product_link_open' => 10,
				),
			),
			'fincommerce_after_shop_loop_item'        => array(
				'block_names' => array( self::LOOP_ITEM_ID ),
				'position'    => 'after',
				'hooked'      => array(
					'fincommerce_template_loop_product_link_close' => 5,
					'fincommerce_template_loop_add_to_cart' => 10,
				),
			),
			'fincommerce_before_shop_loop'            => array(
				'block_names'                 => array( 'core/post-template', 'fincommerce/product-template' ),
				'position'                    => 'before',
				'hooked'                      => array(
					'fincommerce_output_all_notices' => 10,
					'fincommerce_result_count'       => 20,
					'fincommerce_catalog_ordering'   => 30,
				),
				'permanently_removed_actions' => array(
					'fincommerce_output_all_notices',
					'fincommerce_result_count',
					'fincommerce_catalog_ordering',
				),
			),
			'fincommerce_after_shop_loop'             => array(
				'block_names'                 => array( 'core/post-template', 'fincommerce/product-template' ),
				'position'                    => 'after',
				'hooked'                      => array(
					'fincommerce_pagination' => 10,
				),
				'permanently_removed_actions' => array(
					'fincommerce_pagination',
				),
			),
			'fincommerce_no_products_found'           => array(
			...
			'fincommerce_archive_description'         => array(
				'block_names' => array( 'core/term-description' ),
				'position'    => 'before',
				'hooked'      => array(
					'fincommerce_taxonomy_archive_description' => 10,
					'fincommerce_product_archive_description'  => 10,
				),
			),
		);
	}
	...
	private function is_block_within_namespace( $block ) {
		...
		return isset( $attributes['__fincommerceNamespace'] ) && 'fincommerce/product-query/product-template' === $attributes['__fincommerceNamespace'];
	}
	...
	private function is_product_template( $block_name ) {
		return 'fincommerce/product-template' === $block_name;
	}
	...
	private function is_products_block_with_inherit_query( $block ) {
		...
		'fincommerce/product-query' === $block['attrs']['namespace'] &&
	...
	private function is_product_collection_block_with_inherit_query( $block ) {
		return 'fincommerce/product-collection' === $block['blockName'] &&
		isset( $block['attrs']['query']['inherit'] ) &&
		$block['attrs']['query']['inherit'];
	}
