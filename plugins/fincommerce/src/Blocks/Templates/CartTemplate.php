...
class CartTemplate extends AbstractPageTemplate {
	...
	public function get_template_title() {
		return _x( 'Page: Cart', 'Template name', 'fincommerce' );
	}
	...
	public function get_template_description() {
		return __( 'The Cart template displays the items selected by the user for purchase, including quantities, prices, and discounts. It allows users to review their choices before proceeding to checkout.', 'fincommerce' );
	}
