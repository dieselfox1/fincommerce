...
class CheckoutTemplate extends AbstractPageTemplate {
	...
	public function get_template_title() {
		return _x( 'Page: Checkout', 'Template name', 'fincommerce' );
	}
	...
	public function get_template_description() {
		return __( 'The Checkout template guides users through the final steps of the purchase process. It enables users to enter shipping and billing information, select a payment method, and review order details.', 'fincommerce' );
	}
