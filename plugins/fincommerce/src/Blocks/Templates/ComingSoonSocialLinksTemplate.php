...
class ComingSoonSocialLinksTemplate extends AbstractTemplatePart {
	...
	public function get_template_title() {
		return _x( 'Coming soon social links', 'Template name', 'fincommerce' );
	}
	...
	public function get_template_description() {
		return __( 'Reusable template part for displaying social links on the coming soon page.', 'fincommerce' );
	}
