...
namespace Automattic\FinCommerce\Blocks\Templates;
...
class SingleProductTemplateCompatibility extends AbstractTemplateCompatibility {
	const IS_FIRST_BLOCK = '__fincommerceIsFirstBlock';
	const IS_LAST_BLOCK  = '__fincommerceIsLastBlock';
	...
	private function inject_hook_to_first_and_last_blocks( $block_content, $block, $block_hooks ) {
		$first_block_hook = array(
			'before' => array(
				'fincommerce_before_main_content'   => $this->hook_data['fincommerce_before_main_content'],
				'fincommerce_before_single_product' => $this->hook_data['fincommerce_before_single_product'],
				'fincommerce_before_single_product_summary' => $this->hook_data['fincommerce_before_single_product_summary'],
			),
			'after'  => array(),
		);
		...
		$last_block_hook = array(
			'before' => array(),
			'after'  => array(
				'fincommerce_after_single_product' => $this->hook_data['fincommerce_after_single_product'],
				'fincommerce_after_main_content'   => $this->hook_data['fincommerce_after_main_content'],
				'fincommerce_sidebar'              => $this->hook_data['fincommerce_sidebar'],
			),
		);
	...
	protected function set_hook_data() {
		$this->hook_data = array(
			'fincommerce_before_main_content'           => array(
				'block_names' => array(),
				'position'    => 'before',
				'hooked'      => array(
					'fincommerce_output_content_wrapper' => 10,
					'fincommerce_breadcrumb'             => 20,
				),
			),
			'fincommerce_after_main_content'            => array(
				'block_names' => array(),
				'position'    => 'after',
				'hooked'      => array(
					'fincommerce_output_content_wrapper_end' => 10,
				),
			),
			'fincommerce_sidebar'                       => array(
				'block_names' => array(),
				'position'    => 'after',
				'hooked'      => array(
					'fincommerce_get_sidebar' => 10,
				),
			),
			'fincommerce_before_single_product'         => array(
				'block_names' => array(),
				'position'    => 'before',
				'hooked'      => array(
					'fincommerce_output_all_notices' => 10,
				),
			),
			'fincommerce_before_single_product_summary' => array(
				'block_names' => array(),
				'position'    => 'before',
				'hooked'      => array(
					'fincommerce_show_product_sale_flash' => 10,
					'fincommerce_show_product_images'     => 20,
				),
			),
			'fincommerce_single_product_summary'        => array(
				'block_names' => array( 'core/post-excerpt', 'fincommerce/product-summary' ),
				'position'    => 'before',
				'hooked'      => array(
					'fincommerce_template_single_title'   => 5,
					'fincommerce_template_single_rating'  => 10,
					'fincommerce_template_single_price'   => 10,
					'fincommerce_template_single_excerpt' => 20,
					'fincommerce_template_single_add_to_cart' => 30,
					'fincommerce_template_single_meta'    => 40,
					'fincommerce_template_single_sharing' => 50,
				),
			),
			'fincommerce_after_single_product'          => array(
				'block_names' => array(),
				'position'    => 'after',
				'hooked'      => array(),
			),
			'fincommerce_product_meta_start'            => array(
				'block_names' => array( 'fincommerce/product-meta' ),
				'position'    => 'before',
				'hooked'      => array(),
			),
			'fincommerce_product_meta_end'              => array(
				'block_names' => array( 'fincommerce/product-meta' ),
				'position'    => 'after',
				'hooked'      => array(),
			),
			'fincommerce_share'                         => array(
				'block_names' => array( 'fincommerce/product-details' ),
				'position'    => 'before',
				'hooked'      => array(),
			),
			'fincommerce_after_single_product_summary'  => array(
				'block_names' => array( 'fincommerce/product-details' ),
				'position'    => 'after',
				'hooked'      => array(
					'fincommerce_output_product_data_tabs' => 10,
					// We want to display the upsell products after the last block that belongs to the Single Product.
					// 'fincommerce_upsell_display'           => 15.
					'fincommerce_output_related_products'  => 20,
				),
			),
		);
	}
	 ...
	 * For more details, see https://github.com/dieselfox1/fincommerce-blocks/issues/8314.
	 *
	...
	private static function create_wrap_block_group( $blocks ) {
		...
		$new_block = parse_blocks(
			sprintf(
				'<!-- wp:group {"className":"fincommerce product"} -->
	 ...
	 * fincommerce/product-gallery-image, fincommerce/product-details, fincommerce/add-to-cart-form, etc.
	 *
	...
	private static function has_single_product_template_blocks( $parsed_blocks ) {
		$single_product_template_blocks = array( 'fincommerce/product-image-gallery', 'fincommerce/product-gallery', 'fincommerce/product-details', 'fincommerce/add-to-cart-form', 'fincommerce/add-to-cart-with-options', 'fincommerce/product-meta', 'fincommerce/product-price', 'fincommerce/breadcrumbs' );
