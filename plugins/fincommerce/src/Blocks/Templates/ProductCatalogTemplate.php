...
class ProductCatalogTemplate extends AbstractTemplate {
	...
	public function get_template_title() {
		return _x( 'Product Catalog', 'Template name', 'fincommerce' );
	}
	...
	public function get_template_description() {
		return __( 'Displays your products.', 'fincommerce' );
	}
	 ...
	 *
	 * @see https://github.com/dieselfox1/fincommerce-gutenberg-products-block/issues/6278
	 *
