...
abstract class AbstractTemplateCompatibility {
	...
	public function init() {
		...
		add_filter(
			...
			function ( $parsed_block, $source_block, $parent_block ) {
				...
				* @param boolean.
				*/
				$is_disabled_compatility_layer = apply_filters( 'fincommerce_disable_compatibility_layer', false );
	...
	/**
	 * Remove the default callback added by FinCommerce. We replaced these
	...
	protected function remove_default_hooks() {
		 ...
		 */
		$additional_hook_data = apply_filters( 'fincommerce_blocks_hook_compatibility_additional_data', array(), $class_name );
