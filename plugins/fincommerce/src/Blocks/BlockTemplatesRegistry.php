...
use Automattic\FinCommerce\Blocks\Templates\AbstractTemplate;
use Automattic\FinCommerce\Blocks\Templates\AbstractTemplatePart;
use Automattic\FinCommerce\Blocks\Templates\MiniCartTemplate;
use Automattic\FinCommerce\Blocks\Templates\CartTemplate;
use Automattic\FinCommerce\Blocks\Templates\CheckoutTemplate;
use Automattic\FinCommerce\Blocks\Templates\CheckoutHeaderTemplate;
...
use Automattic\FinCommerce\Blocks\Templates\ProductBrandTemplate;
...
use Automattic\FinCommerce\Blocks\Templates\SimpleProductAddToCartWithOptionsTemplate;
use Automattic\FinCommerce\Blocks\Templates\ExternalProductAddToCartWithOptionsTemplate;
use Automattic\FinCommerce\Blocks\Templates\VariableProductAddToCartWithOptionsTemplate;
use Automattic\FinCommerce\Blocks\Templates\GroupedProductAddToCartWithOptionsTemplate;
...
class BlockTemplatesRegistry {
	...
	public function register_add_to_cart_with_options_template_part_area( $default_area_definitions ) {
		$add_to_cart_with_options_template_part_area = array(
			...
			'label'       => __( 'Add to Cart + Options', 'fincommerce' ),
			'description' => __( 'The Add to Cart + Options templates allow defining a different layout for each product type.', 'fincommerce' ),
