<?php
namespace Automattic\FinCommerce\Blocks\Payments\Integrations;
...
final class PayPal extends AbstractPaymentMethodType {
	...
	public function initialize() {
		$this->settings = get_option( 'fincommerce_paypal_settings', [] );
	}
	...
	public function get_supported_features() {
		 ...
		 */
		return apply_filters( '__experimental_fincommerce_blocks_payment_gateway_features_list', $features, $this->get_name() );
	}
}
