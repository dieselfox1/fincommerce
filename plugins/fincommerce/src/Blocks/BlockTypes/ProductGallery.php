		...
		?>
			<dialog
				...
				<div class="wc-block-product-gallery-dialog__content">
					<button class="wc-block-product-gallery-dialog__close-button" data-wp-on--click="actions.closeDialog" aria-label="<?php echo esc_attr__( 'Close dialog', 'fincommerce' ); ?>">
			...
			$p->set_attribute(
				...
				wp_json_encode(
					array(
						...
						'ariaLabelPrevious'       => __( 'Previous image', 'fincommerce' ),
						'ariaLabelNext'           => __( 'Next image', 'fincommerce' ),
					),
