...
class HandlerRegistry {
	...
	public function register_core_collections() {
		$this->register_collection_handlers(
			'fincommerce/product-collection/hand-picked',
		...
		$this->register_collection_handlers(
			'fincommerce/product-collection/by-category',
			function ( $collection_args, $common_query_values, $query ) {
		...
		$this->register_collection_handlers(
			'fincommerce/product-collection/by-tag',
			function ( $collection_args, $common_query_values, $query ) {
		...
		$this->register_collection_handlers(
			'fincommerce/product-collection/related',
			function ( $collection_args ) {
				...
				add_filter( 'fincommerce_product_related_posts_relate_by_category', $category_callback, PHP_INT_MAX );
				add_filter( 'fincommerce_product_related_posts_relate_by_tag', $tag_callback, PHP_INT_MAX );
				...
				remove_filter( 'fincommerce_product_related_posts_relate_by_category', $category_callback, PHP_INT_MAX );
				remove_filter( 'fincommerce_product_related_posts_relate_by_tag', $tag_callback, PHP_INT_MAX );
		...
		$this->register_collection_handlers(
			'fincommerce/product-collection/upsells',
			function ( $collection_args ) {
