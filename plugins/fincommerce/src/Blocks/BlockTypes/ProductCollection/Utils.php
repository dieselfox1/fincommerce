...
class Utils {
	...
	public static function parse_frontend_location_context() {
		...
		if ( is_order_received_page() ) {
			...
			$has_cart_block     = $current_page && \WC_Blocks_Utils::has_block_in_page( $current_page, 'fincommerce/cart' );
			$has_checkout_block = $current_page && \WC_Blocks_Utils::has_block_in_page( $current_page, 'fincommerce/checkout' );
