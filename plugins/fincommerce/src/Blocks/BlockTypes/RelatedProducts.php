...
class RelatedProducts extends AbstractBlock {
	...
	public function update_query( $pre_render, $parsed_block ) {
		...
		if ( ProductQuery::is_fincommerce_variation( $parsed_block ) && 'fincommerce/related-products' === $parsed_block['attrs']['namespace'] ) {
	...
	private function is_related_products_block( $parsed_block, $rendered_block = null ) {
		...
		if ( ProductQuery::is_fincommerce_variation( $parsed_block ) && isset( $parsed_block['attrs']['namespace'] ) && 'fincommerce/related-products' === $parsed_block['attrs']['namespace'] && ! $is_product_collection_block ) {
			return true;
		}
	 ...
	 * The logic is copied from the core function fincommerce_related_products. https://github.com/dieselfox1/fincommerce/blob/ca49caabcba84ce9f60a03c6d3534ec14b350b80/plugins/fincommerce/includes/wc-template-functions.php/#L2039-L2074
	 *
