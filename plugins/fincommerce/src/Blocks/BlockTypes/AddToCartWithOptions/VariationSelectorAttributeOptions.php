...
class VariationSelectorAttributeOptions extends AbstractBlock {
	...
	protected function render( $attributes, $content, $block ): string {
		if (
			! isset(
				...
				$block->context['fincommerce/attributeTerms']
			)
		) {
			return '';
		}

		$attribute_slug = wc_variation_attribute_name( $block->context['fincommerce/attributeName'] );
	...
	protected function render_pills( $attributes, $content, $block ) {
		...
		$attribute_slug  = wc_variation_attribute_name( $block->context['fincommerce/attributeName'] );
		$attribute_terms = $block->context['fincommerce/attributeTerms'];
	...
	protected function render_dropdown( $attributes, $content, $block ) {
		...
		$default_option  = array(
			'label'      => esc_html__( 'Choose an option', 'fincommerce' ),
			'value'      => '',
			'isSelected' => false,
		);
