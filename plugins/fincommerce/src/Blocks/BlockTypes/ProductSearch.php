...
class ProductSearch extends AbstractBlock {
	...
	protected function render( $attributes, $content, $block ) {
		 ...
		 * `experimental__fincommerce_blocks-product-search`. This can be used by tracking extensions such as Google
				...
				for ( const form of forms ) {
					form.addEventListener( 'submit', ( event ) => {
						...
						if ( field && field.value ) {
							wp.hooks.doAction( 'experimental__fincommerce_blocks-product-search', { event: event, searchTerm: field.value } );
						}
					} );
				}
			} );
