...
class ProductSummary extends AbstractBlock {
	...
	private function get_source( $product, $show_description_if_empty ) {
		...
		if ( $short_description ) {
			// Logic copied from https://github.com/dieselfox1/fincommerce/blob/637dde283057ed6667ff81c73ed08774552f631d/plugins/fincommerce/includes/wc-core-functions.php#L53-L62.
	...
	private function create_anchor( $product, $link_text ) {
		...
		return '<a class="wp-block-fincommerce-product-summary__read_more" href="' . $href . '#tab-description">' . $text . '</a>';
	}
	 ...
	 * plugins/fincommerce/client/blocks/assets/js/base/components/summary/utils.ts!
	 *
	 ...
	 * https://github.com/dieselfox1/fincommerce/issues/52835
	 *
	 * @param string $source     Source text.
	...
	protected function render( $attributes, $content, $block ) {
		...
		return sprintf(
			'<div class="wp-block-fincommerce-product-summary"><div class="wc-block-components-product-summary %1$s" style="%2$s">
				%3$s
			</div></div>',
