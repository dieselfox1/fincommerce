	...
	protected function render( $attributes, $content, $block ) {
		...
		if ( '0' === $comment->comment_approved ) {
			if ( $commenter['comment_author_email'] ) {
				$moderation_note = __( 'Your review is awaiting moderation.', 'fincommerce' );
			} else {
				$moderation_note = __( 'Your review is awaiting moderation. This is a preview; your review will be visible after it has been approved.', 'fincommerce' );
			}
