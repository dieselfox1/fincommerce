...
use Automattic\FinCommerce\Internal\ProductFilters\Params;
...
class ProductFilters extends AbstractBlock {
	...
	protected function render( $attributes, $content, $block ) {
		 ...
		 * @since 9.7.0
		 */
		$active_filters = apply_filters( 'fincommerce_blocks_product_filters_selected_items', array(), $filter_params );
		...
		// TODO: Remove this conditional once the fix is released in WP. https://github.com/dieselfox1/gutenberg/pull/4.
			...
			<div class="wc-block-product-filters__overlay">
				<div class="wc-block-product-filters__overlay-wrapper">
					<div
						...
						role="dialog"
						aria-label="<?php echo esc_html__( 'Product Filters', 'fincommerce' ); ?>"
					>
						...
						>
							<button
								...
								data-wp-on--click="actions.closeOverlay"
							>
								<span><?php echo esc_html__( 'Apply', 'fincommerce' ); ?></span>
							</button>
						</footer>
					</div>
				</div>
