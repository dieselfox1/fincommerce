...
use Automattic\FinCommerce\Internal\ProductFilters\FilterDataProvider;
use Automattic\FinCommerce\Internal\ProductFilters\QueryClauses;
...
final class ProductFilterAttribute extends AbstractBlock {
	...
	protected function initialize() {
		...
		add_filter( 'fincommerce_blocks_product_filters_selected_items', array( $this, 'prepare_selected_filters' ), 10, 2 );
	...
	protected function render( $block_attributes, $content, $block ) {
		...
		$wrapper_attributes = array(
			'data-wp-interactive' => 'fincommerce/product-filters',
	...
	private function get_default_product_attribute() {
		...
		$default_attribute = (object) array(
			...
			'attribute_label'   => __( 'Attribute', 'fincommerce' ),
	...
	public function register_block_patterns() {
		...
		register_block_pattern(
			'fincommerce/default-attribute-filter',
			array(
				'title'    => '',
				'inserter' => false,
				'content'  => strtr(
					'
<!-- wp:fincommerce/product-filter-attribute {"attributeId":{{attribute_id}}} -->
<div class="wp-block-fincommerce-product-filter-attribute">
	...
	<!-- wp:fincommerce/product-filter-checkbox-list {"lock":{"remove":true}} -->
	<div class="wp-block-fincommerce-product-filter-checkbox-list wc-block-product-filter-checkbox-list"></div>
	<!-- /wp:fincommerce/product-filter-checkbox-list -->

</div>
<!-- /wp:fincommerce/product-filter-attribute -->
					',
					array(
