...
class MiniCartFooterBlock extends AbstractInnerBlock {
	...
	protected function render_experimental_iapi_mini_cart_footer( $attributes, $content, $block ) {
		...
		$subtotal_label                   = __( 'Subtotal', 'fincommerce' );
		$other_costs_label                = __( 'Shipping, taxes, and discounts calculated at checkout.', 'fincommerce' );
		...
		$wrapper_attributes               = get_block_wrapper_attributes(
			array(
				'data-wp-interactive' => 'fincommerce/mini-cart-footer-block',
		...
		<div <?php echo $wrapper_attributes; // phpcs:ignore finpress.Security.EscapeOutput.OutputNotEscaped ?>>
			<div class="wc-block-components-totals-item wc-block-mini-cart__footer-subtotal">
				...
				<span data-wp-text="fincommerce/mini-cart::state.formattedSubtotal" class="wc-block-formatted-money-amount wc-block-components-formatted-money-amount wc-block-components-totals-item__value">
				</span>
