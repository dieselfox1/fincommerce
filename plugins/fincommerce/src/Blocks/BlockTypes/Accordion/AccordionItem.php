...
class AccordionItem extends AbstractBlock {
	...
	protected function render( $attributes, $content, $block ) {
		...
		$unique_id = wp_unique_id( 'fincommerce-accordion-item-' );
		...
		if ( $p->next_tag( array( 'class_name' => 'wp-block-fincommerce-accordion-item' ) ) ) {
			...
			if ( $p->next_tag( array( 'class_name' => 'accordion-item__toggle' ) ) ) {
				...
				if ( $p->next_tag( array( 'class_name' => 'wp-block-fincommerce-accordion-panel' ) ) ) {
