...
class ProductImage extends AbstractBlock {
	...
	private function render_anchor( $product, $on_sale_badge, $product_image, $attributes, $inner_blocks_content ) {
		...
		$directive      = $is_link ? 'data-wp-on--click="fincommerce/product-collection::actions.viewProduct"' : '';
	...
	private function render_image( $product, $attributes, $image_id = null ) {
		$image_size = 'single' === $attributes['imageSizing'] ? 'fincommerce_single' : 'fincommerce_thumbnail';
	...
	protected function enqueue_data( array $attributes = [] ) {
		...
		$this->asset_data_registry->add( 'placeholderImgSrcFullSize', wc_placeholder_img_src( 'fincommerce_single' ) );
	}
