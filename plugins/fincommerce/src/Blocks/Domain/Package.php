...
class Package {
	...
	/**
	 * Returns the version of FinCommerce Blocks.
	 *
	 * Note: since Blocks was merged into FinCommerce Core, the version of
	 * WC Blocks doesn't update anymore. Use
	 * `Constants::get_constant( 'WC_VERSION' )` when possible to get the
	 * FinCommerce Core version.
	 *
	 * @return string
	 */
	...
	/**
	 * Returns the version of FinCommerce Blocks stored in the database.
	 *
	 * @return string
	 */
	...
	/**
	 * Sets the version of FinCommerce Blocks in the database.
