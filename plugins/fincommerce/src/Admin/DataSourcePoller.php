...
use Automattic\FinCommerce\Admin\RemoteSpecs\DataSourcePoller as RemoteSpecsDataSourcePoller;
...
abstract class DataSourcePoller extends RemoteSpecsDataSourcePoller {
	...
	private static function log_deprecation() {
		 ...
		 * For more details, see the discussion in the FinCommerce GitHub repository:
		 * https://github.com/dieselfox1/fincommerce/pull/45892.
		 */
	}
