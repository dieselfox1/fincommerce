...
trait OrderTraits {
	...
	public function get_item_shipping_amount( $item, $order_items_count = null, $shipping_amount = null ) {
		// Shipping amount loosely based on fincommerce code in includes/admin/meta-boxes/views/html-order-item(s).php
	 ...
	 *
	 * Coupon calculation based on fincommerce code in includes/admin/meta-boxes/views/html-order-item.php.
	 *
	 * @param WC_Order_Item $item Line item from order.
	 *
	 * @return float
