 ...
 * WC Admin Order
 *
 * WC Admin Order class that adds some functionality on top of general FinCommerce WC_Order.
 */

namespace Automattic\FinCommerce\Admin\Overrides;
...
class Order extends \WC_Order {
	...
	public static function add_filters() {
		add_filter( 'fincommerce_order_class', array( __CLASS__, 'order_class_name' ), 10, 3 );
	}
	...
	public static function order_class_name( $classname, $order_type, $order_id ) {
		...
		if ( 'WC_Order' === $classname ) {
			return '\Automattic\FinCommerce\Admin\Overrides\Order';
		} else {
			return $classname;
		}
	}
