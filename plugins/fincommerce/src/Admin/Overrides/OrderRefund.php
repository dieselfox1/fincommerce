 ...
 *
 * WC Admin Order Refund class that adds some functionality on top of general FinCommerce WC_Order_Refund.
 */
...
class OrderRefund extends \WC_Order_Refund {
	...
	public static function order_class_name( $classname, $order_type, $order_id ) {
		...
		if ( 'WC_Order_Refund' === $classname ) {
			return '\Automattic\FinCommerce\Admin\Overrides\OrderRefund';
		} else {
			return $classname;
		}
	}
