...
class ReportCSVEmail extends \WC_Email {
	...
	public function __construct() {
		...
		$this->report_labels = apply_filters(
			'fincommerce_report_export_email_labels',
			array(
				'categories' => __( 'Categories', 'fincommerce' ),
				...
				'revenue'    => __( 'Revenue', 'fincommerce' ),
	...
	public function get_default_heading() {
		return __( 'Your Report Download', 'fincommerce' );
	}
	...
	public function get_default_subject() {
		return __( '[{site_title}]: Your {report_name} Report download is ready', 'fincommerce' );
	}
