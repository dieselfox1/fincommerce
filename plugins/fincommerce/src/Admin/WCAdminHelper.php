...
class WCAdminHelper {
	 ...
	 */
	const WC_ADMIN_TIMESTAMP_OPTION = 'fincommerce_admin_install_timestamp';
	...
	/**
	 * Test how long FinCommerce Admin has been active.
	 *
	 * @param int $seconds Time in seconds to check.
	 * @return bool Whether or not FinCommerce admin has been active for $seconds.
	 */
	...
	/**
	 * Test if FinCommerce Admin has been active within a pre-defined range.
	 *
	 ...
	 * @return bool Whether or not FinCommerce admin has been active within the range.
	 */
	...
	public static function is_current_page_store_page() {
		 ...
		 */
		$store_pages = apply_filters( 'fincommerce_store_pages', $store_pages );
		 ...
		 */
		$is_store_page = apply_filters( 'fincommerce_is_extension_store_page', false, $url );
