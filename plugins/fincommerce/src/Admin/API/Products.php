...
class Products extends \WC_REST_Products_Controller {
	...
	public function get_item_schema() {
		...
		$schema['properties']['last_order_date'] = array(
			'description' => __( "The date the last order for this product was placed, in the site's timezone.", 'fincommerce' ),
			'type'        => 'date-time',
	...
	public function get_collection_params() {
		...
		$params['low_in_stock'] = array(
			'description'       => __( 'Limit result set to products that are low or out of stock. (Deprecated)', 'fincommerce' ),
			'type'              => 'boolean',
			'default'           => false,
			'sanitize_callback' => 'wc_string_to_bool',
		);
		$params['search']       = array(
			'description'       => __( 'Search by similar product name or sku.', 'fincommerce' ),
			'type'              => 'string',
	...
	public function get_items( $request ) {
		...
		/**
		 * The low stock query caused performance issues in FinCommerce 5.5.1
		 ...
		 *
		 * https://github.com/dieselfox1/fincommerce-admin/issues/7358
		 */
