 ...
 *
 * It calls the filters `fincommerce_analytics_{$this->context}_query_args` and
 * `fincommerce_analytics_{$this->context}_select_query` on the `get_data` method.
 *
 * Example:
...
trait FilteredGetDataTrait {
	...
	public function get_data( $query_args ) {
		 ...
		 * @param array $query_args Query parameters.
		 */
		$args    = apply_filters( "fincommerce_analytics_{$this->context}_query_args", $query_args );
		 ...
		 */
		return apply_filters( "fincommerce_analytics_{$this->context}_select_query", $results, $args );
	}
}
