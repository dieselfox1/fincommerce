...
class DataStore extends ReportsDataStore implements DataStoreInterface {
	 ...
	 *
	 * @see Automattic\FinCommerce\Admin\API\Reports\Taxes\DataStore::add_sql_query_params()
	...
	public function get_noncached_stats_data( $query_args, $params, &$data, $expected_interval_count ) {
		...
		if ( null === $totals ) {
			return new \WP_Error( 'fincommerce_analytics_taxes_stats_result_failed', __( 'Sorry, fetching revenue data failed.', 'fincommerce' ) );
		}
		...
		if ( null === $intervals ) {
			return new \WP_Error( 'fincommerce_analytics_taxes_stats_result_failed', __( 'Sorry, fetching tax data failed.', 'fincommerce' ) );
		}
