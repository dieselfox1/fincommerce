...
namespace Automattic\FinCommerce\Admin\API\Reports\Taxes\Stats;
...
class Controller extends GenericStatsController {
	...
	public function __construct() {
		add_filter( 'fincommerce_analytics_taxes_stats_select_query', array( $this, 'set_default_report_data' ) );
	}
	...
	public function prepare_item_for_response( $report, $request ) {
		 ...
		 */
		return apply_filters( 'fincommerce_rest_prepare_report_taxes_stats', $response, $report, $request );
	}
	...
	protected function get_item_properties_schema() {
		return array(
			...
			'tax_codes'    => array(
				'description' => __( 'Amount of tax codes.', 'fincommerce' ),
				'type'        => 'integer',
				'context'     => array( 'view', 'edit' ),
				'readonly'    => true,
			),
	...
	public function get_collection_params() {
		...
		$params['taxes']           = array(
			'description'       => __( 'Limit result set to all items that have the specified term assigned in the taxes taxonomy.', 'fincommerce' ),
			'type'              => 'array',
