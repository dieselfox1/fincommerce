...
trait OrderAwareControllerTrait {
	...
	/**
	 * Get the order number for an order. If no filter is present for `fincommerce_order_number`, we can just return the ID.
	...
	protected function get_order_number( $order_id ) {
		...
		if ( ! has_filter( 'fincommerce_order_number' ) ) {
			return $order->get_id();
		}
	...
	public static function get_order_statuses() {
		...
		// See: https://github.com/dieselfox1/fincommerce-admin/issues/5592.
