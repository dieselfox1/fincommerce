...
namespace Automattic\FinCommerce\Admin\API\Reports\Import;
...
class Controller extends \Automattic\FinCommerce\Admin\API\Reports\Controller {
	...
	public function prepare_item_for_response( $item, $request ) {
		 ...
		 */
		return apply_filters( 'fincommerce_rest_prepare_reports_import', $response, $item, $request );
	}
	...
	public function get_import_collection_params() {
		$params                  = array();
		$params['days']          = array(
			'description'       => __( 'Number of days to import.', 'fincommerce' ),
			'type'              => 'integer',
		...
		$params['skip_existing'] = array(
			'description'       => __( 'Skip importing existing order data.', 'fincommerce' ),
			'type'              => 'boolean',
			'default'           => false,
	...
	public function get_import_public_schema() {
		$schema = array(
			...
			'properties' => array(
				'status'  => array(
					'description' => __( 'Regeneration status.', 'fincommerce' ),
					'type'        => 'string',
					'context'     => array( 'view', 'edit' ),
					'readonly'    => true,
				),
				'message' => array(
					'description' => __( 'Regenerate data message.', 'fincommerce' ),
					'type'        => 'string',
					'context'     => array( 'view', 'edit' ),
					'readonly'    => true,
				),
	...
	public function cancel_import( $request ) {
		...
		$result = array(
			'status'  => 'success',
			'message' => __( 'All pending and in-progress import actions have been cancelled.', 'fincommerce' ),
		);
