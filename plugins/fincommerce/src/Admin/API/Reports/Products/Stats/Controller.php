...
namespace Automattic\FinCommerce\Admin\API\Reports\Products\Stats;
...
class Controller extends GenericStatsController {
	...
	public function __construct() {
		add_filter( 'fincommerce_analytics_products_stats_select_query', array( $this, 'set_default_report_data' ) );
	}
	...
	public function prepare_item_for_response( $report, $request ) {
		 ...
		 */
		return apply_filters( 'fincommerce_rest_prepare_report_products_stats', $response, $report, $request );
	}
	...
	protected function get_item_properties_schema() {
		return array(
			'items_sold'   => array(
				'title'       => __( 'Products sold', 'fincommerce' ),
				'description' => __( 'Number of product items sold.', 'fincommerce' ),
				'type'        => 'integer',
