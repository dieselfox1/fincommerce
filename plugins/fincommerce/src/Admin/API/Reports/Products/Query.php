 ...
 *         );
 * $report = new \Automattic\FinCommerce\Admin\API\Reports\Products\Query( $args );
...
class Query extends ReportsQuery {
	...
	public function get_data() {
		...
		$args = apply_filters( 'fincommerce_analytics_products_query_args', $this->get_query_vars() );

		$data_store = \WC_Data_Store::load( 'report-products' );
		$results    = $data_store->get_data( $args );
		return apply_filters( 'fincommerce_analytics_products_select_query', $results, $args );
	}
}
