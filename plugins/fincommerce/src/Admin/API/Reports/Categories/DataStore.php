...
class DataStore extends ReportsDataStore implements DataStoreInterface {
	...
	protected function add_order_by_params( $query_args, $from_arg, $id_cell ) {
		...
		if ( false !== strpos( $order_by_clause, '_terms' ) ) {
			...
			if ( 'inner' === $from_arg ) {
				...
				// See: https://github.com/dieselfox1/fincommerce-admin/blob/1f261998e7287b77bc13c3d4ee2e84b717da7957/src/API/Reports/SqlQuery.php#L46-L50.
	...
	public function get_noncached_data( $query_args ) {
		...
		if ( null === $categories_data ) {
			return new \WP_Error( 'fincommerce_analytics_categories_result_failed', __( 'Sorry, fetching revenue data failed.', 'fincommerce' ), array( 'status' => 500 ) );
		}
