...
class Controller extends \WC_REST_Reports_Controller {
	...
	public function prepare_item_for_response( $report, $request ) {
		 ...
		 */
		return apply_filters( 'fincommerce_rest_prepare_report_stock_stats', $response, $report, $request );
	}
	...
	public function get_item_schema() {
		$totals = array(
			...
			'lowstock' => array(
				'description' => __( 'Number of low stock products.', 'fincommerce' ),
				'type'        => 'integer',
				'context'     => array( 'view', 'edit' ),
				'readonly'    => true,
			),
		...
		foreach ( $status_options as $status => $label ) {
			$totals[ $status ] = array(
				...
				'description' => sprintf( __( 'Number of %s products.', 'fincommerce' ), $label ),
				'type'        => 'integer',
				'context'     => array( 'view', 'edit' ),
				'readonly'    => true,
			);
