...
class DataStore extends ReportsDataStore implements DataStoreInterface {
	...
	protected function add_sql_query_params( $query_args ) {
		...
		$order_item_meta_table      = $wpdb->prefix . 'fincommerce_order_itemmeta';
	...
	protected function include_extended_info( &$products_data, $query_args ) {
		foreach ( $products_data as $key => $product_data ) {
			...
			if ( $query_args['extended_info'] ) {
				$extended_attributes = apply_filters( 'fincommerce_rest_reports_variations_extended_attributes', $this->extended_attributes, $product_data );
				...
				// See: https://github.com/dieselfox1/fincommerce-admin/issues/2719.
	...
	protected function should_exclude_simple_products( array $query_args ) {
		return apply_filters( 'experimental_fincommerce_analytics_variations_should_exclude_simple_products', true, $query_args );
	}
	...
	protected function fill_deleted_product_name( array &$products ) {
		...
		$query = "
			...
			from
				...
				left join {$wpdb->prefix}fincommerce_order_items as order_items
