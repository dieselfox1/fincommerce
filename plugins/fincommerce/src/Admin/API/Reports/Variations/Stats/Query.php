 ...
 *         );
 * $report = new \Automattic\FinCommerce\Admin\API\Reports\Variations\Stats\Query( $args );
...
use Automattic\FinCommerce\Admin\API\Reports\Query as ReportsQuery;
...
class Query extends ReportsQuery {
	...
	public function get_data() {
		...
		$args = apply_filters( 'fincommerce_analytics_variations_stats_query_args', $this->get_query_vars() );

		$data_store = \WC_Data_Store::load( 'report-variations-stats' );
		$results    = $data_store->get_data( $args );
		return apply_filters( 'fincommerce_analytics_variations_stats_select_query', $results, $args );
	}
