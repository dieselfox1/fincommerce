...
use Automattic\FinCommerce\Admin\API\Reports\Variations\DataStore as VariationsDataStore;
...
class DataStore extends VariationsDataStore implements DataStoreInterface {
	...
	protected function should_exclude_simple_products( array $query_args ) {
		return apply_filters( 'experimental_fincommerce_analytics_variations_stats_should_exclude_simple_products', true, $query_args );
	}
	...
	public function get_noncached_stats_data( $query_args, $params, &$data, $expected_interval_count ) {
		...
		if ( null === $totals ) {
			return new \WP_Error( 'fincommerce_analytics_variations_stats_result_failed', __( 'Sorry, fetching revenue data failed.', 'fincommerce' ) );
		}
