 ...
 *          'country'             => 'GB',
 *         );
 * $report = new \Automattic\FinCommerce\Admin\API\Reports\Customers\Stats\Query( $args );
...
class Query extends ReportsQuery {
	...
	public function get_data() {
		...
		$args = apply_filters( 'fincommerce_analytics_customers_stats_query_args', $this->get_query_vars() );

		$data_store = \WC_Data_Store::load( 'report-customers-stats' );
		$results    = $data_store->get_data( $args );
		return apply_filters( 'fincommerce_analytics_customers_stats_select_query', $results, $args );
	}
}
