...
class DataStore extends ReportsDataStore implements DataStoreInterface {
	...
	protected function add_sql_query_params( $query_args ) {
		...
		$permission_table = $wpdb->prefix . 'fincommerce_downloadable_product_permissions';
	...
	protected function get_filtered_ip_addresses( $query_args, $field ) {
		if ( isset( $query_args[ $field ] ) && is_array( $query_args[ $field ] ) && count( $query_args[ $field ] ) > 0 ) {
			 ...
			 */
			$ip_addresses = apply_filters( 'fincommerce_analytics_' . $field, $ip_addresses, $query_args, $field, $this->context );
