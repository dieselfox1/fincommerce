...
use Automattic\FinCommerce\Admin\API\Reports\Downloads\DataStore as DownloadsDataStore;
...
class DataStore extends DownloadsDataStore implements DataStoreInterface {
	...
	public function get_noncached_stats_data( $query_args, $params, &$data, $expected_interval_count ) {
		...
		if ( null === $totals ) {
			return new \WP_Error( 'fincommerce_analytics_downloads_stats_result_failed', __( 'Sorry, fetching downloads data failed.', 'fincommerce' ) );
		}
