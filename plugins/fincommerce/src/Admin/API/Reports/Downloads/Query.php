 ...
 * );
 * $report = new \Automattic\FinCommerce\Admin\API\Reports\Downloads\Query( $args );
...
class Query extends ReportsQuery {
	...
	public function get_data() {
		...
		$args = apply_filters( 'fincommerce_analytics_downloads_query_args', $this->get_query_vars() );

		$data_store = \WC_Data_Store::load( 'report-downloads' );
		$results    = $data_store->get_data( $args );
		return apply_filters( 'fincommerce_analytics_downloads_select_query', $results, $args );
	}
}
