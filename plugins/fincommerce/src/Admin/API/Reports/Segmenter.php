...
use Automattic\FinCommerce\Admin\API\Reports\Taxes\Stats\DataStore as TaxesStatsDataStore;
	...
	protected function set_all_segments() {
		...
		if ( 'product' === $this->query_args['segmentby'] ) {
			...
			foreach ( $segment_objects as $segment ) {
				...
				$separator    = apply_filters( 'fincommerce_product_variation_title_attributes_separator', ' - ', $segment );
