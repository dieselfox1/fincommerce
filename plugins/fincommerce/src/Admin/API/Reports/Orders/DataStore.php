...
class DataStore extends ReportsDataStore implements DataStoreInterface {
	 ...
	 * The transient name.
	 */
	const ORDERS_STATUSES_ALL_TRANSIENT = 'fincommerce_analytics_orders_statuses_all';
	...
	final public static function init() {
		add_action( 'fincommerce_analytics_update_order_stats', array( __CLASS__, 'maybe_update_order_statuses_transient' ) );
	}
	...
	protected function include_extended_info( &$orders_data, $query_args ) {
		...
		foreach ( $products as $product ) {
			...
			if ( $is_variation ) {
				 ...
				 * @since 4.0.0
				 */
				$separator = apply_filters( 'fincommerce_product_variation_title_attributes_separator', ' - ', $variation );
