...
use Automattic\FinCommerce\Admin\Marketing\MarketingChannelInterface;
use Automattic\FinCommerce\Admin\Marketing\MarketingChannels as MarketingChannelsService;
...
class MarketingChannels extends WC_REST_Controller {
	...
	public function get_item_schema() {
		$schema = [
			...
			'properties' => [
				'slug'                    => [
					'description' => __( 'Unique identifier string for the marketing channel extension, also known as the plugin slug.', 'fincommerce' ),
					'type'        => 'string',
					'context'     => [ 'view' ],
					'readonly'    => true,
				],
				'name'                    => [
					'description' => __( 'Name of the marketing channel.', 'fincommerce' ),
					'type'        => 'string',
					'context'     => [ 'view' ],
					'readonly'    => true,
				],
				'description'             => [
					'description' => __( 'Description of the marketing channel.', 'fincommerce' ),
					'type'        => 'string',
					'context'     => [ 'view' ],
					'readonly'    => true,
				],
				'icon'                    => [
					'description' => __( 'Path to the channel icon.', 'fincommerce' ),
					'type'        => 'string',
					'context'     => [ 'view' ],
					'readonly'    => true,
				],
				'is_setup_completed'      => [
					'type'        => 'boolean',
					'description' => __( 'Whether or not the marketing channel is set up.', 'fincommerce' ),
					'context'     => [ 'view' ],
					'readonly'    => true,
				],
				'settings_url'            => [
					'description' => __( 'URL to the settings page, or the link to complete the setup/onboarding if the channel has not been set up yet.', 'fincommerce' ),
					'type'        => 'string',
					'context'     => [ 'view' ],
					'readonly'    => true,
				],
				'product_listings_status' => [
					'description' => __( 'Status of the marketing channel\'s product listings.', 'fincommerce' ),
					'type'        => 'string',
					'context'     => [ 'view' ],
					'readonly'    => true,
				],
				'errors_count'            => [
					'description' => __( 'Number of channel issues/errors (e.g. account-related errors, product synchronization issues, etc.).', 'fincommerce' ),
					'type'        => 'string',
					'context'     => [ 'view' ],
					'readonly'    => true,
				],
