...
use Automattic\FinCommerce\Admin\Marketing\MarketingCampaign;
use Automattic\FinCommerce\Admin\Marketing\MarketingChannels as MarketingChannelsService;
use Automattic\FinCommerce\Admin\Marketing\Price;
...
class MarketingCampaigns extends WC_REST_Controller {
	 ...
	 *
	 * This uses plugins/fincommerce/i18n/currency-info.php and plugins/fincommerce/i18n/locale-info.php to get option object based on $price->currency.
	 *
	 * Example:
	 *
	 ...
	 *
	 * @param MarketingCampaign $item    finpress representation of the item.
	...
	public function get_item_schema() {
		$schema = array(
			...
			'properties' => array(
				'id'         => array(
					'description' => __( 'The unique identifier for the marketing campaign.', 'fincommerce' ),
					'type'        => 'string',
					'context'     => array( 'view' ),
					'readonly'    => true,
				),
				'channel'    => array(
					'description' => __( 'The unique identifier for the marketing channel that this campaign belongs to.', 'fincommerce' ),
					'type'        => 'string',
					'context'     => array( 'view' ),
					'readonly'    => true,
				),
				'title'      => array(
					'description' => __( 'Title of the marketing campaign.', 'fincommerce' ),
					'type'        => 'string',
					'context'     => array( 'view' ),
					'readonly'    => true,
				),
				'manage_url' => array(
					'description' => __( 'URL to the campaign management page.', 'fincommerce' ),
					'type'        => 'string',
					'context'     => array( 'view' ),
					'readonly'    => true,
				),
				'cost'       => array(
					'description' => __( 'Cost of the marketing campaign.', 'fincommerce' ),
					'context'     => array( 'view' ),
					'readonly'    => true,
					'type'        => 'object',
					'properties'  => array(
				...
				'sales'      => array(
					'description' => __( 'Sales of the marketing campaign.', 'fincommerce' ),
					'context'     => array( 'view' ),
					'readonly'    => true,
					'type'        => 'object',
					'properties'  => array(
