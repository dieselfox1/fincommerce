...
use Automattic\FinCommerce\Admin\Features\MarketingRecommendations\Init as MarketingRecommendationsInit;
...
class MarketingRecommendations extends WC_REST_Controller {
	...
	public function get_items_permissions_check( $request ) {
		if ( ! current_user_can( 'install_plugins' ) ) {
			return new WP_Error( 'fincommerce_rest_cannot_view', __( 'Sorry, you cannot view marketing channels.', 'fincommerce' ), array( 'status' => rest_authorization_required_code() ) );
		}
	...
	public function get_items( $request ) {
		...
		if ( 'channels' === $category ) {
			...
			return new WP_Error( 'fincommerce_rest_invalid_category', __( 'The specified category for recommendations is invalid. Allowed values: "channels", "extensions".', 'fincommerce' ), array( 'status' => 400 ) );
		}
	 ...
	 *
	 * @param array           $item    finpress representation of the item.
