...
use Automattic\FinCommerce\Blocks\AIContent\UpdateProducts;
...
class OnboardingProducts extends \WC_REST_Data_Controller {
	...
	public function update_item_permissions_check( $request ) {
		if ( ! current_user_can( 'manage_options' ) ) {
			return new \WP_Error( 'fincommerce_rest_cannot_update', __( 'Sorry, you cannot create dummy products.', 'fincommerce' ), array( 'status' => rest_authorization_required_code() ) );
		}
		return true;
	}
