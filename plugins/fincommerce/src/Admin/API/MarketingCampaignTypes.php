...
use Automattic\FinCommerce\Admin\Marketing\MarketingCampaignType;
...
class MarketingCampaignTypes extends WC_REST_Controller {
	...
	public function get_item_schema() {
		$schema = [
			...
			'properties' => [
				'id'          => [
					'description' => __( 'The unique identifier for the marketing campaign type.', 'fincommerce' ),
					'type'        => 'string',
					'context'     => [ 'view' ],
					'readonly'    => true,
				],
				'name'        => [
					'description' => __( 'Name of the marketing campaign type.', 'fincommerce' ),
					'type'        => 'string',
					'context'     => [ 'view' ],
					'readonly'    => true,
				],
				'description' => [
					'description' => __( 'Description of the marketing campaign type.', 'fincommerce' ),
					'type'        => 'string',
					'context'     => [ 'view' ],
					'readonly'    => true,
				],
				'channel'     => [
					'description' => __( 'The marketing channel that this campaign type belongs to.', 'fincommerce' ),
					'type'        => 'object',
					'context'     => [ 'view' ],
					'readonly'    => true,
					'properties'  => [
						'slug' => [
							'description' => __( 'The unique identifier of the marketing channel that this campaign type belongs to.', 'fincommerce' ),
							'type'        => 'string',
							'context'     => [ 'view' ],
							'readonly'    => true,
						],
						'name' => [
							'description' => __( 'The name of the marketing channel that this campaign type belongs to.', 'fincommerce' ),
							'type'        => 'string',
							'context'     => [ 'view' ],
							'readonly'    => true,
						],
				...
				'create_url'  => [
					'description' => __( 'URL to the create campaign page for this campaign type.', 'fincommerce' ),
					'type'        => 'string',
					'context'     => [ 'view' ],
					'readonly'    => true,
				],
				'icon_url'    => [
					'description' => __( 'URL to an image/icon for the campaign type.', 'fincommerce' ),
					'type'        => 'string',
					'context'     => [ 'view' ],
					'readonly'    => true,
				],
