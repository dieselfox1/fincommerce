...
class Orders extends \WC_REST_Orders_Controller {
	...
	public function get_collection_params() {
		...
		$params['number'] = array(
			'description'       => __( 'Limit result set to orders matching part of an order number.', 'fincommerce' ),
			'type'              => 'string',
	...
	protected function get_products_by_order_id( $order_id ) {
		global $wpdb;
		$order_items_table    = $wpdb->prefix . 'fincommerce_order_items';
	...
	protected function get_formatted_item_data( $object ) {
		...
		$using_order_class_override = is_a( $object, '\Automattic\FinCommerce\Admin\Overrides\Order' );
