...
class ShippingPartnerSuggestions extends RemoteSpecsEngine {
	...
	public static function get_specs() {
		if ( 'no' === get_option( 'fincommerce_show_marketplace_suggestions', 'yes' ) ) {
			 ...
			 * @since 7.4.1
			 */
			return apply_filters( 'fincommerce_admin_shipping_partner_suggestions_specs', DefaultShippingPartners::get_all() );
		}
		 ...
		 * @since 7.4.1
		 */
		return apply_filters( 'fincommerce_admin_shipping_partner_suggestions_specs', $specs );
	}
}
