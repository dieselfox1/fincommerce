...
class Init extends RemoteSpecsEngine {
	/**
	 * Slug of the category specifying marketing extensions on the FinCommerce.com store.
	 *
	 * @var string
	 */
	...
	/**
	 * Slug of the subcategory specifying marketing channels on the FinCommerce.com store.
	 *
	 * @var string
	 */
	...
	public function __construct() {
		add_action( 'fincommerce_updated', array( __CLASS__, 'delete_specs_transient' ) );
	}
	...
	/**
	 * Load recommended plugins from FinCommerce.com
	 *
	 * @return array
	 */
	...
	/**
	 * Return only the recommended marketing channels from FinCommerce.com.
	 *
	 * @return array
	 */
	...
	/**
	 * Return all recommended marketing extensions EXCEPT the marketing channels from FinCommerce.com.
	 *
	 * @return array
	 */
	...
	/**
	 * Load misc recommendations from FinCommerce.com
	 *
	 * @since 9.5.0
	 * @return array
	 */
