<?php
/**
 * FinCommerce Product Data Views
 */

declare( strict_types = 1 );

namespace Automattic\FinCommerce\Admin\Features\ProductDataViews;
...
class Init {
	...
	public function __construct() {
		add_action( 'admin_menu', array( $this, 'fincommerce_add_new_products_dashboard' ) );
	 ...
	 */
	public function fincommerce_add_new_products_dashboard() {
		...
		add_submenu_page(
			...
			esc_html__( 'All Products ( new )', 'fincommerce' ),
			'manage_fincommerce',
			'fincommerce-products-dashboard',
			array( $this, 'fincommerce_products_dashboard' ),
			1
		);
	}
	 ...
	 */
	public function fincommerce_products_dashboard() {
		...
		wp_add_inline_script( 'wp-edit-site', 'window.wc.productEditor.initializeProductsDashboard( "fincommerce-products-dashboard" );', 'after' );
		wp_enqueue_script( 'wp-edit-site' );

		echo '<div id="fincommerce-products-dashboard"></div>';
	}
}
