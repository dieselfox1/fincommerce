 ...
 *
 * This class exports FinCommerce settings on the Integrations page.
 *
...
class ExportWCSettingsIntegrations extends ExportWCSettings {
	...
	public function get_label() {
		return __( 'Integrations', 'fincommerce' );
	}
	...
	public function get_description() {
		return __( 'Includes all settings in FinCommerce | Settings | Integrations.', 'fincommerce' );
	}
