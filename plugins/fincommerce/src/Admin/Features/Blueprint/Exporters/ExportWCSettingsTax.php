 ...
 *
 * This class exports FinCommerce settings on the Tax page.
 *
...
class ExportWCSettingsTax extends ExportWCSettings {
	...
	public function export(): array {
		...
		return array(
			...
			...$this->generateTaxRateSteps( 'fincommerce_tax_rates' ),
			...$this->generateTaxRateSteps( 'fincommerce_tax_rate_locations' ),
		);
	}
	...
	public function get_description() {
		return __( 'Includes all settings in FinCommerce | Settings | Tax.', 'fincommerce' );
	}
