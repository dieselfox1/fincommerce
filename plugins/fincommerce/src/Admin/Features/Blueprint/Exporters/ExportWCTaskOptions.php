 ...
 *
 * This class exports FinCommerce task options.
 *
...
class ExportWCTaskOptions implements StepExporter, HasAlias {
	...
	/**
	 * Export FinCommerce task options.
	 *
	...
	public function export() {
		return new SetSiteOptions(
			array(
				'fincommerce_admin_customize_store_completed' => $this->wp_get_option( 'fincommerce_admin_customize_store_completed', 'no' ),
				'fincommerce_task_list_tracked_completed_actions' => $this->wp_get_option( 'fincommerce_task_list_tracked_completed_actions', array() ),
			)
		);
	}
	...
	public function get_label() {
		return __( 'Task Configurations', 'fincommerce' );
	}
	...
	public function get_description() {
		return __( 'Includes the task configurations for FinCommerce.', 'fincommerce' );
	}
