...
class GetMobileApp extends Task {
	...
	public function get_title() {
		return __( 'Get the free FinCommerce mobile app', 'fincommerce' );
	}
	...
	public function is_complete() {
		return get_option( 'fincommerce_admin_dismissed_mobile_app_modal' ) === 'yes';
	}
	...
	public function can_view() {
		$jetpack_can_be_installed                        = current_user_can( 'manage_fincommerce' ) && current_user_can( 'install_plugins' ) && ! self::is_jetpack_connected();
