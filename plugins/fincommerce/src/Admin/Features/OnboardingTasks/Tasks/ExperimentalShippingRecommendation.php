...
class ExperimentalShippingRecommendation extends Task {
	...
	public function get_title() {
		return __( 'Get your products shipped', 'fincommerce' );
	}
	...
	public static function has_plugins_active() {
		return PluginsHelper::is_plugin_active( 'fincommerce-shipping' );
	}
	...
	public static function has_jetpack_connected() {
		$jetpack_connection_manager = new Manager( 'fincommerce' );
