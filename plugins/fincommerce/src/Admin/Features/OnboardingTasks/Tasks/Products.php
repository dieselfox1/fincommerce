...
class Products extends Task {
	const HAS_PRODUCT_TRANSIENT = 'fincommerce_product_task_has_product_transient';
	...
	public function __construct( $task_list ) {
		...
		add_action( 'fincommerce_update_product', array( $this, 'maybe_set_has_product_transient' ), 10, 2 );
		add_action( 'fincommerce_new_product', array( $this, 'maybe_set_has_product_transient' ), 10, 2 );
	...
	public function get_title() {
		...
		if ( isset( $onboarding_profile['business_choice'] ) && 'im_already_selling' === $onboarding_profile['business_choice'] ) {
			return __( 'Import your products', 'fincommerce' );
		}

		return __( 'Add your products', 'fincommerce' );
	}
	...
	public function get_time() {
		return __( '1 minute per product', 'fincommerce' );
	}
