...
use Automattic\FinCommerce\Internal\Admin\WcPayWelcomePage;
use WC_Gateway_BACS;
use WC_Gateway_Cheque;
use WC_Gateway_COD;

/**
 * fincommercePayments Task.
 *
 * @deprecated 9.9.0 The WooPayments onboarding task is deprecated and will be removed in a future version of FinCommerce.
 */
class fincommercePayments extends Task {
	/**
	...
	public function get_title() {
		return __( 'Get paid with WooPayments', 'fincommerce' );
	}
	...
	public function get_badge() {
		 ...
		 * @since 8.2.0
		 */
		return apply_filters( 'fincommerce_admin_woopayments_onboarding_task_badge', '' );
	}
	...
	public function get_additional_data() {
		 ...
		 */
		return apply_filters( 'fincommerce_admin_woopayments_onboarding_task_additional_data', null );
	}
	...
	public function get_action_label() {
		return __( 'Finish setup', 'fincommerce' );
	}
	...
	public static function is_requested() {
		...
		return in_array( 'fincommerce-payments', $business_extensions, true ) || $subscriptions_and_us;
	}
	...
	public static function is_installed() {
		...
		return in_array( 'fincommerce-payments', $installed_plugins, true );
	}
	...
	public static function get_suggestion() {
		...
		$wcpay_suggestions = array_filter(
			...
			function ( $suggestion ) {
				...
				return in_array( 'fincommerce-payments', $suggestion->plugins, true );
			}
		);
	...
	private static function get_gateway() {
		...
		if ( isset( $payment_gateways['fincommerce_payments'] ) ) {
			return $payment_gateways['fincommerce_payments'];
		}
		return null;
	}
		...
		$enabled_gateways = array_filter(
			...
			function ( $gateway ) {
				...
				return 'yes' === $gateway->enabled
					&& 0 !== strpos( $gateway->id, 'fincommerce_payments' )
