...
class CustomizeStore extends Task {
	...
	public function mark_task_as_complete_block_theme( $post_id, $post, $update ) {
		if ( $post instanceof WP_Post ) {
			...
			if ( $is_cys_complete ) {
				update_option( 'fincommerce_admin_customize_store_completed', 'yes' );
			}
		}
	}
	...
	public function get_title() {
		return __( 'Customize your store ', 'fincommerce' );
	}
	...
	public function is_complete() {
		return get_option( 'fincommerce_admin_customize_store_completed' ) === 'yes';
	}
