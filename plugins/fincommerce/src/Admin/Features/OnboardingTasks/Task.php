...
abstract class Task {
	 ...
	 * @var string
	 */
	const DISMISSED_OPTION = 'fincommerce_task_list_dismissed_tasks';
	 ...
	 * @deprecated 7.2.0
	 */
	const SNOOZED_OPTION = 'fincommerce_task_list_remind_me_later_tasks';
	 ...
	 * @var string
	 */
	const ACTIONED_OPTION = 'fincommerce_task_list_tracked_completed_actions';
	 ...
	 * @var string
	 */
	const COMPLETED_OPTION = 'fincommerce_task_list_tracked_completed_tasks';
	...
	public function get_action_label() {
		return __( "Let's go", 'fincommerce' );
	}
	...
	public function in_progress_label() {
		return esc_html__( 'In progress', 'fincommerce' );
	}
