 ...
 *
 * @deprecated since 6.3.0, use FinCommerce\Internal\Admin\Onboarding.
 */
class Onboarding extends DeprecatedClassFacade {
	 ...
	 * @var string
	 */
	protected static $facade_over_classname = 'Automattic\FinCommerce\Admin\Features\Onboarding';
	...
	public static function get_allowed_industries() {
		wc_deprecated_function( 'get_allowed_industries', '6.3', '\Automattic\FinCommerce\Internal\Admin\OnboardingIndustries::get_allowed_industries()' );
		return \Automattic\FinCommerce\Internal\Admin\Onboarding\OnboardingIndustries::get_allowed_industries();
	}
	...
	public static function get_allowed_product_types() {
		wc_deprecated_function( 'get_allowed_product_types', '6.3', '\Automattic\FinCommerce\Internal\Admin\OnboardingProducts::get_allowed_product_types()' );
		return \Automattic\FinCommerce\Internal\Admin\Onboarding\OnboardingProducts::get_allowed_product_types();
	}
