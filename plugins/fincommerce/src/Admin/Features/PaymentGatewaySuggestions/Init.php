...
class Init extends RemoteSpecsEngine {
	 ...
	 */
	const RECOMMENDED_PAYMENT_PLUGINS_DISMISS_OPTION = 'fincommerce_setting_payments_recommendations_hidden';
	...
	public function __construct() {
		...
		add_action( 'update_option_fincommerce_default_country', array( $this, 'delete_specs_transient' ) );
	}
	...
	public static function get_cached_or_default_suggestions() {
		$specs = 'no' === get_option( 'fincommerce_show_marketplace_suggestions', 'yes' )
		 ...
		 */
		$specs   = apply_filters( 'fincommerce_admin_payment_gateway_suggestion_specs', $specs );
		$results = EvaluateSuggestion::evaluate_specs( $specs );
	...
	public static function get_specs() {
		if ( 'no' === get_option( 'fincommerce_show_marketplace_suggestions', 'yes' ) ) {
			return apply_filters( 'fincommerce_admin_payment_gateway_suggestion_specs', DefaultPaymentGateways::get_all() );
		}
		...
		return apply_filters( 'fincommerce_admin_payment_gateway_suggestion_specs', $specs );
	}
	...
	public static function should_display() {
		...
		return apply_filters( 'fincommerce_allow_payment_recommendations', true );
	}
