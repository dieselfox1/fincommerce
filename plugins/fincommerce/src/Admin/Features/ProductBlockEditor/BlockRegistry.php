<?php
/**
 * FinCommerce Product Editor Block Registration
 */
...
class BlockRegistry {
	...
	const GENERIC_BLOCKS = array(
		'fincommerce/conditional',
		'fincommerce/product-checkbox-field',
		'fincommerce/product-collapsible',
		'fincommerce/product-radio-field',
		'fincommerce/product-pricing-field',
		'fincommerce/product-section',
		'fincommerce/product-section-description',
		'fincommerce/product-subsection',
		'fincommerce/product-subsection-description',
		'fincommerce/product-details-section-description',
		'fincommerce/product-tab',
		'fincommerce/product-toggle-field',
		'fincommerce/product-taxonomy-field',
		'fincommerce/product-text-field',
		'fincommerce/product-text-area-field',
		'fincommerce/product-number-field',
		'fincommerce/product-linked-list-field',
		'fincommerce/product-select-field',
	...
	const PRODUCT_FIELDS_BLOCKS = array(
		'fincommerce/product-catalog-visibility-field',
		'fincommerce/product-custom-fields',
		'fincommerce/product-custom-fields-toggle-field',
		'fincommerce/product-description-field',
		'fincommerce/product-downloads-field',
		'fincommerce/product-images-field',
		'fincommerce/product-inventory-email-field',
		'fincommerce/product-sku-field',
		'fincommerce/product-name-field',
		'fincommerce/product-regular-price-field',
		'fincommerce/product-sale-price-field',
		'fincommerce/product-schedule-sale-fields',
		'fincommerce/product-shipping-class-field',
		'fincommerce/product-shipping-dimensions-fields',
		'fincommerce/product-summary-field',
		'fincommerce/product-tag-field',
		'fincommerce/product-inventory-quantity-field',
		'fincommerce/product-variation-items-field',
		'fincommerce/product-password-field',
		'fincommerce/product-list-field',
		'fincommerce/product-has-variations-notice',
		'fincommerce/product-single-variation-notice',
	);
	...
	/**
	 * Get the block name without the "fincommerce/" prefix.
	 *
	...
	private function remove_block_prefix( $block_name ) {
		if ( 0 === strpos( $block_name, 'fincommerce/' ) ) {
			return substr_replace( $block_name, '', 0, strlen( 'fincommerce/' ) );
		}
	...
	private function augment_attributes( $attributes ) {
		...
		// registerWooBlockType function in @fincommerce/block-templates.
	...
	private function augment_uses_context( $uses_context ) {
		// Note: If you modify this function, also update the client-side
		// registerProductEditorBlockType function in @fincommerce/product-editor.
		return array_merge(
