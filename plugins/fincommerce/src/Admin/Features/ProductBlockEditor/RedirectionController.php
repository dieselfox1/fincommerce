<?php
/**
 * FinCommerce Product Editor Redirection Controller
 */
...
class RedirectionController {
	...
	/**
	 * Get the parsed FinCommerce Admin path.
	 */
	protected function get_parsed_route(): array {
		if ( ! \Automattic\FinCommerce\Admin\PageController::is_admin_page() || ! isset( $_GET['path'] ) ) {
			return array(
				'page'       => null,
				'product_id' => null,
			);
