<?php
/**
 * FinCommerce Product Forms Controller
 */
...
class ProductFormsController {
	 ...
	 */
	public function init() { // phpcs:ignore FinCommerce.Functions.InternalInjectionMethod.MissingFinal, FinCommerce.Functions.InternalInjectionMethod.MissingInternalTag -- Not an injection.
		add_action( 'upgrader_process_complete', array( $this, 'migrate_templates_when_plugin_updated' ), 10, 2 );
	}

	/**
	 * Migrate form templates after FinCommerce plugin update.
	 *
	...
	public function migrate_product_form_posts( $action ) {
		...
		$templates = apply_filters(
			'fincommerce_product_form_templates',
