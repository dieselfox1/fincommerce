...
use Automattic\FinCommerce\Admin\Schedulers\SchedulerTraits;
...
class ReportExporter {
	 ...
	 */
	const EXPORT_STATUS_OPTION = 'fincommerce_admin_report_export_status';

	/**
	 * Export file download action.
	 */
	const DOWNLOAD_EXPORT_ACTION = 'fincommerce_admin_download_report_csv';
	...
	public static function get_scheduler_actions() {
		return array(
			'export_report'              => 'fincommerce_admin_report_export',
			'email_report_download_link' => 'fincommerce_admin_email_report_download_link',
		);
	}
	...
	public static function download_export_file() {
		...
		if (
			...
			current_user_can( 'view_fincommerce_reports' )
		) {
