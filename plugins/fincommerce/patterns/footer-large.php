...
/**
 * Title: Large Footer
 * Slug: fincommerce-blocks/footer-large
	...
	<div class="wp-block-columns alignwide" style="padding-right:0px;padding-left:0px">
		...
		<div class="wp-block-column" style="padding-right:50px;flex-basis:60%">
			...
			<div class="wp-block-group"><!-- wp:site-logo /-->
				...
				<h5 class="wp-block-heading" style="margin-top:40px;text-transform:none"><?php esc_html_e( 'Join the community', 'fincommerce' ); ?></h5>
				<!-- /wp:heading -->

				<!-- wp:paragraph {"style":{"spacing":{"margin":{"bottom":"40px"}}}} -->
				<p style="margin-bottom:40px"><?php esc_html_e( 'Learn about new products and discounts', 'fincommerce' ); ?></p>
				<!-- /wp:paragraph -->
