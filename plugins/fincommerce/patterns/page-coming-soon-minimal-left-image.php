 ...
 * Slug: fincommerce/page-coming-soon-minimal-left-image
...
$store_description = ! empty( $site_tagline )
	...
	: sprintf(
		...
		__( '%s transforms your home with our curated collection of home decor, bringing inspiration and style to every corner.', 'fincommerce' ),
		get_bloginfo( 'name' )
	);

?>
<!-- wp:fincommerce/coming-soon {"comingSoonPatternId":"page-coming-soon-minimal-left-image","className":"fincommerce-coming-soon-default fincommerce-coming-soon-minimal-left-image","style":{"color":{"background":"#f9f9f9","text":"#000000"},"elements":{"link":{"color":{"text":"#000000"}}}}} -->
<div class="wp-block-fincommerce-coming-soon fincommerce-coming-soon-default fincommerce-coming-soon-minimal-left-image has-text-color has-background has-link-color" style="color:#000000;background-color:#f9f9f9"><!-- wp:cover {"customOverlayColor":"transparent","isUserOverlayColor":true,"minHeight":100,"minHeightUnit":"vh","className":"coming-soon-is-vertically-aligned-center coming-soon-cover","style":{"spacing":{"padding":{"top":"0px","bottom":"0px","left":"24px","right":"24px"}},"color":{"text":"inherit"},"elements":{"link":{"color":{"text":"inherit"}}}},"layout":{"type":"default"}} -->
...
<div class="wp-block-group alignfull" style="min-height:100vh"><!-- wp:group {"align":"wide","className":"fincommerce-coming-soon-header has-background","style":{"spacing":{"padding":{"top":"26px","bottom":"14px"}}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group alignwide fincommerce-coming-soon-header has-background" style="padding-top:26px;padding-bottom:14px"><!-- wp:group {"align":"wide","layout":{"type":"flex","justifyContent":"space-between","flexWrap":"wrap"}} -->
...
<!-- wp:group {"align":"full","className":"fincommerce-coming-soon-minimal-left-image__content","style":{"spacing":{"padding":{"top":"0","bottom":"0"},"margin":{"top":"120px","bottom":"120px"}}},"layout":{"type":"default"}} -->
<div class="wp-block-group alignfull fincommerce-coming-soon-minimal-left-image__content" style="margin-top:120px;margin-bottom:120px;padding-top:0;padding-bottom:0"><!-- wp:group {"layout":{"type":"constrained"}} -->
...
<div class="wp-block-columns alignfull" style="margin-top:0px;margin-bottom:0px;padding-top:0;padding-right:0;padding-bottom:0;padding-left:0"><!-- wp:column {"verticalAlignment":"bottom","width":"481px","className":"fincommerce-coming-soon-minimal-left-image__content-image","layout":{"type":"default"}} -->
<div class="wp-block-column is-vertically-aligned-bottom fincommerce-coming-soon-minimal-left-image__content-image" style="flex-basis:481px"><!-- wp:image {"aspectRatio":"481/576","scale":"cover","style":{"border":{"radius":"16px"}}} -->
...
<!-- wp:column {"verticalAlignment":"stretch","width":"453px","className":"fincommerce-coming-soon-minimal-left-image__content-text","style":{"spacing":{"blockGap":"0","padding":{"right":"0","left":"0","bottom":"0","top":"53px"}}},"layout":{"type":"default"}} -->
<div class="wp-block-column is-vertically-aligned-stretch fincommerce-coming-soon-minimal-left-image__content-text" style="padding-top:53px;padding-right:0;padding-bottom:0;padding-left:0;flex-basis:453px"><!-- wp:group {"style":{"dimensions":{"minHeight":"100%"},"spacing":{"blockGap":"0"}},"layout":{"type":"flex","orientation":"vertical","justifyContent":"stretch","flexWrap":"nowrap","verticalAlignment":"space-between"}} -->
...
<h1 class="wp-block-heading is-style-default has-<?php echo esc_html( $heading_font_family ); ?>-font-family" style="margin-bottom:var(--wp--preset--spacing--30);font-size:38px;line-height:1.19"><?php echo esc_html__( 'Something big is brewing! Our store is in the works – Launching shortly!', 'fincommerce' ); ?></h1>
<!-- /wp:heading -->
