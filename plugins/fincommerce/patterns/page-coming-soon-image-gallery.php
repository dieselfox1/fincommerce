 ...
 * Slug: fincommerce/page-coming-soon-image-gallery
...
<!-- wp:fincommerce/coming-soon {"comingSoonPatternId":"page-coming-soon-image-gallery","className":"fincommerce-coming-soon-image-gallery"} -->
<div class="wp-block-fincommerce-coming-soon fincommerce-coming-soon-image-gallery">
...
<div class="wp-block-group alignwide" style="padding-right:90px;padding-left:90px">
	<!-- wp:group {"align":"wide","className":"fincommerce-coming-soon-header has-background","style":{"spacing":{"padding":{"bottom":"14px","left":"0px","right":"0px","top":"26px"}}},"layout":{"type":"constrained"}} -->
	<div class="wp-block-group alignwide fincommerce-coming-soon-header has-background" style="padding-top:26px;padding-right:0px;padding-bottom:14px;padding-left:0px"><!-- wp:group {"align":"wide","layout":{"type":"flex","justifyContent":"space-between","flexWrap":"wrap"}} -->
		...
		<div class="wp-block-group alignwide">
			...
			<div class="wp-block-group alignwide">
				<!-- wp:heading {"level":1,"style":{"typography":{"fontSize":"48px","lineHeight":"1.3","fontStyle":"normal","fontWeight":"400"},"spacing":{"padding":{"top":"100px","bottom":"100px"}}},"fontFamily":"<?php echo esc_html( $heading_font_family ); ?>"} -->
					<h1 class="wp-block-heading has-<?php echo esc_html( $heading_font_family ); ?>-font-family" style="padding-top:100px;padding-bottom:100px;font-size:48px;font-style:normal;font-weight:400;line-height:1.3"><em><?php echo esc_html__( 'Great things are coming soon', 'fincommerce' ); ?></em></h1>
				<!-- /wp:heading -->
			</div>
			<!-- /wp:group -->
		</div>
