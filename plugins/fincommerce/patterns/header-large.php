...
/**
 * Title: Large Header
 * Slug: fincommerce-blocks/header-large
...
<div class="wc-blocks-pattern-header-large wc-blocks-header-pattern wp-block-group alignfull" style="padding-right: 40px; padding-left: 40px; padding-top: 24px; padding-bottom: 24px">
	...
	<div class="wp-block-group alignfull">
		...
		<div class="wp-block-columns alignfull are-vertically-aligned-center is-not-stacked-on-mobile">
			...
			<div class="wp-block-column is-vertically-aligned-center">
				...
				<div class="wp-block-group">
					<!-- wp:fincommerce/customer-account {"displayStyle":"icon_only","iconStyle":"line","iconClass":"wc-block-customer-account__account-icon"} /-->

					<!-- wp:fincommerce/mini-cart {"hasHiddenPrice":true} /-->
				</div>
				<!-- /wp:group -->
			</div>
			<!-- /wp:column -->
	...
	<div class="wp-block-group alignfull">
		...
		<div class="wp-block-group" style="padding-right:0;padding-left:0">
			<!-- wp:search {"label":"","showLabel":false,"placeholder":"<?php esc_html_e( 'Search', 'fincommerce' ); ?>","buttonText":"<?php esc_html_e( 'Search', 'fincommerce' ); ?>","buttonUseIcon":true,"query":{"post_type":"product"},"style":{"border":{"radius":"0px"}}} /-->
		</div>
		<!-- /wp:group -->
	</div>
	<!-- /wp:group -->
