...
/**
 * Title: Banner
 * Slug: fincommerce-blocks/banner
 * Categories: FinCommerce, featured-selling
 */


$banner_title       = __( 'Up to 60% off', 'fincommerce' );
$banner_button      = __( 'Shop vinyl records', 'fincommerce' );
$first_description  = __( 'Holiday Sale', 'fincommerce' );
$second_description = __( 'Get your favorite vinyl at record-breaking prices.', 'fincommerce' );
?>
	...
	<div class="wp-block-columns alignwide">
		...
		<div class="wp-block-column is-vertically-aligned-center">
			...
			<figure class="wp-block-image size-full">
				<img src="<?php echo esc_url( plugins_url( 'assets/images/pattern-placeholders/music-needle-turntable-black-and-white-white-photography.jpg', WC_PLUGIN_FILE ) ); ?>" alt="<?php esc_attr_e( 'Placeholder image used to represent products being showcased in a banner.', 'fincommerce' ); ?>" class="wp-image-1" />
			</figure>
			<!-- /wp:image -->
		</div>
		<!-- /wp:column -->
