 ...
 * Slug: fincommerce-blocks/content-right-with-image-left
 * Categories: FinCommerce, About
 */

declare(strict_types=1);


$header  = __( 'Committed to a greener lifestyle', 'fincommerce' );
$content = __( "Our passion is crafting mindful moments with locally sourced, organic, and sustainable products. We're more than a store; we're your path to a community-driven, eco-friendly lifestyle that embraces premium quality.", 'fincommerce' );
$button  = __( 'Meet us', 'fincommerce' );
