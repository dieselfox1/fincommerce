 ...
 * Slug: fincommerce-blocks/featured-category-cover-image
...
$category_title = __( 'Sit back and relax', 'fincommerce' );
$description    = __( 'With a wide range of designer chairs to elevate your living space.', 'fincommerce' );
$button         = __( 'Shop chairs', 'fincommerce' );
?>
