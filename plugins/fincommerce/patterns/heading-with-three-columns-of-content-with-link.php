 ...
 * Slug: fincommerce-blocks/heading-with-three-columns-of-content-with-link
 * Categories: FinCommerce, Services
 */
declare(strict_types=1);

$header        = __( 'Our services', 'fincommerce' );
$product_title = __( 'Create anything', 'fincommerce' );
$description   = __( 'Navigating life\'s intricate fabric, choices unfold paths to the extraordinary, demanding creativity, curiosity, and courage for a truly fulfilling journey.', 'fincommerce' );
$button_link   = __( 'Get started', 'fincommerce' );
?>
