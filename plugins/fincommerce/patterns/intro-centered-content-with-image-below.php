 ...
 * Slug: fincommerce-blocks/centered-content-with-image-below
 * Categories: FinCommerce, Intro
 */

declare(strict_types=1);

$header  = __( 'Find your shade', 'fincommerce' );
$content = __( 'Explore our exclusive collection of sunglasses, crafted to elevate your look and safeguard your eyes. Find your perfect pair and see the world through a new lens.', 'fincommerce' );
$button  = __( 'Shop now', 'fincommerce' );
