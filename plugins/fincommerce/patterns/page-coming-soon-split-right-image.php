 ...
 * Slug: fincommerce/page-coming-soon-split-right-image
...
?>
<!-- wp:fincommerce/coming-soon {"comingSoonPatternId":"page-coming-soon-split-right-image","className":"fincommerce-coming-soon-split-right-image","style":{"color":{"background":"#f9f9f9","text":"#000000"},"elements":{"link":{"color":{"text":"#000000"}}}}} -->
<div class="wp-block-fincommerce-coming-soon fincommerce-coming-soon-split-right-image has-text-color has-background has-link-color" style="color:#000000;background-color:#f9f9f9">
	...
	<div class="wp-block-group" style="min-height:100vh;padding-top:0px;padding-bottom:0px"><!-- wp:group {"style":{"dimensions":{"minHeight":"117px"}},"layout":{"type":"flex","flexWrap":"nowrap","justifyContent":"center"}} -->
		...
		<!-- wp:columns {"className":"fincommerce-split-right-image-content","style":{"spacing":{"blockGap":{"top":"0px","left":"0px"},"margin":{"top":"0px","bottom":"0px"}},"layout":{"selfStretch":"fill","flexSize":null}}} -->
		<div class="wp-block-columns fincommerce-split-right-image-content" style="margin-top:0px;margin-bottom:0px"><!-- wp:column {"verticalAlignment":"center","layout":{"type":"default"}} -->
			<div class="wp-block-column is-vertically-aligned-center"><!-- wp:group {"layout":{"type":"constrained","contentSize":"259px"}} -->
				<div class="wp-block-group"><!-- wp:heading {"textAlign":"center","level":1,"style":{"typography":{"fontSize":"14px","letterSpacing":"2.1px","fontStyle":"normal","fontWeight":"700","textTransform":"uppercase"}},"fontFamily":"<?php echo esc_attr( $body_font_family ); ?>"} -->
					<h1 class="wp-block-heading has-text-align-center has-<?php echo esc_attr( $body_font_family ); ?>-font-family" style="font-size:14px;font-style:normal;font-weight:700;letter-spacing:2.1px;text-transform:uppercase"><?php echo esc_html_x( 'opening soon', 'Used in the heading of the coming soon page', 'fincommerce' ); ?></h1>
					<!-- /wp:heading -->
