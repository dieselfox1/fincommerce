 ...
 * Slug: fincommerce-blocks/hero-product-3-split
 * Categories: FinCommerce, featured-selling
 */


$main_title   = __( 'New: Retro Glass Jug', 'fincommerce' );
$first_title  = __( 'Timeless elegance', 'fincommerce' );
$second_title = __( 'Durable glass', 'fincommerce' );
$third_title  = __( 'Versatile charm', 'fincommerce' );

$first_description  = __( 'Elevate your table with a 330ml Retro Glass Jug, blending classic design and durable hardened glass.', 'fincommerce' );
$second_description = __( 'Crafted from resilient thick glass, this jug ensures lasting quality, making it perfect for everyday use with a touch of vintage charm.', 'fincommerce' );
$third_description  = __( "The Retro Glass Jug's classic silhouette effortlessly complements any setting, making it the ideal choice for serving beverages with style and flair.", 'fincommerce' );
?>
		...
		<div class="wp-block-column">
			...
			<div class="wp-block-cover is-light" style="min-height:800px">
				...
				<img
					...
					alt="<?php esc_attr_e( 'Placeholder image used to represent a product being showcased.', 'fincommerce' ); ?>"
			...
			<div class="wp-block-group" style="margin-top:0;margin-bottom:0;padding-top:20px;padding-right:50px;padding-bottom:20px;padding-left:50px">
				...
				<div class="wp-block-buttons"><!-- wp:button -->
					<div class="wp-block-button">
						<a href="<?php echo esc_url( get_permalink( wc_get_page_id( 'shop' ) ) ); ?>" class="wp-block-button__link wp-element-button"><?php esc_html_e( 'Shop now', 'fincommerce' ); ?></a>
					</div>
					<!-- /wp:button -->
				</div>
				<!-- /wp:buttons -->
