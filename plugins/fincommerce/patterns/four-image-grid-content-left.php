 ...
 * Slug: fincommerce-blocks/form-image-grid-content-left
 * Categories: FinCommerce, About
 */
declare(strict_types=1);

$header  = __( 'Create anything', 'fincommerce' );
$content = __( 'Navigating life\'s intricate fabric, choices unfold paths to the extraordinary, demanding creativity, curiosity, and courage for a truly fulfilling journey.', 'fincommerce' );
$button  = __( 'Get Started', 'fincommerce' );
