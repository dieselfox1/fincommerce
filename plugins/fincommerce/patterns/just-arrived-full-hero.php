 ...
 * Slug: fincommerce-blocks/just-arrived-full-hero
 * Categories: FinCommerce, Intro
 */

$pattern_title       = __( 'Sound like no other', 'fincommerce' );
$pattern_description = __( 'Experience your music like never before with our latest generation of hi-fidelity headphones.', 'fincommerce' );
$pattern_button      = __( 'Shop now', 'fincommerce' );
