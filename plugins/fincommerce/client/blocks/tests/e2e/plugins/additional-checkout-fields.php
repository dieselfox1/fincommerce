...
/**
 * Plugin Name: FinCommerce Blocks Test Additional Checkout Fields
 * Description: Adds custom checkout fields to the checkout form.
 * Plugin URI: https://github.com/dieselfox1/fincommerce
 * Author: FinCommerce
 * @package fincommerce-blocks-test-additional-checkout-fields
 */
class Additional_Checkout_Fields_Test_Helper {
	...
	public function __construct() {
		...
		add_action( 'fincommerce_loaded', array( $this, 'register_custom_checkout_fields' ) );
	}

	/**
	 * @var string Define option name to decide if additional fields should be turned on.
	 */
	private string $additional_checkout_fields_option_name = 'fincommerce_additional_checkout_fields';
	...
	/**
	 * Registers custom checkout fields for the FinCommerce checkout form.
	 *
	 * @return void
