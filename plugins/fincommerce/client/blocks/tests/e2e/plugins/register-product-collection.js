...
__experimentalRegisterProductCollection( {
	name: 'fincommerce/product-collection/my-custom-collection',
...
__experimentalRegisterProductCollection( {
	name: 'fincommerce/product-collection/my-custom-collection-with-preview',
...
__experimentalRegisterProductCollection( {
	name: 'fincommerce/product-collection/my-custom-collection-with-advanced-preview',
...
// Product context
__experimentalRegisterProductCollection( {
	name: 'fincommerce/product-collection/my-custom-collection-product-context',
...
// Cart context
__experimentalRegisterProductCollection( {
	name: 'fincommerce/product-collection/my-custom-collection-cart-context',
...
// Order context
__experimentalRegisterProductCollection( {
	name: 'fincommerce/product-collection/my-custom-collection-order-context',
...
// Archive context
__experimentalRegisterProductCollection( {
	name: 'fincommerce/product-collection/my-custom-collection-archive-context',
...
// Multiple contexts
__experimentalRegisterProductCollection( {
	name: 'fincommerce/product-collection/my-custom-collection-multiple-contexts',
...
__experimentalRegisterProductCollection( {
	name: 'fincommerce/product-collection/my-custom-collection-with-inserter-scope',
...
__experimentalRegisterProductCollection( {
	name: 'fincommerce/product-collection/my-custom-collection-with-block-scope',
