...
wp option set --format=json fincommerce_cod_settings '{
    "enabled":"yes",
...
wp option set --format=json fincommerce_bacs_settings '{
    "enabled":"yes",
...
wp option set --format=json fincommerce_cheque_settings '{
    "enabled":"yes",
