...
wp option update fincommerce_shop_page_id $post_id
...
wp option update fincommerce_cart_page_id $post_id
...
wp option update fincommerce_checkout_page_id $post_id
...
wp option update fincommerce_myaccount_page_id $post_id
...
post_id=$(wp post create \
	...
	--post_author=1 \
	--post_title='Terms')
wp option update fincommerce_terms_page_id $post_id
...
# Create renaming FinCommerce pages using tool
