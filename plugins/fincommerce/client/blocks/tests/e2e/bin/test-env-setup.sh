...
wp-env run tests-cli -- bash wp-content/plugins/fincommerce/blocks-bin/playwright/scripts/index.sh
# Disable the LYS Coming Soon banner.
wp-env run tests-cli -- wp option update fincommerce_coming_soon 'no'
# Activate the Test Helper APIs utility plugin.
wp-env run tests-cli -- wp plugin activate fincommerce-test-plugins/test-helper-apis
