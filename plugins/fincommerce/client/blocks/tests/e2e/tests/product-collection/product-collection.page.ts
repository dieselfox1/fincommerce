...
export const SELECTORS = {
	...
	productImage: {
		inEditor: '[data-type="fincommerce/product-image"]',
		onFrontend: '[data-block-name="fincommerce/product-image"]',
	},
	productTitle: '.wp-block-post-title',
	productPrice: {
		inEditor: '[data-type="fincommerce/product-price"]',
		onFrontend: '[data-block-name="fincommerce/product-price"]',
	},
	addToCartButton: {
		inEditor: '[data-type="fincommerce/product-button"]',
		onFrontend: '[data-block-name="fincommerce/product-button"]',
	},
	pagination: {
	...
	collectionPlaceholder:
		'[data-type="fincommerce/product-collection"] .components-placeholder',
...
class ProductCollectionPage {
	private BLOCK_SLUG = 'fincommerce/product-collection';
	private page: Page;
	private admin: Admin;
	...
	async insertProductElements() {
		...
		const productElements = [
			{ name: 'fincommerce/product-rating', attributes: {} },
			{ name: 'fincommerce/product-sku', attributes: {} },
			{ name: 'fincommerce/product-stock-indicator', attributes: {} },
			{ name: 'fincommerce/product-sale-badge', attributes: {} },
			{
	...
	async setProductAttribute( attribute: 'Color' | 'Size', value: string ) {
		...
		const productAttributesContainer = sidebarSettings.locator(
			'.fincommerce-product-attributes'
		);
	...
	private async insertSingleProductBlock() {
		await this.editor.insertBlock( { name: 'fincommerce/single-product' } );
