...
test.describe( 'Template part customization', () => {
	...
	const fincommerceTemplateUserText = `Hello World in the FinCommerce ${ templateName } template`;
	...
	test.describe( `${ templateName } template`, () => {
		test( `user-modified ${ templateName } template based on the theme template has priority over the user-modified template based on the default FinCommerce template`, async ( {
			page,
			admin,
			editor,
			requestUtils,
