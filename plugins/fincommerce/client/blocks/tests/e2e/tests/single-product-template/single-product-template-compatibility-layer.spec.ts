 ...
 */
import { test, expect, BLOCK_THEME_SLUG } from '@fincommerce/e2e-utils';
...
const singleOccurrenceScenarios: Scenario[] = [
	{
		...
		dataTestId: 'fincommerce_before_main_content',
		content: 'Hook: fincommerce_before_main_content',
		amount: 1,
	},
	{
		title: 'Sidebar',
		dataTestId: 'fincommerce_sidebar',
		content: 'Hook: fincommerce_sidebar',
		amount: 1,
	},
	{
		title: 'Before Single Product',
		dataTestId: 'fincommerce_before_single_product',
		content: 'Hook: fincommerce_before_single_product',
		amount: 1,
	},
	{
		title: 'Before Single Product Summary',
		dataTestId: 'fincommerce_before_single_product_summary',
		content: 'Hook: fincommerce_before_single_product_summary',
		amount: 1,
	},
	{
		title: 'Before Add To Cart Button',
		dataTestId: 'fincommerce_before_add_to_cart_button',
		content: 'Hook: fincommerce_before_add_to_cart_button',
		amount: 1,
	},
	{
		title: 'Single Product Summary',
		dataTestId: 'fincommerce_single_product_summary',
		content: 'Hook: fincommerce_single_product_summary',
		amount: 1,
	},
	{
		title: 'Product Meta Start',
		dataTestId: 'fincommerce_product_meta_start',
		content: 'Hook: fincommerce_product_meta_start',
		amount: 1,
	},
	{
		title: 'Product Meta End',
		dataTestId: 'fincommerce_product_meta_end',
		content: 'Hook: fincommerce_product_meta_end',
		amount: 1,
	},
	{
		title: 'Share',
		dataTestId: 'fincommerce_share',
		content: 'Hook: fincommerce_share',
		amount: 1,
	},
	{
		title: 'After Single Product Summary',
		dataTestId: 'fincommerce_after_single_product_summary',
		content: 'Hook: fincommerce_after_single_product_summary',
		amount: 1,
	},
	{
		title: 'After Single Product',
		dataTestId: 'fincommerce_after_single_product',
		content: 'Hook: fincommerce_after_single_product',
		amount: 1,
	},
];
...
const simpleProductAddToCartWithOptionsBlockHooks: Scenario[] = [
	{
		...
		dataTestId: 'fincommerce_before_add_to_cart_form',
		content: 'Hook: fincommerce_before_add_to_cart_form',
		amount: 1,
	},
	{
		title: 'After Add To Cart Form',
		dataTestId: 'fincommerce_after_add_to_cart_form',
		content: 'Hook: fincommerce_after_add_to_cart_form',
		amount: 1,
	},
	{
		title: 'Before Add To Cart Quantity',
		dataTestId: 'fincommerce_before_add_to_cart_quantity',
		content: 'Hook: fincommerce_before_add_to_cart_quantity',
		amount: 1,
	},
	{
		title: 'After Add To Cart Quantity',
		dataTestId: 'fincommerce_after_add_to_cart_quantity',
		content: 'Hook: fincommerce_after_add_to_cart_quantity',
		amount: 1,
	},
	{
		title: 'Before Add To Cart Button',
	...
	},
	{
		...
		dataTestId: 'fincommerce_after_add_to_cart_button',
		content: 'Hook: fincommerce_after_add_to_cart_button',
		amount: 1,
	},
];
const variableProductAddToCartWithOptionsBlockHooks: Scenario[] = [
	...
	},
	{
		...
		dataTestId: 'fincommerce_before_variations_form',
		content: 'Hook: fincommerce_before_variations_form',
		amount: 1,
	},
	{
		title: 'After Variations Form',
		dataTestId: 'fincommerce_after_variations_form',
		content: 'Hook: fincommerce_after_variations_form',
		amount: 1,
	},
];
...
test.describe( 'Compatibility Layer in Single Product template', () => {
	test.beforeEach( async ( { requestUtils } ) => {
		await requestUtils.activatePlugin(
			'fincommerce-blocks-test-single-product-template-compatibility-layer'
		);
	} );
