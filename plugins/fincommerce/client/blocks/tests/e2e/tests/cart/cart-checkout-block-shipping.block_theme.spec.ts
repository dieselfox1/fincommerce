 ...
 */
import { expect, test as base, FrontendUtils } from '@fincommerce/e2e-utils';
...
test.describe( 'Shopper → Shipping', () => {
	...
	// Series of tests below to cover the following scenarios: see PR https://github.com/dieselfox1/fincommerce/pull/56460 for more details
	...
	// Not testing because this is a "bug" we are going to fix - see https://github.com/dieselfox1/fincommerce/issues/56462
	...
	// Skipping test due to a known bug with needs_shipping - see issue https://github.com/dieselfox1/fincommerce/issues/56507
