...
import { test as base, expect, Editor, wpCLI } from '@fincommerce/e2e-utils';
...
const blockData = {
	...
	slug: 'fincommerce/add-to-cart-form',
...
class BlockUtils {
	 ...
	 * This is useful for simulating extensions that set these attributes via fincommerce_quantity_input
	 * https://github.com/dieselfox1/fincommerce/blob/89945ca8fc4589c061ba2130bf72bf24dc9268bd/plugins/fincommerce/includes/wc-template-functions.php#L1877-L1878
	 *
	 */
...
test.describe( `${ blockData.name } Block`, () => {
	test( 'can be added in the Post Editor only as inner block of the Single Product Block', async ( {
		...
		await editor.insertBlock( { name: 'fincommerce/single-product' } );
