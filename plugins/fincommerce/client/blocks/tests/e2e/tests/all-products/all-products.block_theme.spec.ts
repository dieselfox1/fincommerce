 ...
 */
import { BLOCK_THEME_SLUG, expect, test } from '@fincommerce/e2e-utils';

/**
 * Internal dependencies
 */

const BLOCK_NAME = 'fincommerce/all-products';
...
test.describe( `${ BLOCK_NAME } Block`, () => {
	...
	// Check this regression: hhttps://github.com/dieselfox1/fincommerce/pull/58741.
