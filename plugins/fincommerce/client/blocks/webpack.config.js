 ...
 */
const { NODE_ENV, getAlias } = require( '@fincommerce/block-library/bin/webpack-helpers.js' );
const {
	getCoreConfig,
	getMainConfig,
	getFrontConfig,
...
} = require( '@fincommerce/block-library/bin/webpack-configs.js' );

const interactivityBlocksConfig = require( '@fincommerce/block-library/bin/webpack-config-interactive-blocks.js' );
const interactivityAPIConfig = require( '@fincommerce/block-library/bin/webpack-config-interactivity.js' );
