 ...
 */
import isPostcode from '@fincommerce/block-library/packages/checkout/utils/validation/is-postcode';
import type { IsPostcodeProps } from '@fincommerce/block-library/packages/checkout/utils/validation/is-postcode';
