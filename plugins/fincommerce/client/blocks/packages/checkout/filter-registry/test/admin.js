 ...
 */
import { registerCheckoutFilters, applyCheckoutFilter } from '@fincommerce/block-library/packages/checkout/filter-registry';

jest.mock( '@fincommerce/settings', () => {
	const originalModule = jest.requireActual( '@fincommerce/settings' );
	return {
		// eslint-disable-next-line @typescript-eslint/ban-ts-comment
		// @ts-ignore We know @fincommerce/settings is an object.
		...originalModule,
