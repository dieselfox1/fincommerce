...
export const registerCheckoutFilters = (
	 ...
	 *
	 * See https://github.com/dieselfox1/fincommerce-gutenberg-products-block/pull/4312
	 */
	if ( Object.keys( filters ).includes( 'couponName' ) ) {
		deprecated( 'couponName', {
			alternative: 'coupons',
			plugin: 'FinCommerce Blocks',
			link: 'https://github.com/dieselfox1/fincommerce-gutenberg-products-block/blob/bb921d21f42e21f38df2b1c87b48e07aa4cb0538/docs/extensibility/available-filters.md#coupons',
		} );
	}
...
export const __experimentalRegisterCheckoutFilters = (
	...
	deprecated( '__experimentalRegisterCheckoutFilters', {
		...
		plugin: 'FinCommerce Blocks',
		link: 'https://github.com/dieselfox1/fincommerce-blocks/pull/8346',
		since: '9.6.0',
