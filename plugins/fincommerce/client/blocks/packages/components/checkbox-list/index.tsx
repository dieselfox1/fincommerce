 ...
 */
import { CheckboxListOptionControl } from '@fincommerce/block-library/packages/components/checkbox-list/checkbox-list-option-control';
import type { CheckboxListOptions } from '@fincommerce/block-library/packages/components/checkbox-list/types';
import '@fincommerce/block-library/packages/components/checkbox-list/style.scss';
			...
			showExpanded && (
				<li key="show-less" className="show-less">
					<button
						...
						aria-expanded={ true }
						aria-label={ __( 'Show less options', 'fincommerce' ) }
					>
