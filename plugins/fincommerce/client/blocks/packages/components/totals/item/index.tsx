 ...
 */
import FormattedMonetaryAmount from '@fincommerce/block-library/packages/components/formatted-monetary-amount';
import '@fincommerce/block-library/packages/components/totals/item/style.scss';
