 ...
 */
import Title, { type TitleProps } from '@fincommerce/block-library/packages/components/title';
import '@fincommerce/block-library/packages/components/title/style.scss';
import '@fincommerce/block-library/packages/components/title/stories/style.stories.scss';
