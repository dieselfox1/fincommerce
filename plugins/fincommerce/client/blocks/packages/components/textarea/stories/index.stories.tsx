 ...
 */
import Textarea, { type TextareaProps } from '@fincommerce/block-library/packages/components/textarea';
import '@fincommerce/block-library/packages/components/textarea/style.scss';
