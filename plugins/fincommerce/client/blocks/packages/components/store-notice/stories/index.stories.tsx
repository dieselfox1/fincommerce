...
import { NoticeBannerProps } from '@fincommerce/base-components/notice-banner';
/**
 * Internal dependencies
 */
import StoreNotice from '@fincommerce/block-library/packages/components/store-notice';
