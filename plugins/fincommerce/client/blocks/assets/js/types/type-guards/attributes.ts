 ...
 */
import type { AttributeTerm, AttributeQuery } from '@fincommerce/block-library/assets/js/types/type-defs';
import { objectHasProp } from '@fincommerce/block-library/assets/js/types/type-guards/object';
