...
export const previewProducts = [
	{
		...
		price: '7.99',
		price_html:
			'<span class="fincommerce-Price-amount amount"><span class="fincommerce-Price-currencySymbol">$</span>7.99</span>',
		images: [
			{
				id: 1,
		...
		add_to_cart: {
			text: __( 'Add to cart', 'fincommerce' ),
			description: __( 'Add to cart', 'fincommerce' ),
		},
		has_options: false,
		is_purchasable: true,
		is_in_stock: true,
