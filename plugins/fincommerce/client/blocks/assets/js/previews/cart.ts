...
import { CartResponse } from '@fincommerce/types';
import { getSetting } from '@fincommerce/settings';

/**
 * Internal dependencies
 */
import { previewShippingRates } from '@fincommerce/block-library/assets/js/previews/shipping-rates';
import { API_SITE_CURRENCY, displayForMinorUnit } from '@fincommerce/block-library/assets/js/previews/utils';
 ...
 * data.
 *
 * FinCommerce core has 2 settings which control this, one for cart (displayCartPricesIncludingTax), and one for the
...
// https://github.com/dieselfox1/fincommerce/tree/trunk/docs/apis/store-api/resources-endpoints/cart.md#cart-response
	...
	items: [
		{
			...
			name: __( 'Beanie', 'fincommerce' ),
			summary: __( 'Beanie', 'fincommerce' ),
			short_description: __( 'Warm hat for winter', 'fincommerce' ),
			description:
			...
			variation: [
				{
					attribute: __( 'Color', 'fincommerce' ),
					value: __( 'Yellow', 'fincommerce' ),
				},
				{
					attribute: __( 'Size', 'fincommerce' ),
					value: __( 'Small', 'fincommerce' ),
				},
			],
			prices: {
				...API_SITE_CURRENCY,
		...
		},
		{
			...
			quantity: 1,
			catalog_visibility: 'visible',
			name: __( 'Cap', 'fincommerce' ),
			summary: __( 'Cap', 'fincommerce' ),
			short_description: __( 'Lightweight baseball cap', 'fincommerce' ),
			description:
				'Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Vestibulum tortor quam, feugiat vitae, ultricies eget, tempor sit amet, ante. Donec eu libero sit amet quam egestas semper. Aenean ultricies mi vitae est. Mauris placerat eleifend leo.',
			sku: 'woo-cap',
	...
	cross_sells: [
		{
			...
			permalink: 'https://example.org',
			sku: 'woo-polo',
			short_description: __( 'Polo', 'fincommerce' ),
			description: __( 'Polo', 'fincommerce' ),
			on_sale: false,
			prices: {
				...API_SITE_CURRENCY,
				price: displayForMinorUnit(
		...
		{
			id: 2,
			name: __( 'Long Sleeve Tee', 'fincommerce' ),
			...
			short_description: __( 'Long Sleeve Tee', 'fincommerce' ),
			description: __( 'Long Sleeve Tee', 'fincommerce' ),
			on_sale: false,
			prices: {
				...API_SITE_CURRENCY,
				price: displayForMinorUnit(
		...
		{
			id: 3,
			name: __( 'Hoodie with Zipper', 'fincommerce' ),
			...
			short_description: __( 'Hoodie with Zipper', 'fincommerce' ),
			description: __( 'Hoodie with Zipper', 'fincommerce' ),
			on_sale: true,
			prices: {
				...API_SITE_CURRENCY,
				price: displayForMinorUnit(
		...
		{
			id: 4,
			name: __( 'Hoodie with Logo', 'fincommerce' ),
		...
		{
			id: 5,
			name: __( 'Hoodie with Pocket', 'fincommerce' ),
			...
			short_description: __( 'Hoodie with Pocket', 'fincommerce' ),
			description: __( 'Hoodie with Pocket', 'fincommerce' ),
			on_sale: true,
			prices: {
				...API_SITE_CURRENCY,
		...
		},
		{
			...
			permalink: 'https://example.org',
			sku: 'woo-t-shirt',
			short_description: __( 'T-Shirt', 'fincommerce' ),
			description: __( 'T-Shirt', 'fincommerce' ),
			on_sale: false,
			prices: {
				...API_SITE_CURRENCY,
