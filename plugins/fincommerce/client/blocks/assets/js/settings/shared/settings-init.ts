 ...
 */
import { SymbolPosition, CurrencyCode } from '@fincommerce/types';
...
export interface fincommerceSiteCurrency {
...
export interface fincommerceSiteLocale {
...
export interface fincommerceSharedSettings {
	adminUrl: string;
	...
	>;
	currency: fincommerceSiteCurrency;
	currentUserId: number;
	currentUserIsAdmin: boolean;
	homeUrl: string;
	locale: fincommerceSiteLocale;
...
const defaults: fincommerceSharedSettings = {
	adminUrl: '',
	countries: [],
	countryData: {},
	currency: {
...
interface AllSettings
	extends fincommerceSharedSettings,
...
allSettings.currency = {
	...defaults.currency,
	...( allSettings.currency as fincommerceSiteCurrency ),
};
