 ...
 */
import type { Currency, SymbolPosition } from '@fincommerce/types';

/**
 * Internal dependencies
 */
import { allSettings } from '@fincommerce/block-library/assets/js/settings/shared/settings-init';
import { getCurrencyPrefix, getCurrencySuffix } from '@fincommerce/block-library/assets/js/settings/shared/utils';
...
// Settings from the server in fincommerceSiteCurrency format.
export const CURRENCY = allSettings.currency;
// Convert fincommerceSiteCurrency format to Currency format.
