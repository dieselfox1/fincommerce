 ...
 */
import { useSchemaParser } from '@fincommerce/block-library/assets/js/base/hooks/use-schema-parser';
import { CheckoutState } from '@fincommerce/block-library/assets/js/data/checkout/default-state';
import { PaymentState } from '@fincommerce/block-library/assets/js/data/payment/default-state';
import { CartState } from '@fincommerce/block-library/assets/js/data/cart/default-state';
import checkoutSchema from '@fincommerce/block-library/assets/js/base/hooks/test/checkout-document-schema.json';

// Mock the stores
jest.mock( '@fincommerce/block-data', () => ( {
	__esModule: true,
