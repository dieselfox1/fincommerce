 ...
 */
import * as mockUseStoreCart from '@fincommerce/block-library/assets/js/base/context/hooks/cart/use-store-cart';
import { useStoreCartItemQuantity } from '@fincommerce/block-library/assets/js/base/context/hooks/cart/use-store-cart-item-quantity';
import { config as checkoutStoreConfig } from '@fincommerce/block-library/assets/js/data/checkout';
...
jest.mock( '@fincommerce/block-data', () => ( {
	__esModule: true,
	...jest.requireActual( '@fincommerce/block-data' ),
} ) );
