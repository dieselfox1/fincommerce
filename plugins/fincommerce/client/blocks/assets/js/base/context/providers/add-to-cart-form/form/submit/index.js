 ...
 */
import { useAddToCartFormContext } from '@fincommerce/block-library/assets/js/base/context/providers/add-to-cart-form/form-state';
...
const FormSubmit = () => {
	...
	const submitFormCallback = useCallback( () => {
		...
		removeNotice(
			'add-to-cart',
			`fincommerce/single-product/${ product?.id || 0 }`
		);
