...
export const prepareTotalItems = (
	...
	newTotals.push(
		factory( __( 'Subtotal:', 'fincommerce' ), 'total_items' )
	);

	newTotals.push( factory( __( 'Fees:', 'fincommerce' ), 'total_fees' ) );

	newTotals.push(
		factory( __( 'Discount:', 'fincommerce' ), 'total_discount' )
	);
	...
	if ( needsShipping ) {
		newTotals.push(
			factory( __( 'Shipping:', 'fincommerce' ), 'total_shipping' )
		);
	}
