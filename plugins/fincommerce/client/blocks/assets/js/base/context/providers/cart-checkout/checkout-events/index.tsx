 ...
 */
import { reducer as emitReducer } from '@fincommerce/block-library/assets/js/base/context/providers/cart-checkout/checkout-events/event-emit';
import { emitterCallback, noticeContexts } from '@fincommerce/block-library/assets/js/base/context/event-emit';
import { useStoreEvents } from '@fincommerce/block-library/assets/js/base/context/hooks/use-store-events';

import { useEditorContext } from '@fincommerce/block-library/assets/js/base/context/providers/editor-context';
import { EventListenerRegistrationFunction } from '@fincommerce/block-library/assets/js/events/event-emitter';
...
export const CheckoutEventsProvider = ( {
	 ...
	 * See: https://github.com/dieselfox1/fincommerce-gutenberg-products-block/pull/4039/commits/a502d1be8828848270993264c64220731b0ae181
	 */
	...
	const onCheckoutValidationBeforeProcessing = useMemo( () => {
		return function ( ...args: Parameters< typeof onCheckoutValidation > ) {
			deprecated( 'onCheckoutValidationBeforeProcessing', {
				...
				alternative: 'onCheckoutValidation',
				plugin: 'FinCommerce Blocks',
				link: 'https://github.com/dieselfox1/fincommerce-blocks/pull/8381',
			} );
			return onCheckoutValidation( ...args );
		};
	}, [ onCheckoutValidation ] );
