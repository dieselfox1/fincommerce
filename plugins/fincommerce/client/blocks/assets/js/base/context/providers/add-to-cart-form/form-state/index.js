 ...
 */
import { actions } from '@fincommerce/block-library/assets/js/base/context/providers/add-to-cart-form/form-state/actions';
import { reducer } from '@fincommerce/block-library/assets/js/base/context/providers/add-to-cart-form/form-state/reducer';
import { DEFAULT_STATE, STATUS } from '@fincommerce/block-library/assets/js/base/context/providers/add-to-cart-form/form-state/constants';
import {
	EMIT_TYPES,
	emitterObservers,
	emitEvent,
...
} from '@fincommerce/block-library/assets/js/base/context/providers/add-to-cart-form/form-state/event-emit';
import { removeNoticesByStatus } from '@fincommerce/block-library/assets/js/utils/notices';

/**
 * @typedef {import('@fincommerce/type-defs/add-to-cart-form').AddToCartFormDispatchActions} AddToCartFormDispatchActions
 * @typedef {import('@fincommerce/type-defs/add-to-cart-form').AddToCartFormEventRegistration} AddToCartFormEventRegistration
 * @typedef {import('@fincommerce/type-defs/contexts').AddToCartFormContext} AddToCartFormContext
 */
				...
				emitEventWithAbort(
					...
					if ( ! handleErrorResponse( observerResponses ) ) {
						...
						createErrorNotice( message, {
							id: 'add-to-cart',
							context: `fincommerce/single-product/${
								product?.id || 0
							}`,
						} );
					}
