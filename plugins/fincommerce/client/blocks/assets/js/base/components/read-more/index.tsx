 ...
 */
import { clampLines } from '@fincommerce/block-library/assets/js/base/components/read-more/utils';
...
export const defaultProps = {
	...
	ellipsis: '&hellip;',
	lessText: __( 'Read less', 'fincommerce' ),
	maxLines: 3,
	moreText: __( 'Read more', 'fincommerce' ),
};
