...
import type { PackageRateOption } from '@fincommerce/type-defs/shipping';
...
export interface PackageProps {
	/* PackageId can be a string, FinCommerce Subscriptions uses strings for example, but FinCommerce core uses numbers */
