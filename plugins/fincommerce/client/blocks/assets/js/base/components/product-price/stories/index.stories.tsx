...
import { currencyControl } from '@fincommerce/storybook-controls';

/**
 * Internal dependencies
 */
import ProductPrice, { ProductPriceProps } from '@fincommerce/block-library/assets/js/base/components/product-price';
