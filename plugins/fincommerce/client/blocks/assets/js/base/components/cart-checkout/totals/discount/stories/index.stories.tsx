...
import {
	...
	currencyControl,
	INTERACTION_TIMEOUT,
} from '@fincommerce/storybook-controls';
import {
 ...
 */
import Discount, { TotalsDiscountProps } from '@fincommerce/block-library/assets/js/base/components/cart-checkout/totals/discount';
