...
import '@fincommerce/block-library/assets/js/base/components/skeleton/patterns/cart-line-items/style.scss';
...
export const CartLineItemsCheckoutSkeleton = ( {
	...
	return (
		<div
			...
			aria-live="polite"
			aria-label={ __( 'Loading products in cart…', 'fincommerce' ) }
		>
