 ...
 */
import NoProducts from '@fincommerce/block-library/assets/js/base/components/product-list/no-products';
import NoMatchingProducts from '@fincommerce/block-library/assets/js/base/components/product-list/no-matching-products';
import ProductSortSelect from '@fincommerce/block-library/assets/js/base/components/product-list/product-sort-select';
import ProductListItem from '@fincommerce/block-library/assets/js/base/components/product-list/product-list-item';
import {
	GenerateQuery,
	GetSortArgs,
	Query,
	...
	ProductListProps,
	TotalQuery,
} from '@fincommerce/block-library/assets/js/base/components/product-list/types';
import '@fincommerce/block-library/assets/js/base/components/product-list/style.scss';
...
const announceLoadingCompletion = ( totalProducts: number ): void => {
	...
	if ( totalProducts === 0 ) {
		speak( __( 'No products found', 'fincommerce' ) );
	} else {
		speak(
			sprintf(
