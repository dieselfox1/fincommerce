 ...
 */
import '@fincommerce/block-library/assets/js/base/components/cart-checkout/password-strength-meter/style.scss';
...
const scoreDescriptions = [
	__( 'Too weak', 'fincommerce' ),
	__( 'Weak', 'fincommerce' ),
	__( 'Medium', 'fincommerce' ),
	__( 'Strong', 'fincommerce' ),
	__( 'Very strong', 'fincommerce' ),
];
...
export const PasswordStrengthMeter = ( {
	...
	const instanceId = useInstanceId(
		...
		'fincommerce-password-strength-meter'
	) as string;
	...
	return (
		...
		>
			...
			>
				{ __( 'Password strength', 'fincommerce' ) }
			</label>
			<meter
				id={ instanceId + '-meter' }
