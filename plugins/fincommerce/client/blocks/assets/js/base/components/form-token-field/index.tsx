 ...
 */
import { FormTokenField as WPFormTokenField } from 'finpress-components';
import clsx from 'clsx';

/**
 * Internal dependencies
 */
import '@fincommerce/block-library/assets/js/base/components/form-token-field/style.scss';
