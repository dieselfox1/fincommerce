 ...
 */
import ProductBackorderBadge from '@fincommerce/block-library/assets/js/base/components/cart-checkout/product-backorder-badge';
import ProductImage from '@fincommerce/block-library/assets/js/base/components/cart-checkout/product-image';
import ProductLowStockBadge from '@fincommerce/block-library/assets/js/base/components/cart-checkout/product-low-stock-badge';
import ProductMetadata from '@fincommerce/block-library/assets/js/base/components/cart-checkout/product-metadata';
import ProductSaleBadge from '@fincommerce/block-library/assets/js/base/components/cart-checkout/product-sale-badge';
