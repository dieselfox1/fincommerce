 ...
 */
import AddressLine2Field from '@fincommerce/block-library/assets/js/base/components/cart-checkout/form/address-line-2-field';
import { AddressLineFieldsProps } from '@fincommerce/block-library/assets/js/base/components/cart-checkout/form/types';
import { createFieldProps } from '@fincommerce/block-library/assets/js/base/components/cart-checkout/form/utils';
