 ...
 */
import PackageRates from '@fincommerce/block-library/assets/js/base/components/cart-checkout/shipping-rates-control-package/package-rates';
import PackageItems from '@fincommerce/block-library/assets/js/base/components/cart-checkout/shipping-rates-control-package/package-items';
import type { PackageProps } from '@fincommerce/block-library/assets/js/base/components/cart-checkout/shipping-rates-control-package/types';
import '@fincommerce/block-library/assets/js/base/components/cart-checkout/shipping-rates-control-package/style.scss';
