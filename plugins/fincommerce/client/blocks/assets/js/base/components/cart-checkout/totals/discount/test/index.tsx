...
import { CartResponseTotalsItem } from '@fincommerce/type-defs/cart-response';
import type { LoadingMaskProps } from '@fincommerce/base-components/loading-mask';
/**
 * Internal dependencies
 */
import TotalsDiscount, { TotalsDiscountProps } from '@fincommerce/block-library/assets/js/base/components/cart-checkout/totals/discount';
import { RemovableChipProps } from '@fincommerce/block-library/packages/components/chip/removable-chip';
import { TotalsItemProps } from '@fincommerce/block-library/packages/components/totals/item';
...
jest.mock( '@fincommerce/blocks-checkout', () => ( {
...
jest.mock(
	'@fincommerce/base-components/loading-mask',
...
jest.mock( '@fincommerce/blocks-components', () => ( {
