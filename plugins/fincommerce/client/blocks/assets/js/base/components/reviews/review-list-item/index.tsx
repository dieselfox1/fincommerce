 ...
 */
import '@fincommerce/block-library/assets/js/base/components/reviews/review-list-item/style.scss';
	...
	return (
		<div className="wc-block-review-list-item__image wc-block-components-review-list-item__image">
			{ imageType === 'product' ? (
				...
				// Github discussion for a context: https://github.com/dieselfox1/fincommerce-blocks/pull/7651#discussion_r1019560494.
				<img
					aria-hidden="true"
					alt=""
			...
			{ review.verified && (
				<div
					...
					title={ __( 'Verified buyer', 'fincommerce' ) }
				>
					{ __( 'Verified buyer', 'fincommerce' ) }
				</div>
			) }
		</div>
	);
...
function getReviewContent( review: Review ): JSX.Element {
	return (
		<ReadMore
			maxLines={ 10 }
			moreText={ __( 'Read full review', 'fincommerce' ) }
			lessText={ __( 'Hide full review', 'fincommerce' ) }
