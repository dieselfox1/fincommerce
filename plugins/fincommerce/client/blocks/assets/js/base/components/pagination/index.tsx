 ...
 */
import { getIndexes } from '@fincommerce/block-library/assets/js/base/components/pagination/utils';
import '@fincommerce/block-library/assets/js/base/components/pagination/style.scss';
		...
		<div className="wc-block-pagination wc-block-components-pagination">
			...
			{ displayNextAndPreviousArrows && (
				<button
					...
					title={ __( 'Previous page', 'fincommerce' ) }
			...
			{ displayNextAndPreviousArrows && (
				<button
					className="wc-block-pagination-page wc-block-components-pagination__page wc-block-components-pagination-page--arrow"
					onClick={ () => onPageChange( currentPage + 1 ) }
					title={ __( 'Next page', 'fincommerce' ) }
					disabled={ currentPage >= totalPages }
				>
					<Label
						label="&rarr;"
						screenReaderLabel={ __( 'Next page', 'fincommerce' ) }
					/>
				</button>
			) }
		</div>
