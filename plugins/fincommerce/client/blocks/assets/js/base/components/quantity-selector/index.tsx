...
import type { QuantitySelectorProps } from '@fincommerce/block-library/assets/js/base/components/quantity-selector/types';
		...
		<div className={ classes }>
			<input
				...
				aria-label={ sprintf(
					...
					__( 'Quantity of %s in your cart.', 'fincommerce' ),
					itemName
				) }
			/>
			{ editable && (
				<>
					<button
						...
						aria-label={ sprintf(
							/* translators: %s refers to the item name in the cart. */
							__( 'Reduce quantity of %s', 'fincommerce' ),
							itemName
						) }
					...
					<button
						...
						aria-label={ sprintf(
							...
							__( 'Increase quantity of %s', 'fincommerce' ),
							itemName
						) }
