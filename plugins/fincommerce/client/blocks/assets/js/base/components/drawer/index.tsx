...
import * as ariaHelper from '@fincommerce/block-library/assets/js/base/components/drawer/utils/aria-helper';
import '@fincommerce/block-library/assets/js/base/components/drawer/style.scss';
	...
	return closeButtonWrapper
		? createPortal(
				<Button
					...
					onClick={ onClick }
					removeTextWrap
					aria-label={ __( 'Close', 'fincommerce' ) }
				>
					<Icon icon={ close } />
				</Button>,
				closeButtonWrapper
...
export { default as DrawerCloseButton } from '@fincommerce/block-library/assets/js/base/components/drawer/close-button';
