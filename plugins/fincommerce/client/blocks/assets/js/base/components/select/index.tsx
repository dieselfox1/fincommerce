 ...
 */
import '@fincommerce/block-library/assets/js/base/components/select/style.scss';
...
export const Select = ( props: SelectProps ) => {
	const {
		...
		required,
		errorMessage = __( 'Please select a valid option', 'fincommerce' ),
		placeholder,
		...restOfProps
	} = props;
