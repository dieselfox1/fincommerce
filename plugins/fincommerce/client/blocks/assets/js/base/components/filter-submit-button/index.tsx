 ...
 */
import '@fincommerce/block-library/assets/js/base/components/filter-submit-button/style.scss';
...
const FilterSubmitButton = ( {
	...
	label = __( 'Apply', 'fincommerce' ),
	onClick,
	screenReaderLabel = __( 'Apply filter', 'fincommerce' ),
