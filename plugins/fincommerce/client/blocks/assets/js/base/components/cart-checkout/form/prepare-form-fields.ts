 ...
 */
import { COUNTRY_LOCALE } from '@fincommerce/block-settings';
import {
 ...
 *
 * @param {Object} localeField Locale fields from FinCommerce.
...
/**
 * COUNTRY_LOCALE is locale data from FinCommerce countries class. This doesn't match the shape of the new field data blocks uses,
