...
import '@fincommerce/block-library/assets/js/base/components/skeleton/patterns/checkout-payment/style.scss';
...
export const CheckoutPaymentSkeleton = () => {
	return (
		<div
			...
			aria-live="polite"
			aria-label={ __( 'Loading payment options… ', 'fincommerce' ) }
		>
