 ...
 */
import type { BlockErrorProps } from '@fincommerce/block-library/assets/js/base/components/block-error-boundary/types';

const BlockError = ( {
	imageUrl = `${ WC_BLOCKS_IMAGE_URL }/block-error.svg`,
	header = __( 'Oops!', 'fincommerce' ),
	text = __( 'There was an error loading the content.', 'fincommerce' ),
	errorMessage,
	errorMessagePrefix = __( 'Error:', 'fincommerce' ),
	button,
	showErrorBlock = true,
