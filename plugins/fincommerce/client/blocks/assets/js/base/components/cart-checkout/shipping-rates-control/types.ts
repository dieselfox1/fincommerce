 ...
 */
import { CartResponseShippingRate } from '@fincommerce/type-defs/cart-response';
...
import {
	...
	TernaryFlag,
} from '@fincommerce/block-library/assets/js/base/components/cart-checkout/shipping-rates-control-package/types';
...
export interface PackagesProps {
	...
	context?: 'fincommerce/cart' | 'fincommerce/checkout' | '';
}
