 ...
 */
import '@fincommerce/block-library/assets/js/base/components/product-price/style.scss';
		...
		<>
			<span className="screen-reader-text">
				{ sprintf(
					...
					__( 'Price between %1$s and %2$s', 'fincommerce' ),
...
const SalePrice = ( {
	...
	return (
		<>
			...
			/>
			<span className="screen-reader-text">
				{ __( 'Discounted price:', 'fincommerce' ) }
			</span>
			<FormattedMonetaryAmount
				currency={ currency }
				renderText={ ( value ) => (
