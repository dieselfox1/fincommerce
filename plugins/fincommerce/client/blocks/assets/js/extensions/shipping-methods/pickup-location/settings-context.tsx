...
} from '@fincommerce/block-library/assets/js/extensions/shipping-methods/pickup-location/types';
import {
	defaultSettings,
	getInitialSettings,
...
} from '@fincommerce/block-library/assets/js/extensions/shipping-methods/pickup-location/utils';
