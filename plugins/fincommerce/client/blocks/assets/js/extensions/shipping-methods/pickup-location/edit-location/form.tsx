...
import { countryStateOptions, states } from '@fincommerce/block-library/assets/js/extensions/shipping-methods/pickup-location/utils';
...
const Form = ( {
	...
	return (
		<form ref={ formRef }>
			<TextControl
				label={ __( 'Location name', 'fincommerce' ) + ' *' }
				name={ 'location_name' }
				value={ values.name }
				...
				onInvalid={ (
					...
					event.target.setCustomValidity(
						__( 'A Location title is required', 'fincommerce' )
					);
				} }
			...
			<TextControl
				...
				placeholder={ __( 'Address', 'fincommerce' ) }
			...
			<TextControl
				...
				placeholder={ __( 'City', 'fincommerce' ) }
			...
			<TextControl
				...
				hideLabelFromVision={ true }
				placeholder={ __( 'Postcode / ZIP', 'fincommerce' ) }
			...
			{ ! countryHasStates && (
				<TextControl
					placeholder={ __( 'State', 'fincommerce' ) }
					value={ selectedState }
			...
			<SelectControl
				...
				label={ __( 'Country / State', 'fincommerce' ) }
				hideLabelFromVision={ true }
				placeholder={ __( 'Country / State', 'fincommerce' ) }
				value={ ( () => {
			...
			<TextControl
				label={ __( 'Pickup details', 'fincommerce' ) }
				name={ 'pickup_details' }
