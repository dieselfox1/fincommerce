 ...
 */
import { SettingsCard, SettingsSection } from '@fincommerce/block-library/assets/js/extensions/shipping-methods/shared-components';
...
const GeneralSettingsDescription = () => (
	<>
		<h2>{ _x( 'General', 'Admin settings', 'fincommerce' ) }</h2>
		<p>
			{ __(
		...
		>
			{ __( 'View checkout page', 'fincommerce' ) }
		</ExternalLink>
	</>
);
		...
		<SettingsSection Description={ GeneralSettingsDescription }>
			<SettingsCard>
				...
				<CheckboxControl
					...
					label={ __( 'Enable local pickup', 'fincommerce' ) }
					help={
						<span>
							{ __(
				...
				<TextControl
					...
					placeholder={ __( 'Pickup', 'fincommerce' ) }
				...
				{ showCosts ? (
					<>
						<TextControl
							...
							placeholder={ __( 'Free', 'fincommerce' ) }
							type="number"
							pattern="[0-9]+\.?[0-9]*"
							min={ 0 }
							value={ settings.cost }
						...
						<SelectControl
							...
							options={ [
								{
									label: __( 'Taxable', 'fincommerce' ),
									value: 'taxable',
								},
								{
									label: __( 'Not taxable', 'fincommerce' ),
									value: 'none',
								},
							] }
