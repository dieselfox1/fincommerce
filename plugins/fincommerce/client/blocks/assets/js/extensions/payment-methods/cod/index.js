 ...
 */
import { PAYMENT_METHOD_NAME } from '@fincommerce/block-library/assets/js/extensions/payment-methods/cod/constants';

const settings = getPaymentMethodData( 'cod', {} );
const defaultLabel = __( 'Cash on delivery', 'fincommerce' );
