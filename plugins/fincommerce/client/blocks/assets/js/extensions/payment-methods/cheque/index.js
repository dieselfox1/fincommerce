 ...
 */
import { PAYMENT_METHOD_NAME } from '@fincommerce/block-library/assets/js/extensions/payment-methods/cheque/constants';

const settings = getPaymentMethodData( 'cheque', {} );
const defaultLabel = __( 'Check payment', 'fincommerce' );
