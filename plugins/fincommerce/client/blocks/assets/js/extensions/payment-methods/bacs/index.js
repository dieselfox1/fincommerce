 ...
 */
import { PAYMENT_METHOD_NAME } from '@fincommerce/block-library/assets/js/extensions/payment-methods/bacs/constants';

const settings = getPaymentMethodData( 'bacs', {} );
const defaultLabel = __( 'Direct bank transfer', 'fincommerce' );
