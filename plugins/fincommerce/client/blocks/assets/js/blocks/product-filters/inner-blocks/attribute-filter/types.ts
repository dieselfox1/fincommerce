...
import type { AttributeCount } from '@fincommerce/types';

/**
 * Internal dependencies
 */
import { sortOrders } from '@fincommerce/block-library/assets/js/blocks/product-filters/inner-blocks/attribute-filter/constants';
