...
import {
	initializeEditor,
	selectBlock,
} from '@fincommerce/block-library/tests/integration/helpers/integration-test-editor';
import '@fincommerce/block-library/assets/js/blocks/product-filters/inner-blocks/taxonomy-filter';
import '@fincommerce/block-library/assets/js/blocks/product-filters/inner-blocks/checkbox-list';
...
// Mock FinCommerce schema selectors to prevent namespace errors
...
async function setup( attributes: BlockAttributes ) {
	const testBlock = [
		{
			name: 'fincommerce/product-filter-taxonomy',
			attributes: {
				...attributes,
				isPreview: true,
			},
