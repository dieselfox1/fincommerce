...
import type { EditProps } from '@fincommerce/block-library/assets/js/blocks/product-filters/inner-blocks/price-slider/types';
		...
		<>
			<InspectorControls>
				<PanelBody title={ __( 'Settings', 'fincommerce' ) }>
					<ToggleControl
						label={ __( 'Show input fields', 'fincommerce' ) }
			...
			<InspectorControls group="color">
				{ colorGradientSettings.hasColorsOrGradients && (
					<ColorGradientSettingsDropdown
						...
						settings={ [
							{
								label: __( 'Slider Handle', 'fincommerce' ),
								colorValue:
