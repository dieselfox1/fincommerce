 ...
 */
import { EditProps } from '@fincommerce/block-library/assets/js/blocks/product-filters/inner-blocks/removable-chips/types';
		...
		<div { ...innerBlocksProps }>
			<BlockControls>
				<ToolbarGroup>
					<ToolbarButton
						icon={ arrowRight }
						label={ __( 'Horizontal', 'fincommerce' ) }
						onClick={ () =>
							setAttributes( {
								layout: {
									...usedLayout,
			...
			<InspectorControls group="color">
				{ colorGradientSettings.hasColorsOrGradients && (
					<ColorGradientSettingsDropdown
						...
						settings={ [
							{
								label: __( 'Chip Text', 'fincommerce' ),
							...
							{
								label: __( 'Chip Border', 'fincommerce' ),
								colorValue:
							...
							{
								label: __( 'Chip Background', 'fincommerce' ),
								colorValue:
