 ...
 */
import { ProductFiltersContext, ProductFiltersStore } from '@fincommerce/block-library/assets/js/blocks/product-filters/frontend';
import { formatPrice, getCurrency } from '@fincommerce/block-library/assets/js/blocks/product-filters/utils/price-currency';
...
>( 'fincommerce/product-filters', productFilterPriceStore );
