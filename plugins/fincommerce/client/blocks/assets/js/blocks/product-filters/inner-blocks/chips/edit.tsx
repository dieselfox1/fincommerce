 ...
 */
import { EditProps } from '@fincommerce/block-library/assets/js/blocks/product-filters/inner-blocks/chips/types';
import '@fincommerce/block-library/assets/js/blocks/product-filters/inner-blocks/chips/editor.scss';
