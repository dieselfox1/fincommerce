 ...
 */
import type { ProductFiltersStore } from '@fincommerce/block-library/assets/js/blocks/product-filters/frontend';
import type {
	ProductFilterPriceContext,
	ProductFilterPriceStore,
} from '@fincommerce/block-library/assets/js/blocks/product-filters/inner-blocks/price-filter/frontend';
...
>( 'fincommerce/product-filters', productFilterPriceSliderStore );
