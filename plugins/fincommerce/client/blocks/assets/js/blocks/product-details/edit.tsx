 ...
 */
import { ProductDetailsEditProps } from '@fincommerce/block-library/assets/js/blocks/product-details/types';
import { getTemplate, isAdditionalProductDataEmpty } from '@fincommerce/block-library/assets/js/blocks/product-details/utils';
import { LegacyProductDetailsPreview } from '@fincommerce/block-library/assets/js/blocks/product-details/legacy-preview';
import '@fincommerce/block-library/assets/js/blocks/product-details/editor.scss';
...
const Edit = ( {
	 ...
	 * Check the PR for more details: https://github.com/dieselfox1/fincommerce/pull/59686
	 */
	useEffect( () => {
		if (
			wasBlockJustInserted &&
