 ...
 */
import '@fincommerce/block-library/assets/js/blocks/active-filters/style.scss';
import { getAttributeFromTaxonomy } from '@fincommerce/block-library/assets/js/utils/attributes';
import {
	formatPriceRange,
	...
	StoreAttributes,
} from '@fincommerce/block-library/assets/js/blocks/active-filters/utils';
import ActiveAttributeFilters from '@fincommerce/block-library/assets/js/blocks/active-filters/active-attribute-filters';
import FilterPlaceholders from '@fincommerce/block-library/assets/js/blocks/active-filters/filter-placeholders';
...
const ActiveFiltersBlock = ( {
	...
	*/
	...
	const activeStockStatusFilters = useMemo( () => {
		...
		const stockStatusLabel = __( 'Stock Status', 'fincommerce' );
	...
	const activeRatingFilters = useMemo( () => {
		...
		const ratingLabel = __( 'Rating', 'fincommerce' );
			...
			<div className="wc-block-active-filters">
				<ul className={ listClasses }>
					{ isEditor ? (
						<>
							{ renderRemovableListItem( {
								type: __( 'Size', 'fincommerce' ),
								name: __( 'Small', 'fincommerce' ),
								displayStyle: blockAttributes.displayStyle,
							} ) }
							{ renderRemovableListItem( {
								type: __( 'Color', 'fincommerce' ),
				...
				{ shouldShowLoadingPlaceholders ? (
					...
					>
						<Label
							label={ __( 'Clear All', 'fincommerce' ) }
