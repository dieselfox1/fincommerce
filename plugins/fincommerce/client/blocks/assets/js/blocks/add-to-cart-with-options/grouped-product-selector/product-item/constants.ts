	...
	[
		...
		[
			[
				...
				[
					[
						'fincommerce/add-to-cart-with-options-grouped-product-item-selector',
					],
					[
						'fincommerce/add-to-cart-with-options-grouped-product-item-label',
						{
							fontSize: 'medium',
							style: {
								layout: {
					...
					[
						...
						[
							...
							[ 'fincommerce/product-stock-indicator' ],
						],
					],
				],
			],
