...
import { SelectedAttributes } from '@fincommerce/stores/fincommerce/cart';
...
import setStyles from '@fincommerce/block-library/assets/js/blocks/add-to-cart-with-options/variation-selector/set-styles';
