 ...
 */
import metadata from '@fincommerce/block-library/assets/js/blocks/product-categories/block.json';
import Edit from '@fincommerce/block-library/assets/js/blocks/product-categories/edit';
import type { ProductCategoriesIndexProps } from '@fincommerce/block-library/assets/js/blocks/product-categories/types';
import '@fincommerce/block-library/assets/js/blocks/product-categories/editor.scss';
import '@fincommerce/block-library/assets/js/blocks/product-categories/style.scss';
		...
		from: [
			{
				...
				isMatch: ( {
					...
					idBase === 'fincommerce_product_categories' &&
					!! instance?.raw,
				transform: ( { instance } ) =>
					createBlock( 'fincommerce/product-categories', {
