...
import blockJson from '@fincommerce/block-library/assets/js/blocks/product-gallery/block.json';
import '@fincommerce/block-library/assets/js/blocks/product-gallery';
import '@fincommerce/block-library/assets/js/blocks/product-gallery/inner-blocks/product-gallery-large-image';
import '@fincommerce/block-library/assets/js/blocks/product-gallery/inner-blocks/product-gallery-thumbnails';
import '@fincommerce/block-library/assets/js/blocks/next-previous-buttons';
...
async function setup( attributes = {} ) {
	const productImageBlock = createBlock( 'fincommerce/product-image', {
	...
	const largeImageBlock = createBlock(
		...
		[
			productImageBlock,
			createBlock( 'fincommerce/product-sale-badge', { align: 'right' } ),
			createBlock(
