...
import type { Store as ProductGallery } from '@fincommerce/block-library/assets/js/blocks/product-gallery/frontend';
	...
	actions: {
		startZoom: ( event: MouseEvent ) => {
			...
			const isMouseEventFromLargeImage = target.classList.contains(
				'wc-block-fincommerce-product-gallery-large-image__image'
			);
