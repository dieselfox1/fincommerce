...
export default function Edit( {
	...
	return (
		...
		>
			{ displayArrow && (
				<span
					className={ `wp-block-fincommerce-product-reviews-pagination-previous-arrow is-arrow-${ paginationArrow }` }
				>
					{ displayArrow }
				</span>
			) }
			<PlainText
				...
				tagName="span"
				aria-label={ __( 'Older reviews page link', 'fincommerce' ) }
				placeholder={ __( 'Older Reviews', 'fincommerce' ) }
				value={ label }
				onChange={ ( newLabel ) =>
