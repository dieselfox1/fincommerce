 ...
 */
import { useCommentQueryArgs, useCommentList } from '@fincommerce/block-library/assets/js/blocks/product-reviews/inner-blocks/review-template/hooks';
...
export default function ReviewTemplateEdit( {
	...
	if ( ! commentTree.length ) {
		return (
			<p { ...blockProps }>
				{ __( 'No results found.', 'fincommerce' ) }
			</p>
		);
	}
