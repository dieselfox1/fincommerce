		...
		<div>
			...
			>
				<div className="comment-form-rating">
					<span>{ __( 'Your rating *', 'fincommerce' ) }</span>
					<p className="wp-block-fincommerce-product-reviews__editor__stars"></p>
				</div>
				<p>
					<label htmlFor={ `review-${ instanceId }` }>
						{ __( 'Your review *', 'fincommerce' ) }
					</label>
					<textarea
