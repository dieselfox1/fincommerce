 ...
 */
import '@fincommerce/block-library/assets/js/blocks/coming-soon/newsletter-panel.scss';
		...
		>
			<div className="coming-soon-newsletter-mailpoet-setting-panel-body">
				...
				<Button variant="link" href={ setupLink }>
					{ __( 'Set up MailPoet', 'fincommerce' ) }
				</Button>
			</div>
		</PluginDocumentSettingPanel>
	);
