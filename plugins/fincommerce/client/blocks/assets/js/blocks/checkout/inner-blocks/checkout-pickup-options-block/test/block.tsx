 ...
 */
import CheckoutPickupOptionsBlock from '@fincommerce/block-library/assets/js/blocks/checkout/inner-blocks/checkout-pickup-options-block/block';
import {
	generateShippingPackage,
	generateShippingRate,
} from '@fincommerce/block-library/assets/js/mocks/shipping-package';
...
jest.mock( '@fincommerce/settings', () => {
	const actualModule = jest.requireActual( '@fincommerce/settings' );
	return {
		...actualModule,
...
( useStoreCart as jest.Mock ).mockImplementation( () =>
	jest.requireActual( '@fincommerce/base-context/hooks' ).useStoreCart()
);
