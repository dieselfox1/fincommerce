...
import { ExperimentalOrderLocalPickupPackages } from '@fincommerce/blocks-checkout';
import { LocalPickupSelect } from '@fincommerce/base-components/cart-checkout/local-pickup-select';
...
const renderPickupLocation = (
	...
	let secondaryLabel = <em>{ __( 'free', 'fincommerce' ) }</em>;
