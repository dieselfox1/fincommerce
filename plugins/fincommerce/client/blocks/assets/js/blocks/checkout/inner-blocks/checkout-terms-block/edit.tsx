 ...
 */
import '@fincommerce/block-library/assets/js/blocks/checkout/inner-blocks/checkout-terms-block/editor.scss';
import { termsConsentDefaultText, termsCheckboxDefaultText } from '@fincommerce/block-library/assets/js/blocks/checkout/inner-blocks/checkout-terms-block/constants';
	...
	return (
		<div { ...blockProps }>
			<InspectorControls>
				...
				<PanelBody title={ __( 'Display options', 'fincommerce' ) }>
					<ToggleControl
						label={ __( 'Require checkbox', 'fincommerce' ) }
						checked={ checkbox }
						onChange={ () =>
							setAttributes( {
								checkbox: ! checkbox,
					...
					/>
					<ToggleControl
						label={ __( 'Show separator', 'fincommerce' ) }
