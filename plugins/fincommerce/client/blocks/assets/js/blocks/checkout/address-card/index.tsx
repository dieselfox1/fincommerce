 ...
 */
import '@fincommerce/block-library/assets/js/blocks/checkout/address-card/style.scss';
...
const AddressCard = ( {
	...
	const label =
		target === 'shipping'
			? __( 'Edit shipping address', 'fincommerce' )
			: __( 'Edit billing address', 'fincommerce' );
