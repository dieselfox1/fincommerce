 ...
 */
import { previewCart as mockPreviewCart } from '@fincommerce/block-library/assets/js/previews/cart';
import {
	textContentMatcher,
	textContentMatcherAcrossSiblings,
} from '@fincommerce/block-library/tests/utils/find-by-text';
const baseContextHooks = jest.requireMock( '@fincommerce/base-context/hooks' );
const fincommerceSettings = jest.requireMock( '@fincommerce/settings' );
import SummaryBlock from '@fincommerce/block-library/assets/js/blocks/checkout/inner-blocks/checkout-order-summary-block/frontend';
import SubtotalBlock from '@fincommerce/block-library/assets/js/blocks/checkout/inner-blocks/checkout-order-summary-subtotal/frontend';
import FeeBlock from '@fincommerce/block-library/assets/js/blocks/checkout/inner-blocks/checkout-order-summary-fee/frontend';
import TaxesBlock from '@fincommerce/block-library/assets/js/blocks/checkout/inner-blocks/checkout-order-summary-taxes/frontend';
import DiscountBlock from '@fincommerce/block-library/assets/js/blocks/checkout/inner-blocks/checkout-order-summary-discount/frontend';
import CouponsBlock from '@fincommerce/block-library/assets/js/blocks/checkout/inner-blocks/checkout-order-summary-coupon-form/frontend';
import ShippingBlock from '@fincommerce/block-library/assets/js/blocks/checkout/inner-blocks/checkout-order-summary-shipping/frontend';
import CartItemsBlock from '@fincommerce/block-library/assets/js/blocks/checkout/inner-blocks/checkout-order-summary-cart-items/frontend';
...
jest.mock( '@fincommerce/settings', () => ( {
	...jest.requireActual( '@fincommerce/settings' ),
	SITE_CURRENCY: {
		code: 'USD',
		symbol: '$',
		thousandSeparator: ',',
...
jest.mock( '@fincommerce/base-context/hooks', () => ( {
	...jest.requireActual( '@fincommerce/base-context/hooks' ),
...
jest.mock( '@fincommerce/base-context', () => ( {
	...jest.requireActual( '@fincommerce/base-context' ),
...
jest.mock( '@fincommerce/settings', () => {
	const originalModule = jest.requireActual( '@fincommerce/settings' );
...
const setGetSettingImplementation = ( implementation ) => {
	fincommerceSettings.getSetting.mockImplementation( implementation );
};
