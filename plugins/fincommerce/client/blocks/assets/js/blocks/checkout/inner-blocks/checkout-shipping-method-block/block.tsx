...
import { defaultLocalPickupText, defaultShippingText } from '@fincommerce/block-library/assets/js/blocks/checkout/inner-blocks/checkout-shipping-method-block/constants';
import { shippingAddressHasValidationErrors } from '@fincommerce/block-library/assets/js/data/cart/utils';

const SHIPPING_RATE_ERROR = {
	hidden: true,
	message: __( 'Shipping options are not available', 'fincommerce' ),
};
