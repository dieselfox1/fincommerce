...
import type { BillingAddress } from '@fincommerce/settings';
import { getSetting } from '@fincommerce/settings';
import { emptyAddressFields } from '@fincommerce/base-utils';
import type { CartResponseBillingAddress } from '@fincommerce/types';

/**
 * Internal dependencies
 */
import CustomerAddress from '@fincommerce/block-library/assets/js/blocks/checkout/inner-blocks/checkout-shipping-address-block/customer-address';
	...
	return (
		<>
			...
			<CheckboxControl
				...
				label={ __( 'Use same address for billing', 'fincommerce' ) }
