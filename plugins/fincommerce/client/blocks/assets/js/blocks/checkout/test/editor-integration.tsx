...
async function setup( attributes: BlockAttributes ) {
	const testBlock = [ { name: 'fincommerce/checkout', attributes } ];
...
describe( 'Checkout block editor integration', () => {
	beforeAll( async () => {
		...
		// add `core/audio` into the fincommerce/checkout-totals-block specifically
		registerCheckoutFilters( 'woo-test-namespace', {
			...
			additionalCartCheckoutInnerBlockTypes: (
				...
				if ( block === 'fincommerce/checkout-totals-block' ) {
