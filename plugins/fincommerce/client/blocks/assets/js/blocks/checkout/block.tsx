...
import { CheckoutProvider, noticeContexts } from '@fincommerce/base-context';
 ...
 */
import '@fincommerce/block-library/assets/js/blocks/checkout/styles/style.scss';
import EmptyCart from '@fincommerce/block-library/assets/js/blocks/checkout/empty-cart';
import CheckoutOrderError from '@fincommerce/block-library/assets/js/blocks/checkout/checkout-order-error';
import { LOGIN_TO_CHECKOUT_URL, isLoginRequired, reloadPage } from '@fincommerce/block-library/assets/js/blocks/checkout/utils';
	...
	return (
		<div className="wc-block-must-login-prompt">
			...
			<a href={ LOGIN_TO_CHECKOUT_URL }>
				{ __( 'Click here to log in.', 'fincommerce' ) }
			</a>
		</div>
	);
};
