...
interface fincommerceBaseLocation {
	type: LocationType;
	sourceData?: object | undefined;
}

interface ProductLocation extends fincommerceBaseLocation {
...
interface ArchiveLocation extends fincommerceBaseLocation {
...
interface CartLocation extends fincommerceBaseLocation {
...
interface OrderLocation extends fincommerceBaseLocation {
...
interface SiteLocation extends fincommerceBaseLocation {
	type: LocationType.Site;
	sourceData?: object | undefined;
}

export type fincommerceBlockLocation =
	| ProductLocation
	| ArchiveLocation
	| CartLocation
	| OrderLocation
 ...
 * {
 *  collection: 'fincommerce/product-collection/featured'
 * }
 *
