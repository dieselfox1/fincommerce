...
import NoReviewsPlaceholder from '@fincommerce/block-library/assets/js/blocks/reviews/reviews-by-category/no-reviews-placeholder';
import {
	getBlockControls,
...
const ReviewsByCategoryEditor = ( {
	...
	const buttonTitle = __( 'Edit selected categories', 'fincommerce' );
	...
	return (
		<>
			...
			<EditorContainerBlock
				...
				name={ __( 'Reviews by Category', 'fincommerce' ) }
