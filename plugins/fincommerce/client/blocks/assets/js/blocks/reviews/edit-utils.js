...
export const getSharedReviewContentControls = ( attributes, setAttributes ) => {
	...
	return (
		<>
			<ToggleControl
				label={ __( 'Product rating', 'fincommerce' ) }
			...
			<ToggleControl
				label={ __( 'Reviewer name', 'fincommerce' ) }
			...
			/>
			<ToggleControl
				label={ __( 'Review date', 'fincommerce' ) }
			...
			/>
			<ToggleControl
				label={ __( 'Review content', 'fincommerce' ) }
			...
			{ attributes.showReviewImage && (
				<>
					<ToggleGroupControl
						label={ __( 'Review image', 'fincommerce' ) }
						isBlock
					...
					>
						<ToggleGroupControlOption
							value="reviewer"
							label={ __( 'Reviewer photo', 'fincommerce' ) }
						/>
						<ToggleGroupControlOption
							value="product"
...
export const getSharedReviewListControls = ( attributes, setAttributes ) => {
	...
	return (
		<>
			...
			/>
			<SelectControl
				label={ __( 'Order Product Reviews by', 'fincommerce' ) }
			...
			/>
			<RangeControl
				label={ __( 'Starting Number of Reviews', 'fincommerce' ) }
			...
			{ attributes.showLoadMore && (
				<RangeControl
					label={ __( 'Load More Reviews', 'fincommerce' ) }
