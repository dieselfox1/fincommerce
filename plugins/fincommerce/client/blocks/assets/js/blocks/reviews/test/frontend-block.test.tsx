 ...
 */
import ReviewsFrontendBlock from '@fincommerce/block-library/assets/js/blocks/reviews/frontend-block';
import { getReviews } from '@fincommerce/block-library/assets/js/blocks/reviews/utils';
