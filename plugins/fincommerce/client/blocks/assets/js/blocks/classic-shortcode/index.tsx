 ...
 */
import '@fincommerce/block-library/assets/js/blocks/classic-shortcode/editor.scss';
import '@fincommerce/block-library/assets/js/blocks/classic-shortcode/style.scss';
import { CartPlaceholder, CheckoutPlaceholder } from '@fincommerce/block-library/assets/js/blocks/classic-shortcode/placeholder';
import { TEMPLATES, TYPES } from '@fincommerce/block-library/assets/js/blocks/classic-shortcode/constants';
import { getTemplateDetailsBySlug } from '@fincommerce/block-library/assets/js/blocks/classic-shortcode/utils';
import * as blockifiedCheckout from '@fincommerce/block-library/assets/js/blocks/classic-shortcode/checkout';
import * as blockifiedCart from '@fincommerce/block-library/assets/js/blocks/classic-shortcode/cart';
import metadata from '@fincommerce/block-library/assets/js/blocks/classic-shortcode/block.json';
import type { BlockifiedTemplateConfig } from '@fincommerce/block-library/assets/js/blocks/classic-shortcode/types';
...
const ConvertTemplate = ( { blockifyConfig, clientId, attributes } ) => {
	...
	return (
		<TabbableContainer className="wp-block-fincommerce-classic-shortcode__placeholder-migration-button-container">
			<Button
				variant="primary"
				onClick={ () => {
					onClickCallback( {
			...
			<Button
				variant="secondary"
				href="https://fincommerce.com/document/fincommerce-store-editing/customizing-cart-and-checkout/"
				target="_blank"
				tabIndex={ 0 }
			>
...
const Edit = ( { clientId, attributes }: BlockEditProps< Attributes > ) => {
	...
	const placeholderTitle = getTitle
		? getTitle()
		: __( 'Classic Shortcode Placeholder', 'fincommerce' );
	...
	const learnMoreContent = createInterpolateElement(
		...
		),
		{
			a: (
				...
				<ExternalLink href="https://fincommerce.com/document/fincommerce-store-editing/customizing-cart-and-checkout/" />
			),
		}
	);
	...
	return (
		<div { ...blockProps }>
			<Placeholder className="wp-block-fincommerce-classic-shortcode__placeholder">
				<div className="wp-block-fincommerce-classic-shortcode__placeholder-wireframe">
				...
				<div className="wp-block-fincommerce-classic-shortcode__placeholder-copy">
					<div className="wp-block-fincommerce-classic-shortcode__placeholder-copy__icon-container">
...
const settings = {
	...
	variations: [
		{
			name: 'checkout',
			title: __( 'Classic Checkout', 'fincommerce' ),
			attributes: {
				shortcode: 'checkout',
			},
		...
		{
			name: 'cart',
			title: __( 'Classic Cart', 'fincommerce' ),
			attributes: {
				shortcode: 'cart',
			},
			isActive: ( blockAttributes, variationAttributes ) =>
