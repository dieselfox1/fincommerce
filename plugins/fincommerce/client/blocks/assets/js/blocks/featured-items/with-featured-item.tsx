...
import { trimCharacters } from '@fincommerce/utils';

/**
 * Internal dependencies
 */
import { CallToAction } from '@fincommerce/block-library/assets/js/blocks/featured-items/call-to-action';
import { ConstrainedResizable } from '@fincommerce/block-library/assets/js/blocks/featured-items/constrained-resizable';
import { EditorBlock, GenericBlockUIConfig } from '@fincommerce/block-library/assets/js/blocks/featured-items/types';
import { BgImageDimensions, useBackgroundImage } from '@fincommerce/block-library/assets/js/blocks/featured-items/use-background-image';
import {
	getBackgroundColorVisibilityStatus,
	dimRatioToClass,
	getBackgroundImageStyles,
	getClassPrefixFromName,
} from '@fincommerce/block-library/assets/js/blocks/featured-items/utils';
								...
								<div
									...
									dangerouslySetInnerHTML={ {
										__html:
											...
											// Returning max 400 character to match the frontend block logic in PHP: see https://github.com/dieselfox1/fincommerce/blob/027bf00f291967608abbbd6408193c970dffdd2a/plugins/fincommerce/src/Blocks/BlockTypes/FeaturedProduct.php#L88
