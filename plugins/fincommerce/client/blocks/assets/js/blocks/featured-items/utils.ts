...
import { Coordinates, ImageFit } from '@fincommerce/block-library/assets/js/blocks/featured-items/types';
import { BgImageDimensions } from '@fincommerce/block-library/assets/js/blocks/featured-items/use-background-image';
