...
import {
	...
	circlePlus,
	plus,
} from '@fincommerce/block-library/assets/js/blocks/accordion/inner-blocks/accordion-item/icons';
			...
			<InspectorControls key="setting">
				<PanelBody title={ __( 'Settings', 'fincommerce' ) }>
					...
					<ToggleGroupControl
						...
						__next40pxDefaultSize
						isBlock
						label={ __( 'Icon Position', 'fincommerce' ) }
						value={ iconPosition }
						onChange={ ( value ) => {
			...
			>
				...
				>
					<RichText
						...
						placeholder={ __( 'Accordion title', 'fincommerce' ) }
					/>
					<span
