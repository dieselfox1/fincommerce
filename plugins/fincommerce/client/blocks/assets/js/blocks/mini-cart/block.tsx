...
import Drawer from '@fincommerce/base-components/drawer';
 ...
 */
import type { BlockAttributes } from '@fincommerce/block-library/assets/js/blocks/mini-cart/types';
import QuantityBadge from '@fincommerce/block-library/assets/js/blocks/mini-cart/quantity-badge';
import { MiniCartContentsBlock } from '@fincommerce/block-library/assets/js/blocks/mini-cart/mini-cart-contents/block';
import '@fincommerce/block-library/assets/js/blocks/mini-cart/style.scss';
import {
	blockName,
	attributes as miniCartContentsAttributes,
} from '@fincommerce/block-library/assets/js/blocks/mini-cart/mini-cart-contents/attributes';
import { metadata as miniCartContentsMetadata } from '@fincommerce/block-library/assets/js/blocks/mini-cart/mini-cart-contents/metadata';
	...
	useEffect( () => {
		if ( contentsNode instanceof Element ) {
			const container = contentsNode.querySelector(
				'.wp-block-fincommerce-mini-cart-contents'
			);
			if ( ! container ) {
				return;
			}
			if ( isOpen ) {
				const renderedBlock = renderParentBlock( {
					...
					selector: '.wp-block-fincommerce-mini-cart-contents',
		...
		<>
			...
			>
				<div
					...
					ref={ contentsRef }
					// This string is sanitized by the backend https://github.com/dieselfox1/fincommerce/blob/ec9274030f2f9d854e23ac332f3303c445c4c4c2/plugins/fincommerce/src/Blocks/BlockTypes/MiniCart.php#L474-L475
