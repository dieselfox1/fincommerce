 ...
 */
import Block from '@fincommerce/block-library/assets/js/blocks/mini-cart/block';
import { defaultCartState } from '@fincommerce/block-library/assets/js/data/cart/default-state';

const MiniCartBlock = ( props ) => (
	<SlotFillProvider>
		<Block
			contents='<div data-block-name="fincommerce/mini-cart-contents" class="wp-block-fincommerce-mini-cart-contents"><div data-block-name="fincommerce/filled-mini-cart-contents-block" class="wp-block-fincommerce-filled-mini-cart-contents-block"><div data-block-name="fincommerce/mini-cart-title-block" class="wp-block-fincommerce-mini-cart-title-block"><div data-block-name="fincommerce/mini-cart-title-label-block" class="wp-block-fincommerce-mini-cart-title-label-block"></div>
			<div data-block-name="fincommerce/mini-cart-title-items-counter-block" class="wp-block-fincommerce-mini-cart-title-items-counter-block"></div></div>
			<div data-block-name="fincommerce/mini-cart-items-block" class="wp-block-fincommerce-mini-cart-items-block"><div data-block-name="fincommerce/mini-cart-products-table-block" class="wp-block-fincommerce-mini-cart-products-table-block"></div></div>
			<div data-block-name="fincommerce/mini-cart-footer-block" class="wp-block-fincommerce-mini-cart-footer-block"><div data-block-name="fincommerce/mini-cart-cart-button-block" class="wp-block-fincommerce-mini-cart-cart-button-block"></div>
			<div data-block-name="fincommerce/mini-cart-checkout-button-block" class="wp-block-fincommerce-mini-cart-checkout-button-block"></div></div></div>
			<div data-block-name="fincommerce/empty-mini-cart-contents-block" class="wp-block-fincommerce-empty-mini-cart-contents-block">
			<p class="has-text-align-center"><strong>Your cart is currently empty!</strong></p>
			<div data-block-name="fincommerce/mini-cart-shopping-button-block" class="wp-block-fincommerce-mini-cart-shopping-button-block"></div></div></div>'
			{ ...props }
		/>
	</SlotFillProvider>
);
