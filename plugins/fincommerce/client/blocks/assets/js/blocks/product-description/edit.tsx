 ...
 */
import { ProductDescriptionEditProps } from '@fincommerce/block-library/assets/js/blocks/product-description/types';
...
function Content( props ) {
	...
	return content?.protected ? (
		<div { ...blockProps }>
			<Warning>
				{ __( 'This content is password protected.', 'fincommerce' ) }
			</Warning>
		</div>
	) : (
		<div
...
export default function ProductDescriptionEdit( {
	...
	const { hasInvalidContext, warningElement } =
		useQueryLoopProductContextValidation( {
			...
			blockName: __( 'Product Description', 'fincommerce' ),
		} );
