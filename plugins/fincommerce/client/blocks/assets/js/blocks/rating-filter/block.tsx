 ...
 */
import { previewOptions } from '@fincommerce/block-library/assets/js/blocks/rating-filter/preview';
import '@fincommerce/block-library/assets/js/blocks/rating-filter/style.scss';
import { Attributes } from '@fincommerce/block-library/assets/js/blocks/rating-filter/types';
import { formatSlug, getActiveFilters } from '@fincommerce/block-library/assets/js/blocks/rating-filter/utils';
import { useSetWrapperVisibility } from '@fincommerce/block-library/assets/js/blocks/filter-wrapper/context';
import type { RatingValues } from '@fincommerce/block-library/assets/js/blocks/product-collection/types';
...
const translations = {
	ratingAdded: ( rating: string ): string =>
		sprintf(
			...
			__( 'Rated %s out of 5 filter added.', 'fincommerce' ),
			rating
		),
				...
				{ blockAttributes.displayStyle === 'dropdown' ? (
					<>
						<FormTokenField
							...
							disabled={ isLoading }
							placeholder={ __( 'Select Rating', 'fincommerce' ) }
