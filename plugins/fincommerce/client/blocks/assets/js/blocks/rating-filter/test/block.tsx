...
import * as hooks from '@fincommerce/base-context/hooks';
import userEvent from '@testing-library/user-event';
import type { WCStoreV1ProductsCollectionProps } from '@fincommerce/types';

/**
 * Internal dependencies
 */
import RatingFilterBlock from '@fincommerce/block-library/assets/js/blocks/rating-filter/block';
