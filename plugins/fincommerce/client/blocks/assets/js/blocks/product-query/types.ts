 ...
 */
import type { AttributeMetadata, EditorBlock } from '@fincommerce/types';
...
export interface ProductQueryArguments {
	...
	__fincommerceAttributes?: AttributeMetadata[];
	/**
	 ...
	 * ```
	 */
	__fincommerceStockStatus?: string[];
}
/* eslint-enable */
...
export enum QueryVariation {
	...
	PRODUCT_QUERY = 'fincommerce/product-query',
	RELATED_PRODUCTS = 'fincommerce/related-products',
}
