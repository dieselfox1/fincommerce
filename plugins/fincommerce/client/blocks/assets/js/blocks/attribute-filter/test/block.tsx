 ...
 */
import AttributeFilterBlock from '@fincommerce/block-library/assets/js/blocks/attribute-filter/block';
import { BlockAttributes } from '@fincommerce/block-library/assets/js/blocks/attribute-filter/types';
