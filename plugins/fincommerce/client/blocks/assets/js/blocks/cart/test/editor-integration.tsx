...
import '@fincommerce/block-library/assets/js/blocks/cart/inner-blocks/cart-order-summary-coupon-form';
...
async function setup( attributes: BlockAttributes ) {
	const testBlock = [ { name: 'fincommerce/cart', attributes } ];
...
describe( 'Cart block editor integration', () => {
	beforeAll( () => {
		...
		// add `core/audio` into the fincommerce/cart-order-summary-block specifically
		registerCheckoutFilters( 'woo-test-namespace', {
			...
			additionalCartCheckoutInnerBlockTypes: (
				...
				if ( block === 'fincommerce/cart-order-summary-block' ) {
