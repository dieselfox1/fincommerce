 ...
 */
import Block from '@fincommerce/block-library/assets/js/blocks/cart/inner-blocks/cart-order-summary-discount/block';
...
jest.mock( '@fincommerce/blocks-checkout', () => {
	const actual = jest.requireActual( '@fincommerce/blocks-checkout' );
	return {
		...actual,
