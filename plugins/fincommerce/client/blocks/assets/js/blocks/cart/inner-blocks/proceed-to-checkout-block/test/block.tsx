...
import { CartEventsProvider } from '@fincommerce/block-library/assets/js/base/context/providers';
...
describe( 'Proceed to checkout block', () => {
	...
	it( 'allows the link to be filtered', () => {
		...
		expect( link?.href ).toBe( 'https://fincommerce.com/' );
	} );
