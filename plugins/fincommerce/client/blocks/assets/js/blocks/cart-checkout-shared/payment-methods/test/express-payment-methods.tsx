 ...
 */
import mockEditorContext from '@fincommerce/block-library/assets/js/blocks/cart-checkout-shared/payment-methods/test/__mocks__/editor-context';
import { getExpectedExpressPaymentProps } from '@fincommerce/block-library/assets/js/blocks/cart-checkout-shared/payment-methods/test/__mocks__/express-payment-props';
		...
		describe( 'In a frontend context', () => {
			...
			it( 'should pass the correct properties to the rendered element', () => {
				...
				expect( console ).toHaveWarnedWith(
					'isPristine is deprecated since version 9.6.0. Please use isIdle instead. See: https://github.com/dieselfox1/fincommerce-blocks/pull/8110'
				);
			} );
		} );
