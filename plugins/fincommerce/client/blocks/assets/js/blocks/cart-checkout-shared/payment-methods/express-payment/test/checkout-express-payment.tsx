 ...
 */
import CheckoutExpressPayment from '@fincommerce/block-library/assets/js/blocks/cart-checkout-shared/payment-methods/express-payment/checkout-express-payment';
...
jest.mock( '@fincommerce/base-components/skeleton', () => ( {
