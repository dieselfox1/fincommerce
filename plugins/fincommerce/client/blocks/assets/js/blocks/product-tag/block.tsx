...
const ProductsByTagBlock = ( {
	...
	const getInspectorControls = () => {
		...
		return (
			<InspectorControls key="inspector">
				<PanelBody
					title={ __( 'Product Tag', 'fincommerce' ) }
	...
	const renderEditMode = () => {
		...
		const onDone = () => {
			save();
			debouncedSpeak(
				__( 'Showing Products by Tag block preview.', 'fincommerce' )
			);
		};
		const onCancel = () => {
			stopEditing();
		...
		return (
			<Placeholder
				...
				label={ __( 'Products by Tag', 'fincommerce' ) }
			...
			<BlockControls>
				<ToolbarGroup
					controls={ [
						{
							icon: 'edit',
							title: __( 'Edit selected tags', 'fincommerce' ),
							onClick: () =>
