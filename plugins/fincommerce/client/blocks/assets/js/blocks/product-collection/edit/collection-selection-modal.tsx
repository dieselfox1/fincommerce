 ...
 */
import CollectionChooser, { applyCollection } from '@fincommerce/block-library/assets/js/blocks/product-collection/edit/collection-chooser';
import type { ProductCollectionAttributes } from '@fincommerce/block-library/assets/js/blocks/product-collection/types';
...
const PatternSelectionModal = ( props: {
	...
	return (
		<Modal
			...
			title={ __( 'What products do you want to show?', 'fincommerce' ) }
