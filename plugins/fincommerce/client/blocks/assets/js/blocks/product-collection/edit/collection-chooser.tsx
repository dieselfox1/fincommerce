 ...
 */
import { type CollectionName, CoreCollectionNames } from '@fincommerce/block-library/assets/js/blocks/product-collection/types';
...
import { getDefaultProductCollection } from '@fincommerce/block-library/assets/js/blocks/product-collection/utils';
...
const CreateCollectionButton = ( props: CollectionButtonProps ) => {
	...
	return (
		<div className="wc-blocks-product-collection__collections-create">
			<span>{ __( 'or', 'fincommerce' ) }</span>
			<Tooltip text={ description } placement="top">
				<Button onClick={ onClick }>
					{ __( 'create your own', 'fincommerce' ) }
				</Button>
			</Tooltip>
		</div>
	);
