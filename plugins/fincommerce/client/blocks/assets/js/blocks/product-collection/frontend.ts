...
} from '@fincommerce/block-library/assets/js/blocks/product-collection/legacy-events';
import { CoreCollectionNames } from '@fincommerce/block-library/assets/js/blocks/product-collection/types';
import '@fincommerce/block-library/assets/js/blocks/product-collection/style.scss';
...
const scrollCarousel = ( direction: 'left' | 'right' ) => {
	...
	const productCollection = ref?.closest(
		'.wp-block-fincommerce-product-collection'
	);
...
store( 'fincommerce/product-collection', productCollectionStore, {
	lock: true,
} );
