...
import type { AttributeMetadata } from '@fincommerce/types';

/**
 * Internal dependencies
 */
import { fincommerceBlockLocation } from '@fincommerce/block-library/assets/js/blocks/product-template/utils';
...
export interface ProductCollectionQuery {
	 ...
	 * ```
	 */
	fincommerceStockStatus: string[];
	fincommerceAttributes: AttributeMetadata[];
	isProductCollectionBlock: boolean;
	fincommerceHandPickedProducts: string[];
...
export type ProductCollectionContentProps =
	ProductCollectionEditComponentProps & {
		location: fincommerceBlockLocation;
...
export enum CoreCollectionNames {
	PRODUCT_CATALOG = 'fincommerce/product-collection/product-catalog',
	BEST_SELLERS = 'fincommerce/product-collection/best-sellers',
	FEATURED = 'fincommerce/product-collection/featured',
	NEW_ARRIVALS = 'fincommerce/product-collection/new-arrivals',
	ON_SALE = 'fincommerce/product-collection/on-sale',
	TOP_RATED = 'fincommerce/product-collection/top-rated',
	HAND_PICKED = 'fincommerce/product-collection/hand-picked',
	RELATED = 'fincommerce/product-collection/related',
	UPSELLS = 'fincommerce/product-collection/upsells',
	CROSS_SELLS = 'fincommerce/product-collection/cross-sells',
	BY_CATEGORY = 'fincommerce/product-collection/by-category',
	BY_TAG = 'fincommerce/product-collection/by-tag',
}
