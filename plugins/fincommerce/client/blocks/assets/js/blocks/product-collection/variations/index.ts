 ...
 */
import { CORE_NAME as PRODUCT_TITLE_ID } from '@fincommerce/block-library/assets/js/blocks/product-collection/variations/elements/product-title';
import { CORE_NAME as PRODUCT_SUMMARY_ID } from '@fincommerce/block-library/assets/js/blocks/product-collection/variations/elements/product-summary';
