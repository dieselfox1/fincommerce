...
import { filterActiveSavedPaymentMethods } from '@fincommerce/block-library/assets/js/data/payment/utils/filter-active-saved-payment-methods';
import { STATUS as PAYMENT_STATUS } from '@fincommerce/block-library/assets/js/data/payment/constants';
...
export const getCurrentStatus = ( state: PaymentState ) => {
	deprecated( 'getCurrentStatus', {
		...
		plugin: 'FinCommerce Blocks',
		link: 'https://github.com/dieselfox1/fincommerce-blocks/pull/7666',
	} );
