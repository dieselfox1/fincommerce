...
import { PaymentResult } from '@fincommerce/types';

/**
 * Internal dependencies
 */
import { defaultPaymentState, PaymentState } from '@fincommerce/block-library/assets/js/data/payment/default-state';
import { ACTION_TYPES } from '@fincommerce/block-library/assets/js/data/payment/action-types';
import { STATUS } from '@fincommerce/block-library/assets/js/data/payment/constants';
