 ...
 */
import receiveCollection from '@fincommerce/block-library/assets/js/data/collections/reducers';
import { ACTION_TYPES as types } from '@fincommerce/block-library/assets/js/data/collections/action-types';
