 ...
 */
import type { ValidationStoreDescriptor } from '@fincommerce/block-library/assets/js/data/validation';
import { STORE_KEY as VALIDATION_STORE_KEY } from '@fincommerce/block-library/assets/js/data/validation/constants';
