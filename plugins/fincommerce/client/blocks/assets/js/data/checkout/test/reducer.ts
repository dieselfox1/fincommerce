...
import { defaultState } from '@fincommerce/block-library/assets/js/data/checkout/default-state';
import { STATUS } from '@fincommerce/block-library/assets/js/data/checkout/constants';
...
describe( 'Checkout Store Reducer', () => {
	...
	it( 'should handle INCREMENT_CALCULATING using deprecated action', () => {
		...
		expect( console ).toHaveWarnedWith(
			'__internalIncrementCalculating is deprecated and will be removed from FinCommerce in version 9.9.0. Please use disableCheckoutFor instead.'
		);
	} );
	...
	it( 'should handle DECREMENT_CALCULATING using deprecated action', () => {
		...
		expect( console ).toHaveWarnedWith(
			'__internalDecrementCalculating is deprecated and will be removed from FinCommerce in version 9.9.0. Please use disableCheckoutFor instead.'
		);
	} );
	...
	describe( 'should handle SET_EXTENSION_DATA', () => {
		...
		it( 'should work with deprecated __internalSetExtensionData and show deprecation warning', () => {
			...
			expect( console ).toHaveWarnedWith(
				'__internalSetExtensionData is deprecated and will be removed from FinCommerce in version 9.9.0. Please use setExtensionData instead.'
			);
		} );
	} );
} );
