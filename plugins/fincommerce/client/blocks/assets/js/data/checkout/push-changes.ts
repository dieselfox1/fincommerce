 ...
 */
import { STORE_KEY as CHECKOUT_STORE_KEY } from '@fincommerce/block-library/assets/js/data/checkout/constants';
import { STORE_KEY as PAYMENT_STORE_KEY } from '@fincommerce/block-library/assets/js/data/payment/constants';
import { processErrorResponse } from '@fincommerce/block-library/assets/js/data/utils';
import { CheckoutPutData } from '@fincommerce/block-library/assets/js/data/checkout/types';
import {
...
const initialize = () => {
	...
	localState.hasSession = document.cookie.includes( 'fincommerce_cart_hash' );
