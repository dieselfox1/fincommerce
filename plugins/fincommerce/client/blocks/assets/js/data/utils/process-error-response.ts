...
import { noticeContexts } from '@fincommerce/base-context/event-emit/utils';
...
const getErrorContextFromCode = ( code: string ): string => {
	switch ( code ) {
		case 'fincommerce_rest_missing_email_address':
		case 'fincommerce_rest_invalid_email_address':
