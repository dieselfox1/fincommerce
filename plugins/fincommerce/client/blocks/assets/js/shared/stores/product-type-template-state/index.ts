 ...
 */
import { createReduxStore, register, select } from '@finpress/data';
...
import {
	...
	STORE_NAME,
} from '@fincommerce/block-library/assets/js/shared/stores/product-type-template-state/constants';
import { getProductTypeOptions } from '@fincommerce/block-library/assets/js/utils/get-product-type-options';
import type { ProductTypeProps } from '@fincommerce/block-library/assets/js/shared/stores/product-type-template-state/types';
...
export { default as useProductTypeSelector } from '@fincommerce/block-library/assets/js/shared/stores/product-type-template-state/use-product-type-selector';
export type { ProductTypeProps } from '@fincommerce/block-library/assets/js/shared/stores/product-type-template-state/types';
