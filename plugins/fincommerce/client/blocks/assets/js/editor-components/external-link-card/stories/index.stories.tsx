 ...
 */
import ExternalLinkCard, { ExternalLinkCardProps } from '@fincommerce/block-library/assets/js/editor-components/external-link-card';
...
Default.args = {
	...
	href: 'https://fincommerce.com/posts/seven-tips-to-extend-holiday-sales-momentum/',
