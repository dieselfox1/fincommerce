 ...
 */
import '@fincommerce/block-library/assets/js/editor-components/feedback-prompt/style.scss';
			...
			{ isVisible && (
				<div className="wc-block-feedback-prompt">
					...
					<a
						...
						target="_blank"
					>
						{ __( 'Give us your feedback.', 'fincommerce' ) }
...
export const CartCheckoutFeedbackPrompt = () => (
	<FeedbackPrompt
		...
		url="https://github.com/dieselfox1/fincommerce/discussions/new?category=checkout-flow&labels=type%3A+product%20feedback"
	/>
);
