 ...
 */
import { getFilteredList, defaultMessages } from '@fincommerce/block-library/assets/js/editor-components/search-list-control/utils';
import SearchListItem from '@fincommerce/block-library/assets/js/editor-components/search-list-control/item';
import Tag from '@fincommerce/block-library/assets/js/editor-components/tag';
import type {
...
} from '@fincommerce/block-library/assets/js/editor-components/search-list-control/types';
import '@fincommerce/block-library/assets/js/editor-components/search-list-control/style.scss';
...
const SelectedListItems = < T extends object = object >( {
	...
	return (
		<div className="fincommerce-search-list__selected">
			<div className="fincommerce-search-list__selected-header">
...
const ListItemsContainer = < T extends object = object >( {
	...
	if ( filteredList.length === 0 ) {
		return (
			<div className="fincommerce-search-list__list is-not-found">
				<span className="fincommerce-search-list__not-found-icon">
	...
	return (
		<ul className="fincommerce-search-list__list">
			<ListItems
...
export const SearchListControl = < T extends object = object >(
	...
	return (
		<div
			className={ clsx( 'fincommerce-search-list', className, {
		...
		>
			...
			<div className="fincommerce-search-list__search">
				{ type === 'text' ? (
					<TextControl
			...
			{ isLoading ? (
				<div className="fincommerce-search-list__list">
					<Spinner />
				</div>
			) : (
				<ListItemsContainer
