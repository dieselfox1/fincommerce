 ...
 */
import { SearchListControl } from '@fincommerce/block-library/assets/js/editor-components/search-list-control';

const noop = () => {};

const SELECTORS = {
	listItems: '.fincommerce-search-list__list > li',
...
describe( 'SearchListControl', () => {
	...
	// @see https://github.com/dieselfox1/fincommerce-blocks/issues/6524
