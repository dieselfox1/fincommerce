 ...
 */
import FeedbackIcon from '@fincommerce/block-library/assets/js/editor-components/ces-feedback-button/feedback-icon';
...
export const CesFeedbackButton = ( {
	...
	emailLabel = __( 'Email address (Optional)', 'fincommerce' ),
	emailHelp = __(
		'Share if you would like to discuss your experience or participate in future research.',
		'fincommerce'
	),
	buttonText = __( 'Help us improve', 'fincommerce' ),
	submitLabel = __( "🙏🏻 Thanks for sharing — we're on it!", 'fincommerce' ),
	wrapper: Wrapper,
	wrapperProps = {},
