 ...
 */
import * as helpers from '@fincommerce/block-library/assets/js/blocks-registry/payment-methods/payment-method-config-helper';
	...
	beforeAll( () => {
		...
		registerPaymentMethodExtensionCallbacks(
			'fincommerce-marketplace-extension',
			{
				...
				// 'other-fincommerce-marketplace-extension'.
