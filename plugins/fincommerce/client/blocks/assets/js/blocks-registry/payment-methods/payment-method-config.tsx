 ...
 */
import { getCanMakePayment } from '@fincommerce/block-library/assets/js/blocks-registry/payment-methods/payment-method-config-helper';
import {
	assertConfigHasProperties,
	assertValidElement,
	assertValidElementOrString,
} from '@fincommerce/block-library/assets/js/blocks-registry/payment-methods/assertions';
		...
		if ( typeof config.supports?.savePaymentInfo !== 'undefined' ) {
			deprecated(
				'Passing savePaymentInfo when registering a payment method.',
				{
					...
					link: 'https://github.com/dieselfox1/fincommerce-gutenberg-products-block/pull/3686',
				}
			);
		}
		if (
