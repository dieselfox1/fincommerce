 ...
 */
import { default as PaymentMethodConfig } from '@fincommerce/block-library/assets/js/blocks-registry/payment-methods/payment-method-config';
import { default as ExpressPaymentMethodConfig } from '@fincommerce/block-library/assets/js/blocks-registry/payment-methods/express-payment-method-config';
import { canMakePaymentExtensionsCallbacks } from '@fincommerce/block-library/assets/js/blocks-registry/payment-methods/extensions-config';
import { STORE_KEY as PAYMENT_STORE_KEY } from '@fincommerce/block-library/assets/js/data/payment/constants';
import type { PaymentStoreDescriptor } from '@fincommerce/block-library/assets/js/data/payment';
...
export const registerPaymentMethod = (
	...
	if ( typeof options === 'function' ) {
		...
		deprecated( 'Passing a callback to registerPaymentMethod()', {
			...
			link: 'https://github.com/dieselfox1/fincommerce-gutenberg-products-block/pull/3404',
		} );
	} else {
