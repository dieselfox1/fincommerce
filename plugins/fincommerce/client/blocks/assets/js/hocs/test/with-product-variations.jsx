...
import * as mockUtils from '@fincommerce/editor-components/utils';

/**
 * Internal dependencies
 */
import withProductVariations from '@fincommerce/block-library/assets/js/hocs/with-product-variations';
import * as mockBaseUtils from '@fincommerce/block-library/assets/js/base/utils/errors';

jest.mock( '@fincommerce/editor-components/utils', () => ( {
