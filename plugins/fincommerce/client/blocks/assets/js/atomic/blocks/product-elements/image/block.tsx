 ...
 */
import ProductSaleBadge from '@fincommerce/block-library/assets/js/atomic/blocks/product-elements/sale-badge/block';
import '@fincommerce/block-library/assets/js/atomic/blocks/product-elements/image/style.scss';
import { BlockAttributes, ImageSizing, ProductImageContext } from '@fincommerce/block-library/assets/js/atomic/blocks/product-elements/image/types';
...
export const Block = ( props: Props ): JSX.Element | null => {
	...
	const anchorLabel = product?.name
		? // translators: %s is the product name.
		  sprintf( __( 'Link to %s', 'fincommerce' ), product.name )
		: '';
	const anchorProps = {
