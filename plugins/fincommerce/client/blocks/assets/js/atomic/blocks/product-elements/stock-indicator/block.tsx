...
import '@fincommerce/block-library/assets/js/atomic/blocks/product-elements/stock-indicator/style.scss';
		...
		<div
			className={ clsx( className, {
				...
				...( props.isDescendantOfAllProducts && {
					...
					'wc-block-components-product-stock-indicator wp-block-fincommerce-product-stock-indicator':
						true,
				} ),
			} ) }
			// When inside All products block
