...
import { RegisteredBlockComponent } from '@fincommerce/types';
 ...
 * 		<div data-block-name="fincommerce/product-title"></div>
 *
...
const renderInnerBlocks = ( {
	...
	return Array.from( children ).map( ( node: Node, index: number ) => {
		...
		const isCheckoutBlockChild = block === 'fincommerce/checkout';
		const isCartBlockChild = block === 'fincommerce/cart';
