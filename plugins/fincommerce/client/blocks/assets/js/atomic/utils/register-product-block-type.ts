...
/**
 * Manages block registration and unregistration for FinCommerce product blocks in different contexts.
...
/**
 * Registers a block type specifically for FinCommerce product templates and optionally makes it available
