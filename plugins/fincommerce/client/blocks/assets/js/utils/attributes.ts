...
export const updateAttributeInSiblingBlock = (
	...
	// Loop through parent block's children until we find fincommerce/checkout-shipping-methods-block.
	// Also set this attribute in the fincommerce/checkout-shipping-methods-block.
