 ...
 */
const { getEntryConfig, genericBlocks } = require( '@fincommerce/block-library/bin/webpack-entries' );
const {
	ASSET_CHECK,
	NODE_ENV,
	CHECK_CIRCULAR_DEPS,
	...
	getCacheGroups,
} = require( '@fincommerce/block-library/bin/webpack-helpers' );
const AddSplitChunkDependencies = require( '@fincommerce/block-library/bin/add-split-chunk-dependencies' );
...
const getMainConfig = ( options = {} ) => {
	...
	return {
		...
		plugins: [
			 ...
			 * https://github.com/dieselfox1/fincommerce/blob/7d72fb937907bf841aabe959642be524eb093803/plugins/fincommerce/client/blocks/bin/copy-blocks-json.sh
			 */
