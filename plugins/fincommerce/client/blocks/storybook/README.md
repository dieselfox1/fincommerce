...
export default {
	title: 'FinCommerce Blocks/${MyCategory}/${MyComponent}',
...
We expose the `INTERACTION_TIMEOUT` constant from `@fincommerce/storybook-controls'` as a simple way to set our timeouts across our stories.
