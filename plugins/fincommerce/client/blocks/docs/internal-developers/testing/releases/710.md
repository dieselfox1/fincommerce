...
Zip file for testing: [fincommerce-gutenberg-products-block.zip](https://github.com/dieselfox1/fincommerce-gutenberg-products-block/files/8153605/fincommerce-gutenberg-products-block.zip)
...
1. Be sure that you are on `finpress 5.9`.
...
5. Confirm that the FinCommerce block template names appear on the list according to the following table:
