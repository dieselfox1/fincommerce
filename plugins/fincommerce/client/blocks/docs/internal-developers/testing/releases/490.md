...
Zip file for testing: [fincommerce-gutenberg-products-block.zip](https://github.com/dieselfox1/fincommerce-gutenberg-products-block/files/6295807/fincommerce-gutenberg-products-block.zip)
...
-   Install the [Google Analytics Integration Extension](https://github.com/dieselfox1/fincommerce-google-analytics-integration)
...
-   Go to the store and trigger some events using the All Products Block and Cart block (feature plugin only). See list of events in <https://github.com/dieselfox1/fincommerce-gutenberg-products-block/pull/3953>.
...
-   In FinCommerce > Settings check the option to Enable tax rates and calculations.
