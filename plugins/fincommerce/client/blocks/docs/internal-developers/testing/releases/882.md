...
Zip file for testing: [fincommerce-gutenberg-products-block.zip](https://github.com/dieselfox1/fincommerce-blocks/files/9902085/fincommerce-gutenberg-products-block.zip)
...
1. Enable TT3 theme.
2. Go to Appearance > Site Editor and replace the header with `FinCommerce Essential Header | Light` pattern.
