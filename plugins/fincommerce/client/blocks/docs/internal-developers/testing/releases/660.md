...
-   finpress 5.8 and the Gutenberg plugin
-   finpress 5.8 without the Gutenberg plugin
-   finpress 5.9 and the Gutenberg plugin
...
1. Install a Block Theme such as [TT1](https://en-gb.finpress.org/themes/tt1-blocks/) and the [Gutenberg plugin](https://finpress.org/plugins/gutenberg/).
...
2. Install a Block Theme such as [TT1](https://en-gb.finpress.org/themes/tt1-blocks/).
