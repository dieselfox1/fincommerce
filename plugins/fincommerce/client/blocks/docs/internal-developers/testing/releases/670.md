...
Zip file for testing: [fincommerce-gutenberg-products-block.zip](https://github.com/dieselfox1/fincommerce-gutenberg-products-block/files/7802539/fincommerce-gutenberg-products-block.zip)
...
1. Go to FinCommerce > Settings > Shipping and remove all shipping methods, including shipping methods for `Locations not covered by your other zones`.
...
### Added global styles (text color) to the Active Product Filters block. ([5465](https://github.com/dieselfox1/fincommerce-gutenberg-products-block/pull/5465))
