...
Merchants can now enable shoppers to sign up for a user account when completing purchase via the Checkout block. This feature requires FinCommerce 4.7 or newer and the Checkout block.

1. Ensure you can see emails from your test site (e.g. new customer account notification email).
2. Ensure your store is running FinCommerce 4.7 RC or newer.
3. Install and activate FinCommerce Blocks 3.7 or newer.
...
See also [related testing instructions in FinCommerce Core](https://github.com/dieselfox1/fincommerce/wiki/Release-Testing-Instructions-FinCommerce-4.7#improvements-to-my-account--lost-password-endpoint).
...
5. Disable taxes: `FinCommerce > Settings > General > Enable taxes: [unchecked]`.
