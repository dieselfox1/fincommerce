...
Zip file for testing: [fincommerce-gutenberg-products-block.zip](https://github.com/dieselfox1/fincommerce-blocks/files/11801343/fincommerce-gutenberg-products-block.zip)
...
2. Create a new post: To do this, navigate to Posts > Add New from the finpress dashboard.
...
| Before | After |
| ------ | ----- |
| ![image](https://github.com/dieselfox1/fincommerce-blocks/assets/20469356/7444c66f-8c86-4444-a1ee-419b38eeba25)  |  ![image](https://github.com/dieselfox1/fincommerce-blocks/assets/20469356/da76db67-6d7d-460d-8737-be1a6201b06d)  |
...
1. Create a new post: To do this, navigate to Posts > Add New from the finpress dashboard.
...
![Screenshot 2023-06-13 at 14 18 51](https://github.com/dieselfox1/fincommerce-blocks/assets/90977/69156833-3cba-461d-bec6-a4d07fc6bf50)
...
2. Open the block inserter and search for the `FinCommerce Product Filters` pattern.
...
| Before | After |
| ------ | ----- |
|![image](https://github.com/dieselfox1/fincommerce-blocks/assets/4463174/ffa10e39-a8b0-4468-bd6b-30db08cb48a4)|![image](https://github.com/dieselfox1/fincommerce-blocks/assets/4463174/5a435970-b94d-477e-986d-478620c60b91)|
...
| Before | After |
| ------ | ----- |
|<img width="898" alt="before icon" src="https://github.com/dieselfox1/fincommerce-blocks/assets/905781/f8c0bc43-fefc-4771-89f2-b5a9122f25fc">|<img width="827" alt="after icon" src="https://github.com/dieselfox1/fincommerce-blocks/assets/905781/520c3f1f-9247-4484-a43b-02c458147c57">|
...
| Before | After |
| ------ | ----- |
| <img width="279" alt="Edit_Page_“Mini_cart”_‹_kirigami_—_finpress-2" src="https://github.com/dieselfox1/fincommerce-blocks/assets/905781/35f49092-13c1-4d8c-b411-8e5af8fdff4a">|<img width="280" alt="Edit_Page_“Mini_cart”_‹_kirigami_—_finpress" src="https://github.com/dieselfox1/fincommerce-blocks/assets/905781/15a48120-b16d-4db0-be69-d0f65e2f0ff8">|
...
Before | After
--- | ---
![imatge](https://github.com/dieselfox1/fincommerce-blocks/assets/3616980/084b8dee-aff3-435a-aaec-b231609afe6e) | ![imatge](https://github.com/dieselfox1/fincommerce-blocks/assets/3616980/1db799a4-cd27-4c06-9acf-b18ffa96bad1)
...
![file.png](https://github.com/dieselfox1/fincommerce-blocks/assets/2132595/fc7e0a01-ad54-4c81-8071-e77af8bb4e66)
...
![file.png](https://github.com/dieselfox1/fincommerce-blocks/assets/2132595/30fd5c40-b035-4765-ad3b-00e8f1837785)
...
1. Make sure your store has no reviews.
2. Create a new post: Navigate to Posts > Add New from the finpress dashboard.
...
### Mini Cart Block: show the total price, including tax, according to the option. ([9878](https://github.com/dieselfox1/fincommerce-blocks/pull/9878))

1. Open the FinCommerce Settings via FinCommerce > Settings from the sidebar menu of the WP-Admin.
...
7. Now set up a Shipping method going to FinCommerce > Settings > Shipping > Add shipping zone. Create the zone and add a shipping method with a price different from 0.
...
14. Open the FinCommerce Settings.
