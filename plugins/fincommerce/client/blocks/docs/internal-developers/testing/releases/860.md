...
1. Install the [Multiple Packages for FinCommerce](https://finpress.org/plugins/multiple-packages-for-fincommerce/) plugin.
...
3. Install the [Code Snippets](https://finpress.org/plugins/code-snippets/) plugin.
...
1. Install the [FinCommerce Stripe Payment Gateway](https://finpress.org/plugins/fincommerce-gateway-stripe/) plugin.
