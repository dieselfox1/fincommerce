...
Zip file for testing: [fincommerce-gutenberg-products-block.zip](https://github.com/dieselfox1/fincommerce-blocks/files/13549019/fincommerce-gutenberg-products-block.zip)
...
| Before                                                                                                                                                                | After                                                                                                                                                                 |
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| <img width="1407" alt="Screenshot 2023-11-29 at 11 23 27" src="https://github.com/dieselfox1/fincommerce-blocks/assets/186112/a2408bf2-bf20-4c03-8388-8e51fbfc9fab"> | <img width="1407" alt="Screenshot 2023-11-29 at 11 23 21" src="https://github.com/dieselfox1/fincommerce-blocks/assets/186112/50d4eb2e-a09e-463b-856d-b6ce5e7c4619"> |
...
2. Check the copy is the same expected in the designs (see screenshots here: [#11875](https://github.com/dieselfox1/fincommerce-blocks/issues/11875)).

### Update patterns design [#12005](https://github.com/dieselfox1/fincommerce-blocks/pull/12005)
...
<img width="750" alt="Screenshot 2023-12-04 at 14 53 27" src="https://github.com/dieselfox1/fincommerce-blocks/assets/186112/f919bb4a-850b-483d-be35-8ea12e161de9">
...
2. Install [Code Snippets](https://finpress.org/plugins/code-snippets/), that will allow us to insert some PHP code into our store.
3. Go to Snippets > Add New. Set the code snippet title to `Product summary` and add this PHP code:

```PHP
add_action('fincommerce_single_product_summary', function() {
	echo 'fincommerce_single_product_summary';
});
```

4. In the frontend, go to a Single product page and ensure that the string `fincommerce_single_product_summary` is visible before the Product Summary.

| Before                                                                                                          | After                                                                                                           |
|-----------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------|
| ![image](https://github.com/dieselfox1/fincommerce-blocks/assets/4463174/8489872a-7f4b-4bcd-8345-144672a793e3) | ![image](https://github.com/dieselfox1/fincommerce-blocks/assets/4463174/328adbb7-19af-4b96-ab1e-395e40414738) |

### Remove isExperimental flag from product-query module which is not experimental [#10531](https://github.com/dieselfox1/fincommerce-blocks/pull/10531)
...
![image](https://github.com/dieselfox1/fincommerce-blocks/assets/16707866/ae7c96e0-99fa-495b-8b83-1d0d0fbf3fde)
...
![image](https://github.com/dieselfox1/fincommerce-blocks/assets/16707866/66637971-647b-4fa7-a591-a211052fb61e)
...
### Migration of Product Collection and Product Button blocks to the new `store()` API [#11558](https://github.com/dieselfox1/fincommerce-blocks/pull/11558)
...
![Screen Shot 2023-11-22 at 17 03 21 PM](https://github.com/dieselfox1/fincommerce-blocks/assets/20098064/ea3a20da-f4c5-49cc-acff-de600139ca28)
...
| Before                                                                                                                                     | After                                                                                                                                      |
|--------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------|
| <img width="286" alt="image" src="https://github.com/dieselfox1/fincommerce-blocks/assets/20098064/decb0d07-f6d6-4881-aa21-602d120c3865"> | <img width="288" alt="image" src="https://github.com/dieselfox1/fincommerce-blocks/assets/20098064/f3a166f5-4c1b-42d2-b2c4-4627f759c7aa"> |
...
| Before                                                                                                                                     | After                                                                                                                                      |
|--------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------|
| <img width="289" alt="image" src="https://github.com/dieselfox1/fincommerce-blocks/assets/20098064/80c33902-f2da-4474-8658-50fc39dd43fd"> | <img width="285" alt="image" src="https://github.com/dieselfox1/fincommerce-blocks/assets/20098064/06608aa3-a85d-43ec-b662-4ce6da634905"> |
...
<img src="https://github.com/dieselfox1/fincommerce-blocks/assets/3616980/099d4c8a-c2bb-4615-9006-c3283924f768" alt="" width="646" />
...
<img src="https://github.com/dieselfox1/fincommerce-blocks/assets/3616980/afc4aeaa-6fea-4fac-ad54-2e03f8e02e1a" alt="" width="321" />
...
1. Install [FinCommerce Stripe Payment Gateway](https://finpress.org/plugins/fincommerce-gateway-stripe/) and set it up
...
### Import CheckboxControl from a single place [#12015](https://github.com/dieselfox1/fincommerce-blocks/pull/12015)
...
<br><br>
<img width="292" alt="Screenshot 2023-11-21 at 18 17 37" src="https://github.com/dieselfox1/fincommerce-blocks/assets/3323310/22e60e36-9818-4a0a-8393-5b5cd53f25d0">
</td>
<td valign="top">After:
<br><br>
<img width="293" alt="Screenshot 2023-11-21 at 17 57 27" src="https://github.com/dieselfox1/fincommerce-blocks/assets/3323310/e5ca3c95-f17a-47a0-b6e9-23395cc14144">
</td>
</tr>
</table>
...
<td valign="top">Before:
<br><br>
<img width="293" alt="Screenshot 2023-11-21 at 18 11 48" src="https://github.com/dieselfox1/fincommerce-blocks/assets/3323310/161a9bb4-626d-49d5-bf93-bc03a2d1d8dc">
</td>
<td valign="top">After:
<br><br>
<img width="295" alt="Screenshot 2023-11-21 at 18 08 52" src="https://github.com/dieselfox1/fincommerce-blocks/assets/3323310/cea552a4-4fd0-427a-8517-0e3eff105f9d">
</td>
</tr>
</table>
...
| Before                                                                                                                                      | After                                                                                                                                       |
|---------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------|
| ![Screenshot 2023-11-24 at 09 15 27](https://github.com/dieselfox1/fincommerce-blocks/assets/4479106/cddb89e8-36a2-4326-8953-88851f39973b) | ![Screenshot 2023-11-24 at 10 25 10](https://github.com/dieselfox1/fincommerce-blocks/assets/4479106/ff9c2ee9-67d2-4cd1-8498-19793c148b72) |
...
| Before                                                                                                                                    | After                                                                                                                                     |
|-------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------|
| ![Screenshot 2023-11-23 at 12 21 56](https://github.com/dieselfox1/fincommerce-blocks/assets/90977/3d68acba-08e3-4207-b29a-2debc38f5e5f) | ![Screenshot 2023-11-23 at 12 21 15](https://github.com/dieselfox1/fincommerce-blocks/assets/90977/3cb98e30-22d4-44ac-8a0b-dc2abbb6d113) |
...
<td valign="top">Before:
<br><br>
<img width="1138" alt="Screenshot 2023-11-27 at 14 37 44" src="https://github.com/dieselfox1/fincommerce-blocks/assets/3323310/14b932c9-4c0a-40d0-a9f2-7ffff81836c4">

</td>
<td valign="top">After:
<br><br>
<img width="1135" alt="Screenshot 2023-11-27 at 14 36 28" src="https://github.com/dieselfox1/fincommerce-blocks/assets/3323310/a3f53c2a-15eb-4c65-b890-fbf818890feb"></td>
</tr>
</table>
...
- [helper-plugin-01.zip](https://github.com/dieselfox1/fincommerce-blocks/files/13487656/helper-plugin-01.zip)
- [helper-plugin-02.zip](https://github.com/dieselfox1/fincommerce-blocks/files/13487657/helper-plugin-02.zip)
...
<img width="283" alt="Screenshot 2023-11-28 at 19 13 46" src="https://github.com/dieselfox1/fincommerce-blocks/assets/3323310/c98dae13-a013-447a-825f-48b2ec46c6f4">
...
- [helper-plugin-01.zip](https://github.com/dieselfox1/fincommerce-blocks/files/13487757/helper-plugin-01.zip)
- [helper-plugin-02.zip](https://github.com/dieselfox1/fincommerce-blocks/files/13487758/helper-plugin-02.zip)
- [helper-plugin-03.zip](https://github.com/dieselfox1/fincommerce-blocks/files/13487759/helper-plugin-03.zip)
...
<br><br>
<img width="283" alt="Screenshot 2023-11-28 at 21 32 30" src="https://github.com/dieselfox1/fincommerce-blocks/assets/3323310/ba6a42ba-9934-4510-8ba7-c1513fc05c85">
</td>
<td valign="top">Open:
<br><br>
<img width="283" alt="Screenshot 2023-11-28 at 21 32 38" src="https://github.com/dieselfox1/fincommerce-blocks/assets/3323310/e2079194-eca8-40df-baca-0691f5930d8e">
</td>
</tr>
</table>
...
- [helper-plugin-01.zip](https://github.com/dieselfox1/fincommerce-blocks/files/13488042/helper-plugin-01.zip)
- [helper-plugin-02.zip](https://github.com/dieselfox1/fincommerce-blocks/files/13488043/helper-plugin-02.zip)
- [helper-plugin-03.zip](https://github.com/dieselfox1/fincommerce-blocks/files/13488045/helper-plugin-03.zip)
- [helper-plugin-04.zip](https://github.com/dieselfox1/fincommerce-blocks/files/13488046/helper-plugin-04.zip)
- [helper-plugin-05.zip](https://github.com/dieselfox1/fincommerce-blocks/files/13488047/helper-plugin-05.zip)
- [helper-plugin-06.zip](https://github.com/dieselfox1/fincommerce-blocks/files/13488049/helper-plugin-06.zip)
- [helper-plugin-07.zip](https://github.com/dieselfox1/fincommerce-blocks/files/13488050/helper-plugin-07.zip)
- [helper-plugin-08.zip](https://github.com/dieselfox1/fincommerce-blocks/files/13488051/helper-plugin-08.zip)
- [helper-plugin-09.zip](https://github.com/dieselfox1/fincommerce-blocks/files/13488052/helper-plugin-09.zip)
- [helper-plugin-10.zip](https://github.com/dieselfox1/fincommerce-blocks/files/13488053/helper-plugin-10.zip)
...
<td valign="top">Closed:
<br><br>
<img width="283" alt="Screenshot 2023-11-28 at 21 24 23" src="https://github.com/dieselfox1/fincommerce-blocks/assets/3323310/6cdd2a81-fa59-4e4f-ada0-dce1bacdda87">
</td>
<td valign="top">Open:
<br><br>
<img width="282" alt="Screenshot 2023-11-28 at 21 30 26" src="https://github.com/dieselfox1/fincommerce-blocks/assets/3323310/e2bb8b51-a253-4c11-9340-2210111e940c">
</td>
</tr>
</table>
...
[helper-plugin-01.zip](https://github.com/dieselfox1/fincommerce-blocks/files/13522252/helper-plugin-01.zip)
...
<td valign="top">Before:
<br><br>
<img width="1280" alt="Screenshot 2023-12-01 at 14 23 02" src="https://github.com/dieselfox1/fincommerce-blocks/assets/3323310/c1ce59b3-1d5d-4072-bd5b-aec8804cccca">
</td>
<td valign="top">After:
<br><br>
<img width="1280" alt="Screenshot 2023-12-01 at 14 24 20" src="https://github.com/dieselfox1/fincommerce-blocks/assets/3323310/a491a946-0a4f-4b5e-b94f-958a4efb2789">
</td>
</tr>
</table>

### Revert "Remove unused Add to Cart product element (#11948)" [#12033](https://github.com/dieselfox1/fincommerce-blocks/pull/12033)
...
### Implement the Block Hooks API to automatically inject the Mini-Cart block [#11745](https://github.com/dieselfox1/fincommerce-blocks/pull/11745)
...
- You should never see two mini-cart blocks in a header pattern or template part (for example FinCommerce header patterns should be untouched).
...
[https://github.com/dieselfox1/fincommerce-blocks/assets/1429108/4d61ec4e-f1ab-478a-850f-d568993599df](https://github.com/dieselfox1/fincommerce-blocks/assets/1429108/4d61ec4e-f1ab-478a-850f-d568993599df)

And how things look after:

[https://github.com/dieselfox1/fincommerce-blocks/assets/1429108/289aaccb-0877-462f-8190-fa046aba1799](https://github.com/dieselfox1/fincommerce-blocks/assets/1429108/289aaccb-0877-462f-8190-fa046aba1799)
