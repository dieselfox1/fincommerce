...
Zip file for testing: [fincommerce-gutenberg-products-block.zip](https://github.com/dieselfox1/fincommerce-blocks/files/11972116/fincommerce-gutenberg-products-block.zip)

## FinCommerce Core

### Add Cart/Checkout/Order-Received Templates [#9301](https://github.com/dieselfox1/fincommerce-blocks/pull/9301)

1. On a new FinCommerce installation take note of the contents for Cart and Checkout pages
...
11. Go to FinCommerce > Settings > Advanced and verify that for Cart and Checkout we have a freeform endpoint textbox, as opposed to the old page selection dropdown
12. Edit and save them, and verify that a new checkout flow displays Cart and Checkout on the newly chosen endpoints

### Add/attributes filter count display toggle [#9833](https://github.com/dieselfox1/fincommerce-blocks/pull/9833)
...
### Banner pattern: improve spacing and centering in responsive designs [#9877](https://github.com/dieselfox1/fincommerce-blocks/pull/9877)
...
<img width="700" alt="Screenshot 2023-06-19 at 12 23 41" src="https://github.com/dieselfox1/fincommerce-blocks/assets/186112/08d0043b-c856-497c-86c2-cd5f5b4cadf2">
<img width="1209" alt="Screenshot 2023-06-19 at 12 23 49" src="https://github.com/dieselfox1/fincommerce-blocks/assets/186112/a4d74096-0b3b-48c2-a60a-5d13a6f7e53f">

### Hero Split pattern: add shop link to the button [#9879](https://github.com/dieselfox1/fincommerce-blocks/pull/9879)

1. Create a new page or post.
2. Insert the `Hero Product - Split` pattern and save.
3. Go to the front end and check the `Shop now` button links to the shop.

### Make use of product search [#9890](https://github.com/dieselfox1/fincommerce-blocks/pull/9890)

1. Add the following patterns to a post/page `FinCommerce Essential Header | Dark`, `FinCommerce Essential Header`, `FinCommerce Large Header | Dark` and `FinCommerce Large Header`.
...
### `Featured Products 5-item grid` fix alignment [#9913](https://github.com/dieselfox1/fincommerce-blocks/pull/9913)
...
<img src="https://github.com/dieselfox1/fincommerce-blocks/assets/186112/7930ca9e-895a-45f3-b098-b2a85c33c9c9" />

### Shop by Price pattern: add price filters to buttons [#9915](https://github.com/dieselfox1/fincommerce-blocks/pull/9915)
...
<img width="1235" alt="Screenshot 2023-06-20 at 16 34 27" src="https://github.com/dieselfox1/fincommerce-blocks/assets/186112/561aa7e7-be01-4617-abcd-ff7b71584a1c">

### Use the single product block on the Hero Product pattern [#9935](https://github.com/dieselfox1/fincommerce-blocks/pull/9935)
...
<img width="1199" alt="Screenshot 2023-06-21 at 14 17 30" src="https://github.com/dieselfox1/fincommerce-blocks/assets/186112/867d945e-0629-4df3-8e77-aead323c3d54">
...
### Add new `Small discount banner with image` pattern [#9947](https://github.com/dieselfox1/fincommerce-blocks/pull/9947)
...
### Add new `Discount banner` pattern [#9936](https://github.com/dieselfox1/fincommerce-blocks/pull/9936)
...
### Remove attributes data from save function for active filters [#10047](https://github.com/dieselfox1/fincommerce-blocks/pull/10047)
...
### Remove attributes data from save function for filter by price [#10039](https://github.com/dieselfox1/fincommerce-blocks/pull/10039)
...
### Add size settings to the `Product Image` block [#10034](https://github.com/dieselfox1/fincommerce-blocks/pull/10034)
...
### Add to Cart with options block > Remove opinionated style for the price list in grouped products. [#9988](https://github.com/dieselfox1/fincommerce-blocks/pull/9988)
...
| Before | After |
| ------ | ----- |
| <img width="1107" alt="Screenshot 2023-06-26 at 12 33 18" src="https://github.com/dieselfox1/fincommerce-blocks/assets/15730971/2a42ad75-bdf1-4229-a2a1-bc1495a5d8b6"> | <img width="1029" alt="Screenshot 2023-06-26 at 12 32 15" src="https://github.com/dieselfox1/fincommerce-blocks/assets/15730971/07959a5c-808b-44bf-aa50-a66513ebb533"> |
...
![image](https://github.com/dieselfox1/fincommerce-blocks/assets/11503784/0f864388-d605-46cc-8749-041dca830eb3)
...
5. Make sure the blocks are named correctly (as in the list above) and the word "FinCommerce" does not appear in front of the blocks title.
...
> _"The Cart & Checkout Blocks are a feature to optimize for faster checkout. To make sure this feature is right for your store, [review the list of compatible extensions](https://fincommerce.com/document/cart-checkout-blocks-support-status/#section-3)."_
...
### Hide "collection from" text when a location has an incomplete address. [#9808](https://github.com/dieselfox1/fincommerce-blocks/pull/9808)

1. Go to FinCommerce > Settings > Shipping > Local Pickup. Create 2 pickup locations—one should have a full address/pickup location, and one should have no address like so:

![Screenshot 2023-06-13 at 12 48 21](https://github.com/dieselfox1/fincommerce-blocks/assets/90977/2dcd6ed7-08ec-4351-8f30-1d6b887eec9d)
...
![Screenshot 2023-06-13 at 12 50 13](https://github.com/dieselfox1/fincommerce-blocks/assets/90977/8bd1fd97-ae82-40f8-a4cb-11b5a705488c)

5. Select the pickup location with no address. It should not show the collection from section:

![Screenshot 2023-06-13 at 12 50 19](https://github.com/dieselfox1/fincommerce-blocks/assets/90977/80dda09b-e99a-4d00-81fb-b3916dddeb9a)

6. Place the order and check the confirmation displays correctly without an address also:

![Screenshot 2023-06-13 at 12 56 19](https://github.com/dieselfox1/fincommerce-blocks/assets/90977/7aacfa0d-0ff7-408f-854e-01bfa59da502)

### Cleanup code to lazy-load wc-settings in the Mini-Cart block [#10042](https://github.com/dieselfox1/fincommerce-blocks/pull/10042)
...
Before | After
--- | ---
[before.webm](https://github.com/dieselfox1/fincommerce-blocks/assets/3616980/a7bed8d6-13d4-4b8a-b775-eea8feab9d32) | [after.webm](https://github.com/dieselfox1/fincommerce-blocks/assets/3616980/c3b75b3b-60fb-4683-be6a-3bc9d108dd42)
...
### Mini Cart: Add Price, Icon and Product Count color settings [#9647](https://github.com/dieselfox1/fincommerce-blocks/pull/9647)
...
### Avoid usage of __experimentalUseFocusOutside [#10017](https://github.com/dieselfox1/fincommerce-blocks/pull/10017)
...
### Single Product Template: fix compatibility layer logic when the blocks aren't wrapped in a group block [#9982](https://github.com/dieselfox1/fincommerce-blocks/pull/9982)
...
### Product Image: use WC Core function to render image [#9984](https://github.com/dieselfox1/fincommerce-blocks/pull/9984)
...
### Single Product Block > Ensure the Product Summary and Title are always rendered  with the correct context independent of their position [#9968](https://github.com/dieselfox1/fincommerce-blocks/pull/9968)
...
<img width="1319" alt="Screenshot 2023-06-22 at 18 37 47" src="https://github.com/dieselfox1/fincommerce-blocks/assets/15730971/2774edbe-cc8c-473c-8bae-e590327e0390">
...
### Allow customer account block to center align [#9750](https://github.com/dieselfox1/fincommerce-blocks/pull/9750)
...
Before | After
--- | ---
![imatge](https://github.com/dieselfox1/fincommerce-blocks/assets/3616980/d212291d-6aaf-4642-847d-62a336cbc922) | ![imatge](https://github.com/dieselfox1/fincommerce-blocks/assets/3616980/509f25b6-788a-46b2-95e2-2dc74b92d59b)

### Fix cart and checkout conditionals when using a block based theme and templates [#10098](https://github.com/dieselfox1/fincommerce-blocks/pull/10098)
...
![Screenshot 2023-07-05 at 11 37 57](https://github.com/dieselfox1/fincommerce-blocks/assets/90977/c8fb8bc5-abd6-43e2-8e3c-1748497aa0f7)
