...
Zip file for testing: [fincommerce-gutenberg-products-block.zip](https://github.com/dieselfox1/fincommerce-gutenberg-products-block/files/7083656/fincommerce-gutenberg-products-block.zip)

## Feature plugin and package inclusion in FinCommerce

### Testing Link to Product Page setting in All Products Block ([4630](https://github.com/dieselfox1/fincommerce-gutenberg-products-block/pull/4630))
...
### New Filter Products by Stock block ([4145](https://github.com/dieselfox1/fincommerce-gutenberg-products-block/pull/4145))
...
2. Ensure `Hide out of stock products from catalogue` is **disabled** in **FinCommerce > Settings > Products > Inventory**
...
8. Change the `Hide out of stock products from catalogue` to **enabled** in **FinCommerce > Settings > Products > Inventory**
...
### Fix layout issues with Category List Block ([4587](https://github.com/dieselfox1/fincommerce-gutenberg-products-block/pull/4587))
...
3. Go to FinCommerce > Settings > Products and set the "Shop Page" to be the page you created in the previous step.
4. Visit the page and ensure the category list is rendered correctly with no excessive line-breaks.

### Ensure no impact from changes to SortSelect components ([4580](https://github.com/dieselfox1/fincommerce-gutenberg-products-block/pull/4580))
