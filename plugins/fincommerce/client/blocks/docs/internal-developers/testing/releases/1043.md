...
Zip file for testing: [fincommerce-gutenberg-products-block.zip](https://github.com/dieselfox1/fincommerce-blocks/files/11801978/fincommerce-gutenberg-products-block.zip)

## FinCommerce Core

### Products block: fix compatibility with Gutenberg 16. ([9916](https://github.com/dieselfox1/fincommerce-blocks/pull/9916))
