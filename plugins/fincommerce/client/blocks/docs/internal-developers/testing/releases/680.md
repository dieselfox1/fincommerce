...
Zip file for testing: [fincommerce-gutenberg-products-block.zip](https://github.com/dieselfox1/fincommerce-gutenberg-products-block/files/7903801/fincommerce-gutenberg-products-block.zip)

## WC Core

### FSE: Add support for the global style for the Price Filter block. ([5559](https://github.com/dieselfox1/fincommerce-gutenberg-products-block/pull/5559))

1. Upgrade to `finpress 5.9`.
...
### FSE: Update the block theme folders to latest Gutenberg convention (i.e. `templates` and `parts`). ([5464](https://github.com/dieselfox1/fincommerce-gutenberg-products-block/pull/5464))

1. Activate the Gutenberg plugin (or use finpress 5.9). Select a block theme e.g. TT1 Blocks.
2. Open Appearance > Editor > Templates.
3. Make sure all the templates and parts appear correctly. FinCommerce templates that should be available: `Archive Product`, `Single Product`, `Product Category` and `Product Tag`. FinCommerce template-parts that should be available `Mini Cart`.

### FSE: Add support for the wide and full alignment for the legacy template block. ([5433](https://github.com/dieselfox1/fincommerce-gutenberg-products-block/pull/5433))
...
9. Go to Appearance > Customize > FinCommerce > Product Images and set a custom aspect ratio (for example, 16:9).
...
### Hold stock for 60mins if the order is pending payment. ([5546](https://github.com/dieselfox1/fincommerce-gutenberg-products-block/pull/5546))
...
1. Install `FinCommerce Points and Rewards`, go to FinCommerce > Points and Rewards and add points to your user.
2. Go to FinCommerce > Points and Rewards > Settings and enable "Allow partial redemption"
...
Install the [Stripe Payment Method Extension](https://github.com/dieselfox1/fincommerce-gateway-stripe/), activate it, enable it and test it works by:
...
### FSE: Add support for the global style for the Product Title block. ([5515](https://github.com/dieselfox1/fincommerce-gutenberg-products-block/pull/5515))
...
### FSE: Add support for the global style for the Stock Indicator block. ([5525](https://github.com/dieselfox1/fincommerce-gutenberg-products-block/pull/5525))
...
### FSE: Add support for the global style for the Summary Product block. ([5524](https://github.com/dieselfox1/fincommerce-gutenberg-products-block/pull/5524))
