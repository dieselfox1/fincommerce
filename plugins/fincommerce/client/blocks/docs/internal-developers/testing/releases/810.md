...
Zip file for testing: [fincommerce-gutenberg-products-block.zip](https://github.com/dieselfox1/fincommerce-blocks/files/9131847/fincommerce-gutenberg-products-block.zip)
...
4. Confirm the following updated FinCommerce templates' descriptions:
...
3. Under FinCommerce > Settings > Products > Inventory, check the box that says "Hide out of stock items from the catalog".
