...
Zip file for
testing: [fincommerce-gutenberg-products-block.zip](https://github.com/dieselfox1/fincommerce-blocks/files/9758323/fincommerce-gutenberg-products-block.zip)
...
3. [Open the List View](https://finpress.com/go/tutorials/how-to-use-the-list-view-in-the-finpress-block-editor/).
...
found [here](https://github.com/dieselfox1/fincommerce-blocks/blob/trunk/docs/internal-developers/testing/cart-checkout/data-stores.md)
. At a minimum, we will need to smoke test by trying the
different [stripe failure](https://github.com/dieselfox1/fincommerce-blocks/blob/trunk/docs/internal-developers/testing/cart-checkout/data-stores.md#stripe-failures)
modes
...
1. In a new page or a template, go to the patterns tab and make sure all 6 patterns appear under the FinCommerce
   category dropdown.
...
1. Install [this test plugin](https://github.com/dieselfox1/fincommerce-blocks/files/9665640/some-extension-name.zip)
...
1. Install
   the [Google Analytics Integration Extension](https://github.com/dieselfox1/fincommerce-google-analytics-integration)
...
6. See the upgrade notices for filter blocks as shown
   in [this comment](https://github.com/dieselfox1/fincommerce-blocks/pull/6978#issuecomment-1252087654).
...
1. Install the [newsletter-test](https://github.com/dieselfox1/newsletter-test) plugin to your site
...
1. Get a zip of this plugin (from below) and upload it to a finpress.com website.
