...
### Use the @wordpress/components instead of wordpress-components while in editor ([8432](https://github.com/dieselfox1/fincommerce-blocks/pull/8432))
...
### Move the usage of Notices from @wordpress/components from frontend to editor (Filter by Attribute) ([8457](https://github.com/dieselfox1/fincommerce-blocks/pull/8457))
...
### Move the usage of Notices from @wordpress/components from frontend to editor (Filter by Rating) ([8444](https://github.com/dieselfox1/fincommerce-blocks/pull/8444))
...
### Move usage of wordpress-components to editor and replace with @wordpr… ([8463](https://github.com/dieselfox1/fincommerce-blocks/pull/8463))
