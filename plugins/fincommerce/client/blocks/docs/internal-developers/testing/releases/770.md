...
Zip file for testing: [fincommerce-gutenberg-products-block.zip](https://github.com/dieselfox1/fincommerce-blocks/files/8777633/fincommerce-gutenberg-products-block.zip)
...
1. Install finpress beta tester plugin and update to WP 6.0.
