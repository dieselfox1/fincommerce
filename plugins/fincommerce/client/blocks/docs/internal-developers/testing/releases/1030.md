...
Zip file for testing: [fincommerce-gutenberg-products-block.zip](https://github.com/dieselfox1/fincommerce-blocks/files/11554379/fincommerce-gutenberg-products-block.zip)

## FinCommerce Core

### Only show the Mini Cart count badge when there are items in the cart [#9259](https://github.com/dieselfox1/fincommerce-blocks/pull/9259)
...
### Store API: Fix payment method validation (fixes COD) [#9375](https://github.com/dieselfox1/fincommerce-blocks/pull/9375)
...
### Styling fixes for form step headings [#9437](https://github.com/dieselfox1/fincommerce-blocks/pull/9437)
...
### Product Gallery Block > Remove global variable overwrite and keep support for the Single Product Block. [#9475](https://github.com/dieselfox1/fincommerce-blocks/pull/9475)
...
### Update Mini-Cart block editor sidebar [#9420](https://github.com/dieselfox1/fincommerce-blocks/pull/9420)
...
| Design                                                                                                          | Actual                                                                                                          |
| --------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------- |
| ![image](https://github.com/dieselfox1/fincommerce-blocks/assets/3616980/38553c5b-410b-4ef1-8e4f-d8238e89475a) | ![image](https://github.com/dieselfox1/fincommerce-blocks/assets/3616980/c085837a-c407-4565-828b-2ebb2d28a286) |

### Add to Cart Button > Update block registration to rely on metadata and enable usage for the Single Product Block [#9404](https://github.com/dieselfox1/fincommerce-blocks/pull/9404)
...
### Fix alignment issue with 'Add Coupon Code' button in FinCommerce Blocks (#9391) [#9392](https://github.com/dieselfox1/fincommerce-blocks/pull/9392)
...
### Improve transform classic product template UX [#9386](https://github.com/dieselfox1/fincommerce-blocks/pull/9386)
...
### Add color and typography styles on the mini cart title block [#9382](https://github.com/dieselfox1/fincommerce-blocks/pull/9382)
...
### Product Meta block: Remove the fill color of the icon and move it to the Icons library, Product Details block: Remove the fill color of the Product Details icon and move it to the icons library ([#9506](https://github.com/dieselfox1/fincommerce-blocks/pull/9506) and [#9503](https://github.com/dieselfox1/fincommerce-blocks/pull/9503))
...
### Update Mini-Cart block logic to use isSiteEditorPage util [#9501](https://github.com/dieselfox1/fincommerce-blocks/pull/9501)
...
6. Verify in the sidebar there is a _Mini-Cart in cart and checkout pages_ toggle.
   ![image](https://github.com/dieselfox1/fincommerce-blocks/assets/3616980/96bccc7b-3a1d-479e-a98b-54b600582747)
...
### Prevent QuantitySelector stealing focus on page load [#9487](https://github.com/dieselfox1/fincommerce-blocks/pull/9487)
...
### Render Product Details block when used along the Post Content block [#9479](https://github.com/dieselfox1/fincommerce-blocks/pull/9479)
...
### Mini Cart: stop using Modal component [#9345](https://github.com/dieselfox1/fincommerce-blocks/pull/9345)
...
### Update `Hero Product – Split` Pattern Color Settings [#9433](https://github.com/dieselfox1/fincommerce-blocks/pull/9433)

1. Activate a block theme (TT3).
2. From the editor, insert the `Hero Product – Split` pattern (under the FinCommerce section).
...
2. Make sure the `Hero product chessboard` pattern appears under the FinCommerce category dropdown.
...
1. Create a new page or post
2. Make sure the `Product listing with gallery` pattern appears under the FinCommerce category dropdown.
3. Insert in and make sure it shows as expected on the design.

### Add Product Details: product listing pattern [#9383](https://github.com/dieselfox1/fincommerce-blocks/pull/9383)
...
1. Create a new page or post
2. Make sure the `Product collections: featured collections` pattern appears under the FinCommerce category dropdown.
3. Insert in and make sure it shows as expected on the design.

### Add product details pattern [#9408](https://github.com/dieselfox1/fincommerce-blocks/pull/9408)

1. Add a page/post and use the block inserter and go to Patterns->FinCommerce->Product Details Pattern.
...
1. Add a page/post and use the block inserter to add the `Banner` pattern by going to patterns->fincommerce->Banner
