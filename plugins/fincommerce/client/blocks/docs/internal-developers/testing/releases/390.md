...
Zip file for testing: [fincommerce-gutenberg-products-block.zip](https://github.com/dieselfox1/fincommerce-gutenberg-products-block/files/5597018/fincommerce-gutenberg-products-block.zip)
...
-   [ ] Ensure the Allow customers to log into an existing account during checkout option is enabled in **FinCommerce -> Settings -> Accounts & Privacy**.
...
-   [ ] Proceed with the payment and verify you are redirected to the success screen and the order appears in the admin (FinCommerce > Orders).
