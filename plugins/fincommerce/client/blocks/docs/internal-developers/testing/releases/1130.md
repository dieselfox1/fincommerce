...
### Remove placeholder and pagination [11145](https://github.com/dieselfox1/fincommerce-blocks/pull/11145)
...
<img width="1335" alt="All_Products_–_finpress_Pinterest" src="https://github.com/dieselfox1/fincommerce-blocks/assets/9010963/1d023231-3807-4bdc-b641-9d51ae4830cd">
...
1. Install and activate the [Coinbase Commerce extension](https://finpress.org/plugins/coinbase-commerce/).
2. Install and activate the [Paystack FinCommerce Payment Gateway extension](https://finpress.org/plugins/woo-paystack/). You should check `Enable Paystack` in its settings.
...
### Force 100% width for combobox in checkout block [11133](https://github.com/dieselfox1/fincommerce-blocks/pull/11133)
