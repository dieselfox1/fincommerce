...
Zip file for testing: [fincommerce-gutenberg-products-block.zip](https://github.com/dieselfox1/fincommerce-blocks/files/10966635/fincommerce-gutenberg-products-block.zip)

## FinCommerce Core

### Cart and Checkout blocks

#### Add filter to change proceed to checkout button text and URL [#8613](https://github.com/dieselfox1/fincommerce-blocks/pull/8613)

1. Add items to your cart, go to the Cart block and ensure the button to proceed to checkout works and looks normal.

#### Fix / Return associative array for fincommerce_order_get_tax_location filter [#8681](https://github.com/dieselfox1/fincommerce-blocks/pull/8681)
...
#### Add LocalPickupSelect component [#8634](https://github.com/dieselfox1/fincommerce-blocks/pull/8634)
...
#### Allow view switcher to toggle view when using Gutenberg list view [#8429](https://github.com/dieselfox1/fincommerce-blocks/pull/8429)
...
1. Create a new page or post and open the [block inserter](https://finpress.org/documentation/article/adding-a-new-block/).
2. Hover over the Cart and Checkout blocks.
3. Verify that the editor no longer freezes.

#### Add Debounce to Shipping Calculation selection [#8498](https://github.com/dieselfox1/fincommerce-blocks/pull/8498)
...
#### Ignore shipping address from server when updating shipping methods [#8718](https://github.com/dieselfox1/fincommerce-blocks/pull/8718)
...
#### Remove wc-blocks-registry from Mini Cart block dependencies so more scripts can be lazy-loaded [#8657](https://github.com/dieselfox1/fincommerce-blocks/pull/8657)
...
2. Enable a block theme, like [TT3](https://github.com/finpress/twentytwentythree/).
...
#### Remove wc-settings from Mini Cart block dependencies [#8703](https://github.com/dieselfox1/fincommerce-blocks/pull/8703), Preload Mini Cart inner blocks frontend scripts [#8653](https://github.com/dieselfox1/fincommerce-blocks/pull/8653)
...
#### Only print wp.apiFetch.createPreloadingMiddleware() when needed [#8647](https://github.com/dieselfox1/fincommerce-blocks/pull/8647)
...
#### Mini Cart drawer close button: inherit text color and improve alignment [#8605](https://github.com/dieselfox1/fincommerce-blocks/pull/8605)

0. Switch to a dark theme (ie: [TT3](https://github.com/finpress/twentytwentythree/)) and set a dark styling (ie: Appearance > Editor > edit a template > Style > Browse styles > Pilgrimage).
...
#### Fix Mini Cart missing translations [#8591](https://github.com/dieselfox1/fincommerce-blocks/pull/8591)
...
#### Make the customer account icon bigger to match the mini-cart one [#8594](https://github.com/dieselfox1/fincommerce-blocks/pull/8594)
...
#### Make the start shopping button show the theme style [#8567](https://github.com/dieselfox1/fincommerce-blocks/pull/8567)
...
#### Switch Select by Toggle for the 'Add-to-Cart behaviour' [#8558](https://github.com/dieselfox1/fincommerce-blocks/pull/8558)
...
#### Remove colorClassName and style from QuantityBadge [#8557](https://github.com/dieselfox1/fincommerce-blocks/pull/8557)
...
#### Add explicit CSS styling to mini-cart block amount in inserter preview [#8516](https://github.com/dieselfox1/fincommerce-blocks/pull/8516)
...
#### Products: Update product element margins in patterns [#8401](https://github.com/dieselfox1/fincommerce-blocks/pull/8401)

1. Add the **Products** block to a post or page.
2. Add FinCommerce Products patterns:
	- FinCommerce 1:1 Image 4-Column Products Row
	- FinCommerce 3-Column Product Row
	- FinCommerce 4-Column Product Row
	- FinCommerce Large Image Product Gallery
	- FinCommerce Minimal 5-Column Products Row
	- FinCommerce Minimal Product List
	- FinCommerce Product Gallery
	- FinCommerce Product list with 1:1 images
	- FinCommerce Product list with full product description

3. Ensure all margins are displaying correctly both in the editor and the frontend.

#### Improve Products block Attributes Filter Inspector Controls [#8583](https://github.com/dieselfox1/fincommerce-blocks/pull/8583)
...
#### Fix Products block Add to Cart button when AJAX on archives is disabled [#8532](https://github.com/dieselfox1/fincommerce-blocks/pull/8532)

1. Go to FinCommerce > Settings > Products and disable the _Enable AJAX add to cart buttons on archives_ checkbox.
...
#### [Products]: Fix attributes filters that do not update the editor preview correctly [#8611](https://github.com/dieselfox1/fincommerce-blocks/pull/8611)
...
#### Product Price block: add support to the Single Product Template [#8609](https://github.com/dieselfox1/fincommerce-blocks/pull/8609)
...
#### Enable the compatibility layer when Product Meta, Product Price and Breadcrumbs blocks are added [#8719](https://github.com/dieselfox1/fincommerce-blocks/pull/8719)
...
#### Product Result Count block: Add support for global styles [#8517](https://github.com/dieselfox1/fincommerce-blocks/pull/8517)
...
### Add border support to mini cart contents [#8654](https://github.com/dieselfox1/fincommerce-blocks/pull/8654)
