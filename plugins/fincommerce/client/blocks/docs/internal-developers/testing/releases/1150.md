...
1. Set up [FinCommerce Stripe Payment Gateway](https://finpress.org/plugins/fincommerce-gateway-stripe/) and ensure your site is using HTTPS so express methods from Stripe can show.
...
4. Add the following code snippet using the [Code Snippets](https://finpress.org/plugins/code-snippets/) plugin:
