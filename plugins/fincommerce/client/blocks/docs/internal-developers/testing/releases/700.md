...
Zip file for testing: [fincommerce-gutenberg-products-block.zip](https://github.com/dieselfox1/fincommerce-gutenberg-products-block/files/8074954/fincommerce-gutenberg-products-block.zip)

## Feature Plugin

### FSE: Enable global style for Attribute Filter Block ([5557](https://github.com/dieselfox1/fincommerce-gutenberg-products-block/pull/5557))
...
### FSE: Enable global style for Sale Product Block ([5565](https://github.com/dieselfox1/fincommerce-gutenberg-products-block/pull/5565))
...
### FSE: Revert template customization for FinCommerce templates ([5746](https://github.com/dieselfox1/fincommerce-gutenberg-products-block/pull/5746))

1. Ensure you have the latest FinCommerce, finpress 5.9 and a block theme so that the FSE feature is enabled.
...
11. Now add a FinCommerce template (e.g. `single-product.html`) into your theme or download and install [this version of TwentyTwentyTwo](https://github.com/dieselfox1/fincommerce-gutenberg-products-block/files/8036005/twentytwentytwo.zip) and test steps 1-10 again.

### Checkout: Local state management for shipping options ([5802](https://github.com/dieselfox1/fincommerce-gutenberg-products-block/pull/5802))
...
### Cart and Checkout: Appender button overlap ([5801](https://github.com/dieselfox1/fincommerce-gutenberg-products-block/pull/5801))
...
### Cart and Checkout: Fix button hover and focus states ([5712](https://github.com/dieselfox1/fincommerce-gutenberg-products-block/pull/5712))
...
### Product blocks: Fix ignoring redirection to cart after add ([5708](https://github.com/dieselfox1/fincommerce-gutenberg-products-block/pull/5708))

1. Go to FinCommerce Settings > Products > General and toggle _Redirect to the cart page after successful addition_
...
### Checkout: Fix default attributes not being passed to the front-end ([5732](https://github.com/dieselfox1/fincommerce-gutenberg-products-block/pull/5732))
...
### Checkout: Fix handling of orders without payments ([5720](https://github.com/dieselfox1/fincommerce-gutenberg-products-block/pull/5720))
...
### TS conversion of several blocks ([5668](https://github.com/dieselfox1/fincommerce-gutenberg-products-block/pull/5668))
...
### FSE: Add a “Remove Image” option to the Featured Category Block ([5719](https://github.com/dieselfox1/fincommerce-gutenberg-products-block/pull/5719))
...
### TT2: Fix Twenty Twenty-Two Products by Category Block item tile styling issues ([5684](https://github.com/dieselfox1/fincommerce-gutenberg-products-block/pull/5684))

1. Get the [Twenty Twenty Two](https://finpress.org/themes/twentytwentytwo/) theme
