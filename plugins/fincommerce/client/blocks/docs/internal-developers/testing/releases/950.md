...
1. Enable the [Multiple Packages for FinCommerce](https://wordpress.org/plugins/multiple-packages-for-fincommerce/) extension and set a price for local pickup.
