...
2. Change your site language to a fully localized language as es-Es. ([Translation status](https://translate.finpress.org/locale/es/default/wp-plugins/woo-gutenberg-products-block/))
