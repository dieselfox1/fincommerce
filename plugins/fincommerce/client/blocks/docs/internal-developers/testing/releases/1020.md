...
Zip file for testing: [fincommerce-gutenberg-products-block.zip](https://github.com/dieselfox1/fincommerce-blocks/files/11450388/fincommerce-gutenberg-products-block.zip)

## FinCommerce Core

### Add shop by price pattern ([#9373](https://github.com/dieselfox1/fincommerce-blocks/pull/9373))

1. Create a page and use the block inserter->patterns->FinCommerce and to insert the Shop by Price pattern.
...
### Mini Cart drawer: print width in PHP [#9329](https://github.com/dieselfox1/fincommerce-blocks/pull/9329)
...
### Convert to use WP core blocks [#9340](https://github.com/dieselfox1/fincommerce-blocks/pull/9340)

1. Create a page and use the block inserter->patterns->FinCommerce and to insert the Featured Category Triple pattern.
2. Check that the preview shows up nicely and add the pattern to the page.
3. Update/save and check the frontend and ensure it is displaying nicely per design.
...
1. Create a page/post and use the block inserter->patterns->FinCommerce->Product Hero | Wide
...
### Remove duplicated code in BlockTypesController.php [#9283](https://github.com/dieselfox1/fincommerce-blocks/pull/9283)
...
### Fix Product Price styles leaking into the Mini Cart, Cart and Checkout blocks [#9276](https://github.com/dieselfox1/fincommerce-blocks/pull/9276)
...
### Implement new Hero Product – Split pattern [#9191](https://github.com/dieselfox1/fincommerce-blocks/pull/9191)

1. Create a new page or post
2. Make sure the `FinCommerce Hero Product – Split` pattern appears under the FinCommerce category dropdown.
...
### Add featured category cover image [#9284](https://github.com/dieselfox1/fincommerce-blocks/pull/9284)

1. Create a page and use the block inserter->patterns->FinCommerce and to insert the Featured Category Cover Image.
2. Insert the pattern and update/save and check the frontend and ensure it is displaying close to the design from [#9046](https://github.com/dieselfox1/fincommerce-blocks/issues/9046)

![image](https://user-images.githubusercontent.com/2132595/235695902-d16abe15-9cbd-4633-959c-07c324dd765c.png)

### Prevent email address being removed when changing shipping method/entering shipping address [#9328](https://github.com/dieselfox1/fincommerce-blocks/pull/9328)

1. Enable local pickup (FinCommerce -> Settings -> Shipping -> Local Pickup) and add some locations.
2. Add some shipping locations in FinCommerce -> Settings -> Shipping.
...
8. Uncheck the "Use shipping as billing" checkbox and check out with two different addresses. Ensure the addresses are correct in the order confirmation email and in the FinCommerce back end.

### [Pattern] Add new Hero product 3 split pattern [#9319](https://github.com/dieselfox1/fincommerce-blocks/pull/9319)

1. Create a new page or post
2. Make sure the `Hero product 3 split` pattern appears under the FinCommerce category dropdown.
3. Insert in and make sure it shows as expected on the design.

![image](https://user-images.githubusercontent.com/186112/234288498-1fcc67e4-2d63-4550-b669-b6139150fe30.png)

### Rename Add to Cart [#9315](https://github.com/dieselfox1/fincommerce-blocks/pull/9315)
...
1. Create a new page or post
2. Make sure the `Product Collections: Newest Arrivals` pattern appears under the FinCommerce category dropdown.
3. Insert in and make sure it shows as expected on the design.
...
### Fix shipping notices for multiple packages [#9285](https://github.com/dieselfox1/fincommerce-blocks/pull/9285)

- Enable “Multiple Packages for FinCommerce” extension.
- Go to FinCommerce > Settings > Multiple packages
...
### Add/featured category focus pattern [#9322](https://github.com/dieselfox1/fincommerce-blocks/pull/9322)

1. Create a page and use the block inserter->patterns->FinCommerce and to insert the Featured Category Focus.
...
### Product Image Gallery: fix inline [#9297](https://github.com/dieselfox1/fincommerce-blocks/pull/9297)
...
1. Create a new page or post
2. Make sure the `Product Collections: Featured Collection` pattern appears under the FinCommerce category dropdown.
3. Insert in and make sure it shows as expected on the design.

![image](https://user-images.githubusercontent.com/186112/233585760-18e4748e-4856-4731-acdf-843a5031a692.png)

### Remove min-height and padding for WP Button elements [#9260](https://github.com/dieselfox1/fincommerce-blocks/pull/9260)
...
### Products block: Using nested selector to add margin between Product elements [#8993](https://github.com/dieselfox1/fincommerce-blocks/pull/8993)
...
1. Create a new page or post
2. Make sure the `FinCommerce Header Centered Search` pattern appears under the FinCommerce category dropdown.
3. Insert in and make sure it shows as expected on the design.
...
1. Create a new page or post
2. Make sure the `Footer with 3 menus` pattern appears under the FinCommerce category dropdown.
3. Insert in and make sure it shows as expected on the design.

![image](https://user-images.githubusercontent.com/186112/233968590-c5a00d1f-f057-49ee-9703-c75ec9bc6499.png)

### Use currentColor for Mini Cart footer border [#9245](https://github.com/dieselfox1/fincommerce-blocks/pull/9245)
...
### Update icon and description for the Product Meta block [#9243](https://github.com/dieselfox1/fincommerce-blocks/pull/9243)
...
### [Patterns]: Add new Featured products: 5-item grid pattern [#9006](https://github.com/dieselfox1/fincommerce-blocks/pull/9006)

1. Create a new page or post
2. Make sure the `FinCommerce Featured Products 5-item grid` pattern appears under the FinCommerce category dropdown.
3. Insert in and make sure it shows as expected on the design.

![image](https://user-images.githubusercontent.com/186112/231194280-b54da592-8e6f-44f2-983b-7bb2f0c9be44.png)

### Implement Hand-Picked Products block [#7925](https://github.com/dieselfox1/fincommerce-blocks/pull/7925)
...
### Only validate postcode if its required or filled [#9377](https://github.com/dieselfox1/fincommerce-blocks/pull/9377)
...
### Remove `<br>` In Hero Product – Split Pattern Heading [#9409](https://github.com/dieselfox1/fincommerce-blocks/pull/9409)
...
![CleanShot 2023-05-09 at 10 24 32](https://github.com/dieselfox1/fincommerce-blocks/assets/481776/b118ae6d-9c9d-477c-8d2e-9c88faa52179)

### Related Products: Fix hardcoded limit product [#9407](https://github.com/dieselfox1/fincommerce-blocks/pull/9407)
...
### Mini Cart Contents block: fix wide width not being applied in the editor [#9201](https://github.com/dieselfox1/fincommerce-blocks/pull/9201)
