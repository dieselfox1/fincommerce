...
Zip file for testing: [fincommerce-gutenberg-products-block.zip](https://github.com/dieselfox1/fincommerce-blocks/files/9242756/fincommerce-gutenberg-products-block.zip)

## Feature plugin and package inclusion in FinCommerce

### Remove compatibility notice for Mini Cart block ([6803](https://github.com/dieselfox1/fincommerce-blocks/pull/6803))
...
### Add new icon for mini cart block ([6784](https://github.com/dieselfox1/fincommerce-blocks/pull/6784))
...
### Fix: Replace DropdownSelector with FormTokenField from Gutenberg ([6647](https://github.com/dieselfox1/fincommerce-blocks/pull/6647))
...
### Use the archive-product template to render product attributes pages ([6776](https://github.com/dieselfox1/fincommerce-blocks/pull/6776))
...
### All Products block: Migrate to block.json ([6754](https://github.com/dieselfox1/fincommerce-blocks/pull/6754))
...
### Start using block.json and convert to TS the Product by Category block ([6680](https://github.com/dieselfox1/fincommerce-blocks/pull/6680))
...
### Start using block.json and convert to TS the Product Best Sellers block ([6683](https://github.com/dieselfox1/fincommerce-blocks/pull/6683))
...
### Fix: FinCommerce messages don't appear in block themes with Mini Cart block ([6728](https://github.com/dieselfox1/fincommerce-blocks/pull/6728))
...
### SearchListControl: Fix preserving case of original item ([6551](https://github.com/dieselfox1/fincommerce-blocks/pull/6551))
...
### Fix proceed to checkout button on Cart ([6804](https://github.com/dieselfox1/fincommerce-blocks/pull/6804))
...
### Ensure addresses sync correctly when loading the Checkout Shipping Address Block ([6773](https://github.com/dieselfox1/fincommerce-blocks/pull/6773))
...
### Ensure shipping rate names show when multiple packages are used ([6753](https://github.com/dieselfox1/fincommerce-blocks/pull/6753))

1. Install the ["Multiple Packages for FinCommerce" plugin](https://wordpress.org/plugins/multiple-packages-for-fincommerce/)
...
### Fix missing translations in inspector ([6737](https://github.com/dieselfox1/fincommerce-blocks/pull/6737))
