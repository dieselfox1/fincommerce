...
4. Verify a text has appeared: `Fly your finpress banner...`.
...
We also made some changes to our API endpoints to make them work correctly with finpress 5.5. We should make sure interacting with the following blocks doesn't show errors in the console or the PHP logs:
