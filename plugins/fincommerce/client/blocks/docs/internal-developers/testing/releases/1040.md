...
Zip file for testing: [fincommerce-gutenberg-products-block.zip](https://github.com/dieselfox1/fincommerce-blocks/files/11681289/fincommerce-gutenberg-products-block.zip)

## FinCommerce Core

### Product Rating: fix the filter fincommerce_product_get_rating_html is removed [#9719](https://github.com/dieselfox1/fincommerce-blocks/pull/9719)
...
### Product rating: improve preview style when the product doesn't have rating [#9684](https://github.com/dieselfox1/fincommerce-blocks/pull/9684)
...
| Before | After |
| ------ | ----- |
|![image](https://github.com/dieselfox1/fincommerce-blocks/assets/4463174/269b46d7-3370-4fb0-9c54-e7f59801e6a9)|![image](https://github.com/dieselfox1/fincommerce-blocks/assets/4463174/808f9f4f-39a1-4888-8650-498152e67ed4)|

### Combine country asset data to reduce the amount of data consumed by the cart and checkout blocks [#9552](https://github.com/dieselfox1/fincommerce-blocks/pull/9552)
...
5. In FinCommerce > Settings and change "Shipping location(s)" to specific locations. Limit to a few countries
...
### Product Image Gallery: Reintroduce filters and override-restore the global product variable. [#9630](https://github.com/dieselfox1/fincommerce-blocks/pull/9630)
...
### Blockified Single Product Template: add product-classes via `wc_get_product_class` [#9697](https://github.com/dieselfox1/fincommerce-blocks/pull/9697)
...
### Add to Cart with Options block: Restore the global variable to its original value after being overridden [#9581](https://github.com/dieselfox1/fincommerce-blocks/pull/9581)
...
3. Access `wp-admin/admin.php?page=jetpack_modules` to confirm the FinCommerce Analytics module is enabled.
...
### Make Mini-Cart block work well with caching plugins [#9493](https://github.com/dieselfox1/fincommerce-blocks/pull/9493)

**With your admin user:**

1. Install _[WP-Optimize - Clean, Compress, Cache](https://finpress.org/plugins/wp-optimize/)_ or a similar caching plugin.
...
### Blockified Single Product Template: avoid to add another group block on the editor side when the user creates a template for a specific product [#9699](https://github.com/dieselfox1/fincommerce-blocks/pull/9699)
...
9. Visit the product.
10. Ensure that there is a div with the class `fincommerce` that wraps the entire template.
11. Visit another product.
12. Ensure that there is a div with the class `fincommerce` that wraps the entire template.
...
### Ensure aria-label is showing correct value based on setting [#9672](https://github.com/dieselfox1/fincommerce-blocks/pull/9672)
...
### Stack cart and checkout buttons on smaller screens [#9603](https://github.com/dieselfox1/fincommerce-blocks/pull/9603)
...
### Remove `setFullAddressPushed` to prevent address continually pushing [#9606](https://github.com/dieselfox1/fincommerce-blocks/pull/9606)
...
Before | After
--- | ---
[before](https://github.com/dieselfox1/fincommerce-blocks/assets/3616980/dedaa44b-2a07-4fd5-9ea2-c3d1b9e13080) | [after](https://github.com/dieselfox1/fincommerce-blocks/assets/3616980/9bc56a48-88df-4e0a-af9e-98843433ca7a)


### Product Rating block: Add the block to the Single Product template by default [#9510](https://github.com/dieselfox1/fincommerce-blocks/pull/9510)
...
### Ensure inner content is not truncated on different widths [#9640](https://github.com/dieselfox1/fincommerce-blocks/pull/9640)

1. Create a new post & add the FinCommerce Just Arrived Full Hero pattern.
...
### Fix invisible Mini-Cart badge in themes without <body> background [#9601](https://github.com/dieselfox1/fincommerce-blocks/pull/9601)
...
Before | After
--- | ---
![imatge](https://github.com/dieselfox1/fincommerce-blocks/assets/3616980/f1be4c5a-b9ec-4b92-bb3d-3083ceb9f4e9) | ![imatge](https://github.com/dieselfox1/fincommerce-blocks/assets/3616980/01ed4c2f-f2a8-4fee-abba-e4c53413079c)

### Product Rating block: Add Single Product template support to the block [#9499](https://github.com/dieselfox1/fincommerce-blocks/pull/9499)
...
### Mini-Cart: Make error notifications non-dismissable [#9578](https://github.com/dieselfox1/fincommerce-blocks/pull/9578)
...
### Product Rating block: Hide rating when the product has no reviews [#9556](https://github.com/dieselfox1/fincommerce-blocks/pull/9556)
...
| Before | After |
|--------|--------|
| <img width="1239" alt="image" src="https://github.com/dieselfox1/fincommerce-blocks/assets/20469356/ff7be2fc-0326-4c7f-98d3-669f783a56b4"> | <img width="1239" alt="image" src="https://github.com/dieselfox1/fincommerce-blocks/assets/20469356/ff7be2fc-0326-4c7f-98d3-669f783a56b4"> |


On Frontend:
| Before | After |
|--------|--------|
| <img width="1238" alt="image" src="https://github.com/dieselfox1/fincommerce-blocks/assets/20469356/08f725f2-8999-4f66-b4c4-c3bd3f24d5be"> | <img width="1238" alt="image" src="https://github.com/dieselfox1/fincommerce-blocks/assets/20469356/08f725f2-8999-4f66-b4c4-c3bd3f24d5be"> |
...
8. Click on the 'Single Product' block to add it to the template. You'll be prompted to select a product from your FinCommerce store to feature in the block. Make sure to select a product that contains at least one review.
...
| Before | After |
|--------|--------|
| <img width="1223" alt="image" src="https://github.com/dieselfox1/fincommerce-blocks/assets/20469356/53975777-3f3d-4e79-9619-98f83a42cb6e"> | <img width="1244" alt="image" src="https://github.com/dieselfox1/fincommerce-blocks/assets/20469356/23df0597-df8d-44c5-8d0e-acd2942504f1"> |


On Frontend:
| Before | After |
|--------|--------|
| <img width="1224" alt="image" src="https://github.com/dieselfox1/fincommerce-blocks/assets/20469356/6676974c-973c-4087-b2bf-6a6580fea583"> | <img width="1225" alt="image" src="https://github.com/dieselfox1/fincommerce-blocks/assets/20469356/32c2b66b-1239-400c-974a-bfcf9998d68b"> |
...
| Before | After |
| ------ | ----- |
| <img width="1241" alt="image" src="https://github.com/dieselfox1/fincommerce-blocks/assets/20469356/8ada29fc-6cc3-468b-89b3-5a291415a023"> | <img width="1258" alt="image" src="https://github.com/dieselfox1/fincommerce-blocks/assets/20469356/f591756d-02f2-474d-9bfc-a37d06f7d6f4"> |


On Frontend:
| Before | After |
|--------|--------|
| <img width="1254" alt="image" src="https://github.com/dieselfox1/fincommerce-blocks/assets/20469356/c16a3a8c-ff3f-4d3e-b331-09a68ec00838"> | <img width="1246" alt="image" src="https://github.com/dieselfox1/fincommerce-blocks/assets/20469356/1e838f85-ae3a-4047-89b8-3fe765c1f3cb"> |
...
1. Enable local pickup with pickup price. For that, go to `FinCommerce -> Settings -> Shipping -> Local pickup`, under `General` Check `Enable local pickup` and `Add a price for customers who choose local pickup`, and save. Then add a price under the `Cost` input.
2. Remove the shipping methods from the WC settings (FinCommerce -> Settings -> Shipping -> Shipping zones)
...
1. Add a shipping method in `FinCommerce -> Settings -> Shipping -> Shipping zones`. Ensure the shopper's address is within the shipping zone created.
...
1. Disable local pickup. For that, go to `FinCommerce -> Settings -> Shipping -> Local pickup`, under `General` uncheck `Enable local pickup` and save.
2. Go to `FinCommerce -> Settings -> General`. Select `No location by default` under `Default customer location`
3. Remove any default(fallback) shipping rates in `FinCommerce -> Settings -> Shipping -> Shipping zones -> Locations not covered by your other zones`
...
1. Add a default(fallback) shipping rate in `FinCommerce -> Settings -> Shipping -> Shipping zones -> Locations not covered by your other zones`
...
5. Open the inserter and search for: `FinCommerce Single Product Block` (for other templates, check the table below).
...
| Template               | Block Name                               |
|------------------------|------------------------------------------|
| Single Product         | FinCommerce Single Product Block         |
| Product Catalog        | FinCommerce Product Grid Block           |
| Product Search Results | FinCommerce Product Search Results Block |
| Products by Attribute  | FinCommerce Product Attribute Block      |
| Products by Category   | FinCommerce Product Taxonomy Block       |
| Products By Tag        | FinCommerce Product Tag Block            |


### Add to Cart with Options block: Prevent page redirection when clicking on Add to Cart button [#9691](https://github.com/dieselfox1/fincommerce-blocks/pull/9691)
...
9. Click on the 'Single Product' block to add it to the template. You'll be prompted to select a product from your FinCommerce store to feature in the block. Make sure to select a product that contains at least one review.
...
### Render the single product title as an h1 when transforming from classic template [#9748](https://github.com/dieselfox1/fincommerce-blocks/pull/9748)
...
### Use a portal to render the Drawer close button in order to fix its alignment inside the Mini-Cart Contents block [#9507](https://github.com/dieselfox1/fincommerce-blocks/pull/9507)
...
Before | After
--- | ---
![imatge](https://github.com/dieselfox1/fincommerce-blocks/assets/3616980/8248bc9c-722f-49cd-b3d3-2680975f4683) | ![imatge](https://github.com/dieselfox1/fincommerce-blocks/assets/3616980/7b805947-ab1a-4530-86bd-83277279a60b)
