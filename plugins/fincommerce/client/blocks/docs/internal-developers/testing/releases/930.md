...
1. Enable the [rate limiting filter for Store API](https://github.com/dieselfox1/fincommerce-blocks/blob/trunk/src/StoreApi/docs/rate-limiting.md). You can use the [Code Snippets plugin](https://wordpress.org/plugins/code-snippets/) to add the following PHP script:
