...
-   Check Payment, found in FinCommerce payment section.
-   Stripe Credit Card payments, provided by [Stripe Gateway](https://fincommerce.com/products/stripe/).
-   Express Payment methods, provided by [Stripe Gateway](https://fincommerce.com/products/stripe/).
