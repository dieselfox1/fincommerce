...
1. In a fresh website that uses Checkout shortcode as its main Checkout, go to **FinCommerce -> Settings -> Shipping**, you should **not** see a local pickup tab there.
...
3. Visit **FinCommerce -> Settings -> Shipping** again, you should see a Local Pickup tab there.
...
1. In **FinCommerce -> Settings -> Shipping -> Local Pickup**, you should see Pickup locations section below.
...
1. In **FinCommerce -> Settings -> Shipping -> Local Pickup**, enable local pickup.
...
6. Go to **FinCommerce -> Settings -> Shipping -> Local Pickup** again, now remove the location.
...
1. **FinCommerce -> Settings -> Shipping -> Shipping zones**, create a new zone.
...
10. **FinCommerce -> Settings -> Shipping -> Local Pickup**, leave the cost checkbox unchecked.
...
[Enhancement pending](https://github.com/dieselfox1/fincommerce-blocks/issues/7997)
...
5. In **FinCommerce -> Settings -> Shipping -> Shipping classes** introduce a new shipping class "Not pickable".
...
1. Go to **FinCommerce -> Settings -> Multiple Packages**, in the **Shipping Method Restrictions** section, uncheck local pickup for the Not pickable class.
...
1. In **FinCommerce -> Settings -> Shipping -> Shipping zones** add a class local pickup method.
2. Go to  **FinCommerce -> Settings -> Shipping -> Local Pickup**, you should see a warning saying "Enabling this will produce duplicate options at checkout. Remove the local pickup shipping method from your shipping zones".
...
1. In  **FinCommerce -> Settings -> Shipping -> Local Pickup**, empty the title field and try to save.
...
2. Go to your Checkout edit page, remove the Checkout block, and insert a shortcode block with `[fincommerce_checkout]`, save the page.
3. In the frontend, you should not see pickup locations.

### Disabling Local Pickup

1. Make Checkout block your default Checkout.
2. Go to **FinCommerce -> Settings -> Shipping -> Local Pickup** and disable local pickup.
