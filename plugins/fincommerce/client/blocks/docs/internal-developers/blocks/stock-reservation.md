...
To prevent multiple customers trying to purchase the same stock when limits are in place, both FinCommerce ([4.3+](https://github.com/dieselfox1/fincommerce/pull/26395#pullrequestreview-430633490)) and the Blocks plugin have a stock reservation system which is used during checkout.
