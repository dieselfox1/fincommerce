...
This repo includes [Storybook](https://storybook.js.org) tooling so we can test and develop components in isolation. The storybook is automatically built and published to [GitHub pages](https://fincommerce.github.io/fincommerce-blocks/) on every push to the main branch.
...
For more info about individual components, refer to [Storybook](https://fincommerce.github.io/fincommerce-blocks/) or individual readme files.
...
🐞 Found a mistake, or have a suggestion? [Leave feedback about this document here.](https://github.com/dieselfox1/fincommerce/issues/new?assignees=&labels=type%3A+documentation&template=suggestion-for-documentation-improvement-correction.md&title=Feedback%20on%20./docs/contributors/storybook-and-components.md)
