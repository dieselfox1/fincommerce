jQuery( function( $ ) {
	...
	// fincommerce_params is required to continue, ensure the object exists
	if ( typeof fincommerce_params === 'undefined' ) {
		return false;
	}
	...
	$(' .fincommerce .payment-method-actions .button.delete' ).on( 'click' , function( event ) {
