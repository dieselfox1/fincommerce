/*global ajaxurl, fincommerce_term_ordering_params */
	...
	$( table_selector ).sortable({
		...
		update: function( event, ui ) {
			...
			window.wcTracks.recordEvent( 'product_attributes_ordering_term', {
				is_category:
					fincommerce_term_ordering_params.taxonomy === 'product_cat'
						? 'yes'
						: 'no',
			} );
			...
			$.post(
				ajaxurl,
				{
					action: 'fincommerce_term_ordering',
					id: termid,
					nextid: nexttermid,
					thetaxonomy: fincommerce_term_ordering_params.taxonomy
				},
				function(response) {
