...
jQuery( function ( $ ) {
	...
	var wc_password_strength_meter = {
		...
		includeMeter: function ( wrapper, field ) {
			var meter = wrapper.find( '.fincommerce-password-strength' );
			...
			if ( '' === field.val() ) {
				...
				var meter =
					'<div id="password_strength" class="fincommerce-password-strength" role="alert"></div>';
		...
		checkPasswordStrength: function ( wrapper, field ) {
			var meter = wrapper.find( '.fincommerce-password-strength' ),
				hint = wrapper.find( '.fincommerce-password-hint' ),
				hint_html =
					'<small class="fincommerce-password-hint">' +
