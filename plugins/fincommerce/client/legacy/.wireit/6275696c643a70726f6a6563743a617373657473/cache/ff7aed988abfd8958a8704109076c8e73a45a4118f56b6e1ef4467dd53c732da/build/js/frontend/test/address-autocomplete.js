		...
		Object.assign( global.window, {
			wc_checkout_params: {
				address_providers: [
					...
					{ id: 'wc-payments', name: 'FinCommerce Payments' },
...
describe( 'Address Suggestions Component', () => {
	...
	beforeEach( async () => {
		...
		billingWrapper.className = 'fincommerce-input-wrapper';
		...
		shippingWrapper.className = 'fincommerce-input-wrapper';
	...
	describe( 'DOM Initialization', () => {
		test( 'should create suggestions container for address inputs', () => {
			...
			expect( billingSuggestions.className ).toBe(
				'fincommerce-address-suggestions'
			);
