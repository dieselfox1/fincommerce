					...
					var select2_args = {
						...
						ajax: {
							...
							data:        function( params ) {
								return {
									term         : params.term,
									action       : $( this ).data( 'action' ) || 'fincommerce_json_search_products_and_variations',
					...
					var select2_args = {
						...
						ajax: {
							...
							data:        function( params ) {
								return {
									term         : params.term,
									action       : $( this ).data( 'action' ) || 'fincommerce_json_search_pages',
					...
					var select2_args = {
						...
						ajax: {
							...
							data:        function( params ) {
								return {
									term:     params.term,
									action:   'fincommerce_json_search_customers',
					...
					var select2_args = $.extend( {
						...
						ajax: {
							...
							data:        function( params ) {
								return {
									term:     params.term,
									action:   'fincommerce_json_search_product_attributes',
