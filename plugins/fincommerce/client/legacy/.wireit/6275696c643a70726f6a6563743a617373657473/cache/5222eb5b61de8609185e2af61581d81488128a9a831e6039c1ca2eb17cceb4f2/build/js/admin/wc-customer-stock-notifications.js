/* global wc_admin_customer_stock_notifications_params, fincommerce_admin_meta_boxes */
;( function( $, window ) {
	...
	$( function() {
		...
		$( '.fincommerce-customer-stock-notification #delete-action' ).on( 'click', function( e ) {
		...
		$( 'input#fincommerce_customer_stock_notifications_require_double_opt_in' )
			.on( 'change', function () {
				if ( $( this ).is( ':checked' ) ) {
