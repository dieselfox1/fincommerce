...
jQuery( function( $ ) {
	...
	function field_is_required( field, is_required ) {
		if ( is_required ) {
			...
			field.removeClass( 'validate-required fincommerce-invalid fincommerce-invalid-required-field' );
	...
	$( document.body )
		.on( 'country_to_state_changing', function( event, country, wrapper ) {
			...
			var fieldsets = $(
				'.fincommerce-billing-fields__field-wrapper,' +
				'.fincommerce-shipping-fields__field-wrapper,' +
				'.fincommerce-address-fields__field-wrapper,' +
				'.fincommerce-additional-fields__field-wrapper .fincommerce-account-fields'
			);
