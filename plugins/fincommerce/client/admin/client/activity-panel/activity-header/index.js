...
class ActivityHeader extends Component {
	render() {
		...
		const cardClassName = clsx(
			{
				'fincommerce-layout__inbox-panel-header': subtitle,
				'fincommerce-layout__activity-panel-header': ! subtitle,
			},
			className
		);
		...
		return (
			<div className={ cardClassName }>
				<div className="fincommerce-layout__inbox-title">
					...
					>
						{ countUnread > 0 && (
							<span className="fincommerce-layout__inbox-badge">
								{ unreadMessages }
							</span>
						) }
					</Text>
				</div>
				<div className="fincommerce-layout__inbox-subtitle">
					{ subtitle && (
				...
				{ menu && (
					<div className="fincommerce-layout__activity-panel-header-menu">
						{ menu }
					</div>
				) }
			</div>
