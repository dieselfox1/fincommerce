...
export const Panel = ( {
	...
	const panelClass = 'fincommerce-layout__activity-panel-wrapper';
	...
	const handleFocusOutside = ( event ) => {
		const isClickOnModalOrSnackbar =
			...
			( event.relatedTarget.closest(
				'.fincommerce-inbox-dismiss-confirmation_modal'
			) ||
	...
	return (
		...
		>
			<div
				className="fincommerce-layout__activity-panel-content"
