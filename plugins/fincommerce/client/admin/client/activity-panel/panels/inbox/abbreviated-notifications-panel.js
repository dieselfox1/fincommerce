...
export const AbbreviatedNotificationsPanel = ( { thingsToDoNextCount } ) => {
	...
	return (
		<div className="fincommerce-abbreviated-notifications">
			{ thingsToDoNextCount > 0 && ! isExtendedTaskListHidden && (
				...
				>
					<Text as="h3">
						{ __( 'Things to do next', 'fincommerce' ) }
					</Text>
					<Text as="p">
						{ sprintf(
			...
			{ ordersToProcessCount > 0 && isSetupTaskListHidden && (
				...
				>
					<Text as="h3">
						{ __( 'Orders to fulfill', 'fincommerce' ) }
					</Text>
					<Text>
						{ sprintf(
			...
			{ reviewsToModerateCount > 0 && isSetupTaskListHidden && (
				...
				>
					<Text as="h3">
						{ __( 'Reviews to moderate', 'fincommerce' ) }
					</Text>
					<Text>
						{ sprintf(
			...
			{ stockNoticesCount > 0 && isSetupTaskListHidden && (
				...
				>
					<Text as="h3">
						{ __( 'Inventory to review', 'fincommerce' ) }
					</Text>
					<Text>
						{ __(
