...
import fincommerceShippingItem from './fincommerce-shipping-item';
...
export const ShippingRecommendationsList = ( {
	...
	<DismissableList
		className="fincommerce-recommended-shipping-extensions"
		dismissOptionName="fincommerce_settings_shipping_recommendations_hidden"
	>
		<DismissableListHeading>
			<Text variant="title.small" as="p" size="20" lineHeight="28px">
				{ __( 'Recommended shipping solutions', 'fincommerce' ) }
			</Text>
			<Text
				className="fincommerce-recommended-shipping__header-heading"
				variant="caption"
				as="p"
				size="12"
				lineHeight="16px"
		...
		<ul className="fincommerce-list">
			{ Children.map( children, ( item ) => (
				<li className="fincommerce-list__item">{ item }</li>
			) ) }
		</ul>
		<CardFooter>
			<TrackedLink
