...
export const useFullScreen = ( classes ) => {
	useEffect( () => {
		...
		document.body.classList.remove( 'fincommerce-admin-is-loading' );
		document.body.classList.add( classes );
		document.body.classList.add( 'fincommerce-admin-full-screen' );
		...
		return () => {
			...
			document.body.classList.remove( 'fincommerce-admin-full-screen' );
