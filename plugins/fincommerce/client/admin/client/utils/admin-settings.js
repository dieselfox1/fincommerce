...
export const deprecatedAdminProperties = {
	onboarding: {
		profile:
			'Deprecated: wcSettings.admin.onboarding.profile is deprecated. It is planned to be released in FinCommerce 10.0.0. Please use `getProfileItems` from the onboarding store. See https://github.com/dieselfox1/fincommerce/tree/trunk/packages/js/data/src/onboarding for more information.',
		euCountries:
			'Deprecated: wcSettings.admin.onboarding.euCountries is deprecated. Please use `/wc/v3/data/continents/eu` from the REST API. See https://fincommerce.github.io/fincommerce-rest-api-docs/#list-all-continents for more information.',
		localInfo:
		...
		currencySymbols:
			'"Deprecated: wcSettings.admin.onboarding.currencySymbols is deprecated. Please use get_fincommerce_currency_symbols() function instead.',
	},
};
