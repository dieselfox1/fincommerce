...
export const Choice = ( {
	...
	const inputId = 'fincommerce-' + value.replace( /_/g, '-' );

	return (
		<div
			role="radio"
			className={ clsx(
				'fincommerce-profiler-choice-container',
				className
			) }
			...
			tabIndex={ 0 }
		>
			<div className="fincommerce-profiler-choice">
				<input
					className="fincommerce-profiler-choice-input"
					id={ inputId }
					name={ name }
					type="radio"
					value={ value }
			...
			{ selected && subOptionsComponent && (
				<div className="fincommerce-profiler-choice-sub-options">
					{ subOptionsComponent }
				</div>
			) }
		</div>
