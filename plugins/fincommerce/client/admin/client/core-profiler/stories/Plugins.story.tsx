...
const plugins = [
	{
		...
		image_url:
			'https://fincommerce.com/wp-content/plugins/wccom-plugins/obw-free-extensions/images/core-profiler/logo-jetpack.svg',
		learn_more_link: 'https://fincommerce.com/products/jetpack',
		install_priority: 8,
		is_installed: true,
		is_activated: true,
		manage_url: '',
	...
	{
		name: 'Pinterest for FinCommerce',
		description: 'Get your products in front of a highly engaged audience.',
		image_url:
			'https://fincommerce.com/wp-content/plugins/wccom-plugins/obw-free-extensions/images/core-profiler/logo-pinterest.svg',
		manage_url: 'admin.php?page=wc-admin&path=%2Fpinterest%2Flanding',
		is_built_by_wc: true,
		min_php_version: '7.3',
		key: 'pinterest-for-fincommerce',
		label: 'Showcase your products with Pinterest',
		learn_more_link:
			'https://fincommerce.com/products/pinterest-for-fincommerce',
		install_priority: 2,
		is_visible: true,
		is_installed: false,
		is_activated: false,
...
export const InstallationErrorBanner = () => (
	<div className="fincommerce-profiler-plugins">
		<PluginErrorBanner
...
export default {
	title: 'FinCommerce Admin/Core Profiler/Plugins',
	component: Plugins,
