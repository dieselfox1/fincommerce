...
export const IntroOptIn = ( {
	...
	return (
		<div
			className="fincommerce-profiler-intro-opt-in"
			data-testid="core-profiler-intro-opt-in-screen"
		>
			<Navigation percentage={ navigationProgress } />
			<div className="fincommerce-profiler-page__content fincommerce-profiler-intro-opt-in__content">
				<div className="fincommerce-profiler-welcome-image" />
				<Heading
					title={ __( 'Welcome to Woo!', 'fincommerce' ) }
				...
				/>
				<Button
					className="fincommerce-profiler-setup-store__button"
					variant="primary"
					onClick={ () =>
						sendEvent( {
				...
				>
					{ __( 'Set up my store', 'fincommerce' ) }
				</Button>
				<Button
					className="fincommerce-profiler-setup-store__button"
					variant="tertiary"
				...
				>
					{ __( 'Skip guided setup', 'fincommerce' ) }
				</Button>
				<div className="fincommerce-profiler-intro-opt-in__footer">
					<CheckboxControl
						...
						label={ interpolateComponents( {
							mixedString: __(
								'I agree to share my data to tailor my store setup experience, get more relevant content, and help make FinCommerce better for everyone. You can opt out at any time in FinCommerce settings. {{link}}Learn more about usage tracking.{{/link}}',
								'fincommerce'
							),
							components: {
								link: (
