...
import { WCUser } from '@fincommerce/data';
	...
	const defaultProps = {
		context: {
			pluginsAvailable: [
				...
				{
					key: 'fincommerce-payments',
					name: 'FinCommerce Payments',
					description: 'FinCommerce Payments description',
					image_url: 'fincommerce-payments-image-url',
					manage_url: 'fincommerce-payments-manage-url',
					is_built_by_wc: true,
					is_visible: true,
				},
			],
