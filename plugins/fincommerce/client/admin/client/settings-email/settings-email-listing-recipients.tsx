...
export const RecipientsList = ( {
	...
	return (
		<div className="fincommerce-email-listing-recipients">
			<div className="fincommerce-email-listing-recipients-to">
				{ to.join( ', ' ) }
			</div>
			{ copyCount > 0 && (
				<Tooltip
					className="fincommerce-email-listing-recipients-tooltip"
