...
const colorFieldMap = {
	fincommerce_email_base_color: 'baseColor',
	fincommerce_email_background_color: 'bgColor',
	fincommerce_email_body_background_color: 'bodyBgColor',
	fincommerce_email_text_color: 'bodyTextColor',
	fincommerce_email_footer_text_color: 'footerTextColor',
};
