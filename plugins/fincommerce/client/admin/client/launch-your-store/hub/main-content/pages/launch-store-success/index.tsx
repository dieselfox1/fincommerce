...
export const LaunchYourStoreSuccess = ( {
	...
	useFullScreen( [ 'fincommerce-launch-your-store-success' ] );
	...
	return (
		...
		>
			<div className="fincommerce-launch-store__congrats">
				<ConfettiAnimation
					delay={ 1000 }
					colors={ [
						'#DFD1FB',
				...
				/>
				<div className="fincommerce-launch-store__congrats-header-container">
					...
					>
						...
						<span>{ __( 'Back to Home', 'fincommerce' ) }</span>
					</Button>
				</div>
				<div className="fincommerce-launch-store__congrats-content">
					<h1 className="fincommerce-launch-store__congrats-heading">
						{ siteIsShowingCachedContent
							? __(
					...
					<h2 className="fincommerce-launch-store__congrats-subheading">
						{ siteIsShowingCachedContent
							? createInterpolateElement(
									...
									),
									{
										link: (
											<a
												href="https://fincommerce.com/document/configuring-fincommerce-settings/coming-soon-mode/#server-caches"
												target="_blank"
												rel="noreferrer"
											>
												{ __(
					...
					<div className="fincommerce-launch-store__congrats-midsection-container">
						<div className="fincommerce-launch-store__congrats-visit-store">
							...
							<div className="buttons-container">
								...
								>
									{ __( 'Visit your store', 'fincommerce' ) }
								</Button>
							</div>
						</div>
					...
					<h2 className="fincommerce-launch-store__congrats-main-actions-title">
