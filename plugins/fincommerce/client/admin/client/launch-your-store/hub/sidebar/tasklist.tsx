...
export const getLysTasklist = async () => {
	...
	/**
	 * This filter allows customizing the list of tasks to show in FinCommerce Launch Your Store feature.
	 *
	 * @filter fincommerce_launch_your_store_tasklist_whitelist
	 * @param {string[]} LYS_TASKS_WHITELIST Default list of task IDs to show in LYS.
	 *
	 */
	const filteredTasks = applyFilters(
		'fincommerce_launch_your_store_tasklist_whitelist',
		[ ...LYS_TASKS_WHITELIST ]
	) as string[];
