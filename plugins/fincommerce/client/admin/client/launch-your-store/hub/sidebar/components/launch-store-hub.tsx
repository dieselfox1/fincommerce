...
export const LaunchYourStoreHubSidebar = ( props: SidebarComponentProps ) => {
	...
	const sidebarDescription = __(
		'Ready to start selling? Before you launch your store, make sure you’ve completed these essential tasks. If you’d like to change your store visibility, go to FinCommerce | Settings | Site visibility.',
		'fincommerce'
	);
	...
	return (
		...
		>
			<motion.div
				className="fincommerce-edit-site-layout__header-container"
				animate={ 'view' }
			>
				<SiteHub
					variants={ {
			...
			>
				<div className="fincommerce-edit-site-sidebar-navigation-screen-essential-tasks__group-header">
					<Heading level={ 2 }>
						{ __( 'Essential Tasks', 'fincommerce' ) }
					</Heading>
				</div>
				<ItemGroup className="fincommerce-edit-site-sidebar-navigation-screen-essential-tasks__group">
					{ tasklist &&
						hasIncompleteTasks &&
				...
				{ testOrderCount > 0 && (
					<>
						<div className="fincommerce-edit-site-sidebar-navigation-screen-test-data__group-header">
							<Heading level={ 2 }>
								{ __( 'Test data', 'fincommerce' ) }
							</Heading>
						</div>
						<ItemGroup className="fincommerce-edit-site-sidebar-navigation-screen-remove-test-data__group">
							<ToggleControl
				...
				<ItemGroup className="fincommerce-edit-site-sidebar-navigation-screen-launch-store-button__group">
