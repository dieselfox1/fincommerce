		...
		<TourKit
			config={ {
				...
				options: {
					...
					classNames: 'fincommerce-lys-homescreen-status-tour-kit',
				},
				steps: [
					{
						referenceElements: {
							desktop:
								'#wp-admin-bar-fincommerce-site-visibility-badge',
						},
						meta: {
								...
								desktop: createInterpolateElement(
									...
									),
									{
										link: (
											...
											<a
												href="https://fincommerce.com/document/configuring-fincommerce-settings/coming-soon-mode/"
												target="_blank"
												rel="noreferrer"
											/>
										),
