...
// Fetch search results for a given set of URLSearchParams from the FinCommerce.com API
...
// Fetch data for the discover page from the FinCommerce.com API
...
function wpAjax(
	...
	return new Promise( ( resolve, reject ) => {
		if ( ! window.wp.updates ) {
			reject( __( 'Please reload and try again', 'fincommerce' ) );
			return;
		}
