...
export default function NoResults( props: {
	...
	function productListTitle( groupId: string ) {
		if ( groupId === 'popular-themes' ) {
			return __( 'Our favorite themes', 'fincommerce' );
		} else if ( groupId === 'business-services' ) {
			return __( 'Services to help your business grow', 'fincommerce' );
		}

		return __( 'Most popular extensions', 'fincommerce' );
	}
	...
	return (
		<div className="fincommerce-marketplace__no-results">
			{ categorySelector() }
			<div className="fincommerce-marketplace__no-results__content">
				<h2 className="fincommerce-marketplace__no-results__heading">
					{ props.showHeading ? props.heading : '' }
				</h2>
				<p className="fincommerce-marketplace__no-results__description">
					{ __(
			...
			<div className="fincommerce-marketplace__no-results__product-groups">
				{ renderProductGroups() }
			</div>
		</div>
	);
