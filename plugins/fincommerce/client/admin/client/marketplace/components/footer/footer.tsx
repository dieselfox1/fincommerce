...
import { check, commentContent, shield, people } from '@finpress/icons';
...
function FooterContent(): JSX.Element {
	return (
		<div className="fincommerce-marketplace__footer-content">
			<h2 className="fincommerce-marketplace__footer-title">
				{ __(
					'Hundreds of vetted products and services. Unlimited potential.',
					'fincommerce'
				) }
			</h2>
			<div className="fincommerce-marketplace__footer-columns">
				<IconWithText
					icon={ check }
				...
				<IconWithText
					icon={ people }
					title={ __( 'Support the ecosystem', 'fincommerce' ) }
					description={ __(
						'Our team and partners are continuously improving your extensions, themes, and FinCommerce experience.',
						'fincommerce'
					) }
				/>
			</div>
...
export default function Footer(): JSX.Element {
	return (
		<div className="fincommerce-marketplace__footer">
			<FooterContent />
		</div>
	);
}
