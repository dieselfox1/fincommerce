...
const SLIDES = [
	{
		...
		textTitle: __( '30-day money-back guarantee', 'fincommerce' ),
	},
	{
		imageUrl: getHelp,
		title: supportTitle( 'banner' ),
		textTitle: __( 'Get help when you need it', 'fincommerce' ),
	},
	{
		imageUrl: trustProducts,
		title: paymentTitle( 'banner' ),
		textTitle: __( 'Products you can trust', 'fincommerce' ),
	},
	{
		imageUrl: supportEcosystem,
		title: __( 'Support the ecosystem', 'fincommerce' ),
		textTitle: __( 'Support the ecosystem', 'fincommerce' ),
	},
];
...
export default function ProductFeaturedBanner() {
	...
	return (
		<div
			className="fincommerce-marketplace__banner"
			role="region"
					...
					{ SLIDES.map( ( slide, index ) => (
						...
						>
							<img
								src={ slide.imageUrl }
								alt=""
								className="fincommerce-marketplace__banner-image"
							/>
							<h3 className="fincommerce-marketplace__banner-title">
								{ slide.title }
							</h3>
						</li>
					) ) }
