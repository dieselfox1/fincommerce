...
function DropdownContent( props: {
	...
	return (
		<ul className="fincommerce-marketplace__category-dropdown-list">
			{ props.categories.map( ( category ) => (
				<li
					className="fincommerce-marketplace__category-dropdown-item"
					key={ category.slug }
				>
					<button
						className={ clsx(
							'fincommerce-marketplace__category-dropdown-item-button',
							{
								'fincommerce-marketplace__category-dropdown-item-button--selected':
