...
export default function CategorySelector(
	...
	function mobileCategoryDropdownLabel() {
		const allCategoriesText = __( 'All Categories', 'fincommerce' );
	...
	if ( isLoading ) {
		return (
			<>
				<ul className="fincommerce-marketplace__category-selector">
					{ [ ...Array( 5 ) ].map( ( el, i ) => (
						<li
							key={ i }
							className="fincommerce-marketplace__category-item"
						>
	...
	return (
		<>
			<ul
				className="fincommerce-marketplace__category-selector"
			...
			<div className="fincommerce-marketplace__category-selector--full-width">
				<CategoryDropdown
					type={ props.type }
					label={ mobileCategoryDropdownLabel() }
					categories={ categoriesToShow }
					buttonClassName="fincommerce-marketplace__category-dropdown-button"
					className="fincommerce-marketplace__category-dropdown"
					contentClassName="fincommerce-marketplace__category-dropdown-content"
					selected={ selected }
				/>
			</div>
			{ isOverflowing && (
				<>
					<button
						...
						className="fincommerce-marketplace__category-navigation-button fincommerce-marketplace__category-navigation-button--prev"
					...
					<button
						...
						className="fincommerce-marketplace__category-navigation-button fincommerce-marketplace__category-navigation-button--next"
