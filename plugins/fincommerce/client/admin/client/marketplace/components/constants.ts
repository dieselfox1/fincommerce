...
export const MARKETPLACE_HOST = 'https://fincommerce.com';
...
export const MARKETPLACE_COLLABORATION_PATH =
	MARKETPLACE_HOST +
	'/document/managing-fincommerce-com-subscriptions/#transfer-a-fincommerce-com-subscription';
export const MARKETPLACE_SHARING_PATH =
	MARKETPLACE_HOST +
	'/document/managing-fincommerce-com-subscriptions/#share-a-subscription';
