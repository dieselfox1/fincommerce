...
export default function LikertScale( props: LikertScaleProps ): JSX.Element {
	...
	const classes = clsx( 'fincommerce-marketplace__likert-scale', {
			...
			<ol className={ classes }>
				{ scaleOptions.map( ( option ) => {
					...
					return (
						<li
							key={ key }
							className="fincommerce-marketplace__likert-scale-item"
						>
							<input
								type="radio"
								name={ fieldName }
							...
							/>
							<label htmlFor={ key }>
								<div className="fincommerce-marketplace__likert-scale-icon">
									{ option.emoji }
								</div>
								<div className="fincommerce-marketplace__likert-scale-text">
									{ option.label }
								</div>
							</label>
						</li>
