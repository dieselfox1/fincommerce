...
function ProductCard( props: ProductCardProps ): JSX.Element {
	...
	const classNames = clsx(
		'fincommerce-marketplace__product-card',
		`fincommerce-marketplace__product-card--${ type }`,
		{
	...
	const CardLink = () => {
		return (
			<a
				ref={ linkRef }
				className="fincommerce-marketplace__product-card__link"
				href={ productUrl() }
				rel="noopener noreferrer"
				target="_blank"
				onClick={ ( e ) => {
	...
	const BusinessService = () => {
		...
		return (
			<div className="fincommerce-marketplace__business-card">
				<div
					className="fincommerce-marketplace__business-card__header"
				...
				<div className="fincommerce-marketplace__business-card__content">
					<div className="fincommerce-marketplace__business-card__main-content">
						<h2>
							<CardLink />
						</h2>
						<p className="fincommerce-marketplace__product-card__description">
							{ decodedDescription }
						</p>
					</div>
					<div className="fincommerce-marketplace__business-card__badge">
	...
	const footer = ! isBusinessService ? (
		<footer className="fincommerce-marketplace__product-card__footer">
			{ isLoading && (
				<div className="fincommerce-marketplace__product-card__price" />
			) }
	...
	const cardContent = (
		<div className="fincommerce-marketplace__product-card__content">
			{ showBigImage && (
				<div className="fincommerce-marketplace__product-card__image">
					{ ! isLoading && (
						<img
							className="fincommerce-marketplace__product-card__image-inner"
							src={ product.image }
							alt={ product.title }
						/>
					) }
			...
			<div className="fincommerce-marketplace__product-card__header">
				<div className="fincommerce-marketplace__product-card__details">
					{ showCardIcon && (
						<>
							{ isLoading && (
								<div className="fincommerce-marketplace__product-card__icon" />
							) }
							{ ! isLoading && product.icon && (
								<img
									className="fincommerce-marketplace__product-card__icon"
					...
					<div className="fincommerce-marketplace__product-card__meta">
						<h2 className="fincommerce-marketplace__product-card__title">
							<CardLink />
						</h2>
						{ showVendorLoading && (
							<p className="fincommerce-marketplace__product-card__vendor-details">
								<span className="fincommerce-marketplace__product-card__vendor" />
							</p>
						) }
						{ showVendor && (
							<p className="fincommerce-marketplace__product-card__vendor-details">
								...
								{ productVendor && isSponsored() && (
									<span
										aria-hidden="true"
										className="fincommerce-marketplace__product-card__vendor-details__separator"
									>
										·
									</span>
								) }
								{ isSponsored() && (
									<span className="fincommerce-marketplace__product-card__sponsored-label">
										{ __( 'Sponsored', 'fincommerce' ) }
									</span>
								) }
							</p>
						) }
	...
	const CardWrapper = () => {
		...
		return (
			<div className="fincommerce-marketplace__product-card-wrapper">
