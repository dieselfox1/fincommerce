...
import { parseAdminUrl } from '@fincommerce/navigation';
...
/**
 * Records a payments-related event with the FinCommerce Tracks system.
 *
...
export const recordPaymentsEvent = (
	...
	// Capture the business registration country code from the FinCommerce settings if not provided.
...
/**
 * Records a payments-provider-related event with the FinCommerce Tracks system.
 *
...
/**
 * Records a payments onboarding-related event with the FinCommerce Tracks system.
 *
