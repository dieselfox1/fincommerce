...
export const PaymentMethodListItem = ( {
	...
	return (
		<div
			id={ method.id }
			className="fincommerce-list__item fincommerce-list__item-enter-done"
			{ ...props }
		>
			<div className="fincommerce-list__item-inner">
				...
				{ method.id === 'apple_google' && (
					<div className="fincommerce-list__item-multi">
						<div className="fincommerce-list__item-multi-row multi-row-space">
							<div className="fincommerce-list__item-before">
								<img
									src={ method.icon }
									alt={ method.title + ' logo' }
						...
						<div className="fincommerce-list__item-multi-row">
							<div className="fincommerce-list__item-before">
								<img
				...
				<div className="fincommerce-list__item-after">
					<div className="fincommerce-list__item-after__actions wc-settings-prevent-change-event">
						<ToggleControl
							checked={
