...
export default function PaymentMethodsSelection() {
	...
	return (
		<div className="settings-payments-onboarding-modal__step--content">
			<div className="fincommerce-recommended-payment-methods">
				<div className="fincommerce-recommended-payment-methods__header">
					<div className="fincommerce-recommended-payment-methods__header--title">
					...
					<div className="fincommerce-recommended-payment-methods__header--description">
						{ __(
				...
				<div className="fincommerce-recommended-payment-methods__list">
					<div
				...
				<div
					className={ clsx(
						'fincommerce-recommended-payment-methods__list_footer',
						{
									...
									const eventProps = {
										...
										business_country:
											window.wcSettings?.admin
												?.fincommerce_payments_nox_profile
