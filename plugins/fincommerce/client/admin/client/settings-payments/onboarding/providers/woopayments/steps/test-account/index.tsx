...
const TestDriveLoader: React.FunctionComponent< {
	...
	<Loader className="fincommerce-payments-test-account-step__preloader">
		<Loader.Layout className="fincommerce-payments-test-account-step__preloader-layout">
			<Loader.Illustration>
				<img
					src={ `${ WC_ASSET_URL }images/onboarding/test-account-setup.svg` }
					alt={ __( 'Setup', 'fincommerce' ) }
					style={ { maxWidth: '223px' } }
				/>
			</Loader.Illustration>

			<Loader.Title>
				{ title || __( 'Finishing payments setup', 'fincommerce' ) }
			</Loader.Title>
...
const PHASE_MESSAGES = [
	__( 'Setting up your test account', 'fincommerce' ),
	__( 'Finishing payments setup', 'fincommerce' ),
	__( 'Almost there!', 'fincommerce' ),
];
...
const TestAccountStep = () => {
	...
	const actions = isAccountAlreadyExistsError
		? [
				{
					label: __( 'Reset Account', 'fincommerce' ),
		...
		: [
				...
				{
					label: __( 'Cancel', 'fincommerce' ),
					variant: 'secondary' as const,
					className:
						'fincommerce-payments-test-account-step__error-cancel-button',
					onClick: () => {
						recordPaymentsOnboardingEvent(
							'woopayments_onboarding_modal_click',
							{
	...
	return (
		<div className="fincommerce-payments-test-account-step">
			...
			{ ( status === 'error' || status === 'blocked' ) && (
				<Notice
					...
					className="fincommerce-payments-test-account-step__error"
				>
					<p className="fincommerce-payments-test-account-step__error-message">
						{ errorMessage ||
							__(
