...
export const WooPaymentsPostSandboxAccountSetupModal = ( {
	 ...
	 * Redirects the user to the FinCommerce admin store setup page.
	 */
			...
			{ isOpen && (
				...
				>
					<div className="fincommerce-woopayments-modal__content">
						...
						<div className="fincommerce-woopayments-modal__content__item">
							<h2>{ __( "What's next:", 'fincommerce' ) }</h2>
						</div>
					...
					<div className="fincommerce-woopayments-modal__actions">
						...
						>
							{ __( 'Continue store setup', 'fincommerce' ) }
						</Button>
						{ ! devMode && (
							<Button
								variant="secondary"
							...
							>
								{ __( 'Activate payments', 'fincommerce' ) }
							</Button>
						) }
					</div>
				</Modal>
