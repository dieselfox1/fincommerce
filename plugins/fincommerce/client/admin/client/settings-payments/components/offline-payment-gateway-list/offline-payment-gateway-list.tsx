...
import { type OfflinePaymentMethodProvider } from '@fincommerce/data';
...
export const OfflinePaymentGatewayListItem = ( {
	...
	return (
		<SortableItem
			...
			id={ gateway.id }
			className={
				'fincommerce-list__item fincommerce-list__item-enter-done' +
