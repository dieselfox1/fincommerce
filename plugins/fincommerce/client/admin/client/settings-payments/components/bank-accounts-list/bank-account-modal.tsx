...
export const BankAccountModal = ( {
	...
	return (
		<Modal
			...
			title={
				account
					? __( 'Edit bank account', 'fincommerce' )
					: __( 'Add a bank account', 'fincommerce' )
			}
		...
		>
			<div className={ 'bank-account-modal__content' }>
				<p className={ 'bank-account-modal__description' }>
					{ account
						? __( 'Edit your bank account details.', 'fincommerce' )
						: __(
				...
				<TextControl
					className={ 'bank-account-modal__field is-required' }
					label={ __( 'Account Name', 'fincommerce' ) }
					required
				...
				<TextControl
					...
					label={ __( 'Bank Name', 'fincommerce' ) }
				...
				<TextControl
					className={ 'bank-account-modal__field' }
					label={ __( 'BIC / SWIFT', 'fincommerce' ) }
					value={ formData.bic }
