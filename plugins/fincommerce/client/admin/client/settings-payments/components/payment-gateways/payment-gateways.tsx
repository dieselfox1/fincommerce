...
export const PaymentGateways = ( {
	...
	/**
	 * Generates a list of country options from the FinCommerce settings.
	 */
		...
		<div className="settings-payment-gateways">
			<div className="settings-payment-gateways__header">
				<div className="settings-payment-gateways__header-title">
					{ __( 'Payment providers', 'fincommerce' ) }
				</div>
				<div className={ selectContainerClass }>
					<CountrySelector
						className="fincommerce-select-control__country"
						label={ __( 'Business location:', 'fincommerce' ) }
						placeholder={ '' }
						value={
							countryOptions.find(
								( country ) =>
						...
						onChange={ ( currentSelectedCountry: string ) => {
							...
							apiFetch( {
								...
								if (
									...
									window.wcSettings.admin.fincommerce_payments_nox_profile.business_country_code =
										currentSelectedCountry;
								}
