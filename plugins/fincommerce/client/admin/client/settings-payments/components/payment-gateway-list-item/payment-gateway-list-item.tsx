...
export const PaymentGatewayListItem = ( {
	...
	return (
		<div
			id={ gateway.id }
			className={ `transitions-disabled fincommerce-list__item fincommerce-list__item-enter-done fincommerce-item__payment-gateway ${
				itemIsWooPayments
					? `fincommerce-item__fincommerce-payments`
					: ''
			} ${
		...
		>
			<div className="fincommerce-list__item-inner">
				<div className="fincommerce-list__item-before">
					...
					{ gateway.icon && (
						<img
							className={ 'fincommerce-list__item-image' }
							src={ gateway.icon }
				...
				<div className="fincommerce-list__item-text">
					<span className="fincommerce-list__item-title">
						...
						{ gateway.supports?.includes( 'subscriptions' ) && (
							<Tooltip
								...
								children={
									<img
										className="fincommerce-list__item-recurring-payments-icon"
										src={
											WC_ASSET_URL +
					...
					<span
						className="fincommerce-list__item-content"
				...
				<div className="fincommerce-list__item-buttons">
					<div className="fincommerce-list__item-buttons__actions">
				...
				<div className="fincommerce-list__item-after">
					<div className="fincommerce-list__item-after__actions">
						<EllipsisMenu
							label={ __(
