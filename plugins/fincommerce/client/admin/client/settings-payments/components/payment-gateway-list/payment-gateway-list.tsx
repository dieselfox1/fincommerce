					...
					case PaymentsProviderType.OfflinePmsGroup:
						...
						return (
							...
							>
								...
								<div
									id={ offlinePmsGroup.id }
									className="transitions-disabled fincommerce-list__item clickable-list-item enter-done"
									onClick={ () => {
										navigate(
											removeOriginFromURL(
								...
								>
									<div className="fincommerce-list__item-inner">
										...
										<div className="fincommerce-list__item-after centered no-buttons">
											<div className="fincommerce-list__item-after__actions">
												<a
													className="fincommerce-list__item-after__actions__arrow"
													href={
														offlinePmsGroup
															.management._links
															.settings.href
