...
export const IncentiveBanner = ( {
	...
	return (
		<Card className="fincommerce-incentive-banner" isRounded={ true }>
			<div className="fincommerce-incentive-banner__content">
				<div className={ 'fincommerce-incentive-banner__image' }>
					<img
						src={
							WC_ASSET_URL +
							'images/settings-payments/incentives-illustration.svg'
						}
						alt={ __( 'Incentive illustration', 'fincommerce' ) }
					/>
				</div>
				<CardBody className="fincommerce-incentive-banner__body">
					<StatusBadge
						status="has_incentive"
						message={ __( 'Limited time offer', 'fincommerce' ) }
					/>

					<div className={ 'fincommerce-incentive-banner__copy' }>
						<h2>{ incentive.title }</h2>
						<p>{ incentive.description }</p>
					</div>

					<div className={ 'fincommerce-incentive-banner__terms' }>
					...
					<div className={ 'fincommerce-incentive-banner__actions' }>
						<Button
							variant={ 'primary' }
							isBusy={ isSubmitted }
