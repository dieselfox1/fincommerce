...
class HistoricalDataLayout extends Component {
	render() {
		...
		return (
			<Fragment>
				<SectionHeader
					title={ __( 'Import historical data', 'fincommerce' ) }
				/>
				<div className="fincommerce-settings__wrapper">
					<div className="fincommerce-setting">
						<div className="fincommerce-setting__input">
							<span className="fincommerce-setting__help">
								{ __(
									'This tool populates historical analytics data by processing customers ' +
										'and orders created prior to activating FinCommerce Admin.',
									'fincommerce'
								) }
							</span>
							{ status !== 'finished' && (
