...
function HistoricalDataActions( {
	...
	const getActions = () => {
		...
		if (
			...
			return (
				<Fragment>
					<Button
						className="fincommerce-settings-historical-data__action-button"
						isPrimary
						onClick={ onStopImport }
					>
						{ __( 'Stop Import', 'fincommerce' ) }
					</Button>
					<div className="fincommerce-setting__help fincommerce-settings-historical-data__action-help">
						{ __(
		...
		return (
			<Fragment>
				<Button isSecondary onClick={ reimportData }>
					{ __( 'Re-import Data', 'fincommerce' ) }
				</Button>
				<Button isSecondary onClick={ deletePreviousData }>
					{ __( 'Delete Previously Imported Data', 'fincommerce' ) }
				</Button>
			</Fragment>
		);
	};
	...
	return (
		<div className="fincommerce-settings__actions fincommerce-settings-historical-data__actions">
			{ getActions() }
		</div>
	);
}
