...
const TAXES_REPORT_CHARTS_FILTER = 'fincommerce_admin_taxes_report_charts';
const TAXES_REPORT_FILTERS_FILTER = 'fincommerce_admin_taxes_report_filters';
const TAXES_REPORT_ADVANCED_FILTERS_FILTER =
	'fincommerce_admin_taxes_report_advanced_filters';
 ...
 *
 * @filter fincommerce_admin_taxes_report_charts
 * @param {Array.<chart>} charts Report charts.
 */
export const charts = applyFilters( TAXES_REPORT_CHARTS_FILTER, [
	{
		key: 'total_tax',
		label: __( 'Total tax', 'fincommerce' ),
		order: 'desc',
		orderby: 'total_tax',
		type: 'currency',
	},
	{
		key: 'order_tax',
		label: __( 'Order tax', 'fincommerce' ),
		order: 'desc',
		orderby: 'order_tax',
		type: 'currency',
	},
	{
		key: 'shipping_tax',
		label: __( 'Shipping tax', 'fincommerce' ),
		order: 'desc',
 ...
 *
 * @filter fincommerce_admin_taxes_report_advanced_filters
...
const filterValues = [
	{ label: __( 'All taxes', 'fincommerce' ), value: 'all' },
	{
		...
		settings: {
			...
			labels: {
				...
				title: __( 'Compare Tax Codes', 'fincommerce' ),
 ...
 *
 * @filter fincommerce_admin_taxes_report_filters
