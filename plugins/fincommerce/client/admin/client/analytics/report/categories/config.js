...
const CATEGORY_REPORT_CHARTS_FILTER =
	'fincommerce_admin_categories_report_charts';
const CATEGORY_REPORT_FILTERS_FILTER =
	'fincommerce_admin_categories_report_filters';
const CATEGORY_REPORT_ADVANCED_FILTERS_FILTER =
	'fincommerce_admin_category_report_advanced_filters';
 ...
 *
 * @filter fincommerce_admin_categories_report_charts
 ...
 *
 * @filter fincommerce_admin_category_report_advanced_filters
...
const filterValues = [
	{
		label: __( 'All categories', 'fincommerce' ),
		value: 'all',
	},
	{
		label: __( 'Single category', 'fincommerce' ),
		...
		subFilters: [
			{
				...
				settings: {
					...
					labels: {
						...
						button: __( 'Single Category', 'fincommerce' ),
					},
				},
			},
		],
	},
	{
		...
		settings: {
			...
			labels: {
				...
				title: __( 'Compare Categories', 'fincommerce' ),
 ...
 *
 * @filter fincommerce_admin_categories_report_filters
