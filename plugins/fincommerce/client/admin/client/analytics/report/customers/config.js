...
const CUSTOMERS_REPORT_FILTERS_FILTER =
	'fincommerce_admin_customers_report_filters';
const CUSTOMERS_REPORT_ADVANCED_FILTERS_FILTER =
	'fincommerce_admin_customers_report_advanced_filters';
 ...
 *
 * @filter fincommerce_admin_customers_report_filters
...
export const filters = applyFilters( CUSTOMERS_REPORT_FILTERS_FILTER, [
	{
		...
		showFilters: () => true,
		filters: [
			{ label: __( 'All Customers', 'fincommerce' ), value: 'all' },
			{
				label: __( 'Single Customer', 'fincommerce' ),
				...
				subFilters: [
					{
						...
						settings: {
							...
							labels: {
								...
								button: __( 'Single Customer', 'fincommerce' ),
							},
						},
					},
				],
 ...
 *
 * @filter fincommerce_admin_customers_report_advanced_filters
...
export const advancedFilters = applyFilters(
	CUSTOMERS_REPORT_ADVANCED_FILTERS_FILTER,
	{
		...
		filters: {
			name: {
				labels: {
					add: __( 'Name', 'fincommerce' ),
					placeholder: __( 'Search', 'fincommerce' ),
					remove: __( 'Remove customer name filter', 'fincommerce' ),
					rule: __(
					...
					filter: __( 'Select customer name', 'fincommerce' ),
				},
				rules: [
					{
						value: 'includes',
			...
			country: {
				labels: {
					add: __( 'Country / Region', 'fincommerce' ),
					placeholder: __( 'Search', 'fincommerce' ),
					remove: __(
					...
					filter: __( 'Select country / region', 'fincommerce' ),
				},
				rules: [
					{
						value: 'includes',
						...
						label: _x( 'Includes', 'countries', 'fincommerce' ),
					},
					{
						value: 'excludes',
						...
						label: _x( 'Excludes', 'countries', 'fincommerce' ),
					},
				],
				input: {
					component: 'Search',
			...
			email: {
				labels: {
					add: __( 'Email', 'fincommerce' ),
					placeholder: __( 'Search customer email', 'fincommerce' ),
					remove: __( 'Remove customer email filter', 'fincommerce' ),
					rule: __(
					...
					filter: __( 'Select customer email', 'fincommerce' ),
				},
				rules: [
					{
						value: 'includes',
			...
			orders_count: {
				labels: {
					add: __( 'No. of Orders', 'fincommerce' ),
					remove: __( 'Remove order filter', 'fincommerce' ),
					rule: __(
			...
			total_spend: {
				labels: {
					add: __( 'Total Spend', 'fincommerce' ),
					remove: __( 'Remove total spend filter', 'fincommerce' ),
					rule: __(
			...
			registered: {
				labels: {
					add: __( 'Registered', 'fincommerce' ),
					remove: __( 'Remove registered filter', 'fincommerce' ),
					rule: __(
					...
					filter: __( 'Select registered date', 'fincommerce' ),
				},
				rules: [
					{
						value: 'before',
						...
						label: _x( 'Before', 'date', 'fincommerce' ),
					},
					{
						value: 'after',
						...
						label: _x( 'After', 'date', 'fincommerce' ),
					},
					{
						value: 'between',
						/* translators: Sentence fragment, logical, "Between" refers to average order value of a customer, between two given amounts. Screenshot for context: https://cloudup.com/cCsm3GeXJbE */
						label: _x( 'Between', 'date', 'fincommerce' ),
					},
				],
				input: {
					component: 'Date',
			...
			last_active: {
				labels: {
					add: __( 'Last active', 'fincommerce' ),
					remove: __( 'Remove last active filter', 'fincommerce' ),
					rule: __(
