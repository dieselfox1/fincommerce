...
const STOCK_REPORT_ADVANCED_FILTERS_FILTER =
	'fincommerce_admin_stock_report_advanced_filters';
 ...
 *
 * @filter fincommerce_admin_stock_report_advanced_filters
 ...
 *
 * @filter fincommerce_admin_stock_report_filters
...
export const filters = applyFilters( STOCK_REPORT_FILTERS_FILTER, [
	{
		...
		filters: [
			...
			{
				label: __( 'Low stock', 'fincommerce' ),
				value: 'lowstock',
			},
			{ label: __( 'In stock', 'fincommerce' ), value: 'instock' },
			{
	...
	{
		label: __( 'Filter by', 'fincommerce' ),
		staticParams: [ 'paged', 'per_page' ],
		param: 'filter',
