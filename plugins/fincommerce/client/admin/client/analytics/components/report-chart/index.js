...
import { Chart, AnalyticsError } from '@fincommerce/components';
import {
	getReportChartData,
...
export class ReportChart extends Component {
	...
	renderChart( mode, isRequesting, chartData, legendTotals ) {
		...
		const emptyMessage = emptySearchResults
			? __( 'No data for the current search', 'fincommerce' )
			: __( 'No data for the selected date range', 'fincommerce' );
