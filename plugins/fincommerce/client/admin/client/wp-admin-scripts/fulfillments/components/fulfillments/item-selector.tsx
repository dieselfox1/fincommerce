...
export default function ItemSelector( { editMode }: ItemSelectorProps ) {
	...
	return (
		<ul className="fincommerce-fulfillment-item-list">
			<li>
				<div className="fincommerce-fulfillment-item-bulk-select">
					{ editMode && (
						<CheckboxControl
							onChange={ () => {
					...
					<div className="fincommerce-fulfillment-item-bulk-select__label">
						{ sprintf(
