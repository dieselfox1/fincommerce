...
export default function LockLabel( { message }: { message: string } ) {
	return (
		<div className="fincommerce-fulfillment-lock-label">
			<span className="fincommerce-fulfillment-lock-label__icon">
				<svg
					width="10"
					height="15"
					viewBox="0 0 10 15"
			...
			<span className="fincommerce-fulfillment-lock-label__text">
				{ message ||
					__(
