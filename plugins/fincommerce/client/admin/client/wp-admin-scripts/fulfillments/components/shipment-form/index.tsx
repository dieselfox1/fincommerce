	...
	return (
		<FulfillmentCard
			...
			header={
				<>
					<TruckIcon />
					<h3>{ __( 'Shipment Information', 'fincommerce' ) }</h3>
				</>
			}
		>
			<div className="fincommerce-fulfillment-shipment-information-options">
				<div className="fincommerce-fulfillment-shipment-information-option-tracking-number">
					<CheckboxControl
						type="radio"
				...
				<div className="fincommerce-fulfillment-shipment-information-option-manual-entry">
					<CheckboxControl
						type="radio"
						name={ randomRadioGroupName }
						...
						label={ __( 'Enter manually', 'fincommerce' ) }
						__nextHasNoMarginBottom
					/>
					{ selectedOption === SHIPMENT_OPTION_MANUAL_ENTRY && (
				...
				<div className="fincommerce-fulfillment-shipment-information-option-no-info">
					<CheckboxControl
						type="radio"
						name={ randomRadioGroupName }
						...
						label={ __( 'No shipment information', 'fincommerce' ) }
						__nextHasNoMarginBottom
					/>
				</div>
			</div>
