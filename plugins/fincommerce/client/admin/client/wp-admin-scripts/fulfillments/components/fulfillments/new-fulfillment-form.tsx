...
const NewFulfillmentForm: React.FC = () => {
	...
	return (
		<div
			className={ [
				'fincommerce-fulfillment-new-fulfillment-form',
				isEditing
					? 'fincommerce-fulfillment-new-fulfillment-form__disabled'
					: '',
				fulfillments.length === 0
					? 'fincommerce-fulfillment-new-fulfillment-form__first'
					: '',
			].join( ' ' ) }
		>
			<div
				className={ [
					'fincommerce-fulfillment-new-fulfillment-form__header',
			...
			{ ! isEditing && openSection === 'order' && (
				<div className="fincommerce-fulfillment-new-fulfillment-form__content">
