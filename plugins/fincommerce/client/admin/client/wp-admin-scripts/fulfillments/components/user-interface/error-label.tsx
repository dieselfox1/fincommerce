...
export default function ErrorLabel( { error }: { error: string } ) {
	...
	return (
		<div className="fincommerce-fulfillment-error-label" ref={ labelRef }>
			<span className="fincommerce-fulfillment-error-label__icon">
				<svg
					width="16"
					height="16"
					viewBox="0 0 16 16"
			...
			<span className="fincommerce-fulfillment-error-label__text">
				{ error }
			</span>
		</div>
	);
