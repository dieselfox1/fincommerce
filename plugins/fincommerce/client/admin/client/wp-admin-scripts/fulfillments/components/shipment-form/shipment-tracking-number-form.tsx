...
const ShipmentProviderIcon = ( { providerKey }: { providerKey: string } ) => {
	...
	return (
		<div className="fincommerce-fulfillment-shipment-provider-icon">
...
export default function ShipmentTrackingNumberForm() {
	...
	const handleTrackingNumberLookup = async () => {
		...
		try {
			...
			setError(
				__( 'Failed to fetch shipment information.', 'fincommerce' )
			);
		} finally {
			setIsLoading( false );
		}
	...
	return (
		<>
			...
			{ editMode ? (
				...
				<>
					<div className="fincommerce-fulfillment-input-container">
						<h4>{ __( 'Tracking Number', 'fincommerce' ) }</h4>
						<div className="fincommerce-fulfillment-input-group space-between">
							<span
								onClick={ () => {
									setEditMode( true );
						...
						{ isAmbiguousProvider && (
							<Flex direction={ 'column' } gap={ 0 }>
								...
								<Button
									variant="link"
									size="small"
									className="fincommerce-fulfillment-description-button"
									onClick={ () => {
										setSelectedOption(
					...
					<div className="fincommerce-fulfillment-input-container">
						<h4>{ __( 'Tracking URL', 'fincommerce' ) }</h4>
						<div className="fincommerce-fulfillment-input-group">
							<ExternalLink
								href={ trackingUrl }
								style={ {
