...
export default function FulfillmentEditor( {
	...
	return (
		<div
			className={ [
				'fincommerce-fulfillment-stored-fulfillment-list-item',
				disabled
					? 'fincommerce-fulfillment-stored-fulfillment-list-item__disabled'
					: '',
			].join( ' ' ) }
		>
			<div
				className={ [
					'fincommerce-fulfillment-stored-fulfillment-list-item-header',
					expanded ? 'is-open' : '',
				].join( ' ' ) }
						...
						sprintf(
							isEditing
								? /* translators: %s: Fulfillment ID */
								  __( 'Editing fulfillment #%s', 'fincommerce' )
								: /* translators: %s: Fulfillment ID */
								  __( 'Fulfillment #%s', 'fincommerce' ),
							index + 1
						)
					}
				</h3>
			...
			{ expanded && (
				<div className="fincommerce-fulfillment-stored-fulfillment-list-item-content">
					...
					<ShipmentFormProvider fulfillment={ fulfillment }>
						...
						>
							...
							{ fulfillmentLockState.isLocked ? (
								<div className="fincommerce-fulfillment-item-lock-container">
									<LockLabel
										message={ fulfillmentLockState.reason }
									/>
								</div>
							) : (
								<div className="fincommerce-fulfillment-item-actions">
									{ ! isEditing ? (
										<>
