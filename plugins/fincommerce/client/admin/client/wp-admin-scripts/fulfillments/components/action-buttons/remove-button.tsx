...
export default function RemoveButton( {
	...
	return (
		<>
			...
			{ isOpen && (
				<Modal
					title={ __( 'Remove fulfillment', 'fincommerce' ) }
					onRequestClose={ closeModal }
					size="medium"
					isDismissible={ false }
					className="fincommerce-fulfillment-modal"
				>
					<p className="fincommerce-fulfillment-modal-text">
						{ __(
					...
					<div className="fincommerce-fulfillment-modal-actions">
						<Button
							variant="link"
							onClick={ closeModal }
							__next40pxDefaultSize
						...
						<Button
							...
							__next40pxDefaultSize
						>
							{ __( 'Remove fulfillment', 'fincommerce' ) }
						</Button>
					</div>
				</Modal>
			) }
