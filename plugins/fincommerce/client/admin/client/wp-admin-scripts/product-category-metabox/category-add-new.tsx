		...
		async ( value = '' ) => {
			...
			return apiFetch< CategoryTerm[] >( {
				url: addQueryArgs(
					...
					{
						term: value,
						action: 'fincommerce_json_search_categories',
	...
	return (
		<div id={ CATEGORY_TERM_NAME + '-adder' }>
			<a
				...
				aria-label={ __( 'Add new category', 'fincommerce' ) }
			>
				{ __( '+ Add new category', 'fincommerce' ) }
			</a>
			{ showAddNew && (
				<div id="product_cat-add" className="category-add">
					...
					<input
						...
						placeholder={ __( 'New category name', 'fincommerce' ) }
					...
					>
						{ __( 'Parent category:', 'fincommerce' ) }
					</label>
					<SelectControl< CategoryTerm >
						{ ...selectProps }
						label={ __( 'Parent category:', 'fincommerce' ) }
						items={ fetchedItems }
						selected={ categoryParent || null }
						placeholder={ __( 'Find category', 'fincommerce' ) }
					...
					<input
						...
						value={ __( 'Add new category', 'fincommerce' ) }
