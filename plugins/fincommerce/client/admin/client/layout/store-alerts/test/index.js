...
describe( 'StoreAlerts', () => {
	...
	it( 'should show the alert title and content', () => {
		...
		expect(
			container.querySelector( '.fincommerce-store-alerts__title' )
				.textContent
		).toBe( 'Alert title 1' );
		expect(
			container.querySelector( '.fincommerce-store-alerts__message' )
				.textContent
	...
	it( 'should not show the pagination for a single alert', () => {
		...
		expect(
			container.querySelector( '.fincommerce-store-alerts__pagination' )
		).toBeNull();
	} );
	...
	it( 'should show the actions for an alert that contains actions', () => {
		...
		expect(
			container.querySelector(
				'.components-button:not(.fincommerce-store-alerts__close)'
			).textContent
		).toBe( 'Click me!' );
		expect(
			container
		...
		expect(
			container.querySelector( '.fincommerce-store-alerts__snooze' )
