...
const QUEUE_OPTION = 'fincommerce_admin_transient_notices_queue';
const QUEUED_NOTICE_FILTER = 'fincommerce_admin_queued_notice_filter';
...
export function TransientNotices( props ) {
	...
	useEffect( () => {
		getCurrentUserNotices().forEach( ( queuedNotice ) => {
			 ...
			 *
			 * @filter fincommerce_admin_queued_notice_filter
