...
export const PAGES_FILTER = 'fincommerce_admin_pages_list';

export const getPages = ( reports = [] ) => {
	const pages = [];
	const initialBreadcrumbs = [
		[ '', getAdminSetting( 'fincommerceTranslation' ) ],
	];

	pages.push( {
		container: Homescreen,
		path: '/',
		breadcrumbs: [ ...initialBreadcrumbs, __( 'Home', 'fincommerce' ) ],
	...
	if ( window.wcAdminFeatures.analytics ) {
		pages.push( {
			...
			breadcrumbs: [
				...initialBreadcrumbs,
				[ '/analytics/overview', __( 'Analytics', 'fincommerce' ) ],
				__( 'Overview', 'fincommerce' ),
			],
		...
		pages.push( {
			...
			breadcrumbs: [
				...initialBreadcrumbs,
				[ '/analytics/revenue', __( 'Analytics', 'fincommerce' ) ],
	...
	if ( window.wcAdminFeatures.marketing ) {
		pages.push( {
			...
			breadcrumbs: [
				...initialBreadcrumbs,
				[ '/marketing', __( 'Marketing', 'fincommerce' ) ],
				__( 'Overview', 'fincommerce' ),
			],
			wpOpenMenu: 'toplevel_page_fincommerce-marketing',
			navArgs: {
				id: 'fincommerce-marketing-overview',
			},
			capability: 'view_fincommerce_reports',
		} );
	}
	...
	if ( isFeatureEnabled( 'marketplace' ) ) {
		pages.push( {
			...
			path: '/extensions',
			breadcrumbs: [
				[ '/extensions', __( 'Extensions', 'fincommerce' ) ],
				__( 'Extensions', 'fincommerce' ),
			],
			wpOpenMenu: 'toplevel_page_fincommerce',
			capability: 'manage_fincommerce',
			navArgs: {
				id: 'fincommerce-marketplace',
			},
		} );
	}
	...
	if ( isFeatureEnabled( 'product_block_editor' ) ) {
		...
		pages.push( {
			...
			path: '/add-product',
			breadcrumbs: [
				[ '/add-product', __( 'Product', 'fincommerce' ) ],
		...
		pages.push( {
			...
			breadcrumbs: [
				[ '/edit-product', __( 'Product', 'fincommerce' ) ],
				__( 'Edit Product', 'fincommerce' ),
			],
			navArgs: {
	...
	pages.push( {
		...
		breadcrumbs: [
			[ '/edit-product', __( 'Product', 'fincommerce' ) ],
			__( 'Edit Product Variation', 'fincommerce' ),
		],
		navArgs: {
			id: 'fincommerce-edit-product',
		},
	...
	if ( window.wcAdminFeatures[ 'launch-your-store' ] ) {
		pages.push( {
			...
			breadcrumbs: [
				...initialBreadcrumbs,
				__( 'Launch Your Store', 'fincommerce' ),
			],
			layout: {
				header: false,
				footer: true,
	...
	if ( window.wcAdminFeatures[ 'wc-pay-welcome-page' ] ) {
		pages.push( {
			...
			breadcrumbs: [
				[ '/wc-pay-welcome-page', __( 'WooPayments', 'fincommerce' ) ],
				__( 'WooPayments', 'fincommerce' ),
			],
			navArgs: {
				id: 'fincommerce-wc-pay-welcome-page',
			},
			wpOpenMenu: 'toplevel_page_fincommerce-wc-pay-welcome-page',
			capability: 'manage_fincommerce',
		} );
	}

	/**
	 * List of FinCommerce Admin pages.
	 *
	 * @filter fincommerce_admin_pages_list
...
export const Controller = ( { ...props } ) => {
	...
	useEffect( () => {
		...
		window.document.body.classList.remove( 'fincommerce-admin-is-loading' );
	}, [] );
