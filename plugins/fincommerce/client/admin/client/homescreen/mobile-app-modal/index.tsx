...
export const MobileAppModal = () => {
	...
	const onFinish = () => {
		updateOptions( {
			fincommerce_admin_dismissed_mobile_app_modal: 'yes',
		} ).then( () =>
		...
		<>
			{ guideIsOpen && (
				<Guide
					onFinish={ onFinish }
					contentLabel=""
					className={ 'fincommerce__mobile-app-welcome-modal' }
					pages={ [
						{
							content: (
	...
	const addMobileAppHelpEntry = useCallback(
		(
			...
			return [
				...helpMenuEntries,
				{
					title: __( 'Get the FinCommerce app', 'fincommerce' ),
					link: getAdminLink(
...
registerPlugin( 'fincommerce-mobile-app-modal', {
