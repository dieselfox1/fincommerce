...
import { useUserPreferences, pluginsStore } from '@fincommerce/data';
...
export const StatsOverview = () => {
	...
	return (
		<Card
			size="large"
			className="fincommerce-stats-overview fincommerce-homescreen-card"
		>
			...
			<TabPanel
				className="fincommerce-stats-overview__tabs"
				onSelect={ ( period ) => {
				...
				tabs={ [
					{
						title: __( 'Today', 'fincommerce' ),
						name: 'today',
					},
					{
						title: __( 'Week to date', 'fincommerce' ),
						name: 'week',
					},
					{
						title: __( 'Month to date', 'fincommerce' ),
						name: 'month',
					},
				] }
			>
			...
			<CardFooter>
				<Link
					className="fincommerce-stats-overview__more-btn"
				...
				>
					{ __( 'View detailed stats', 'fincommerce' ) }
				</Link>
			</CardFooter>
		</Card>
	);
