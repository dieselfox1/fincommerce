...
async function enableXStateV4Inspect() {
	...
	console.log(
		'Devtools: XState V4 inspector enabled for FinCommerce Admin. To disable, type localStorage.setItem("xstate_inspect", "false")'
	);
}
...
async function enableXStateV5Inspect() {
	...
	// eslint-disable-next-line no-console
	console.log(
		'Devtools: XState V5 inspector enabled for FinCommerce Admin. To disable, type localStorage.setItem("xstateV5_inspect", "false")'
	);
}
