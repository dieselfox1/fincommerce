	...
	return (
		<>
			<input
				...
				name="country"
				type="text"
				className="fincommerce-select-control__autofill-input"
				tabIndex={ -1 }
...
export function StoreAddress( {
	...
	return (
		<div className="fincommerce-store-address-fields">
			<SelectControl
			...
			{ ! locale?.address_1?.hidden && (
				<TextControl
					...
					id={ 'fincommerce-store-address-form-address_1' }
					label={
						locale?.address_1?.label ||
						__( 'Address', 'fincommerce' )
					}
			...
			{ ! locale?.postcode?.hidden && (
				<TextControl
					__nextHasNoMarginBottom
					id={ 'fincommerce-store-address-form-postcode' }
					label={
						locale?.postcode?.label ||
						__( 'Post code', 'fincommerce' )
					}
			...
			{ ! locale?.city?.hidden && (
				<TextControl
					__nextHasNoMarginBottom
					id={ 'fincommerce-store-address-form-city' }
					label={ locale?.city?.label || __( 'City', 'fincommerce' ) }
					{ ...getInputProps( 'city' ) }
