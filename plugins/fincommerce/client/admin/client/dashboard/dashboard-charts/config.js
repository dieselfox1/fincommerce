...
const DASHBOARD_CHARTS_FILTER = 'fincommerce_admin_dashboard_charts_filter';
...
const defaultCharts = [
	...
	{
		label: __( 'Gross discounted', 'fincommerce' ),
		report: 'coupons',
		key: 'amount',
	},
	{
 ...
 *
 * @filter fincommerce_admin_dashboard_charts_filter
