...
const SHOW_APP_BANNER_MODIFIER_CLASS = 'fincommerce-layout__show-app-banner';
...
export const Banner = ( { onInstall, onDismiss } ) => {
	...
	useEffect( () => {
		const layout =
			document.getElementsByClassName( 'fincommerce-layout' )[ 0 ];
	...
	return (
		<div className="fincommerce-mobile-app-banner">
			<Icon
			...
			/>
			<AppIcon />
			<div className="fincommerce-mobile-app-banner__description">
				<p className="fincommerce-mobile-app-banner__description__text">
					{ __( 'Run your store from anywhere', 'fincommerce' ) }
				</p>
				<p className="fincommerce-mobile-app-banner__description__text">
					{ __( 'Download the FinCommerce app', 'fincommerce' ) }
				</p>
			</div>
