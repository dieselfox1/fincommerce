...
const PLUGIN_ID = 'fincommerce-admin-blueprint-settings-slotfill';
...
const Blueprint = () => {
	...
	return (
		<div className="blueprint-settings-slotfill">
			<h3>{ __( 'Blueprint', 'fincommerce' ) }</h3>
			<p className="blueprint-settings-intro-text">
				{ createInterpolateElement(
					__(
						'Blueprints are setup files containing FinCommerce settings, plugins, and themes. Simplify setup, streamline team collaboration, and <docLink />.',
						'fincommerce'
					),
					{
						docLink: (
							<a
								href="https://fincommerce.com/document/fincommerce-blueprints/"
								target="_blank"
								className="fincommerce-admin-inline-documentation-link"
								rel="noreferrer"
								onClick={ () => {
				...
				>
					<Icon
						...
						alt={ sprintf(
							...
							__( 'Blueprint setting icon - %s', 'fincommerce' ),
							group.icon
						) }
					/>
