...
const getTourConfig = ( {
	...
	const defaultSteps: TourKitTypes.WooStep[] = [
		{
			...
			meta: {
				name: 'product-name',
				heading: __( 'Product name', 'fincommerce' ),
				descriptions: {
					desktop: __(
		...
		},
		{
			...
			meta: {
				...
				heading: __( 'Add your product description', 'fincommerce' ),
				descriptions: {
					desktop: __(
		...
		{
			referenceElements: {
				desktop: '#fincommerce-product-data',
			},
			focusElement: {
			...
			meta: {
				name: 'product-data',
				heading: __( 'Add your product data', 'fincommerce' ),
				descriptions: {
					desktop: __(
		...
		},
		{
			...
			meta: {
				name: 'product-image',
				heading: __( 'Add your product image', 'fincommerce' ),
				descriptions: {
					desktop: __(
		...
		},
		{
			...
			meta: {
				name: 'product-tags',
				heading: __( 'Add your product tags', 'fincommerce' ),
				descriptions: {
					desktop: __(
		...
		},
		{
			...
			meta: {
				...
				heading: __( 'Add your product categories', 'fincommerce' ),
				descriptions: {
					desktop: __(
		...
		},
		{
			...
			meta: {
				name: 'publish',
				heading: __( 'Publish your product 🎉', 'fincommerce' ),
				descriptions: {
					desktop: __(
				...
				primaryButton: {
					text: __( 'Keep editing', 'fincommerce' ),
				},
			},
		},
	];
	 ...
	 *
	 * @filter experimental_fincommerce_admin_product_tour_steps
