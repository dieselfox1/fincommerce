...
const RecommendedExtensions = ( {
	extensions,
	isLoading,
	title = __( 'Recommended extensions', 'fincommerce' ),
	description = __(
	...
	const categoryClass = category
		? `fincommerce-marketing-recommended-extensions-card__category-${ category }`
		: '';
	...
	return (
		<Card
			...
			className={ clsx(
				'fincommerce-marketing-recommended-extensions-card',
				categoryClass
			) }
		>
			{ isLoading ? (
				<div
					className={ clsx(
						...
						`fincommerce-marketing-recommended-extensions-card__items--count-${ placholdersCount }`
					) }
				>
				...
				<div
					className={ clsx(
						'fincommerce-marketing-recommended-extensions-card__items',
						`fincommerce-marketing-recommended-extensions-card__items--count-${ extensions.length }`
					) }
				>
