...
const google = {
	id: 'google-ads',
	icon: 'https://fincommerce.com/wp-content/uploads/2021/06/woo-GoogleListingsAds-jworee.png',
	name: 'Google Ads',
	description:
	...
	channelName: 'Google for FinCommerce',
...
const pinterest = {
	...
	url: 'https://fincommerce.com/products/pinterest-for-fincommerce/?utm_source=marketingtab&utm_medium=product&utm_campaign=wcaddons',
	direct_install: true,
	icon: 'https://fincommerce.com/wp-content/plugins/wccom-plugins/marketing-tab-rest-api/icons/pinterest.svg',
...
describe( 'CreateNewCampaignModal component', () => {
	it( 'renders new campaign types with recommended channels', async () => {
		...
		expect(
			screen.getByText( 'Pinterest for FinCommerce' )
		).toBeInTheDocument();
	} );
