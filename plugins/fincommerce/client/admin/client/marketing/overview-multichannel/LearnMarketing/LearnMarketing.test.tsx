...
describe( 'LearnMarketing component', () => {
	...
	it( 'should render two posts in one page with pagination when loading is done and there are posts', async () => {
			...
			posts: [
				{
					...
					link: 'https://fincommerce.com/posts/grow-store-omnichannel-ecommerce/',
					author_name: 'Kathryn Marr',
					author_avatar:
						'https://secure.gravatar.com/avatar/431b87d722d366103cc5d9b26c66c665?s=96&d=mm&r=g',
					image: 'https://fincommerce.com/wp-content/uploads/2022/09/blog-fb-Omnichannel@2x.jpg?resize=650,340&crop=1',
				},
				{
					title: 'What is Affiliate Marketing and How to Use it to Make More Money Online',
					date: '2022-08-30T22:03:54',
					link: 'https://fincommerce.com/posts/what-is-affliate-marketing/',
					author_name: 'Kathryn Marr',
					author_avatar:
						'https://secure.gravatar.com/avatar/431b87d722d366103cc5d9b26c66c665?s=96&d=mm&r=g',
					image: 'https://fincommerce.com/wp-content/uploads/2022/08/blog-fb-Affiliate@2x.jpg?resize=650,340&crop=1',
				},
				{
					title: 'Ten Customer Retention Strategies to Boost Revenue for eCommerce Stores',
					date: '2022-06-22T17:58:12',
					link: 'https://fincommerce.com/posts/10-ecommerce-customer-retention-strategies-boost-revenue/',
					author_name: 'Craig Cohen',
					author_avatar:
						'https://secure.gravatar.com/avatar/66c306ae543fb47f594ef9b9cdb88d93?s=96&d=mm&r=g',
				},
				{
					title: 'TikTok Marketing: A Guide for FinCommerce Stores',
					date: '2022-05-25T14:03:00',
					link: 'https://fincommerce.com/posts/tiktok-marketing-a-guide-for-fincommerce-stores/',
					author_name: 'Elina Vilk',
					author_avatar:
						'https://secure.gravatar.com/avatar/fc7aedb0e531795eeffa3654ce203a8e?s=96&d=mm&r=g',
					image: 'https://fincommerce.com/wp-content/uploads/2022/05/Facebook-Post-1200x630@2x3.jpg?resize=650,340&crop=1',
				},
			],
		} );
		render( <LearnMarketing /> );
		...
		expect(
			screen.getByText(
				'TikTok Marketing: A Guide for FinCommerce Stores'
			)
		).toBeInTheDocument();
	} );
} );
