...
export const DiscoverTools = () => {
	...
	const renderCardContent = () => {
		...
		if ( data.length === 0 ) {
			return (
				<CardBody className="fincommerce-marketing-discover-tools-card-body-empty-content">
					...
					<Button
						variant="tertiary"
						href="https://fincommerce.com/product-category/fincommerce-extensions/marketing-extensions/"
						onClick={ () => {
	...
	return (
		<CollapsibleCard
			header={ __( 'Discover more marketing tools', 'fincommerce' ) }
		>
			{ renderCardContent() }
		</CollapsibleCard>
	);
