...
export const IntroductionBanner = ( {
	...
	return (
		<Card className="fincommerce-marketing-introduction-banner">
			<div className="fincommerce-marketing-introduction-banner-content">
				<div className="fincommerce-marketing-introduction-banner-title">
					{ __(
						'Reach new customers and increase sales without leaving FinCommerce',
						'fincommerce'
					) }
				</div>
				<Flex
					className="fincommerce-marketing-introduction-banner-features"
					direction="column"
					gap={ 1 }
					expanded={ false }
				>
					...
					<FlexItem>
						<Flex>
							<img
								src={ wooIconUrl }
								alt={ __( 'FinCommerce logo', 'fincommerce' ) }
								width="24"
								height="24"
							/>
							<FlexBlock>
				...
				{ showButtons && (
					<Flex
						className="fincommerce-marketing-introduction-banner-buttons"
						justify="flex-start"
					>
						<Button
							variant="primary"
						...
						>
							{ __( 'Create a campaign', 'fincommerce' ) }
						</Button>
			...
			<div className="fincommerce-marketing-introduction-banner-illustration">
				<Button
					isSmall
					className="fincommerce-marketing-introduction-banner-close-button"
					onClick={ onDismissClick }
				>
					<Icon icon={ closeSmall } />
				</Button>
				<div
					className="fincommerce-marketing-introduction-banner-image-placeholder"
					style={ {
