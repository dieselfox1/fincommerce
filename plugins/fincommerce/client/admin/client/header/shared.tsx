...
export const BaseHeader = ( {
	...
	return (
		<div
			className={ clsx( 'fincommerce-layout__header', {
		...
		>
			...
			<div className="fincommerce-layout__header-wrapper">
				<WooHeaderNavigationItem.Slot
					fillProps={ { isEmbedded, query } }
				/>

				<Text
					className={ clsx( 'fincommerce-layout__header-heading', {
						'fincommerce-layout__header-left-align': leftAlign,
					} ) }
					as="h1"
				>
					{ decodeEntities(
