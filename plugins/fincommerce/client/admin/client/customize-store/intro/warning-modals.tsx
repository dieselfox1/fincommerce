...
export const ThemeSwitchWarningModal = ( {
	...
	return (
		<Modal
			className={
				'fincommerce-customize-store__theme-switch-warning-modal'
			}
			title={ __(
		...
		>
			...
			<div className="fincommerce-customize-store__theme-switch-warning-modal-footer">
				<Button
					onClick={ () => {
				...
				<Button
					...
					variant="primary"
				>
					{ __( 'Design a new theme', 'fincommerce' ) }
				</Button>
			</div>
		</Modal>
	);
