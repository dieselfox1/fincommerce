...
const loaderSteps = [
	{
		title: __( 'Setting up the foundations', 'fincommerce' ),
		image: (
			<img
				src={ loaderAssemblingStore }
				alt={ __( 'Setting up the foundations', 'fincommerce' ) }
			/>
		),
		progress: 25,
	},
	{
		...
		image: (
			<img
				...
				alt={ __( 'Turning on the lights', 'fincommerce' ) }
			/>
		),
		progress: 50,
	},
	{
		...
		image: (
			<img
				src={ openingTheDoors }
				alt={ __( 'Opening the doors', 'fincommerce' ) }
			/>
		),
		progress: 100,
	},
