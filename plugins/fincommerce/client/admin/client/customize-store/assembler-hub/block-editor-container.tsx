...
export const BlockEditorContainer = () => {
	...
	// This is necessary to avoid this issue: https://github.com/dieselfox1/fincommerce/issues/45593
	// Related PR: https://github.com/dieselfox1/fincommerce/pull/45600
	...
	const previewOpacity = useScrollOpacity(
		'.fincommerce-customize-store__block-editor iframe',
		scrollDirection
	);
