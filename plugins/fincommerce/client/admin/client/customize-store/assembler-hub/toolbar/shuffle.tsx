...
import { Button, Path, SVG, ToolbarGroup } from '@finpress/components';
...
// This is the icon that is used in the Shuffle button. Currently we are using an outdated version of @finpress/icons.
// import { shuffle } from '@finpress/icons';

// Copied-pasted from a recent version of @finpress/icons
const shuffleIcon = (
...
export default function Shuffle( { clientId }: { clientId: string } ) {
	...
	return (
		<ToolbarGroup className="fincommerce-customize-your-store-toolbar-shuffle-container">
			<Button
				icon={ shuffleIcon }
				label={ __( 'Shuffle', 'fincommerce' ) }
				onClick={ () => {
