		...
		>
			<HighlightedBlockContextProvider>
				...
				<EntityProvider kind="root" type="site">
					...
					>
						<div
							className={ clsx( 'fincommerce-edit-site-layout' ) }
						>
							<motion.div
							...
							<div className="fincommerce-edit-site-layout__content">
								<div className="fincommerce-edit-site-layout__sidebar">
									<NavigableRegion
										ariaLabel={ __(
											'Navigation',
											'fincommerce'
										) }
										className="fincommerce-edit-site-layout__sidebar-region"
									>
										<motion.div
											animate={ { opacity: 1 } }
											transition={ {
											...
											className="fincommerce-edit-site-layout__sidebar"
										>
											<Sidebar />
										</motion.div>
									</NavigableRegion>
								...
								{ ! isMobileViewport && (
									<div className="fincommerce-edit-site-layout__canvas-container">
										{ canvasResizer }
										{ !! canvasSize.width && (
											<motion.div
												initial={ false }
												layout="position"
												className={ clsx(
													'fincommerce-edit-site-layout__canvas'
												) }
											>
												<ErrorBoundary>
													<ResizableFrame
