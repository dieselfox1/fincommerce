...
export const SidebarNavigationScreenHomepage = ( {
	...
	const title = __( 'Choose your homepage', 'fincommerce' );
			...
			content={
				<div className="fincommerce-customize-store__sidebar-homepage-content">
					<div className="fincommerce-edit-site-sidebar-navigation-screen-patterns__group-homepage">
						{ /* This is necessary to fix this issue: https://github.com/dieselfox1/fincommerce/issues/45711
						  If the user switch the homepage while the editor is loading, header and footer could disappear.
						  For more details check: https://github.com/dieselfox1/fincommerce/pull/45735
						  */ }
