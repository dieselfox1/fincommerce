...
const LogoSettings = ( {
	...
	return (
		<div className="fincommerce-customize-store__sidebar-group">
			<div className="fincommerce-customize-store__sidebar-group-header">
				{ __( 'Settings', 'fincommerce' ) }
			</div>
			<RangeControl
				__nextHasNoMarginBottom
				__next40pxDefaultSize
				label={ __( 'Image width', 'fincommerce' ) }
				onChange={ ( newWidth ) =>
			...
			<ToggleControl
				__nextHasNoMarginBottom
				label={ __( 'Link logo to homepage', 'fincommerce' ) }
				onChange={ () => {
			...
			{ canUserEdit && (
				<>
					<ToggleControl
						__nextHasNoMarginBottom
						label={ __( 'Use as site icon', 'fincommerce' ) }
...
const LogoEdit = ( {
	...
	const logoImg = (
		<div className="fincommerce-customize-store__sidebar-logo-container">
			<img
				className="fincommerce-customize-store_custom-logo"
				src={ logoUrl }
				alt={ alt }
				onLoad={ ( event ) => {
					setNaturalSize( {
...
export const SidebarNavigationScreenLogo = ( {
	...
	return (
		<SidebarNavigationScreen
			title={ __( 'Add your logo', 'fincommerce' ) }
			description={ __(
			...
			content={
				<div className="fincommerce-customize-store__sidebar-logo-content">
					<div className="fincommerce-customize-store__sidebar-group-header fincommerce-customize-store__logo-header-container">
						<span>{ __( 'Logo', 'fincommerce' ) }</span>
						{ Boolean( siteLogoId ) && (
							<DropdownMenu
								icon={ moreVertical }
								label={ __( 'Options', 'fincommerce' ) }
								className="fincommerce-customize-store__logo-dropdown-menu"
								popoverProps={ {
									className:
										'fincommerce-customize-store__logo-dropdown-popover',
									placement: 'bottom-end',
								} }
							>
								{ ( { onClose } ) => (
									<>
										<MenuGroup className="fincommerce-customize-store__logo-menu-group">
											<MediaUploadCheck>
												<MediaUpload
													onSelect={ (
														media: Parameters<
										...
										<MenuGroup className="fincommerce-customize-store__logo-menu-group">
											<MenuItem
												className="fincommerce-customize-store__logo-menu-item-delete"
												onClick={ () => {
													onClose();
													onRemoveLogo();
													trackEvent(
					...
					<LogoEdit
						...
						isLoading={ isLoading }
					/>
					<div className="fincommerce-customize-store__fiverr-cta-group">
						<strong>
							{ __( "DON'T HAVE A LOGO YET?", 'fincommerce' ) }
						</strong>
						<p>
