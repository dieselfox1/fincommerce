...
const SUPPORTED_FOOTER_PATTERNS = [
	'fincommerce-blocks/footer-with-3-menus',
	'fincommerce-blocks/footer-simple-menu',
	'fincommerce-blocks/footer-large',
];
...
export const SidebarNavigationScreenFooter = ( {
	...
	const title = __( 'Choose your footer', 'fincommerce' );
	...
	return (
		<SidebarNavigationScreen
			...
			content={
				<>
					<div className="fincommerce-customize-store__sidebar-footer-content">
						{ isLoading && (
