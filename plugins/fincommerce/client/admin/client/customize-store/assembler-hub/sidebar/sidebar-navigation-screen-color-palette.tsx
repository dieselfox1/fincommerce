...
const SidebarNavigationScreenColorPaletteContent = () => {
	...
	return (
		<div
			className="fincommerce-customize-store_sidebar-color-content"
			style={ {
				opacity: 0,
		...
		>
			<ColorPalette />
			<PanelBody
				className="fincommerce-customize-store__color-panel-container"
				title={ __( 'or create your own', 'fincommerce' ) }
...
export const SidebarNavigationScreenColorPalette = ( {
	...
	const title = __( 'Choose your color palette', 'fincommerce' );
