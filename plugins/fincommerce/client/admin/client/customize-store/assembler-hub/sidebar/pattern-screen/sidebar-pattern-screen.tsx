...
export const SidebarPatternScreen = ( { category }: { category: string } ) => {
	...
	useEffect( () => {
		...
		const previewPatternList = document.querySelector(
			'.fincommerce-customize-store-edit-site-layout__sidebar-extra__pattern .block-editor-block-patterns-list'
		);
	...
	useEffect( () => {
		...
		const iframe = window.document.querySelector(
			'.fincommerce-customize-store-assembler > iframe[name="editor-canvas"]'
	...
	return (
		<div
			className="fincommerce-customize-store-edit-site-layout__sidebar-extra__pattern"
			onScroll={ ( event ) => {
		...
		>
			<div className="fincommerce-customize-store-edit-site-layout__sidebar-extra__pattern__header">
				<h1>
					{ capitalize(
						PATTERN_CATEGORIES[
							category as keyof typeof PATTERN_CATEGORIES
			...
			<div className="fincommerce-customize-store-edit-site-layout__sidebar-extra__pattern__description">
				<span>
					{
						PATTERN_CATEGORIES[
							category as keyof typeof PATTERN_CATEGORIES
