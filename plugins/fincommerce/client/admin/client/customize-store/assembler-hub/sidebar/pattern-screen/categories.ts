...
export const PATTERN_CATEGORIES = {
	...
	'featured-selling': {
		label: __( 'Featured selling', 'fincommerce' ),
		description: __(
	...
	'social-media': {
		label: __( 'Social media', 'fincommerce' ),
		description: __(
	...
	// newsletter: {
	// 	label: __( 'Newsletter', 'fincommerce' ),
	// 	description: __(
