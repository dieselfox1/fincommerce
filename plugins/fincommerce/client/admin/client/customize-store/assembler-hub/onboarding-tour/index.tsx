			...
			<TourKit
				config={ {
					options: {
						...
						classNames: [
							'fincommerce-customize-store-tour-kit',
							'fincommerce-customize-store-welcome-tourkit',
						],
					},
					steps: [
						{
							meta: {
								name: 'welcome-tour',
								primaryButton: {
									text: __( 'Take a tour', 'fincommerce' ),
								},
								descriptions,
								heading,
								skipButton: {
		...
		<TourKit
			config={ {
				...
				options: {
					...
					classNames: 'fincommerce-customize-store-tour-kit',
				},
				steps: [
					{
						referenceElements: {
							desktop: `.fincommerce-edit-site-layout__canvas-container`,
						},
						meta: {
					...
					{
						referenceElements: {
							desktop: `.fincommerce-edit-site-layout__sidebar-region`,
						},
						meta: {
