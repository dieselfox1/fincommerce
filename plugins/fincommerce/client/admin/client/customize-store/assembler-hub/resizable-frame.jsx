...
function ResizableFrame( {
	...
	const resizableHandleHelpId = useInstanceId(
		ResizableFrame,
		'fincommerce-edit-site-resizable-frame-handle-help'
	);
	...
	const resizeHandler = (
		...
		<motion.button
			...
			className={ clsx( 'fincommerce-edit-site-resizable-frame__handle', {
				'is-resizing': isResizing,
			} ) }
			variants={ resizeHandleVariants }
			animate={ currentResizeHandleVariant }
			aria-label={ __( 'Drag to resize', 'fincommerce' ) }
			...
			children={
				...
				! hasHandlerDragged && (
					<Popover
						className="fincommerce-assembler-hub__resizable-frame__drag-handler"
						position="middle right"
					>
						{ __( 'Drag to resize', 'fincommerce' ) }
					</Popover>
				)
			}
		/>
	...
	return (
		<ResizableBox
				...
				left: (
					<>
						{ isHandleVisibleByDefault ? (
							...
							<Tooltip
								position="middle right"
								text={ __( 'Drag to resize', 'fincommerce' ) }
							>
								{ resizeHandler }
							</Tooltip>
						) }
			...
			className={ clsx( 'fincommerce-edit-site-resizable-frame__inner', {
				'is-resizing': isResizing,
			} ) }
		>
			<motion.div
