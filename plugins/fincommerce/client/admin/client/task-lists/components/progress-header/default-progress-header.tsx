...
export const DefaultProgressHeader = ( {
	...
	return (
		<div className="fincommerce-task-progress-header">
			<TaskListMenu
				id={ taskListId }
				hideTaskListText={ __( 'Hide setup list', 'fincommerce' ) }
			/>
			<div className="fincommerce-task-progress-header__contents">
				{ completedCount !== tasksCount ? (
					<>
						...
						<progress
							className="fincommerce-task-progress-header__progress-bar"
							max={ tasksCount }
