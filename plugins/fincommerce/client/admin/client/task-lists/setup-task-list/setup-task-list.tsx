...
import { List, useSlot } from '@fincommerce/experimental';
...
export const SetupTaskList = ( {
	...
	const taskListHeaderSlot = useSlot(
		`fincommerce_onboarding_task_list_header_${
	...
	return (
		<>
			...
			<div
				className={ clsx(
					`fincommerce-task-dashboard__container fincommerce-task-list__${ id } setup-task-list`
				) }
			>
				<Card
					size="large"
				...
				>
					<div className="fincommerce-task-card__header-container">
