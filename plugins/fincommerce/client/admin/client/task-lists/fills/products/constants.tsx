...
export const productTypes = Object.freeze( [
	{
		...
		title: __( 'Physical product', 'fincommerce' ),
		content: __(
	...
	},
	{
		...
		title: __( 'Digital product', 'fincommerce' ),
		content: __(
	...
	},
	{
		...
		title: __( 'Variable product', 'fincommerce' ),
		content: __(
	...
	},
	{
		...
		content: __( 'A collection of related products.', 'fincommerce' ),
		before: <Widget />,
		after: <Icon icon={ chevronRight } />,
	},
	{
		key: 'external' as const,
		title: __( 'External product', 'fincommerce' ),
		content: __( 'Link a product to an external website.', 'fincommerce' ),
		before: <Link />,
		after: <Icon icon={ chevronRight } />,
	},
] );
...
export const LoadSampleProductType = {
	...
	title: __( 'can’t decide?', 'fincommerce' ),
	content: __(
	...
	before: <LightBulb />,
	after: <Icon icon={ chevronRight } />,
	className: 'fincommerce-products-list__item-load-sample-product',
};
...
export const PrintfulAdvertProductPlacement = {
	...
	title: (
		<span className="printful-sponsored__text">
			{ __( 'Print-on-demand products', 'fincommerce' ) }
		</span>
	),
	content: __(
	...
	className: 'fincommerce-products-list__item-advert',
	before: (
		<img
	...
	after: (
		<div className="fincommerce-label">
			{ __( 'Promoted', 'fincommerce' ) }
		</div>
	),
	onClick: () => {
		recordEvent( 'tasklist_product_printful_advert_click' );
		window.open(
			'https://fincommerce.com/products/printful',
			'_blank',
			'noopener,noreferrer'
		);
	},
...
export const ImportCSVItem = {
	...
	title: (
		<span className="printful-sponsored__text">
			{ __( 'Are you already selling somewhere else?', 'fincommerce' ) }
		</span>
	),
	content: __( 'Import your products from a CSV file.', 'fincommerce' ),
	className: 'fincommerce-products-list__item-advert',
	before: <Upload />,
	after: null,
	onClick: () => {
...
export const SETUP_TASKLIST_PRODUCTS_AFTER_FILTER =
	'fincommerce_admin_task_products_after';
