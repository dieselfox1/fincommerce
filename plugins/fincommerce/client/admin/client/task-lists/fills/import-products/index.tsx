...
export const Products = () => {
	...
	return (
		<div className="fincommerce-task-import-products">
			<h1>{ __( 'Import your products', 'fincommerce' ) }</h1>
			<CardList items={ importTypesWithTimeRecord } />
			<div className="fincommerce-task-import-products-stacks">
				<Button
					onClick={ () => {
						recordEvent(
				...
				>
					{ __( 'Or add your products from scratch', 'fincommerce' ) }
