...
const Marketing = ( { onComplete }: MarketingProps ) => {
	...
	return (
		<div className="fincommerce-task-marketing">
				...
				<TaskPromo
					...
					buttonHref={
						isFeatureEnabled( 'marketplace' )
							...
							: 'https://fincommerce.com/product-category/fincommerce-extensions/marketing-extensions/'
					}
					buttonText={ __( 'Start growing', 'fincommerce' ) }
