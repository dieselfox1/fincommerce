 ...
 */
export const AUTOMATION_PLUGINS = [ 'fincommerce-services' ];

/**
 * Check if a store has a complete address given general settings.
 *
 * @param {Object} generalSettings                             General settings.
 * @param {Object} generalSettings.fincommerce_store_address   Store address.
 * @param {Object} generalSettings.fincommerce_default_country Store default country.
 * @param {Object} generalSettings.fincommerce_store_postcode  Store postal code.
 */
