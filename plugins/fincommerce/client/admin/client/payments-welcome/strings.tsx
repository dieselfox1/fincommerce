...
export default {
	...
	limitedTimeOffer: __( 'Limited time offer', 'fincommerce' ),
	...
	andMore: __( '& more', 'fincommerce' ),
	learnMore: __( 'Learn more', 'fincommerce' ),
	survey: {
		title: __( 'No thanks, I don’t want WooPayments', 'fincommerce' ),
		intro: __(
		...
		commentsLabel: __( 'Comments (Optional)', 'fincommerce' ),
		cancelButton: __( 'Just dismiss WooPayments', 'fincommerce' ),
		submitButton: __( 'Dismiss and send feedback', 'fincommerce' ),
	},
	faq: {
		haveQuestions: __( 'Have questions?', 'fincommerce' ),
		getInTouch: __( 'Get in touch', 'fincommerce' ),
	},
	apms: {
		addMoreWaysToPay: __(
		...
		seeMore: __( 'See more', 'fincommerce' ),
		paypal: {
		...
		installTextPost: __( 'extension in your store.', 'fincommerce' ),
	},
};
