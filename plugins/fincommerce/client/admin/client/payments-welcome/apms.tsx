...
export const apms: Apm[] = [
	{
		...
		link: 'https://fincommerce.com/products/fincommerce-paypal-payments/',
		extension: 'fincommerce-paypal-payments',
	},
	{
		id: 'amazonpay',
		...
		link: 'https://fincommerce.com/products/pay-with-amazon/',
		extension: 'fincommerce-gateway-amazon-payments-advanced',
	},
];
	...
	return (
		<>
			...
			<Card size="large" className="woopayments-welcome-page__apms">
				...
				<CardFooter>
					<ExternalLink href="https://fincommerce.com/product-category/fincommerce-extensions/payment-gateways/wallets/?categoryIds=28682&collections=product&page=1">
