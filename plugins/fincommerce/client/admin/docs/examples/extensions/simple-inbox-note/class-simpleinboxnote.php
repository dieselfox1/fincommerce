<?php
/**
 * FinCommerce Admin SimpleInboxNote example class.
 *
...
class SimpleInboxNote {
	...
	public static function get_note() {
		...
		$note->set_content(
			sprintf(
				'This is your note example contents. You may enter up to 320 displayable characters here. For more information on character limit, visit our <a href="https://developer.fincommerce.com/2021/11/10/introducing-a-320-character-limit-to-inbox-notes/">blogpost</a>.'
			)
		);
