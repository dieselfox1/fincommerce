<?php
/**
 * Plugin Name: FinCommerce Admin Add Report Example
 *
...
function add_report_add_report_menu_item( $report_pages ) {
	$report_pages[] = array(
		...
		'title'  => __( 'Example', 'fincommerce-admin' ),
...
add_filter( 'fincommerce_analytics_report_menu_items', 'add_report_add_report_menu_item' );
