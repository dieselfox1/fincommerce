 ...
 */
import { ReportFilters, TableCard } from '@fincommerce/components';
...
/**
 * Use the 'fincommerce_admin_reports_list' filter to add a report page.
 */
addFilter( 'fincommerce_admin_reports_list', 'plugin-domain', ( reports ) => {
	return [
		...reports,
		{
			report: 'example',
