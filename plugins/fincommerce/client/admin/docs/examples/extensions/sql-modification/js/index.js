...
addFilter(
	'fincommerce_admin_coupons_report_filters',
	'plugin-domain',
	addCurrencyFilters
);
addFilter(
	'fincommerce_admin_taxes_report_filters',
	'plugin-domain',
	addCurrencyFilters
);
addFilter(
	'fincommerce_admin_dashboard_filters',
	'plugin-domain',
	addCurrencyFilters
);
...
addFilter( 'fincommerce_admin_report_table', 'plugin-domain', addTableColumn );
