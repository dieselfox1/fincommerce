<?php
/**
 * Plugin Name: FinCommerce Admin Table Column Example
 *
...
add_filter( 'fincommerce_rest_report_products_schema', 'add_product_extended_attributes_schema' );
...
add_filter( 'fincommerce_rest_reports_products_extended_attributes', 'add_product_extended_attributes' );
