...
class My_Slot_Filled_Gateway extends WC_Payment_Gateway {
	...
	public function __construct() {
		...
		$this->method_title       = __( 'Slot filled gateway', 'fincommerce-admin' );
		$this->method_description = __( 'A gateway demonstrating the use of slot fill for custom configuration screens.', 'fincommerce-admin' );
	...
	public function init_form_fields() {
		$this->form_fields = array(
			...
			'my_setting' => array(
				'title'   => __( 'My setting', 'fincommerce-admin' ),
				'type'    => 'text',
				'default' => '',
			),
		);
	...
	public function needs_setup() {
		$settings = get_option( 'fincommerce_my-slot-filled-gateway_settings', array() );
