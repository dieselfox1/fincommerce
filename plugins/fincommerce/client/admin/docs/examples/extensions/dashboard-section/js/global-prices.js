 ...
 */
import { Card, Chart } from '@fincommerce/components';
import Currency from '@fincommerce/currency';
...
const GlobalPrices = () => {
	...
	return (
		<Card
			className="fincommerce-dashboard__chart-block fincommerce-analytics__card"
