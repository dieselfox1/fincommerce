...
class FeatureContext extends BehatContext implements ClosuredContextInterface {
	...
	public function download_wp( $subdir = '' ) {
		...
		symlink( dirname( dirname( dirname( dirname( dirname( __FILE__ ) ) ) ) ),  $dest_dir . '/wp-content/plugins/fincommerce' );
	}
	...
	public function install_wp( $subdir = '' ) {
		...
		$this->proc( 'wp plugin activate fincommerce', array(), $subdir )->run_check();
	}
}
