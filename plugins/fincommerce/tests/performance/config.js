...
export const STORE_NAME = __ENV.STORE_NAME || 'FinCommerce Core E2E Test Suite';
export const FOOTER_TEXT = 'Built with FinCommerce';
...
export const customer_email =
	__ENV.C_EMAIL || 'customer@fincommercecoree2etestsuite.com';
