...
export function checkoutGuest() {
	let fincommerce_process_checkout_nonce_guest;
	...
	group( 'Proceed to checkout', function () {
		...
		fincommerce_process_checkout_nonce_guest = response
			.html()
	...
	group( 'Place Order', function () {
		...
		const response = http.post(
			`${ base_url }/?wc-ajax=checkout`,
			{
				...
				order_comments: '',
				payment_method: `${ payment_method }`,
				'fincommerce-process-checkout-nonce': `${ fincommerce_process_checkout_nonce_guest }`,
