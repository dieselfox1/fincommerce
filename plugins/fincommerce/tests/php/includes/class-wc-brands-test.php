<?php
/**
 * FinCommerce Brands Unit tests suite
 *
 * @package fincommerce-brands
 */
...
class WC_Brands_Test extends WC_Unit_Test_Case {
	...
	public function test_brand_count_respects_product_visibility() {
		...
		update_option( 'fincommerce_hide_out_of_stock_items', 'yes' );
		...
		// Reset the setting.
		update_option( 'fincommerce_hide_out_of_stock_items', 'no' );
	}
