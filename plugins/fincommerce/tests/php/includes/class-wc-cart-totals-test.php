...
class WC_Cart_Totals_Tests extends WC_Unit_Test_Case {
	 ...
	 *
	 * @link https://github.com/dieselfox1/fincommerce/issues/23916.
	 */
	...
	private function assert_discount_tax_rounding_when_rounding_at_line() {
		...
		update_option( 'fincommerce_price_num_decimals', 0 );

		WC()->cart->calculate_totals();
		update_option( 'fincommerce_price_num_decimals', $decimal_precision );
	 ...
	 *
	 * @link https://github.com/dieselfox1/fincommerce/issues/28292.
	 */
	 ...
	 *
	 * @link https://github.com/dieselfox1/fincommerce/issues/24184#issue-469311323.
	 */
