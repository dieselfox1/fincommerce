 ...
 *
 * @package FinCommerce\Tests\Exporter.
 */
...
class WC_Product_CSV_Exporter_Test extends \WC_Unit_Test_Case {
	...
	public function test_get_column_value_published() {
		...
		add_filter( 'fincommerce_product_export_product_query_args', array( $this, 'set_export_product_query_args' ) );
		...
		remove_filter( 'fincommerce_product_export_product_query_args', array( $this, 'set_export_product_query_args' ) );
	}
}
