 ...
 *
 * @package FinCommerce\Tests\Includes
 */
 ...
 * Covers edge case bug from https://github.com/dieselfox1/fincommerce/issues/58757
 */
class WC_Tax_Test extends WC_Unit_Test_Case {
	...
	/**
	 * Store the original value of fincommerce_calc_taxes.
	 *
	 * @var string|null
	 */
	...
	public function setUp(): void {
		...
		// Store and set fincommerce_calc_taxes option.
		$this->original_calc_taxes = get_option( 'fincommerce_calc_taxes', null );
	...
	public function tearDown(): void {
		...
		// Reset tax settings.
		delete_option( 'fincommerce_shipping_tax_class' );
		delete_option( 'fincommerce_tax_classes' );

		// Restore fincommerce_calc_taxes option to its original value.
		if ( null !== $this->original_calc_taxes ) {
			update_option( 'fincommerce_calc_taxes', $this->original_calc_taxes );
		} else {
			delete_option( 'fincommerce_calc_taxes' );
		}
	 ...
	 * This tests the fix for https://github.com/dieselfox1/fincommerce/issues/58757
	 */
	...
	public function test_get_shipping_tax_rates_with_explicit_shipping_tax_class() {
		...
		update_option( 'fincommerce_shipping_tax_class', 'reduced-rate' );
