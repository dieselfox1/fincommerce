...
class WC_REST_Orders_Controller_Tests extends WC_REST_Unit_Test_Case {
	...
	public function test_orders_api_get_all_fields( bool $with_cogs_enabled ) {
		...
		$order    = \Automattic\FinCommerce\RestApi\UnitTests\Helpers\OrderHelper::create_order( $this->user );
	...
	public function test_valid_and_invalid_customer_ids(): void {
		...
		$this->assertEquals( 'fincommerce_rest_invalid_customer_id', $response->get_data()['code'], 'The returned error indicates the customer ID was invalid.' );
