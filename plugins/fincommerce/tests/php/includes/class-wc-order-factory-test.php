...
class WC_Order_Factory_Test extends WC_Unit_Test_Case {
	...
	use \Automattic\FinCommerce\RestApi\UnitTests\SerializingCacheTrait;
	...
	public function setUp(): void {
		parent::setUp();
		$this->cot_state = \Automattic\FinCommerce\Utilities\OrderUtil::custom_orders_table_usage_is_enabled();
