...
class WC_Admin_Functions_Test extends \WC_Unit_Test_Case {
	...
	public function test_wc_get_current_admin_url() {
		...
		$default_uri            = isset( $_SERVER['REQUEST_URI'] ) ? $_SERVER['REQUEST_URI'] : ''; // phpcs:ignore finpress.Security.ValidatedSanitizedInput.MissingUnslash, finpress.Security.ValidatedSanitizedInput.InputNotSanitized
	 ...
	 *
	 * @link https://github.com/dieselfox1/fincommerce/issues/27445.
	 */
	 ...
	 *
	 * @link https://github.com/dieselfox1/fincommerce/issues/27504.
	 */
	 ...
	 *
	 * @link https://github.com/dieselfox1/fincommerce/issues/29502.
	 */
	 ...
	 * FinCommerce should still handle the stock adjustment calculations correctly.
	 */
