 ...
 *
 * @package FinCommerce\Tests\Admin\Helper
 */
...
class WC_Helper_Sanitization_Test extends WC_Unit_Test_Case {
	...
	public function test_complex_css() {
		$css = '
            @import url("bad.css");
            .logo {
                background-image: url("https://fincommerce.com/logo.png");
		...
		$this->assertStringContainsString( 'fincommerce.com/logo.png', $sanitized );
