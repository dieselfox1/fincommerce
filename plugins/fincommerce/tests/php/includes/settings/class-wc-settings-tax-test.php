...
class WC_Settings_Tax_Test extends WC_Settings_Unit_Test_Case {
	...
	public function test_get_settings_for_default_section() {
		...
		$expected = array(
			...
			'fincommerce_prices_include_tax'    => 'radio',
			'fincommerce_tax_based_on'          => 'select',
			'fincommerce_shipping_tax_class'    => 'select',
			'fincommerce_tax_round_at_subtotal' => 'checkbox',
			'fincommerce_tax_classes'           => 'textarea',
			'fincommerce_tax_display_shop'      => 'select',
			'fincommerce_tax_display_cart'      => 'select',
			'fincommerce_price_display_suffix'  => 'text',
			'fincommerce_tax_total_display'     => 'select',
