...
use Automattic\FinCommerce\Internal\StockNotifications\Admin\SettingsController as StockNotificationsSettings;
...
class WC_Settings_Products_Test extends WC_Settings_Unit_Test_Case {
	 ...
	 *
	 * @testWith ["", ["fincommerce_products_general_settings", "fincommerce_product_settings"]]
	 *           ["inventory", ["fincommerce_inventory_settings"]]
	 *           ["downloadable", ["fincommerce_downloadable_products_settings"]]
	 *
	...
	public function test_get_default_settings_returns_all_settings() {
		...
		$expected = array(
			...
			'fincommerce_shop_page_id'                     => 'single_select_page',
			'fincommerce_cart_redirect_after_add'          => 'checkbox',
			'fincommerce_enable_ajax_add_to_cart'          => 'checkbox',
			'fincommerce_placeholder_image'                => 'text',
			'product_measurement_options'                  => array( 'title', 'sectionend' ),
			'fincommerce_weight_unit'                      => 'select',
			'fincommerce_dimension_unit'                   => 'select',
			'product_rating_options'                       => array( 'title', 'sectionend' ),
			'fincommerce_enable_reviews'                   => 'checkbox',
			'fincommerce_review_rating_verification_label' => 'checkbox',
			'fincommerce_review_rating_verification_required' => 'checkbox',
			'fincommerce_enable_review_rating'             => 'checkbox',
			'fincommerce_review_rating_required'           => 'checkbox',
		);
	...
	public function test_get_inventory_settings_returns_all_settings() {
		...
		$expected = array(
			...
			'fincommerce_manage_stock'            => 'checkbox',
			'fincommerce_hold_stock_minutes'      => 'number',
			'fincommerce_notify_low_stock'        => 'checkbox',
			'fincommerce_notify_no_stock'         => 'checkbox',
			'fincommerce_stock_email_recipient'   => 'text',
			'fincommerce_notify_low_stock_amount' => 'number',
			'fincommerce_notify_no_stock_amount'  => 'number',
			'fincommerce_hide_out_of_stock_items' => 'checkbox',
			'fincommerce_stock_format'            => 'select',
		);
	...
	public function test_get_downloadable_settings_returns_all_settings() {
		...
		$expected = array(
			...
			'fincommerce_file_download_method'                 => 'select',
			'fincommerce_downloads_redirect_fallback_allowed'  => 'checkbox',
			'fincommerce_downloads_require_login'              => 'checkbox',
			'fincommerce_downloads_grant_access_after_payment' => 'checkbox',
			'fincommerce_downloads_add_hash_to_filename'       => 'checkbox',
			'fincommerce_downloads_deliver_inline'             => 'checkbox',
			'fincommerce_downloads_count_partial'        => 'checkbox',
		);
