...
class WC_Abstract_Product_Test extends WC_Unit_Test_Case {
	...
	public function tearDown(): void {
		...
		remove_all_filters( 'fincommerce_get_cogs_total_value' );
	}
	...
	/**
	 * @testdox The total Cost of Goods Sold value van be modified using the fincommerce_get_cogs_total_value filter.
	 */
	public function test_cogs_total_value_can_be_altered_via_filter() {
		...
		add_filter( 'fincommerce_get_product_cogs_total_value', fn( $value, $product ) => $value + $product->get_id(), 10, 2 );
