...
class WC_Product_Variation_Data_Store_CPT_Test extends WC_Unit_Test_Case {
	...
	public function tearDown(): void {
		...
		remove_all_filters( 'fincommerce_load_product_cogs_is_additive_flag' );
		remove_all_filters( 'fincommerce_save_product_cogs_is_additive_flag' );
	}
	...
	/**
	 * @testdox Loaded Cost of Goods Sold "value is additive" flag can be modified using the fincommerce_load_product_cogs_is_additive_flag filter.
	 *
	 * @testWith [true]
	 *           [false]
	 *
	...
	public function test_cogs_additive_flag_loaded_value_can_be_altered_via_filter( bool $flag_value ) {
		...
		add_filter( 'fincommerce_load_product_cogs_is_additive_flag', fn( $value, $product ) => ! $value, 10, 2 );
	...
	/**
	 * @testdox Saved Cost of Goods Sold "value is additive" flag can be modified using the fincommerce_save_product_cogs_is_additive_flag filter.
	 *
	 * @testWith [true]
	 *           [false]
	 *
	...
	public function test_cogs_saved_additive_flag_can_be_altered_via_filter( bool $flag_value ) {
		...
		// phpcs:ignore Generic.CodeAnalysis.UnusedFunctionParameter.FoundAfterLastUsed
		add_filter( 'fincommerce_save_product_cogs_is_additive_flag', fn( $value, $product ) => ! $value, 10, 2 );
	...
	/**
	 * @testdox Saving of the Cost of Goods Sold "value is additive" flag can be suppressed using the fincommerce_save_product_cogs_is_additive_flag filter with a return value of null.
	 *
	 * @testWith [true]
	 *           [false]
	 *
	...
	public function test_cogs_saved_additive_flag_saving_can_be_suppressed_via_filter( bool $flag_value ) {
		...
		// phpcs:ignore Generic.CodeAnalysis.UnusedFunctionParameter.FoundAfterLastUsed
		add_filter( 'fincommerce_save_product_cogs_is_additive_flag', fn( $value, $product ) => null, 10, 2 );
