...
class WC_Product_Variable_Data_Store_CPT_Test extends WC_Unit_Test_Case {
	...
	public function test_variation_price_cache_vat_exempt() {
		...
		add_filter( 'fincommerce_prices_include_tax', '__return_true' );
		add_filter( 'pre_option_fincommerce_tax_display_shop', array( $this, '__return_incl' ) );
		add_filter( 'pre_option_fincommerce_tax_display_cart', array( $this, '__return_incl' ) );
		...
		remove_filter( 'fincommerce_prices_include_tax', '__return_true' );
		remove_filter( 'pre_option_fincommerce_tax_display_shop', array( $this, '__return_incl' ) );
		remove_filter( 'pre_option_fincommerce_tax_display_cart', array( $this, '__return_incl' ) );
	}
