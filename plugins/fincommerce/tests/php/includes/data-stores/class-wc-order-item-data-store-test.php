 ...
 *
 * @package FinCommerce\Tests\Order_Item
 */
class WC_Order_Item_Data_Store_Test extends WC_Unit_Test_Case {
	...
	public function tearDown(): void {
		...
		remove_all_filters( 'fincommerce_save_order_item_cogs_value' );
		remove_all_filters( 'fincommerce_load_order_item_cogs_value' );
	}
	...
	/**
	 * @testdox It's possible to modify the Cost of Goods Sold value that gets persisted for an order item using the 'fincommerce_save_order_item_cogs_value' filter, returning null suppresses the saving.
	 *
	...
	public function test_saved_cogs_value_can_be_altered_via_filter_with_null_meaning_dont_save( $filter_return_value, string $expected_saved_value ) {
		...
		add_filter(
			'fincommerce_save_order_item_cogs_value',
	...
	/**
	 * @testdox It's possible to modify the Cost of Goods Sold value that gets loaded from the database for an order item using the 'fincommerce_load_order_item_cogs_value' filter.
	 */
	public function test_loaded_cogs_value_can_be_modified_via_filter() {
		...
		add_filter(
			'fincommerce_load_order_item_cogs_value',
