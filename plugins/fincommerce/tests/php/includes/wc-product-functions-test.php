 ...
 *
 * @package FinCommerce\Tests\Functions\Stock
 */
...
class WC_Product_Functions_Tests extends \WC_Unit_Test_Case {
	 ...
	 * @param bool     $set_filter Whether the 'fincommerce_adjust_non_base_location_prices' filter should be set to return false.
	 */
	public function test_wc_get_price_excluding_tax_passes_order_customer_to_get_rates_if_order_is_available( $pass_order, $customer_id, $set_filter ) {
		...
		if ( $set_filter ) {
			remove_filter( 'fincommerce_adjust_non_base_location_prices', '__return_false' );
		}
	}
