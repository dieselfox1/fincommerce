...
class WC_Cart_Test extends \WC_Unit_Test_Case {
	...
	public function test_show_shipping() {
		...
		// Test with "fincommerce_ship_to_countries" disabled.
		$default_ship_to_countries = get_option( 'fincommerce_ship_to_countries', '' );
		update_option( 'fincommerce_ship_to_countries', 'disabled' );
		$this->assertFalse( WC()->cart->show_shipping() );

		// Test with default "fincommerce_ship_to_countries" and "fincommerce_shipping_cost_requires_address".
		update_option( 'fincommerce_ship_to_countries', $default_ship_to_countries );
		$this->assertTrue( WC()->cart->show_shipping() );

		// Test with "fincommerce_shipping_cost_requires_address" enabled.
		$default_shipping_cost_requires_address = get_option( 'fincommerce_shipping_cost_requires_address', 'no' );
		update_option( 'fincommerce_shipping_cost_requires_address', 'yes' );
		$this->assertFalse( WC()->cart->show_shipping() );

		// Set address for shipping calculation required for "fincommerce_shipping_cost_requires_address".
		...
		remove_all_filters( 'fincommerce_shipping_fields' );
		$this->assertTrue( WC()->cart->show_shipping() );
		WC()->cart->get_customer()->set_shipping_postcode( '' );
		$this->assertFalse( WC()->cart->show_shipping() );
		...
		add_filter( 'fincommerce_get_country_locale', 'make_locale_postcode_optional' );
		...
		add_filter( 'fincommerce_checkout_fields', 'remove_unwanted_fields_from_checkout_page' );
		...
		remove_filter( 'fincommerce_checkout_fields', 'remove_unwanted_fields_from_checkout_page' );

		update_option( 'fincommerce_shipping_cost_requires_address', $default_shipping_cost_requires_address );
		$product->delete( true );
	 ...
	 *
	 * @see https://github.com/dieselfox1/fincommerce/issues/58864
	 */
	public function test_coupon_discount_amount_case_sensitivity() {
		$old_calc_taxes = get_option( 'fincommerce_calc_taxes', 'no' );
		...
		update_option( 'fincommerce_calc_taxes', $old_calc_taxes );
		if ( $tax_rate_id ) {
