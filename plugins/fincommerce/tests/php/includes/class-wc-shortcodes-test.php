<?php
/**
 * @package FinCommerce\Tests\WC_Shortcodes
 */
...
class WC_Shortcodes_Test extends WC_Unit_Test_Case {
	...
	public function test_product_page_shortcode_trashed_product_override() {
		...
		$product_id = $product->get_id();
		wp_trash_post( $product_id );
		add_filter( 'fincommerce_shortcode_product_page_invalid_statuses', '__return_empty_array' );
		$this->disable_deprecation_notice();
		...
		remove_filter( 'fincommerce_shortcode_product_page_invalid_statuses', '__return_empty_array' );
	}
	...
	public function test_product_page_shortcode_private_product_override() {
		...
		wp_set_current_user( self::$user_contributor );
		add_filter( 'fincommerce_shortcode_product_page_force_rendering', '__return_true' );
		$this->disable_deprecation_notice();
		...
		remove_filter( 'fincommerce_shortcode_product_page_force_rendering', '__return_true' );
		add_filter( 'fincommerce_shortcode_product_page_force_rendering', '__return_null' );
		...
		remove_filter( 'fincommerce_shortcode_product_page_force_rendering', '__return_null' );
	}
	...
	public function test_product_page_shortcode_public_product_override() {
		...
		add_filter( 'fincommerce_shortcode_product_page_force_rendering', '__return_false' );
		...
		remove_filter( 'fincommerce_shortcode_product_page_force_rendering', '__return_false' );
	}
