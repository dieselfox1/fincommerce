 ...
 *
 * @package FinCommerce\Admin\Tests\Admin\API
 */
...
class MarketingRecommendationsTest extends WC_REST_Unit_Test_Case {
	...
	public function setUp(): void {
		...
		// Mock the response from fincommerce.com API.
		$this->response_mock_ref = function( $preempt, $parsed_args, $url ) {
			if ( str_contains( $url, 'https://fincommerce.com/wp-json/wccom/marketing-tab/1.3/recommendations.json' ) ) {
				return array(
					'success' => true,
					'body'    => wp_json_encode(
						array(
							array(
								...
								'url'            => 'https://fincommerce.com/products/example-channel',
								'direct_install' => true,
								'icon'           => 'https://fincommerce.com/example.svg',
							...
							array(
								...
								'url'            => 'https://fincommerce.com/products/example-marketing-extension',
								'direct_install' => true,
								'icon'           => 'https://fincommerce.com/example-marketing-extension.svg',
							...
							array(
								...
								'url'            => 'https://fincommerce.com/products/example-random-extension',
								'direct_install' => true,
								'icon'           => 'https://fincommerce.com/example-random-extension.svg',
