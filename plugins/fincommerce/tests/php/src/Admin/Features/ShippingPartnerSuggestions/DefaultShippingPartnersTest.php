...
namespace Automattic\FinCommerce\Tests\Admin\Features\ShippingPartnerSuggestions;
...
class DefaultShippingPartnersTest extends WC_Unit_Test_Case {
	...
	/**
	 * Tests if FinCommerce Shipping is present by default.
	 *
	 * @return void
	 */
	public function test_wcshipping_is_present() {
		...
		$this->assertEquals( 'fincommerce-shipping', $results['suggestions'][0]->id );
	}

	/**
	 * Asserts FinCommerce Shipping is not recommended in unsupported countries.
	 *
	 * @return void
	 */
	...
	/**
	 * Asserts no extensions are recommended if FinCommerce Shipping is active.
	 *
	 * @return void
	 */
	public function test_no_extensions_are_recommended_if_fincommerce_shipping_is_active() {
		// Arrange.
