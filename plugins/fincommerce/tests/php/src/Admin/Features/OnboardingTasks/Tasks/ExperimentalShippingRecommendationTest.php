 ...
 *
 * @package FinCommerce\Admin\Tests\Admin\Features\OnboardingTasks\Tasks
 */

namespace Automattic\FinCommerce\Tests\Admin\Features\OnboardingTasks\Tasks;

use Automattic\FinCommerce\Admin\Features\OnboardingTasks\Tasks\ExperimentalShippingRecommendation;
...
class ExperimentalShippingRecommendationTest extends WC_Unit_Test_Case {
	...
	public function setUp(): void {
		...
		add_filter( 'fincommerce_admin_features', array( $this, 'get_mocked_admin_features' ), self::HOOK_PRIORITY );
	...
	public function tearDown(): void {
		...
		remove_filter( 'fincommerce_admin_features', array( $this, 'get_mocked_admin_features' ), self::HOOK_PRIORITY );
