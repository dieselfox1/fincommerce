...
use Automattic\FinCommerce\Admin\Features\Blueprint\Init;
use Automattic\FinCommerce\Tests\Admin\Features\Blueprint\stubs\DummyExporter;
use Mockery;
 ...
 * Class InitTest
 *
 * @package Automattic\FinCommerce\Tests\Admin\Features\Blueprint
 */
class InitTest extends MockeryTestCase {
	...
	public function test_get_step_groups_for_js() {
		...
		$expected = array(
			array(
				'id'          => 'settings',
				'description' => 'Includes all the items featured in FinCommerce | Settings.',
				'label'       => 'FinCommerce Settings',
				'icon'        => 'settings',
				'items'       => array(
					array(
						'id'          => 'dummy',
