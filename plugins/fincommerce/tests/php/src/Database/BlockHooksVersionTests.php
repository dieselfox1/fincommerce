...
namespace Automattic\FinCommerce\Tests\Database;
...
class BlockHooksVersionTests extends \WC_Unit_Test_Case {
	 ...
	 * @var string
	 */
	protected static $option_name = 'fincommerce_hooked_blocks_version';
	...
	/**
	 * Test fincommerce_hooked_blocks_version option gets set on fincommerce_newly_installed action.
	 *
	 * @return void
	 */
	public function test_block_hooks_version_is_saved_on_install() {
		...
		delete_option( 'fincommerce_version' );
	...
	/**
	 * Test fincommerce_hooked_blocks_version option is not set on fincommerce_newly_installed action with classic themes.
	 *
	 * @return void
	 */
	...
	/**
	 * Test fincommerce_hooked_blocks_version option is not updated if already set on fincommerce_newly_installed action.
	 *
	 * @return void
	 */
	...
	/**
	 * Test fincommerce_hooked_blocks_version option gets set on theme switch from a classic to a block theme.
	 *
	 * @return void
	 */
