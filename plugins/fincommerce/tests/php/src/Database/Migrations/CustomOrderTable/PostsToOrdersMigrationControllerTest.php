...
namespace Automattic\FinCommerce\Tests\Database\Migrations\CustomOrderTable;
...
use Automattic\FinCommerce\Testing\Tools\DynamicDecorator;
...
"
	...
	private function assert_order_op_data_is_migrated( $order ) {
		...
		$this->assertEquals( $order->get_version(), $db_order_op_data->fincommerce_version );
