...
class StoreNoticeOnThemeSwitch extends \WC_Unit_Test_Case {
	 ...
	 * @var string
	 */
	protected static $enable_store_notice_in_classic_theme_option = 'fincommerce_enable_store_notice_in_classic_theme';
	 ...
	 * @var string
	 */
	protected static $is_store_notice_active_option = 'fincommerce_demo_store';
