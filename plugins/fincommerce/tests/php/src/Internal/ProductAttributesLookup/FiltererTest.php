...
use Automattic\FinCommerce\Internal\AttributesHelper;
...
class FiltererTest extends \WC_Unit_Test_Case {
	...
	private function set_hide_out_of_stock_items( $hide ) {
		update_option( 'fincommerce_hide_out_of_stock_items', $hide ? 'yes' : 'no' );
	}
	...
	private function set_use_lookup_table( $use ) {
		update_option( 'fincommerce_attribute_lookup_enabled', $use ? 'yes' : 'no' );
	}
