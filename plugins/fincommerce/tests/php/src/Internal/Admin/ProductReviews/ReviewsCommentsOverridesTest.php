 ...
 *
 * @covers \Automattic\FinCommerce\Internal\Admin\ProductReviews\ReviewsCommentsOverrides
 */
class ReviewsCommentsOverridesTest extends WC_Unit_Test_Case {
	 ...
	 *
	 * @covers \Automattic\FinCommerce\Internal\Admin\ProductReviews\ReviewsCommentsOverrides::display_notices()
	 ...
	 *
	 * @covers \Automattic\FinCommerce\Internal\Admin\ProductReviews\ReviewsCommentsOverrides::maybe_display_reviews_moved_notice()
	 ...
	 *
	 * @covers \Automattic\FinCommerce\Internal\Admin\ProductReviews\ReviewsCommentsOverrides::should_display_reviews_moved_notice()
	 ...
	 *
	 * @covers \Automattic\FinCommerce\Internal\Admin\ProductReviews\ReviewsCommentsOverrides::display_reviews_moved_notice()
	 *
	 * @return void
	...
	public function test_display_reviews_moved_notice() : void {
		...
		$nonce = wp_create_nonce( 'fincommerce_hide_notices_nonce' );
	 ...
	 *
	 * @covers \Automattic\FinCommerce\Internal\Admin\ProductReviews\ReviewsCommentsOverrides::get_dismiss_capability()
	...
	public function provider_test_get_dismiss_capability() : Generator {
		yield 'another notice' => [ 'manage_fincommerce', 'other_notice', 'manage_fincommerce' ];
		yield 'product reviews moved notice' => [ 'manage_fincommerce', ReviewsCommentsOverrides::REVIEWS_MOVED_NOTICE_ID, 'moderate_comments' ];
	}

	/**
	 * @testdox `exclude_reviews_from_comments` excludes product reviews from the comment query in the comments page.
	 *
	 * @covers \Automattic\FinCommerce\Internal\Admin\ProductReviews\ReviewsCommentsOverrides::exclude_reviews_from_comments()
	 *
	 * @return void
	 * @throws ReflectionException If the method doesn't exist.
	 */
