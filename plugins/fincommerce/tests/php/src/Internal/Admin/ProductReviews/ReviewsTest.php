 ...
 *
 * @covers \Automattic\FinCommerce\Internal\Admin\ProductReviews\Reviews
 */
class ReviewsTest extends WC_Unit_Test_Case {
	 ...
	 *
	 * @covers \Automattic\FinCommerce\Internal\Admin\ProductReviews\Reviews::get_capability()
	 *
	 * @return void
	 */
	public function test_get_view_page_capability() : void {
		...
		$callback = function() {
			return 'manage_fincommerce';
		};

		add_filter( 'fincommerce_product_reviews_page_capability', $callback );

		$this->assertEquals( 'manage_fincommerce', Reviews::get_capability() );

		remove_filter( 'fincommerce_product_reviews_page_capability', $callback );
	}

	/**
	 * @testdox `load_reviews_screen` creates an instance of {@see \Automattic\FinCommerce\Internal\Admin\ProductReviews\ReviewsListTable}.
	 *
	 * @covers \Automattic\FinCommerce\Internal\Admin\ProductReviews\Reviews::load_reviews_screen()
	 *
	 * @return void
	 ...
	 *
	 * @covers \Automattic\FinCommerce\Internal\Admin\ProductReviews\Reviews::get_pending_count_bubble()
	 ...
	 *
	 * @covers \Automattic\FinCommerce\Internal\Admin\ProductReviews\Reviews::edit_review_parent_file()
	 *
	 * @return void
	 * @throws ReflectionException If the method doesn't exist.
	 */
	 ...
	 *
	 * @covers \Automattic\FinCommerce\Internal\Admin\ProductReviews\Reviews::render_reviews_list_table()
	 *
	 * @return void
	...
	public function test_render_reviews_list_table() : void {
		...
		add_filter(
			'fincommerce_product_reviews_list_table',
		...
		remove_all_filters( 'fincommerce_product_reviews_list_table' );
	}

	/**
	 * @testdox `is_reviews_page` will determine if the current screen is the product reviews page.
	 *
	 * @covers \Automattic\FinCommerce\Internal\Admin\ProductReviews\Reviews::is_reviews_page()
	 ...
	 *
	 * @covers       \Automattic\FinCommerce\Internal\Admin\ProductReviews\Reviews::get_bulk_action_notice_messages()
	 ...
	 *
	 * @covers \Automattic\FinCommerce\Internal\Admin\ProductReviews\Reviews::maybe_display_reviews_bulk_action_notice()
...
test2</p></div>',
	 ...
	 *
	 * @covers       \Automattic\FinCommerce\Internal\Admin\ProductReviews\Reviews::display_notices()
	 ...
	 *
	 * @covers \Automattic\FinCommerce\Internal\Admin\ProductReviews\Reviews::is_review_or_reply()
	...
	public function test_is_review_or_reply_with_comment_object() : void {
		...
		add_filter( 'fincommerce_product_reviews_is_product_review_or_reply', $callback );

		$this->assertTrue( $method->invoke( $reviews, new stdClass() ) );

		remove_filter( 'fincommerce_product_reviews_is_product_review_or_reply', $callback );
	}
