...
use Automattic\FinCommerce\Internal\Admin\EmailPreview\EmailPreviewRestController;
...
class EmailPreviewRestControllerTest extends WC_REST_Unit_Test_Case {
	...
	public function test_send_preview_error_response() {
		add_filter( 'fincommerce_mail_callback', array( $this, 'simulate_failed_sending' ), 10, 0 );
		...
		remove_filter( 'fincommerce_mail_callback', array( $this, 'simulate_failed_sending' ), 10 );
	}
	...
	public function test_save_transient_sanitization_logic_with_newlines() {
		$textarea_key            = 'fincommerce_email_footer_text';
		...
		$text_key            = 'fincommerce_email_header_image';
		$text_value          = "Line 1\nLine 2\nLine 3";
