...
use Automattic\FinCommerce\Internal\Admin\BlockTemplates\BlockTemplate;
...
class BlockTemplateTest extends WC_Unit_Test_Case {
	...
	public function test_after_add_block_hooks() {
		...
		try {
			add_action( 'fincommerce_block_template_after_add_block', $after_add_block_hook );
			...
			add_action( 'fincommerce_block_template_area_uncategorized_after_add_block_test-block-id', $specific_after_add_block_hook );
			...
			remove_action( 'fincommerce_block_template_after_add_block', $after_add_block_hook );
			remove_action( 'fincommerce_block_template_area_uncategorized_after_add_block_test-block-id', $specific_after_add_block_hook );
		}
	}
	...
	public function test_after_remove_block_hooks() {
		...
		try {
			add_action( 'fincommerce_block_template_after_remove_block', $after_remove_block_hook );
			add_action( 'fincommerce_block_template_area_uncategorized_after_remove_block_test-block-id', $specific_after_remove_block_hook );
			...
			remove_action( 'fincommerce_block_template_after_remove_block', $after_remove_block_hook );
			remove_action( 'fincommerce_block_template_area_uncategorized_after_remove_block_test-block-id', $specific_after_remove_block_hook );
		}
	}
