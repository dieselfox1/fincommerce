...
namespace Automattic\FinCommerce\Tests\Internal\Admin\Suggestions\Incentives;

use Automattic\FinCommerce\Internal\Admin\Suggestions\Incentives\Incentive;
use Automattic\FinCommerce\Internal\Admin\Suggestions\Incentives\WooPayments;
...
class WooPaymentsTest extends WC_Unit_Test_Case {
	...
	public function test_is_visible_skips_extension_active_check() {
		...
		$filter_callback = fn( $caps ) => array( 'manage_fincommerce' => true );
