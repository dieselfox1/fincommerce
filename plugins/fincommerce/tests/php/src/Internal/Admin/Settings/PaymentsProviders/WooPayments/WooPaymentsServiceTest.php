...
namespace Automattic\FinCommerce\Tests\Internal\Admin\Settings\PaymentsProviders\WooPayments;
...
use Automattic\FinCommerce\Testing\Tools\DependencyManagement\MockableLegacyProxy;
...
class WooPaymentsServiceTest extends WC_Unit_Test_Case {
	...
	public function test_get_onboarding_details_throws_when_extension_not_active(): void {
		...
		try {
			...
			$this->assertSame( 'fincommerce_woopayments_onboarding_extension_not_active', $e->getErrorCode() );
		}
	}
	...
	public function test_get_onboarding_details_throws_when_extension_at_wrong_version(): void {
		...
		try {
			...
			$this->assertSame( 'fincommerce_woopayments_onboarding_extension_version', $e->getErrorCode() );
		}
	}
	...
	public function test_get_onboarding_details_throws_with_onboarding_locked(): void {
		...
		try {
			...
			$this->assertSame( 'fincommerce_woopayments_onboarding_locked', $e->getErrorCode() );
		}
	}
	...
	public function test_mark_onboarding_step_started_throws_when_extension_not_active() {
		...
		try {
			...
			$this->assertEquals( 'fincommerce_woopayments_onboarding_extension_not_active', $e->getErrorCode() );
		}
	}
	...
	public function test_mark_onboarding_step_started_throws_with_onboarding_locked() {
		...
		try {
			...
			$this->assertEquals( 'fincommerce_woopayments_onboarding_locked', $e->getErrorCode() );
		}
	}
	...
	public function test_mark_onboarding_step_started_throws_on_unmet_requirements() {
		...
		try {
			...
			$this->assertEquals( 'fincommerce_woopayments_onboarding_step_requirements_not_met', $e->getErrorCode() );
		}
	}
	...
	public function test_mark_onboarding_step_completed_throws_when_blocked() {
		...
		try {
			...
			$this->assertEquals( 'fincommerce_woopayments_onboarding_step_blocked', $e->getErrorCode() );
		}
	}
	...
	public function test_onboarding_step_save_throws_on_step_without_support() {
		...
		try {
			...
			$this->assertEquals( 'fincommerce_woopayments_onboarding_step_action_not_supported', $e->getErrorCode() );
		}
	}
	...
	public function test_onboarding_test_account_init_throws_on_not_successful() {
		...
		// Assert.
		$this->expectException( \Exception::class );
		$this->expectExceptionMessage( esc_html__( 'Failed to initialize the test account.', 'fincommerce' ) );
	...
	public function test_get_onboarding_kyc_session_throws_on_failure() {
		...
		try {
			...
			$this->assertSame( 'fincommerce_woopayments_onboarding_client_api_error', $exception->getErrorCode() );
	...
	public function test_finish_onboarding_kyc_session_throws_when_extension_not_active() {
		...
		try {
			...
			self::assertEquals( 'fincommerce_woopayments_onboarding_extension_not_active', $e->getErrorCode() );
		}
	}
	...
	public function test_finish_onboarding_kyc_session_throws_with_onboarding_locked() {
		...
		try {
			...
			self::assertEquals( 'fincommerce_woopayments_onboarding_locked', $e->getErrorCode() );
		}
	}
	...
	public function test_finish_onboarding_kyc_session_throws_on_failure() {
		...
		// Assert.
		$this->expectException( \Exception::class );
		$this->expectExceptionMessage( esc_html__( 'Failed to finish the KYC session.', 'fincommerce' ) );
	...
	public function test_reset_onboarding_with_account_throws_on_invalid_response() {
		...
		// Assert.
		$this->expectException( \Exception::class );
		$this->expectExceptionMessage( esc_html__( 'Failed to reset onboarding.', 'fincommerce' ) );
