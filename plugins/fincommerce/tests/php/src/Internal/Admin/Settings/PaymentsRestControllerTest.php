...
class PaymentsRestControllerTest extends WC_REST_Unit_Test_Case {
	...
	public function test_get_payment_providers_with_no_location() {
		...
		// Clean up.
		delete_option( 'fincommerce_default_country' );
	}
	...
	private function mock_providers( bool $skip_suggestions = false, bool $skip_offline_pms = false, bool $skip_paypal = false, bool $enabled_core_paypal_pg = false ) {
		...
		if ( ! $skip_suggestions && current_user_can( 'install_plugins' ) ) {
			$mock_providers[] = array(
				...
				'image'             => 'http://localhost:8888/wp-content/plugins/fincommerce/assets/images/onboarding/woopayments.svg',
				'icon'              => 'http://localhost:8888/wp-content/plugins/fincommerce/assets/images/onboarding/woopayments.svg',
				'links'             => array(
					array(
						'_type' => 'pricing',
			...
			$mock_providers[] = array(
				...
				'image'             => 'http://localhost:8888/wp-content/plugins/fincommerce/assets/images/onboarding/paypal.png',
				'icon'              => 'http://localhost:8888/wp-content/plugins/fincommerce/assets/images/payment_methods/72x72/paypal.png',
				'links'             => array(
					array(
						'_type' => 'about',
		...
		if ( ! $skip_offline_pms ) {
			$mock_providers[] = array(
				...
				'icon'        => 'http://localhost:8888/wp-content/plugins/fincommerce/assets/images/payment_methods/cod.svg',
			);
			$mock_providers[] = array(
				...
				'icon'        => 'http://localhost:8888/wp-content/plugins/fincommerce/assets/images/payment_methods/bacs.svg',
				'links'       => array(
					array(
						'_type' => 'about',
						'url'   => 'https://fincommerce.com/',
					),
				),
				'state'       => array(
					'enabled'     => false,
			...
			$mock_providers[] = array(
				...
				'icon'        => 'http://localhost:8888/wp-content/plugins/fincommerce/assets/images/payment_methods/cheque.svg',
				'links'       => array(
					array(
						'_type' => 'about',
						'url'   => 'https://fincommerce.com/',
		...
		if ( ! $skip_paypal ) {
			$mock_providers[] = array(
				...
				'links'       => array(
					array(
						'_type' => 'about',
						'url'   => 'https://fincommerce.com/paypal',
					),
				),
				'plugin'      => array(
					'_type'  => 'wporg',
				...
				'other'     => array(
					array(
						...
						'links'       => array(
							array(
								'_type' => 'link',
								'url'   => 'https://fincommerce.com/stripe',
							),
						),
						'tags'        => array(),
						'category'    => 'category3',
					...
					array(
						...
						'links'       => array(
							array(
								'_type' => 'link',
								'url'   => 'https://fincommerce.com/affirm',
							),
						),
						'tags'        => array(),
						'category'    => 'category2',
			...
			->willReturn(
				array(
					array(
						'id'          => 'category1',
						'_priority'   => 10,
						'title'       => esc_html__( 'Category1', 'fincommerce' ),
						'description' => esc_html__( 'Description.', 'fincommerce' ),
					),
					array(
						'id'          => 'category2',
						'_priority'   => 20,
						'title'       => esc_html__( 'Category2', 'fincommerce' ),
						'description' => esc_html__( 'Description.', 'fincommerce' ),
					),
					array(
						'id'          => 'category3',
						'_priority'   => 30,
						'title'       => esc_html__( 'Category3', 'fincommerce' ),
						'description' => esc_html__( 'Description.', 'fincommerce' ),
					),
				)
			);
