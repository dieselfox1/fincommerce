...
namespace Automattic\FinCommerce\Tests\Internal\Admin\MarketingRecommendations;

use Automattic\FinCommerce\Admin\Features\MarketingRecommendations\DefaultMarketingRecommendations;
use Automattic\FinCommerce\Admin\Features\MarketingRecommendations\Init;
use Automattic\FinCommerce\Admin\Features\MarketingRecommendations\MarketingRecommendationsDataSourcePoller;
 ...
 *
 * @covers \Automattic\FinCommerce\Admin\Features\MarketingRecommendations\Init
 */
class InitTest extends WC_Unit_Test_Case {
	...
	public function tearDown(): void {
		...
		remove_all_filters( 'transient_fincommerce_admin_' . MarketingRecommendationsDataSourcePoller::ID . '_specs' );
	}
	...
	public function test_specs_transient() {
		set_transient(
			'fincommerce_admin_' . MarketingRecommendationsDataSourcePoller::ID . '_specs',
			array(
				'en_US' => array(
					array(
						'id' => 'mock1',
