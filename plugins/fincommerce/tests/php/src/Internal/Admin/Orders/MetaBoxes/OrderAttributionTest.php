<?php
/**
 * \Automattic\FinCommerce\Internal\Admin\Orders\MetaBoxes\OrderAttribution test class.
 */

namespace Automattic\FinCommerce\Tests\Internal\Admin\Orders\MetaBoxes;
...
class OrderAttributionTest extends WP_UnitTestCase {
	...
	public function test_default_arguments_passed_into_output() {
		...
		add_action(
			'fincommerce_before_template_part',
	...
	public function test_additional_order_meta_affects_arguments() {
		...
		$meta = array(
			'_wc_order_attribution_origin'             => 'Referral: FinCommerce.com',
			...
			'_wc_order_attribution_referrer'           => 'https://fincommerce.com/',
		...
		add_action(
			'fincommerce_before_template_part',
			function( $template_name, $template_path, $located, $args ) {
				$this->assertEquals( 'Referral: Fincommerce.com', $args['meta']['origin'] ?? '' );
				$this->assertEquals( 'Desktop', $args['meta']['device_type'] ?? '' );
				$this->assertEquals(
				...
				$this->assertEquals( 'https://fincommerce.com/', $args['meta']['referrer'] ?? '' );
