...
namespace Automattic\FinCommerce\Tests\Internal\Admin\Orders;
...
class EditLockTest extends \WC_Unit_Test_Case {
	...
	public function test_edit_lock_ajax() {
		...
		$response = apply_filters( 'heartbeat_received', array(), $request_data, 'fincommerce_page_wc-orders' ); // phpcs:ignore FinCommerce.Commenting.CommentHooks.MissingHookComment,FinCommerce.Commenting.CommentHooks.HookCommentWrongStyle
