...
namespace Automattic\FinCommerce\Tests\Internal\Utilities;
...
class URLTest extends WC_Unit_Test_Case {
	...
	public function all_parent_urL_expectations(): array {
		return array(
			array(
				'https://local.web/wp-content/uploads/fincommerce_uploads/pdf_bucket/secret-sauce.pdf',
				array(
					'https://local.web/wp-content/uploads/fincommerce_uploads/pdf_bucket/',
					'https://local.web/wp-content/uploads/fincommerce_uploads/',
