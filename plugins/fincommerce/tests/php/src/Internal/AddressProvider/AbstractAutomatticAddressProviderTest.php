...
use Automattic\FinCommerce\Internal\AddressProvider\AbstractAutomatticAddressProvider;
use Automattic\FinCommerce\StoreApi\Utilities\JsonWebToken;
...
class AbstractAutomatticAddressProviderTest extends TestCase {
	...
	protected function tearDown(): void {
		parent::tearDown();
		remove_all_filters( 'pre_update_option_fincommerce_address_autocomplete_enabled' );
	...
	public function test_constructor_sets_up_hooks() {
		$this->assertNotFalse( has_filter( 'pre_update_option_fincommerce_address_autocomplete_enabled', array( $this->test_provider, 'refresh_cache' ) ) );
	...
	public function test_get_asset_url_returns_correct_url() {
		...
		$this->assertStringContainsString( 'plugins/fincommerce', $url );
	}
	...
	public function test_backoff_logic_for_multiple_failures() {
		...
		foreach ( $test_cases as $test_number => $test_case ) {
			...
			remove_all_filters( 'fincommerce_logging_class' );
