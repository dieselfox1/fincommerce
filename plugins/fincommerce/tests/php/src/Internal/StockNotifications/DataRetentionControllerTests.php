...
namespace Automattic\FinCommerce\Tests\Internal\StockNotifications;

use Automattic\FinCommerce\Internal\StockNotifications\DataRetentionController;
...
class DataRetentionControllerTests extends \WC_Unit_Test_Case {
	...
	public function tearDown(): void {
		...
		delete_option( 'fincommerce_customer_stock_notifications_unverified_deletions_days_threshold' );
	}
