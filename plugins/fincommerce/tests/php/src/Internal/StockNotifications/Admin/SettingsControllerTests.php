...
namespace Automattic\FinCommerce\Tests\Internal\StockNotifications\Admin;
...
class SettingsControllerTests extends \WC_Settings_Unit_Test_Case {
	...
	public function test_get_customer_stock_notifications_settings_returns_all_settings() {
		...
		$expected = array(
			...
			'fincommerce_customer_stock_notifications_allow_signups' => 'checkbox',
			'fincommerce_customer_stock_notifications_require_double_opt_in' => 'checkbox',
			'fincommerce_customer_stock_notifications_require_account' => 'checkbox',
			'fincommerce_customer_stock_notifications_create_account_on_signup' => 'checkbox',
			'fincommerce_customer_stock_notifications_unverified_deletions_days_threshold' => 'number',
		);
