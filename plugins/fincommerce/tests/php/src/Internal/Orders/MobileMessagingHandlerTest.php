...
namespace Automattic\FinCommerce\Tests\Internal\Orders;

use Automattic\FinCommerce\Enums\OrderStatus;
use Automattic\FinCommerce\Internal\Orders\MobileMessagingHandler;
use DateTime;
use WC_Order;
use WC_Gateway_COD;
...
class MobileMessagingHandlerTest extends \WC_Unit_Test_Case {
	...
	public function test_show_get_app_message_when_no_mobile_reports_at_all() {
		...
		$this->assertStringContainsString(
			'href="https://fincommerce.com/mobile?blog_id=' . self::BLOG_ID . '&#038;utm_campaign=deeplinks_promote_app&#038;utm_medium=email&#038;utm_source=' . self::DOMAIN . '&#038;utm_term=' . self::BLOG_ID,
			$mobile_message
		);
	}
	...
	public function test_show_manage_order_message_when_store_is_NOT_ipp_eligible() {
		...
		$this->assertStringContainsString(
			'href="https://fincommerce.com/mobile/orders/details?blog_id=' . self::BLOG_ID . '&#038;order_id=' . self::ORDER_ID . '&#038;utm_campaign=deeplinks_orders_details&#038;utm_medium=email&#038;utm_source=' . self::DOMAIN . '&#038;utm_term=' . self::BLOG_ID,
			$mobile_message
		);
	}
	...
	public function test_show_accept_payment_message_when_store_and_order_are_ipp_eligible() {
		...
		$this->assertStringContainsString(
			'href="https://fincommerce.com/mobile/payments?blog_id=' . self::BLOG_ID . '&#038;utm_campaign=deeplinks_payments&#038;utm_medium=email&#038;utm_source=' . self::DOMAIN . '&#038;utm_term=' . self::BLOG_ID,
			$mobile_message
		);
	}
	...
	public function test_show_accept_payment_message_when_store_and_order_are_ipp_eligible_but_no_mobile_app_usage() {
		...
		$this->assertStringContainsString(
			'href="https://fincommerce.com/mobile/payments?blog_id=0&#038;utm_campaign=deeplinks_payments&#038;utm_medium=email&#038;utm_source=' . self::DOMAIN . '&#038;utm_term=0',
			$mobile_message
		);
	}
	...
	private function make_store_not_ipp_eligible() {
		update_option( 'fincommerce_default_country', 'AA:BB' );
		update_option( 'fincommerce_currency', 'CCC' );
	}
