...
namespace Automattic\FinCommerce\Tests\Internal\DependencyManagement;

use Automattic\FinCommerce\Blocks\Assets\Api as BlocksAssetsApi;
use Automattic\FinCommerce\Blocks\Package as BlocksPackage;
use Automattic\FinCommerce\Internal\DependencyManagement\ContainerException;
use Automattic\FinCommerce\Internal\DependencyManagement\RuntimeContainer;
use Automattic\FinCommerce\StoreApi\Schemas\ExtendSchema;
use Automattic\FinCommerce\StoreApi\StoreApi;
use Automattic\FinCommerce\Tests\Internal\DependencyManagement\ExampleClasses\ClassInterface;
use Automattic\FinCommerce\Tests\Internal\DependencyManagement\ExampleClasses\ClassThatHasReferenceArgumentsInInit;
use Automattic\FinCommerce\Tests\Internal\DependencyManagement\ExampleClasses\ClassWithNestedDependencies;
use Automattic\FinCommerce\Tests\Internal\DependencyManagement\ExampleClasses\ClassWithPrivateInjectionMethod;
use Automattic\FinCommerce\Tests\Internal\DependencyManagement\ExampleClasses\ClassWithRecursiveDependencies1;
use Automattic\FinCommerce\Tests\Internal\DependencyManagement\ExampleClasses\ClassWithRecursiveDependencies2;
use Automattic\FinCommerce\Tests\Internal\DependencyManagement\ExampleClasses\ClassWithRecursiveDependencies3;
use Automattic\FinCommerce\Tests\Internal\DependencyManagement\ExampleClasses\ClassWithScalarInjectionMethodArgument;
use Automattic\FinCommerce\Tests\Internal\DependencyManagement\ExampleClasses\ClassWithStaticInjectionMethod;
use Automattic\FinCommerce\Tests\Internal\DependencyManagement\ExampleClasses\ClassWithUntypedInjectionMethodArgument;
use Automattic\FinCommerce\Tests\Internal\DependencyManagement\ExampleClasses\DependencyClassWithInnerDependency;
use Automattic\FinCommerce\Tests\Internal\DependencyManagement\ExampleClasses\InnerDependencyClass;
use Automattic\FinCommerce\Tests\Internal\DependencyManagement\ExampleClasses\ClassThatThrowsOnInit;
use Automattic\FinCommerce\Tests\Internal\DependencyManagement\ExampleClasses\ClassWithStoreApiDependency;
use Automattic\FinCommerce\Internal\DependencyManagement\ExampleClasses\ClassWithConstructorWithOptionalParameters;
...
class RuntimeContainerTest extends \WC_Unit_Test_Case {
	...
	/**
	 * @testdox 'get' throws 'ContainerException' when trying to resolve a class outside the root FinCommerce namespace.
	 */
	public function test_exception_when_trying_to_resolve_class_outside_root_namespace() {
		$this->expectException( ContainerException::class );
		$this->expectExceptionMessage( "Attempt to get an instance of class 'Fizz\Buzz', which is not in the Automattic\FinCommerce\ namespace. Did you forget to add a namespace import?" );
	...
	public function test_exception_when_trying_to_resolve_non_existing_class() {
		$this->expectException( ContainerException::class );
		$this->expectExceptionMessage( "Attempt to get an instance of class 'Automattic\FinCommerce\Fizz\Buzz', which doesn't exist." );

		$this->sut->get( 'Automattic\FinCommerce\Fizz\Buzz' );
	}
	...
	public function test_exception_when_trying_to_resolve_class_with_private_constructor( string $class_name ) {
		$class_name = "Automattic\\FinCommerce\\Internal\\DependencyManagement\\ExampleClasses\\$class_name";
		$this->expectException( ContainerException::class );
	...
	public function test_exception_when_trying_to_resolve_class_with_constructor_with_non_optional_arguments() {
		$class_name = 'Automattic\\FinCommerce\\Internal\\DependencyManagement\\ExampleClasses\\ClassWithConstructorWithParameters';
		$this->expectException( ContainerException::class );
	...
	/**
	 * @testdox 'get' properly resolves and caches classes, and its dependencies, if they are in the root FinCommerce namespace.
	 */
	...
	/**
	 * @testdox 'has' returns true for classes in the root FinCommerce namespace, or passed to the constructor in the initial resolve cache.
	 */
	...
	/**
	 * @testdox 'has' returns false for classes not in the root FinCommerce namespace.
	 */
