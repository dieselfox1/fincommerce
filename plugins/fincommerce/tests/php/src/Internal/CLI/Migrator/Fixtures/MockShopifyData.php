 ...
 *
 * @package Automattic\FinCommerce\Tests\Internal\CLI\Migrator\Fixtures
 */

declare( strict_types=1 );

namespace Automattic\FinCommerce\Tests\Internal\CLI\Migrator\Fixtures;
...
class MockShopifyData {
	...
	/**
	 * Get mock FinCommerce product data (mapped from Shopify).
	 *
	 * @param int $product_id The source product ID.
	 * @return array Mapped FinCommerce product data.
	 */
