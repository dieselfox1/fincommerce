<?php
/**
 * fincommerceProductImporter Test
 *
 * @package Automattic\FinCommerce\Tests\Internal\CLI\Migrator\Core
 */

declare( strict_types=1 );

namespace Automattic\FinCommerce\Tests\Internal\CLI\Migrator\Core;

use Automattic\FinCommerce\Internal\CLI\Migrator\Core\fincommerceProductImporter;
use Automattic\FinCommerce\Tests\Internal\CLI\Migrator\Fixtures\MockShopifyData;
use WC_Product_Simple;
use WC_Product_Variable;

/**
 * fincommerceProductImporterTest class.
 */
class fincommerceProductImporterTest extends \WC_Unit_Test_Case {

	/**
	 * The fincommerceProductImporter instance under test.
	 *
	 * @var fincommerceProductImporter
	 */
	private fincommerceProductImporter $importer;
	...
	public function setUp(): void {
		...
		$this->importer = new fincommerceProductImporter();
	...
	/**
	 * Test fincommerceProductImporter instantiation.
	 */
	public function test_importer_instantiation(): void {
		$this->assertInstanceOf( fincommerceProductImporter::class, $this->importer );
	}
	...
	public function test_import_existing_product_skip(): void {
		...
		$importer_skip = new fincommerceProductImporter();
	...
	public function test_import_existing_product_update(): void {
		...
		$importer_update = new fincommerceProductImporter();
	...
	public function test_dry_run_mode(): void {
		$dry_run_importer = new fincommerceProductImporter();
	...
	public function test_image_import_with_max_limit(): void {
		$limited_importer = new fincommerceProductImporter();
	...
	public function test_image_import_disabled(): void {
		$no_images_importer = new fincommerceProductImporter();
	...
	public function test_error_handling_with_invalid_data(): void {
		...
		// This should still succeed as price validation is handled by FinCommerce.
	...
	public function test_category_creation_disabled(): void {
		$no_categories_importer = new fincommerceProductImporter();
	...
	public function test_tag_creation_disabled(): void {
		$no_tags_importer = new fincommerceProductImporter();
	...
	public function test_variation_handling_disabled(): void {
		$no_variations_importer = new fincommerceProductImporter();
	...
	public function test_find_existing_product_by_slug(): void {
		...
		$update_importer = new fincommerceProductImporter();
