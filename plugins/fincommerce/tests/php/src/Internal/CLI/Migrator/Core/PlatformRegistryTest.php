...
class PlatformRegistryTest extends \WC_Unit_Test_Case {
	...
	public function tearDown(): void {
		parent::tearDown();
		remove_all_filters( 'fincommerce_migrator_platforms' );
	}
	...
	public function test_platform_registration() {
		add_filter(
			'fincommerce_migrator_platforms',
			function ( $platforms ) {
	...
	public function test_get_fetcher_for_wrong_interface_throws_exception() {
		...
		$this->expectException( \InvalidArgumentException::class );
		$this->expectExceptionMessage( 'Invalid fetcher class for platform wrong-fetcher-interface. Class stdClass does not implement Automattic\FinCommerce\Internal\CLI\Migrator\Interfaces\PlatformFetcherInterface.' );
	...
	public function test_get_mapper_for_wrong_interface_throws_exception() {
		...
		$this->expectException( \InvalidArgumentException::class );
		$this->expectExceptionMessage( 'Invalid mapper class for platform wrong-mapper-interface. Class stdClass does not implement Automattic\FinCommerce\Internal\CLI\Migrator\Interfaces\PlatformMapperInterface.' );
