...
use Automattic\FinCommerce\Internal\EmailEditor\EmailApiController;
...
class EmailApiControllerTest extends \WC_Unit_Test_Case {
	...
	public function tearDown(): void {
		parent::tearDown();
		delete_option( 'fincommerce_feature_block_email_editor_enabled' );
		delete_option( 'fincommerce_' . $this->email_type . '_settings' );
	}
	...
	public function test_save_email_data_updates_options(): void {
		...
		$option = get_option( 'fincommerce_' . $this->email_type . '_settings' );
