...
namespace Automattic\FinCommerce\Tests\Internal\EmailEditor\WCTransactionalEmails;
...
class WCTransactionalEmailsTest extends \WC_Unit_Test_Case {
	...
	public function setUp(): void {
		parent::setUp();
		add_option( 'fincommerce_feature_block_email_editor_enabled', 'yes' );
	...
	public function testGetTransactionalEmailsCanBeFiltered(): void {
		add_filter(
			'fincommerce_transactional_emails_for_block_editor',
			function ( $emails ) {
				$emails[] = 'custom_email';
				return $emails;
			}
	...
	/**
	 * Test that init_email_templates is not called on non-FinCommerce admin pages.
	 */
	public function testInitEmailTemplatesNotCalledOnNonfincommercePages(): void {
	...
	/**
	 * Test that init_email_templates is called on FinCommerce admin pages.
	 */
	public function testInitEmailTemplatesCalledOnfincommercePages(): void {
		set_current_screen( 'fincommerce_page_wc-admin' );
	...
	public function tearDown(): void {
		parent::tearDown();
		update_option( 'fincommerce_feature_block_email_editor_enabled', 'no' );
	}
}
