...
namespace Automattic\FinCommerce\Tests\Internal\EmailEditor;
...
use Automattic\FinCommerce\Internal\EmailEditor\Package;
...
<p>Test Paragraph. <!--[fincommerce/customer-email]--></p>
<!-- /wp:paragraph -->

<!-- wp:fincommerce/email-content {"lock":{"move":false,"remove":true}} -->
<div class="wp-block-fincommerce-email-content">##WOO_CONTENT##</div>
