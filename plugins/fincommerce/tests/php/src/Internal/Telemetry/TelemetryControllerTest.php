 ...
 *
 * @package FinCommerce\Admin\Tests\Internal\Telemetry
 */

namespace Automattic\FinCommerce\Tests\Internal\Telemetry;
...
class TelemetryControllerTest extends WC_REST_Unit_Test_Case {
	...
	const MOBILE_USAGE_OPTION_KEY = 'fincommerce_mobile_app_usage';
