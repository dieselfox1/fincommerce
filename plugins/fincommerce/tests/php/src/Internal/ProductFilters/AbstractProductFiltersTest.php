...
abstract class AbstractProductFiltersTest extends \WC_Unit_Test_Case {
	...
	public function setUp(): void {
		...
		$this->backup_options = array(
			'fincommerce_attribute_lookup_enabled' => get_option( 'fincommerce_attribute_lookup_enabled' ),
			'fincommerce_calc_taxes'               => get_option( 'fincommerce_calc_taxes' ),
			'fincommerce_tax_display_shop'         => get_option( 'fincommerce_tax_display_shop' ),
		);
