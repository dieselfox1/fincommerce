...
namespace Automattic\FinCommerce\Tests\Internal\Email;
 ...
 * EmailStyleSync test.
 *
 * @covers \Automattic\FinCommerce\Internal\Email\EmailStyleSync
 */
class EmailStyleSyncTest extends WC_Unit_Test_Case {
	...
	public function setUp(): void {
		...
		$this->original_options = array(
			...
			'fincommerce_email_base_color'            => get_option( 'fincommerce_email_base_color', '' ),
			'fincommerce_email_background_color'      => get_option( 'fincommerce_email_background_color', '' ),
			'fincommerce_email_body_background_color' => get_option( 'fincommerce_email_body_background_color', '' ),
			'fincommerce_email_text_color'            => get_option( 'fincommerce_email_text_color', '' ),
			'fincommerce_email_footer_text_color'     => get_option( 'fincommerce_email_footer_text_color', '' ),
		);
