...
namespace Automattic\FinCommerce\Tests\Internal\Traits;
 ...
 *
 * DON'T USE THE TRAIT. It will be removed in Tfincommerce 10.5.
...
class AccessiblePrivateMethodsTest extends \WC_Unit_Test_Case {
	...
	public function test_private_and_protected_methods_can_be_made_accessible() {
		...
		$sut = new class() {
			...
			//phpcs:ignore FinCommerce.Functions.InternalInjectionMethod.MissingInternalTag
