...
class OrdersTableQueryTests extends \WC_Unit_Test_Case {
	...
	public function test_query_suppress_filters() {
		$hooks = array(
			'fincommerce_orders_table_query_clauses',
			'fincommerce_orders_table_query_sql',
		);
	...
	public function test_query_filters() {
		...
		add_filter( 'fincommerce_orders_table_query_clauses', $filter_callback );
		$this->assertCount( 0, wc_get_orders( array() ) );
		remove_all_filters( 'fincommerce_orders_table_query_clauses' );
		...
		add_filter( 'fincommerce_orders_table_query_clauses', $filter_callback, 10, 3 );
		$this->assertEquals(
			wc_get_orders(
				array(
					'return'        => 'ids',
	...
	public function test_pre_query_escape_hook_simple() {
		...
		add_filter( 'fincommerce_hpos_pre_query', $callback, 10, 3 );
		...
		remove_all_filters( 'fincommerce_hpos_pre_query' );
	}
	...
	public function test_pre_query_escape_hook_return_null() {
		add_filter( 'fincommerce_hpos_pre_query', '__return_null', 10, 3 );
