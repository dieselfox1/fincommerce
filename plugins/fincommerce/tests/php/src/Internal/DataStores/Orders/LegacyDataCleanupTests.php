...
use Automattic\FinCommerce\Internal\DataStores\Orders\LegacyDataCleanup;
...
class LegacyDataCleanupTests extends \WC_Unit_Test_Case {
	...
	public function test_batch_processor_interface() {
		...
		do_action( $batch_processing::PROCESS_SINGLE_BATCH_ACTION_NAME, get_class( $this->sut ) ); // phpcs:ignore FinCommerce.Commenting.CommentHooks.HookCommentWrongStyle -- this is a test
