...
class DataSynchronizerTests extends \HposTestCase {
	...
	public function test_auto_draft_deletion(): void {
		...
		do_action( 'wp_scheduled_auto_draft_delete' ); // phpcs:ignore FinCommerce.Commenting.CommentHooks.HookCommentWrongStyle
	...
	public function test_trashed_order_deletion(): void {
		...
		do_action( 'wp_scheduled_delete' ); // phpcs:ignore FinCommerce.Commenting.CommentHooks.HookCommentWrongStyle
	...
	public function test_hpos_option_is_disabled_but_sync_enabled_with_pending_orders( $auth_table_change_allowed_with_sync_pending, $expected_setting_disabled_status ) {
		...
		$features = apply_filters( 'fincommerce_get_settings_advanced', array(), 'features' );
	...
	public function test_bg_sync_while_sync_enabled() {
		...
		// phpcs:ignore FinCommerce.Commenting.CommentHooks.MissingHookComment -- This is a test.
