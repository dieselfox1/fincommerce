...
use Automattic\FinCommerce\Internal\Fulfillments\FulfillmentsRenderer;
...
class FulfillmentsRendererHooksTest extends \WC_Unit_Test_Case {
	...
	public function test_hooks() {
		...
		$this->assertNotFalse( has_filter( 'manage_fincommerce_page_wc-orders_columns', array( $this->renderer, 'add_fulfillment_columns' ) ) );
		$this->assertNotFalse( has_action( 'manage_fincommerce_page_wc-orders_custom_column', array( $this->renderer, 'render_fulfillment_column_row_data' ) ) );
	...
	public function test_admin_init_hooks() {
		...
		$this->assertNotFalse( has_filter( 'bulk_actions-fincommerce_page_wc-orders', array( $this->renderer, 'define_fulfillment_bulk_actions' ) ) );
		$this->assertNotFalse( has_filter( 'handle_bulk_actions-fincommerce_page_wc-orders', array( $this->renderer, 'handle_fulfillment_bulk_actions' ) ) );
		$container->reset_replacement( CustomOrdersTableController::class );
	}
