...
use Automattic\FinCommerce\Internal\Fulfillments\OrderFulfillmentsRestController;
 ...
 *
 * @package Automattic\FinCommerce\Tests\Internal\Orders
 */
class OrderFulfillmentsRestControllerTest extends WC_REST_Unit_Test_Case {
	...
	public function test_create_fulfillment_invalid_order_id() {
		...
		$this->assertEquals(
			array(
				'code'    => 'fincommerce_rest_order_invalid_id',
