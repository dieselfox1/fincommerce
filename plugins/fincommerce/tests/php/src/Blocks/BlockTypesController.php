...
use Automattic\FinCommerce\Blocks\BlockTypesController as TestedBlockTypesController;
...
class BlockTypesController extends \WP_UnitTestCase {
	...
	public function test_block_should_have_data_attributes() {
		...
		// A block that will be allowed because it has a parent with a fincommerce namespace.
		register_block_type(
			'child-of-woo/block-name',
			[
				'parent' => [ 'fincommerce/checkout-contact-information-block' ],
			]
		);
