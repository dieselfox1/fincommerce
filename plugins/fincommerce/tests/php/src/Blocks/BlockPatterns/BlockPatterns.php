...
namespace Automattic\FinCommerce\Tests\Blocks\BlockPatterns;

use Automattic\FinCommerce\Blocks\Patterns\PatternRegistry;
use Automattic\FinCommerce\Blocks\BlockPatterns as TestedBlockPatterns;
...
class BlockPatterns extends \WP_UnitTestCase {
	...
	protected function setUp(): void {
		...
		delete_site_transient( 'fincommerce_blocks_patterns' );
		...
		$this->pattern_registry
			...
			->withConsecutive(
				array(
					...
					array(
						'title'         => 'Mock Footer',
						'slug'          => 'fincommerce-blocks/mock-footer',
						'description'   => '',
						'viewportWidth' => '',
				...
				array(
					...
					array(
						'title'         => 'Mock Header',
						'slug'          => 'fincommerce-blocks/mock-header',
						'description'   => '',
						'viewportWidth' => '',
						'categories'    => 'FinCommerce',
						'keywords'      => '',
	...
	public function test_cached_block_patterns_registration() {
		...
		set_site_transient( 'fincommerce_blocks_patterns', $pattern_data );
