...
class CartApplyCoupon extends ControllerTestCase {
	...
	public function test_prevent_duplicate_coupon() {
		...
		$this->assertEquals( 'fincommerce_rest_cart_coupon_error', $data['code'] );
	...
	public function test_apply_coupon_when_disabled() {
		...
		// Disable coupons.
		update_option( 'fincommerce_enable_coupons', 'no' );
		...
		$this->assertEquals( 'fincommerce_rest_cart_coupon_disabled', $data['code'] );
