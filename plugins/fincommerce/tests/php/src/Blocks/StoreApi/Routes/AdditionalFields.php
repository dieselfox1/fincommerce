...
class AdditionalFields extends MockeryTestCase {
	...
	private function register_fields() {
		...
		array_map( 'fincommerce_register_additional_checkout_field', $this->fields );
	}
	...
	private function unregister_fields() {
		...
		array_map( '__internal_fincommerce_blocks_deregister_checkout_field', array_keys( $fields ) );
	}
	...
	public function test_checkbox_in_schema() {
		...
		$this->assertEquals(
			array(
				'description' => __( 'Please leave my package on the porch if I\'m not home', 'fincommerce' ),
				'type'        => 'boolean',
				'context'     => array(
					'view',
					'edit',
	...
	public function test_optional_field_in_schema() {
		...
		\__internal_fincommerce_blocks_deregister_checkout_field( $id );
	}
	...
	public function test_reading_values_externally() {
		...
		add_filter(
			"fincommerce_get_default_value_for_{$id}",
			function () {
		...
		\remove_all_filters( "fincommerce_get_default_value_for_{$id}" );
	}
	...
	public function test_reacting_to_value_save() {
		...
		$set_value_mocker->shouldReceive( 'fincommerce_set_additional_field_value' )->withArgs(
			array(
				$id,
				'my-value',
				'other',
	...
	public function test_invalid_rules_schema() {
		$doing_it_wrong_mocker = $this->add_doing_it_wrong_error_mocker( 'fincommerce_register_additional_checkout_field', 'Unable to register field with id: "namespace/test-id". validation: Rules must be defined as an array.' );
		\fincommerce_register_additional_checkout_field(
			array(
	...
	public function test_invalid_validation_rules_schema() {
		$doing_it_wrong_mocker = $this->add_doing_it_wrong_error_mocker( 'fincommerce_register_additional_checkout_field', 'Unable to register field with id: "namespace/test-id". validation: The properties must match schema: {properties}' );
		\fincommerce_register_additional_checkout_field(
			array(
				'id'         => 'namespace/test-id',
				'label'      => 'Test Field',
	...
	public function test_invalid_required_rules_schema() {
		$doing_it_wrong_mocker = $this->add_doing_it_wrong_error_mocker( 'fincommerce_register_additional_checkout_field', 'Unable to register field with id: "namespace/test-id". required: Rules must be defined as an array.' );
		\fincommerce_register_additional_checkout_field(
			array(
				'id'       => 'namespace/test-id',
				'label'    => 'Test Field',
