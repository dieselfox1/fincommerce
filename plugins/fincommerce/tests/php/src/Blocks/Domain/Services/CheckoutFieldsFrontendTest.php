...
namespace Automattic\FinCommerce\Tests\Blocks\Domain\Services;
...
/**
 * Test \Automattic\FinCommerce\Blocks\Domain\Services\Hydration class.
 */
class CheckoutFieldsFrontendTest extends TestCase {
	...
	public function setUp(): void {
		...
		add_filter( 'fincommerce_add_notice', [ $this, 'capture_notice' ] );
		add_filter( 'fincommerce_add_error', [ $this, 'capture_error' ] );
		add_filter( 'fincommerce_add_success', [ $this, 'capture_success' ] );
	...
	protected function tearDown(): void {
		remove_filter( 'fincommerce_add_notice', [ $this, 'capture_notice' ] );
		remove_filter( 'fincommerce_add_error', [ $this, 'capture_error' ] );
		remove_filter( 'fincommerce_add_success', [ $this, 'capture_success' ] );
	}
	...
	public function test_save_account_form_fields_contact_generic_validation_error() {
		...
		__internal_fincommerce_blocks_deregister_checkout_field( 'mynamespace/generic_validation_error' );
	}
	...
	public function test_save_account_form_fields_contact_location_validation_error() {
		...
		add_action( 'fincommerce_blocks_validate_location_contact_fields', $e_thrower );
		...
		__internal_fincommerce_blocks_deregister_checkout_field( 'mynamespace/location_validation_error' );

		remove_action( 'fincommerce_blocks_validate_location_contact_fields', $e_thrower );
	}
	...
	public function test_save_account_form_fields_contact_save_required_field() {
		...
		__internal_fincommerce_blocks_deregister_checkout_field( 'mynamespace/required_field' );
	}
	...
	public function test_save_account_form_fields_contact_save_optional_field() {
		...
		__internal_fincommerce_blocks_deregister_checkout_field( 'mynamespace/optional_field' );
	}
	...
	public function test_save_account_form_fields_contact_email_validation_error_optional_field() {
		...
		__internal_fincommerce_blocks_deregister_checkout_field( 'mynamespace/email_validation_error' );
	}
