...
class Hydration extends TestCase {
	 ...
	 * System under test.
	 *
	 * @var \Automattic\FinCommerce\Blocks\Domain\Services\Hydration
	 */
	private $sut;
	...
	public function setUp(): void {
		parent::setUp();
		$this->sut = Package::container()->get( \Automattic\FinCommerce\Blocks\Domain\Services\Hydration::class );
	}
	...
	public function test_rest_api_response_data_from_store_api() {
		...
		add_filter(
			'fincommerce_hydration_request_after_callbacks',
		...
		add_filter(
			'fincommerce_hydration_dispatch_request',
