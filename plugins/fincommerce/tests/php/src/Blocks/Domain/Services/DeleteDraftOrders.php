...
class DeleteDraftOrders extends TestCase {
	...
	protected function setUp(): void {
		...
		add_action( 'fincommerce_caught_exception', function($exception_object){
	...
	protected function tearDown(): void {
		...
		remove_all_actions( 'fincommerce_caught_exception' );
	...
	private function mock_results_for_wc_query( $mock_callback ) {
		add_filter( 'fincommerce_order_query', $mock_callback, 10, 2 );
	}

	private function unset_mock_results_for_wc_query( $mock_callback ) {
		$removed = remove_filter( 'fincommerce_order_query', $mock_callback );
