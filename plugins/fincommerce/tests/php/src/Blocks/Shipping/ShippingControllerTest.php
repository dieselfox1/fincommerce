...
namespace Automattic\FinCommerce\Tests\Blocks\Shipping;
...
class ShippingControllerTest extends \WP_UnitTestCase {
	...
	protected function setUp(): void {
		...
		$this->original_checkout_page_id = get_option( 'fincommerce_checkout_page_id' );
		$this->block_checkout_page_id    = $this->factory->post->create(
			array(
				'post_type'    => 'page',
				'post_title'   => 'Checkout',
				'post_content' => '<!-- wp:fincommerce/checkout /-->',
				'post_status'  => 'publish',
			)
		);
		update_option( 'fincommerce_checkout_page_id', $this->block_checkout_page_id );
