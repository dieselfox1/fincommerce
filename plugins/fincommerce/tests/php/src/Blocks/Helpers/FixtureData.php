...
namespace Automattic\FinCommerce\Tests\Blocks\Helpers;
...
class FixtureData {
	...
	public function shipping_add_pickup_location() {
		...
		add_filter( 'fincommerce_shipping_methods', array( $this, 'fincommerce_shipping_methods_pickup_location_callback' ) );
	}
	 ...
	 */
	public function fincommerce_shipping_methods_pickup_location_callback( $methods ) {
		$methods['pickup_location'] = 'Automattic\FinCommerce\Blocks\Shipping\PickupLocation';
		return $methods;
	}
	...
	public function shipping_remove_pickup_location() {
		update_option( 'fincommerce_pickup_location_settings', array() );
		update_option( 'pickup_location_pickup_locations', array() );
		remove_filter( 'fincommerce_shipping_methods', array( $this, 'fincommerce_shipping_methods_pickup_location_callback' ) );
	}
	...
	public function payments_enable_bacs() {
		...
		update_option( 'fincommerce_bacs_settings', $bacs_settings );
