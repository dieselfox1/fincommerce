...
class ProductImage extends \WP_UnitTestCase {
	...
	public function test_product_image_render_simple_product() {
		...
		$markup = do_blocks( '<!-- wp:fincommerce/single-product {"productId":' . $data['product']->get_id() . '} --><!-- wp:fincommerce/product-image /--><!-- /wp:fincommerce/single-product -->' );
	...
	public function test_product_image_render_variable_product_with_variation_images() {
		...
		$markup = do_blocks( '<!-- wp:fincommerce/single-product {"productId":' . $data['product']->get_id() . '} --><!-- wp:fincommerce/product-image {"imageId":' . $variation_image_id . '} /--><!-- /wp:fincommerce/single-product -->' );
		...
		$markup_no_image_id = do_blocks( '<!-- wp:fincommerce/single-product {"productId":' . $data['product']->get_id() . '} --><!-- wp:fincommerce/product-image /--><!-- /wp:fincommerce/single-product -->' );
		...
		$markup_invalid   = do_blocks( '<!-- wp:fincommerce/single-product {"productId":' . $data['product']->get_id() . '} --><!-- wp:fincommerce/product-image {"imageId":' . $invalid_image_id . '} /--><!-- /wp:fincommerce/single-product -->' );
	...
	public function test_product_image_render_with_different_sizing() {
		...
		$markup_single = do_blocks( '<!-- wp:fincommerce/single-product {"productId":' . $data['product']->get_id() . '} --><!-- wp:fincommerce/product-image {"imageSizing":"single"} /--><!-- /wp:fincommerce/single-product -->' );
		$this->assertStringContainsString( 'wc-block-components-product-image', $markup_single );

		// Test with 'thumbnail' image sizing.
		$markup_thumbnail = do_blocks( '<!-- wp:fincommerce/single-product {"productId":' . $data['product']->get_id() . '} --><!-- wp:fincommerce/product-image {"imageSizing":"thumbnail"} /--><!-- /wp:fincommerce/single-product -->' );
	...
	public function test_product_image_render_with_sale_badge() {
		...
		$markup = do_blocks( '<!-- wp:fincommerce/single-product {"productId":' . $data['product']->get_id() . '} --><!-- wp:fincommerce/product-image {"showSaleBadge":true} /--><!-- /wp:fincommerce/single-product -->' );

		$this->assertStringContainsString( 'wc-block-components-product-image', $markup );
		$this->assertStringContainsString( 'wp-block-fincommerce-product-sale-badge', $markup );
	...
	public function test_product_image_render_with_inner_blocks() {
		...
		$markup = do_blocks( '<!-- wp:fincommerce/single-product {"productId":' . $data['product']->get_id() . '} --><!-- wp:fincommerce/product-image --><div class="custom-inner-block">Custom content</div><!-- /wp:fincommerce/product-image --><!-- /wp:fincommerce/single-product -->' );
	...
	public function test_product_image_render_without_images() {
		...
		$markup = do_blocks( '<!-- wp:fincommerce/single-product {"productId":' . $product->get_id() . '} --><!-- wp:fincommerce/product-image /--><!-- /wp:fincommerce/single-product -->' );

		$this->assertStringContainsString( 'wc-block-components-product-image', $markup );
		// Should contain placeholder image.
		$this->assertStringContainsString( 'fincommerce-placeholder', $markup );
	...
	public function test_product_image_render_with_invalid_product() {
		$markup = do_blocks( '<!-- wp:fincommerce/single-product {"productId":99999} --><!-- wp:fincommerce/product-image /--><!-- /wp:fincommerce/single-product -->' );
	...
	public function test_product_image_render_without_post_id() {
		$markup = do_blocks( '<!-- wp:fincommerce/product-image --><!-- /wp:fincommerce/product-image -->' );
