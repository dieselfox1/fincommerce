...
class ProductGallery extends \WP_UnitTestCase {
	...
	private function render_product_gallery( $product_id, $gallery_attributes = '' ) {
		return do_blocks(
			sprintf(
				'<!-- wp:fincommerce/single-product {"productId":%d} -->
				<div class="wp-block-fincommerce-single-product fincommerce">
					<!-- wp:fincommerce/product-gallery %s -->
					<div class="wp-block-fincommerce-product-gallery wc-block-product-gallery">
						<!-- wp:fincommerce/product-gallery-thumbnails /-->

						<!-- wp:fincommerce/product-gallery-large-image -->
						<div class="wp-block-fincommerce-product-gallery-large-image wc-block-product-gallery-large-image__inner-blocks">
							<!-- wp:fincommerce/product-image {"showProductLink":false,"showSaleBadge":false,"isDescendentOfSingleProductBlock":true} /-->

							<!-- wp:fincommerce/product-sale-badge {"align":"right"} /-->

							<!-- wp:fincommerce/product-gallery-large-image-next-previous -->
							<div class="wp-block-fincommerce-product-gallery-large-image-next-previous"></div>
							<!-- /wp:fincommerce/product-gallery-large-image-next-previous -->
						</div>
						<!-- /wp:fincommerce/product-gallery-large-image -->
					</div>
					<!-- /wp:fincommerce/product-gallery -->
				</div>
				<!-- /wp:fincommerce/single-product -->',
				$product_id,
				$gallery_attributes
			)
		);
