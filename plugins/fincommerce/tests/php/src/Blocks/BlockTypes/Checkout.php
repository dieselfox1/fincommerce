...
use Automattic\FinCommerce\Tests\Blocks\Mocks\AssetDataRegistryMock;
use Automattic\FinCommerce\Tests\Blocks\Mocks\CheckoutMock;
...
class Checkout extends \WP_UnitTestCase {
	...
	protected function tearDown(): void {
		parent::tearDown();
		remove_filter( 'fincommerce_logging_class', array( $this, 'override_wc_logger' ) );
	}
	...
	public function test_local_pickup_title_change() {
		...
		$updated_content = '<!-- wp:fincommerce/checkout {"showOrderNotes":false} --> <div class="wp-block-fincommerce-checkout is-loading"> <!-- wp:fincommerce/checkout-shipping-method-block {"localPickupText":"Changed pickup"} --> <div class="wp-block-fincommerce-checkout-shipping-method-block"></div> <!-- /wp:fincommerce/checkout-shipping-method-block --></div> <!-- /wp:fincommerce/checkout -->';
		wp_update_post(
			[
				'ID'           => $page_id,
		...
		$updated_content = '<!-- wp:fincommerce/checkout {"showOrderNotes":false} --> <div class="wp-block-fincommerce-checkout is-loading"> <!-- wp:fincommerce/checkout-shipping-method-block {"localPickupText":"Pickup"} --> <div class="wp-block-fincommerce-checkout-shipping-method-block"></div> <!-- /wp:fincommerce/checkout-shipping-method-block --></div> <!-- /wp:fincommerce/checkout -->';
		wp_update_post(
			[
				'ID'           => $page_id,
				'post_content' => $updated_content,
		...
		$updated_content = '<!-- wp:fincommerce/checkout {"showOrderNotes":false} --> <div class="wp-block-fincommerce-checkout is-loading"> <!-- wp:fincommerce/checkout-shipping-method-block {"localPickupText":""} --> <div class="wp-block-fincommerce-checkout-shipping-method-block"></div> <!-- /wp:fincommerce/checkout-shipping-method-block --></div> <!-- /wp:fincommerce/checkout -->';
		wp_update_post(
			[
				'ID'           => $page_id,
				'post_content' => $updated_content,
