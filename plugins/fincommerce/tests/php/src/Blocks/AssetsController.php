...
namespace Automattic\FinCommerce\Tests\Blocks;

use Automattic\FinCommerce\Blocks\Assets\Api;
use Automattic\FinCommerce\Blocks\AssetsController as TestedAssetsController;
...
class AssetsController extends \WP_UnitTestCase {
	...
	protected function setUp(): void {
		...
		$page    = array(
			...
			'content' => '<!-- wp:fincommerce/checkout -->',
		);
		...
		$wp_scripts->registered['mock-dependency']     = (object) array(
			'ver'  => '1.2.3',
			'src'  => 'http://test.local/wp-content/plugins/fincommerce/assets/client/block/mock-dependency.js',
			'deps' => array(
				'mock-sub-dependency',
			),
		);
		$wp_scripts->registered['mock-sub-dependency'] = (object) array(
			'ver'  => '1.2.3',
			'src'  => 'http://test.local/wp-content/plugins/fincommerce/assets/client/block/mock-sub-dependency.js',
			'deps' => array(),
		);
	}
	...
	public function test_no_additional_resource_hints_added() {
		$mock_urls = array(
			array(
				'href' => 'http://test.local/wp-content/plugins/fincommerce/assets/client/blocks/mock.js?ver=1.1.0',
				'as'   => 'script',
			),
		);
	...
	public function test_additional_resource_hints_added_when_block_cart_exists() {
		$this->api->expects( $this->once() )
			...
			->willReturn(
				array(
					'version'      => '1.2.3',
					'src'          => 'http://test.local/wp-content/plugins/fincommerce/assets/client/block/checkout.js',
					'dependencies' => array(
						'mock-dependency',
					),
				)
		...
		$this->assertEquals(
			array_merge(
				...
				array(
					array(
						'href' => 'http://test.local/wp-content/plugins/fincommerce/assets/client/block/checkout.js?ver=1.2.3',
						'as'   => 'script',
					),
					array(
						'href' => 'http://test.local/wp-content/plugins/fincommerce/assets/client/block/mock-dependency.js?ver=1.2.3',
						'as'   => 'script',
					),
					array(
						'href' => 'http://test.local/wp-content/plugins/fincommerce/assets/client/block/mock-sub-dependency.js?ver=1.2.3',
						'as'   => 'script',
					),
				)
			),
	...
	public function test_additional_resource_hints_cache() {
		$mock_cache = array(
			'files'   => array(
				'checkout-frontend' => array(
					'href' => 'http://test.local/wp-content/plugins/fincommerce/assets/client/block/mock-cached.js?ver=1.2.3',
					'as'   => 'script',
				),
			),
			'version' => array(
		...
		set_site_transient( 'fincommerce_block_asset_resource_hints', $mock_cache );
