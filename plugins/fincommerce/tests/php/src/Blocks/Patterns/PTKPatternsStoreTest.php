...
namespace Automattic\FinCommerce\Tests\Blocks\Patterns;
...
class PTKPatternsStoreTest extends \WP_UnitTestCase {
	 ...
	 */
	public function test_fetch_patterns_should_filter_out_the_patterns_with_dependencies_diff_than_fincommerce() {
		update_option( 'fincommerce_allow_tracking', 'yes' );
		$ptk_patterns = array(
			array(
				'ID'         => 1,
			...
			array(
				'ID'           => 3,
				'title'        => 'Jetpack and FinCommerce dep',
				'name'         => 'review-a-quote-with-scattered-images',
				'html'         => '<!-- /wp:spacer -->',
				'dependencies' => [ 'fincommerce', 'jetpack' ],
				'categories'   => array(
					'reviews' => array(
						'slug'  => 'reviews',
						'title' => 'Reviews',
			...
			array(
				'ID'           => 4,
				'title'        => 'FinCommerce dep',
				'name'         => 'review-a-quote-with-scattered-images',
				'html'         => '<!-- /wp:spacer -->',
				'dependencies' => [ 'fincommerce' ],
				'categories'   => array(
					'reviews' => array(
						'slug'  => 'reviews',
						'title' => 'Reviews',
