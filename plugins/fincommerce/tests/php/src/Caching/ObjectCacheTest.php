...
namespace Automattic\FinCommerce\Tests\Caching;

use Automattic\FinCommerce\Caching\CacheException;
use Automattic\FinCommerce\Caching\ObjectCache;
use Automattic\FinCommerce\Caching\CacheEngine;
...
class ObjectCacheTest extends \WC_Unit_Test_Case {
	...
	public function tearDown(): void {
		...
		remove_all_filters( 'fincommerce_after_serializing_the_type_for_caching' );
		remove_all_actions( 'fincommerce_after_removing_the_type_from_cache' );
		remove_all_actions( 'fincommerce_after_flushing_the_type_cache' );
