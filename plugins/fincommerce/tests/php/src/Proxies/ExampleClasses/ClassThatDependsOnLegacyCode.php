...
namespace Automattic\FinCommerce\Tests\Proxies\ExampleClasses;

use Automattic\FinCommerce\Proxies\LegacyProxy;

/**
 * An example class that uses the legacy proxy both from a dependency injected proxy and from the helper methods in the FinCommerce class.
 */
class ClassThatDependsOnLegacyCode {
	 ...
	 * @return mixed The result from the function.
	 */
	public function call_legacy_function_using_fincommerce_class( $function, ...$parameters ) {
	 ...
	 * @return mixed The result from the method.
	 */
	public function call_static_method_using_fincommerce_class( $class_name, $method_name, ...$parameters ) {
	 ...
	 * @return object The instance obtained.
	 */
	public function get_instance_of_using_fincommerce_class( string $class_name, ...$args ) {
