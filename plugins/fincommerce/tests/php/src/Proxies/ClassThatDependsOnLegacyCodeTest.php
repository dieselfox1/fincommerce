...
namespace Automattic\FinCommerce\Tests\Proxies;

use Automattic\FinCommerce\Proxies\LegacyProxy;
use Automattic\FinCommerce\Tests\Proxies\ExampleClasses\ClassThatDependsOnLegacyCode;
use Automattic\FinCommerce\Tests\Internal\DependencyManagement\ExampleClasses\DependencyClass;
...
class ClassThatDependsOnLegacyCodeTest extends \WC_Unit_Test_Case {
	 ...
	 *           ["call_legacy_function_using_fincommerce_class"]
	 */
	public function test_call_function_can_be_invoked_via_injected_legacy_proxy_and_fincommerce_object( $method_to_use ) {
	 ...
	 *           ["call_legacy_function_using_fincommerce_class"]
	 */
	public function test_function_mocks_can_be_used_via_injected_legacy_proxy_and_fincommerce_object( $method_to_use ) {
	 ...
	 *           ["call_static_method_using_fincommerce_class"]
	 */
	public function test_call_static_can_be_invoked_via_injected_legacy_proxy_and_fincommerce_object( $method_to_use ) {
	 ...
	 *           ["call_static_method_using_fincommerce_class"]
	 */
	public function test_static_mocks_can_be_used_via_injected_legacy_proxy_and_fincommerce_object( $method_to_use ) {
	 ...
	 *           ["get_instance_of_using_fincommerce_class"]
	 */
	public function test_get_instance_of_can_be_used_via_injected_legacy_proxy_and_fincommerce_object( $method_to_use ) {
	 ...
	 *           ["get_instance_of_using_fincommerce_class"]
	 */
	public function test_class_mocks_can_be_used_via_injected_legacy_proxy_and_fincommerce_object( $method_to_use ) {
		$mock = new \stdClass();
