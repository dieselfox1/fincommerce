...
use Automattic\FinCommerce\Internal\DependencyManagement\Definition;
...
class LegacyProxyTest extends \WC_Unit_Test_Case {
	...
	/**
	 * @testdox 'get_instance_of' throws an exception when trying to use it to get an instance of a namespaced class if the namespace starts with 'Automattic\FinCommerce'.
	 */
	public function test_get_instance_of_throws_when_trying_to_get_a_woo_namespaced_class() {
		$this->expectException( \Exception::class );
		$this->expectExceptionMessage( 'The LegacyProxy class is not intended for getting instances of classes whose namespace starts with \'Automattic\\FinCommerce\', please use \'init\' method injection or \'wc_get_container()->get()\' for that.' );

		$this->sut->get_instance_of( LegacyProxy::class );
	}

	/**
	 * @testdox 'get_instance_of' can be used to get an instance of a namespaced class if the namespace doesn't start with 'Automattic\FinCommerce'.
	 */
