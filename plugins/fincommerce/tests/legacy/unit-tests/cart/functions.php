...
class WC_Tests_Cart_Functions extends WC_Unit_Test_Case {
	...
	private function get_checkout_url() {
		...
		if ( $checkout_page_id ) {
			...
			$checkout_url = apply_filters( 'fincommerce_get_checkout_url', $checkout_url );
		}
	...
	public function test_get_checkout_url_regular() {
		...
		// Force SSL checkout.
		update_option( 'fincommerce_force_ssl_checkout', 'no' );
	...
	public function test_get_checkout_url_ssl() {
		...
		// Force SSL checkout.
		update_option( 'fincommerce_force_ssl_checkout', 'yes' );
	...
	public function test_wc_cart_totals_coupon_label() {
		...
		$this->expectOutputString( apply_filters( 'fincommerce_cart_totals_coupon_label', 'Coupon: ' . $coupon->get_code() ), wc_cart_totals_coupon_label( $coupon ) );
	}
	...
	public function test_wc_get_cart_url() {
		...
		$this->assertEquals( apply_filters( 'fincommerce_get_cart_url', $cart_page_url ? $cart_page_url : '' ), wc_get_cart_url() );
	}
