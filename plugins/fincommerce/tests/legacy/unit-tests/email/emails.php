 ...
 * @package FinCommerce\Tests\Emails
 */
...
class WC_Tests_WC_Emails extends WC_Unit_Test_Case {
	...
	public function test_format_string_filter_modification() {
		...
		add_filter(
			'fincommerce_email_format_string_replace',
			function ( $replace ) {
		...
		add_filter(
			'fincommerce_email_format_string_find',
			function ( $find ) {
		...
		// Clean up filters.
		remove_all_filters( 'fincommerce_email_format_string_replace' );
		remove_all_filters( 'fincommerce_email_format_string_find' );
	}
	...
	public function test_format_string_main_filter_override() {
		...
		add_filter(
			'fincommerce_email_format_string',
			function () {
		...
		// Clean up.
		remove_all_filters( 'fincommerce_email_format_string' );
	}
