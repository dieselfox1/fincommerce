...
class WC_Tests_Base_Order_Item extends WC_Unit_Test_Case {
	...
	public function tearDown(): void {
		...
		remove_all_filters( 'fincommerce_calculated_order_item_cogs_value' );
	}
	...
	/**
	 * @testdox The calculated value for Cost of Goods Sold can be modified using the 'fincommerce_calculated_order_item_cogs_value' filter, returning null means a failure in the calculation.
	 *
	...
	public function test_filter_can_be_used_to_alter_calculated_cogs_value( $value_returned_by_filter, bool $expected_calculate_method_result, float $expected_obtained_cogs_value ) {
		...
		add_filter(
			'fincommerce_calculated_order_item_cogs_value',
