 ...
 *
 * @package FinCommerce\Tests\Admin\Notes
 */
...
class WC_Tests_Notes_Run_Db_Update extends WC_Unit_Test_Case {
	...
	/**
	 * Load the necessary files, as they're not automatically loaded by FinCommerce.
	 *
	 */
	...
	private static function create_db_update_note() {
		...
		$note->set_title( 'FinCommerce database update required' );
	...
	public function test_create_db_update_note() {
		...
		update_option( 'fincommerce_db_version', '3.9.0' );
