...
class WC_Tests_Admin_Dashboard extends WC_Unit_Test_Case {
	...
	public function setUp(): void {
		...
		add_filter( 'fincommerce_dashboard_status_widget_reports', array( $this, 'mock_replace_dashboard_status_widget_reports' ) );
	}
	...
	public function tearDown(): void {
		...
		remove_filter( 'fincommerce_dashboard_status_widget_reports', array( $this, 'mock_replace_dashboard_status_widget_reports' ) );
	}
	...
	public function test_status_widget_with_woo_admin_disabled() {
		...
		add_filter( 'fincommerce_admin_disabled', '__return_true' );
		...
		remove_filter( 'fincommerce_admin_disabled', '__return_true' );
	}
