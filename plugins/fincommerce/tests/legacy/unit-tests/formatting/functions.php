 ...
 *
 * @package FinCommerce\Tests\Formatting
 */
...
class WC_Tests_Formatting_Functions extends WC_Unit_Test_Case {
	...
	public function test_wc_get_filename_from_url() {
		$this->assertEquals( 'fincommerce.pdf', wc_get_filename_from_url( 'https://fincommerce.com/fincommerce.pdf' ) );
		$this->assertEmpty( wc_get_filename_from_url( 'ftp://wc' ) );
		$this->assertEmpty( wc_get_filename_from_url( 'http://www.skyverge.com' ) );
		$this->assertEquals( 'fincommerce', wc_get_filename_from_url( 'https://fincommerce.com/fincommerce' ) );
	}
	...
	public function test_wc_get_dimension() {
		// Save default.
		$default_unit = get_option( 'fincommerce_dimension_unit' );
		...
		// cm.
		update_option( 'fincommerce_dimension_unit', 'cm' );
		$this->assertEquals(
		...
		// m.
		update_option( 'fincommerce_dimension_unit', 'm' );
		$this->assertEquals(
		...
		// mm.
		update_option( 'fincommerce_dimension_unit', 'mm' );
		$this->assertEquals(
		...
		// yd.
		update_option( 'fincommerce_dimension_unit', 'yd' );
		$this->assertEquals(
		...
		// Restore default.
		update_option( 'fincommerce_dimension_unit', $default_unit );
	}
	...
	public function test_wc_get_weight() {
		// Save default.
		$default_unit = get_option( 'fincommerce_weight_unit' );
		...
		// kg.
		update_option( 'fincommerce_weight_unit', 'kg' );
		...
		// g.
		update_option( 'fincommerce_weight_unit', 'g' );
		...
		// oz.
		update_option( 'fincommerce_weight_unit', 'oz' );
		...
		// Restore default.
		update_option( 'fincommerce_weight_unit', $default_unit );
	}
	...
	public function test_wc_round_tax_total() {
		update_option( 'fincommerce_prices_include_tax', 'no' );
		...
		update_option( 'fincommerce_prices_include_tax', 'yes' );
		$this->assertEquals( 1.25, wc_round_tax_total( 1.246 ) );
		$this->assertEquals( 20, wc_round_tax_total( 19.9997 ) );
		$this->assertEquals( 19.99, wc_round_tax_total( 19.99 ) );
		$this->assertEquals( 19.99, wc_round_tax_total( 19.99 ) );
	...
	public function test_wc_format_decimal() {
		...
		update_option( 'fincommerce_price_decimal_sep', ',' );
		update_option( 'fincommerce_price_thousand_sep', '.' );
	...
	public function test_wc_format_localized_price() {
		// Save default.
		$decimal_sep = get_option( 'fincommerce_price_decimal_sep' );
		update_option( 'fincommerce_price_decimal_sep', ',' );

		$this->assertEquals( '1,17', wc_format_localized_price( '1.17' ) );

		// Restore default.
		update_option( 'fincommerce_price_decimal_sep', $decimal_sep );
	}
	...
	/**
	 * Test wc_get_fincommerce_price_format().
	 *
	 * @since 2.2
	 */
	public function test_get_fincommerce_price_format() {
		// Save default.
		$currency_pos = get_option( 'fincommerce_currency_pos' );

		// Default format (left).
		$this->assertEquals( '%1$s%2$s', get_fincommerce_price_format() );

		// Right.
		update_option( 'fincommerce_currency_pos', 'right' );
		$this->assertEquals( '%2$s%1$s', get_fincommerce_price_format() );

		// Left space.
		update_option( 'fincommerce_currency_pos', 'left_space' );
		$this->assertEquals( '%1$s&nbsp;%2$s', get_fincommerce_price_format() );

		// Right space.
		update_option( 'fincommerce_currency_pos', 'right_space' );
		$this->assertEquals( '%2$s&nbsp;%1$s', get_fincommerce_price_format() );

		// Restore default.
		update_option( 'fincommerce_currency_pos', $currency_pos );
	}
	...
	public function test_wc_get_price_thousand_separator() {
		$separator = get_option( 'fincommerce_price_thousand_sep' );
		...
		update_option( 'fincommerce_price_thousand_sep', $separator );
	}
	...
	public function test_wc_get_price_decimal_separator() {
		$separator = get_option( 'fincommerce_price_decimal_sep' );
		...
		update_option( 'fincommerce_price_decimal_sep', $separator );
	}
	...
	public function test_wc_get_price_decimals() {
		$decimals = get_option( 'fincommerce_price_num_decimals' );

		// Default value.
		$this->assertEquals( 2, wc_get_price_decimals() );

		update_option( 'fincommerce_price_num_decimals', '1' );
		$this->assertEquals( 1, wc_get_price_decimals() );

		update_option( 'fincommerce_price_num_decimals', '-2' );
		$this->assertEquals( 2, wc_get_price_decimals() );

		update_option( 'fincommerce_price_num_decimals', '2.50' );
		$this->assertEquals( 2, wc_get_price_decimals() );

		update_option( 'fincommerce_price_num_decimals', $decimals );
	}
	...
	public function test_wc_price() {
		// Common prices.
		$this->assertEquals( '<span class="fincommerce-Price-amount amount"><bdi class="fincommerce-Price-bidi"><span class="fincommerce-Price-currencySymbol">&#36;</span>1.00</bdi></span>', wc_price( 1 ) );
		$this->assertEquals( '<span class="fincommerce-Price-amount amount"><bdi class="fincommerce-Price-bidi"><span class="fincommerce-Price-currencySymbol">&#36;</span>1.10</bdi></span>', wc_price( 1.1 ) );
		$this->assertEquals( '<span class="fincommerce-Price-amount amount"><bdi class="fincommerce-Price-bidi"><span class="fincommerce-Price-currencySymbol">&#36;</span>1.17</bdi></span>', wc_price( 1.17 ) );
		$this->assertEquals( '<span class="fincommerce-Price-amount amount"><bdi class="fincommerce-Price-bidi"><span class="fincommerce-Price-currencySymbol">&#36;</span>1,111.17</bdi></span>', wc_price( 1111.17 ) );
		$this->assertEquals( '<span class="fincommerce-Price-amount amount"><bdi class="fincommerce-Price-bidi"><span class="fincommerce-Price-currencySymbol">&#36;</span>0.00</bdi></span>', wc_price( 0 ) );

		// Different currency.
		$this->assertEquals( '<span class="fincommerce-Price-amount amount"><bdi class="fincommerce-Price-bidi"><span class="fincommerce-Price-currencySymbol">&pound;</span>1,111.17</bdi></span>', wc_price( 1111.17, array( 'currency' => 'GBP' ) ) );

		// Negative price.
		$this->assertEquals( '<span class="fincommerce-Price-amount amount"><bdi class="fincommerce-Price-bidi">-<span class="fincommerce-Price-currencySymbol">&#36;</span>1.17</bdi></span>', wc_price( -1.17 ) );

		// Aria hidden option.
		$this->assertEquals( '<span class="fincommerce-Price-amount amount" aria-hidden="true"><bdi class="fincommerce-Price-bidi">-<span class="fincommerce-Price-currencySymbol">&#36;</span>1.17</bdi></span>', wc_price( -1.17, array( 'aria-hidden' => true ) ) );

		// Bogus prices.
		$this->assertEquals( '<span class="fincommerce-Price-amount amount"><bdi class="fincommerce-Price-bidi"><span class="fincommerce-Price-currencySymbol">&#36;</span>0.00</bdi></span>', wc_price( null ) );
		$this->assertEquals( '<span class="fincommerce-Price-amount amount"><bdi class="fincommerce-Price-bidi"><span class="fincommerce-Price-currencySymbol">&#36;</span>0.00</bdi></span>', wc_price( 'Q' ) );
		$this->assertEquals( '<span class="fincommerce-Price-amount amount"><bdi class="fincommerce-Price-bidi"><span class="fincommerce-Price-currencySymbol">&#36;</span>0.00</bdi></span>', wc_price( 'ಠ_ಠ' ) );

		// Trim zeros.
		add_filter( 'fincommerce_price_trim_zeros', '__return_true' );
		$this->assertEquals( '<span class="fincommerce-Price-amount amount"><bdi class="fincommerce-Price-bidi"><span class="fincommerce-Price-currencySymbol">&#36;</span>1</bdi></span>', wc_price( 1.00 ) );
		remove_filter( 'fincommerce_price_trim_zeros', '__return_true' );

		// Ex tax label.
		$calc_taxes = get_option( 'fincommerce_calc_taxes' );
		update_option( 'fincommerce_calc_taxes', 'yes' );
		$this->assertEquals( '<span class="fincommerce-Price-amount amount"><bdi class="fincommerce-Price-bidi"><span class="fincommerce-Price-currencySymbol">&#36;</span>1,111.17</bdi></span> <small class="fincommerce-Price-taxLabel tax_label">(ex. tax)</small>', wc_price( '1111.17', array( 'ex_tax_label' => true ) ) );
		update_option( 'fincommerce_calc_taxes', $calc_taxes );
	}
	...
	public function test_wc_format_stock_for_display() {
		...
		$default = get_option( 'fincommerce_stock_format' );
		update_option( 'fincommerce_stock_format', 'low_amount' );
		$this->assertEquals( 'Only 1 left in stock', wc_format_stock_for_display( $product ) );
		update_option( 'fincommerce_stock_format', $default );
	...
	public function test_wc_format_sale_price() {
		$this->assertEquals( '<del aria-hidden="true"><span class="fincommerce-Price-amount amount"><bdi class="fincommerce-Price-bidi"><span class="fincommerce-Price-currencySymbol">&#36;</span>10.00</bdi></span></del> <span class="screen-reader-text">Original price was: &#036;10.00.</span><ins class="fincommerce-Price-salePrice" aria-hidden="true"><span class="fincommerce-Price-amount amount"><bdi class="fincommerce-Price-bidi"><span class="fincommerce-Price-currencySymbol">&#36;</span>5.00</bdi></span></ins><span class="screen-reader-text">Current price is: &#036;5.00.</span>', wc_format_sale_price( '10', '5' ) );
	}
	...
	public function test_wc_format_price_range() {
		$this->assertEquals( '<span class="fincommerce-Price-amount amount" aria-hidden="true"><bdi class="fincommerce-Price-bidi"><span class="fincommerce-Price-currencySymbol">&#36;</span>10.00</bdi></span> <span aria-hidden="true">&ndash;</span> <span class="fincommerce-Price-amount amount" aria-hidden="true"><bdi class="fincommerce-Price-bidi"><span class="fincommerce-Price-currencySymbol">&#36;</span>5.00</bdi></span><span class="screen-reader-text">Price range: &#36;10.00 through &#36;5.00</span>', wc_format_price_range( '10', '5' ) );
	}
