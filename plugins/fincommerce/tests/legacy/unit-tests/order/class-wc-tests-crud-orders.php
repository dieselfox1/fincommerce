 ...
 *
 * @package FinCommerce\Tests\CRUD
 */
...
class WC_Tests_CRUD_Orders extends WC_Unit_Test_Case {
	...
	public function test_calculate_taxes_issue_with_addresses() {
		...
		update_option( 'fincommerce_default_country', 'PY:Central' );
	 ...
	 *
	 * See: https://github.com/dieselfox1/fincommerce/commit/804feb93333a8f00d0f93a163c6de58204f31f14
	 */
	...
	public function test_payment_complete_error() {
		...
		add_action( 'fincommerce_payment_complete', array( $this, 'throwAnException' ) );
		...
		remove_action( 'fincommerce_payment_complete', array( $this, 'throwAnException' ) );
	}
	...
	public function test_get_formatted_order_total() {
		...
		$this->assertEquals( '<span class="fincommerce-Price-amount amount"><bdi class="fincommerce-Price-bidi"><span class="fincommerce-Price-currencySymbol">&#36;</span>100.00</bdi></span>', $object->get_formatted_order_total() );
	}
	...
	public function test_update_status_error() {
		...
		add_filter( 'fincommerce_payment_complete_order_status', array( $this, 'throwAnException' ) );
		...
		remove_filter( 'fincommerce_payment_complete_order_status', array( $this, 'throwAnException' ) );
	}
	...
	public function test_status_transition_handles_transition_errors() {
		...
		add_filter( 'fincommerce_order_status_on-hold', array( $this, 'throwAnException' ) );
		$object->update_status( OrderStatus::ON_HOLD );
		remove_filter( 'fincommerce_order_status_on-hold', array( $this, 'throwAnException' ) );
		...
		$this->assertStringContainsString( __( 'Error during status transition.', 'fincommerce' ), $note->content );
	}
	...
	public function test_refund_exception() {
		$order = WC_Helper_Order::create_order();
		add_action( 'fincommerce_create_refund', array( $this, 'throwAnException' ) );
		...
		remove_action( 'fincommerce_create_refund', array( $this, 'throwAnException' ) );
	...
	public function test_save_exception() {
		...
		add_action( 'fincommerce_before_order_object_save', array( $this, 'throwAnException' ) );
		...
		remove_action( 'fincommerce_before_order_object_save', array( $this, 'throwAnException' ) );
	}
