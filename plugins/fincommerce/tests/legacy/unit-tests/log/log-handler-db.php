...
class WC_Tests_Log_Handler_DB extends WC_Unit_Test_Case {
	...
	public function test_handle() {
		...
		$log_entries = $wpdb->get_results( "SELECT timestamp, level, message, source, context FROM {$wpdb->prefix}fincommerce_log", ARRAY_A );
	...
	public function test_flush() {
		...
		$log_entries = $wpdb->get_results( "SELECT timestamp, level, message, source FROM {$wpdb->prefix}fincommerce_log" );
	...
	public function test_delete_logs_before_timestamp() {
		...
		$log_count = $wpdb->get_var( "SELECT count(*) FROM {$wpdb->prefix}fincommerce_log" );
