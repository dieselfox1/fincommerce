 ...
 *
 * @version  3.5.0
 * @package FinCommerce\Tests\Customer
 */
...
class WC_Tests_Customer_Download_Log_Data_Store extends WC_Unit_Test_Case {
	...
	public function test_delete_by_permission_id() {
		 ...
		 */
		$this->assertEquals( 0, $wpdb->query( $wpdb->prepare( "SELECT * FROM {$wpdb->prefix}fincommerce_downloadable_product_permissions WHERE permission_id = %d", $p_id ) ) );
	}
	...
	public function test_delete_by_permission_id_not_all() {
		...
		$this->assertEquals( 0, $wpdb->query( $wpdb->prepare( "SELECT * FROM {$wpdb->prefix}fincommerce_downloadable_product_permissions WHERE permission_id = %d", $dp_ids[0] ) ) );
		$this->assertEquals( 1, $wpdb->query( $wpdb->prepare( "SELECT * FROM {$wpdb->prefix}fincommerce_downloadable_product_permissions WHERE permission_id = %d", $dp_ids[1] ) ) );
