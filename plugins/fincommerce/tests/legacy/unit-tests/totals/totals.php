...
class WC_Tests_Totals extends WC_Unit_Test_Case {
	...
	public function setUp(): void {
		...
		add_action( 'fincommerce_cart_calculate_fees', array( $this, 'add_cart_fees_callback' ) );
	}
	...
	public function tearDown(): void {
		...
		remove_action( 'fincommerce_cart_calculate_fees', array( $this, 'add_cart_fees_callback' ) );
