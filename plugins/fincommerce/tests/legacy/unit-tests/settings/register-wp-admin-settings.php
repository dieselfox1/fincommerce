 ...
 *
 * @package @package FinCommerce\Tests\Settings
 */
...
class WC_Tests_Register_WP_Admin_Settings extends WC_Unit_Test_Case {
	...
	public function test_constructor() {
		...
		$this->assertEquals( has_filter( 'fincommerce_settings_groups', array( $settings, 'register_page_group' ) ), 10 );
		$this->assertEquals( has_filter( 'fincommerce_settings-' . $this->page->get_id(), array( $settings, 'register_page_settings' ) ), 10 );
	}
