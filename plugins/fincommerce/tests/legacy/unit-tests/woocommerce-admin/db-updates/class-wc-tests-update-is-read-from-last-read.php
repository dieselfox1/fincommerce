 ...
 *
 * @package FinCommerce\Admin\Tests\DBUpdates
 */
class WC_Admin_Tests_Update_Is_Read_From_Last_Read extends WC_Unit_Test_Case {
	...
	/**
	 * Given fincommerce_admin_activity_panel_inbox_last_read does not exist
	...
	public function test_update_does_not_run_when_usermeta_does_not_exist() {
		...
		$wpdb->query(
			"
			delete from {$wpdb->prefix}usermeta where meta_key = 'fincommerce_admin_activity_panel_inbox_last_read'
		"
		);
	...
	/**
	 * Give fincommerce_admin_activity_panel_inbox_last_read
	 * When the update runs
	 * Then it should update notes where date_created value is less than fincommerce_admin_activity_panel_inbox_last_read
	 */
	public function test_it_updates_is_read_when_date_created_value_is_less_than_last_read() {
		...
		// Note with date_created less than fincommerce_admin_activity_panel_inbox_last_read.
		$note = new Note();
		...
		// Note with date_created greater than fincommerce_admin_activity_panel_inbox_last_read.
		$note = new Note();
