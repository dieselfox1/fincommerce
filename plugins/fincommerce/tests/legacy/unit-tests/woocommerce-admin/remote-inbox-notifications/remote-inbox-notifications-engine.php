 ...
 *
 * @package FinCommerce\Admin\Tests\RemoteInboxNotifications
 */
...
class WC_Admin_Tests_RemoteInboxNotifications_RemoteInboxNotificationsEngine extends WC_Unit_Test_Case {
	...
	public function setUp(): void {
		...
		add_filter(
			'transient_fincommerce_admin_' . RemoteInboxNotificationsDataSourcePoller::ID . '_specs',
			function( $value ) {
				if ( $value ) {
					return $value;
				}
	...
	public function tearDown(): void {
		parent::tearDown();
		delete_transient( 'fincommerce_admin_' . RemoteInboxNotificationsDataSourcePoller::ID . '_specs' );
		remove_all_filters( 'transient_fincommerce_admin_' . RemoteInboxNotificationsDataSourcePoller::ID . '_specs' );
	}
