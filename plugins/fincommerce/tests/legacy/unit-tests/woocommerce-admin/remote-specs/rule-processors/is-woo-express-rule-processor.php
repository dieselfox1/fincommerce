...
use Automattic\FinCommerce\Admin\RemoteSpecs\RuleProcessors\IsWooExpressRuleProcessor;
...
class WC_Admin_Tests_RemoteSpecs_RuleProcessors_IsWooExpressRuleProcessor extends WC_Unit_Test_Case {
	...
	public static function setUpBeforeClass(): void {
		...
		function wc_calypso_bridge_is_woo_express_plan() {
			return apply_filters( 'test_wc_calypso_bridge_is_woo_express_plan', true ); // phpcs:ignore FinCommerce.Commenting.CommentHooks.MissingHookComment
		}
	}
