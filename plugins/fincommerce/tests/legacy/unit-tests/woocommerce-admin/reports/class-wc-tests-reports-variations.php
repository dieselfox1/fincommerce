...
class WC_Admin_Tests_Reports_Variations extends WC_Unit_Test_Case {
			...
			'data'    => array(
				0 => array(
					...
					'extended_info' => array(
						...
						'low_stock_amount' => get_option( 'fincommerce_notify_low_stock_amount' ),
						'attributes'       => array(
							0 => array(
								'id'     => 0,
								'name'   => 'color',
	...
	public function test_attribute_filtering() {
		...
		$order_1 = \Automattic\FinCommerce\RestApi\UnitTests\Helpers\OrderHelper::create_order();
		...
		$order_2 = \Automattic\FinCommerce\RestApi\UnitTests\Helpers\OrderHelper::create_order();
		...
		$order_3 = \Automattic\FinCommerce\RestApi\UnitTests\Helpers\OrderHelper::create_order();
