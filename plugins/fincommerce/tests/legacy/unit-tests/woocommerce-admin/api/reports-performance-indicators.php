...
class WC_Admin_Tests_API_Reports_Performance_Indicators extends WC_REST_Unit_Test_Case {
	...
	public function test_get_indicators() {
		...
		$prod_download->set_file( plugin_dir_url( WC_ABSPATH ) . 'fincommerce/assets/images/help.png' );
	...
	public function mock_jetpack_modules() {
		$api_init        = \Automattic\FinCommerce\Admin\API\Init::instance();
		$controller_name = 'Automattic\FinCommerce\Admin\API\Reports\PerformanceIndicators\Controller';
