...
use Automattic\FinCommerce\Admin\API\OnboardingProfile;
...
class WC_Admin_Tests_API_Onboarding_Profiles extends WC_REST_Unit_Test_Case {
	...
	public function test_profile_extensibility() {
		...
		add_filter(
			'fincommerce_rest_onboarding_profile_properties',
			function ( $properties ) {
				$properties['test_profile_datum'] = array(
					'type'        => 'array',
					'description' => __( 'Test onboarding profile extensibility.', 'fincommerce' ),
					'context'     => array( 'view' ),
					'readonly'    => true,
				);
				return $properties;
