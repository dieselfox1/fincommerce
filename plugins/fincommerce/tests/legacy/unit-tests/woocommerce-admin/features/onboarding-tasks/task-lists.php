 ...
 *
 * @package FinCommerce\Admin\Tests\OnboardingTasks
 */
...
class WC_Tests_OnboardingTasks_TaskLists extends WC_Unit_Test_Case {
	...
	/**
	 * Tests that the "fincommerce_admin_experimental_onboarding_tasklists" filter is able to append tasks to any tasklist.
	 */
	public function test_default_tasklists_can_be_add_by_onboarding_filter() {
		// Filter the default task lists.
		add_filter(
			'fincommerce_admin_experimental_onboarding_tasklists',
			function (
				$task_lists
			) {
