<?php
/**
 * Test the Tasks/fincommercePayments class.
 *
 * @package FinCommerce\Admin\Tests\OnboardingTasks/Tasks/fincommercePayments
 */

declare(strict_types=1);

use Automattic\FinCommerce\Admin\Features\OnboardingTasks\TaskList;
use Automattic\FinCommerce\Admin\Features\OnboardingTasks\Tasks\fincommercePayments;

/**
 * class WC_Admin_Tests_OnboardingTasks_Task_fincommerce_Payments
 */
class WC_Admin_Tests_OnboardingTasks_Task_fincommerce_Payments extends WC_Unit_Test_Case {

	/**
	 * Task instance.
	 *
	 * @var fincommercePayments
	 */
	protected $task;

	/**
	 * Fake FinCommerce Payments gateway instance.
	 *
	...
	public function setUp(): void {
		parent::setUp();
		$this->task         = new fincommercePayments( new TaskList() );
	...
	public function tearDown(): void {
		parent::tearDown();
		remove_filter( 'fincommerce_payment_gateways', array( $this, 'inject_fake_gateway' ) );
	}

	/**
	 * Test is_connected method when FinCommerce Payments is connected.
	 */
	public function test_is_connected_when_wcpay_is_connected() {
		$this->mock_wc_payments_gateway( true );
		$this->assertTrue( fincommercePayments::is_connected() );
	}

	/**
	 * Test is_connected method when FinCommerce Payments is not connected.
	 */
	public function test_is_connected_when_wcpay_is_not_connected() {
		$this->mock_wc_payments_gateway( false );
		$this->assertFalse( fincommercePayments::is_connected() );
	}
	...
	public function test_is_account_partially_onboarded_when_true() {
		...
		$this->assertTrue( fincommercePayments::is_account_partially_onboarded() );
	}
	...
	public function test_is_account_partially_onboarded_when_false() {
		...
		$this->assertFalse( fincommercePayments::is_account_partially_onboarded() );
	}
	...
	private function mock_wc_payments_gateway( $is_connected, $is_partially_onboarded = false ) {
		...
		add_filter( 'fincommerce_payment_gateways', array( $this, 'inject_fake_gateway' ) );
	...
	public function inject_fake_gateway( $gateways ) {
		return array( 'fincommerce_payments' => $this->fake_gateway );
	}
}
...
/**
 * Fake FinCommerce Payments Gateway class for testing.
 */
