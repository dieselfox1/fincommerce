 ...
 *
 * @package FinCommerce\Admin\Tests\OnboardingTasks\Tasks
 */
...
use Automattic\FinCommerce\Admin\Features\OnboardingTasks\Tasks\StoreDetails;
...
class WC_Admin_Tests_OnboardingTasks_Task_StoreDetails extends WC_Unit_Test_Case {
	...
	public function test_completed_task_get_title_with_use_completed_title_option() {
		update_option( 'fincommerce_store_address', 'Market Street' );
		update_option( 'fincommerce_store_city', 'San Francisco' );
		update_option( 'fincommerce_store_postcode', '1234' );
		$this->task_list->options['use_completed_title'] = true;
