 ...
 *
 * @package FinCommerce\Admin\Tests\OnboardingTasks/Tasks/Shipping
 */
...
class WC_Admin_Tests_OnboardingTasks_Task_Shipping extends WC_Unit_Test_Case {
	...
	public function setUp(): void {
		...
		add_filter( 'fincommerce_admin_features', array( $this, 'turn_on_smart_shipping_defaults_feature' ), 20, 1 );
	...
	public function tearDown(): void {
		parent::tearDown();
		remove_filter( 'fincommerce_admin_features', array( $this, 'turn_on_smart_shipping_defaults_feature' ), 1 );
