 ...
 *
 * @package Automattic\FinCommerce\Admin\Features
 */

use Automattic\FinCommerce\Internal\Admin\CustomerEffortScoreTracks;
...
class WC_Admin_Tests_CES_Tracks extends WC_Unit_Test_Case {
	...
	/**
	 * Verify that it adds correct action to the queue on fincommerce_update_options action.
	 */
