 ...
 *
 * @package FinCommerce\Admin\Tests\ShippingLabelBannerDisplayRules
 */

use Automattic\FinCommerce\Internal\Admin\ShippingLabelBannerDisplayRules;
...
class WC_Admin_Tests_Shipping_Label_Banner_Display_Rules extends WC_Unit_Test_Case {
	...
	private static $modified_options = array(
		'fincommerce_default_country'              => null,
		'fincommerce_currency'                     => null,
		'fincommerce_shipping_prompt_ab'           => null,
		'fincommerce_shipping_dismissed_timestamp' => null,
	);
	...
	public function test_if_banner_hidden_when_dismiss_option_enabled() {
		update_option( 'fincommerce_shipping_dismissed_timestamp', -1 );
	...
	public function test_if_banner_hidden_when_dismiss_was_clicked_2_hrs_ago() {
		...
		update_option( 'fincommerce_shipping_dismissed_timestamp', $two_hours_from_ago );
	...
	public function test_if_banner_hidden_when_dismiss_was_clicked_24_hrs_1s_ago() {
		...
		update_option( 'fincommerce_shipping_dismissed_timestamp', $twenty_four_hours_one_sec_ago );
	...
	public function test_if_banner_hidden_when_store_is_not_in_us() {
		update_option( 'fincommerce_default_country', 'ES' );
		$this->with_order(
			function ( $that ) {
	...
	/**
	 * Test if the banner is hidden when FinCommerce Shipping & Tax is installed but not up to date.
	 */
