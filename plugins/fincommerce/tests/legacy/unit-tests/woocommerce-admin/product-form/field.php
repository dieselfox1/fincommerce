...
use Automattic\FinCommerce\Internal\Admin\ProductForm\Field;
...
class WC_Admin_Tests_ProductForm_Field extends WC_Unit_Test_Case {
	...
	public function test_no_required_arguments() {
		...
		$this->expectExceptionMessage( 'You are missing required arguments of FinCommerce ProductForm Field: type, section, properties.name, properties.label' );
		new Field(
			'id',
			'fincommerce',
			array()
