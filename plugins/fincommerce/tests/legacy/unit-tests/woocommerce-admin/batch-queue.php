 ...
 *
 * @package FinCommerce\Admin\Tests\Reports
 * @since 3.5.0
 */
...
class WC_Admin_Tests_Reports_Regenerate_Batching extends WC_REST_Unit_Test_Case {
	...
	public function setUp(): void {
		...
		add_filter( 'fincommerce_admin_scheduler_batch_size', array( $this, 'filter_batch_size' ), 10, 3 );
	}
	...
	public function tearDown(): void {
		...
		remove_filter( 'fincommerce_admin_scheduler_batch_size', array( $this, 'filter_batch_size' ), 10, 3 );
	}
