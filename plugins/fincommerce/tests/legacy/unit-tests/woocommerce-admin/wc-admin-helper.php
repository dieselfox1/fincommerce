 ...
 * WCAdminHelper tests
 *
 * @package FinCommerce\Admin\Tests\WCAdminHelper
 */
...
class WC_Admin_Tests_Admin_Helper extends WC_Unit_Test_Case {
	...
	/**
	 * Store original FinCommerce permalinks for restoration.
	 *
	 * @var array
	 */
	...
	public static function setUpBeforeClass(): void {
		...
		self::$original_wc_permalinks       = get_option( 'fincommerce_permalinks', array() );
		global $wp_rewrite;
	...
	public static function tearDownAfterClass(): void {
		...
		update_option( 'fincommerce_permalinks', self::$original_wc_permalinks );
	...
	public function test_is_current_page_store_page_when_permalink_structure_is_plain() {
		...
		delete_option( 'fincommerce_permalinks' );
		$wp_rewrite->flush_rules();
	...
	public function test_is_current_page_store_page_when_store_page_is_not_set() {
		// unset shop page.
		add_filter( 'fincommerce_get_shop_page_id', '__return_false' );
		...
		remove_filter( 'fincommerce_get_shop_page_id', '__return_false' );
	}
	...
	public function test_is_current_page_store_page_when_checkout_page_is_set_to_non_default_page() {
		...
		update_option( 'fincommerce_checkout_page_id', $page_id );
