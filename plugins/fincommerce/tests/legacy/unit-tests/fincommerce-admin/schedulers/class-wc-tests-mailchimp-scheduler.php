 ...
 *
 * @package Automattic\FinCommerce\Internal\Admin\Schedulers
 */

use Automattic\FinCommerce\Internal\Admin\Onboarding;
...
class WC_Admin_Tests_Mailchimp_Scheduler extends WC_Unit_Test_Case {
	/**
	 * @var \Automattic\FinCommerce\Internal\Admin\Schedulers\MailchimpScheduler MailchimpScheduler instance to test
	 */
	private $instance;
	...
	/**
	 * When fincommerce_onboarding_subscribed_to_mailchimp value us 'yes'.
	 ...
	 * Then fincommerce_onboarding_subscribed_to_mailchimp should be updated to 'yes'
	 */
	public function test_it_updates_option_value_when_everything_went_well() {
		...
		// Then.
		$this->assertEquals( 'yes', get_option( 'fincommerce_onboarding_subscribed_to_mailchimp' ) );
	}
}
