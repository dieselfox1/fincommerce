 ...
 *
 * @package FinCommerce\Admin\Tests\Orders
 */

use Automattic\FinCommerce\Admin\API\Reports\Orders\Stats\DataStore as OrdersStatsDataStore;
use Automattic\FinCommerce\Admin\API\Reports\Orders\Stats\Query as OrdersStatsQuery;
...
class WC_Admin_Tests_Reports_Orders_Stats extends WC_Unit_Test_Case {
	...
	public static function setUpBeforeClass(): void {
		add_filter( 'fincommerce_analytics_report_should_use_cache', '__return_false' );
	}
	...
	public static function tearDownAfterClass(): void {
		remove_filter( 'fincommerce_analytics_report_should_use_cache', '__return_false' );
	}
	 ...
	 *
	 * @covers \Automattic\FinCommerce\Admin\API\Reports\Orders\Stats\DataStore::delete_order
	 * @covers \Automattic\FinCommerce\Admin\API\Reports\Products\DataStore::sync_on_order_delete
	 * @covers \Automattic\FinCommerce\Admin\API\Reports\Coupons\DataStore::sync_on_order_delete
	 * @covers \Automattic\FinCommerce\Admin\API\Reports\Taxes\DataStore::sync_on_order_delete
	 */
	public function test_order_deletion() {
		...
		// Enable taxes.
		$default_calc_taxes       = get_option( 'fincommerce_calc_taxes', 'no' );
		$default_customer_address = get_option( 'fincommerce_default_customer_address', 'geolocation' );
		$default_tax_based_on     = get_option( 'fincommerce_tax_based_on', 'shipping' );
		update_option( 'fincommerce_calc_taxes', 'yes' );
		update_option( 'fincommerce_default_customer_address', 'base' );
		update_option( 'fincommerce_tax_based_on', 'base' );
		...
		update_option( 'fincommerce_calc_taxes', $default_customer_address );
		update_option( 'fincommerce_default_customer_address', $default_calc_taxes );
		update_option( 'fincommerce_tax_based_on', $default_tax_based_on );
	}
