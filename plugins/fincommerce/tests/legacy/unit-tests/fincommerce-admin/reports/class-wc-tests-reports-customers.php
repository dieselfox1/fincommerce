 ...
 *
 * @package FinCommerce\Admin\Tests\Customers
 */

use Automattic\FinCommerce\Admin\API\Reports\Customers\Stats\DataStore;
...
class WC_Admin_Tests_Reports_Customer extends WC_Unit_Test_Case {
	 ...
	 *
	 * @covers \Automattic\FinCommerce\Admin\API\Reports\Customers\DataStore::get_order_count
	 */
	 ...
	 *
	 * @covers \Automattic\FinCommerce\Admin\API\Reports\Customers\DataStore::sync_on_order_delete
	 */
