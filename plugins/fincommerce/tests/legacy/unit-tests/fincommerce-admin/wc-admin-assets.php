 ...
 * Loader tests
 *
 * @package FinCommerce\Admin\Tests\Loader
 */
 ...
 *
 * @package FinCommerce\Admin\Tests\WCAdminAssets
 */
class WC_Admin_Tests_WCAdminAssets extends WP_UnitTestCase {
	...
	public function setUp(): void {
		add_filter( 'fincommerce_admin_features', array( $this, 'turn_on_unminified_js_feature' ), 20, 1 );
	}
	...
	public function tearDown(): void {
		remove_filter( 'fincommerce_admin_features', array( $this, 'turn_on_unminified_js_feature' ), 20 );
	}
