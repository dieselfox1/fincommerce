 ...
 *
 * @package FinCommerce\Admin\Tests\API
 * @since 3.5.0
 */
...
class WC_Admin_Tests_API_Reports_Orders extends WC_REST_Unit_Test_Case {
	...
	public function test_get_reports_with_orphaned_refund() {
		...
		// wp_delete_post($order->get_id()) can be prevented by the following filter: maybe_prevent_deletion_of_post (see https://github.com/dieselfox1/fincommerce/blob/97a0d9b16006b089f7d1e98af19d61f6d71b621b/plugins/fincommerce/src/Internal/DataStores/Orders/DataSynchronizer.php#L916 )
	...
	public function test_product_attributes_filter() {
		...
		WC_Helper_Queue::run_all_pending( 'wc-admin-data' );
		WC_Helper_Queue::run_all_pending( 'fincommerce-db-updates' );
	 ...
	 *
	 * See: https://github.com/dieselfox1/fincommerce-admin/issues/5803#issuecomment-738403405.
	 */
	...
	public function test_order_price_formatting_with_different_base_currency() {
		update_option( 'fincommerce_date_type', 'date_created' );
		wp_set_current_user( $this->user );
		WC_Helper_Reports::reset_stats_dbs();
