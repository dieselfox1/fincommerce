...
use Automattic\FinCommerce\Admin\API\OnboardingTasks;
...
// https://github.com/finpress/finpress/blob/master/wp-admin/includes/image.php#L835
...
class WC_Admin_Tests_API_Onboarding_Tasks extends WC_REST_Unit_Test_Case {
	...
	public function test_create_homepage() {
		...
		$this->assertEquals( get_option( 'fincommerce_onboarding_homepage_post_id' ), $data['post_id'] );
		$this->assertEquals( htmlspecialchars_decode( get_edit_post_link( get_option( 'fincommerce_onboarding_homepage_post_id' ) ) ), $data['edit_post_link'] );
	}
	...
	public function test_homepage_template_can_be_filtered() {
		...
		add_filter(
			'fincommerce_admin_onboarding_homepage_template',
			function ( $template ) {
	...
	public function test_dismissed_task_invalid() {
		...
		$this->assertEquals( $response_data['code'], 'fincommerce_rest_invalid_task' );
	}
	...
	public function test_task_list_hidden_invalid_list() {
		...
		$this->assertEquals( $response_data['data']['status'], 404 );
		$this->assertEquals( $response_data['code'], 'fincommerce_rest_invalid_task_list' );
	}
