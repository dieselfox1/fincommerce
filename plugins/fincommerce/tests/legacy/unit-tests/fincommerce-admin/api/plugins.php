...
class WC_Admin_Tests_API_Plugins extends WC_REST_Unit_Test_Case {
	...
	public function test_install_plugin() {
		...
		$request->set_query_params(
			array(
				'plugins' => 'fincommerce-legacy-rest-api',
			)
		);
		...
		$this->assertEquals( array( 'fincommerce-legacy-rest-api' ), $data['data']['installed'] );
		$this->assertEquals( true, $data['success'] );
		$this->assertArrayHasKey( 'fincommerce-legacy-rest-api/fincommerce-legacy-rest-api.php', $plugins );
	}
	...
	public function test_install_invalid_plugins_param() {
		...
		$this->assertEquals( 'fincommerce_rest_invalid_plugins', $data['code'] );
	}
