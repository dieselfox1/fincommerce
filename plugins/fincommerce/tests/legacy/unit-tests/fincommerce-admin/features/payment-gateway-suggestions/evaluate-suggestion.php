...
class WC_Admin_Tests_PaymentGatewaySuggestions_EvaluateSuggestion extends WC_Unit_Test_Case {
	 ...
	 * Mock gateway option.
	 */
	const MOCK_OPTION = 'fincommerce_admin_mock_gateway_option';
	...
	public function test_evaluation_doesnt_log() {
		add_filter( 'fincommerce_admin_remote_specs_evaluator_should_log', '__return_false' );
		...
		remove_filter( 'fincommerce_admin_remote_specs_evaluator_should_log', '__return_false' );
	}
