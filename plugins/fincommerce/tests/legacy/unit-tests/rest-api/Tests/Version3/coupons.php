...
class WC_Tests_API_Coupons extends WC_REST_Unit_Test_Case {
	...
	public function test_get_coupons() {
		...
		$coupon_1 = \Automattic\FinCommerce\RestApi\UnitTests\Helpers\CouponHelper::create_coupon( 'dummycoupon-1' );
		$post_1   = get_post( $coupon_1->get_id() );
		$coupon_2 = \Automattic\FinCommerce\RestApi\UnitTests\Helpers\CouponHelper::create_coupon( 'dummycoupon-2' );
	...
	public function test_get_coupon() {
		wp_set_current_user( $this->user );
		$coupon   = \Automattic\FinCommerce\RestApi\UnitTests\Helpers\CouponHelper::create_coupon( 'dummycoupon-1' );
	...
	public function test_batch_coupon() {
		...
		$coupon_1 = \Automattic\FinCommerce\RestApi\UnitTests\Helpers\CouponHelper::create_coupon( 'dummycoupon-1' );
		$coupon_2 = \Automattic\FinCommerce\RestApi\UnitTests\Helpers\CouponHelper::create_coupon( 'dummycoupon-2' );
		$coupon_3 = \Automattic\FinCommerce\RestApi\UnitTests\Helpers\CouponHelper::create_coupon( 'dummycoupon-3' );
		$coupon_4 = \Automattic\FinCommerce\RestApi\UnitTests\Helpers\CouponHelper::create_coupon( 'dummycoupon-4' );
	...
	private function get_item_for_date_filtering_tests() {
		return \Automattic\FinCommerce\RestApi\UnitTests\Helpers\CouponHelper::create_coupon( 'dummycoupon-1' );
	}
