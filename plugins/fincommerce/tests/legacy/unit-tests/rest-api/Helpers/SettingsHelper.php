...
class SettingsHelper {
	...
	public static function register() {
		\add_filter( 'fincommerce_settings_groups', array( __CLASS__, 'register_groups' ) );
		\add_filter( 'fincommerce_settings-test', array( __CLASS__, 'register_test_settings' ) );
	}
	...
	public static function register_test_settings( $settings ) {
		$settings[] = array(
			...
			'option_key'  => 'fincommerce_shop_page_display',
		);
		return $settings;
	}
}
