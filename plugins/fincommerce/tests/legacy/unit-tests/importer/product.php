 ...
 *
 * @package FinCommerce\Tests\Importer
 */
...
class WC_Tests_Product_CSV_Importer extends WC_Unit_Test_Case {
	 ...
	 * (see https://github.com/dieselfox1/fincommerce/issues/23257).
	 */
	...
	public function test_get_raw_data() {
		...
		$items    = array(
			array(
				...
				'',
				'',
				'http://demo.woothemes.com/fincommerce/wp-content/uploads/sites/56/2013/06/T_1_front.jpg, http://demo.woothemes.com/fincommerce/wp-content/uploads/sites/56/2013/06/T_1_back.jpg',
				'',
				'',
				'',
				'WOOALBUM',
			...
			array(
				...
				'Woo',
				'',
				'http://demo.woothemes.com/fincommerce/wp-content/uploads/sites/56/2013/06/cd_1_angle.jpg, http://demo.woothemes.com/fincommerce/wp-content/uploads/sites/56/2013/06/cd_1_flat.jpg',
				'10',
				'90',
				'',
				'WOOLOGO',
	...
	public function test_get_parsed_data() {
		...
		$items    = array(
			array(
				...
				'raw_image_id'          => 'http://demo.woothemes.com/fincommerce/wp-content/uploads/sites/56/2013/06/T_1_front.jpg',
				'raw_gallery_image_ids' => array( 'http://demo.woothemes.com/fincommerce/wp-content/uploads/sites/56/2013/06/T_1_back.jpg' ),
				'virtual'               => '',
				'downloadable'          => '',
				'manage_stock'          => true,
				'virtual'               => false,
			...
			array(
				...
				'button_text'           => '',
				'status'                => ProductStatus::PUBLISH,
				'raw_image_id'          => 'http://demo.woothemes.com/fincommerce/wp-content/uploads/sites/56/2013/06/cd_1_angle.jpg',
				'raw_gallery_image_ids' => array( 'http://demo.woothemes.com/fincommerce/wp-content/uploads/sites/56/2013/06/cd_1_flat.jpg' ),
				'virtual'               => true,
				'downloadable'          => true,
				'manage_stock'          => false,
				'raw_attributes'        => array(
			...
			array(
				...
				'sku'                => '',
				'name'               => 'FinCommerce Product CSV Suite',
				'featured'           => '',
				'catalog_visibility' => CatalogVisibility::VISIBLE,
				'short_description'  => 'Lorem ipsum dolor sit amet, at exerci civibus appetere sit, iuvaret hendrerit mea no. Eam integre feugait liberavisse an.',
				'description'        => 'Lorem ipsum dolor sit amet, at exerci civibus appetere sit, iuvaret hendrerit mea no. Eam integre feugait liberavisse an.',
				...
				'download_limit'     => '',
				'download_expiry'    => '',
				'product_url'        => 'https://fincommerce.com/products/product-csv-import-suite/',
				'button_text'        => 'Buy on FinCommerce.com',
				'status'             => ProductStatus::PUBLISH,
				'raw_image_id'       => null,
				'virtual'            => false,
				'downloadable'       => false,
			...
			array(
				...
				'button_text'           => '',
				'status'                => ProductStatus::PUBLISH,
				'raw_image_id'          => 'http://demo.woothemes.com/fincommerce/wp-content/uploads/sites/56/2013/06/T_4_front.jpg',
				'raw_gallery_image_ids' => array(
					'http://demo.woothemes.com/fincommerce/wp-content/uploads/sites/56/2013/06/T_4_back.jpg',
					'http://demo.woothemes.com/fincommerce/wp-content/uploads/sites/56/2013/06/T_3_front.jpg',
					'http://demo.woothemes.com/fincommerce/wp-content/uploads/sites/56/2013/06/T_3_back.jpg',
				),
				'virtual'               => false,
				'downloadable'          => false,
				'manage_stock'          => false,
			...
			array(
				...
				'button_text'        => '',
				'status'             => ProductStatus::PUBLISH,
				'raw_image_id'       => 'http://demo.woothemes.com/fincommerce/wp-content/uploads/sites/56/2013/06/T_3_front.jpg',
				'virtual'            => false,
				'downloadable'       => false,
				'manage_stock'       => true,
				'raw_attributes'     => array(
			...
			array(
				...
				'status'                => ProductStatus::PUBLISH,
				'raw_image_id'          => 'http://demo.woothemes.com/fincommerce/wp-content/uploads/sites/56/2013/06/T_1_front.jpg',
				'raw_gallery_image_ids' => array( 'http://demo.woothemes.com/fincommerce/wp-content/uploads/sites/56/2013/06/cd_1_angle.jpg' ),
				'virtual'               => false,
				'downloadable'          => false,
				'manage_stock'          => false,
				'menu_order'            => 4,
	...
	public function test_server_path_traversal() {
		...
		$this->assertEquals( $import_result->get_error_code(), 'fincommerce_product_csv_importer_upload_invalid_file' );
	}
}
