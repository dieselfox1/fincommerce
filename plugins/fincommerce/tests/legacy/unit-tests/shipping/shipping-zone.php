 ...
 *
 * @package FinCommerce\Tests\Shipping
 */
...
class WC_Tests_Shipping_Zone extends WC_Unit_Test_Case {
	...
	public function test_add_location() {
		...
		add_filter( 'fincommerce_valid_location_types', array( $this, 'add_valid_zone_location' ) );
		$this->assertTrue( $zone->is_valid_location_type( 'poop' ) );
		remove_filter( 'fincommerce_valid_location_types', array( $this, 'add_valid_zone_location' ), 10 );
	}
