 ...
 * @package FinCommerce\Tests\Discounts
 */
...
class WC_Tests_Discounts extends WC_Unit_Test_Case {
		...
		return array(
			...
			array(
				array(
					...
					'prices_include_tax'      => false,
					'wc_options'              => array(
						'fincommerce_calc_discounts_sequentially' => array(
							'set'    => 'yes',
							'revert' => 'no',
						),
					),
	...
	/**
	 * filter_fincommerce_coupon_get_discount_amount.
	 *
	 * @param float $discount Discount amount.
	 */
	public function filter_fincommerce_coupon_get_discount_amount( $discount ) {
		return $discount / 2;
	}
	...
	public function test_coupon_discount_amount_filter() {
		...
		add_filter( 'fincommerce_coupon_get_discount_amount', array( $this, 'filter_fincommerce_coupon_get_discount_amount' ) );
		...
		remove_filter( 'fincommerce_coupon_get_discount_amount', array( $this, 'filter_fincommerce_coupon_get_discount_amount' ) );
	}
