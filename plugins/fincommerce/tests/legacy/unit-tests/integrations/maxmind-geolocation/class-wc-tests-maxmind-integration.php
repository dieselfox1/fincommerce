...
class WC_Tests_MaxMind_Integration extends WC_Unit_Test_Case {
	...
	public function setUp(): void {
		...
		$this->database_service = $this->getMockBuilder( 'WC_Integration_maxMind_Database_Service' )
			...
			->getMock();
		add_filter( 'fincommerce_maxmind_geolocation_database_service', array( $this, 'override_integration_service' ) );
	}
	...
	public function tearDown(): void {
		...
		remove_filter( 'fincommerce_maxmind_geolocation_database_service', array( $this, 'override_integration_service' ) );
