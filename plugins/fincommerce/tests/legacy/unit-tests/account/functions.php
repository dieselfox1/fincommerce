 ...
 *
 * @package FinCommerce\Tests\Account
 */
...
class WC_Tests_Account_Functions extends WC_Unit_Test_Case {
	...
	public function test_wc_get_account_menu_item_classes() {
		$this->assertEquals( 'fincommerce-MyAccount-navigation-link fincommerce-MyAccount-navigation-link--test', wc_get_account_menu_item_classes( 'test' ) );
	}
