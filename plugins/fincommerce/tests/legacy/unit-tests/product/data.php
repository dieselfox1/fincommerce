 ...
 *
 * @package FinCommerce\Tests\Product
 */
...
class WC_Tests_Product_Data extends WC_Unit_Test_Case {
	...
	public function test_multiple_get_price_html_calls() {
		...
		$this->assertEquals( '<del aria-hidden="true"><span class="fincommerce-Price-amount amount"><bdi class="fincommerce-Price-bidi"><span class="fincommerce-Price-currencySymbol">&#36;</span>10.00</bdi></span></del> <span class="screen-reader-text">Original price was: &#036;10.00.</span><ins class="fincommerce-Price-salePrice" aria-hidden="true"><span class="fincommerce-Price-amount amount"><bdi class="fincommerce-Price-bidi"><span class="fincommerce-Price-currencySymbol">&#36;</span>7.00</bdi></span></ins><span class="screen-reader-text">Current price is: &#036;7.00.</span>', $product->get_price_html() );

		$product = wc_get_product( $product2_id );
		$this->assertEquals( $product2_id, $product->get_id() );
		$this->assertEquals( '<del aria-hidden="true"><span class="fincommerce-Price-amount amount"><bdi class="fincommerce-Price-bidi"><span class="fincommerce-Price-currencySymbol">&#36;</span>20.00</bdi></span></del> <span class="screen-reader-text">Original price was: &#036;20.00.</span><ins class="fincommerce-Price-salePrice" aria-hidden="true"><span class="fincommerce-Price-amount amount"><bdi class="fincommerce-Price-bidi"><span class="fincommerce-Price-currencySymbol">&#36;</span>16.00</bdi></span></ins><span class="screen-reader-text">Current price is: &#036;16.00.</span>', $product->get_price_html() );

		$product = wc_get_product( $product3_id );
		$this->assertEquals( $product3_id, $product->get_id() );
		$this->assertEquals( '<span class="fincommerce-Price-amount amount"><bdi class="fincommerce-Price-bidi"><span class="fincommerce-Price-currencySymbol">&#36;</span>50.00</bdi></span>', $product->get_price_html() );
	}
	...
	public function test_get_image_should_return_product_image() {
		...
		$this->assertStringContainsString(
			sprintf( $needle, 'attachment-fincommerce_thumbnail size-fincommerce_thumbnail' ),
			$product->get_image()
		);
	...
	public function test_get_image_should_return_place_holder_image() {
		...
		$image = $product->get_image( 'fincommerce_thumbnail', array( 'class' => 'custom-class' ) );
	...
	public function test_get_image_should_return_empty_string() {
		$product = new WC_Product();
		$this->assertEquals( '', $product->get_image( 'fincommerce_thumbnail', array(), false ) );
	}
