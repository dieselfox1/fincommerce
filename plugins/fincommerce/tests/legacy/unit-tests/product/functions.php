...
class WC_Tests_Product_Functions extends WC_Unit_Test_Case {
	...
	public function test_wc_placeholder_img() {
		...
		$this->assertStringContainsString( 'class="custom-class"', wc_placeholder_img( 'fincommerce_thumbnail', $attr ) );
	}
	...
	public function test_wc_get_attachment_image_attributes() {
		$image_attr = array(
			...
			'class'  => 'attachment-fincommerce_thumbnail size-fincommerce_thumbnail',
			'alt'    => '',
		...
		$image_attr    = array(
			'src'    => 'https://wc.local/wp-content/fincommerce_uploads/my-image.jpg',
			'class'  => 'attachment-fincommerce_thumbnail size-fincommerce_thumbnail',
			'alt'    => '',
			'srcset' => 'https://wc.local/wp-content/fincommerce_uploads/my-image-250x250.jpg 250w, https://wc.local/wp-content/fincommerce_uploads/my-image-350x350 350w',
			'sizes'  => '(max-width: 250px) 100vw, 250px',
		);
		$expected_attr = array(
		...
		// Test image hosted in fincommerce_uploads which is not allowed, think shops selling photos.
	...
	public function test_wc_get_price_to_display() {
		...
		update_option( 'fincommerce_tax_display_shop', 'incl' );
