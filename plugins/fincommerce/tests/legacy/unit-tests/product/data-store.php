...
class WC_Tests_Product_Data_Store extends WC_Unit_Test_Case {
	...
	/**
	 * Test creating a new product with fincommerce_new_product_data filter.
	 */
	public function test_product_create_with_fincommerce_new_product_data_filter() {
	...
	public function test_generate_product_title_disable() {
		add_filter( 'fincommerce_product_variation_title_include_attributes', '__return_false' );
	 ...
	 * https://github.com/dieselfox1/fincommerce/issues/13960
	 *
	 * @since 3.0.1
	 */
	public function test_product_meta_save_post() {
		...
		// This takes place of WC_Meta_Box do_action( 'fincommerce_admin_process_product_object ' ) just adding simple meta.
