...
class WC_Tests_Countries extends WC_Unit_Test_Case {
	...
	public function test_get_shipping_continents() {
		...
		update_option( 'fincommerce_specific_ship_to_countries', array( 'CA', 'JP' ) );
		$expected = array(
	...
	public function test_get_allowed_countries() {
		...
		update_option( 'fincommerce_specific_allowed_countries', array( 'RO', 'SI' ) );
		$expected = array(
			'RO' => 'Romania',
			'SI' => 'Slovenia',
		);
		...
		update_option( 'fincommerce_allowed_countries', 'all_except' );
		update_option( 'fincommerce_all_except_countries', array( 'RO', 'SI' ) );
	...
	public function test_get_shipping_countries() {
		...
		update_option( 'fincommerce_ship_to_countries', 'specific' );
		update_option( 'fincommerce_specific_ship_to_countries', array( 'RO', 'SI' ) );
		$expected = array(
			'RO' => 'Romania',
			'SI' => 'Slovenia',
		);
	...
	public function test_get_shipping_country_states() {
		...
		update_option( 'fincommerce_ship_to_countries', 'specific' );
		update_option( 'fincommerce_specific_ship_to_countries', array( 'US' ) );
	...
	public function test_tax_or_vat() {
		...
		update_option( 'fincommerce_default_country', 'CZ' );
		$this->assertEquals( 'VAT', $countries->tax_or_vat() );

		update_option( 'fincommerce_default_country', 'NO' );
		$this->assertEquals( 'VAT', $countries->tax_or_vat() );
