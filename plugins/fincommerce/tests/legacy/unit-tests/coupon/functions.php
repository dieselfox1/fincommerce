...
/**
 * Class Functions.
 * @package FinCommerce\Tests\Coupon
 * @since 2.2
 */
class WC_Tests_Functions extends WC_Unit_Test_Case {
	...
	public function test_wc_coupons_enabled() {
		$this->assertEquals( apply_filters( 'fincommerce_coupons_enabled', get_option( 'fincommerce_enable_coupons' ) === 'yes' ), wc_coupons_enabled() );
	}
