...
class WC_Tests_Notice_Functions extends WC_Unit_Test_Case {
	...
	public function test_wc_print_notices() {
		...
		$this->expectOutputString( '<div class="fincommerce-info" role="status">One True Notice</div><div class="fincommerce-info" data-id="second_notice" role="status">Second True Notice</div>' );
	...
	public function test_wc_print_notices_should_return_notices() {
		$expected_return = "\n	<div class=\"fincommerce-info\" role=\"status\">\n		One True Notice	</div>\n";
	...
	public function test_wc_print_success_notice() {
		...
		$this->expectOutputString( '<div class="fincommerce-message" role="alert">Success!</div>' );
	...
	public function test_wc_print_info_notice() {
		...
		$this->expectOutputString( '<div class="fincommerce-info" role="status">Info!</div>' );
	...
	public function test_wc_print_error_notice() {
		...
		// Specific type.
		$this->expectOutputString( '<ul class="fincommerce-error" role="alert"><li>Error!</li></ul>' );
	...
	public function test_wc_print_notice_data() {
		...
		// Specific type.
		$this->expectOutputString( '<ul class="fincommerce-error" role="alert"><li data-id="billing_postcode">Error!</li></ul>' );
