...
class WC_Tests_Core_Functions extends WC_Unit_Test_Case {
	...
	/**
	 * Test get_fincommerce_currency().
	 *
	 * @since 2.2
	 */
	public function test_get_fincommerce_currency() {

		$this->assertEquals( 'USD', get_fincommerce_currency() );
	}

	/**
	 * Test get_fincommerce_currencies().
	 *
	 * @since 2.2
	 */
	public function test_get_fincommerce_currencies() {
		static $currencies;
		...
		$this->assertEquals( $expected_currencies, get_fincommerce_currencies() );
	...
	/**
	 * Test get_fincommerce_currency_symbol().
	 *
	 * @since 2.2
	 */
	public function test_get_fincommerce_currency_symbol() {

		// Default currency.
		$this->assertEquals( '&#36;', get_fincommerce_currency_symbol() );

		// Given specific currency.
		$this->assertEquals( '&pound;', get_fincommerce_currency_symbol( 'GBP' ) );

		// Each case.
		foreach ( array_keys( get_fincommerce_currencies() ) as $currency_code ) {
			$this->assertIsString( get_fincommerce_currency_symbol( $currency_code ) );
		}
	}
	...
	public function test_wc_get_theme_support() {
		...
		add_theme_support( 'fincommerce', $theme_support_options );
	...
	/**
	 * Test get_fincommerce_api_url().
	 *
	 * @since 2.2
	 */
	public function test_get_fincommerce_api_url() {

		$base_uri = get_home_url();

		// Base URI.
		$this->assertEquals( "$base_uri/wc-api/v3/", get_fincommerce_api_url( null ) );

		// Path.
		$this->assertEquals( "$base_uri/wc-api/v3/orders", get_fincommerce_api_url( 'orders' ) );
	}
	...
	public function test_wc_get_logger() {
		...
		add_filter( 'fincommerce_logging_class', array( $this, 'return_bad_logger' ) );
	...
	public function test_wc_get_logger_for_instance() {
		add_filter( 'fincommerce_logging_class', array( $this, 'return_valid_logger_instance' ) );
	 ...
	 *
	 * This is a helper function to test fincommerce_logging_class filter and wc_get_logger.
	 *
	...
	public function test_wc_print_r() {
		...
		add_filter( 'fincommerce_print_r_alternatives', array( $this, 'filter_wc_print_r_alternatives' ) );
		...
		remove_filter( 'fincommerce_print_r_alternatives', array( $this, 'filter_wc_print_r_alternatives' ) );
	}
	...
	public function test_wc_create_update_order_currency() {
		$old_currency = get_fincommerce_currency();
		$new_currency = 'BGN';

		update_option( 'fincommerce_currency', $new_currency );
		...
		update_option( 'fincommerce_currency', $old_currency );
	...
	public function test_wc_get_template_cleans_absolute_path() {
		add_filter( 'fincommerce_locate_template', array( $this, 'force_template_path' ), 10, 2 );
		...
		remove_filter( 'fincommerce_locate_template', array( $this, 'force_template_path' ) );

		$file_path = wp_cache_get( sanitize_key( 'template-global/wrapper-start.php---' . WC_VERSION ), 'fincommerce' );
