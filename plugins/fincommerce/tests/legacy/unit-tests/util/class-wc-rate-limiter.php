...
class WC_Tests_Rate_Limiter extends WC_Unit_Test_Case {
	...
	public function test_rate_limit_option_migration() {
		...
		add_option( 'fincommerce_rate_limit_add_payment_method_123', time() + 1000 );
		add_option( 'fincommerce_rate_limit_add_payment_method_234', time() - 1 );
		...
		$this->assertFalse( get_option( 'fincommerce_rate_limit_add_payment_method_123' ) );
		$this->assertFalse( get_option( 'fincommerce_rate_limit_add_payment_method_234' ) );
	}
}
