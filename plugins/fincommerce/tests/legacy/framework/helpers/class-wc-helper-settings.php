...
class WC_Helper_Settings {
	...
	public static function register() {
		add_filter( 'fincommerce_settings_groups', array( 'WC_Helper_Settings', 'register_groups' ) );
		add_filter( 'fincommerce_settings-test', array( 'WC_Helper_Settings', 'register_test_settings' ) );
	}
