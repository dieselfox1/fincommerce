 ...
 *
 * @package FinCommerce\Tests\Helper
 */
...
class WC_Helper_Shipping {
	...
	public static function force_customer_us_address() {
		add_filter( 'fincommerce_customer_get_shipping_country', array( self::class, 'force_customer_us_country' ) );
		add_filter( 'fincommerce_customer_get_shipping_state', array( self::class, 'force_customer_us_state' ) );
		add_filter( 'fincommerce_customer_get_shipping_postcode', array( self::class, 'force_customer_us_postcode' ) );
	}
	...
	public static function delete_simple_flat_rate() {
		delete_option( 'fincommerce_flat_rate_settings' );
		delete_option( 'fincommerce_flat_rate' );
		WC_Cache_Helper::get_transient_version( 'shipping', true );
