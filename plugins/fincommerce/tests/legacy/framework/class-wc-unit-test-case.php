<?php
/**
 * Base test case for all FinCommerce tests.
 *
 ...
 * WC Unit Test Case.
 *
 * Provides FinCommerce-specific setup/tear down/assert methods, custom factories,
...
class WC_Unit_Test_Case extends WP_HTTP_TestCase {
	...
	public function setUp(): void {
		...
		add_filter( 'fincommerce_session_handler', array( $this, 'set_mock_session_handler' ) );
