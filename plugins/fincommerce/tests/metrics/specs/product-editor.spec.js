...
test.describe( 'Product editor performance', () => {
	...
	test.beforeAll( async () => {
		await wpCLI(
			'wp option set fincommerce_feature_product_block_editor_enabled yes'
		);
	} );
	...
	test.afterAll( async ( {}, testInfo ) => {
		...
		await wpCLI(
			'wp option set fincommerce_feature_product_block_editor_enabled no'
		);
	} );
...
/* eslint-enable @fincommerce/dependency-group, jest/expect-expect, jest/no-test-callback, array-callback-return, jest/no-identical-title */
