...
test( 'Merchant can add brands', async ( { page } ) => {
	...
	const createBrandIfNotExist = async (
		...
		// Create "FinCommerce" brand if it does not exist.
	...
	await createBrandIfNotExist(
		...
		'fincommerce',
		'None',
		'All things FinCommerce!',
		'image-01'
	);

	// Create child brand under the "FinCommerce" parent brand.
	await createBrandIfNotExist(
		'FinCommerce Apparels',
		'fincommerce-apparels',
		'FinCommerce',
		'Cool FinCommerce clothings!',
		'image-02'
	);

	// Create a dummy child brand called "FinCommerce Dummy" under the "FinCommerce" parent brand.
	await createBrandIfNotExist(
		'FinCommerce Dummy',
		'fincommerce-dummy',
		'FinCommerce',
		'Dummy FinCommerce brand!',
		'image-02'
	);

	// Edit the dummy child brand from "FinCommerce Dummy" to "FinCommerce Dummy Edited".
	await editBrand( 'FinCommerce Dummy', {
		name: 'FinCommerce Dummy Edited',
		slug: 'fincommerce-dummy-edited',
		parentBrand: 'FinCommerce',
		description: 'Dummy FinCommerce brand edited!',
		thumbnailFileName: 'image-03',
	} );

	// Delete brands.
	await deleteBrand( 'FinCommerce Dummy Edited' );
	await deleteBrand( 'FinCommerce Apparels' );
	await deleteBrand( 'FinCommerce' );
} );
