 ...
 */
import { WP_API_PATH } from '@fincommerce/e2e-utils-playwright';
...
// test case for bug https://github.com/dieselfox1/fincommerce/pull/46429
...
test(
	...
	async ( { page } ) => {
		...
		expect( await page.title() ).toBe(
			'Shop – FinCommerce Core E2E Test Suite'
		);
	}
);
