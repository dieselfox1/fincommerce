 ...
 *
 * @see {@link [Product - Attributes properties](https://fincommerce.github.io/fincommerce-rest-api-docs/#product-attributes-properties)}
 */
 ...
 *
 * @see {@link [Product variation properties](https://fincommerce.github.io/fincommerce-rest-api-docs/#product-variation-properties)}
 */
...
/**
 * Create a variable product using the FinCommerce REST API.
 *
 * @param {{ name: string, visible: boolean, variation: boolean, options: string[] }[]} attributes List of attributes. See [Product - Attributes properties](https://fincommerce.github.io/fincommerce-rest-api-docs/#product-attributes-properties).
...
async function showVariableProductTour( browser, show ) {
	...
	const { id: userId, fincommerce_meta } = await addProductPage.evaluate(
		() => {
...
/**
 * Create variations through the FinCommerce REST API.
 *
