 ...
 */
import { createClient, WC_API_PATH } from '@fincommerce/e2e-utils-playwright';
...
const create = {
	 ...
	 *
	 * @see {@link [Batch update product variations](https://fincommerce.github.io/fincommerce-rest-api-docs/#batch-update-product-variations)}
	 * @param {number|string} productId  Product ID to add variations to
	 * @param {object[]}      variations Array of variations to add. See [Product variation properties](https://fincommerce.github.io/fincommerce-rest-api-docs/#product-variation-properties)
