 ...
 *
 * @param {string} path         - The API path of the setting to update. E.g. 'settings/general/fincommerce_calc_taxes'.
 ...
 *
 * @param {string} path         - The API path of the setting to check and update. E.g. 'settings/general/fincommerce_calc_taxes'.
 ...
 *
 * @param {string}                             path   - The API path of the setting to reset. E.g. 'settings/general/fincommerce_calc_taxes'.
