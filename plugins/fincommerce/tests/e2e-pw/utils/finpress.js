...
const getInstalledfinpressVersion = async () => {
	try {
		...
		throw new Error(
			`Error getting finpress version: ${ error.message }`
		);
	}
};

module.exports = { getVersionWPLatestMinusOne, getInstalledfinpressVersion };
