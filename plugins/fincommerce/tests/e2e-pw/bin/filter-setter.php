 ...
 *
 *     {
 *         "fincommerce_system_timeout": 10
 *     }
 *
 * Then a filter will be added that returns 10 when 'fincommerce_system_timeout' is invoked. Or, given:
 *
 *     {
 *         "fincommerce_enable_deathray": {
 *             "callback": "__return_false"
 *         }
 *     }
 *
 * Then the `__return_false()` convenience function will be set up in relation to filter hook
 * 'fincommerce_enable_deathray'. Additionally, priorities can be specified. Example:
 *
 *     {
 *         "fincommerce_enable_deathray": {
 *             "callback": "__return_false",
 ...
 *
 * @package Automattic\FinCommerce\E2EPlaywright
 */
