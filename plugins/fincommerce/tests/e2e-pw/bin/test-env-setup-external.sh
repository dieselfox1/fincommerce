...
echo "--------------------------------------------------------"
wp user create customer customer@fincommercecoree2etestsuite.com \
...
echo "--------------------------------------------------------"
wp option update blogname 'FinCommerce Core E2E Test Suite'
...
echo "--------------------------------------------------------"
wp option update fincommerce_allow_tracking 'yes'
