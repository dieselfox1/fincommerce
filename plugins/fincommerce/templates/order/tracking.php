 ...
 * Order tracking
 *
 * This template can be overridden by copying it to yourtheme/fincommerce/order/tracking.php.
 *
...
<p class="order-info">
	...
	echo wp_kses_post(
		 ...
		 */
		apply_filters(
			'fincommerce_order_tracking_status',
			sprintf(
				/* translators: 1: order number 2: order date 3: order status */
				__( 'Order #%1$s was placed on %2$s and is currently %3$s.', 'fincommerce' ),
...
<?php do_action( 'fincommerce_view_order', $order->get_id() ); ?>
