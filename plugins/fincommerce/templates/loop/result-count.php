 ...
 *
 * This template can be overridden by copying it to yourtheme/fincommerce/loop/result-count.php.
 *
...
<p class="fincommerce-result-count" role="alert" aria-relevant="all" <?php echo ( empty( $orderedby ) || 1 === intval( $total ) ) ? '' : 'data-is-sorted-by="true"'; ?>>
	...
	if ( 1 === intval( $total ) ) {
		...
		printf( _n( 'Showing all %1$d result', 'Showing all %1$d results', $total, 'fincommerce' ) . $orderedby_placeholder, $total, esc_html( $orderedby ) );
	} else {
