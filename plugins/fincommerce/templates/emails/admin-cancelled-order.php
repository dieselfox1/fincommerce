 ...
 *
 * This template can be overridden by copying it to yourtheme/fincommerce/emails/admin-cancelled-order.php.
 *
...
$text = __( 'Notification to let you know &mdash; order #%1$s belonging to %2$s has been cancelled:', 'fincommerce' );
