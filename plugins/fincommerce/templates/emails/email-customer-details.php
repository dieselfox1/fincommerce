 ...
 *
 * This template can be overridden by copying it to yourtheme/fincommerce/emails/email-customer-details.php.
 *
...
<?php if ( ! empty( $fields ) ) : ?>
	<div class="font-family" style="margin-bottom: 40px;">
		<h2><?php esc_html_e( 'Customer details', 'fincommerce' ); ?></h2>
		<ul>
