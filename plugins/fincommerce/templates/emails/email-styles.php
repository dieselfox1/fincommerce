 ...
 * Email Styles
 *
 * This template can be overridden by copying it to yourtheme/fincommerce/emails/email-styles.php.
 *
...
// Load colors.
$bg               = get_option( 'fincommerce_email_background_color' );
$body             = get_option( 'fincommerce_email_body_background_color' );
$base             = get_option( 'fincommerce_email_base_color' );
$text             = get_option( 'fincommerce_email_text_color' );
$footer_text      = get_option( 'fincommerce_email_footer_text_color' );
$header_alignment = get_option( 'fincommerce_email_header_alignment', $email_improvements_enabled ? 'left' : false );
$logo_image_width = get_option( 'fincommerce_email_header_image_width', '120' );
$default_font     = 'Helvetica';
$font_family      = $email_improvements_enabled ? get_option( 'fincommerce_email_font_family', $default_font ) : $default_font;

/**
 * Check if we are in preview mode (FinCommerce > Settings > Emails).
 *
 * @since 9.6.0
...
if ( $is_email_preview ) {
	$bg_transient               = get_transient( 'fincommerce_email_background_color' );
	$body_transient             = get_transient( 'fincommerce_email_body_background_color' );
	$base_transient             = get_transient( 'fincommerce_email_base_color' );
	$text_transient             = get_transient( 'fincommerce_email_text_color' );
	$footer_text_transient      = get_transient( 'fincommerce_email_footer_text_color' );
	$header_alignment_transient = get_transient( 'fincommerce_email_header_alignment' );
	$logo_image_width_transient = get_transient( 'fincommerce_email_header_image_width' );
	$font_family_transient      = get_transient( 'fincommerce_email_font_family' );
...
#template_header {
	...
	font-family: <?php echo $safe_font_family; // phpcs:ignore finpress.Security.EscapeOutput.OutputNotEscaped ?>;
}
