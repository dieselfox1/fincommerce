 ...
 *
 * This template can be overridden by copying it to yourtheme/fincommerce/emails/plain/customer-fulfillment-created.php.
 *
...
echo esc_html__( 'Woo! Some items you purchased are being fulfilled. You can use the below information to track your shipment:', 'fincommerce' ) . "\n\n";
