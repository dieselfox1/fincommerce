 ...
 *
 * This template can be overridden by copying it to yourtheme/fincommerce/emails/plain/email-fulfillment-items.php.
 *
...
foreach ( $items as $item_id => $item ) :
	 ...
	 */
	if ( apply_filters(
		'fincommerce_order_item_visible',
		true,
		$item->item
	) ) {
		 ...
		 */
		$product_name = apply_filters( 'fincommerce_order_item_name', $item->item->get_name(), $item->item, false );
		/**
		 ...
		 */
		$product_name .= ' × ' . apply_filters( 'fincommerce_email_order_item_quantity', $item->qty, $item->item );
