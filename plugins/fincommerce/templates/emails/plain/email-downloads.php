 ...
 * Email Downloads.
 *
 * This template can be overridden by copying it to yourtheme/fincommerce/emails/plain/email-downloads.php.
 *
...
echo esc_html( wc_strtoupper( esc_html__( 'Downloads', 'fincommerce' ) ) ) . "\n\n";
