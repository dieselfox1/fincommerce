 ...
 *
 * This template can be overridden by copying it to yourtheme/fincommerce/emails/plain/email-order-items.php.
 *
...
foreach ( $items as $item_id => $item ) :
	if ( apply_filters( 'fincommerce_order_item_visible', true, $item ) ) {
		...
		if ( $email_improvements_enabled ) {
			 ...
			 */
			$product_name = apply_filters( 'fincommerce_order_item_name', $item->get_name(), $item, false );
			/**
			 ...
			 */
			$product_name .= ' × ' . apply_filters( 'fincommerce_email_order_item_quantity', $item->get_quantity(), $item );
