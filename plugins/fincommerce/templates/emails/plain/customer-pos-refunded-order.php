 ...
 *
 * This template can be overridden by copying it to yourtheme/fincommerce/emails/plain/customer-pos-refunded-order.php.
 *
...
if ( ! empty( $order->get_billing_first_name() ) ) {
	...
	echo esc_html__( 'Hi there,', 'fincommerce' ) . "\n\n";
}
if ( $partial_refund ) {
...
if ( ! empty( $pos_refund_returns_policy ) ) {
	echo "\n" . esc_html__( 'Refund & Returns Policy', 'fincommerce' ) . "\n\n";
 ...
 * @since 4.0.0
 */
echo wp_kses_post( apply_filters( 'fincommerce_email_footer_text', get_option( 'fincommerce_email_footer_text' ), $email ) );
