 ...
 *
 * This template can be overridden by copying it to yourtheme/fincommerce/emails/plain/customer-reset-password.php.
 *
...
echo sprintf( esc_html__( 'Someone has requested a new password for the following account on %s:', 'fincommerce' ), esc_html( $blogname ) ) . "\n\n";
