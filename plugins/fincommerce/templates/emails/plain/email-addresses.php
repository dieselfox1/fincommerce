 ...
 *
 * This template can be overridden by copying it to yourtheme/fincommerce/emails/plain/email-addresses.php.
 *
 ...
 */
do_action( 'fincommerce_email_customer_address_section', 'billing', $order, $sent_to_admin, true );
...
if ( ! wc_ship_to_billing_address_only() && $order->needs_shipping_address() ) {
	...
	if ( $shipping ) {
		 ...
		 * @param bool $plain_text If this email is plain text or not.
		 */
		do_action( 'fincommerce_email_customer_address_section', 'shipping', $order, $sent_to_admin, true );
	}
}
