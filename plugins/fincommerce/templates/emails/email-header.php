 ...
 * Email Header
 *
 * This template can be overridden by copying it to yourtheme/fincommerce/emails/email-header.php.
 *
						...
						<table border="0" cellpadding="0" cellspacing="0" height="100%" width="100%" id="inner_wrapper">
							<tr>
								<td align="center" valign="top">
									<?php
									$img = get_option( 'fincommerce_email_header_image' );
									/**
									...
									if ( apply_filters( 'fincommerce_is_email_preview', false ) ) {
										$img_transient = get_transient( 'fincommerce_email_header_image' );
