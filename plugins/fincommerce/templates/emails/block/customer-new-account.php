...
printf( esc_html__( 'Welcome to %s', 'fincommerce' ), '<!--[fincommerce/site-title]-->' );
?></h2>
<!-- /wp:heading -->
...
<p><?php
	/* translators: %s: Site title */
	printf( esc_html__( 'Thanks for creating an account on %s. Here’s a copy of your user details.', 'fincommerce' ), '<!--[fincommerce/site-title]-->' );
?></p>
<!-- /wp:paragraph -->
...
echo wp_kses( sprintf( __( 'Username: <b>%s</b>', 'fincommerce' ), '<!--[fincommerce/customer-username]-->' ), array( 'b' => array() ) );
?></p>
<!-- /wp:paragraph -->
...
<p><?php
	...
	printf(
		...
		wp_kses_post(
			sprintf(
				$link_template,
				esc_attr( '[fincommerce/my-account-url]' ),
				esc_html__( 'My account', 'fincommerce' )
			)
		)
	);
	?></p>
...
<!-- wp:paragraph -->
<p> <?php echo esc_html__( 'We look forward to seeing you soon.', 'fincommerce' ); ?> </p>
<!-- /wp:paragraph -->
