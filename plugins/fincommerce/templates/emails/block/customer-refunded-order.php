...
printf( esc_html__( 'Order refunded: %s', 'fincommerce' ), '<!--[fincommerce/order-number]-->' );
?></h2>
<!-- /wp:heading -->
...
printf( esc_html__( 'Your order from %s has been refunded.', 'fincommerce' ), '<!--[fincommerce/site-title]-->' );
?></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph -->
<p> <?php echo esc_html__( 'Here’s a reminder of what you’ve ordered:', 'fincommerce' ); ?> </p>
<!-- /wp:paragraph -->
