...
printf( esc_html__( 'New order: #%s,', 'fincommerce' ), '<!--[fincommerce/order-number]-->' );
?></h2>
<!-- /wp:heading -->
...
printf( esc_html__( 'You’ve received a new order from %s', 'fincommerce' ), '<!--[fincommerce/customer-full-name]-->' );
?></p>
<!-- /wp:paragraph -->
...
<p class="has-text-align-center"> <?php echo esc_html__( 'Congratulations on the sale!', 'fincommerce' ); ?> </p>
<!-- /wp:paragraph -->
