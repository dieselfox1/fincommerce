...
<!-- wp:heading -->
<h2 class="wp-block-heading"> <?php echo esc_html__( 'Good things are heading your way!', 'fincommerce' ); ?> </h2>
<!-- /wp:heading -->
...
<!-- wp:paragraph -->
<p> <?php echo esc_html__( 'We have finished processing your order.', 'fincommerce' ); ?> </p>
<!-- /wp:paragraph -->
