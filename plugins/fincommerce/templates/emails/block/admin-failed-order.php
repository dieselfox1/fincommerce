...
printf( esc_html__( 'Order failed: #%s,', 'fincommerce' ), '<!--[fincommerce/order-number]-->' );
?></h2>
<!-- /wp:heading -->
...
<!-- wp:paragraph -->
<p><?php
echo wp_kses_post( __( 'We hope they’ll be back soon! Read more about <a href="https://fincommerce.com/document/managing-orders/">troubleshooting failed payments</a>.', 'fincommerce' ) );
?></p>
<!-- /wp:paragraph -->
