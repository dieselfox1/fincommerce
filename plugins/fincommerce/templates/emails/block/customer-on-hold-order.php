...
<!-- wp:heading -->
<h2 class="wp-block-heading"> <?php echo esc_html__( 'Thank you for your order', 'fincommerce' ); ?> </h2>
<!-- /wp:heading -->
...
<!-- wp:paragraph -->
<p> <?php echo esc_html__( 'We’ve received your order and it’s currently on hold until we can confirm your payment has been processed.', 'fincommerce' ); ?> </p>
<!-- /wp:paragraph -->
