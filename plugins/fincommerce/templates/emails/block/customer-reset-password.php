...
<!-- wp:heading -->
<h2 class="wp-block-heading"> <?php echo esc_html__( 'Reset your password', 'fincommerce' ); ?> </h2>
<!-- /wp:heading -->

<!-- wp:paragraph -->
<p><?php
	/* translators: %s: Customer username */
	printf( esc_html__( 'Hi %s,', 'fincommerce' ), '<!--[fincommerce/customer-username]-->' );
?></p>
<!-- /wp:paragraph -->
...
<p><?php
	...
	printf( esc_html__( 'Someone has requested a new password for the following account on %s:', 'fincommerce' ), '<!--[fincommerce/site-title]-->' );
?></p>
<!-- /wp:paragraph -->
...
<!-- wp:paragraph -->
<p><?php
	echo esc_html__( 'If you didn’t make this request, just ignore this email. If you’d like to proceed, reset your password via the link below:', 'fincommerce' );
?></p>
<!-- /wp:paragraph -->
