...
<!-- wp:heading -->
<h2 class="wp-block-heading"> <?php echo esc_html__( 'Sorry, your order was unsuccessful', 'fincommerce' ); ?> </h2>
<!-- /wp:heading -->
...
<!-- wp:paragraph -->
<p> <?php echo esc_html__( "Unfortunately, we couldn't complete your order due to an issue with your payment method.", 'fincommerce' ); ?> </p>
<!-- /wp:paragraph -->

<!-- wp:paragraph -->
<p><?php
	/* translators: %s: Site title */
	printf( esc_html__( "If you'd like to continue with your purchase, please return to %s and try a different method of payment.", 'fincommerce' ), '<!--[fincommerce/site-title]-->' )
?></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph -->
<p> <?php echo esc_html__( 'Your order details are as follows:', 'fincommerce' ); ?> </p>
<!-- /wp:paragraph -->
...
printf( esc_html__( 'If you need any help with your order, please contact us at %s.', 'fincommerce' ), '<!--[fincommerce/store-email]-->' );
?></p>
<!-- /wp:paragraph -->
