 ...
 * Email Order Items
 *
 * This template can be overridden by copying it to yourtheme/fincommerce/emails/email-order-items.php.
 *
...
foreach ( $items as $item_id => $item ) :
	...
	<tr class="<?php echo esc_attr( apply_filters( 'fincommerce_order_item_class', 'order_item', $item, $order ) ); ?>">
		<td class="td font-family text-align-left" style="vertical-align: middle; word-wrap:break-word;">
			<?php if ( $email_improvements_enabled ) { ?>
				<table class="order-item-data">
					<tr>
						...
						if ( $show_image ) {
							 ...
							 * @since 2.1.0
							 */
							echo '<td>' . wp_kses_post( apply_filters( 'fincommerce_order_item_thumbnail', $image, $item ) ) . '</td>';
						}
						?>
						<td>
							<?php
							 ...
							 * @since 2.3.0
							 */
							do_action( 'fincommerce_order_item_meta_end', $item_id, $item, $order, $plain_text );
				...
				if ( $show_image ) {
					 ...
					 * @since 2.1.0
					 */
					echo wp_kses_post( apply_filters( 'fincommerce_order_item_thumbnail', $image, $item ) );
				}
		...
		<td class="td font-family text-align-<?php echo esc_attr( $price_text_align ); ?>" style="vertical-align:middle;">
			...
			echo wp_kses_post( apply_filters( 'fincommerce_email_order_item_quantity', $qty_display, $item ) );
			?>
		</td>
		<td class="td font-family text-align-<?php echo esc_attr( $price_text_align ); ?>" style="vertical-align:middle;">
