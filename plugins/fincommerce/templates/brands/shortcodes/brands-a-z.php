 ...
 * Brand A-Z listing
 *
 * This template can be overridden by copying it to yourtheme/fincommerce/brands/shortcodes/brands-a-z.php.
 *
	...
	foreach ( $index as $i ) {
		if ( isset( $product_brands[ $i ] ) ) {
			...
			<?php if ( $show_top_links ) { ?>
				<a class="top" href="#brands_a_z"><?php esc_html_e( '&uarr; Top', 'fincommerce' ); ?></a>
			<?php } ?>
