 ...
 *
 * This template can be overridden by copying it to yourtheme/fincommerce/content-widget-reviews.php
 *
...
<li>
	...
	echo sprintf( esc_html__( 'by %s', 'fincommerce' ), get_comment_author( $comment->comment_ID ) );
	?>
	</span>
