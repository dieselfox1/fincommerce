 ...
 * Login form
 *
 * This template can be overridden by copying it to yourtheme/fincommerce/global/form-login.php.
 *
...
?>
<form class="fincommerce-form fincommerce-form-login login" method="post" <?php echo ( $hidden ) ? 'style="display:none;"' : ''; ?>>
	...
	<p class="form-row form-row-first">
		<label for="username"><?php esc_html_e( 'Username or email', 'fincommerce' ); ?>&nbsp;<span class="required" aria-hidden="true">*</span><span class="screen-reader-text"><?php esc_html_e( 'Required', 'fincommerce' ); ?></span></label>
	...
	<p class="form-row form-row-last">
		...
		<input class="input-text fincommerce-Input" type="password" name="password" id="password" autocomplete="current-password" required aria-required="true" />
	</p>
	<div class="clear"></div>
	...
	<p class="form-row">
		...
		<button type="submit" class="fincommerce-button button fincommerce-form-login__submit<?php echo esc_attr( wc_wp_theme_get_element_class_name( 'button' ) ? ' ' . wc_wp_theme_get_element_class_name( 'button' ) : '' ); ?>" name="login" value="<?php esc_attr_e( 'Login', 'fincommerce' ); ?>"><?php esc_html_e( 'Login', 'fincommerce' ); ?></button>
	</p>
