 ...
 *
 * This template can be overridden by copying it to yourtheme/fincommerce/checkout/order-receipt.php.
 *
...
<?php do_action( 'fincommerce_receipt_' . $order->get_payment_method(), $order->get_id() ); ?>
