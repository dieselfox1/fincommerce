 ...
 * Auth header
 *
 * This template can be overridden by copying it to yourtheme/fincommerce/auth/header.php.
 *
...
<head>
	...
	<title><?php esc_html_e( 'Application authentication request', 'fincommerce' ); ?></title>
