...
class WC_Shipping_Rate implements JsonSerializable {
	...
	public function get_id() {
		 ...
		 */
		return apply_filters( 'fincommerce_shipping_rate_id', $this->data['id'], $this );
	}
	...
	public function get_method_id() {
		 ...
		 * @param WC_Shipping_Rate $this The shipping rate object.
		 */
		return apply_filters( 'fincommerce_shipping_rate_method_id', $this->data['method_id'], $this );
	}
	...
	public function get_instance_id() {
		 ...
		 * @param WC_Shipping_Rate $this The shipping rate object.
		 */
		return apply_filters( 'fincommerce_shipping_rate_instance_id', $this->data['instance_id'], $this );
	}
	...
	public function get_label() {
		 ...
		 * @param WC_Shipping_Rate $this The shipping rate object.
		 */
		return apply_filters( 'fincommerce_shipping_rate_label', $this->data['label'], $this );
	}
	...
	public function get_cost() {
		 ...
		 * @param WC_Shipping_Rate $this The shipping rate object.
		 */
		return apply_filters( 'fincommerce_shipping_rate_cost', $this->data['cost'], $this );
	}
	...
	public function get_taxes() {
		 ...
		 * @param WC_Shipping_Rate $this The shipping rate object.
		 */
		return apply_filters( 'fincommerce_shipping_rate_taxes', $this->data['taxes'], $this );
	}
	...
	public function get_shipping_tax() {
		 ...
		 * @param WC_Shipping_Rate $this The shipping rate object.
		 */
		return apply_filters( 'fincommerce_get_shipping_tax', count( $taxes ) > 0 && ! WC()->customer->get_is_vat_exempt() ? (float) array_sum( $taxes ) : 0.0, $this );
	}
	...
	public function get_tax_status() {
		 ...
		 */
		return apply_filters( 'fincommerce_shipping_rate_tax_status', $this->data['tax_status'], $this );
	}
	...
	public function get_description() {
		 ...
		 */
		return apply_filters( 'fincommerce_shipping_rate_description', $this->data['description'], $this );
	}
	...
	public function get_delivery_time() {
		 ...
		 * @param WC_Shipping_Rate  $this          The shipping rate.
		 */
		return apply_filters( 'fincommerce_shipping_rate_delivery_time', $this->data['delivery_time'], $this );
	}
