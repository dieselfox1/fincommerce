<?php
/**
 * FinCommerce Order Item Functions
 *
...
function wc_add_order_item( $order_id, $item_array ) {
	...
	do_action( 'fincommerce_new_order_item', $item_id, $item, $order_id );
...
function wc_update_order_item( $item_id, $args ) {
	...
	do_action( 'fincommerce_update_order_item', $item_id, $args );
...
function wc_delete_order_item( $item_id ) {
	...
	do_action( 'fincommerce_before_delete_order_item', $item_id );

	$data_store->delete_order_item( $item_id );

	do_action( 'fincommerce_delete_order_item', $item_id );

	return true;
}

/**
 * FinCommerce Order Item Meta API - Update term meta.
 *
 * @param int    $item_id    Item ID.
...
/**
 * FinCommerce Order Item Meta API - Add term meta.
 *
 * @param int    $item_id    Item ID.
 * @param string $meta_key   Meta key.
 * @param mixed  $meta_value Meta value.
...
/**
 * FinCommerce Order Item Meta API - Delete term meta.
 *
 * @param int    $item_id    Item ID.
 * @param string $meta_key   Meta key.
...
/**
 * FinCommerce Order Item Meta API - Get term meta.
 *
 * @param int    $item_id Item ID.
