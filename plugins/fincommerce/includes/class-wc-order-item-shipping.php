...
class WC_Order_Item_Shipping extends WC_Order_Item {
	...
	public function calculate_taxes( $calculate_tax_for = array() ) {
		...
		do_action( 'fincommerce_order_item_shipping_after_calculate_taxes', $this, $calculate_tax_for );
	...
	*/
	...
	public function get_method_title( $context = 'view' ) {
		...
		if ( 'view' === $context ) {
			return $method_title ? $method_title : __( 'Shipping', 'fincommerce' );
		} else {
			return $method_title;
		}
	}
	...
	public function get_tax_class( $context = 'view' ) {
		return get_option( 'fincommerce_shipping_tax_class' );
	}
