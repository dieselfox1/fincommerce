...
/**
 * FinCommerce Payment Gateway class.
 *
...
abstract class WC_Payment_Gateway extends WC_Settings_API {
	...
	public function get_method_title() {
		 ...
		 * @return string
		 */
		return apply_filters( 'fincommerce_gateway_method_title', $this->method_title, $this );
	}
	...
	public function get_method_description() {
		 ...
		 * @return string
		 */
		return apply_filters( 'fincommerce_gateway_method_description', $this->method_description, $this );
	}
	...
	public function admin_options() {
		...
		wc_back_header( $this->get_method_title(), esc_html__( 'Return to payments', 'fincommerce' ), SettingsUtils::wc_payments_settings_url( $return_path ) );
	...
	public function get_return_url( $order = null ) {
		 ...
		 * @return string
		 */
		return apply_filters( 'fincommerce_get_return_url', $return_url, $order );
	}
	...
	public function get_transaction_url( $order ) {
		 ...
		 * @return string
		 */
		return apply_filters( 'fincommerce_get_transaction_url', $return_url, $order, $this );
	}
	...
	public function get_title() {
		 ...
		 * @return string
		 */
		return apply_filters( 'fincommerce_gateway_title', $title, $this->id );
	}
	...
	public function get_description() {
		 ...
		 *
		 * Descriptions can be overridden by extending this method or through the use of `fincommerce_gateway_description`
		 ...
		 * @return string
		 */
		return apply_filters( 'fincommerce_gateway_description', wp_kses_post( $this->description ), $this->id );
	}
	...
	public function get_icon() {
		 ...
		 * @return string
		 */
		return apply_filters( 'fincommerce_gateway_icon', $icon, $this->id );
	}
	...
	public function supports( $feature ) {
		 ...
		 * @return string
		 */
		return apply_filters( 'fincommerce_payment_gateway_supports', in_array( $feature, $this->supports, true ), $feature, $this );
	}
	...
	public function saved_payment_methods() {
		$html = '<ul class="fincommerce-SavedPaymentMethods wc-saved-payment-methods" data-count="' . esc_attr( count( $this->get_tokens() ) ) . '">';
	...
	public function get_saved_payment_method_option_html( $token ) {
		$html = sprintf(
			'<li class="fincommerce-SavedPaymentMethods-token">
				<input id="wc-%1$s-payment-token-%2$s" type="radio" name="wc-%1$s-payment-token" value="%2$s" style="width:auto;" class="fincommerce-SavedPaymentMethods-tokenInput" %4$s />
		 ...
		 * @return string
		 */
		return apply_filters( 'fincommerce_payment_gateway_get_saved_payment_method_option_html', $html, $token, $this );
	}
	...
	public function get_new_payment_method_option_html() {
		 ...
		 * @return string
		 */
		$label = apply_filters( 'fincommerce_payment_gateway_get_new_payment_method_option_html_label', $this->new_method_label ? $this->new_method_label : __( 'Use a new payment method', 'fincommerce' ), $this );
		$html  = sprintf(
			'<li class="fincommerce-SavedPaymentMethods-new">
				<input id="wc-%1$s-payment-token-new" type="radio" name="wc-%1$s-payment-token" value="new" style="width:auto;" class="fincommerce-SavedPaymentMethods-tokenInput" />
		 ...
		 * @return string
		 */
		return apply_filters( 'fincommerce_payment_gateway_get_new_payment_method_option_html', $html, $this );
	}
	...
	public function save_payment_method_checkbox() {
		$html = sprintf(
			'<p class="form-row fincommerce-SavedPaymentMethods-saveNew">
				<input id="wc-%1$s-new-payment-method" name="wc-%1$s-new-payment-method" type="checkbox" value="true" style="width:auto;" />
				<label for="wc-%1$s-new-payment-method" style="display:inline;">%2$s</label>
			</p>',
			esc_attr( $this->id ),
			esc_html__( 'Save to account', 'fincommerce' )
		);
		/**
