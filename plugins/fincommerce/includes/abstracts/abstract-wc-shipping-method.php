...
/**
 * FinCommerce Shipping Method Class.
 *
...
abstract class WC_Shipping_Method extends WC_Settings_API {
	...
	public function supports( $feature ) {
		return apply_filters( 'fincommerce_shipping_method_supports', in_array( $feature, $this->supports ), $feature, $this );
	}
	...
	public function get_method_title() {
		return apply_filters( 'fincommerce_shipping_method_title', $this->method_title, $this );
	}
	...
	public function get_method_description() {
		return apply_filters( 'fincommerce_shipping_method_description', $this->method_description, $this );
	}
	...
	public function get_title() {
		return apply_filters( 'fincommerce_shipping_method_title', $this->title, $this->id );
	}
	...
	public function add_rate( $args = array() ) {
		$args = apply_filters(
			'fincommerce_shipping_method_add_rate_args',
			wp_parse_args(
				$args,
				array(
		...
		if ( $args['package'] ) {
			...
			$rate->add_meta_data( __( 'Items', 'fincommerce' ), implode( ', ', $items_in_package ) );
		}

		$this->rates[ $args['id'] ] = apply_filters( 'fincommerce_shipping_method_add_rate', $rate, $args, $this );
	}
	...
	public function is_available( $package ) {
		...
		return apply_filters( 'fincommerce_shipping_' . $this->id . '_is_available', $available, $package, $this );
	}
	...
	public function admin_options() {
		...
		echo $this->get_admin_options_html(); // phpcs:ignore finpress.XSS.EscapeOutput.OutputNotEscaped
	}
	...
	public function get_option( $key, $empty_value = null ) {
		...
		$option = apply_filters( 'fincommerce_shipping_' . $this->id . '_option', parent::get_option( $key, $empty_value ), $key, $this );
		return $option;
	}
	...
	public function get_instance_option( $key, $empty_value = null ) {
		...
		$instance_option = apply_filters( 'fincommerce_shipping_' . $this->id . '_instance_option', $this->instance_settings[ $key ], $key, $this );
	...
	public function get_instance_form_fields() {
		return apply_filters( 'fincommerce_shipping_instance_form_fields_' . $this->id, array_map( array( $this, 'set_defaults' ), $this->instance_form_fields ) );
	}
	 ...
	 *
	 * This method is usually attached to fincommerce_update_options_x hooks.
	 *
	 * @since 2.6.0
	...
	public function process_admin_options() {
		...
		return update_option( $this->get_instance_option_key(), apply_filters( 'fincommerce_shipping_' . $this->id . '_instance_settings_values', $this->instance_settings, $this ), 'yes' );
	}
}
