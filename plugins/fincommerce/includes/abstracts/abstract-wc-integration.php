...
abstract class WC_Integration extends WC_Settings_API {
	...
	public function get_method_title() {
		return apply_filters( 'fincommerce_integration_title', $this->method_title, $this );
	}
	...
	public function get_method_description() {
		return apply_filters( 'fincommerce_integration_description', $this->method_description, $this );
	}
