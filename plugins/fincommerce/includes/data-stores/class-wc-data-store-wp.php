...
class WC_Data_Store_WP {
	...
	public function filter_raw_meta_data( &$object, $raw_meta_data ) {
		...
		return apply_filters( "fincommerce_data_store_wp_{$this->meta_type}_read_meta", $meta_data, $object, $this );
	}
	...
	protected function get_wp_query_args( $query_vars ) {
		...
		return apply_filters( 'fincommerce_get_wp_query_args', $wp_query_args, $query_vars );
	}
