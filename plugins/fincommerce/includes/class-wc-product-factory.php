 ...
 * Product Factory
 *
 * The FinCommerce product factory creating the right product object.
 *
...
class WC_Product_Factory {
	...
	public static function get_product_classname( $product_id, $product_type ) {
		 ...
		 * @since 3.0.0
		 */
		$classname = apply_filters( 'fincommerce_product_class', self::get_classname_from_product_type( $product_type ), $product_type, ProductType::VARIATION === $product_type ? 'product_variation' : 'product', $product_id );
	...
	public static function get_product_type( $product_id ) {
		...
		$override = apply_filters( 'fincommerce_product_type_query', false, $product_id );
		if ( ! $override ) {
