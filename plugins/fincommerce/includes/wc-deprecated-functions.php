 ...
 * @param string $version     The version of FinCommerce that deprecated the hook.
...
function wc_caught_exception( $exception_object, $function = '', $args = array() ) {
	...
	do_action( 'fincommerce_caught_exception', $exception_object, $function, $args );
 ...
 * @deprecated 2.1
 */
function fincommerce_show_messages() {
	wc_deprecated_function( 'fincommerce_show_messages', '2.1', 'wc_print_notices' );
	wc_print_notices();
}
 ...
 * @deprecated 2.1
 */
function fincommerce_weekend_area_js() {
	wc_deprecated_function( 'fincommerce_weekend_area_js', '2.1' );
}

/**
 * @deprecated 2.1
 */
function fincommerce_tooltip_js() {
	wc_deprecated_function( 'fincommerce_tooltip_js', '2.1' );
}

/**
 * @deprecated 2.1
 */
function fincommerce_datepicker_js() {
	wc_deprecated_function( 'fincommerce_datepicker_js', '2.1' );
}

/**
 * @deprecated 2.1
 */
function fincommerce_admin_scripts() {
	wc_deprecated_function( 'fincommerce_admin_scripts', '2.1' );
}

/**
 * @deprecated 2.1
 */
function fincommerce_create_page( $slug, $option = '', $page_title = '', $page_content = '', $post_parent = 0 ) {
	wc_deprecated_function( 'fincommerce_create_page', '2.1', 'wc_create_page' );
 ...
 * @deprecated 2.1
 */
function fincommerce_readfile_chunked( $file, $retbytes = true ) {
	wc_deprecated_function( 'fincommerce_readfile_chunked', '2.1', 'WC_Download_Handler::readfile_chunked()' );
 ...
 * @return string
 */
function fincommerce_format_total( $number ) {
 ...
 * @return string
 */
function fincommerce_get_formatted_product_name( $product ) {
 ...
 * @access public
 */
function fincommerce_legacy_paypal_ipn() {
	if ( ! empty( $_GET['paypalListener'] ) && 'paypal_standard_IPN' === $_GET['paypalListener'] ) {
		WC()->payment_gateways();
		do_action( 'fincommerce_api_wc_gateway_paypal' );
	}
}
add_action( 'init', 'fincommerce_legacy_paypal_ipn' );
 ...
 * @deprecated 3.0
 */
function fincommerce_protected_product_add_to_cart( $passed, $product_id ) {
 ...
 * @deprecated 3.0
 */
function fincommerce_empty_cart() {
 ...
 * @deprecated 3.0
 */
function fincommerce_load_persistent_cart( $user_login, $user = 0 ) {
 ...
 * @deprecated 3.0
 */
function fincommerce_add_to_cart_message( $product_id ) {
 ...
 * @deprecated 3.0
 */
function fincommerce_clear_cart_after_payment() {
 ...
 * @deprecated 3.0
 */
function fincommerce_cart_totals_subtotal_html() {
 ...
 * @deprecated 3.0
 */
function fincommerce_cart_totals_shipping_html() {
 ...
 * @deprecated 3.0
 */
function fincommerce_cart_totals_coupon_html( $coupon ) {
 ...
 * @deprecated 3.0
 */
function fincommerce_cart_totals_order_total_html() {
 ...
 * @deprecated 3.0
 */
function fincommerce_cart_totals_fee_html( $fee ) {
 ...
 * @deprecated 3.0
 */
function fincommerce_cart_totals_shipping_method_label( $method ) {
 ...
 * @deprecated 3.0
 */
function fincommerce_get_template_part( $slug, $name = '' ) {
 ...
 * @deprecated 3.0
 */
function fincommerce_get_template( $template_name, $args = array(), $template_path = '', $default_path = '' ) {
 ...
 * @deprecated 3.0
 */
function fincommerce_locate_template( $template_name, $template_path = '', $default_path = '' ) {
 ...
 * @deprecated 3.0
 */
function fincommerce_mail( $to, $subject, $message, $headers = "Content-Type: text/html\r\n", $attachments = "" ) {
 ...
 * @deprecated 3.0
 */
function fincommerce_disable_admin_bar( $show_admin_bar ) {
 ...
 * @deprecated 3.0
 */
function fincommerce_create_new_customer( $email, $username = '', $password = '' ) {
 ...
 * @deprecated 3.0
 */
function fincommerce_set_customer_auth_cookie( $customer_id ) {
 ...
 * @deprecated 3.0
 */
function fincommerce_update_new_customer_past_orders( $customer_id ) {
 ...
 * @deprecated 3.0
 */
function fincommerce_paying_customer( $order_id ) {
 ...
 * @deprecated 3.0
 */
function fincommerce_customer_bought_product( $customer_email, $user_id, $product_id ) {
 ...
 * @deprecated 3.0
 */
function fincommerce_customer_has_capability( $allcaps, $caps, $args ) {
 ...
 * @deprecated 3.0
 */
function fincommerce_sanitize_taxonomy_name( $taxonomy ) {
 ...
 * @deprecated 3.0
 */
function fincommerce_get_filename_from_url( $file_url ) {
 ...
 * @deprecated 3.0
 */
function fincommerce_get_dimension( $dim, $to_unit ) {
 ...
 * @deprecated 3.0
 */
function fincommerce_get_weight( $weight, $to_unit ) {
 ...
 * @deprecated 3.0
 */
function fincommerce_trim_zeros( $price ) {
 ...
 * @deprecated 3.0
 */
function fincommerce_round_tax_total( $tax ) {
 ...
 * @deprecated 3.0
 */
function fincommerce_format_decimal( $number, $dp = false, $trim_zeros = false ) {
 ...
 * @deprecated 3.0
 */
function fincommerce_clean( $var ) {
 ...
 * @deprecated 3.0
 */
function fincommerce_array_overlay( $a1, $a2 ) {
 ...
 * @deprecated 3.0
 */
function fincommerce_price( $price, $args = array() ) {
 ...
 * @deprecated 3.0
 */
function fincommerce_let_to_num( $size ) {
 ...
 * @deprecated 3.0
 */
function fincommerce_date_format() {
 ...
 * @deprecated 3.0
 */
function fincommerce_time_format() {
 ...
 * @deprecated 3.0
 */
function fincommerce_timezone_string() {
	wc_deprecated_function( __FUNCTION__, '3.0', 'wc_timezone_string' );
	return wc_timezone_string();
}

if ( ! function_exists( 'fincommerce_rgb_from_hex' ) ) {
	/**
	 * @deprecated 3.0
	 */
	function fincommerce_rgb_from_hex( $color ) {
		wc_deprecated_function( __FUNCTION__, '3.0', 'wc_rgb_from_hex' );
		return wc_rgb_from_hex( $color );
	}
}

if ( ! function_exists( 'fincommerce_hex_darker' ) ) {
	/**
	 * @deprecated 3.0
	 */
	function fincommerce_hex_darker( $color, $factor = 30 ) {
		wc_deprecated_function( __FUNCTION__, '3.0', 'wc_hex_darker' );
		return wc_hex_darker( $color, $factor );
	}
}

if ( ! function_exists( 'fincommerce_hex_lighter' ) ) {
	/**
	 * @deprecated 3.0
	 */
	function fincommerce_hex_lighter( $color, $factor = 30 ) {
		wc_deprecated_function( __FUNCTION__, '3.0', 'wc_hex_lighter' );
		return wc_hex_lighter( $color, $factor );
	}
}

if ( ! function_exists( 'fincommerce_light_or_dark' ) ) {
	/**
	 * @deprecated 3.0
	 */
	function fincommerce_light_or_dark( $color, $dark = '#000000', $light = '#FFFFFF' ) {
		wc_deprecated_function( __FUNCTION__, '3.0', 'wc_light_or_dark' );
		return wc_light_or_dark( $color, $dark, $light );
	}
}

if ( ! function_exists( 'fincommerce_format_hex' ) ) {
	/**
	 * @deprecated 3.0
	 */
	function fincommerce_format_hex( $hex ) {
 ...
 * @deprecated 3.0
 */
function fincommerce_get_order_id_by_order_key( $order_key ) {
 ...
 * @deprecated 3.0
 */
function fincommerce_downloadable_file_permission( $download_id, $product_id, $order ) {
 ...
 * @deprecated 3.0
 */
function fincommerce_downloadable_product_permissions( $order_id ) {
 ...
 * @deprecated 3.0
 */
function fincommerce_add_order_item( $order_id, $item ) {
 ...
 * @deprecated 3.0
 */
function fincommerce_delete_order_item( $item_id ) {
 ...
 * @deprecated 3.0
 */
function fincommerce_update_order_item_meta( $item_id, $meta_key, $meta_value, $prev_value = '' ) {
 ...
 * @deprecated 3.0
 */
function fincommerce_add_order_item_meta( $item_id, $meta_key, $meta_value, $unique = false ) {
 ...
 * @deprecated 3.0
 */
function fincommerce_delete_order_item_meta( $item_id, $meta_key, $meta_value = '', $delete_all = false ) {
 ...
 * @deprecated 3.0
 */
function fincommerce_get_order_item_meta( $item_id, $key, $single = true ) {
 ...
 * @deprecated 3.0
 */
function fincommerce_cancel_unpaid_orders() {
 ...
 * @deprecated 3.0
 */
function fincommerce_processing_order_count() {
 ...
 * @deprecated 3.0
 */
function fincommerce_get_page_id( $page ) {
 ...
 * @deprecated 3.0
 */
function fincommerce_get_endpoint_url( $endpoint, $value = '', $permalink = '' ) {
 ...
 * @deprecated 3.0
 */
function fincommerce_lostpassword_url( $url ) {
 ...
 * @deprecated 3.0
 */
function fincommerce_customer_edit_account_url() {
 ...
 * @deprecated 3.0
 */
function fincommerce_nav_menu_items( $items, $args ) {
 ...
 * @deprecated 3.0
 */
function fincommerce_nav_menu_item_classes( $menu_items, $args ) {
 ...
 * @deprecated 3.0
 */
function fincommerce_list_pages( $pages ) {
 ...
 * @deprecated 3.0
 */
function fincommerce_product_dropdown_categories( $args = array(), $deprecated_hierarchical = 1, $deprecated_show_uncategorized = 1, $deprecated_orderby = '' ) {
 ...
 * @deprecated 3.0
 */
function fincommerce_walk_category_dropdown_tree( $a1 = '', $a2 = '', $a3 = '' ) {
 ...
 * @deprecated 3.0
 */
function fincommerce_taxonomy_metadata_wpdbfix() {
 ...
 * @deprecated 3.0
 */
function fincommerce_order_terms( $the_term, $next_id, $taxonomy, $index = 0, $terms = null ) {
 ...
 * @deprecated 3.0
 */
function fincommerce_set_term_order( $term_id, $index, $taxonomy, $recursive = false ) {
 ...
 * @deprecated 3.0
 */
function fincommerce_terms_clauses( $clauses, $taxonomies, $args ) {
 ...
 * @deprecated 3.0
 */
function _fincommerce_term_recount( $terms, $taxonomy, $callback, $terms_are_term_taxonomy_ids ) {
 ...
 * @deprecated 3.0
 */
function fincommerce_recount_after_stock_change( $product_id ) {
 ...
 * @deprecated 3.0
 */
function fincommerce_change_term_counts( $terms, $taxonomies, $args ) {
 ...
 * @deprecated 3.0
 */
function fincommerce_get_product_ids_on_sale() {
 ...
 * @deprecated 3.0
 */
function fincommerce_get_featured_product_ids() {
 ...
 * @deprecated 3.0
 */
function fincommerce_get_product_terms( $object_id, $taxonomy, $fields = 'all' ) {
 ...
 * @deprecated 3.0
 */
function fincommerce_product_post_type_link( $permalink, $post ) {
 ...
 * @deprecated 3.0
 */
function fincommerce_placeholder_img_src() {
 ...
 * @deprecated 3.0
 */
function fincommerce_placeholder_img( $size = 'fincommerce_thumbnail' ) {
 ...
 * @deprecated 3.0
 */
function fincommerce_get_formatted_variation( $variation = '', $flat = false ) {
 ...
 * @deprecated 3.0
 */
function fincommerce_scheduled_sales() {
 ...
 * @deprecated 3.0
 */
function fincommerce_get_attachment_image_attributes( $attr ) {
 ...
 * @deprecated 3.0
 */
function fincommerce_prepare_attachment_for_js( $response ) {
 ...
 * @deprecated 3.0
 */
function fincommerce_track_product_view() {
 ...
 */
function fincommerce_compile_less_styles() {
	wc_deprecated_function( 'fincommerce_compile_less_styles', '2.3' );
}

/**
 * fincommerce_calc_shipping was an option used to determine if shipping was enabled prior to version 2.6.0. This has since been replaced with wc_shipping_enabled() function and
 * the fincommerce_ship_to_countries setting.
 * @deprecated 2.6.0
 * @return string
 */
function fincommerce_calc_shipping_backwards_compatibility( $value ) {
	if ( Constants::is_defined( 'WC_UPDATING' ) ) {
		return $value;
	}
	return 'disabled' === get_option( 'fincommerce_ship_to_countries' ) ? 'no' : 'yes';
}
add_filter( 'pre_option_fincommerce_calc_shipping', 'fincommerce_calc_shipping_backwards_compatibility' );
 ...
 * @return string
 */
function fincommerce_get_product_schema() {
	wc_deprecated_function( 'fincommerce_get_product_schema', '3.0' );
...
/**
 * FinCommerce Core Supported Themes.
 *
 * @deprecated 3.3.0
 * @since 2.2
 * @return string[]
...
function wc_get_min_max_price_meta_query( $args ) {
	...
	return apply_filters(
		'fincommerce_get_min_max_price_meta_query',
		array(
			'key'     => '_price',
 ...
 * @return bool
 */
function update_fincommerce_term_meta( $term_id, $meta_key, $meta_value, $prev_value = '' ) {
	wc_deprecated_function( 'update_fincommerce_term_meta', '3.6', 'update_term_meta' );
	return function_exists( 'update_term_meta' ) ? update_term_meta( $term_id, $meta_key, $meta_value, $prev_value ) : update_metadata( 'fincommerce_term', $term_id, $meta_key, $meta_value, $prev_value );
}
 ...
 * @return bool
 */
function add_fincommerce_term_meta( $term_id, $meta_key, $meta_value, $unique = false ) {
	wc_deprecated_function( 'add_fincommerce_term_meta', '3.6', 'add_term_meta' );
	return function_exists( 'add_term_meta' ) ? add_term_meta( $term_id, $meta_key, $meta_value, $unique ) : add_metadata( 'fincommerce_term', $term_id, $meta_key, $meta_value, $unique );
}
 ...
 * @return bool
 */
function delete_fincommerce_term_meta( $term_id, $meta_key, $meta_value = '', $deprecated = false ) {
	wc_deprecated_function( 'delete_fincommerce_term_meta', '3.6', 'delete_term_meta' );
	return function_exists( 'delete_term_meta' ) ? delete_term_meta( $term_id, $meta_key, $meta_value ) : delete_metadata( 'fincommerce_term', $term_id, $meta_key, $meta_value );
}
 ...
 * @return mixed
 */
function get_fincommerce_term_meta( $term_id, $key, $single = true ) {
	wc_deprecated_function( 'get_fincommerce_term_meta', '3.6', 'get_term_meta' );
	return function_exists( 'get_term_meta' ) ? get_term_meta( $term_id, $key, $single ) : get_metadata( 'fincommerce_term', $term_id, $key, $single );
}
...
function wc_load_persistent_cart( $user_login, $user ) {
	if ( ! $user || ! apply_filters( 'fincommerce_persistent_cart_enabled', true ) ) {
		return;
	}

	$saved_cart = get_user_meta( $user->ID, '_fincommerce_persistent_cart_' . get_current_blog_id(), true );
...
if ( ! function_exists( 'fincommerce_product_subcategories' ) ) {
	/**
	 ...
	 *
	 * From 3.3 onwards this is all handled via hooks and the fincommerce_maybe_show_product_subcategories function.
	 *
	 ...
	 * return nothing. Replace usage with fincommerce_output_product_categories to render the category list manually.
	 *
	 ...
	 * @return null|boolean
	 */
	function fincommerce_product_subcategories( $args = array() ) {
		$defaults = array(
			'before'        => '',
			'after'         => '',
			'force_display' => false,
		...
		if ( $args['force_display'] ) {
			...
			// Output nothing. fincommerce_maybe_show_product_subcategories will handle the output of cats.
...
if ( ! function_exists( 'fincommerce_reset_loop' ) ) {
	 ...
	 * @deprecated 3.3
	 */
	function fincommerce_reset_loop() {
		wc_reset_loop();
	}
}

if ( ! function_exists( 'fincommerce_product_reviews_tab' ) ) {
	/**
	 * Output the reviews tab content.
	 *
	 * @deprecated 2.4.0 Unused.
	 */
	function fincommerce_product_reviews_tab() {
		wc_deprecated_function( 'fincommerce_product_reviews_tab', '2.4' );
	}
}

/**
 * Get the URL to the FinCommerce Legacy REST API.
 *
 * Note that as of FinCommerce 9.0 the FinCommerce Legacy REST API has been moved to a dedicated extension,
 * and the implementation of its root endpoint in FinCommerce core is now just a stub that will always return an error.
 * See the setup_legacy_api_stub method in includes/class-fincommerce.php and:
 * https://developer.fincommerce.com/2023/10/03/the-legacy-rest-api-will-move-to-a-dedicated-extension-in-fincommerce-9-0/
 *
 * @deprecated 9.0.0 The Legacy REST API has been removed from FinCommerce core.
 *
 * @since 2.1
 * @param string $path an endpoint to include in the URL.
 * @return string the URL.
 */
function get_fincommerce_api_url( $path ) {
