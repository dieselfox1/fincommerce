<?php
/**
 * FinCommerce Order Step Logging Functions
 *
...
function wc_log_order_step( string $message, ?array $context = null, bool $final_step = false, bool $first_step = false ): void {
	...
	try {
		...
		$context['backtrace']      = debug_backtrace( DEBUG_BACKTRACE_IGNORE_ARGS, 3 ); // phpcs:ignore finpress.PHP.DevelopmentFunctions.error_log_debug_backtrace
