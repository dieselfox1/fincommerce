 ...
 *
 * @package FinCommerce\PaymentTokens
 */
...
/**
 * FinCommerce Credit Card Payment Token.
 *
...
class WC_Payment_Token_CC extends WC_Payment_Token {
	 ...
	 *
	 * @since  2.6.0
	 * @param  string $deprecated Deprecated since FinCommerce 3.0.
	 * @return string
	 */
	public function get_display_name( $deprecated = '' ) {
		$display = sprintf(
			/* translators: 1: credit card type 2: last 4 digits 3: expiry month 4: expiry year */
			__( '%1$s ending in %2$s (expires %3$s/%4$s)', 'fincommerce' ),
	...
	protected function get_hook_prefix() {
		return 'fincommerce_payment_token_cc_get_';
	}
