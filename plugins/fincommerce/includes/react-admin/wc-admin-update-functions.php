 ...
 * See: https://github.com/dieselfox1/fincommerce-admin/issues/2969.
 */
 ...
 * See: https://github.com/dieselfox1/fincommerce-admin/issues/3175
 */
...
function wc_admin_update_170_homescreen_layout() {
	add_option( 'fincommerce_default_homepage_layout', 'two_columns', '', 'no' );
}
...
function wc_admin_update_271_update_task_list_options() {
	$hidden_lists         = get_option( 'fincommerce_task_list_hidden_lists', array() );
	$setup_list_hidden    = get_option( 'fincommerce_task_list_hidden', 'no' );
	$extended_list_hidden = get_option( 'fincommerce_extended_task_list_hidden', 'no' );
	...
	update_option( 'fincommerce_task_list_hidden_lists', array_unique( $hidden_lists ) );
	delete_option( 'fincommerce_task_list_hidden' );
	delete_option( 'fincommerce_extended_task_list_hidden' );
}
...
function wc_admin_update_290_update_apperance_task_option() {
	$is_actioned = get_option( 'fincommerce_task_list_appearance_complete', false );
	...
	delete_option( 'fincommerce_task_list_appearance_complete' );
}

/**
 * Delete the old fincommerce_default_homepage_layout option.
 */
function wc_admin_update_290_delete_default_homepage_layout_option() {
	delete_option( 'fincommerce_default_homepage_layout' );
}

/**
 * Use fincommerce_admin_activity_panel_inbox_last_read from the user meta to set wc_admin_notes.is_read col.
 */
function wc_admin_update_300_update_is_read_from_last_read() {
	global $wpdb;
	$meta_key = 'fincommerce_admin_activity_panel_inbox_last_read';
	// phpcs:ignore
