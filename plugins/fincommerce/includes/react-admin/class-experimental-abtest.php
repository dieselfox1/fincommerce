 ...
 *
 * FinCommerce\Admin\Experimental_Abtest::in_treatment('experiment_name');
 *
 *
...
final class Experimental_Abtest {
	...
	protected function fetch_variation( $test_name ) {
		...
		$args = array(
			...
			'woo_country_code'              => rawurlencode( get_option( 'fincommerce_default_country', 'US:CA' ) ),
		 ...
		 * @since 6.5.0
		 */
		$args     = apply_filters( 'fincommerce_explat_request_args', $args );
