...
use Automattic\FinCommerce\Internal\Admin\Settings;

/**
 * Format a number using the decimal and thousands separator settings in FinCommerce.
 *
...
/**
 * Retrieves a URL to relative path inside FinCommerce admin with
 ...
 *
 * @internal FinCommerce core only includes Tracks in admin, not the REST API, so we need to include it.
