...
abstract class WC_Legacy_Cart {
	...
	public function &__get( $name ) {
		...
		switch ( $name ) {
			...
			case 'round_at_subtotal' :
				$value = 'yes' === get_option( 'fincommerce_tax_round_at_subtotal' );
				break;
			...
			case 'tax' :
				...
				break;
			case 'discount_total':
				wc_deprecated_argument( 'WC_Cart->discount_total', '2.3', 'After tax coupons are no longer supported. For more information see: https://fincommerce.wordpress.com/2014/12/upcoming-coupon-changes-in-fincommerce-2-3/' );
				$value = 0;
				break;
	...
	public function get_discounts_before_tax() {
		...
		return apply_filters( 'fincommerce_cart_discounts_before_tax', $discounts_before_tax, $this );
	}
