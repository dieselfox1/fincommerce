...
abstract class WC_Abstract_Legacy_Product extends WC_Data {
	...
	public function __get( $key ) {
		...
		wc_doing_it_wrong( $key, __( 'Product properties should not be accessed directly.', 'fincommerce' ), '3.0' );
	...
	public function get_variation_default_attributes() {
		...
		return apply_filters( 'fincommerce_product_default_attributes', $this->get_default_attributes(), $this );
	}
	...
	public function get_price_html_from_to( $from, $to ) {
		...
		return apply_filters( 'fincommerce_get_price_html_from_to', wc_format_sale_price( $from, $to ), $from, $to, $this );
	}
	...
	/**
	 * Returns the price including or excluding tax, based on the 'fincommerce_tax_display_shop' setting.
	 *
	...
	public function get_parent() {
		...
		return apply_filters( 'fincommerce_product_parent', absint( $this->get_post_data()->post_parent ), $this );
	}
	...
	public function get_upsells() {
		...
		return apply_filters( 'fincommerce_product_upsell_ids', $this->get_upsell_ids(), $this );
	}
	...
	public function get_cross_sells() {
		...
		return apply_filters( 'fincommerce_product_crosssell_ids', $this->get_cross_sell_ids(), $this );
	}
	...
	public static function sync_average_rating( $post_id ) {
		...
		// See notes in https://github.com/dieselfox1/fincommerce/pull/22909#discussion_r262393401.
		// Sync count first like in the original method https://github.com/dieselfox1/fincommerce/blob/2.6.0/includes/abstracts/abstract-wc-product.php#L1101-L1128.
