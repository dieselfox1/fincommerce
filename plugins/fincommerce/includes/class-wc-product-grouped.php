...
class WC_Product_Grouped extends WC_Product {
	...
	public function add_to_cart_text() {
		return apply_filters( 'fincommerce_product_add_to_cart_text', __( 'View products', 'fincommerce' ), $this );
	}
	...
	public function add_to_cart_description() {
		...
		return apply_filters( 'fincommerce_product_add_to_cart_description', sprintf( __( 'View products in the &ldquo;%s&rdquo; group', 'fincommerce' ), $this->get_name() ), $this );
	}
	...
	public function get_price_html( $price = '' ) {
		...
		if ( '' !== $min_price ) {
			...
			if ( $is_free ) {
				$price = apply_filters( 'fincommerce_grouped_free_price_html', __( 'Free!', 'fincommerce' ), $this );
			} else {
				$price = apply_filters( 'fincommerce_grouped_price_html', $price . $this->get_price_suffix(), $this, $child_prices );
			}
		} else {
			$price = apply_filters( 'fincommerce_grouped_empty_price_html', '', $this );
		}
