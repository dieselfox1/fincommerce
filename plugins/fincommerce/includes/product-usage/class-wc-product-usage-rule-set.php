<?php
/**
 * FinCommerce Product Usage Rule.
 *
 * This class defines the DTO for passing product feature restriction rules to FinCommerce extensions.
 *
 * @package FinCommerce\Admin\ProductUsage
 */
