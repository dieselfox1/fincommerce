...
abstract class WC_REST_Controller extends WP_REST_Controller {
	...
	protected function add_additional_fields_schema( $schema ) {
		...
		$schema['properties'] = apply_filters( 'fincommerce_rest_' . $object_type . '_schema', $schema['properties'] );
	...
	protected function check_batch_limit( $items ) {
		$limit = apply_filters( 'fincommerce_rest_batch_items_limit', 100, $this->get_normalized_rest_base() );
		$total = 0;
		...
		if ( $total > $limit ) {
			...
			return new WP_Error( 'fincommerce_rest_request_entity_too_large', sprintf( __( 'Unable to accept more than %s items for this request.', 'fincommerce' ), $limit ), array( 'status' => 413 ) );
		}
	...
	public function get_public_batch_schema() {
		$schema = array(
			...
			'properties' => array(
				'create' => array(
					'description' => __( 'List of created resources.', 'fincommerce' ),
					'type'        => 'array',
				...
				'update' => array(
					'description' => __( 'List of updated resources.', 'fincommerce' ),
					'type'        => 'array',
					'context'     => array( 'view', 'edit' ),
					'items'       => array(
						'type' => 'object',
				...
				'delete' => array(
					'description' => __( 'List of delete resources.', 'fincommerce' ),
					'type'        => 'array',
					'context'     => array( 'view', 'edit' ),
					'items'       => array(
						'type' => 'integer',
