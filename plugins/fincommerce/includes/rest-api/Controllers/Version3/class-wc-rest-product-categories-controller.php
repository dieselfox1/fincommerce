...
class WC_REST_Product_Categories_Controller extends WC_REST_Product_Categories_V2_Controller {
	...
	public function prepare_item_for_response( $item, $request ) {
		 ...
		 */
		return apply_filters( "fincommerce_rest_prepare_{$this->taxonomy}", $response, $item, $request );
	}
	...
	public function get_item_schema() {
		$schema = array(
			...
			'properties' => array(
				...
				'parent'      => array(
					'description' => __( 'The ID for the parent of the resource.', 'fincommerce' ),
					'type'        => 'integer',
					'context'     => array( 'view', 'edit' ),
				),
				'description' => array(
					'description' => __( 'HTML description of the resource.', 'fincommerce' ),
					'type'        => 'string',
					'context'     => array( 'view', 'edit' ),
					'arg_options' => array(
				...
				'display'     => array(
					'description' => __( 'Category archive display type.', 'fincommerce' ),
					'type'        => 'string',
					'default'     => 'default',
				...
				'image'       => array(
					'description' => __( 'Image data.', 'fincommerce' ),
					'type'        => 'object',
					'context'     => array( 'view', 'edit' ),
					'properties'  => array(
						'id'                => array(
				...
				'menu_order'  => array(
					'description' => __( 'Menu order, used to custom sort the resource.', 'fincommerce' ),
					'type'        => 'integer',
					'context'     => array( 'view', 'edit' ),
				),
				'count'       => array(
					'description' => __( 'Number of published products for the resource.', 'fincommerce' ),
					'type'        => 'integer',
					'context'     => array( 'view', 'edit' ),
					'readonly'    => true,
				),
