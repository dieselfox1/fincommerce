...
class WC_REST_Data_Currencies_Controller extends WC_REST_Data_Controller {
		...
		register_rest_route(
			...
			array(
				array(
					...
					'args'                => array(
						'location' => array(
							'description' => __( 'ISO4217 currency code.', 'fincommerce' ),
							'type'        => 'string',
						),
					),
				),
	...
	public function get_item( $request ) {
		...
		if ( empty( $data ) ) {
			return new WP_Error( 'fincommerce_rest_data_invalid_currency', __( 'There are no currencies matching these parameters.', 'fincommerce' ), array( 'status' => 404 ) );
		}
	...
	public function get_current_item( $request ) {
		$currency = get_option( 'fincommerce_currency' );
	...
	public function prepare_item_for_response( $item, $request ) {
		 ...
		 */
		return apply_filters( 'fincommerce_rest_prepare_data_currency', $response, $item, $request );
	}
	...
	public function get_item_schema() {
		$schema = array(
			...
			'properties' => array(
				...
				'name'   => array(
					'type'        => 'string',
					'description' => __( 'Full name of currency.', 'fincommerce' ),
					'context'     => array( 'view' ),
					'readonly'    => true,
				),
				'symbol' => array(
