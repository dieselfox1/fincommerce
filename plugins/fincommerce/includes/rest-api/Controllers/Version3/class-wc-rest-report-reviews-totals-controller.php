...
class WC_REST_Report_Reviews_Totals_Controller extends WC_REST_Reports_Controller {
	...
	protected function get_reports() {
		...
		for ( $i = 1; $i <= 5; $i++ ) {
			...
			$data[] = array(
				...
				'name'  => sprintf( __( 'Rated %s out of 5', 'fincommerce' ), $i ),
	...
	public function prepare_item_for_response( $report, $request ) {
		 ...
		 */
		return apply_filters( 'fincommerce_rest_prepare_report_reviews_count', $response, $report, $request );
	}
	...
	public function get_item_schema() {
		$schema = array(
			...
			'properties' => array(
				...
				'name'  => array(
					'description' => __( 'Review type name.', 'fincommerce' ),
					'type'        => 'string',
					'context'     => array( 'view' ),
					'readonly'    => true,
				),
				'total' => array(
					'description' => __( 'Amount of reviews.', 'fincommerce' ),
					'type'        => 'string',
					'context'     => array( 'view' ),
					'readonly'    => true,
				),
