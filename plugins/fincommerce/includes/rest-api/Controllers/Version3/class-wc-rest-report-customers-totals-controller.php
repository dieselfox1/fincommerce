...
class WC_REST_Report_Customers_Totals_Controller extends WC_REST_Reports_Controller {
	...
	protected function get_reports() {
		...
		$data = array(
			array(
				'slug'  => 'paying',
				'name'  => __( 'Paying customer', 'fincommerce' ),
				'total' => $total_paying,
			),
			array(
				'slug'  => 'non_paying',
				'name'  => __( 'Non-paying customer', 'fincommerce' ),
	...
	public function prepare_item_for_response( $report, $request ) {
		 ...
		 */
		return apply_filters( 'fincommerce_rest_prepare_report_customers_count', $response, $report, $request );
	}
	...
	public function get_item_schema() {
		$schema = array(
			...
			'properties' => array(
				...
				'name'  => array(
					'description' => __( 'Customer type name.', 'fincommerce' ),
					'type'        => 'string',
					'context'     => array( 'view' ),
					'readonly'    => true,
				),
				'total' => array(
					'description' => __( 'Amount of customers.', 'fincommerce' ),
					'type'        => 'string',
					'context'     => array( 'view' ),
					'readonly'    => true,
				),
