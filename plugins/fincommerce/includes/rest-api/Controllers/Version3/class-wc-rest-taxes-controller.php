...
class WC_REST_Taxes_Controller extends WC_REST_Taxes_V2_Controller {
	...
	public function get_item_schema() {
		...
		$schema['properties']['postcodes'] = array(
			'description' => __( 'List of postcodes / ZIPs. Introduced in FinCommerce 5.3.', 'fincommerce' ),
			'type'        => 'array',
			'items'       => array(
				'type' => 'string',
			),
		...
		$schema['properties']['cities'] = array(
			'description' => __( 'List of city names. Introduced in FinCommerce 5.3.', 'fincommerce' ),
			'type'        => 'array',
			'items'       => array(
				'type' => 'string',
			),
		...
		$schema['properties']['postcode']['description'] =
			__( "Postcode/ZIP, it doesn't support multiple values. Deprecated as of FinCommerce 5.3, 'postcodes' should be used instead.", 'fincommerce' );

		$schema['properties']['city']['description'] =
			__( "City name, it doesn't support multiple values. Deprecated as of FinCommerce 5.3, 'cities' should be used instead.", 'fincommerce' );
