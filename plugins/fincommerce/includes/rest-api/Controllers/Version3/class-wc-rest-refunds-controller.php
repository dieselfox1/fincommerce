...
class WC_REST_Refunds_Controller extends WC_REST_Order_Refunds_Controller {
	...
	protected function prepare_objects_query( $request ) {
		 ...
		 * @since 9.0.0.
		 */
		$args = apply_filters( 'fincommerce_rest_refunds_prepare_object_query', $args, $request );
	...
	public function prepare_object_for_response( $refund, $request ) {
		...
		return apply_filters( "fincommerce_rest_prepare_{$this->post_type}_object", $response, $refund, $request );
