...
class WC_REST_Layout_Templates_Controller extends WC_REST_Controller {
	...
	public function register_routes() {
		register_rest_route(
			...
			array(
				...
				'args'                => array(
					'area' => array(
						'description' => __( 'Area to get templates for.', 'fincommerce' ),
						'type'        => 'string',
						'default'     => '',
					),
				),
	...
	public function get_item( $request ) {
		...
		if ( count( $layout_templates ) !== 1 ) {
			return new WP_Error( 'fincommerce_rest_layout_template_invalid_id', __( 'Invalid layout template ID.', 'fincommerce' ), array( 'status' => 404 ) );
		}
