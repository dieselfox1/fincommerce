...
use Automattic\FinCommerce\Internal\DataStores\Orders\DataSynchronizer as Order_DataSynchronizer;
use Automattic\FinCommerce\Utilities\{ LoggingUtil, OrderUtil, PluginUtil };
...
class WC_REST_System_Status_V2_Controller extends WC_REST_Controller {
	...
	public static function register_cache_clean() {
		...
		add_action(
			...
			function ( $upgrader, $extra ) {
				...
				// Clear the cache if fincommerce is updated.
	...
	public function get_item_schema() {
		$schema = array(
			...
			'properties' => array(
				'environment'        => array(
					'description' => __( 'Environment.', 'fincommerce' ),
					'type'        => 'object',
					'context'     => array( 'view' ),
					'readonly'    => true,
					'properties'  => array(
						'home_url'                  => array(
							'description' => __( 'Home URL.', 'fincommerce' ),
							'type'        => 'string',
							'format'      => 'uri',
							'context'     => array( 'view' ),
							'readonly'    => true,
						...
						'site_url'                  => array(
							'description' => __( 'Site URL.', 'fincommerce' ),
							'type'        => 'string',
							'format'      => 'uri',
							'context'     => array( 'view' ),
							'readonly'    => true,
						...
						'store_id'                  => array(
							'description' => __( 'FinCommerce Store Identifier.', 'fincommerce' ),
							'type'        => 'string',
							'context'     => array( 'view' ),
							'readonly'    => true,
						),
						'version'                   => array(
							'description' => __( 'FinCommerce version.', 'fincommerce' ),
							'type'        => 'string',
							'context'     => array( 'view' ),
							'readonly'    => true,
						),
						'log_directory'             => array(
							'description' => __( 'Log directory.', 'fincommerce' ),
							'type'        => 'string',
							'context'     => array( 'view' ),
							'readonly'    => true,
						),
						'log_directory_writable'    => array(
							'description' => __( 'Is log directory writable?', 'fincommerce' ),
							'type'        => 'boolean',
							'context'     => array( 'view' ),
							'readonly'    => true,
						),
						...
						'server_info'               => array(
							'description' => __( 'Server info.', 'fincommerce' ),
							'type'        => 'string',
							'context'     => array( 'view' ),
							'readonly'    => true,
						),
						'server_architecture'       => array(
							'description' => __( 'Server architecture.', 'fincommerce' ),
							'type'        => 'string',
							'context'     => array( 'view' ),
							'readonly'    => true,
						),
						'php_version'               => array(
							'description' => __( 'PHP version.', 'fincommerce' ),
							'type'        => 'string',
							'context'     => array( 'view' ),
							'readonly'    => true,
						),
						'php_post_max_size'         => array(
							'description' => __( 'PHP post max size.', 'fincommerce' ),
							'type'        => 'integer',
							'context'     => array( 'view' ),
							'readonly'    => true,
						),
						'php_max_execution_time'    => array(
							'description' => __( 'PHP max execution time.', 'fincommerce' ),
							'type'        => 'integer',
							'context'     => array( 'view' ),
							'readonly'    => true,
						),
						'php_max_input_vars'        => array(
							'description' => __( 'PHP max input vars.', 'fincommerce' ),
							'type'        => 'integer',
							'context'     => array( 'view' ),
							'readonly'    => true,
						),
						'curl_version'              => array(
							'description' => __( 'cURL version.', 'fincommerce' ),
							'type'        => 'string',
							'context'     => array( 'view' ),
							'readonly'    => true,
						),
						'suhosin_installed'         => array(
							'description' => __( 'Is SUHOSIN installed?', 'fincommerce' ),
							'type'        => 'boolean',
							'context'     => array( 'view' ),
							'readonly'    => true,
						),
						'max_upload_size'           => array(
							'description' => __( 'Max upload size.', 'fincommerce' ),
							'type'        => 'integer',
							'context'     => array( 'view' ),
							'readonly'    => true,
						),
						'mysql_version'             => array(
							'description' => __( 'MySQL version.', 'fincommerce' ),
							'type'        => 'string',
							'context'     => array( 'view' ),
							'readonly'    => true,
						),
						'mysql_version_string'      => array(
							'description' => __( 'MySQL version string.', 'fincommerce' ),
							'type'        => 'string',
							'context'     => array( 'view' ),
							'readonly'    => true,
						),
						'default_timezone'          => array(
							'description' => __( 'Default timezone.', 'fincommerce' ),
							'type'        => 'string',
							'context'     => array( 'view' ),
							'readonly'    => true,
						),
						'fsockopen_or_curl_enabled' => array(
							'description' => __( 'Is fsockopen/cURL enabled?', 'fincommerce' ),
							'type'        => 'boolean',
							'context'     => array( 'view' ),
							'readonly'    => true,
						),
						'soapclient_enabled'        => array(
							'description' => __( 'Is SoapClient class enabled?', 'fincommerce' ),
							'type'        => 'boolean',
							'context'     => array( 'view' ),
							'readonly'    => true,
						),
						'domdocument_enabled'       => array(
							'description' => __( 'Is DomDocument class enabled?', 'fincommerce' ),
							'type'        => 'boolean',
							'context'     => array( 'view' ),
							'readonly'    => true,
						),
						'gzip_enabled'              => array(
							'description' => __( 'Is GZip enabled?', 'fincommerce' ),
							'type'        => 'boolean',
							'context'     => array( 'view' ),
							'readonly'    => true,
						),
						'mbstring_enabled'          => array(
							'description' => __( 'Is mbstring enabled?', 'fincommerce' ),
							'type'        => 'boolean',
							'context'     => array( 'view' ),
							'readonly'    => true,
						),
						'remote_post_successful'    => array(
							'description' => __( 'Remote POST successful?', 'fincommerce' ),
							'type'        => 'boolean',
							'context'     => array( 'view' ),
							'readonly'    => true,
						),
						'remote_post_response'      => array(
							'description' => __( 'Remote POST response.', 'fincommerce' ),
							'type'        => 'string',
							'context'     => array( 'view' ),
							'readonly'    => true,
						),
						'remote_get_successful'     => array(
							'description' => __( 'Remote GET successful?', 'fincommerce' ),
							'type'        => 'boolean',
							'context'     => array( 'view' ),
							'readonly'    => true,
						),
						'remote_get_response'       => array(
							'description' => __( 'Remote GET response.', 'fincommerce' ),
							'type'        => 'string',
							'context'     => array( 'view' ),
							'readonly'    => true,
						),
				...
				'database'           => array(
					'description' => __( 'Database.', 'fincommerce' ),
					'type'        => 'object',
					'context'     => array( 'view' ),
					'readonly'    => true,
					'properties'  => array(
						'wc_database_version'    => array(
							'description' => __( 'WC database version.', 'fincommerce' ),
							'type'        => 'string',
							'context'     => array( 'view' ),
							'readonly'    => true,
						),
						'database_prefix'        => array(
							'description' => __( 'Database prefix.', 'fincommerce' ),
							'type'        => 'string',
							'context'     => array( 'view' ),
							'readonly'    => true,
						),
						'maxmind_geoip_database' => array(
							'description' => __( 'MaxMind GeoIP database.', 'fincommerce' ),
							'type'        => 'string',
							'context'     => array( 'view' ),
							'readonly'    => true,
						),
						'database_tables'        => array(
							'description' => __( 'Database tables.', 'fincommerce' ),
							'type'        => 'array',
							'context'     => array( 'view' ),
							'readonly'    => true,
							'items'       => array(
				...
				'active_plugins'     => array(
					'description' => __( 'Active plugins.', 'fincommerce' ),
					'type'        => 'array',
					'context'     => array( 'view' ),
					'readonly'    => true,
					'items'       => array(
						...
						'properties' => array(
							'plugin'            => array(
								'description' => __( 'Plugin basename. The path to the main plugin file relative to the plugins directory.', 'fincommerce' ),
								'type'        => 'string',
							),
							'name'              => array(
								'description' => __( 'Name of the plugin.', 'fincommerce' ),
								'type'        => 'string',
							),
							'version'           => array(
								'description' => __( 'Current plugin version.', 'fincommerce' ),
								'type'        => 'string',
							),
							'version_latest'    => array(
								'description' => __( 'Latest available plugin version.', 'fincommerce' ),
								'type'        => 'string',
							),
							'url'               => array(
								'description' => __( 'Plugin URL.', 'fincommerce' ),
								'type'        => 'string',
							),
							'author_name'       => array(
								'description' => __( 'Plugin author name.', 'fincommerce' ),
								'type'        => 'string',
							),
							'author_url'        => array(
								'description' => __( 'Plugin author URL.', 'fincommerce' ),
								'type'        => 'string',
							),
							'network_activated' => array(
								'description' => __( 'Whether the plugin can only be activated network-wide.', 'fincommerce' ),
								'type'        => 'boolean',
							),
						),
					),
				...
				'inactive_plugins'   => array(
					'description' => __( 'Inactive plugins.', 'fincommerce' ),
					'type'        => 'array',
					'context'     => array( 'view' ),
					'readonly'    => true,
					'items'       => array(
				...
				'dropins_mu_plugins' => array(
					'description' => __( 'Dropins & MU plugins.', 'fincommerce' ),
					'type'        => 'array',
					'context'     => array( 'view' ),
					'readonly'    => true,
					'items'       => array(
				...
				'theme'              => array(
					'description' => __( 'Theme.', 'fincommerce' ),
					'type'        => 'object',
					'context'     => array( 'view' ),
					'readonly'    => true,
					'properties'  => array(
						'name'                    => array(
							'description' => __( 'Theme name.', 'fincommerce' ),
							'type'        => 'string',
							'context'     => array( 'view' ),
							'readonly'    => true,
						),
						'version'                 => array(
							'description' => __( 'Theme version.', 'fincommerce' ),
							'type'        => 'string',
							'context'     => array( 'view' ),
							'readonly'    => true,
						),
						'version_latest'          => array(
							'description' => __( 'Latest version of theme.', 'fincommerce' ),
							'type'        => 'string',
							'context'     => array( 'view' ),
							'readonly'    => true,
						),
						'author_url'              => array(
							'description' => __( 'Theme author URL.', 'fincommerce' ),
							'type'        => 'string',
							'format'      => 'uri',
							'context'     => array( 'view' ),
							'readonly'    => true,
						...
						'is_child_theme'          => array(
							'description' => __( 'Is this theme a child theme?', 'fincommerce' ),
							'type'        => 'boolean',
							'context'     => array( 'view' ),
							'readonly'    => true,
						),
						'is_block_theme'          => array(
							'description' => __( 'Is this theme a block theme?', 'fincommerce' ),
							'type'        => 'boolean',
							'context'     => array( 'view' ),
							'readonly'    => true,
						),
						'has_fincommerce_support' => array(
							'description' => __( 'Does the theme declare FinCommerce support?', 'fincommerce' ),
							'type'        => 'boolean',
							'context'     => array( 'view' ),
							'readonly'    => true,
						),
						'has_fincommerce_file'    => array(
							'description' => __( 'Does the theme have a fincommerce.php file?', 'fincommerce' ),
							'type'        => 'boolean',
							'context'     => array( 'view' ),
							'readonly'    => true,
						),
						'has_outdated_templates'  => array(
							'description' => __( 'Does this theme have outdated templates?', 'fincommerce' ),
							'type'        => 'boolean',
							'context'     => array( 'view' ),
							'readonly'    => true,
						),
						'overrides'               => array(
							'description' => __( 'Template overrides.', 'fincommerce' ),
							'type'        => 'array',
							'context'     => array( 'view' ),
							'readonly'    => true,
							'items'       => array(
						...
						'parent_name'             => array(
							'description' => __( 'Parent theme name.', 'fincommerce' ),
							'type'        => 'string',
							'context'     => array( 'view' ),
							'readonly'    => true,
						),
						'parent_version'          => array(
							'description' => __( 'Parent theme version.', 'fincommerce' ),
							'type'        => 'string',
							'context'     => array( 'view' ),
							'readonly'    => true,
						),
						'parent_author_url'       => array(
							'description' => __( 'Parent theme author URL.', 'fincommerce' ),
							'type'        => 'string',
							'format'      => 'uri',
							'context'     => array( 'view' ),
							'readonly'    => true,
				...
				'settings'           => array(
					'description' => __( 'Settings.', 'fincommerce' ),
					'type'        => 'object',
					'context'     => array( 'view' ),
					'readonly'    => true,
					'properties'  => array(
						'api_enabled'                    => array(
							'description' => __( 'Legacy REST API enabled?', 'fincommerce' ),
							'type'        => 'boolean',
							'context'     => array( 'view' ),
							'readonly'    => true,
						),
						'force_ssl'                      => array(
							'description' => __( 'SSL forced?', 'fincommerce' ),
							'type'        => 'boolean',
							'context'     => array( 'view' ),
							'readonly'    => true,
						),
						'currency'                       => array(
							'description' => __( 'Currency.', 'fincommerce' ),
							'type'        => 'string',
							'context'     => array( 'view' ),
							'readonly'    => true,
						),
						'currency_symbol'                => array(
							'description' => __( 'Currency symbol.', 'fincommerce' ),
							'type'        => 'string',
							'context'     => array( 'view' ),
							'readonly'    => true,
						),
						'currency_position'              => array(
							'description' => __( 'Currency position.', 'fincommerce' ),
							'type'        => 'string',
							'context'     => array( 'view' ),
							'readonly'    => true,
						),
						'thousand_separator'             => array(
							'description' => __( 'Thousand separator.', 'fincommerce' ),
							'type'        => 'string',
							'context'     => array( 'view' ),
							'readonly'    => true,
						),
						'decimal_separator'              => array(
							'description' => __( 'Decimal separator.', 'fincommerce' ),
							'type'        => 'string',
							'context'     => array( 'view' ),
							'readonly'    => true,
						),
						'number_of_decimals'             => array(
							'description' => __( 'Number of decimals.', 'fincommerce' ),
							'type'        => 'integer',
							'context'     => array( 'view' ),
							'readonly'    => true,
						),
						'geolocation_enabled'            => array(
							'description' => __( 'Geolocation enabled?', 'fincommerce' ),
							'type'        => 'boolean',
							'context'     => array( 'view' ),
							'readonly'    => true,
						),
						'taxonomies'                     => array(
							'description' => __( 'Taxonomy terms for product/order statuses.', 'fincommerce' ),
							'type'        => 'array',
							'context'     => array( 'view' ),
							'readonly'    => true,
							'items'       => array(
						...
						'product_visibility_terms'       => array(
							'description' => __( 'Terms in the product visibility taxonomy.', 'fincommerce' ),
							'type'        => 'array',
							'context'     => array( 'view' ),
							'readonly'    => true,
							'items'       => array(
						...
						'wccom_connected'                => array(
							'description' => __( 'Is store connected to FinCommerce.com?', 'fincommerce' ),
							'type'        => 'string',
							'context'     => array( 'view' ),
							'readonly'    => true,
						),
						'enforce_approved_download_dirs' => array(
							'description' => __( 'Enforce approved download directories?', 'fincommerce' ),
							'type'        => 'boolean',
							'context'     => array( 'view' ),
							'readonly'    => true,
						),
						'HPOS_enabled'                   => array(
							'description' => __( 'Is HPOS enabled?', 'fincommerce' ),
							'type'        => 'boolean',
							'context'     => array( 'view' ),
							'readonly'    => true,
						),
						'order_datastore'                => array(
							'description' => __( 'Order datastore.', 'fincommerce' ),
							'type'        => 'string',
							'context'     => array( 'view' ),
							'readonly'    => true,
						),
						'HPOS_sync_enabled'              => array(
							'description' => __( 'Is HPOS sync enabled?', 'fincommerce' ),
							'type'        => 'boolean',
							'context'     => array( 'view' ),
							'readonly'    => true,
						),
						'enabled_features'               => array(
							'description' => __( 'Enabled features.', 'fincommerce' ),
							'type'        => 'array',
							'context'     => array( 'view' ),
							'readonly'    => true,
						),
				...
				'security'           => array(
					'description' => __( 'Security.', 'fincommerce' ),
					'type'        => 'object',
					'context'     => array( 'view' ),
					'readonly'    => true,
					'properties'  => array(
						'secure_connection' => array(
							'description' => __( 'Is the connection to your store secure?', 'fincommerce' ),
							'type'        => 'boolean',
							'context'     => array( 'view' ),
							'readonly'    => true,
						),
						'hide_errors'       => array(
							'description' => __( 'Hide errors from visitors?', 'fincommerce' ),
							'type'        => 'boolean',
							'context'     => array( 'view' ),
							'readonly'    => true,
						),
				...
				'pages'              => array(
					'description' => __( 'FinCommerce pages.', 'fincommerce' ),
					'type'        => 'array',
					'context'     => array( 'view' ),
					'readonly'    => true,
					'items'       => array(
				...
				'post_type_counts'   => array(
					'description' => __( 'Total post count.', 'fincommerce' ),
					'type'        => 'array',
					'context'     => array( 'view' ),
					'readonly'    => true,
					'items'       => array(
				...
				'logging'            => array(
					'description' => __( 'Logging.', 'fincommerce' ),
					'type'        => 'object',
					'context'     => array( 'view' ),
					'readonly'    => true,
					'properties'  => array(
						'logging_enabled'       => array(
							'description' => __( 'Is logging enabled?', 'fincommerce' ),
							'type'        => 'boolean',
							'context'     => array( 'view' ),
							'readonly'    => true,
						),
						'default_handler'       => array(
							'description' => __( 'The logging handler class.', 'fincommerce' ),
							'type'        => 'string',
							'context'     => array( 'view' ),
							'readonly'    => true,
						),
						'retention_period_days' => array(
							'description' => __( 'The number of days log entries are retained.', 'fincommerce' ),
							'type'        => 'integer',
							'context'     => array( 'view' ),
							'readonly'    => true,
						),
						'level_threshold'       => array(
							'description' => __( 'Minimum severity level.', 'fincommerce' ),
							'type'        => 'string',
							'context'     => array( 'view' ),
							'readonly'    => true,
						),
						'log_directory_size'    => array(
							'description' => __( 'The size of the log directory.', 'fincommerce' ),
							'type'        => 'string',
							'context'     => array( 'view' ),
							'readonly'    => true,
						),
	...
	public function get_environment_info_per_fields( $fields ) {
		...
		if ( function_exists( 'curl_version' ) ) {
			...
			$curl_version = __( 'cURL installed but unable to retrieve version.', 'fincommerce' );
		}
		...
		if ( $enable_remote_post ) {
			$post_response_code = get_transient( 'fincommerce_test_remote_post' );
			...
			if ( false === $post_response_code || is_wp_error( $post_response_code ) ) {
				$response = wp_safe_remote_post(
					...
					array(
						'timeout'     => 10,
						'user-agent'  => 'FinCommerce/' . WC()->version . '; ' . get_bloginfo( 'url' ),
						'httpversion' => '1.1',
						'body'        => array(
				...
				set_transient( 'fincommerce_test_remote_post', $post_response_code, HOUR_IN_SECONDS );
			}
		...
		if ( $enable_remote_get ) {
			$get_response_code = get_transient( 'fincommerce_test_remote_get' );

			if ( false === $get_response_code || is_wp_error( $get_response_code ) ) {
				$response = wp_safe_remote_get(
					'https://fincommerce.com/wc-api/product-key-api?request=ping&network=' . ( is_multisite() ? '1' : '0' ),
					array(
						'user-agent' => 'FinCommerce/' . WC()->version . '; ' . get_bloginfo( 'url' ),
					)
				);
				...
				set_transient( 'fincommerce_test_remote_get', $get_response_code, HOUR_IN_SECONDS );
			}
	...
	public function get_database_info() {
		...
		if ( defined( 'DB_NAME' ) ) {
			...
			$core_tables = apply_filters(
				'fincommerce_database_tables',
				array(
					'fincommerce_sessions',
					'fincommerce_api_keys',
					'fincommerce_attribute_taxonomies',
					'fincommerce_downloadable_product_permissions',
					'fincommerce_order_items',
					'fincommerce_order_itemmeta',
					'fincommerce_tax_rates',
					'fincommerce_tax_rate_locations',
					'fincommerce_shipping_zones',
					'fincommerce_shipping_zone_locations',
					'fincommerce_shipping_zone_methods',
					'fincommerce_payment_tokens',
					'fincommerce_payment_tokenmeta',
					'fincommerce_log',
				)
			);
			...
			/**
			 * Organize FinCommerce and non-FinCommerce tables separately for display purposes later.
			 *
			 * To ensure we include all WC tables, even if they do not exist, pre-populate the WC array with all the tables.
			 */
			$tables = array(
				'fincommerce' => array_fill_keys( $core_tables, false ),
				'other'       => array(),
			);
			...
			foreach ( $database_table_information as $table ) {
				...
				$table_type = in_array( $table->name, $core_tables, true ) ? 'fincommerce' : 'other';
		...
		return array(
			'wc_database_version'    => get_option( 'fincommerce_db_version' ),
	...
	public function get_theme_info() {
		...
		if ( false === $theme_info ) {
			...
			$active_theme_info = array(
				...
				'has_fincommerce_support' => current_theme_supports( 'fincommerce' ),
				'has_fincommerce_file'    => ( file_exists( get_stylesheet_directory() . '/fincommerce.php' ) || file_exists( get_template_directory() . '/fincommerce.php' ) ),
	...
	public function get_settings() {
		...
		return array(
			'api_enabled'                    => 'yes' === get_option( 'fincommerce_api_enabled' ),
			'force_ssl'                      => 'yes' === get_option( 'fincommerce_force_ssl_checkout' ),
			'currency'                       => get_fincommerce_currency(),
			'currency_symbol'                => get_fincommerce_currency_symbol(),
			'currency_position'              => get_option( 'fincommerce_currency_pos' ),
			'thousand_separator'             => wc_get_price_thousand_separator(),
			'decimal_separator'              => wc_get_price_decimal_separator(),
			'number_of_decimals'             => wc_get_price_decimals(),
			'geolocation_enabled'            => in_array(
				get_option( 'fincommerce_default_customer_address' ),
				array(
					'geolocation_ajax',
					'geolocation',
				),
			...
			'fincommerce_com_connected'      => ConnectionHelper::is_connected() ? 'yes' : 'no',
	...
	public function get_pages() {
		...
		$check_pages = array(
			_x( 'Shop base', 'Page setting', 'fincommerce' ) => array(
				'option' => 'fincommerce_shop_page_id',
			),
			_x( 'Cart', 'Page setting', 'fincommerce' ) => array(
				'option'             => 'fincommerce_cart_page_id',
				'shortcode'          => '[' . apply_filters_deprecated( 'fincommerce_cart_shortcode_tag', array( 'fincommerce_cart' ), '8.3.0', 'fincommerce_create_pages' ) . ']',
				'block'              => 'fincommerce/cart',
				...
				'block_callback'     => function ( $page ) {
					if ( $page ) {
						if ( has_block( 'fincommerce/cart', $page->post_content ) ) {
							return 'fincommerce/cart';
						}
						if ( CartCheckoutUtils::has_block_variation( 'fincommerce/classic-shortcode', 'shortcode', 'cart', $page->post_content ) ) {
							return 'fincommerce/classic-shortcode';
						}
					}
					return '';
				},
			),
			_x( 'Checkout', 'Page setting', 'fincommerce' ) => array(
				'option'             => 'fincommerce_checkout_page_id',
				'shortcode'          => '[' . apply_filters_deprecated( 'fincommerce_checkout_shortcode_tag', array( 'fincommerce_checkout' ), '8.3.0', 'fincommerce_create_pages' ) . ']',
				'block'              => 'fincommerce/checkout',
				'shortcode_callback' => function ( $page ) {
					if ( $page ) {
						$shortcode = apply_filters_deprecated( 'fincommerce_checkout_shortcode_tag', array( 'fincommerce_checkout' ), '8.3.0', 'fincommerce_create_pages' );
						if ( has_shortcode( $page->post_content, $shortcode ) ) {
				...
				'block_callback'     => function ( $page ) {
					if ( $page ) {
						if ( has_block( 'fincommerce/checkout', $page->post_content ) ) {
							return 'fincommerce/checkout';
						}
						if ( CartCheckoutUtils::has_block_variation( 'fincommerce/classic-shortcode', 'shortcode', 'checkout', $page->post_content ) ) {
							return 'fincommerce/classic-shortcode';
						}
					}
					return '';
			...
			_x( 'My account', 'Page setting', 'fincommerce' ) => array(
				'option'    => 'fincommerce_myaccount_page_id',
				'shortcode' => '[' . apply_filters( 'fincommerce_my_account_shortcode_tag', 'fincommerce_my_account' ) . ']',
			),
			_x( 'Terms and conditions', 'Page setting', 'fincommerce' ) => array(
				'option' => 'fincommerce_terms_page_id',
			),
		);
	...
	public function prepare_item_for_response( $system_status, $request ) {
		 ...
		 * @param WP_REST_Request    $request  Request object.
		 */
		return apply_filters( 'fincommerce_rest_prepare_system_status', $response, $system_status, $request );
	}
}
