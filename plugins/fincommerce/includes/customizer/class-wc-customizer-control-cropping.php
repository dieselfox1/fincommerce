...
class WC_Customizer_Control_Cropping extends WP_Customize_Control {
	 ...
	 * @var string
	 */
	public $type = 'fincommerce-cropping-control';
	...
	public function render_content() {
		...
		<ul id="input_<?php echo esc_attr( $this->id ); ?>" class="fincommerce-cropping-control">
			<?php foreach ( $this->choices as $key => $radio ) : ?>
				<li>
					...
					<?php if ( 'custom' === $key ) : ?>
						<span class="fincommerce-cropping-control-aspect-ratio">
