...
class WC_Product_External extends WC_Product {
	...
	*/
	...
	public function set_manage_stock( $manage_stock ) {
		...
		if ( true === $manage_stock ) {
			$this->error( 'product_external_invalid_manage_stock', __( 'External products cannot be stock managed.', 'fincommerce' ) );
		}
	}
	...
	public function set_stock_status( $stock_status = '' ) {
		...
		if ( ProductStockStatus::IN_STOCK !== $stock_status ) {
			$this->error( 'product_external_invalid_stock_status', __( 'External products cannot be stock managed.', 'fincommerce' ) );
		}
	}
	...
	public function set_backorders( $backorders ) {
		...
		if ( 'no' !== $backorders ) {
			$this->error( 'product_external_invalid_backorders', __( 'External products cannot be backordered.', 'fincommerce' ) );
		}
	}
	...
	*/
	...
	public function is_purchasable() {
		return apply_filters( 'fincommerce_is_purchasable', false, $this );
	}
	...
	public function add_to_cart_url() {
		return apply_filters( 'fincommerce_product_add_to_cart_url', $this->get_product_url(), $this );
	}
	...
	public function single_add_to_cart_text() {
		return apply_filters( 'fincommerce_product_single_add_to_cart_text', $this->get_button_text() ? $this->get_button_text() : _x( 'Buy product', 'placeholder', 'fincommerce' ), $this );
	}
	...
	public function add_to_cart_text() {
		return apply_filters( 'fincommerce_product_add_to_cart_text', $this->get_button_text() ? $this->get_button_text() : _x( 'Buy product', 'placeholder', 'fincommerce' ), $this );
	}
	...
	public function add_to_cart_description() {
		...
		return apply_filters( 'fincommerce_product_add_to_cart_description', $this->get_button_text() ? $this->get_button_text() : sprintf( __( 'Buy &ldquo;%s&rdquo;', 'fincommerce' ), $this->get_name() ), $this );
	}
}
