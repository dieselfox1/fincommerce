<?php
/**
 * FinCommerce Coupon Tracking
 *
 * @package FinCommerce\Tracks
 */

/**
 * This class adds actions to track usage of a FinCommerce Coupon.
 */
class WC_Coupon_Tracking {
	...
	public function init() {
		add_action( 'fincommerce_coupon_object_updated_props', array( $this, 'track_coupon_updated' ), 10, 2 );
	}
