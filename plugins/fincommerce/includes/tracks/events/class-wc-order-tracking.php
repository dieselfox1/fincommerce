...
/**
 * This class adds actions to track usage of a FinCommerce Order.
 */
class WC_Order_Tracking {
	...
	public function init() {
		add_action( 'fincommerce_admin_order_data_after_order_details', array( $this, 'track_order_viewed' ) );
	}
