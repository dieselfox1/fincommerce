...
class WC_Order_Item_Fee extends WC_Order_Item {
	...
	public function calculate_taxes( $calculate_tax_for = array() ) {
		...
		do_action( 'fincommerce_order_item_fee_after_calculate_taxes', $this, $calculate_tax_for );
	...
	*/
	...
	public function set_tax_class( $value ) {
		if ( $value && ! in_array( $value, WC_Tax::get_tax_class_slugs(), true ) ) {
			$this->error( 'order_item_fee_invalid_tax_class', __( 'Invalid tax class', 'fincommerce' ) );
		}
	...
	*/
	...
	public function get_name( $context = 'view' ) {
		...
		if ( 'view' === $context ) {
			return $name ? $name : __( 'Fee', 'fincommerce' );
		} else {
			return $name;
		}
	}
