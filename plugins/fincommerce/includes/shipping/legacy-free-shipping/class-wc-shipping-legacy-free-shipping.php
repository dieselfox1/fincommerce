...
class WC_Shipping_Legacy_Free_Shipping extends WC_Shipping_Method {
	...
	public function __construct() {
		...
		$this->method_title = __( 'Free shipping (legacy)', 'fincommerce' );
	...
	public function init_form_fields() {
		$this->form_fields = array(
			...
			'title'        => array(
				...
				'default'     => __( 'Free Shipping', 'fincommerce' ),
				'desc_tip'    => true,
			),
			'availability' => array(
			...
			'requires'     => array(
				...
				'options' => array(
					...
					'either'     => __( 'A minimum order amount OR a coupon', 'fincommerce' ),
					'both'       => __( 'A minimum order amount AND a coupon', 'fincommerce' ),
				),
			),
			'min_amount'   => array(
				...
				'description' => __( 'Users will need to spend this amount to get free shipping (if enabled above).', 'fincommerce' ),
				'default'     => '0',
				'desc_tip'    => true,
			),
		);
