...
class WC_Shipping_Flat_Rate extends WC_Shipping_Method {
	...
	public function __construct( $instance_id = 0 ) {
		...
		$this->method_title       = __( 'Flat rate', 'fincommerce' );
		$this->method_description = __( 'Lets you charge a fixed rate for shipping.', 'fincommerce' );
		$this->supports           = array(
			'shipping-zones',
			'instance-settings',
	...
	protected function evaluate_cost( $sum, $args = array() ) {
		...
		$args           = apply_filters( 'fincommerce_evaluate_shipping_cost_args', $args, $sum, $this );
		$locale         = localeconv();
	...
	public function sanitize_cost( $value ) {
		...
		if ( ! $contains_shortcodes ) {
			$value = \Automattic\FinCommerce\Utilities\NumberUtil::sanitize_cost_in_current_locale( $value );
		}
