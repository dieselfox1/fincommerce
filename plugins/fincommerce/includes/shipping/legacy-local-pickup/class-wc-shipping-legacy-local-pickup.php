...
class WC_Shipping_Legacy_Local_Pickup extends WC_Shipping_Method {
	...
	public function __construct() {
		...
		$this->method_title = __( 'Local pickup (legacy)', 'fincommerce' );
	...
	public function init_form_fields() {
		$this->form_fields = array(
			...
			'title'        => array(
				...
				'default'     => __( 'Local pickup', 'fincommerce' ),
				'desc_tip'    => true,
			),
			'codes'        => array(
				'title'       => __( 'Allowed ZIP/post codes', 'fincommerce' ),
				'type'        => 'text',
				'desc_tip'    => __( 'What ZIP/post codes are available for local pickup?', 'fincommerce' ),
				'default'     => '',
