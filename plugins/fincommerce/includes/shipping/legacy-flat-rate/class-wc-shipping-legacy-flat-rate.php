...
class WC_Shipping_Legacy_Flat_Rate extends WC_Shipping_Method {
	...
	public function __construct() {
		...
		$this->method_title = __( 'Flat rate (legacy)', 'fincommerce' );
		...
		add_action( 'fincommerce_flat_rate_shipping_add_rate', array( $this, 'calculate_extra_shipping' ), 10, 2 );
	}
	...
	public function calculate_shipping( $package = array() ) {
		 ...
		 *
		 *      add_action( 'fincommerce_flat_rate_shipping_add_rate', 'add_another_custom_flat_rate', 10, 2 );
		 *
		 ...
		 *      }.
		 */
		do_action( 'fincommerce_flat_rate_shipping_add_rate', $this, $rate );
	}
