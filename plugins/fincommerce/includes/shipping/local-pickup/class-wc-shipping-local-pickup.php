...
class WC_Shipping_Local_Pickup extends WC_Shipping_Method {
	...
	public function __construct( $instance_id = 0 ) {
		...
		$this->method_description = __( 'Allow customers to pick up orders themselves. By default, when using local pickup store base taxes will apply regardless of customer address.', 'fincommerce' );
		$this->supports           = array(
			'shipping-zones',
			'instance-settings',
	...
	public function init_form_fields() {
		$this->instance_form_fields = array(
			'title'      => array(
				...
				'placeholder' => __( 'e.g. Local pickup', 'fincommerce' ),
				'desc_tip'    => true,
			),
			'tax_status' => array(
			...
			'cost'       => array(
				...
				'description'       => __( 'Optional cost for local pickup.', 'fincommerce' ),
				'default'           => '',
				'desc_tip'          => true,
