...
class WC_Admin_Reports {
	...
	public static function register_hook_handlers() {
		add_filter( 'fincommerce_after_dashboard_status_widget_parameter', array( __CLASS__, 'get_report_instance' ) );
		add_filter( 'fincommerce_dashboard_status_widget_reports', array( __CLASS__, 'replace_dashboard_status_widget_reports' ) );
	}
	...
	public static function get_reports() {
		$reports = array(
			'orders'    => array(
				...
				'reports' => array(
					'sales_by_date'     => array(
						'title'       => __( 'Sales by date', 'fincommerce' ),
						'description' => '',
						'hide_title'  => true,
						'callback'    => array( __CLASS__, 'get_report' ),
					),
					'sales_by_product'  => array(
						'title'       => __( 'Sales by product', 'fincommerce' ),
						'description' => '',
						'hide_title'  => true,
						'callback'    => array( __CLASS__, 'get_report' ),
					),
					'sales_by_category' => array(
						'title'       => __( 'Sales by category', 'fincommerce' ),
						'description' => '',
						'hide_title'  => true,
						'callback'    => array( __CLASS__, 'get_report' ),
					),
					'coupon_usage'      => array(
						'title'       => __( 'Coupons by date', 'fincommerce' ),
						'description' => '',
						'hide_title'  => true,
						'callback'    => array( __CLASS__, 'get_report' ),
					),
					'downloads'         => array(
						'title'       => __( 'Customer downloads', 'fincommerce' ),
						'description' => '',
						'hide_title'  => true,
						'callback'    => array( __CLASS__, 'get_report' ),
					),
			...
			'customers' => array(
				...
				'reports' => array(
					'customers'     => array(
						'title'       => __( 'Customers vs. guests', 'fincommerce' ),
						'description' => '',
						'hide_title'  => true,
						'callback'    => array( __CLASS__, 'get_report' ),
					),
					'customer_list' => array(
						'title'       => __( 'Customer list', 'fincommerce' ),
						'description' => '',
						'hide_title'  => true,
						'callback'    => array( __CLASS__, 'get_report' ),
					),
			...
			'stock'     => array(
				...
				'reports' => array(
					'low_in_stock' => array(
						'title'       => __( 'Low in stock', 'fincommerce' ),
						'description' => '',
						'hide_title'  => true,
						'callback'    => array( __CLASS__, 'get_report' ),
					),
					'out_of_stock' => array(
						'title'       => __( 'Out of stock', 'fincommerce' ),
						'description' => '',
						'hide_title'  => true,
						'callback'    => array( __CLASS__, 'get_report' ),
					),
					'most_stocked' => array(
						'title'       => __( 'Most stocked', 'fincommerce' ),
						'description' => '',
						'hide_title'  => true,
						'callback'    => array( __CLASS__, 'get_report' ),
					),
		...
		if ( wc_tax_enabled() ) {
			$reports['taxes'] = array(
				...
				'reports' => array(
					'taxes_by_code' => array(
						'title'       => __( 'Taxes by code', 'fincommerce' ),
						'description' => '',
						'hide_title'  => true,
						'callback'    => array( __CLASS__, 'get_report' ),
					),
					'taxes_by_date' => array(
						'title'       => __( 'Taxes by date', 'fincommerce' ),
						'description' => '',
						'hide_title'  => true,
						'callback'    => array( __CLASS__, 'get_report' ),
					),
		...
		/**
		 * Filter the list and add reports to the legacy _fincommerce > Reports_.
		 *
		 ...
		 * );
		 *
		 * This filter has a colliding name with the one in Automattic\FinCommerce\Admin\API\Reports\Controller.
		 * To make sure your code runs in the context of the legacy _fincommerce > Reports_ screen, and not the REST endpoint,
		 * use the following:
		 *
		 * add_filter( 'fincommerce_admin_reports',
		 *     function( $reports ) {
		 *         if ( is_admin() ) {
		 *             // ...
		 *
		...
		$reports = apply_filters( 'fincommerce_reports_charts', $reports ); // Backwards compatibility.
		...
		foreach ( $reports as $key => &$report_group ) {
			...
			// Silently ignore reports given for the filter in Automattic\FinCommerce\Admin\API\Reports\Controller.
