...
add_filter( 'fincommerce_csv_product_import_mapping_default_columns', 'wc_importer_default_english_mappings', 100 );
...
add_filter( 'fincommerce_csv_product_import_mapping_special_columns', 'wc_importer_default_special_english_mappings', 100 );
