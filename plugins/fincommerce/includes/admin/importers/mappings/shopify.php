...
add_filter( 'fincommerce_csv_product_import_mapping_default_columns', 'wc_importer_shopify_mappings', 10, 2 );
...
add_filter( 'fincommerce_csv_product_import_mapping_special_columns', 'wc_importer_shopify_special_mappings', 10, 2 );
...
add_filter( 'fincommerce_product_importer_pre_expand_data', 'wc_importer_shopify_expand_data' );
