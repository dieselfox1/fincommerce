...
class WC_Meta_Box_Product_Reviews {
	...
	public static function save( $data ) {
		...
		if ( ! isset( $_POST['fincommerce_meta_nonce'], $_POST['rating'] ) || ! wp_verify_nonce( wp_unslash( $_POST['fincommerce_meta_nonce'] ), 'fincommerce_save_data' ) ) { // WPCS: input var ok, sanitization ok.
			return $data;
		}
