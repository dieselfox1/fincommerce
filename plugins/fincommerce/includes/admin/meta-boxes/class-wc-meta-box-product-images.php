...
class WC_Meta_Box_Product_Images {
	...
	public static function output( $post ) {
				...
				if ( ! empty( $attachments ) ) {
					foreach ( $attachments as $attachment_id ) {
						...
						<li class="image" data-attachment_id="<?php echo esc_attr( $attachment_id ); ?>">
							...
							do_action( 'fincommerce_admin_after_product_gallery_item', $thepostid, $attachment_id );
							?>
						</li>
						<?php
		...
		<p class="add_product_images hide-if-no-js">
			<a href="#" data-choose="<?php esc_attr_e( 'Add images to product gallery', 'fincommerce' ); ?>" data-update="<?php esc_attr_e( 'Add to gallery', 'fincommerce' ); ?>" data-delete="<?php esc_attr_e( 'Delete image', 'fincommerce' ); ?>" data-text="<?php esc_attr_e( 'Delete', 'fincommerce' ); ?>"><?php esc_html_e( 'Add product gallery images', 'fincommerce' ); ?></a>
		</p>
		<?php
	}
