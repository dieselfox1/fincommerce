...
class WC_Admin_Upload_Downloadable_Product {
	...
	public function upload_dir( $pathdata ) {
		...
		if ( isset( $_POST['type'] ) && 'downloadable_product' === $_POST['type'] ) {
			...
			if ( empty( $pathdata['subdir'] ) ) {
				$pathdata['path']   = $pathdata['path'] . '/fincommerce_uploads';
				$pathdata['url']    = $pathdata['url'] . '/fincommerce_uploads';
				$pathdata['subdir'] = '/fincommerce_uploads';
			} else {
				$new_subdir = '/fincommerce_uploads' . $pathdata['subdir'];
	...
	/**
	 * Change filename for FinCommerce uploads and prepend unique chars for security.
	 *
	...
	public function update_filename( $full_filename, $ext, $dir ) {
		...
		if ( ! strpos( $dir, 'fincommerce_uploads' ) ) {
			return $full_filename;
		}

		if ( 'no' === get_option( 'fincommerce_downloads_add_hash_to_filename' ) ) {
			return $full_filename;
		}
	 ...
	 */
	public function fincommerce_media_upload_downloadable_product() {
