...
$delete_confirmation_js = sprintf(
	...
	esc_js( __( 'Are you sure you want to clear all logs from the database?', 'fincommerce' ) )
);
?>
<form method="get" id="mainform">
	...
	<?php $log_table_list->search_box( __( 'Search logs', 'fincommerce' ), 'log' ); ?>
	<?php $log_table_list->display(); ?>

	<?php
	submit_button(
		__( 'Flush all logs', 'fincommerce' ),
		'delete',
		'flush-logs',
		true,
		array(
