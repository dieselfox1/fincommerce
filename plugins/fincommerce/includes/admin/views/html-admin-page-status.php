...
$tabs        = apply_filters( 'fincommerce_admin_status_tabs', $tabs );
?>
<div class="wrap fincommerce">
	...
	switch ( $current_tab ) {
		...
		case 'logs':
			...
			break;
		default:
			if ( array_key_exists( $current_tab, $tabs ) && has_action( 'fincommerce_admin_status_content_' . $current_tab ) ) {
				do_action( 'fincommerce_admin_status_content_' . $current_tab );
			} else {
