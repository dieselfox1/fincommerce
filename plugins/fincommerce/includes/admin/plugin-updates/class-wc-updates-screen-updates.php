<?php
/**
 * Manages FinCommerce plugin updating on the Updates screen.
 *
...
class WC_Updates_Screen_Updates extends WC_Plugin_Updates {
	...
	public function update_screen_modal() {
		...
		if ( ! empty( $this->major_untested_plugins ) ) {
			echo $this->get_extensions_modal_warning(); // phpcs:ignore finpress.XSS.EscapeOutput.OutputNotEscaped
