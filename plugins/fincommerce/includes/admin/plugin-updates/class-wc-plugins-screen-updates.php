<?php
/**
 * Manages FinCommerce plugin updating on the Plugins screen.
 *
...
class WC_Plugins_Screen_Updates extends WC_Plugin_Updates {
	 ...
	 *
	 * @param  string $content FinCommerce readme file content.
	 * @param  string $new_version FinCommerce new version.
	 * @return string
	 */
	...
	public function plugin_screen_modal_js() {
		...
		<script>
			( function( $ ) {
				var $update_box = $( '#fincommerce-update' );
