...
class WC_Report_Customers extends WC_Admin_Report {
	...
	public function get_chart_legend() {
		...
		$legend[] = array(
			...
			'title'            => sprintf( __( '%s signups in this period', 'fincommerce' ), '<strong>' . count( $this->customers ) . '</strong>' ),
	...
	public function customers_vs_guests() {
		...
		<div class="chart-container">
			...
			<ul class="pie-chart-legend">
				<li style="border-color: <?php echo esc_attr( $this->chart_colours['customers'] ); ?>"><?php esc_html_e( 'Customer sales', 'fincommerce' ); ?></li>
				<li style="border-color: <?php echo esc_attr( $this->chart_colours['guests'] ); ?>"><?php esc_html_e( 'Guest sales', 'fincommerce' ); ?></li>
			</ul>
		</div>
				 ...
				 jQuery.plot(
					...
					],
					{
						...
						series: {
							...
							enable_tooltip: true,
							append_tooltip: "<?php echo esc_html( ' ' . __( 'orders', 'fincommerce' ) ); ?>",
						},
						legend: {
							show: false
						}
	...
	public function output_report() {
		...
		$users_query = new WP_User_Query(
			apply_filters(
				'fincommerce_admin_report_customers_user_query_args',
				array(
		...
		<script type="text/javascript">
			...
			jQuery(function(){
				...
				var drawGraph = function( highlight ) {
					var series = [
							{
								label: "<?php echo esc_js( __( 'Customer orders', 'fincommerce' ) ); ?>",
								...
								shadowSize: 0,
								enable_tooltip: true,
								append_tooltip: "<?php echo esc_html( ' ' . __( 'customer orders', 'fincommerce' ) ); ?>",
								stack: true,
							},
							{
								label: "<?php echo esc_js( __( 'Guest orders', 'fincommerce' ) ); ?>",
								...
								shadowSize: 0,
								enable_tooltip: true,
								append_tooltip: "<?php echo esc_html( ' ' . __( 'guest orders', 'fincommerce' ) ); ?>",
								stack: true,
							},
							{
								label: "<?php echo esc_js( __( 'Signups', 'fincommerce' ) ); ?>",
								...
								shadowSize: 0,
								enable_tooltip: true,
								append_tooltip: "<?php echo esc_html( ' ' . __( 'new users', 'fincommerce' ) ); ?>",
								stack: false
							},
						];
