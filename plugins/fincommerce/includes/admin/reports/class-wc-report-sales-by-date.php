...
class WC_Report_Sales_By_Date extends WC_Admin_Report {
	...
	private function query_report_data() {
		...
		$this->report_data = apply_filters( 'fincommerce_admin_report_data', $this->report_data );
	}
	...
	public function get_chart_legend() {
		...
		switch ( $this->chart_groupby ) {
			case 'day':
				$average_total_sales_title = sprintf(
					...
					__( '%s average gross daily sales', 'fincommerce' ),
					'<strong>' . wc_price( $data->average_total_sales ) . '</strong>'
				);
				$average_sales_title = sprintf(
					/* translators: %s: average sales */
					__( '%s average net daily sales', 'fincommerce' ),
			...
			default:
				$average_total_sales_title = sprintf(
					/* translators: %s: average total sales */
					__( '%s average gross monthly sales', 'fincommerce' ),
					'<strong>' . wc_price( $data->average_total_sales ) . '</strong>'
				);
				$average_sales_title = sprintf(
					/* translators: %s: average sales */
					__( '%s average net monthly sales', 'fincommerce' ),
					'<strong>' . wc_price( $data->average_sales ) . '</strong>'
				);
				break;
		}
		...
		$legend[] = array(
			'title'            => sprintf(
				...
				__( '%s gross sales in this period', 'fincommerce' ),
				'<strong>' . wc_price( $data->total_sales ) . '</strong>'
			),
			'placeholder'      => __( 'This is the sum of the order totals after any refunds and including shipping and taxes.', 'fincommerce' ),
		...
		$legend[] = array(
			'title'            => sprintf(
				...
				__( '%s net sales in this period', 'fincommerce' ),
				'<strong>' . wc_price( $data->net_sales ) . '</strong>'
			),
			'placeholder'      => __( 'This is the sum of the order totals after any refunds and excluding shipping and taxes.', 'fincommerce' ),
		...
		$legend[] = array(
			'title'            => sprintf(
				...
				__( '%s orders placed', 'fincommerce' ),
		...
		$legend[] = array(
			'title'            => sprintf(
				...
				__( '%s items purchased', 'fincommerce' ),
		...
		$legend[] = array(
			'title'            => sprintf(
				...
				_n( '%1$s refunded %2$d order (%3$d item)', '%1$s refunded %2$d orders (%3$d items)', $this->report_data->total_refunded_orders, 'fincommerce' ),
		...
		$legend[] = array(
			'title'            => sprintf(
				...
				__( '%s charged for shipping', 'fincommerce' ),
		...
		$legend[] = array(
			'title'            => sprintf(
				...
				__( '%s worth of coupons used', 'fincommerce' ),
	...
	public function get_main_chart() {
		...
		// 3rd party filtering of report data.
		$data = apply_filters( 'fincommerce_admin_report_chart_data', $data );
			...
			jQuery(function(){
				...
				var drawGraph = function( highlight ) {
					var series = [
						...
						{
							label: "<?php echo esc_js( __( 'Number of orders', 'fincommerce' ) ); ?>",
						...
						{
							label: "<?php echo esc_js( __( 'Average gross sales amount', 'fincommerce' ) ); ?>",
						...
						{
							label: "<?php echo esc_js( __( 'Average net sales amount', 'fincommerce' ) ); ?>",
						...
						{
							label: "<?php echo esc_js( __( 'Coupon amount', 'fincommerce' ) ); ?>",
