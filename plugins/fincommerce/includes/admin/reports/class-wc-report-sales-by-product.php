 ...
 *
 * @package FinCommerce\Admin\Reporting
 */
...
class WC_Report_Sales_By_Product extends WC_Admin_Report {
	...
	public function get_chart_legend() {
		...
		$legend[] = array(
			...
			'title'            => sprintf( __( '%s sales for the selected items', 'fincommerce' ), '<strong>' . wc_price( $total_sales ) . '</strong>' ),
		...
		$legend[] = array(
			...
			'title'            => sprintf( __( '%s purchases for the selected items', 'fincommerce' ), '<strong>' . ( $total_items ) . '</strong>' ),
	...
	public function output_report() {
		...
		$ranges = array(
			'year'       => __( 'Year', 'fincommerce' ),
			'last_month' => __( 'Last month', 'fincommerce' ),
			'month'      => __( 'This month', 'fincommerce' ),
			'7day'       => __( 'Last 7 days', 'fincommerce' ),
		);
	...
	public function get_chart_widgets() {
		...
		if ( ! empty( $this->product_ids ) ) {
			$widgets[] = array(
				'title'    => __( 'Showing reports for:', 'fincommerce' ),
	...
	public function current_filters() {
		...
		echo '<p><a class="button" href="' . esc_url( remove_query_arg( 'product_ids' ) ) . '">' . esc_html__( 'Reset', 'fincommerce' ) . '</a></p>';
	}
	...
	public function products_widget() {
		?>
		<h4 class="section_title"><span><?php esc_html_e( 'Product search', 'fincommerce' ); ?></span></h4>
		<div class="section">
			<form method="GET">
				<div>
					<?php // @codingStandardsIgnoreStart ?>
					<select class="wc-product-search" style="width:203px;" multiple="multiple" id="product_ids" name="product_ids[]" data-placeholder="<?php esc_attr_e( 'Search for a product&hellip;', 'fincommerce' ); ?>" data-action="fincommerce_json_search_products_and_variations"></select>
					<button type="submit" class="submit button" value="<?php esc_attr_e( 'Show', 'fincommerce' ); ?>"><?php esc_html_e( 'Show', 'fincommerce' ); ?></button>
		...
		<h4 class="section_title"><span><?php esc_html_e( 'Top sellers', 'fincommerce' ); ?></span></h4>
		<div class="section">
			<table cellspacing="0">
				<?php
				...
				if ( $top_sellers ) {
					...
					echo '<tr><td colspan="3">' . esc_html__( 'No products found in range', 'fincommerce' ) . '</td></tr>';
				}
				?>
			</table>
		</div>
		<h4 class="section_title"><span><?php esc_html_e( 'Top freebies', 'fincommerce' ); ?></span></h4>
		<div class="section">
			<table cellspacing="0">
				<?php
		...
		<h4 class="section_title"><span><?php esc_html_e( 'Top earners', 'fincommerce' ); ?></span></h4>
		<div class="section">
			<table cellspacing="0">
				<?php
	...
	public function get_export_button() {
		...
		<a
			...
			class="export_csv"
			data-export="chart"
			data-xaxes="<?php esc_attr_e( 'Date', 'fincommerce' ); ?>"
			data-groupby="<?php echo $this->chart_groupby; ?>"<?php // @codingStandardsIgnoreLine ?>
		>
			<?php esc_html_e( 'Export CSV', 'fincommerce' ); ?>
		</a>
		<?php
	}
	...
	public function get_main_chart() {
		...
		if ( empty( $this->product_ids ) ) {
			...
			<div class="chart-container">
				<p class="chart-prompt"><?php esc_html_e( 'Choose a product to view stats', 'fincommerce' ); ?></p>
			</div>
			<?php
		} else {
			...
			<script type="text/javascript">
				...
				jQuery(function(){
					...
					var drawGraph = function( highlight ) {
						...
						var series = [
							{
								label: "<?php echo esc_js( __( 'Number of items sold', 'fincommerce' ) ) ?>",
							...
							{
								label: "<?php echo esc_js( __( 'Sales amount', 'fincommerce' ) ) ?>",
