...
class WC_Report_Taxes_By_Date extends WC_Admin_Report {
	...
	public function get_main_chart() {
		...
		<table class="widefat">
			<thead>
				<tr>
					<th><?php _e( 'Period', 'fincommerce' ); ?></th>
					<th class="total_row"><?php _e( 'Number of orders', 'fincommerce' ); ?></th>
					<th class="total_row"><?php _e( 'Total sales', 'fincommerce' ); ?> <?php echo wc_help_tip( __( "This is the sum of the 'Order total' field within your orders.", 'fincommerce' ) ); ?></th>
					<th class="total_row"><?php _e( 'Total shipping', 'fincommerce' ); ?> <?php echo wc_help_tip( __( "This is the sum of the 'Shipping total' field within your orders.", 'fincommerce' ) ); ?></th>
					<th class="total_row"><?php _e( 'Total tax', 'fincommerce' ); ?> <?php echo wc_help_tip( __( 'This is the total tax for the rate (shipping tax + product tax).', 'fincommerce' ) ); ?></th>
					<th class="total_row"><?php _e( 'Net profit', 'fincommerce' ); ?> <?php echo wc_help_tip( __( 'Total sales minus shipping and tax.', 'fincommerce' ) ); ?></th>
				</tr>
			</thead>
			<?php if ( ! empty( $tax_rows ) ) : ?>
				...
				<tfoot>
					...
					?>
					<tr>
						<th scope="row"><?php _e( 'Totals', 'fincommerce' ); ?></th>
			...
			<?php else : ?>
				<tbody>
					<tr>
						<td><?php _e( 'No taxes found in this period', 'fincommerce' ); ?></td>
					</tr>
				</tbody>
			<?php endif; ?>
		</table>
