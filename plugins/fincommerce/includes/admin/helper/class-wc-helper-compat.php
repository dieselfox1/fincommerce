<?php
/**
 * FinCommerce Admin Helper Compat
 *
 ...
 *
 * Some level of compatibility with the legacy FinCommerce Helper plugin.
 */
class WC_Helper_Compat {
	...
	public static function load() {
		add_action( 'fincommerce_helper_loaded', array( __CLASS__, 'helper_loaded' ) );
	}

	/**
	 * Runs during fincommerce_helper_loaded
	 */
	...
	public static function plugin_deactivation_notice() {
		...
		<div id="message" class="error is-dismissible">
			<p><?php printf( __( 'The FinCommerce Helper plugin is no longer needed. <a href="%s">Manage subscriptions</a> from the extensions tab instead.', 'fincommerce' ), esc_url( admin_url( 'admin.php?page=wc-addons&section=helper' ) ) ); ?></p>
		</div>
		<?php
	}
	...
	public static function admin_menu() {
		...
		add_dashboard_page( __( 'FinCommerce Helper', 'fincommerce' ), __( 'FinCommerce Helper', 'fincommerce' ), 'manage_options', 'woothemes-helper', array( __CLASS__, 'render_compat_menu' ) );
	}
