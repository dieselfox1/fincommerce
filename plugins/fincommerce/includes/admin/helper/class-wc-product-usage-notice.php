<?php
/**
 * FinCommerce Product Usage Notice.
 *
...
class WC_Product_Usage_Notice {
	 ...
	 * @var string
	 */
	const DISMISSED_COUNT_META_PREFIX = '_fincommerce_product_usage_notice_dismissed_count_';
	 ...
	 * @var string
	 */
	const DISMISSED_TIMESTAMP_META_PREFIX = '_fincommerce_product_usage_notice_dismissed_timestamp_';
	 ...
	 * @var string
	 */
	const REMIND_LATER_TIMESTAMP_META_PREFIX = '_fincommerce_product_usage_notice_remind_later_timestamp_';
	 ...
	 * @var string
	 */
	const LAST_DISMISSED_TIMESTAMP_META = '_fincommerce_product_usage_notice_last_dismissed_timestamp';
	...
	public static function load() {
		...
		add_action( 'wp_ajax_fincommerce_dismiss_product_usage_notice', array( __CLASS__, 'ajax_dismiss' ) );
		add_action( 'wp_ajax_fincommerce_remind_later_product_usage_notice', array( __CLASS__, 'ajax_remind_later' ) );
	}
	...
	public static function enqueue_product_usage_notice_scripts() {
		...
		wp_localize_script(
			...
			array(
				...
				'renewUrl'            => $renew_url,
				'dismissAction'       => 'fincommerce_dismiss_product_usage_notice',
				'remindLaterAction'   => 'fincommerce_remind_later_product_usage_notice',
