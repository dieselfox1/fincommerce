<?php
/**
 * FinCommerce Admin Helper Options
 *
 ...
 *
 * An interface to the fincommerce_helper_data entry in the wp_options table.
 */
class WC_Helper_Options {
	 ...
	 * @var string
	 */
	private static $option_name = 'fincommerce_helper_data';
