<?php
/**
 * A utility class to handle FinCommerce.com connection.
 *
 ...
 *
 * Contains the logic to manage FinCommerce.com Helper Connection.
 */
class WC_Woo_Helper_Connection {
	...
	public static function get_connection_url_notice(): string {
		...
		return sprintf(
		/* translators: 1: FinCommerce.com connection URL, 2: home URL */
			__( 'Your site is currently connected to FinCommerce.com using <b>%1$s</b>, but your actual site URL is <b>%2$s</b>. To fix this, please reconnect your site to <b>FinCommerce.com</b> to ensure everything works correctly.', 'fincommerce' ),
			$url,
			$home_url
		);
	}
