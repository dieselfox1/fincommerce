...
if ( ! class_exists( 'WC_Admin_Dashboard_Setup', false ) ) :
	...
	class WC_Admin_Dashboard_Setup {
		...
		public function __construct() {
			if ( $this->should_display_widget() ) {
				add_meta_box(
					...
					__( 'FinCommerce Setup', 'fincommerce' ),
					array( $this, 'render' ),
					'dashboard',
					'normal',
					'high'
		...
		public function should_display_widget() {
			if ( ! class_exists( 'Automattic\FinCommerce\Admin\Features\Features' ) || ! class_exists( 'Automattic\FinCommerce\Admin\Features\OnboardingTasks\TaskLists' ) ) {
				return false;
			}
