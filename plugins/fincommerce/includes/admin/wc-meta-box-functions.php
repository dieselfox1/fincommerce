<?php
/**
 * FinCommerce Meta Box Functions
 *
 * @author      WooThemes
 * @category    Core
 ...
 */
function fincommerce_wp_text_input( $field, ?WC_Data $data = null ) {
	global $post;
 ...
 * @param WC_Data|null $data  WC_Data object, will be preferred over post object when passed.
 */
function fincommerce_wp_hidden_input( $field, ?WC_Data $data = null ) {
	global $post;
 ...
 * @param WC_Data|null $data  WC_Data object, will be preferred over post object when passed.
 */
function fincommerce_wp_textarea_input( $field, ?WC_Data $data = null ) {
	global $post;
 ...
 * @param WC_Data|null $data  WC_Data object, will be preferred over post object when passed.
 */
function fincommerce_wp_checkbox( $field, ?WC_Data $data = null ) {
	global $post;
 ...
 * @param WC_Data|null $data  WC_Data object, will be preferred over post object when passed.
 */
function fincommerce_wp_select( $field, ?WC_Data $data = null ) {
	global $post;
 ...
 * @param WC_Data|null $data  WC_Data object, will be preferred over post object when passed.
 */
function fincommerce_wp_radio( $field, ?WC_Data $data = null ) {
	global $post;
 ...
 * @param array $field Field data.
 */
function fincommerce_wp_note( $field ) {
	$field['wrapper_class'] = isset( $field['wrapper_class'] ) ? $field['wrapper_class'] : '';
