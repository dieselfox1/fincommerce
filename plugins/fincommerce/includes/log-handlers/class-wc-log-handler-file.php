 ...
 *
 * @package FinCommerce\Log Handlers
 */
 ...
 * @version        1.0.0
 * @package        FinCommerce\Classes\Log_Handlers
 */
class WC_Log_Handler_File extends WC_Log_Handler {
	...
	public function __construct( $log_size_limit = null ) {
		...
		$this->log_size_limit = apply_filters( 'fincommerce_log_file_size_limit', $log_size_limit );
	...
	public function clear( $handle ) {
		...
		do_action( 'fincommerce_log_clear', $handle );
	...
	public static function get_log_file_path( $handle ) {
		...
		if ( function_exists( 'wp_hash' ) ) {
			...
			wc_doing_it_wrong( __METHOD__, __( 'This method should not be called before plugins_loaded.', 'fincommerce' ), '3.0' );
			return false;
		}
	}
	...
	public static function get_log_file_name( $handle ) {
		if ( function_exists( 'wp_hash' ) ) {
			...
			wc_doing_it_wrong( __METHOD__, __( 'This method should not be called before plugins_loaded.', 'fincommerce' ), '3.3' );
			return false;
		}
	}
