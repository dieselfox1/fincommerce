...
abstract class WC_Log_Levels {
	...
	public static function get_all_level_labels() {
		return array(
			self::EMERGENCY => __( 'Emergency', 'fincommerce' ),
			self::ALERT     => __( 'Alert', 'fincommerce' ),
			self::CRITICAL  => __( 'Critical', 'fincommerce' ),
			self::ERROR     => __( 'Error', 'fincommerce' ),
			self::WARNING   => __( 'Warning', 'fincommerce' ),
			self::NOTICE    => __( 'Notice', 'fincommerce' ),
			self::INFO      => __( 'Info', 'fincommerce' ),
			self::DEBUG     => __( 'Debug', 'fincommerce' ),
		);
	}
}
