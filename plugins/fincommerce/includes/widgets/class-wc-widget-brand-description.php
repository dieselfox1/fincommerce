...
class WC_Widget_Brand_Description extends WP_Widget {
	...
	public function __construct() {
		...
		$this->woo_widget_name        = __( 'FinCommerce Brand Description', 'fincommerce' );
		$this->woo_widget_description = __( 'When viewing a brand archive, show the current brands description.', 'fincommerce' );
