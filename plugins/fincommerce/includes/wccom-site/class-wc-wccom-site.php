<?php
/**
 * FinCommerce.com Product Installation.
 *
 * @package FinCommerce\WCCom
 * @since   3.7.0
 */
 ...
 * WC_WCCOM_Site Class
 *
 * Main class for FinCommerce.com connected site.
 */
class WC_WCCOM_Site {
	...
	public static function load() {
		...
		add_action( 'fincommerce_wccom_install_products', array( 'WC_WCCOM_Site_Installer', 'install' ) );
		add_filter( 'determine_current_user', array( __CLASS__, 'authenticate_wccom' ), 14 );
		add_action( 'fincommerce_rest_api_get_rest_namespaces', array( __CLASS__, 'register_rest_namespace' ) );
	}
	...
	/**
	 * Authenticate FinCommerce.com request.
	 *
	 * @since 3.7.0
	...
	/**
	 * Verify FinCommerce.com request from a given body and signature request.
	 *
	 * @since 3.7.0
