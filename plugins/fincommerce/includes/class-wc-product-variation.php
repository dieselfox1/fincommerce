 ...
 * Product Variation
 *
 * The FinCommerce product variation class handles product variation data.
 *
...
class WC_Product_Variation extends WC_Product_Simple {
	...
	protected function get_hook_prefix() {
		return 'fincommerce_product_variation_get_';
	}
	...
	public function get_title() {
		return apply_filters( 'fincommerce_product_title', $this->parent_data['title'], $this );
	}
	...
	public function add_to_cart_url() {
		...
		return apply_filters( 'fincommerce_product_add_to_cart_url', $url, $this );
	}
	...
	*/
	...
	public function is_purchasable() {
		 ...
		 */
		return apply_filters( 'fincommerce_variation_is_purchasable', $this->variation_is_visible() && parent::is_purchasable() && ( ProductStatus::PUBLISH === $this->parent_data['status'] || current_user_can( 'edit_post', $this->get_parent_id() ) ), $this );
	}
	...
	public function variation_is_active() {
		return apply_filters( 'fincommerce_variation_is_active', true, $this );
	}
	...
	public function variation_is_visible() {
		 ...
		 * @param object $variation The variation object.
		 */
		return apply_filters( 'fincommerce_variation_is_visible', ProductStatus::PUBLISH === get_post_status( $this->get_id() ) && '' !== $this->get_price(), $this->get_id(), $this->get_parent_id(), $this );
	}
