...
if ( ! class_exists( 'WC_Email_Customer_Reset_Password', false ) ) :
	...
	class WC_Email_Customer_Reset_Password extends WC_Email {
		...
		public function __construct() {
			...
			$this->title       = __( 'Reset password', 'fincommerce' );
			$this->description = __( 'Send an email to customers notifying them that their password has been reset', 'fincommerce' );
			...
			// Trigger.
			add_action( 'fincommerce_reset_password_notification', array( $this, 'trigger' ), 10, 2 );
		...
		public function get_default_subject() {
			return $this->email_improvements_enabled
				? __( 'Reset your password for {site_title}', 'fincommerce' )
				: __( 'Password Reset Request for {site_title}', 'fincommerce' );
		}
		...
		public function get_default_heading() {
			return $this->email_improvements_enabled
				? __( 'Reset your password', 'fincommerce' )
				: __( 'Password Reset Request', 'fincommerce' );
		}
