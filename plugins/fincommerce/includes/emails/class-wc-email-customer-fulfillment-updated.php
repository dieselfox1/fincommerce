...
if ( ! class_exists( 'WC_Email_Customer_Fulfillment_Updated', false ) ) :
	...
	class WC_Email_Customer_Fulfillment_Updated extends WC_Email {
		...
		public function __construct() {
			...
			$this->title          = __( 'Fulfillment updated', 'fincommerce' );
			...
			add_action( 'fincommerce_fulfillment_updated_notification', array( $this, 'trigger' ), 10, 3 );

			// Call parent constructor.
			parent::__construct();

			$this->description = __( 'Fulfillment updated emails are sent to the customer when the merchant updates a fulfillment for the order. The notification isn’t sent for draft fulfillments.', 'fincommerce' );
		}
		...
		public function get_default_subject() {
			return __( 'A shipment from {site_title} order {order_number} has been updated', 'fincommerce' );
		}
		...
		public function get_default_heading() {
			return __( 'Your shipment has been updated', 'fincommerce' );
		}
		...
		public function get_default_additional_content() {
			return __( 'If anything looks off or you have questions, feel free to contact our support team.', 'fincommerce' );
		}
