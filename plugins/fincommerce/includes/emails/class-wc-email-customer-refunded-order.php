...
if ( ! class_exists( 'WC_Email_Customer_Refunded_Order', false ) ) :
	...
	class WC_Email_Customer_Refunded_Order extends WC_Email {
		...
		public function __construct() {
			...
			$this->title          = __( 'Refunded order', 'fincommerce' );
			...
			$this->description = $this->email_improvements_enabled
				? __( 'Send an email to customers notifying them when an order has been partially or fully refunded', 'fincommerce' )
				: __( 'Order refunded emails are sent to customers when their orders are refunded.', 'fincommerce' );
		}
		...
		public function get_default_subject( $partial = false ) {
			if ( $partial ) {
				return __( 'Your {site_title} order #{order_number} has been partially refunded', 'fincommerce' );
			} else {
				return __( 'Your {site_title} order #{order_number} has been refunded', 'fincommerce' );
			}
		}
		...
		public function get_subject() {
			 ...
			 * @since 3.7.0
			 */
			$subject = apply_filters( 'fincommerce_email_subject_customer_refunded_order', $this->format_string( $subject ), $this->object, $this );
		...
		public function get_default_additional_content() {
			return $this->email_improvements_enabled
				? __( 'If you need any help with your order, please contact us at {store_email}.', 'fincommerce' )
				: __( 'We hope to see you again soon.', 'fincommerce' );
		}
