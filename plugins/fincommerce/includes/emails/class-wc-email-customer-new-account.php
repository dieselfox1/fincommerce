...
if ( ! class_exists( 'WC_Email_Customer_New_Account', false ) ) {
	...
	class WC_Email_Customer_New_Account extends WC_Email {
		...
		public function __construct() {
			...
			$this->title          = __( 'New account', 'fincommerce' );
			$this->email_group    = 'accounts';
			$this->description    = __( 'Send an email to customers notifying them that they have created an account', 'fincommerce' );
		...
		public function get_default_subject() {
			return __( 'Your {site_title} account has been created!', 'fincommerce' );
		}
		...
		public function get_default_heading() {
			return __( 'Welcome to {site_title}', 'fincommerce' );
		}
		...
		public function get_default_additional_content() {
			return __( 'We look forward to seeing you soon.', 'fincommerce' );
		}
