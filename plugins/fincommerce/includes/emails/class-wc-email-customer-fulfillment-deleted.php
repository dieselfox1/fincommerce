...
if ( ! class_exists( 'WC_Email_Customer_Fulfillment_Deleted', false ) ) :
	...
	class WC_Email_Customer_Fulfillment_Deleted extends WC_Email {
		...
		public function __construct() {
			...
			$this->title          = __( 'Fulfillment deleted', 'fincommerce' );
			...
			add_action( 'fincommerce_fulfillment_deleted_notification', array( $this, 'trigger' ), 10, 3 );

			// Call parent constructor.
			parent::__construct();

			$this->description = __( 'Fulfillment deleted emails are sent to the customer when the merchant cancels an already fulfilled fulfillment. The notification isn’t sent for draft fulfillments.', 'fincommerce' );
		}
		...
		public function get_default_subject() {
			return __( 'A shipment from {site_title} order {order_number} has been cancelled', 'fincommerce' );
		}
		...
		public function get_default_heading() {
			return __( 'One of your shipments has been removed', 'fincommerce' );
		}
		...
		public function get_default_additional_content() {
			return __( 'If you have any questions or notice anything unexpected, feel free to reach out to our support team through your account or reply to this email.', 'fincommerce' );
		}
