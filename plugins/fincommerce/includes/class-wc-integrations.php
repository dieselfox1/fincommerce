<?php
/**
 * FinCommerce Integrations class
 *
 * Loads Integrations into FinCommerce.
 *
 * @version 3.9.0
 * @package FinCommerce\Classes\Integrations
 */
...
class WC_Integrations {
	...
	public function __construct() {
		...
		do_action( 'fincommerce_integrations_init' );

		$load_integrations = array(
			'WC_Integration_MaxMind_Geolocation',
		);

		$load_integrations = apply_filters( 'fincommerce_integrations', $load_integrations );
