...
class WC_Data_Store {
	 ...
	 * Ran through `fincommerce_data_stores`.
	 *
	 * @var array
	 */
	...
	public function __construct( $object_type ) {
		...
		$this->stores      = apply_filters( 'fincommerce_data_stores', $this->stores );
		...
		if ( array_key_exists( $object_type, $this->stores ) ) {
			$store = apply_filters( 'fincommerce_' . $object_type . '_data_store', $this->stores[ $object_type ] );
			if ( is_object( $store ) ) {
	 ...
	 *
	 * @since 3.0.0
	 * @param WC_Data $data FinCommerce data instance.
	 */
