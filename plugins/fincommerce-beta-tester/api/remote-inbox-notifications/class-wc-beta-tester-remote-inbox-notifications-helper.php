...
use Automattic\FinCommerce\Admin\RemoteInboxNotifications\SpecRunner;
...
use Automattic\FinCommerce\Admin\RemoteSpecs\RuleProcessors\GetRuleProcessor;
...
class WC_Beta_Tester_Remote_Inbox_Notifications_Helper {
	...
	public static function get_transient_name() {
		return 'fincommerce_admin_' . RemoteInboxNotificationsDataSourcePoller::ID . '_specs';
	}
