...
function tools_reset_launch_your_store() {
	...
	delete_option( 'fincommerce_coming_soon' );
	delete_option( 'fincommerce_store_pages_only' );
	delete_option( 'fincommerce_private_link' );
	delete_option( 'fincommerce_share_key' );

	$result = ( new \Automattic\FinCommerce\Admin\API\LaunchYourStore() )->initialize_coming_soon();
	if ( ! $result ) {
	...
	delete_option( 'fincommerce_admin_launch_your_store_survey_completed' );

	// Reset essential task list completion tracking.
	$tasks_completed = get_option( \Automattic\FinCommerce\Admin\Features\OnboardingTasks\Task::COMPLETED_OPTION, array() );
	...
	update_option( \Automattic\FinCommerce\Admin\Features\OnboardingTasks\Task::COMPLETED_OPTION, $tasks_completed );

	// Reset setup task list completion tracking.
	$task_lists_completed = get_option( \Automattic\FinCommerce\Admin\Features\OnboardingTasks\TaskList::COMPLETED_OPTION, array() );
	...
	update_option( \Automattic\FinCommerce\Admin\Features\OnboardingTasks\TaskList::COMPLETED_OPTION, $task_lists_completed );
