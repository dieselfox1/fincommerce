<?php
/**
 * Fake fincommercePayments account data for testing purposes.
 *
...
if (
	...
	add_filter( 'fincommerce_payment_gateways', 'tools_fake_wcpay' );
	add_filter( 'fincommerce_available_payment_gateways', 'tools_fake_wcpay' );
	...
	function tools_fake_wcpay( $gateways ) {
		$gateways['fincommerce_payments'] = new Fake_WCPayments();
		return $gateways;
	}
}
