...
class WC_Beta_Tester_Product_Editor_Devtools {
	...
	public function register_scripts() {
		...
		if ( ! Automattic\FinCommerce\Utilities\FeaturesUtil::feature_is_enabled( 'product_block_editor' ) || ! \Automattic\FinCommerce\Admin\PageController::is_admin_page() ) {
			return;
		}
		...
		wp_register_script(
			'fincommerce-beta-tester-product-editor-devtools',
			$script_url,
		...
		wp_enqueue_script( 'fincommerce-beta-tester-product-editor-devtools' );
		...
		wp_enqueue_style( 'fincommerce-beta-tester-product-editor-devtools' );
	}
}
