<?php
/**
 * FinCommerce Beta Tester CLI controls
 *
...
/**
 * Control your local FinCommerce Beta Tester plugin.
 */
class WC_Beta_Tester_CLI extends WP_CLI_Command {

	/**
	 * Install a live branch of the FinCommerce plugin
	 *
	 * ## Options
	 * <branch>
	...
	/**
	 * Deactivate FinCommerce.
	 *
	 * ## Examples
	 *  wp wc-beta-tester deactivate_fincommerce
	 */
	public function deactivate_fincommerce() {
		$installer = new WC_Beta_Tester_Live_Branches_Installer();
		$installer->deactivate_fincommerce();

		WP_CLI::success( 'Deactivated FinCommerce' );
	}

	/**
	 * Activate a live branch of the FinCommerce plugin.
	 *
	 * ## Options
	 * <branch>
