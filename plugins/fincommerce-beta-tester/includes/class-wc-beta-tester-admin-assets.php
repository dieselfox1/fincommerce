...
class WC_Beta_Tester_Admin_Assets {
	...
	public function admin_scripts() {
		...
		wp_register_style( 'wc-beta-tester-admin', WC_Beta_Tester::instance()->plugin_url() . '/assets/css/admin.css', array( 'fincommerce_admin_styles' ), WC_BETA_TESTER_VERSION );
		...
		wp_localize_script(
			...
			array(
				...
				'description' => sprintf( __( 'Release of version %s', 'fincommerce-beta-tester' ), $version ),
			)
		);
		...
		wp_localize_script(
			...
			array(
				'i18n_pick_version' => __( 'Please pick a FinCommerce version.', 'fincommerce-beta-tester' ),
			)
		);
