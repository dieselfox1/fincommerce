...
class WC_Beta_Tester_Channel {
	...
	public function settings_init() {
		...
		add_settings_section(
			...
			__( 'Settings', 'fincommerce-beta-tester' ),
		...
		add_settings_field(
			...
			__( 'Release Channel', 'fincommerce-beta-tester' ),
		...
		add_settings_field(
			...
			__( 'Automatic Updates', 'fincommerce-beta-tester' ),
	...
	public function update_section_html( $args ) {
		?>
		<p id="<?php echo esc_attr( $args['id'] ); ?>"><?php esc_html_e( 'The following settings allow you to choose which FinCommerce updates to receive on this site, including beta and RC versions not quite ready for production deployment.', 'fincommerce-beta-tester' ); ?></p>
		<?php
	}
	...
	public function version_select_html( $args ) {
		...
		$channels = array(
			'beta'   => array(
				'name'        => __( 'Beta Releases', 'fincommerce-beta-tester' ),
				'description' => __( 'Beta releases contain experimental functionality for testing purposes only. This channel will also include RC and stable releases if more current.', 'fincommerce-beta-tester' ),
			),
			'rc'     => array(
				'name'        => __( 'Release Candidates', 'fincommerce-beta-tester' ),
				'description' => __( 'Release candidates are released to ensure any critical problems have not gone undetected. This channel will also include stable releases if more current.', 'fincommerce-beta-tester' ),
			),
			'stable' => array(
	...
	public function automatic_update_checkbox_html( $args ) {
		...
		<label for="<?php echo esc_attr( $args['label_for'] ); ?>">
			...
			<?php echo esc_html__( 'If enabled, FinCommerce will update to the latest release in the background. Use with caution; we do not recommend using this on production stores!', 'fincommerce-beta-tester' ); ?>
		</label>
		<?php
	}
	...
	public function add_to_menus() {
		add_submenu_page( 'plugins.php', __( 'FinCommerce Beta Tester', 'fincommerce-beta-tester' ), __( 'WC Beta Tester', 'fincommerce-beta-tester' ), 'install_plugins', 'wc-beta-tester', array( $this, 'settings_page_html' ) );
	}
