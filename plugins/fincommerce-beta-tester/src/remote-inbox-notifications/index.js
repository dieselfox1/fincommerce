...
function RemoteInboxNotifications( {
	...
	const importFromUrl = async ( _url ) => {
		const preDefinedUrls = {
			staging:
				'https://staging.fincommerce.com/wp-json/wccom/inbox-notifications/2.0/notifications.json',
			production:
				'https://fincommerce.com/wp-json/wccom/inbox-notifications/2.0/notifications.json',
		};
