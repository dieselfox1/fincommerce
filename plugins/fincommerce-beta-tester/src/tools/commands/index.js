...
export default [
	{
		...
		description: `This will trigger a FinCommerce Admin install, which usually
    happens when a new version (or new install) of FinCommerce
	...
	},
	{
		...
		description:
			'Updates fincommerce_admin_install_timestamp to a certain date',
	...
	{
		command: 'Force errors on fincommerce.com requests',
	...
	{
		command: 'Set FinCommerce.com Base URL',
