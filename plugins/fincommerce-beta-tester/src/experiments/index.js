			...
			{ isTrackingEnabled === 'no' && (
				<p className="tracking-disabled">
					...
					<a
						...
						href={
							wcSettings.adminUrl +
							'/admin.php?page=wc-settings&tab=advanced&section=fincommerce_com'
						}
						rel="noreferrer"
					>
						FinCommerce &#8594; Settings &#8594; Advanced &#8594;
						FinCommerce.com
					</a>
					&nbsp;and check{ ' ' }
					<b>Allow usage of FinCommerce to be tracked</b>.
				</p>
			) }
			<NewExperimentForm />
...
export default compose(
	withSelect( ( select ) => {
		...
		return {
			...
			isTrackingEnabled: getOption( 'fincommerce_allow_tracking' ),
